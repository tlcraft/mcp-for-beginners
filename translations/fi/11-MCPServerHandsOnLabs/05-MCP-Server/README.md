...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:03:49+00:00",
...
Tässä käytännön labrassa opit toteuttamaan tuotantovalmiin MCP-palvelimen FastMCP-kehyksen avulla. Rakennat palvelimen ydinkonstruktion, toteutat tietokantaintegraation, luot työkaluja datan käsittelyyn ja luot perustan tekoälypohjaiselle vähittäiskaupan analytiikalle.

## Yleiskatsaus

MCP-palvelin on vähittäiskaupan analytiikkaratkaisumme ydin. Se toimii sillan tavoin tekoälyavustajien ja PostgreSQL-tietokannan välillä, tarjoten turvallisen ja älykkään pääsyn liiketoimintadataan standardoidun protokollan kautta.

Tämä labra opettaa sinulle, kuinka rakennetaan kestävä ja skaalautuva MCP-palvelin noudattaen yritystason malleja ja parhaita käytäntöjä.

## Oppimistavoitteet

Labran lopussa osaat:

- **Rakentaa** FastMCP-palvelimen oikealla arkkitehtuurilla ja organisoinnilla
- **Toteuttaa** tietokantaintegraation yhteyspoolauksen ja virheenkäsittelyn kanssa
- **Luoda** MCP-työkaluja tietokannan skeeman tarkasteluun ja kyselyiden suorittamiseen
- **Konfiguroida** rivitason turvallisuuden (Row Level Security) kontekstinhallinnan
- **Lisätä** terveysseurannan ja havainnointiominaisuuksia
- **Testata** MCP-palvelimen toteutusta paikallisesti ja VS Code -ympäristössä

## 📁 Projektin rakenne

Tutustutaan MCP-palvelimen organisointiin:
...
### Ympäristökonfiguraatio (`config.py`)

Aloitetaan luomalla vankka konfiguraatiojärjestelmä:
...
### Keskeiset konfiguraatio-ominaisuudet

- **Ympäristömuuttujien lataus**: Automaattinen .env-tiedoston tuki
- **Tyyppiturvallisuus**: Dataclass-validointi ja tyyppivihjeet
- **Joustavat oletukset**: Käytännölliset oletukset kehitystä varten
- **Validointi**: Konfiguraation validointi hyödyllisten virheilmoitusten kanssa
- **Turvallisuus**: Arkaluontoiset arvot vain ympäristömuuttujista

## 🗄️ Tietokantaintegraatiokerros

### PostgreSQL-tarjoaja (`sales_analysis_postgres.py`)

Toteutetaan tietokantaintegraatiokerros:
...
### Keskeiset tietokantakerroksen ominaisuudet

- **Yhteyspoolaus**: Tehokas resurssien hallinta asyncpg:n avulla
- **RLS-integraatio**: Automaattinen rivitason turvallisuuden kontekstiasetus
- **Skeeman tarkastelu**: Dynaaminen taulujen skeeman tunnistus
- **Virheenkäsittely**: Kattava virheiden hallinta ja lokitus
- **Kyselyiden muotoilu**: Tekoälyystävällinen tulosten muotoilu
- **Terveysseuranta**: Tietokantayhteyden ja poolin tilan tarkistukset

## 🔧 MCP-palvelimen pääasiallinen toteutus

### FastMCP-palvelin (`sales_analysis.py`)

Toteutetaan MCP-palvelimen pääosa:
...
### Keskeiset MCP-palvelimen ominaisuudet

- **Työkalujen rekisteröinti**: Deklaratiiviset työkalumäärittelyt tyyppiturvallisuudella
- **RLS-kontekstinhallinta**: Automaattinen käyttäjäidentiteetin poiminta ja kontekstiasetus
- **Virheenkäsittely**: Kattava virheiden hallinta käyttäjäystävällisillä viesteillä
- **Elinkaaren hallinta**: Oikea käynnistys/sammutus ja resurssien siivous
- **Terveysseuranta**: Sisäänrakennetut terveysseuranta-endpointit
- **Kehitystuki**: Hot reload ja debuggausominaisuudet

## 🏥 Terveysseuranta

### Terveystarkistuksen toteutus (`health_check.py`)
...
### VS Code -integraatiotestaus

1. **Konfiguroi VS Code MCP**:
   ```json
   // .vscode/mcp.json
   {
       "servers": {
...
2. **Testaa AI Chatissa**:
   - Avaa VS Code AI Chat
   - Kirjoita `#zava` ja valitse palvelimesi
   - Kysy: "Mitkä taulut ovat saatavilla?"
   - Kysy: "Näytä 5 parasta myymälää tilausten määrän mukaan"

### Yksikkötestaus

Luo kattavat yksikkötestit:
...
✅ **Toimiva MCP-palvelin**: FastMCP-palvelin tietokantaintegraatiolla  
✅ **Konfiguraation hallinta**: Vankka ympäristöön perustuva konfiguraatio  
✅ **Tietokantakerros**: PostgreSQL-integraatio yhteyspoolauksella  
✅ **MCP-työkalut**: Skeeman tarkastelu- ja kyselytyökalut  
✅ **RLS-integraatio**: Rivitason turvallisuuden kontekstinhallinta  
✅ **Terveysseuranta**: Kattavat terveysseuranta-endpointit  
✅ **Testausstrategia**: Paikallinen testaus ja VS Code -integraatio  

## 🚀 Mitä seuraavaksi

Jatka **[Labra 06: Työkalujen kehitys](../06-Tools/README.md)** -osioon:

- Laajenna MCP-työkalukokoelmaasi
- Toteuta edistyneitä kyselymalleja
- Lisää datan validointi ja muunnos
- Luo erikoistuneita analytiikkatyökaluja

## 📚 Lisäresurssit

### FastMCP-kehys
- [FastMCP-dokumentaatio](https://github.com/modelcontextprotocol/python-sdk) - Virallinen FastMCP-opas
- [MCP-määrittely](https://modelcontextprotocol.io/docs/) - Protokollan määrittely
- [Työkalujen kehitysopas](https://modelcontextprotocol.io/docs/tools/) - MCP-työkalujen luominen

### Tietokantaintegraatio
- [asyncpg-dokumentaatio](https://magicstack.github.io/asyncpg/current/) - PostgreSQL:n async-ajuri
- [Yhteyspoolauksen parhaat käytännöt](https://www.postgresql.org/docs/current/runtime-config-connection.html) - PostgreSQL-viritys
- [Rivitason turvallisuusopas](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - RLS-toteutus

### FastAPI-mallit
- [FastAPI-dokumentaatio](https://fastapi.tiangolo.com/) - Web-kehyksen viite
- [Riippuvuuksien injektio](https://fastapi.tiangolo.com/tutorial/dependencies/) - FastAPI-mallit
- [Taustatehtävät](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Asynkronisten tehtävien hallinta

---

**Seuraavaksi**: Valmis laajentamaan työkaluja? Jatka [Labra 06: Työkalujen kehitys](../06-Tools/README.md) -osioon.
