...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:15:38+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "fi"
}
-->
# Tietoturva ja monikäyttäjäympäristöt

## 🎯 Mitä tämä labra kattaa

Tämä labra tarjoaa kattavat ohjeet yritystason tietoturvan ja monikäyttäjäympäristöjen toteuttamiseen MCP-palvelimille. Opit suunnittelemaan turvallisia ja vaatimustenmukaisia järjestelmiä, jotka suojaavat arkaluontoisia vähittäiskaupan tietoja ja mahdollistavat joustavat käyttömallit eri käyttäjäryhmille.

## Yleiskatsaus

Tietoturva on ensisijaisen tärkeää vähittäiskaupan sovelluksissa, jotka käsittelevät asiakastietoja, maksutietoja ja liiketoimintatiedustelua. Tämä labra kattaa koko tietoturva-arkkitehtuurin autentikoinnista ja valtuutuksesta datan eristämiseen ja vaatimustenmukaisuuden seurantaan.

Toteutamme syvyyssuuntaisen puolustusstrategian, joka yhdistää Azuren identiteettipalvelut, PostgreSQL:n rivitason tietoturvan, sovellustason kontrollit ja kattavan auditointilokin luodaksemme vahvan ja vaatimustenmukaisen alustan.

## Oppimistavoitteet

Labran lopussa osaat:

- **Toteuttaa** yritystason rivitason tietoturvan monikäyttäjäympäristöjen datan eristämiseksi
- **Suunnitella** turvalliset autentikointi- ja valtuutusmallit Azuren avulla
- **Konfiguroida** kattavat auditointilokit vaatimustenmukaisuusvaatimuksia varten
- **Soveltaa** syvyyssuuntaisia tietoturvastrategioita kaikilla sovellustasoilla
- **Vahvistaa** tietoturvatoteutuksia järjestelmällisen testauksen avulla
- **Seurata** tietoturvatapahtumia ja reagoida mahdollisiin uhkiin

## 🔐 Monikäyttäjäympäristön tietoturva-arkkitehtuuri

### Tietoturvakerrosten yleiskatsaus
...
### Monikäyttäjäympäristömallit

Toteutuksessamme käytetään **Jaettu tietokanta, jaettu skeema** -mallia rivitason tietoturvalla:

**Edut:**
- Kustannustehokas resurssien käyttö
- Yksinkertaistettu ylläpito ja päivitykset
- Vahva datan eristäminen RLS:n avulla
- Vaatimustenmukaisuutta tukevat auditointilokit

**Kompromissit:**
- Vaatii huolellista RLS-politiikan suunnittelua
- Skeemamuutokset vaikuttavat kaikkiin käyttäjiin
- Tarvitsee vahvat varmuuskopiointi- ja palautusmenettelyt

## 🛡️ Rivitason tietoturvan toteutus
...
## 🧪 Tietoturvan testaus ja validointi
...
### Haavoittuvuustestauksen tarkistuslista
...
✅ **Monikäyttäjäympäristön tietoturva**: Toteutettu rivitason tietoturva täydellistä datan eristämistä varten  
✅ **Azure-autentikointi**: Integroitu Azure Entra ID JWT-validoinnilla  
✅ **Roolipohjainen valtuutus**: Konfiguroitu hierarkkinen rooli- ja käyttöoikeusjärjestelmä  
✅ **Kattava auditointilokitus**: Luotu tietoturvatapahtumien seuranta ja valvonta  
✅ **Tietoturvatestaus**: Toteutettu automatisoidut tietoturvan validointitestit  
✅ **Uhkien seuranta**: Luotu reaaliaikainen tietoturvatapahtumien havaitseminen ja hälytys  

## 🚀 Mitä seuraavaksi

Jatka **[Labra 03: Ympäristön asennus](../03-Setup/README.md)** -osioon:

- Konfiguroi kehitysympäristöt tietoturvan parhaiden käytäntöjen mukaisesti
- Aseta Azure-palvelut autentikointia ja seurantaa varten
- Toteuta turvalliset tietokantayhteydet ja salaisuuksien hallinta
- Vahvista tietoturvakonfiguraatiot kehitysympäristöissä

## 📚 Lisäresurssit

### Azuren tietoturva
- [Azure Entra ID -dokumentaatio](https://docs.microsoft.com/azure/active-directory/) - Kattava opas identiteettialustaan
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Salaisuuksien hallintapalvelu
- [Azuren tietoturvan parhaat käytännöt](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Tietoturvaohjeet

### Tietokannan tietoturva
- [PostgreSQL:n rivitason tietoturva](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Virallinen RLS-dokumentaatio
- [Tietokannan tietoturvan tarkistuslista](https://www.postgresql.org/docs/current/security.html) - PostgreSQL:n tietoturvaopas
- [Monikäyttäjäympäristön tietokantamallit](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Arkkitehtuurimallit

### Tietoturvatestaus
- [OWASP Testing Guide](https://owasp.org/www-project-web-security-testing-guide/) - Kattava tietoturvatestausopas
- [JWT:n tietoturvan parhaat käytännöt](https://tools.ietf.org/html/rfc8725) - JWT:n tietoturvaohjeet
- [API:n tietoturvatestaus](https://owasp.org/www-project-api-security/) - API-spesifinen tietoturvatestaus

---

**Edellinen**: [Labra 01: Keskeiset arkkitehtuurikonseptit](../01-Architecture/README.md)  
**Seuraava**: [Labra 03: Ympäristön asennus](../03-Setup/README.md)
