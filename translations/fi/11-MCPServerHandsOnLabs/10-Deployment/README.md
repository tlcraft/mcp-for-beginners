...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:29:01+00:00",
...
Tämä labra tarjoaa kattavat ohjeet MCP-järjestelmän vähittäismyyntipalvelimen käyttöönottoon tuotantoympäristöissä modernien konttiteknologioiden ja pilvinatiivien menetelmien avulla. Opit ottamaan käyttöön skaalautuvia, turvallisia ja valvottuja MCP-palvelimia, jotka kestävät yritystason kuormituksia.

## Yleiskatsaus

MCP-palvelimien tuotantokäyttöönotto vaatii huolellista suunnittelua konttiteknologian, orkestroinnin, turvallisuuden, skaalautuvuuden ja valvonnan osalta. Tämä labra kattaa käyttöönoton Azure Container Apps -palveluun PostgreSQL Flexible Serverin kanssa, CI/CD-putkien toteutuksen ja automaattisen skaalauksen konfiguroinnin vaihteleville kuormituksille.

Käyttöönoton strategiat vaihtelevat yksinkertaisista yhden kontin kehitysympäristöistä monimutkaisiin monialueisiin, automaattisesti skaalautuviin tuotantoympäristöihin, joissa on kattavat valvonta- ja turvallisuusominaisuudet.

## Oppimistavoitteet

Labran lopussa osaat:

- **Kontittaa** MCP-palvelimet Dockerin avulla käyttäen monivaiheisia rakennuksia
- **Ottaa käyttöön** Azure Container Apps -palvelussa turvallisella verkottamisella
- **Konfiguroida** tuotantotason PostgreSQL:n korkean käytettävyyden kanssa
- **Toteuttaa** CI/CD-putket automatisoitua käyttöönottoa varten
- **Skaalata** sovelluksia automaattisesti kysynnän mukaan
- **Valvoa** tuotantokäyttöönottoja kattavalla näkyvyydellä

## 🐳 Docker-kontittaminen

### Monivaiheinen Dockerfile
...
### Docker Compose kehityskäyttöön
...
## ☁️ Azure Container Apps -käyttöönotto
...
### Automaatioskaalauksen konfigurointi
...
## 🔐 Tuotantotason turvallisuuskonfigurointi
...
✅ **Konttistrategia**: Tuotantovalmiit Docker-kontit turvallisuusvahvistuksella  
✅ **Pilvikäyttöönotto**: Azure Container Apps automaattisella skaalauksella ja valvonnalla  
✅ **Tietokantakäyttöönotto**: PostgreSQL Flexible Server korkean käytettävyyden kanssa  
✅ **CI/CD-putket**: Automatisoidut testaus-, rakennus- ja käyttöönotto-työnkulut  
✅ **Suorituskyvyn valvonta**: Kattava metrikkojen keräys ja hälytykset  
✅ **Turvallisuuskonfigurointi**: Tuotantotason turvallisuuspolitiikat ja verkkoeristys  

## 🚀 Mitä seuraavaksi

Jatka **[Labra 11: Valvonta ja näkyvyys](../11-Monitoring/README.md)** -osioon:

- Ota käyttöön kattava valvonta Application Insightsin avulla
- Konfiguroi jäsennelty lokitus ja hajautettu jäljitys
- Toteuta hälytykset ja automatisoidut vastejärjestelmät
- Valvo liiketoimintametrikoita ja suorituskykyindikaattoreita

## 📚 Lisäresurssit

### Konttiteknologiat
- [Dockerin parhaat käytännöt](https://docs.docker.com/develop/dev-best-practices/) - Dockerin viralliset parhaat käytännöt
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Azure Container Apps -dokumentaatio
- [Kubernetes-dokumentaatio](https://kubernetes.io/docs/) - Kubernetesin virallinen dokumentaatio

### CI/CD ja DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - GitHub Actions -dokumentaatio
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Azure DevOps -palvelut
- [Infrastruktuuri koodina](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Azure Bicep -dokumentaatio

### Turvallisuus ja valvonta
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Azure-turvallisuussuositukset
- [Konttiturvallisuus](https://kubernetes.io/docs/concepts/security/) - Kubernetesin turvallisuuskäsitteet
...
**Edellinen**: [Labra 09: VS Code -integraatio](../09-VS-Code/README.md)  
**Seuraava**: [Labra 11: Valvonta ja näkyvyys](../11-Monitoring/README.md)
