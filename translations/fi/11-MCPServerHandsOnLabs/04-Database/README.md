...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:31:03+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "fi"
}
-->
# Tietokannan suunnittelu ja skeema

## 🎯 Mitä tämä labra kattaa

Tässä labrassa perehdytään syvällisesti Zava Retail -järjestelmän PostgreSQL-tietokannan suunnitteluun. Opit toteuttamaan kattavan vähittäiskaupan skeeman, jossa on vektorihaun ominaisuudet, monivuokraajamallin tietorakenteet ja rivitason tietoturva (RLS) datan eristämiseksi.

## Yleiskatsaus

Tietokanta on MCP-palvelimen perusta, joka tallentaa vähittäiskaupan dataa useiden myymälöiden välillä samalla säilyttäen tiukan datan eristyksen. Käytämme PostgreSQL:ää ja pgvector-laajennusta mahdollistamaan semanttisen haun, jonka avulla asiakkaat voivat löytää tuotteita luonnollisen kielen kyselyillä.

Skeemamme noudattaa moderneja monivuokraajamalleja, joissa rivitason tietoturva varmistaa, että käyttäjät voivat käyttää vain valtuutettujen myymälöidensä dataa. Tämä lähestymistapa tarjoaa yritystason tietoturvaa samalla säilyttäen optimaalisen suorituskyvyn.

## Oppimistavoitteet

Labran lopussa osaat:

- **Suunnitella** skaalautuvia monivuokraajamallin vähittäiskaupan tietokantaskeemoja
- **Toteuttaa** PostgreSQL:n pgvector-laajennuksen vektorihaulle
- **Konfiguroida** rivitason tietoturvan datan eristämiseksi
- **Luoda** realistista testidataa
- **Optimoida** tietokannan suorituskykyä vähittäiskaupan tarpeisiin
- **Toteuttaa** varmuuskopiointi- ja palautusstrategioita

## 🗃️ Tietokannan arkkitehtuuri

### PostgreSQL ja pgvector

Tietokantamme hyödyntää PostgreSQL:n yritysominaisuuksia yhdistettynä pgvector-laajennukseen AI-pohjaista hakua varten:
...
Tietokanta käyttää **jaettua tietokantaa, jaettua skeemaa** -monivuokraajamallia rivitason tietoturvalla:
...
## 📊 Keskeinen skeemasuunnittelu

### Myymälät-taulu (vuokraajamasteri)
...
## 🔍 Vektorihaun toteutus

### Tuote-embeddausten taulu
...
## 🔐 Rivitason tietoturvan asettaminen

### Tietokantaroolit ja käyttöoikeudet
...
Labran suorittamisen jälkeen sinulla on:

✅ **Monivuokraajamallin tietokantasuunnittelu**: Toteutettu rivitason tietoturva datan eristämiseksi  
✅ **Vektorihaun ominaisuudet**: Konfiguroitu pgvector semanttista tuotehakua varten  
✅ **Kattava skeema**: Luotu tuotantovalmiin vähittäiskaupan tietokantaskeema  
✅ **Testidatan generointi**: Rakennettu realistista testidataa kehitystä ja testausta varten  
✅ **Suorituskyvyn optimointi**: Konfiguroitu indeksit ja kyselyoptimointi  
✅ **Varmuuskopiointi ja palautus**: Luotu vahvat datan suojausstrategiat  

## 🚀 Mitä seuraavaksi

Jatka **[Labra 05: MCP-palvelimen toteutus](../05-MCP-Server/README.md)** -osioon:

- Rakenna FastMCP-palvelin, joka yhdistyy tähän tietokantaan
- Toteuta tietokantakyselytyökalut MCP-protokollaa varten
- Lisää semanttisen haun ominaisuudet embeddausten avulla
- Konfiguroi yhteyspoolaus ja virheenkäsittely

## 📚 Lisäresurssit

### PostgreSQL & pgvector
- [PostgreSQL-dokumentaatio](https://www.postgresql.org/docs/) - Täydellinen PostgreSQL-viite
- [pgvector-laajennus](https://github.com/pgvector/pgvector) - Vektorien samankaltaisuushaku PostgreSQL:lle
- [PostgreSQL:n suorituskyvyn optimointi](https://wiki.postgresql.org/wiki/Performance_Optimization) - Parhaat käytännöt optimointiin

### Monivuokraajamalli
- [Rivitason tietoturva](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS -dokumentaatio
- [Monivuokraajamallin tietorakenne](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure-arkkitehtuurimallit
- [Tietokannan tietoturvan parhaat käytännöt](https://www.postgresql.org/docs/current/security.html) - PostgreSQL:n tietoturvaopas

### Vektoripohjaiset tietokannat
- [Vektorihaun perusteet](https://www.pinecone.io/learn/vector-database/) - Ymmärrä vektoripohjaiset tietokannat
- [Embeddausmallit](https://platform.openai.com/docs/guides/embeddings) - OpenAI:n embeddausdokumentaatio
- [HNSW-algoritmi](https://arxiv.org/abs/1603.09320) - Hierarkkiset navigoitavat pienet maailmaverkot

---

**Edellinen**: [Labra 03: Ympäristön asennus](../03-Setup/README.md)  
**Seuraava**: [Labra 05: MCP-palvelimen toteutus](../05-MCP-Server/README.md)
