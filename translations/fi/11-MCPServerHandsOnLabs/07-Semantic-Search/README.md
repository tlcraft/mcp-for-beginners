...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:33:09+00:00",
...
Tämä labra tarjoaa kattavat ohjeet semanttisen haun toteuttamiseen Azure OpenAI -upotusten ja PostgreSQL:n pgvector-laajennuksen avulla. Opit rakentamaan tekoälypohjaisen tuotehaun, joka ymmärtää luonnollisen kielen kyselyt ja tuottaa relevantteja tuloksia semanttisen samankaltaisuuden perusteella.

## Yleiskatsaus

Perinteinen avainsanapohjainen haku ei usein pysty ymmärtämään käyttäjän tarkoitusta ja semanttista merkitystä. Semanttinen haku, joka hyödyntää vektoriupotuksia, mahdollistaa luonnollisen kielen kyselyt, kuten "mukavat juoksukengät sateiseen säähän", löytämään relevantteja tuotteita, vaikka kyseiset sanat eivät esiintyisi tuotekuvauksissa.

Toteutuksemme yhdistää Azure OpenAI:n tehokkaat upotusmallit PostgreSQL:n pgvector-laajennukseen luoden suorituskykyisen ja skaalautuvan semanttisen hakujärjestelmän, joka parantaa vähittäiskaupan kokemusta älykkäällä tuotehaulla.

## Oppimistavoitteet

Labran lopussa osaat:

- **Integroida** Azure OpenAI -upotusmallit tekstin vektorointiin
- **Toteuttaa** pgvectorin tehokkaisiin samankaltaisuushakuihin
- **Rakentaa** semanttisia hakutyökaluja luonnollisen kielen tuotekyselyihin
- **Luoda** hybridihaku, joka yhdistää perinteisen ja vektoripohjaisen haun
- **Optimoida** vektorikyselyt tuotantokäyttöön
- **Suunnitella** suositusjärjestelmiä upotusten samankaltaisuuden avulla

## 🧠 Semanttisen haun arkkitehtuuri
...
## 🔍 Tuoteupotusten luominen

### Automatisoitu upotusprosessi
...
## 🔎 Semanttiset hakutyökalut

### Semanttinen tuotehakutyökalu
...
✅ **Azure OpenAI -integraatio**: Täydellinen upotusten luonti välimuistilla ja optimoinnilla  
✅ **Vektorihakutoteutus**: Tuotantovalmiit semanttiset haut pgvectorilla  
✅ **Hybridihakukyvyt**: Avainsana- ja semanttisen haun yhdistelmä optimaalisiin tuloksiin  
✅ **Suositusjärjestelmät**: Tekoälypohjaiset tuotesuositukset samankaltaisuuden avulla  
✅ **Suorituskyvyn optimointi**: Vektorihakemiston optimointi ja älykäs välimuisti  
✅ **Skaalautuva arkkitehtuuri**: Yrityskäyttöön valmis semanttinen hakujärjestelmä  

## 🚀 Mitä seuraavaksi

Jatka **[Labra 08: Testaus ja virheenkorjaus](../08-Testing/README.md)** -osioon:

- Toteuta kattavat testausstrategiat semanttiselle haulle
- Korjaa vektorihakujen suorituskykyongelmia
- Vahvista upotusten laatu ja relevanssi
- Testaa suositusjärjestelmän tarkkuus

## 📚 Lisäresurssit

### Azure OpenAI
- [Azure OpenAI Service Documentation](https://docs.microsoft.com/azure/cognitive-services/openai/) - Palvelun kattava opas
- [Embeddings API Reference](https://platform.openai.com/docs/api-reference/embeddings) - API-dokumentaatio
- [Best Practices for Embeddings](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Toteutusohjeet

### Vektoripohjaiset tietokannat
- [pgvector Documentation](https://github.com/pgvector/pgvector) - PostgreSQL:n vektorilaajennus
- [Vector Search Optimization](https://www.pinecone.io/learn/vector-search-optimization/) - Suorituskyvyn hienosäätö
- [HNSW Algorithm](https://arxiv.org/abs/1603.09320) - Hierarkkiset navigoitavat pienet maailmaverkot

### Semanttinen haku
- [Information Retrieval Fundamentals](https://nlp.stanford.edu/IR-book/) - Stanfordin IR-oppikirja
- [Vector Search Best Practices](https://weaviate.io/blog/vector-search-best-practices) - Toteutusmallit
- [Hybrid Search Strategies](https://blog.vespa.ai/hybrid-search/) - Erilaisten hakutapojen yhdistäminen

---

**Edellinen**: [Labra 06: Työkalujen kehitys](../06-Tools/README.md)  
**Seuraava**: [Labra 08: Testaus ja virheenkorjaus](../08-Testing/README.md)
