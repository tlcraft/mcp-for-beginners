...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:04:59+00:00",
...
ห้องปฏิบัติการนี้ให้คำแนะนำอย่างละเอียดเกี่ยวกับการทดสอบและการดีบักเซิร์ฟเวอร์ MCP ในสภาพแวดล้อมการใช้งานจริง คุณจะได้เรียนรู้วิธีการสร้างกลยุทธ์การทดสอบที่แข็งแกร่ง ดีบักปัญหาที่ซับซ้อน และทำให้เซิร์ฟเวอร์ MCP ของคุณทำงานได้อย่างน่าเชื่อถือภายใต้เงื่อนไขต่างๆ

## ภาพรวม

การทดสอบเซิร์ฟเวอร์ MCP ต้องใช้วิธีการหลายชั้นที่ครอบคลุมการทดสอบหน่วย การทดสอบการรวม การตรวจสอบประสิทธิภาพ และการทดสอบสถานการณ์จริง ห้องปฏิบัติการนี้ครอบคลุมวงจรการทดสอบทั้งหมดตั้งแต่การพัฒนาไปจนถึงการตรวจสอบในสภาพแวดล้อมการใช้งานจริง

กลยุทธ์การทดสอบของเรามุ่งเน้นไปที่ความน่าเชื่อถือ ความปลอดภัย และประสิทธิภาพ เพื่อให้มั่นใจว่าเซิร์ฟเวอร์ MCP ของคุณสามารถรองรับการทำงานในสภาพแวดล้อมการใช้งานจริงได้โดยยังคงรักษาความสมบูรณ์ของข้อมูลและคุณภาพประสบการณ์ของผู้ใช้

## วัตถุประสงค์การเรียนรู้

เมื่อจบห้องปฏิบัติการนี้ คุณจะสามารถ:

- **สร้าง** ชุดการทดสอบหน่วยและการทดสอบการรวมที่ครอบคลุม  
- **ออกแบบ** กลยุทธ์การทดสอบที่มีประสิทธิภาพสำหรับเครื่องมือ MCP และการดำเนินการฐานข้อมูล  
- **ดีบัก** ปัญหาที่ซับซ้อนโดยใช้เทคนิคการดีบักขั้นสูง  
- **ตรวจสอบ** ประสิทธิภาพภายใต้โหลดด้วยสถานการณ์การทดสอบที่สมจริง  
- **ตรวจสอบ** ระบบในสภาพแวดล้อมการใช้งานจริงด้วยการแจ้งเตือนและการสังเกตการณ์ที่มีประสิทธิภาพ  
- **ทำให้เป็นอัตโนมัติ** เวิร์กโฟลว์การทดสอบสำหรับการรวมอย่างต่อเนื่อง  

## 🧪 สถาปัตยกรรมการทดสอบ

### ภาพรวมกลยุทธ์การทดสอบ
...
✅ **กรอบการทดสอบที่ครอบคลุม**: การทดสอบหน่วย การทดสอบการรวม และการทดสอบประสิทธิภาพสำหรับทุกองค์ประกอบ  
✅ **เครื่องมือดีบักขั้นสูง**: เครื่องมือดีบักที่ซับซ้อนพร้อมการติดตามการดำเนินการ  
✅ **การตรวจสอบประสิทธิภาพ**: ความสามารถในการทดสอบโหลดและการวิเคราะห์ความสามารถในการขยายตัว  
✅ **การทดสอบความปลอดภัย**: การป้องกัน SQL injection และการตรวจสอบ RLS  
✅ **การรวมการตรวจสอบ**: เมตริกประสิทธิภาพและการวิเคราะห์คอขวด  
✅ **พร้อมสำหรับ CI/CD**: เวิร์กโฟลว์การทดสอบอัตโนมัติสำหรับการรวมอย่างต่อเนื่อง  

## 🚀 สิ่งที่ต้องทำต่อไป

ดำเนินการต่อกับ **[Lab 09: การรวม VS Code](../09-VS-Code/README.md)** เพื่อ:

- ตั้งค่า VS Code สำหรับการพัฒนาเซิร์ฟเวอร์ MCP  
- ตั้งค่าสภาพแวดล้อมการดีบักใน VS Code  
- รวมเซิร์ฟเวอร์ MCP กับ VS Code Chat  
- ทดสอบเวิร์กโฟลว์ VS Code แบบครบวงจร  

## 📚 แหล่งข้อมูลเพิ่มเติม

### เฟรมเวิร์กการทดสอบ
- [pytest Documentation](https://docs.pytest.org/) - เฟรมเวิร์กการทดสอบ Python  
- [AsyncPG Testing](https://magicstack.github.io/asyncpg/current/index.html) - การทดสอบ PostgreSQL แบบ Async  
- [FastAPI Testing](https://fastapi.tiangolo.com/tutorial/testing/) - รูปแบบการทดสอบ API  

### การทดสอบประสิทธิภาพ
- [Load Testing Best Practices](https://docs.python.org/3/library/asyncio.html) - การทดสอบประสิทธิภาพแบบ Async  
- [Database Performance Testing](https://www.postgresql.org/docs/current/performance-tips.html) - การปรับแต่ง PostgreSQL  
- [Memory Profiling](https://docs.python.org/3/library/tracemalloc.html) - การวิเคราะห์หน่วยความจำ Python  

### เครื่องมือดีบัก
- [Python Debugging](https://docs.python.org/3/library/pdb.html) - ดีบักเกอร์ Python  
- [Async Debugging](https://docs.python.org/3/library/asyncio-dev.html) - การดีบัก Asyncio  
- [SQL Debugging](https://www.postgresql.org/docs/current/runtime-config-logging.html) - การบันทึก PostgreSQL  

---

**ก่อนหน้า**: [Lab 07: การรวม Semantic Search](../07-Semantic-Search/README.md)  
**ถัดไป**: [Lab 09: การรวม VS Code](../09-VS-Code/README.md)  
