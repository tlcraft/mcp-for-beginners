...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:18:06+00:00",
...
## 🎯 สิ่งที่คุณจะได้เรียนรู้ในแลปนี้

แลปนี้ให้คำแนะนำที่ครอบคลุมสำหรับการตั้งค่าการตรวจสอบ การสังเกตการณ์ และการแจ้งเตือนสำหรับเซิร์ฟเวอร์ MCP ในสภาพแวดล้อมการใช้งานจริง คุณจะได้เรียนรู้วิธีตั้งค่า Application Insights สร้างแดชบอร์ดที่มีความหมาย ตั้งค่าการแจ้งเตือนที่มีประสิทธิภาพ และสร้างกระบวนการแก้ไขปัญหาเพื่อความเป็นเลิศในการดำเนินงาน

## ภาพรวม

การตรวจสอบและการสังเกตการณ์ที่มีประสิทธิภาพเป็นสิ่งสำคัญสำหรับการรักษาความน่าเชื่อถือของเซิร์ฟเวอร์ MCP ในการใช้งานจริง แลปนี้ครอบคลุมสามเสาหลักของการสังเกตการณ์—เมตริก, ล็อก, และเทรซ—และแสดงวิธีการตั้งค่าการตรวจสอบที่ครอบคลุมซึ่งช่วยให้คุณสามารถตรวจจับปัญหาได้อย่างเชิงรุกและแก้ไขปัญหาได้อย่างรวดเร็ว

คุณจะได้เรียนรู้วิธีเปลี่ยนข้อมูลเทเลเมตรีดิบให้เป็นข้อมูลเชิงลึกที่นำไปใช้ได้จริง ซึ่งช่วยให้คุณเข้าใจพฤติกรรมของระบบ ปรับปรุงประสิทธิภาพ และรักษาความพร้อมใช้งานสูง

## วัตถุประสงค์การเรียนรู้

เมื่อจบแลปนี้ คุณจะสามารถ:

- **ตั้งค่า** การผสานรวม Application Insights อย่างครอบคลุมสำหรับเซิร์ฟเวอร์ MCP  
- **ออกแบบ** รูปแบบการล็อกที่มีโครงสร้างเพื่อการแก้ไขปัญหาที่มีประสิทธิภาพ  
- **สร้าง** ระบบการรวบรวมและวิเคราะห์เมตริกประสิทธิภาพ  
- **กำหนดค่า** การแจ้งเตือนอัจฉริยะพร้อมการแจ้งเตือนที่นำไปใช้ได้จริง  
- **สร้าง** แดชบอร์ดการดำเนินงานสำหรับการตรวจสอบแบบเรียลไทม์  
- **จัดตั้ง** กระบวนการแก้ไขปัญหาและคู่มือการดำเนินงานที่มีประสิทธิภาพ  
...
### การล็อกที่ปรับปรุงด้วยข้อมูลที่มีโครงสร้าง
...
หลังจากจบแลปนี้ คุณควรมี:

✅ **การผสานรวม Application Insights**: การตั้งค่าการตรวจสอบและเทเลเมตรีที่สมบูรณ์  
✅ **การล็อกที่มีโครงสร้าง**: การล็อกที่พร้อมใช้งานในสภาพแวดล้อมจริงพร้อมการเชื่อมโยงและบริบท  
✅ **เมตริกแบบกำหนดเอง**: การรวบรวมและวิเคราะห์เมตริกทางธุรกิจและเทคนิค  
✅ **การแจ้งเตือนอัจฉริยะ**: การแจ้งเตือนเชิงรุกพร้อมช่องทางการแจ้งเตือนหลายช่องทาง  
✅ **แดชบอร์ดการดำเนินงาน**: การตรวจสอบแบบเรียลไทม์และข้อมูลเชิงลึกทางธุรกิจ  
✅ **กระบวนการแก้ไขปัญหา**: การวินิจฉัยอัตโนมัติและคู่มือการดำเนินงาน  

## 🚀 สิ่งที่ควรทำต่อไป

ดำเนินการต่อกับ **[แลป 12: แนวปฏิบัติที่ดีที่สุดและการปรับปรุง](../12-Best-Practices/README.md)** เพื่อ:

- ใช้เทคนิคการปรับปรุงประสิทธิภาพ  
- ตั้งค่าการรักษาความปลอดภัยที่ครอบคลุม  
- เรียนรู้แนวปฏิบัติที่ดีที่สุดสำหรับการใช้งานจริง  
- จัดตั้งกลยุทธ์การเพิ่มประสิทธิภาพต้นทุน  

## 📚 แหล่งข้อมูลเพิ่มเติม

### Azure Monitor
- [เอกสาร Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - คู่มือการตรวจสอบที่สมบูรณ์  
- [อ้างอิงคำสั่ง KQL](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - ภาษา Query สำหรับ Application Insights  
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - การสร้างแดชบอร์ดแบบกำหนดเอง  

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - คู่มือการติดตั้ง  
- [Distributed Tracing](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - แนวคิดเกี่ยวกับการติดตาม  
- [Metrics Collection](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - แนวปฏิบัติที่ดีที่สุดสำหรับเมตริก  

### ความเป็นเลิศในการดำเนินงาน
- [SRE Handbook](https://sre.google/sre-book/table-of-contents/) - หลักการ Site Reliability Engineering  
- [แนวปฏิบัติที่ดีที่สุดสำหรับการตรวจสอบ](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - แนวปฏิบัติที่ดีที่สุดในอุตสาหกรรม  
- [การตอบสนองต่อเหตุการณ์](https://response.pagerduty.com/) - คู่มือการจัดการเหตุการณ์  

---

**ก่อนหน้า**: [แลป 10: กลยุทธ์การใช้งาน](../10-Deployment/README.md)  
**ถัดไป**: [แลป 12: แนวปฏิบัติที่ดีที่สุดและการปรับปรุง](../12-Best-Practices/README.md)  
