...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:31:45+00:00",
  "source_file": "11-MCPServerHandsOnLabs/07-Semantic-Search/README.md",
  "language_code": "th"
}
-->
# การผสานการค้นหาแบบ Semantic

## 🎯 สิ่งที่คุณจะได้เรียนรู้ในห้องปฏิบัติการนี้

ห้องปฏิบัติการนี้ให้คำแนะนำอย่างละเอียดเกี่ยวกับการนำความสามารถในการค้นหาแบบ Semantic มาใช้ โดยใช้ Azure OpenAI embeddings และส่วนขยาย pgvector ของ PostgreSQL คุณจะได้เรียนรู้วิธีสร้างระบบค้นหาสินค้าที่ขับเคลื่อนด้วย AI ซึ่งเข้าใจคำถามในภาษาธรรมชาติและนำเสนอผลลัพธ์ที่เกี่ยวข้องตามความคล้ายคลึงเชิงความหมาย

## ภาพรวม

การค้นหาแบบดั้งเดิมที่อิงตามคำสำคัญมักไม่สามารถจับความตั้งใจของผู้ใช้และความหมายเชิงความหมายได้ การค้นหาแบบ Semantic โดยใช้ vector embeddings ช่วยให้สามารถค้นหาสินค้าได้จากคำถามในภาษาธรรมชาติ เช่น "รองเท้าวิ่งที่ใส่สบายสำหรับสภาพอากาศฝนตก" แม้ว่าคำเหล่านั้นจะไม่ได้ปรากฏในคำอธิบายสินค้าโดยตรง

การนำไปใช้ของเราผสมผสานโมเดล embedding ที่ทรงพลังของ Azure OpenAI เข้ากับส่วนขยาย pgvector ของ PostgreSQL เพื่อสร้างระบบค้นหาแบบ Semantic ที่มีประสิทธิภาพสูงและสามารถปรับขนาดได้ ซึ่งช่วยยกระดับประสบการณ์การค้าปลีกด้วยการค้นหาสินค้าอย่างชาญฉลาด

## วัตถุประสงค์การเรียนรู้

เมื่อจบห้องปฏิบัติการนี้ คุณจะสามารถ:

- **ผสาน** โมเดล embedding ของ Azure OpenAI เพื่อการแปลงข้อความเป็นเวกเตอร์  
- **นำไปใช้** pgvector สำหรับการค้นหาความคล้ายคลึงอย่างมีประสิทธิภาพ  
- **สร้าง** เครื่องมือค้นหาแบบ Semantic สำหรับคำถามเกี่ยวกับสินค้าในภาษาธรรมชาติ  
- **ออกแบบ** การค้นหาแบบผสมผสานระหว่างการค้นหาแบบดั้งเดิมและแบบเวกเตอร์  
- **ปรับปรุง** การค้นหาเวกเตอร์เพื่อประสิทธิภาพในระดับการผลิต  
- **พัฒนา** ระบบแนะนำสินค้าด้วยความคล้ายคลึงของ embedding  

## 🧠 สถาปัตยกรรมการค้นหาแบบ Semantic

### กระบวนการค้นหาเวกเตอร์
...
## 🔍 การสร้าง Embedding สำหรับสินค้า

### กระบวนการสร้าง Embedding อัตโนมัติ
...
## 🔎 เครื่องมือค้นหาแบบ Semantic

### เครื่องมือค้นหาสินค้าแบบ Semantic
...
✅ **การผสาน Azure OpenAI**: การสร้าง embedding ที่สมบูรณ์พร้อมการแคชและการปรับปรุง  
✅ **การนำไปใช้การค้นหาเวกเตอร์**: ระบบค้นหาแบบ Semantic ที่พร้อมใช้งานในระดับการผลิตด้วย pgvector  
✅ **ความสามารถในการค้นหาแบบผสมผสาน**: การค้นหาแบบคำสำคัญและแบบ Semantic เพื่อผลลัพธ์ที่ดีที่สุด  
✅ **ระบบแนะนำสินค้า**: การแนะนำสินค้าที่ขับเคลื่อนด้วย AI โดยใช้ความคล้ายคลึงของ embedding  
✅ **การปรับปรุงประสิทธิภาพ**: การปรับปรุงดัชนีเวกเตอร์และการแคชอย่างชาญฉลาด  
✅ **สถาปัตยกรรมที่ปรับขนาดได้**: โครงสร้างพื้นฐานการค้นหาแบบ Semantic ที่พร้อมใช้งานในระดับองค์กร  

## 🚀 สิ่งที่ต้องทำต่อไป

ดำเนินการต่อกับ **[Lab 08: การทดสอบและการแก้ไขข้อผิดพลาด](../08-Testing/README.md)** เพื่อ:

- นำกลยุทธ์การทดสอบที่ครอบคลุมมาใช้สำหรับการค้นหาแบบ Semantic  
- แก้ไขปัญหาประสิทธิภาพการค้นหาเวกเตอร์  
- ตรวจสอบคุณภาพและความเกี่ยวข้องของ embedding  
- ทดสอบความแม่นยำของระบบแนะนำสินค้า  

## 📚 แหล่งข้อมูลเพิ่มเติม

### Azure OpenAI
- [เอกสาร Azure OpenAI Service](https://docs.microsoft.com/azure/cognitive-services/openai/) - คู่มือบริการแบบสมบูรณ์  
- [Embeddings API Reference](https://platform.openai.com/docs/api-reference/embeddings) - เอกสาร API  
- [แนวทางปฏิบัติที่ดีที่สุดสำหรับ Embeddings](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - คำแนะนำการนำไปใช้  

### ฐานข้อมูลเวกเตอร์
- [เอกสาร pgvector](https://github.com/pgvector/pgvector) - ส่วนขยายเวกเตอร์ของ PostgreSQL  
- [การปรับปรุงการค้นหาเวกเตอร์](https://www.pinecone.io/learn/vector-search-optimization/) - การปรับแต่งประสิทธิภาพ  
- [อัลกอริทึม HNSW](https://arxiv.org/abs/1603.09320) - กราฟโลกขนาดเล็กที่สามารถนำทางได้แบบลำดับชั้น  

### การค้นหาแบบ Semantic
- [พื้นฐานการดึงข้อมูล](https://nlp.stanford.edu/IR-book/) - หนังสือเรียน IR ของ Stanford  
- [แนวทางปฏิบัติที่ดีที่สุดสำหรับการค้นหาเวกเตอร์](https://weaviate.io/blog/vector-search-best-practices) - รูปแบบการนำไปใช้  
- [กลยุทธ์การค้นหาแบบผสมผสาน](https://blog.vespa.ai/hybrid-search/) - การผสมผสานวิธีการค้นหาต่าง ๆ  

---

**ก่อนหน้า**: [Lab 06: การพัฒนาเครื่องมือ](../06-Tools/README.md)  
**ถัดไป**: [Lab 08: การทดสอบและการแก้ไขข้อผิดพลาด](../08-Testing/README.md)  
