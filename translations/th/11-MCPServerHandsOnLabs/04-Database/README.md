...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:29:50+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "th"
}
-->
# การออกแบบฐานข้อมูลและสคีมา

## 🎯 สิ่งที่คุณจะได้เรียนรู้ในแลบนี้

แลบนี้จะเจาะลึกการออกแบบฐานข้อมูล PostgreSQL สำหรับระบบ Zava Retail คุณจะได้เรียนรู้การสร้างสคีมาร้านค้าครบวงจรที่มีความสามารถในการค้นหาแบบเวกเตอร์ การออกแบบข้อมูลแบบหลายผู้เช่า (Multi-Tenant) และการตั้งค่าความปลอดภัยระดับแถว (Row Level Security - RLS) เพื่อแยกข้อมูลอย่างปลอดภัย

## ภาพรวม

ฐานข้อมูลเป็นรากฐานของเซิร์ฟเวอร์ MCP ของเรา โดยเก็บข้อมูลร้านค้าหลายแห่งพร้อมกับรักษาการแยกข้อมูลอย่างเข้มงวด เราใช้ PostgreSQL พร้อมส่วนขยาย pgvector เพื่อเพิ่มความสามารถในการค้นหาแบบเชิงความหมาย ทำให้ลูกค้าสามารถค้นหาสินค้าด้วยคำถามในภาษาธรรมชาติ

สคีมาของเราปฏิบัติตามรูปแบบการออกแบบข้อมูลแบบหลายผู้เช่าสมัยใหม่ โดยมี Row Level Security เพื่อให้ผู้ใช้สามารถเข้าถึงข้อมูลเฉพาะร้านค้าที่ได้รับอนุญาต วิธีนี้ให้ความปลอดภัยระดับองค์กรพร้อมกับประสิทธิภาพที่เหมาะสม

## วัตถุประสงค์การเรียนรู้

เมื่อจบแลบนี้ คุณจะสามารถ:

- **ออกแบบ** สคีมาฐานข้อมูลร้านค้าที่สามารถขยายได้สำหรับหลายผู้เช่า  
- **ใช้งาน** PostgreSQL พร้อม pgvector สำหรับการค้นหาแบบเวกเตอร์  
- **ตั้งค่า** Row Level Security เพื่อแยกข้อมูล  
- **สร้าง** ข้อมูลตัวอย่างที่สมจริงสำหรับการทดสอบ  
- **ปรับปรุง** ประสิทธิภาพฐานข้อมูลสำหรับการใช้งานในร้านค้า  
- **ดำเนินการ** กลยุทธ์การสำรองข้อมูลและการกู้คืน  

## 🗃️ สถาปัตยกรรมฐานข้อมูล

### PostgreSQL พร้อม pgvector

ฐานข้อมูลของเราใช้คุณสมบัติระดับองค์กรของ PostgreSQL ร่วมกับส่วนขยาย pgvector เพื่อการค้นหาแบบ AI:
...
ฐานข้อมูลใช้รูปแบบ **Shared Database, Shared Schema** สำหรับการใช้งานหลายผู้เช่าพร้อม Row Level Security:
...
### ตาราง Products พร้อม Categories
...
## 🔍 การใช้งานการค้นหาแบบเวกเตอร์

### ตาราง Product Embeddings
...
## 🔐 การตั้งค่า Row Level Security

### บทบาทและสิทธิ์ในฐานข้อมูล
...
## 🎯 สิ่งสำคัญที่คุณจะได้รับ

หลังจากจบแลบนี้ คุณควรมี:

✅ **การออกแบบฐานข้อมูลหลายผู้เช่า**: ใช้งาน Row Level Security เพื่อแยกข้อมูลอย่างปลอดภัย  
✅ **ความสามารถในการค้นหาแบบเวกเตอร์**: ตั้งค่า pgvector สำหรับการค้นหาเชิงความหมายของสินค้า  
✅ **สคีมาครบวงจร**: สร้างสคีมาฐานข้อมูลร้านค้าที่พร้อมใช้งานในระดับผลิต  
✅ **การสร้างข้อมูลตัวอย่าง**: สร้างข้อมูลทดสอบที่สมจริงสำหรับการพัฒนาและการทดสอบ  
✅ **การปรับปรุงประสิทธิภาพ**: ตั้งค่าดัชนีและปรับปรุงคำสั่งค้นหา  
✅ **การสำรองข้อมูลและการกู้คืน**: สร้างกลยุทธ์การปกป้องข้อมูลที่แข็งแกร่ง  

## 🚀 สิ่งที่ต้องทำต่อไป

ดำเนินการต่อที่ **[Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)** เพื่อ:

- สร้างเซิร์ฟเวอร์ FastMCP ที่เชื่อมต่อกับฐานข้อมูลนี้  
- ใช้งานเครื่องมือคำสั่งค้นหาฐานข้อมูลสำหรับโปรโตคอล MCP  
- เพิ่มความสามารถในการค้นหาเชิงความหมายโดยใช้ embeddings  
- ตั้งค่าการจัดการการเชื่อมต่อและการจัดการข้อผิดพลาด  

## 📚 แหล่งข้อมูลเพิ่มเติม

### PostgreSQL & pgvector
- [PostgreSQL Documentation](https://www.postgresql.org/docs/) - เอกสารอ้างอิง PostgreSQL ครบถ้วน  
- [pgvector Extension](https://github.com/pgvector/pgvector) - การค้นหาความคล้ายคลึงแบบเวกเตอร์สำหรับ PostgreSQL  
- [PostgreSQL Performance Tuning](https://wiki.postgresql.org/wiki/Performance_Optimization) - แนวทางปฏิบัติที่ดีที่สุดในการปรับปรุงประสิทธิภาพ  

### สถาปัตยกรรมหลายผู้เช่า
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - เอกสาร PostgreSQL RLS  
- [Multi-Tenant Data Architecture](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - รูปแบบสถาปัตยกรรม Azure  
- [Database Security Best Practices](https://www.postgresql.org/docs/current/security.html) - คู่มือความปลอดภัยของ PostgreSQL  

### ฐานข้อมูลเวกเตอร์
- [Vector Search Fundamentals](https://www.pinecone.io/learn/vector-database/) - ความเข้าใจเกี่ยวกับฐานข้อมูลเวกเตอร์  
- [Embedding Models](https://platform.openai.com/docs/guides/embeddings) - เอกสาร OpenAI embeddings  
- [HNSW Algorithm](https://arxiv.org/abs/1603.09320) - กราฟ Hierarchical Navigable Small World  

---

**ก่อนหน้า**: [Lab 03: Environment Setup](../03-Setup/README.md)  
**ถัดไป**: [Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)  
