...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:13:58+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "th"
}
-->
# ความปลอดภัยและการรองรับหลายผู้ใช้งาน

## 🎯 สิ่งที่คุณจะได้เรียนรู้ในห้องปฏิบัติการนี้

ห้องปฏิบัติการนี้ให้คำแนะนำอย่างละเอียดเกี่ยวกับการสร้างระบบความปลอดภัยระดับองค์กรและการรองรับหลายผู้ใช้งานสำหรับเซิร์ฟเวอร์ MCP คุณจะได้เรียนรู้วิธีออกแบบระบบที่ปลอดภัยและสอดคล้องกับข้อกำหนด เพื่อปกป้องข้อมูลที่สำคัญในธุรกิจค้าปลีก พร้อมทั้งรองรับการเข้าถึงที่ยืดหยุ่นสำหรับผู้ใช้งานหลายราย

## ภาพรวม

ความปลอดภัยเป็นสิ่งสำคัญในแอปพลิเคชันค้าปลีกที่จัดการข้อมูลลูกค้า ข้อมูลการชำระเงิน และข้อมูลเชิงธุรกิจ ห้องปฏิบัติการนี้ครอบคลุมสถาปัตยกรรมความปลอดภัยทั้งหมด ตั้งแต่การยืนยันตัวตนและการอนุญาต ไปจนถึงการแยกข้อมูลและการตรวจสอบความสอดคล้อง

เราใช้กลยุทธ์การป้องกันหลายชั้น โดยผสมผสานบริการด้านตัวตนของ Azure, PostgreSQL Row Level Security, การควบคุมในระดับแอปพลิเคชัน และการบันทึกการตรวจสอบอย่างครอบคลุม เพื่อสร้างแพลตฟอร์มที่แข็งแกร่งและสอดคล้องกับข้อกำหนด

## วัตถุประสงค์การเรียนรู้

เมื่อจบห้องปฏิบัติการนี้ คุณจะสามารถ:

- **นำไปใช้** Row Level Security ระดับองค์กรเพื่อแยกข้อมูลสำหรับผู้ใช้งานหลายราย
- **ออกแบบ** รูปแบบการยืนยันตัวตนและการอนุญาตที่ปลอดภัยด้วย Azure
- **ตั้งค่า** การบันทึกการตรวจสอบอย่างครอบคลุมเพื่อตอบสนองข้อกำหนดด้านความสอดคล้อง
- **ประยุกต์ใช้** กลยุทธ์การป้องกันหลายชั้นในทุกระดับของแอปพลิเคชัน
- **ตรวจสอบ** การใช้งานด้านความปลอดภัยผ่านการทดสอบอย่างเป็นระบบ
- **ติดตาม** เหตุการณ์ด้านความปลอดภัยและตอบสนองต่อภัยคุกคามที่อาจเกิดขึ้น

## 🔐 สถาปัตยกรรมความปลอดภัยสำหรับผู้ใช้งานหลายราย

### ภาพรวมของชั้นความปลอดภัย
...
### รูปแบบการรองรับหลายผู้ใช้งาน

การใช้งานของเรานำรูปแบบ **Shared Database, Shared Schema** ที่มี Row Level Security มาใช้:

**ข้อดี:**
- การใช้ทรัพยากรที่คุ้มค่า
- การบำรุงรักษาและการอัปเดตที่ง่ายขึ้น
- การแยกข้อมูลที่แข็งแกร่งผ่าน RLS
- การบันทึกการตรวจสอบที่สอดคล้องกับข้อกำหนด

**ข้อเสีย:**
- ต้องออกแบบนโยบาย RLS อย่างรอบคอบ
- การเปลี่ยนแปลงใน Schema มีผลต่อผู้ใช้งานทุกคน
- ต้องมีขั้นตอนการสำรองข้อมูล/กู้คืนที่แข็งแกร่ง

## 🛡️ การใช้งาน Row Level Security
...
### รายการตรวจสอบการทดสอบการเจาะระบบ
...
✅ **ความปลอดภัยสำหรับผู้ใช้งานหลายราย**: ใช้งาน Row Level Security เพื่อแยกข้อมูลอย่างสมบูรณ์  
✅ **การยืนยันตัวตนด้วย Azure**: ผสาน Azure Entra ID พร้อมการตรวจสอบ JWT  
✅ **การอนุญาตตามบทบาท**: ตั้งค่าระบบบทบาทและสิทธิ์แบบลำดับชั้น  
✅ **การบันทึกการตรวจสอบอย่างครอบคลุม**: สร้างการติดตามและการตรวจสอบเหตุการณ์ด้านความปลอดภัย  
✅ **การทดสอบความปลอดภัย**: ใช้งานการทดสอบการตรวจสอบความปลอดภัยอัตโนมัติ  
✅ **การติดตามภัยคุกคาม**: สร้างการตรวจจับและการแจ้งเตือนเหตุการณ์ด้านความปลอดภัยแบบเรียลไทม์  

## 🚀 สิ่งที่ต้องทำต่อไป

ดำเนินการต่อกับ **[Lab 03: Environment Setup](../03-Setup/README.md)** เพื่อ:

- ตั้งค่าสภาพแวดล้อมการพัฒนาด้วยแนวทางปฏิบัติที่ดีที่สุดด้านความปลอดภัย
- ตั้งค่าบริการ Azure สำหรับการยืนยันตัวตนและการติดตาม
- ใช้งานการเชื่อมต่อฐานข้อมูลที่ปลอดภัยและการจัดการความลับ
- ตรวจสอบการตั้งค่าความปลอดภัยในสภาพแวดล้อมการพัฒนา

## 📚 แหล่งข้อมูลเพิ่มเติม

### ความปลอดภัยใน Azure
- [เอกสาร Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - คู่มือแพลตฟอร์มตัวตนแบบครบวงจร
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - บริการจัดการความลับ
- [แนวทางปฏิบัติที่ดีที่สุดด้านความปลอดภัยใน Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - คำแนะนำด้านความปลอดภัย

### ความปลอดภัยของฐานข้อมูล
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - เอกสาร RLS อย่างเป็นทางการ
- [รายการตรวจสอบความปลอดภัยของฐานข้อมูล](https://www.postgresql.org/docs/current/security.html) - คู่มือความปลอดภัยของ PostgreSQL
- [รูปแบบฐานข้อมูลสำหรับผู้ใช้งานหลายราย](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - รูปแบบสถาปัตยกรรม

### การทดสอบความปลอดภัย
- [คู่มือการทดสอบ OWASP](https://owasp.org/www-project-web-security-testing-guide/) - การทดสอบความปลอดภัยอย่างครอบคลุม
- [แนวทางปฏิบัติที่ดีที่สุดด้านความปลอดภัยของ JWT](https://tools.ietf.org/html/rfc8725) - ข้อควรพิจารณาด้านความปลอดภัยของ JWT
- [การทดสอบความปลอดภัยของ API](https://owasp.org/www-project-api-security/) - การทดสอบความปลอดภัยเฉพาะ API

---

**ก่อนหน้า**: [Lab 01: Core Architecture Concepts](../01-Architecture/README.md)  
**ถัดไป**: [Lab 03: Environment Setup](../03-Setup/README.md)
