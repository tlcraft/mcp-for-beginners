...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:27:40+00:00",
...
ห้องปฏิบัติการนี้ให้คำแนะนำอย่างละเอียดเกี่ยวกับการปรับใช้เซิร์ฟเวอร์ MCP สำหรับร้านค้าปลีกในสภาพแวดล้อมการผลิต โดยใช้วิธีการที่ทันสมัย เช่น การใช้คอนเทนเนอร์และแนวทางแบบ Cloud-Native คุณจะได้เรียนรู้วิธีปรับใช้เซิร์ฟเวอร์ MCP ที่สามารถปรับขนาดได้ มีความปลอดภัย และมีการตรวจสอบที่เหมาะสม เพื่อรองรับการทำงานในระดับองค์กร

## ภาพรวม

การปรับใช้เซิร์ฟเวอร์ MCP ในสภาพแวดล้อมการผลิตต้องคำนึงถึงการใช้คอนเทนเนอร์ การจัดการ การรักษาความปลอดภัย การปรับขนาด และการตรวจสอบ ห้องปฏิบัติการนี้ครอบคลุมการปรับใช้บน Azure Container Apps พร้อมกับ PostgreSQL Flexible Server การสร้าง CI/CD pipelines และการตั้งค่าการปรับขนาดอัตโนมัติสำหรับการทำงานที่มีความหลากหลาย

กลยุทธ์การปรับใช้มีตั้งแต่การปรับใช้คอนเทนเนอร์เดี่ยวแบบง่ายสำหรับการพัฒนา ไปจนถึงสภาพแวดล้อมการผลิตที่ซับซ้อนในหลายภูมิภาค พร้อมการปรับขนาดอัตโนมัติและฟีเจอร์การตรวจสอบและความปลอดภัยที่ครอบคลุม

## วัตถุประสงค์การเรียนรู้

เมื่อจบห้องปฏิบัติการนี้ คุณจะสามารถ:

- **สร้างคอนเทนเนอร์** เซิร์ฟเวอร์ MCP โดยใช้ Docker และการสร้างแบบหลายขั้นตอน  
- **ปรับใช้** บน Azure Container Apps พร้อมเครือข่ายที่ปลอดภัย  
- **ตั้งค่า** PostgreSQL ระดับการผลิตที่มีความพร้อมใช้งานสูง  
- **ดำเนินการ** CI/CD pipelines สำหรับการปรับใช้อัตโนมัติ  
- **ปรับขนาด** แอปพลิเคชันโดยอัตโนมัติตามความต้องการ  
- **ตรวจสอบ** การปรับใช้ในสภาพแวดล้อมการผลิตด้วยการสังเกตการณ์ที่ครอบคลุม  

## 🐳 การสร้างคอนเทนเนอร์ด้วย Docker

### Dockerfile แบบหลายขั้นตอน
...
## ☁️ การปรับใช้ Azure Container Apps
...
## 🔐 การตั้งค่าความปลอดภัยในสภาพแวดล้อมการผลิต
...
✅ **กลยุทธ์คอนเทนเนอร์**: คอนเทนเนอร์ Docker ที่พร้อมสำหรับการผลิต พร้อมการเพิ่มความปลอดภัย  
✅ **การปรับใช้บนคลาวด์**: Azure Container Apps พร้อมการปรับขนาดอัตโนมัติและการตรวจสอบ  
✅ **การปรับใช้ฐานข้อมูล**: PostgreSQL Flexible Server ที่มีความพร้อมใช้งานสูง  
✅ **CI/CD Pipelines**: Workflow สำหรับการทดสอบ การสร้าง และการปรับใช้อัตโนมัติ  
✅ **การตรวจสอบประสิทธิภาพ**: การเก็บรวบรวมข้อมูลเมตริกและการแจ้งเตือนที่ครอบคลุม  
✅ **การตั้งค่าความปลอดภัย**: นโยบายความปลอดภัยระดับการผลิตและการแยกเครือข่าย  

## 🚀 สิ่งที่ควรทำต่อไป

ดำเนินการต่อกับ **[Lab 11: Monitoring and Observability](../11-Monitoring/README.md)** เพื่อ:

- ตั้งค่าการตรวจสอบที่ครอบคลุมด้วย Application Insights  
- ตั้งค่าการบันทึกแบบมีโครงสร้างและการติดตามแบบกระจาย  
- ดำเนินการแจ้งเตือนและระบบตอบสนองอัตโนมัติ  
- ตรวจสอบเมตริกทางธุรกิจและตัวชี้วัดประสิทธิภาพ  

## 📚 แหล่งข้อมูลเพิ่มเติม

### เทคโนโลยีคอนเทนเนอร์
- [Docker Best Practices](https://docs.docker.com/develop/dev-best-practices/) - แนวทางปฏิบัติที่ดีที่สุดของ Docker  
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - เอกสาร Azure Container Apps  
- [Kubernetes Documentation](https://kubernetes.io/docs/) - เอกสาร Kubernetes อย่างเป็นทางการ  

### CI/CD และ DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - เอกสาร GitHub Actions  
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - บริการ Azure DevOps  
- [Infrastructure as Code](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - เอกสาร Azure Bicep  

### ความปลอดภัยและการตรวจสอบ
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - คำแนะนำด้านความปลอดภัยของ Azure  
- [Container Security](https://kubernetes.io/docs/concepts/security/) - แนวคิดด้านความปลอดภัยของ Kubernetes  
...
**ก่อนหน้า**: [Lab 09: VS Code Integration](../09-VS-Code/README.md)  
**ถัดไป**: [Lab 11: Monitoring and Observability](../11-Monitoring/README.md)  
