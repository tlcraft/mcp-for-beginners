...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-02T09:29:21+00:00",
...
**Model Context Protocol (MCP)** คือกรอบงานล้ำสมัยที่ออกแบบมาเพื่อมาตรฐานการสื่อสารระหว่างโมเดล AI กับแอปพลิเคชันของลูกค้า หลักสูตรโอเพ่นซอร์สนี้นำเสนอเส้นทางการเรียนรู้ที่มีโครงสร้าง พร้อมตัวอย่างโค้ดและกรณีใช้งานจริงในภาษาการเขียนโปรแกรมยอดนิยม เช่น C#, Java, JavaScript, TypeScript และ Python

ไม่ว่าคุณจะเป็นนักพัฒนา AI สถาปนิกระบบ หรือวิศวกรซอฟต์แวร์ คู่มือนี้คือแหล่งข้อมูลครบวงจรสำหรับการเข้าใจพื้นฐาน MCP และกลยุทธ์การใช้งาน
...
เตรียมพร้อมสำหรับสองวันที่เต็มไปด้วยความรู้เชิงลึกทางเทคนิค การเชื่อมต่อชุมชน และการเรียนรู้แบบลงมือทำในงาน MCP Dev Days งานเสมือนจริงที่ทุ่มเทให้กับ Model Context Protocol (MCP) — มาตรฐานใหม่ที่เชื่อมโยงโมเดล AI กับเครื่องมือที่พวกเขาใช้

➡️ [ลงทะเบียน MCP Dev Days](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

คุณสามารถชมงาน MCP Dev Days โดยลงทะเบียนผ่านหน้ากิจกรรมของเรา: https://aka.ms/mcpdevdays จากนั้นคุณจะสามารถเข้าร่วมชมถ่ายทอดสดผ่าน YouTube หรือ Twitch เนื้อหาทั้งหมดจะถูกบันทึกและพร้อมให้ชมย้อนหลังบนช่อง Microsoft Developer YouTube โค้ดตัวอย่างสำหรับเดโมจะถูกปล่อยบน GitHub ด้วย
...
#### วันที่ 1: ประสิทธิภาพ MCP, เครื่องมือ DevTools และชุมชน

มุ่งเน้นการเสริมพลังนักพัฒนาให้ใช้ MCP ในกระบวนการพัฒนา และเฉลิมฉลองชุมชน MCP ที่น่าทึ่ง เราจะมีสมาชิกชุมชนและพันธมิตร เช่น Arcade, Block, Okta และ Neon มาร่วมแบ่งปันวิธีการทำงานร่วมกับ Microsoft เพื่อสร้างระบบนิเวศ MCP ที่เปิดกว้างและขยายได้ การสาธิตจริงผ่าน VS Code, Visual Studio, GitHub Copilot และเครื่องมือยอดนิยมในชุมชน  
เวิร์กโฟลว์การพัฒนาที่ขับเคลื่อนด้วยบริบทอย่างเป็นรูปธรรม  
เซสชันและข้อมูลเชิงลึกที่นำโดยชุมชน  
ไม่ว่าคุณจะเพิ่งเริ่มต้นกับ MCP หรือกำลังพัฒนาอยู่แล้ว วันแรกจะมอบแรงบันดาลใจและแนวทางปฏิบัติที่นำไปใช้ได้จริง
...
- การใช้บล็อกสร้าง เช่น Functions, ACA และ API Management
- การจัดการ registry และเครื่องมือ (1P + 3P)

ถ้าคุณเป็นนักพัฒนา ผู้สร้างเครื่องมือ หรือกลยุทธ์ผลิตภัณฑ์ AI วันที่สองนี้เต็มไปด้วยข้อมูลเชิงลึกที่คุณต้องการเพื่อสร้างโซลูชัน MCP ที่ขยายตัวได้ ปลอดภัย และพร้อมสำหรับอนาคต
...
### การสร้างและปรับใช้ MCP server และ client แรกของคุณ พร้อมห้องปฏิบัติการและสถานการณ์จริง  
<details>
...
### แนวทางปฏิบัติที่ดีที่สุดของ Model Context Protocol  
<details>
  <summary><strong>บทเรียนที่ 6-9: ชุมชน แนวทางปฏิบัติที่ดีที่สุด และห้องปฏิบัติการ</strong></summary>

- **06. การมีส่วนร่วมของชุมชน** – [คู่มือ](./06-CommunityContributions/README.md)
- **07. ข้อมูลเชิงลึกจากการนำไปใช้ตั้งแต่แรก** – [คู่มือ](./07-LessonsFromEarlyAdoption/README.md)
- **08. แนวทางปฏิบัติที่ดีที่สุดสำหรับ MCP** – [คู่มือ](./08-BestPractices/README.md)
- **09. กรณีศึกษาของ MCP** – [คู่มือ](./09-CaseStudy/README.md)
</details>

### ห้องปฏิบัติการ Model Context Protocol ด้วย AI Toolkit สำหรับ VScode  
<details>
  <summary><strong>บทเรียนที่ 10: ห้องปฏิบัติการสร้างเซิร์ฟเวอร์ MCP ด้วย AI Toolkit สำหรับ VScode</strong></summary>
    
- **10. การปรับปรุงกระบวนการทำงาน AI: การสร้างเซิร์ฟเวอร์ MCP ด้วย AI Toolkit** – [ห้องปฏิบัติการ](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md)
</details>
...
มี [คู่มือการศึกษา](./study_guide.md) ที่ครอบคลุมเพื่อช่วยให้คุณนำทางในรีโพสิตอรีนี้ได้อย่างมีประสิทธิภาพ คู่มือประกอบด้วย:

- แผนที่หลักสูตรแบบภาพแสดงหัวข้อทั้งหมดที่ครอบคลุม  
- การแยกส่วนรายละเอียดของแต่ละส่วนในรีโพสิตอรี  
- คำแนะนำวิธีใช้โปรเจกต์ตัวอย่าง  
...
โครงการนี้ยินดีรับการมีส่วนร่วมและข้อเสนอแนะ ส่วนใหญ่ของการมีส่วนร่วมจะต้องให้คุณตกลงใน
Contributor License Agreement (CLA) ที่ระบุว่าคุณมีสิทธิ์และให้สิทธิ์เราใช้ผลงานของคุณจริง ๆ รายละเอียดเพิ่มเติมดูได้ที่ <https://cla.opensource.microsoft.com>

เมื่อคุณส่งคำขอดึง (pull request) ระบบ CLA bot จะตรวจสอบโดยอัตโนมัติว่าคุณจำเป็นต้องส่ง CLA หรือไม่ และจะติดสถานะที่เหมาะสมกับ PR (เช่น การตรวจสอบสถานะ หรือคอมเมนต์) เพียงทำตามคำแนะนำที่บอทให้ไว้ คุณจะต้องทำเพียงครั้งเดียวสำหรับทุกรีโพสิตอรีที่ใช้ CLA ของเรา
...
## 🎒 หลักสูตรอื่น ๆ  
ทีมงานของเรามีหลักสูตรอื่น ๆ ให้เลือกเรียน! ลองดูได้ที่:
...
- [การใช้งาน GitHub Copilot สำหรับการเขียนโปรแกรมร่วมกับ AI](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
- [เลือกการผจญภัยของ Copilot ด้วยตัวคุณเอง](https://github.com/microsoft/CopilotAdventures?WT.mc_id=academic-105485-koreyst)


## ™️ แจ้งเตือนเครื่องหมายการค้า

โครงการนี้อาจมีเครื่องหมายการค้าหรือโลโก้ของโครงการ ผลิตภัณฑ์ หรือบริการต่างๆ การใช้เครื่องหมายการค้าหรือโลโก้ของ Microsoft อย่างถูกต้องต้องเป็นไปตาม
...
การใช้เครื่องหมายการค้าหรือโลโก้ของ Microsoft ในเวอร์ชันที่ดัดแปลงของโครงการนี้ต้องไม่ก่อให้เกิดความสับสนหรือแสดงว่ามีการสนับสนุนจาก Microsoft
การใช้เครื่องหมายการค้าหรือโลโก้ของบุคคลที่สามต้องเป็นไปตามนโยบายของเจ้าของเครื่องหมายนั้นๆ

**ข้อจำกัดความรับผิดชอบ**:  
เอกสารนี้ได้รับการแปลโดยใช้บริการแปลภาษาอัตโนมัติ [Co-op Translator](https://github.com/Azure/co-op-translator) แม้เราจะพยายามให้ความถูกต้องสูงสุด แต่โปรดทราบว่าการแปลโดยอัตโนมัติอาจมีข้อผิดพลาดหรือความคลาดเคลื่อน เอกสารต้นฉบับในภาษาต้นทางถือเป็นแหล่งข้อมูลที่เชื่อถือได้ สำหรับข้อมูลที่สำคัญ ขอแนะนำให้ใช้บริการแปลโดยผู้เชี่ยวชาญด้านภาษามนุษย์ เราไม่รับผิดชอบต่อความเข้าใจผิดหรือการตีความผิดที่เกิดขึ้นจากการใช้การแปลนี้