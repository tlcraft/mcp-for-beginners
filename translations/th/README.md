...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T14:06:59+00:00",
...
- 🌐 [ชุมชน MCP](https://github.com/orgs/modelcontextprotocol/discussions) – เข้าร่วมการสนทนาและมีส่วนร่วมกับชุมชน
 ...
 ### ➡️รับชมตามความต้องการ - MCP Dev Days
เตรียมตัวให้พร้อมสำหรับสองวันของข้อมูลเชิงลึกทางเทคนิค การเชื่อมต่อชุมชน และการเรียนรู้แบบลงมือทำใน MCP Dev Days ซึ่งเป็นงานเสมือนจริงที่อุทิศให้กับ Model Context Protocol (MCP) — มาตรฐานใหม่ที่เชื่อมโยงโมเดล AI และเครื่องมือที่พวกเขาใช้งาน
คุณสามารถรับชม MCP Dev Days ได้โดยลงทะเบียนในหน้ากิจกรรมของเรา: https://aka.ms/mcpdevdays. 

#### วันที่ 1: MCP Productivity, DevTools, & Community: 

เน้นการเพิ่มพลังให้นักพัฒนาใช้ MCP ในกระบวนการทำงานของนักพัฒนา และเฉลิมฉลองชุมชน MCP ที่น่าทึ่ง เราจะเข้าร่วมกับสมาชิกชุมชนและพันธมิตร เช่น Arcade, Block, Okta และ Neon เพื่อดูว่าพวกเขาร่วมมือกับ Microsoft อย่างไรในการสร้างระบบนิเวศ MCP ที่เปิดกว้างและขยายได้
...
ไม่ว่าคุณจะเพิ่งเริ่มต้นกับ MCP หรือกำลังสร้างด้วยมัน วันที่ 1 จะสร้างแรงบันดาลใจและให้ข้อมูลที่นำไปใช้ได้จริง

#### วันที่ 2: สร้าง MCP Servers ด้วยความมั่นใจ

สำหรับผู้สร้าง MCP เราจะเจาะลึกกลยุทธ์การนำไปใช้และแนวทางปฏิบัติที่ดีที่สุดสำหรับการสร้าง MCP servers และการรวม MCP เข้ากับกระบวนการทำงาน AI ของคุณ
...
| 3.4 | การรวม VS Code | ใช้ MCP servers ใน VS Code | [คู่มือ](./03-GettingStarted/04-vscode/README.md) |
...
| 3.9 | การปรับใช้ | ปรับใช้ MCP servers สู่การใช้งานจริง | [คู่มือ](./03-GettingStarted/09-deployment/README.md) |
...
| 5.14 | การออกแบบบริบท | เทคนิคสำหรับการออกแบบบริบทที่มีประสิทธิภาพ | [คู่มือ](./05-AdvancedTopics/mcp-contextengineering/README.md) |
...
| 07 | บทเรียนจากการใช้งานในช่วงแรก | เรื่องราวการใช้งานจริง | [Guide](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | แนวทางปฏิบัติที่ดีที่สุดสำหรับ MCP | ประสิทธิภาพ, ความทนทานต่อข้อผิดพลาด, ความยืดหยุ่น | [Guide](./08-BestPractices/README.md) |
| 09 | กรณีศึกษา MCP | ตัวอย่างการใช้งานจริง | [Guide](./09-CaseStudy/README.md) |
| 10 | เวิร์กช็อปแบบลงมือปฏิบัติ | การสร้างเซิร์ฟเวอร์ MCP ด้วย AI Toolkit | [Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
| Java with Spring | ตัวอย่างแอปพลิเคชันในคอนเทนเนอร์ | [View Code](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
| TypeScript | ตัวอย่างในคอนเทนเนอร์ | [View Code](./04-PracticalImplementation/samples/typescript/README.md) |
...
มี [คู่มือการเรียน](./study_guide.md) ที่ครอบคลุมเพื่อช่วยให้คุณนำทางที่เก็บนี้ได้อย่างมีประสิทธิภาพ คู่มือประกอบด้วย:
...
โครงการนี้ยินดีต้อนรับการมีส่วนร่วมและข้อเสนอแนะ การมีส่วนร่วมส่วนใหญ่ต้องการให้คุณตกลงกับ
...
ที่บอทให้ คุณจะต้องทำสิ่งนี้เพียงครั้งเดียวสำหรับทุกที่เก็บที่ใช้ CLA ของเรา
...
- **หลักสูตรหลัก (00-10)**: เนื้อหาหลักที่จัดเรียงในสิบโมดูลตามลำดับ
...
การใช้เครื่องหมายการค้าหรือโลโก้ของบุคคลที่สามต้องปฏิบัติตามนโยบายของบุคคลที่สามนั้นๆ
