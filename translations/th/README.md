...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T17:39:14+00:00",
...
**Model Context Protocol (MCP)** เป็นกรอบการทำงานที่ทันสมัยซึ่งออกแบบมาเพื่อมาตรฐานการโต้ตอบระหว่างโมเดล AI และแอปพลิเคชันลูกค้า หลักสูตรโอเพ่นซอร์สนี้มีเส้นทางการเรียนรู้ที่มีโครงสร้าง พร้อมตัวอย่างการเขียนโค้ดและกรณีศึกษาในโลกจริง ครอบคลุมภาษาการเขียนโปรแกรมยอดนิยม เช่น C#, Java, JavaScript, TypeScript และ Python
...
| 11 | การผสานรวมเซิร์ฟเวอร์ MCP กับฐานข้อมูล | เส้นทางการเรียนรู้แบบลงมือทำ 13 ห้องปฏิบัติการสำหรับการผสานรวม PostgreSQL | [ห้องปฏิบัติการ](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | บทนำ | ภาพรวมของ MCP พร้อมการผสานรวมฐานข้อมูลและกรณีศึกษาเกี่ยวกับการวิเคราะห์การค้าปลีก | [ห้องปฏิบัติการ 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.3 | ความปลอดภัย & การใช้งานหลายผู้เช่า | การรักษาความปลอดภัยระดับแถว, การยืนยันตัวตน, และการเข้าถึงข้อมูลหลายผู้เช่า | [Lab 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.5 | การออกแบบฐานข้อมูล | การตั้งค่า PostgreSQL, การออกแบบโครงสร้างข้อมูลสำหรับการค้าปลีก, และข้อมูลตัวอย่าง | [Lab 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
...
| 11.7 | การพัฒนาเครื่องมือ | การสร้างเครื่องมือสำหรับการสืบค้นฐานข้อมูลและการตรวจสอบโครงสร้างข้อมูล | [Lab 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
...
| 11.9 | การทดสอบ & การแก้ไขข้อผิดพลาด | กลยุทธ์การทดสอบ, เครื่องมือแก้ไขข้อผิดพลาด, และวิธีการตรวจสอบ | [Lab 08](./11-MCPServerHandsOnLabs/08-Testing/README.md) |
| 11.10 | การรวมเข้ากับ VS Code | การตั้งค่า VS Code สำหรับ MCP และการใช้งาน AI Chat | [Lab 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
...
| 11.13 | แนวปฏิบัติที่ดีที่สุด | การปรับปรุงประสิทธิภาพ, การเพิ่มความปลอดภัย, และเคล็ดลับสำหรับการใช้งานในระดับผลิต | [Lab 12](./11-MCPServerHandsOnLabs/12-Best-Practices/README.md) |
...
เตรียมพร้อมสำหรับสองวันของข้อมูลเชิงลึกทางเทคนิค, การเชื่อมต่อชุมชน, และการเรียนรู้แบบลงมือทำใน MCP Dev Days ซึ่งเป็นกิจกรรมเสมือนจริงที่อุทิศให้กับ Model Context Protocol (MCP) — มาตรฐานใหม่ที่เชื่อมโยงโมเดล AI และเครื่องมือที่พวกมันพึ่งพา
...
เน้นการเพิ่มพลังให้กับนักพัฒนาในการใช้ MCP ในกระบวนการพัฒนา และเฉลิมฉลองชุมชน MCP ที่น่าทึ่ง เราจะมีสมาชิกชุมชนและพันธมิตร เช่น Arcade, Block, Okta, และ Neon มาร่วมแบ่งปันวิธีที่พวกเขาร่วมมือกับ Microsoft เพื่อสร้างระบบนิเวศ MCP ที่เปิดกว้างและขยายได้  
...
- การใช้ส่วนประกอบเช่น Functions, ACA, และ API Management
...
มาเรียนรู้เกี่ยวกับ Model Context Protocol (MCP) ซึ่งเป็นกรอบงานล้ำสมัยที่ออกแบบมาเพื่อมาตรฐานการโต้ตอบระหว่างโมเดล AI และแอปพลิเคชันลูกค้า ผ่านเซสชันที่เหมาะสำหรับผู้เริ่มต้น เราจะนำคุณเข้าสู่ MCP และแนะนำวิธีสร้าง MCP server แรกของคุณ
...
- **11-MCPServerHandsOnLabs/**: เส้นทางการเรียนรู้ 13 ห้องปฏิบัติการสำหรับการสร้าง MCP servers ที่พร้อมใช้งานในระดับผลิตด้วยการรวม PostgreSQL
- **images/**: แผนภาพและภาพประกอบที่ใช้ตลอดหลักสูตร
- **translations/**: การสนับสนุนหลายภาษา พร้อมการแปลอัตโนมัติ
...
โครงการนี้อาจมีเครื่องหมายการค้าหรือโลโก้สำหรับโครงการ ผลิตภัณฑ์ หรือบริการ การใช้เครื่องหมายการค้าหรือโลโก้ของ Microsoft อย่างถูกต้องต้องเป็นไปตามและปฏิบัติตาม [แนวทางการใช้เครื่องหมายการค้าและแบรนด์ของ Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) การใช้เครื่องหมายการค้าหรือโลโก้ของ Microsoft ในเวอร์ชันที่ปรับเปลี่ยนของโครงการนี้ต้องไม่ก่อให้เกิดความสับสนหรือบ่งบอกถึงการสนับสนุนจาก Microsoft การใช้เครื่องหมายการค้าหรือโลโก้ของบุคคลที่สามใด ๆ ต้องเป็นไปตามนโยบายของบุคคลที่สามนั้น ๆ
