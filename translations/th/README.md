...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T18:47:53+00:00",
...
| Java with Spring | ตัวอย่างแอปพลิเคชันในคอนเทนเนอร์ | [ดูโค้ด](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
## 🎯 สิ่งที่ต้องมีเพื่อเรียนรู้ MCP
...
[คู่มือการศึกษา](./study_guide.md) ที่ครอบคลุมมีให้เพื่อช่วยให้คุณสำรวจที่เก็บนี้ได้อย่างมีประสิทธิภาพ คู่มือประกอบด้วย:
...
เน้นการเพิ่มพลังให้กับนักพัฒนาในการใช้ MCP ในกระบวนการทำงานของนักพัฒนา และเฉลิมฉลองชุมชน MCP ที่น่าทึ่ง เราจะมีสมาชิกชุมชนและพันธมิตร เช่น Arcade, Block, Okta และ Neon มาร่วมแบ่งปันวิธีที่พวกเขาร่วมมือกับ Microsoft เพื่อสร้างระบบนิเวศ MCP ที่เปิดกว้างและขยายได้
- การสาธิตในโลกจริงผ่าน VS Code, Visual Studio, GitHub Copilot และเครื่องมือชุมชนยอดนิยม
- กระบวนการทำงานที่ขับเคลื่อนด้วยบริบท
...
เรียนรู้ผ่านวิดีโอเซสชันเข้มข้นเกี่ยวกับวิธีการสร้าง MCP servers การรวมเข้ากับ VS Code และการปรับใช้อย่างมืออาชีพบน Azure โดยอ้างอิงจากเนื้อหาหลักสูตร MCP สำหรับผู้เริ่มต้น ฝึกฝนทักษะในเทคโนโลยีที่บริษัทใหญ่ๆ กำลังใช้งานอยู่
...
เรียนรู้เกี่ยวกับ Model Context Protocol (MCP) ซึ่งเป็นกรอบงานล้ำสมัยที่ออกแบบมาเพื่อมาตรฐานการโต้ตอบระหว่างโมเดล AI และแอปพลิเคชันไคลเอนต์ ผ่านเซสชันที่เหมาะสำหรับผู้เริ่มต้น เราจะแนะนำ MCP และแนะนำวิธีการสร้าง MCP server แรกของคุณ
...
ใช้การมีส่วนร่วมของคุณ สำหรับรายละเอียดเพิ่มเติม โปรดเยี่ยมชม 
...
โครงการนี้อาจมีเครื่องหมายการค้าหรือโลโก้สำหรับโครงการ ผลิตภัณฑ์ หรือบริการ การใช้เครื่องหมายการค้าหรือโลโก้ของ Microsoft อย่างได้รับอนุญาตต้องเป็นไปตามและต้องปฏิบัติตาม
