...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T20:29:37+00:00",
...
**Model Context Protocol (MCP)** เป็นกรอบการทำงานที่ทันสมัยซึ่งออกแบบมาเพื่อมาตรฐานการโต้ตอบระหว่างโมเดล AI และแอปพลิเคชันลูกค้า หลักสูตรโอเพ่นซอร์สนี้นำเสนอเส้นทางการเรียนรู้ที่มีโครงสร้าง พร้อมตัวอย่างการเขียนโค้ดและกรณีการใช้งานจริงในภาษาการเขียนโปรแกรมยอดนิยม เช่น C#, Java, JavaScript, TypeScript และ Python
...
| 3.2 | ไคลเอนต์ตัวแรก | พัฒนาไคลเอนต์ MCP พื้นฐาน | [คู่มือ](./03-GettingStarted/02-client/README.md) |
...
| 5.3 | OAuth2 Demo | ใช้การตรวจสอบสิทธิ์ OAuth2 | [คู่มือ](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
...
| Java กับ Spring | ตัวอย่างแอปพลิเคชันในคอนเทนเนอร์ | [ดูโค้ด](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
| TypeScript | ตัวอย่างในคอนเทนเนอร์ | [ดูโค้ด](./04-PracticalImplementation/samples/typescript/README.md) |

## 🎯 สิ่งที่ควรเตรียมก่อนเรียน MCP
...
- เข้าร่วมการพูดคุยในชุมชนของเราเพื่อรับการสนับสนุน

## 📚 คู่มือการเรียนและทรัพยากร

ที่เก็บนี้มีทรัพยากรมากมายเพื่อช่วยให้คุณเรียนรู้และนำทางได้อย่างมีประสิทธิภาพ:

### คู่มือการเรียน

[คู่มือการเรียน](./study_guide.md) ที่ครอบคลุมมีให้เพื่อช่วยให้คุณนำทางที่เก็บนี้ได้อย่างมีประสิทธิภาพ คู่มือประกอบด้วย:

- แผนภาพหลักสูตรที่แสดงหัวข้อทั้งหมดที่ครอบคลุม
- การแบ่งส่วนของแต่ละส่วนในที่เก็บอย่างละเอียด
- คำแนะนำเกี่ยวกับวิธีการใช้โปรเจกต์ตัวอย่าง
- เส้นทางการเรียนรู้ที่แนะนำสำหรับระดับทักษะต่าง ๆ
- ทรัพยากรเพิ่มเติมเพื่อเสริมการเรียนรู้ของคุณ

### บันทึกการเปลี่ยนแปลง

เราเก็บ [บันทึกการเปลี่ยนแปลง](./changelog.md) ที่ละเอียดซึ่งติดตามการอัปเดตที่สำคัญทั้งหมดในเนื้อหาหลักสูตร รวมถึง:
...
เน้นการเพิ่มพลังให้กับนักพัฒนาในการใช้ MCP ในกระบวนการทำงานของนักพัฒนา และเฉลิมฉลองชุมชน MCP ที่น่าทึ่ง เราจะเข้าร่วมกับสมาชิกชุมชนและพันธมิตร เช่น Arcade, Block, Okta และ Neon เพื่อดูว่าพวกเขาร่วมมือกับ Microsoft อย่างไรในการสร้างระบบนิเวศ MCP ที่เปิดกว้างและขยายได้
...
ไม่ว่าคุณจะเพิ่งเริ่มต้นกับ MCP หรือกำลังสร้างด้วยมัน วันแรกจะสร้างแรงบันดาลใจและให้คำแนะนำที่นำไปใช้ได้จริง

#### [วันที่สอง: สร้าง MCP Servers อย่างมั่นใจ](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

เหมาะสำหรับผู้สร้าง MCP เราจะเจาะลึกกลยุทธ์การใช้งานและแนวทางปฏิบัติที่ดีที่สุดในการสร้าง MCP servers และการรวม MCP เข้ากับกระบวนการทำงาน AI ของคุณ

#### หัวข้อที่ครอบคลุม:

- การสร้าง MCP Servers และการรวมเข้ากับประสบการณ์ของเอเจนต์
...
เรียนรู้ผ่านวิดีโอเซสชันเข้มข้นเกี่ยวกับวิธีการสร้าง MCP servers การรวมเข้ากับ VS Code และการปรับใช้อย่างมืออาชีพบน Azure โดยอิงจากเนื้อหาหลักสูตร MCP สำหรับผู้เริ่มต้น ออกไปพร้อมกับทักษะที่ใช้งานได้จริงในเทคโนโลยีที่บริษัทใหญ่ ๆ กำลังใช้งานอยู่
...
มาเรียนรู้เกี่ยวกับ Model Context Protocol (MCP) ซึ่งเป็นกรอบงานล้ำสมัยที่ออกแบบมาเพื่อสร้างมาตรฐานการโต้ตอบระหว่างโมเดล AI และแอปพลิเคชันไคลเอนต์ ผ่านเซสชันที่เหมาะสำหรับผู้เริ่มต้น เราจะนำคุณเข้าสู่ MCP และแนะนำวิธีการสร้าง MCP server แรกของคุณ
...
โปรเจกต์นี้ยินดีรับการมีส่วนร่วมและข้อเสนอแนะ การมีส่วนร่วมส่วนใหญ่ต้องการให้คุณตกลงใน
Contributor License Agreement (CLA) ซึ่งระบุว่าคุณมีสิทธิ์และให้สิทธิ์เรา
ในการใช้การมีส่วนร่วมของคุณ สำหรับรายละเอียดเพิ่มเติม โปรดเยี่ยมชม 
<https://cla.opensource.microsoft.com>

เมื่อคุณส่ง pull request CLA bot จะกำหนดโดยอัตโนมัติว่าคุณต้องให้
...
- **study_guide.md**: คู่มือที่ครอบคลุมสำหรับการนำทางที่เก็บ
- **changelog.md**: บันทึกการเปลี่ยนแปลงที่สำคัญทั้งหมดในเนื้อหาหลักสูตร
- **mcp.json**: ไฟล์การกำหนดค่าของ MCP specification
- **CODE_OF_CONDUCT.md, LICENSE, SECURITY.md, SUPPORT.md**: เอกสารการกำกับดูแลโปรเจกต์
...
โปรเจกต์นี้อาจมีเครื่องหมายการค้าหรือโลโก้สำหรับโปรเจกต์ ผลิตภัณฑ์ หรือบริการ การใช้เครื่องหมายการค้าหรือโลโก้ของ Microsoft อย่างได้รับอนุญาตต้องเป็นไปตามและต้องปฏิบัติตาม
...
การใช้เครื่องหมายการค้าหรือโลโก้ของ Microsoft ในเวอร์ชันที่แก้ไขของโปรเจกต์นี้ต้องไม่ก่อให้เกิดความสับสนหรือบ่งบอกถึงการสนับสนุนจาก Microsoft
