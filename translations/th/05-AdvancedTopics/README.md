...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-02T12:28:29+00:00",
...
บทเรียนนี้สำรวจแนวคิดขั้นสูงในการใช้งาน Model Context Protocol โดยเน้นที่การรวมหลายโหมด, ความสามารถในการขยายระบบ, แนวทางปฏิบัติด้านความปลอดภัยที่ดีที่สุด และการบูรณาการในองค์กร หัวข้อเหล่านี้มีความสำคัญสำหรับการสร้างแอปพลิเคชัน MCP ระดับการผลิตที่สามารถรองรับความต้องการที่ซับซ้อนในสภาพแวดล้อมองค์กร

## วัตถุประสงค์การเรียนรู้

เมื่อจบบทเรียนนี้ คุณจะสามารถ:
- นำความสามารถแบบหลายโหมดมาใช้ในกรอบงาน MCP
...
- บูรณาการ MCP กับระบบ AI และกรอบงานในองค์กร
...
|------|-------|-------------|
| [mcp-oauth2-demo](../../../05-AdvancedTopics/mcp-oauth2-demo) | MCP OAuth2 Demo | แอป Spring Boot ขนาดเล็กที่แสดงการใช้งาน OAuth2 กับ MCP ทั้งในฐานะ Authorization และ Resource Server แสดงการออกโทเค็นอย่างปลอดภัย, จุดสิ้นสุดที่ได้รับการป้องกัน, การปรับใช้บน Azure Container Apps และการบูรณาการกับ API Management |
| [web-search-mcp](../../../05-AdvancedTopics/web-search-mcp) | Web Search MCP | เซิร์ฟเวอร์และไคลเอนต์ MCP ด้วย Python ที่รวมกับ SerpAPI สำหรับการค้นหาเว็บ ข่าว สินค้า และถามตอบแบบเรียลไทม์ แสดงการประสานงานเครื่องมือหลายตัว การบูรณาการ API ภายนอก และการจัดการข้อผิดพลาดอย่างแข็งแกร่ง |
...
MCP รองรับไม่เพียงแต่การโต้ตอบแบบข้อความเท่านั้น แต่ยังมีความสามารถแบบหลายโหมด ช่วยให้โมเดลทำงานร่วมกับภาพ เสียง และข้อมูลประเภทอื่นๆ ได้

### สถาปัตยกรรมสำหรับการรองรับหลายโหมด

การใช้งาน MCP แบบหลายโหมดโดยทั่วไปประกอบด้วย:

1. **Modal-Specific Parsers**: ส่วนประกอบที่แปลงสื่อประเภทต่างๆ ให้อยู่ในรูปแบบที่โมเดลสามารถประมวลผลได้
2. **Modal-Specific Tools**: เครื่องมือเฉพาะทางที่ออกแบบมาเพื่อจัดการกับโหมดเฉพาะ (เช่น วิเคราะห์ภาพ, ประมวลผลเสียง)
3. **Unified Context Management**: ระบบที่รักษาบริบทข้ามโหมดต่างๆ
4. **Response Generation**: ความสามารถในการสร้างคำตอบที่อาจรวมหลายโหมด

### ตัวอย่าง C# แบบหลายโหมด: การวิเคราะห์ภาพ
...
### ตัวอย่าง Java แบบหลายโหมด: การประมวลผลเสียง
...
### ตัวอย่าง Python แบบหลายโหมด: การสร้างคำตอบหลายโหมด
...
Root contexts เป็นแนวคิดพื้นฐานใน Model Context Protocol ที่ให้ชั้นข้อมูลถาวรสำหรับเก็บประวัติการสนทนาและสถานะที่ใช้ร่วมกันระหว่างคำขอและเซสชันหลายรายการ

### ทำความเข้าใจกับ Root Contexts

Root contexts ทำหน้าที่เป็นภาชนะที่เก็บประวัติและสถานะของชุดการโต้ตอบที่เกี่ยวข้อง ช่วยให้:

- **การรักษาการสนทนา**: รักษาการสนทนาแบบหลายรอบอย่างต่อเนื่อง
- **การจัดการหน่วยความจำ**: เก็บและเรียกข้อมูลข้ามการโต้ตอบ
- **การจัดการสถานะ**: ติดตามความคืบหน้าในเวิร์กโฟลว์ที่ซับซ้อน
- **การแชร์บริบท**: อนุญาตให้ไคลเอนต์หลายรายเข้าถึงสถานะการสนทนาเดียวกัน

ใน MCP root contexts มีลักษณะสำคัญเหล่านี้:

- แต่ละ root context มีตัวระบุเฉพาะ
- สามารถเก็บประวัติการสนทนา, ความชอบของผู้ใช้ และข้อมูลเมตาอื่นๆ
...
### ตัวอย่าง Python: Root Context สำหรับการช่วยเหลือแบบหลายรอบ
...
1. **สร้าง Context ที่เน้นจุดประสงค์ชัดเจน**: สร้าง root contexts แยกตามวัตถุประสงค์หรือโดเมนของการสนทนาเพื่อความชัดเจน
2. **กำหนดนโยบายหมดอายุ**: ใช้นโยบายในการเก็บถาวรหรือลบ contexts เก่าเพื่อจัดการพื้นที่จัดเก็บและสอดคล้องกับนโยบายการเก็บข้อมูล
3. **เก็บข้อมูลเมตาที่เกี่ยวข้อง**: ใช้ข้อมูลเมตาของ context เพื่อเก็บข้อมูลสำคัญเกี่ยวกับการสนทนาที่อาจเป็นประโยชน์ในภายหลัง
4. **ใช้ ID ของ Context อย่างสม่ำเสมอ**: เมื่อสร้าง context แล้ว ให้ใช้ ID นั้นอย่างต่อเนื่องสำหรับคำขอที่เกี่ยวข้องทั้งหมดเพื่อรักษาความต่อเนื่อง
5. **สร้างสรุป**: เมื่อ context มีขนาดใหญ่ ให้พิจารณาสร้างสรุปเพื่อจับข้อมูลสำคัญในขณะที่จัดการขนาดของ context
6. **ใช้การควบคุมการเข้าถึง**: สำหรับระบบที่มีผู้ใช้หลายคน ให้ใช้การควบคุมการเข้าถึงที่เหมาะสมเพื่อรักษาความเป็นส่วนตัวและความปลอดภัยของบริบทการสนทนา
7. **จัดการข้อจำกัดของ Context**: ตระหนักถึงข้อจำกัดของขนาด context และวางแผนกลยุทธ์สำหรับการจัดการการสนทนาที่ยาวมาก
8. **เก็บถาวรเมื่อเสร็จสิ้น**: เก็บถาวร context เมื่อการสนทนาสิ้นสุดเพื่อคืนทรัพยากรพร้อมกับรักษาประวัติการสนทนา

## การสุ่มตัวอย่างใน Model Context Protocol

กลยุทธ์การสุ่มตัวอย่างมีความสำคัญสำหรับการปรับแต่งคำตอบของโมเดลใน MCP การตั้งค่าการสุ่มตัวอย่างที่เหมาะสมสามารถปรับปรุงคุณภาพและประสิทธิภาพของคำตอบได้อย่างมาก MCP มีวิธีมาตรฐานในการควบคุมการสร้างข้อความของโมเดลด้วยพารามิเตอร์เฉพาะที่มีผลต่อความสุ่ม ความคิดสร้างสรรค์ และความสอดคล้อง

### ภาพรวมของพารามิเตอร์การสุ่มตัวอย่าง

MCP กำหนดพารามิเตอร์การสุ่มตัวอย่างต่อไปนี้ที่สามารถตั้งค่าในคำขอของไคลเอนต์ได้:
...
| `stop_sequences` | ลำดับคำสั่งที่กำหนดเองซึ่งหยุดการสร้างเมื่อเจอ | อาร์เรย์ของสตริง |

### Temperature และ Top-K/Top-P Sampling

พารามิเตอร์การสุ่มตัวอย่างช่วยปรับแต่งพฤติกรรมของโมเดลภาษาเพื่อให้ได้สมดุลระหว่างผลลัพธ์ที่กำหนดได้และความคิดสร้างสรรค์ตามที่ต้องการ
...
### การสุ่มตัวอย่างแบบกำหนดผลแน่นอน

สำหรับแอปพลิเคชันที่ต้องการผลลัพธ์ที่สม่ำเสมอ การสุ่มตัวอย่างแบบกำหนดผลแน่นอนช่วยให้ผลลัพธ์ซ้ำได้
...
การสุ่มตัวอย่างอัจฉริยะปรับพารามิเตอร์ตามบริบทและความต้องการของแต่ละคำขอ
...
## การกำหนดเส้นทางใน Model Context Protocol

การกำหนดเส้นทางเป็นสิ่งจำเป็นสำหรับการส่งคำขอไปยังโมเดล เครื่องมือ หรือบริการที่เหมาะสมภายในระบบ MCP

### การกำหนดเส้นทางตามเนื้อหา

การกำหนดเส้นทางตามเนื้อหาส่งคำขอไปยังบริการเฉพาะตามเนื้อหาของคำขอ
...
### การบาลานซ์โหลดอัจฉริยะ

การบาลานซ์โหลดช่วยเพิ่มประสิทธิภาพการใช้ทรัพยากรและรับประกันความพร้อมใช้งานสูงสำหรับบริการ MCP
...
การกำหนดเส้นทางเครื่องมือช่วยให้การเรียกเครื่องมือถูกส่งไปยังบริการที่เหมาะสมที่สุดตามบริบท
...
แผนภาพด้านล่างแสดงวิธีการทำงานร่วมกันของการสุ่มตัวอย่างและการกำหนดเส้นทางในสถาปัตยกรรม MCP ที่ครอบคลุม:
...
## ความสามารถในการขยายและ MCP ประสิทธิภาพสูง

สำหรับการปรับใช้ในองค์กร การใช้งาน MCP มักต้องรองรับคำขอจำนวนมากด้วยความหน่วงต่ำที่สุด
...
#### การขยายแนวตั้งและการปรับแต่งทรัพยากร
...
ความปลอดภัยเป็นสิ่งสำคัญสำหรับการใช้งาน MCP โดยเฉพาะในสภาพแวดล้อมองค์กร
...
#### ตัวอย่างการปกป้องข้อมูลด้วย Python
...
การบูรณาการ MCP กับระบบองค์กรเช่น Azure OpenAI และ Microsoft AI Foundry
...
### ตัวอย่างการบูรณาการในองค์กรด้วย Python
...
- การใช้งาน MCP แบบหลายโหมดช่วยขยายความสามารถของ AI เกินกว่าการประมวลผลข้อความ
- ความสามารถในการขยายเป็นสิ่งจำเป็นสำหรับการปรับใช้ในองค์กรและสามารถแก้ไขได้ด้วยการขยายแนวนอนและแนวตั้ง
- มาตรการความปลอดภัยครบถ้วนช่วยปกป้องข้อมูลและรับประกันการควบคุมการเข้าถึงที่เหมาะสม
- การบูรณาการกับแพลตฟอร์มเช่น Azure OpenAI และ Microsoft AI Foundry ช่วยเพิ่มความสามารถของ MCP
...
1. ระบุความต้องการแบบหลายโหมดสำหรับกรณีใช้งานของคุณ
2. ร่างการควบคุมความปลอดภัยที่จำเป็นเพื่อปกป้องข้อมูลที่ละเอียดอ่อน
3. ออกแบบสถาปัตยกรรมที่สามารถขยายได้เพื่อรองรับโหลดที่เปลี่ยนแปลง
4. วางแผนจุดบูรณาการกับระบบ AI ขององค์กร
5. บันทึกปัญหาคอขวดด้านประสิทธิภาพที่อาจเกิดขึ้นและกลยุทธ์แก้ไข
...
เอกสารนี้ได้รับการแปลโดยใช้บริการแปลภาษาอัตโนมัติ [Co-op Translator](https://github.com/Azure/co-op-translator) แม้ว่าเราจะพยายามให้ความถูกต้องสูงสุด โปรดทราบว่าการแปลอัตโนมัติอาจมีข้อผิดพลาดหรือความไม่ถูกต้อง เอกสารต้นฉบับในภาษาต้นทางควรถูกพิจารณาเป็นแหล่งข้อมูลที่เชื่อถือได้ สำหรับข้อมูลที่สำคัญ ขอแนะนำให้ใช้บริการแปลโดยมืออาชีพที่เป็นมนุษย์ เราจะไม่รับผิดชอบต่อความเข้าใจผิดหรือการตีความผิดใดๆ ที่เกิดจากการใช้การแปลนี้