...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-04T17:31:32+00:00",
...
เมื่อคุณกำลังสร้างเอเจนต์ AI ไม่ใช่แค่การสร้างคำตอบที่ชาญฉลาดเท่านั้น แต่ยังรวมถึงการให้เอเจนต์ของคุณสามารถดำเนินการได้จริง นั่นคือที่มาของ Model Context Protocol (MCP) MCP ช่วยให้ง่ายต่อการเข้าถึงเครื่องมือและบริการภายนอกอย่างสม่ำเสมอ คิดซะว่าเหมือนการเสียบเอเจนต์ของคุณเข้ากับกล่องเครื่องมือที่มัน *สามารถ* ใช้งานได้จริง

สมมติว่าคุณเชื่อมต่อเอเจนต์กับเซิร์ฟเวอร์ MCP เครื่องคิดเลข ทันใดนั้นเอเจนต์ของคุณก็สามารถทำการคำนวณทางคณิตศาสตร์ได้เพียงแค่รับคำสั่งเช่น “47 คูณ 89 เท่ากับเท่าไหร่?” — โดยไม่ต้องเขียนตรรกะหรือสร้าง API แบบกำหนดเอง

## ภาพรวม

บทเรียนนี้จะสอนวิธีเชื่อมต่อเซิร์ฟเวอร์ MCP เครื่องคิดเลขกับเอเจนต์โดยใช้ส่วนขยาย [AI Toolkit](https://aka.ms/AIToolkit) ใน Visual Studio Code เพื่อให้เอเจนต์ของคุณสามารถทำการคำนวณ เช่น การบวก ลบ คูณ และหาร ผ่านภาษาธรรมชาติ

AI Toolkit เป็นส่วนขยายที่ทรงพลังสำหรับ Visual Studio Code ที่ช่วยให้การพัฒนาเอเจนต์เป็นไปอย่างราบรื่น วิศวกร AI สามารถสร้างแอปพลิเคชัน AI ได้อย่างง่ายดายโดยการพัฒนาและทดสอบโมเดล generative AI — ทั้งในเครื่องและบนคลาวด์ ส่วนขยายนี้รองรับโมเดล generative หลักๆ ที่มีอยู่ในปัจจุบัน
...
- กำหนดค่าเอเจนต์เพื่อให้ค้นหาและใช้งานเครื่องมือที่เซิร์ฟเวอร์ MCP ให้มาได้
- ใช้เครื่องมือ MCP ผ่านภาษาธรรมชาติ

## แนวทาง

นี่คือแนวทางระดับสูงที่เราจะทำ:
...
ในแบบฝึกหัดนี้ คุณจะสร้าง รัน และพัฒนาเอเจนต์ AI ด้วยเครื่องมือจากเซิร์ฟเวอร์ MCP ภายใน Visual Studio Code โดยใช้ AI Toolkit
...
![ภาพหน้าจออินเทอร์เฟซการเลือกโมเดลในส่วนขยาย AI Toolkit ของ Visual Studio Code หัวข้อ “Find the right model for your AI Solution” พร้อมคำอธิบายให้ค้นหา ทดสอบ และใช้งานโมเดล AI ด้านล่างในส่วน “Popular Models” มีการ์ดโมเดล 6 ตัว: DeepSeek-R1 (โฮสต์บน GitHub), OpenAI GPT-4o, OpenAI GPT-4.1, OpenAI o1, Phi 4 Mini (CPU - เล็ก, เร็ว), และ DeepSeek-R1 (โฮสต์บน Ollama) แต่ละการ์ดมีตัวเลือก “Add” และ “Try in Playground”](../../../../translated_images/aitk-model-catalog.2acd38953bb9c119aa629fe74ef34cc56e4eed35e7f5acba7cd0a59e614ab335.th.png)
...
![ภาพหน้าจออินเทอร์เฟซ "Calculator Agent" ใน AI Toolkit ของ Visual Studio Code มีหน้าต่างโมดัลชื่อ "Generate a prompt" อธิบายว่าคุณสามารถสร้าง prompt template โดยการกรอกรายละเอียดพื้นฐาน มีช่องข้อความตัวอย่าง system prompt: "You are a helpful and efficient math assistant. When given a problem involving basic arithmetic, you respond with the correct result." ด้านล่างมีปุ่ม "Close" และ "Generate" พื้นหลังแสดงการตั้งค่าเอเจนต์ รวมถึงโมเดลที่เลือก "OpenAI GPT-4o (via GitHub)" และช่อง system กับ user prompt](../../../../translated_images/aitk-generate-prompt.ba9e69d3d2bbe2a26444d0c78775540b14196061eee32c2054e9ee68c4f51f3a.th.png)
...
เมื่อคุณกำหนด system prompt ของเอเจนต์แล้ว — เพื่อชี้นำพฤติกรรมและการตอบสนอง — ถึงเวลาติดตั้งความสามารถใช้งานจริง ในส่วนนี้ คุณจะสร้างเซิร์ฟเวอร์ MCP เครื่องคิดเลขที่มีเครื่องมือสำหรับบวก ลบ คูณ และหาร เซิร์ฟเวอร์นี้จะช่วยให้เอเจนต์ของคุณทำการคำนวณแบบเรียลไทม์ตามคำสั่งภาษาธรรมชาติ

![ภาพหน้าจอส่วนล่างของอินเทอร์เฟซ Calculator Agent ในส่วนขยาย AI Toolkit ของ Visual Studio Code แสดงเมนูขยาย “Tools” และ “Structure output” พร้อมเมนูดรอปดาวน์ “Choose output format” ตั้งค่าเป็น “text” ด้านขวาเป็นปุ่ม “+ MCP Server” สำหรับเพิ่มเซิร์ฟเวอร์ Model Context Protocol มีไอคอนรูปภาพแสดงเหนือส่วน Tools](../../../../translated_images/aitk-add-mcp-server.9742cfddfe808353c0caf9cc0a7ed3e80e13abf4d2ebde315c81c3cb02a2a449.th.png)

AI Toolkit มาพร้อมเทมเพลตเพื่อความสะดวกในการสร้างเซิร์ฟเวอร์ MCP ของคุณเอง เราจะใช้เทมเพลต Python สำหรับสร้างเซิร์ฟเวอร์ MCP เครื่องคิดเลข
...
11. ในมุมมอง **Explorer** ของ **Activity Bar** ขยายไดเรกทอรี **src** และเลือกไฟล์ **server.py** เพื่อเปิดใน editor
...
เมื่อเอเจนต์ของคุณมีเครื่องมือแล้ว ถึงเวลานำไปใช้! ในส่วนนี้ คุณจะส่งคำสั่งไปยังเอเจนต์เพื่อทดสอบและตรวจสอบว่าเอเจนต์ใช้เครื่องมือที่เหมาะสมจากเซิร์ฟเวอร์ MCP เครื่องคิดเลขหรือไม่

![ภาพหน้าจออินเทอร์เฟซ Calculator Agent ในส่วนขยาย AI Toolkit ของ Visual Studio Code แผงซ้ายใต้ “Tools” มีเซิร์ฟเวอร์ MCP ชื่อ local-server-calculator_server พร้อมเครื่องมือสี่ตัว: add, subtract, multiply, และ divide มีป้ายแสดงว่าเครื่องมือสี่ตัวเปิดใช้งาน ด้านล่างเป็นส่วน “Structure output” ที่พับเก็บ และปุ่ม “Run” สีฟ้า แผงขวาใต้ “Model Response” เอเจนต์เรียกใช้เครื่องมือ multiply และ subtract โดยมีอินพุต {"a": 3, "b": 25} และ {"a": 75, "b": 20} ตามลำดับ ผลลัพธ์ “Tool Response” สุดท้ายแสดงเป็น 75.0 มีปุ่ม “View Code” ที่ด้านล่าง](../../../../translated_images/aitk-agent-response-with-tools.e7c781869dc8041a25f9903ed4f7e8e0c7e13d7d94f6786a6c51b1e172f56866.th.png)

คุณจะรันเซิร์ฟเวอร์ MCP เครื่องคิดเลขบนเครื่องพัฒนาของคุณผ่าน **Agent Builder** ในฐานะไคลเอนต์ MCP

1. กด `F5` เพื่อเริ่มดีบักเซิร์ฟเวอร์ MCP **Agent (Prompt) Builder** จะเปิดแท็บ editor ใหม่ สถานะเซิร์ฟเวอร์จะแสดงในเทอร์มินัล
...
4. ตรวจสอบผลลัพธ์เอเจนต์ โมเดลควรสรุปว่าคุณจ่ายเงิน **$55**
...
7. เมื่อทดสอบเสร็จแล้ว คุณสามารถหยุดเซิร์ฟเวอร์ได้โดยใช้คำสั่ง **CTRL/CMD+C** ในเทอร์มินัล

## การบ้าน

ลองเพิ่มเครื่องมือใหม่ในไฟล์ **server.py** ของคุณ (เช่น คืนค่ารากที่สองของตัวเลข) ส่งคำสั่งเพิ่มเติมที่ต้องใช้เครื่องมือใหม่ (หรือเครื่องมือเดิม) อย่าลืมรีสตาร์ทเซิร์ฟเวอร์เพื่อโหลดเครื่องมือที่เพิ่มเข้ามา
...
- คุณสามารถเพิ่มเครื่องมือใหม่ให้กับเซิร์ฟเวอร์ MCP เพื่อขยายขีดความสามารถของเอเจนต์ให้ตอบโจทย์ความต้องการที่เปลี่ยนแปลงได้
- AI Toolkit มีเทมเพลต (เช่น เทมเพลตเซิร์ฟเวอร์ MCP สำหรับ Python) เพื่อช่วยให้การสร้างเครื่องมือแบบกำหนดเองง่ายขึ้น
