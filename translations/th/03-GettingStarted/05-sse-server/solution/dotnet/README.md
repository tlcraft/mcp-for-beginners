...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T20:10:16+00:00",
...
เมื่อเซิร์ฟเวอร์ทำงานในเทอร์มินัลหนึ่ง ให้เปิดเทอร์มินัลอีกอันแล้วรันคำสั่งต่อไปนี้:
...
> ตรวจสอบให้แน่ใจว่าเลือก **SSE** เป็นประเภทการส่งข้อมูล และ URL เป็น `http://localhost:3001/sse`
...
> ![!TIP]
> โดยปกติแล้วการรัน inspector ในโหมด CLI จะเร็วกว่าการรันในเบราว์เซอร์มาก
