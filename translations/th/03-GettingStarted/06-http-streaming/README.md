...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-10T16:13:12+00:00",
...
- **stdio**: การรับ/ส่งข้อมูลมาตรฐาน เหมาะสำหรับเครื่องมือที่ทำงานในเครื่องและ CLI ง่ายแต่ไม่เหมาะกับเว็บหรือคลาวด์
...
- **Streamable HTTP**: การขนส่งสตรีมมิ่งผ่าน HTTP สมัยใหม่ รองรับการแจ้งเตือนและขยายตัวได้ดีกว่า แนะนำสำหรับการใช้งานในสภาพแวดล้อมการผลิตและคลาวด์ส่วนใหญ่
...
> **คำแนะนำ:** การเลือกกลไกการขนส่งที่เหมาะสมส่งผลต่อประสิทธิภาพ การขยายตัว และประสบการณ์ผู้ใช้ **Streamable HTTP** เป็นตัวเลือกที่แนะนำสำหรับแอปพลิเคชันสมัยใหม่ที่ต้องการขยายตัวและพร้อมใช้งานบนคลาวด์
...
**การสตรีม** คือเทคนิคในโปรแกรมเครือข่ายที่อนุญาตให้ส่งและรับข้อมูลเป็นชิ้นเล็ก ๆ หรือเป็นลำดับของเหตุการณ์ แทนที่จะรอให้ข้อมูลทั้งหมดพร้อมก่อนส่ง เหมาะอย่างยิ่งสำหรับ:
...
ตัวอย่างนี้แสดงให้เห็นเซิร์ฟเวอร์ส่งข้อความเป็นชุด ๆ ไปยังไคลเอนต์ทันทีที่พร้อม แทนที่จะรอให้ข้อความทั้งหมดพร้อมก่อน
...
- **การใช้งานไคลเอนต์:**
   ...
   - MCP: ไคลเอนต์ที่ซับซ้อนขึ้น มีตัวจัดการข้อความเพื่อประมวลผลข้อความหลายประเภท
...
มีข้อแนะนำบางประการเมื่อเลือกใช้งานระหว่างการสตรีมแบบคลาสสิก (เช่น จุดสิ้นสุด `/stream` ที่แสดงไว้ข้างต้น) กับการสตรีมผ่าน MCP

- **สำหรับความต้องการสตรีมง่าย ๆ:** การสตรีม HTTP แบบคลาสสิกง่ายต่อการใช้งานและเพียงพอสำหรับความต้องการพื้นฐาน

- **สำหรับแอปพลิเคชันที่ซับซ้อนและโต้ตอบได้:** MCP Streaming ให้แนวทางที่มีโครงสร้างมากขึ้น พร้อมเมตาดาต้าที่สมบูรณ์และแยกระหว่างการแจ้งเตือนกับผลลัพธ์สุดท้าย

- **สำหรับแอป AI:** ระบบแจ้งเตือนของ MCP มีประโยชน์มากสำหรับงาน AI ที่ใช้เวลานานซึ่งต้องการแจ้งความคืบหน้าให้ผู้ใช้ทราบ

## การสตรีมใน MCP

ตอนนี้คุณได้เห็นคำแนะนำและการเปรียบเทียบระหว่างการสตรีมแบบคลาสสิกกับ MCP แล้ว มาดูรายละเอียดว่าคุณจะใช้การสตรีมใน MCP ได้อย่างไร

การเข้าใจวิธีการทำงานของการสตรีมในกรอบงาน MCP เป็นสิ่งจำเป็นสำหรับการสร้างแอปที่ตอบสนองและให้ข้อมูลเรียลไทม์แก่ผู้ใช้ในระหว่างการทำงานที่ใช้เวลานาน

ใน MCP การสตรีมไม่ได้หมายถึงการส่งผลลัพธ์หลักเป็นชิ้น ๆ แต่หมายถึงการส่ง **การแจ้งเตือน** ไปยังไคลเอนต์ในขณะที่เครื่องมือกำลังประมวลผลคำขอ การแจ้งเตือนเหล่านี้อาจรวมถึงการอัปเดตความคืบหน้า บันทึก หรือเหตุการณ์อื่น ๆ
...
เราใช้คำว่า "การแจ้งเตือน" ในบริบทของ MCP หมายถึงอะไร?
...
> [!NOTE]
> ขึ้นอยู่กับ SDK ที่ใช้ ระบบ logging อาจเปิดใช้งานโดยอัตโนมัติ หรือคุณอาจต้องเปิดใช้งานด้วยตนเองในคอนฟิกเซิร์ฟเวอร์
...
นอกจากนี้ เพื่อเปิดใช้งานการแจ้งเตือน ให้แน่ใจว่าเซิร์ฟเวอร์ของคุณใช้กลไกการขนส่งแบบสตรีม (เช่น `streamable-http`) และไคลเอนต์ของคุณมีตัวจัดการข้อความเพื่อประมวลผลการแจ้งเตือน นี่คือตัวอย่างการตั้งค่าเซิร์ฟเวอร์ให้ใช้กลไก `streamable-http`:
...
เพื่อเปิดใช้งานการแจ้งเตือนในเซิร์ฟเวอร์ MCP ของคุณ ให้แน่ใจว่าใช้กลไกการขนส่งแบบสตรีม:
...
เพื่อเปิดใช้งานการแจ้งเตือน ให้แน่ใจว่าเซิร์ฟเวอร์ของคุณใช้กลไกการขนส่งแบบสตรีม (เช่น `streamable-http`) และไคลเอนต์ของคุณมีตัวจัดการข้อความเพื่อประมวลผลการแจ้งเตือน
...
การแจ้งเตือนความคืบหน้าเป็นข้อความเรียลไทม์ที่ส่งจากเซิร์ฟเวอร์ไปยังไคลเอนต์ในระหว่างการทำงานที่ใช้เวลานาน แทนที่จะรอจนกระบวนการทั้งหมดเสร็จสิ้น เซิร์ฟเวอร์จะอัปเดตสถานะปัจจุบันให้ไคลเอนต์ทราบอย่างต่อเนื่อง ช่วยเพิ่มความโปร่งใส ประสบการณ์ผู้ใช้ และทำให้ง่ายต่อการดีบัก
...
เมื่อพัฒนาเซิร์ฟเวอร์ MCP ที่ใช้การสื่อสารผ่าน HTTP ความปลอดภัยจะเป็นเรื่องสำคัญที่ต้องให้ความใส่ใจอย่างรอบคอบในหลายๆ ด้านของการโจมตีและมาตรการป้องกัน
...
- **การผูกกับ localhost**: สำหรับการพัฒนาในเครื่อง ควรผูกเซิร์ฟเวอร์กับ `localhost` เพื่อไม่ให้เปิดเผยสู่สาธารณะ
- **การพิสูจน์ตัวตน**: ควรใช้ระบบพิสูจน์ตัวตน (เช่น API keys, OAuth) ในการใช้งานจริง
- **CORS**: ตั้งค่านโยบาย Cross-Origin Resource Sharing (CORS) เพื่อจำกัดการเข้าถึง
- **HTTPS**: ใช้ HTTPS ในการใช้งานจริงเพื่อเข้ารหัสข้อมูลที่ส่งผ่าน
...
- เป็นวิธีการส่งข้อมูลที่แนะนำสำหรับแอป MCP ใหม่ๆ
...
- คุณสามารถรองรับทั้ง SSE และ Streamable HTTP โดยรันทั้งสองแบบบน endpoint ที่ต่างกัน
- ค่อยๆ ย้ายลูกค้าไปยังวิธีการส่งข้อมูลใหม่

### ความท้าทาย

ควรแก้ไขความท้าทายเหล่านี้ในระหว่างการย้าย:

- การอัปเดตลูกค้าทุกตัวให้ทันสมัย
...
นอกจากนี้ นี่คือแนวทางปฏิบัติที่ดีที่สุดเมื่อพัฒนาด้านความปลอดภัยในเซิร์ฟเวอร์สตรีม MCP ของคุณ:
...
คุณจะพบกับความท้าทายบางอย่างเมื่อพัฒนาด้านความปลอดภัยในเซิร์ฟเวอร์สตรีม MCP:
...
เพื่อเดินหน้าต่อกับการสตรีม MCP และขยายความรู้ของคุณ ส่วนนี้มีแหล่งข้อมูลเพิ่มเติมและขั้นตอนแนะนำสำหรับการสร้างแอปพลิเคชันที่ซับซ้อนขึ้น
...
- ลองสร้างเครื่องมือ MCP ที่ซับซ้อนขึ้นโดยใช้การสตรีมสำหรับการวิเคราะห์แบบเรียลไทม์ แชท หรือการแก้ไขร่วมกัน
