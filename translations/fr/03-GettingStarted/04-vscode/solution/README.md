...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-18T05:45:50+00:00",
  "source_file": "03-GettingStarted/04-vscode/solution/README.md",
  "language_code": "fr"
}
-->
Cela correspond à exécuter une commande comme suit : `node build/index.js`.
...
- Type a prompt in your chat window that matches the description of your tool. For example to trigger the tool `add` tapez quelque chose comme "add 3 to 20".
    ...
    Sélectionner l'outil devrait produire un résultat numérique indiquant "23" si votre invite était comme mentionné précédemment.
