...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-16T14:58:09+00:00",
...
Cet exemple implique d'avoir un LLM côté client. Le LLM nécessite que vous exécutiez cela dans un Codespaces ou que vous configuriez un token d'accès personnel dans GitHub pour que cela fonctionne.
