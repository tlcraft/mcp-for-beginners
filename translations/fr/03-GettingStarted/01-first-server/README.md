...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-02T10:25:16+00:00",
...
L'inspecteur est un excellent outil qui peut lancer votre serveur et vous permet d'interagir avec lui pour vérifier son bon fonctionnement. Démarrons-le :
...
- Les phases de test et de débogage sont essentielles pour garantir la fiabilité des implémentations MCP
...
3. Lancez l’outil inspector pour vérifier que le serveur fonctionne correctement.
