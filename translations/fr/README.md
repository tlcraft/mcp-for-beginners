...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-20T15:32:13+00:00",
...
|--|--|--|--|
| 00 | **Introduction au MCP** | Vue d’ensemble du Model Context Protocol et son importance dans les pipelines IA, incluant ce qu’est le MCP, pourquoi la standardisation est essentielle, ainsi que des cas d’usage et bénéfices concrets | [Introduction](./00-Introduction/README.md) |
...
| 3.7 | **Tester votre serveur** | Les tests sont une étape clé du développement. Cette section vous montre comment utiliser plusieurs outils différents pour tester. | [Tester votre serveur](./03-GettingStarted/07-testing/README.md) |
...
les droits d’utiliser votre contribution. Pour plus de détails, rendez-vous sur <https://cla.opensource.microsoft.com>.
