...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-11T14:30:30+00:00",
...
Que vous soyez développeur IA, architecte système ou ingénieur logiciel, ce guide est votre ressource complète pour maîtriser les bases du MCP et ses stratégies de mise en œuvre.
...
## 🧭 Structure complète du programme MCP

| Ch | Titre | Description | Lien |
|--|--|--|--|
| 00 | **Introduction au MCP** | Présentation du Model Context Protocol et de son importance dans les pipelines IA, y compris ce qu’est le Model Context Protocol, pourquoi la standardisation est essentielle, ainsi que des cas d’usage pratiques et leurs avantages | [Introduction](./00-Introduction/README.md) |
| 01 | **Concepts fondamentaux expliqués** | Exploration approfondie des concepts clés du MCP, y compris l’architecture client-serveur, les composants principaux du protocole et les modèles de messagerie | [Concepts fondamentaux](./01-CoreConcepts/README.md) |
...
| 03 | **Premiers pas avec MCP** | Configuration de l’environnement, création de serveurs et clients MCP basiques, intégration de MCP avec des applications existantes | [Premiers pas](./03-GettingStarted/README.md) |
...
| 3.6 | **Utiliser AI Toolkit** | AI Toolkit est un excellent outil pour gérer vos flux de travail IA et MCP. | [Utiliser AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
| 3.7 | **Tester votre serveur** | Les tests sont une étape importante du développement. Cette section vous aide à tester avec plusieurs outils différents. | [Tester votre serveur](./03-GettingStarted/07-testing/README.md) |
| 3.8 | **Déployer votre serveur** | Comment passer du développement local à la production ? Cette section vous accompagne pour développer et déployer votre serveur. | [Déployer votre serveur](./03-GettingStarted/08-deployment/README.md) |
| 04 | **Mise en œuvre pratique** | Utilisation des SDK dans différents langages, débogage, tests et validation, création de modèles de prompt et workflows réutilisables | [Mise en œuvre pratique](./04-PracticalImplementation/README.md) |
...
| 5.2 | **Multimodalité** | Comment travailler avec différentes modalités comme les images et plus | [Multimodalité](./05-AdvancedTopics/mcp-multi-modality/README.md) |
| 5.3 | **Démo MCP OAuth2** | Application Spring Boot minimaliste montrant OAuth2 avec MCP, à la fois comme serveur d’autorisation et serveur de ressources. Démontre l’émission sécurisée de tokens, les endpoints protégés, le déploiement sur Azure Container Apps et l’intégration API Management. | [Démo MCP OAuth2](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
| 5.4 | **Contextes racines** | En savoir plus sur les contextes racines et comment les implémenter | [Contextes racines](./05-AdvancedTopics/mcp-root-contexts/README.md) |
...
| 5.7 | **Montée en charge** | Apprendre à faire évoluer les serveurs MCP, y compris les stratégies d’échelle horizontale et verticale, l’optimisation des ressources et l’ajustement des performances | [Montée en charge](./05-AdvancedTopics/mcp-scaling/README.md) |
| 5.8 | **Sécurité** | Sécuriser votre serveur MCP, y compris l’authentification, l’autorisation et les stratégies de protection des données | [Sécurité](./05-AdvancedTopics/mcp-security/README.md) |
| 5.9 | **Web Search MCP** | Serveur et client MCP en Python intégrant SerpAPI pour la recherche web, d’actualités, de produits et Q&R en temps réel. Démontre l’orchestration multi-outils, l’intégration d’API externes et la gestion robuste des erreurs | [Web Search MCP](./05-AdvancedTopics/web-search-mcp/README.md) |
| 5.10 | **Streaming en temps réel** | Le streaming de données en temps réel est devenu essentiel dans un monde axé sur les données, où entreprises et applications ont besoin d’un accès immédiat à l’information pour prendre des décisions rapides. | [Streaming en temps réel](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
| 06 | **Contributions de la communauté** | Comment contribuer au code et à la documentation, collaborer via GitHub, améliorations et retours pilotés par la communauté | [Contributions de la communauté](./06-CommunityContributions/README.md) |
...
| 08 | **Bonnes pratiques pour MCP** | Optimisation des performances, conception de systèmes MCP tolérants aux pannes, stratégies de test et de résilience | [Bonnes pratiques](./08-BestPractices/README.md) |
| 09 | **Études de cas MCP** | Analyses approfondies des architectures de solutions MCP, plans de déploiement et conseils d’intégration, diagrammes annotés et parcours de projets | [Case Studies](./09-CaseStudy/README.md) |
| 10 | **Optimisation des flux de travail IA : Création d’un serveur MCP avec AI Toolkit** | Atelier pratique complet combinant MCP avec l’AI Toolkit de Microsoft pour VS Code. Apprenez à développer des applications intelligentes reliant des modèles IA à des outils réels via des modules pratiques couvrant les bases, le développement de serveurs personnalisés et les stratégies de déploiement en production. | [Hands On Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |

## Projets exemples

### 🧮 Projets exemples MCP Calculator :
<details>
...
<details>
  <summary><strong>Découvrez des exemples avancés</strong></summary>

  - [Exemple avancé en C#](./04-PracticalImplementation/samples/csharp/README.md)
  - [Exemple d’application conteneur en Java](./04-PracticalImplementation/samples/java/containerapp/README.md)
...
Un [Guide d’étude](./study_guide.md) complet est disponible pour vous aider à naviguer efficacement dans ce dépôt. Le guide inclut :
...
Ce projet peut contenir des marques déposées ou des logos pour des projets, produits ou services. L'utilisation autorisée des marques ou logos Microsoft est soumise aux conditions des  
...
L'utilisation des marques ou logos Microsoft dans des versions modifiées de ce projet ne doit pas prêter à confusion ni laisser penser à un parrainage de Microsoft.  
