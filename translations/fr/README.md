...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T10:50:07+00:00",
...
### ➡️ Regardez à la demande - MCP Dev Days  
...
- Démonstrations réelles avec VS Code, Visual Studio, GitHub Copilot et des outils communautaires populaires  
- Flux de travail pratiques et axés sur le contexte  
- Sessions et perspectives dirigées par la communauté  
Que vous débutiez avec MCP ou que vous construisiez déjà avec, le Jour 1 vous inspirera et vous fournira des actions concrètes.  
...
| 00 | Introduction à MCP | Vue d'ensemble du Model Context Protocol et de son importance dans les pipelines IA | [En savoir plus](./00-Introduction/README.md) |
...
| 3.5 | Serveur SSE | Créez des serveurs utilisant les événements envoyés par le serveur (SSE) | [Guide](./03-GettingStarted/05-sse-server/README.md) |
...
| RUST | Exemple de conteneur | [Voir le code](.03-GettingStarted/samples/rust/README.md) |
...
Ce projet peut contenir des marques ou logos pour des projets, produits ou services. L'utilisation autorisée des marques ou logos Microsoft est soumise aux [Directives sur les marques et la marque de Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
