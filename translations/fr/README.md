...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T06:50:49+00:00",
...
- 📜 [Spécification MCP originale](https://spec.modelcontextprotocol.io/) – Références techniques héritées (peut contenir des détails supplémentaires)  
...
| 00 | Introduction à MCP | Vue d'ensemble du protocole de contexte de modèle et de son importance dans les pipelines IA | [En savoir plus](./00-Introduction/README.md) |
...
| 3.7 | Outils IA | Utilisez l'outil IA avec MCP | [Guide](./03-GettingStarted/07-aitk/README.md) |
...
| **Module 6-10 : Communauté et bonnes pratiques** | | | |
| 06 | Contributions communautaires | Comment contribuer à l'écosystème MCP | [Guide](./06-CommunityContributions/README.md) |
| 07 | Leçons des premières adoptions | Histoires d'implémentation dans le monde réel | [Guide](./07-LessonsFromEarlyAdoption/README.md) |
...
| 10 | Atelier pratique | Construire un serveur MCP avec l'outil IA | [Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
| Langage | Description | Lien |
|---------|-------------|------|
| C# | Exemple avancé | [View Code](./04-PracticalImplementation/samples/csharp/README.md) |
| Java avec Spring | Exemple d'application conteneur | [View Code](./04-PracticalImplementation/samples/java/containerapp/README.md) |
| JavaScript | Exemple avancé | [View Code](./04-PracticalImplementation/samples/javascript/README.md) |
| Python | Implémentation complexe | [View Code](../../04-PracticalImplementation/samples/python/READMEmd) |
| TypeScript | Exemple de conteneur | [View Code](./04-PracticalImplementation/samples/typescript/README.md) |
...
- (Optionnel) Des notions en concepts IA/ML
...
Préparez-vous à deux jours d'approfondissement technique, de connexion communautaire et d'apprentissage pratique lors des MCP Dev Days, un événement virtuel dédié au Model Context Protocol (MCP) — la norme émergente qui relie les modèles IA et les outils qu'ils utilisent.  
...
Que vous débutiez avec MCP ou que vous construisiez déjà avec, le Jour 1 vous inspirera et vous donnera des conseils pratiques.
...
Ce projet peut contenir des marques ou logos pour des projets, produits ou services. L'utilisation autorisée des marques ou logos Microsoft est soumise aux [Directives de marque et d'identité de Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
