...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-02T11:49:39+00:00",
...
|--|--|--|--|
| 00 | **Introduction au MCP** | Présentation du Model Context Protocol et de son importance dans les pipelines IA, incluant ce qu’est le Model Context Protocol, pourquoi la standardisation est essentielle, ainsi que des cas pratiques et bénéfices | [Introduction](./00-Introduction/README.md) |
| 01 | **Concepts fondamentaux expliqués** | Exploration approfondie des concepts clés du MCP, incluant l’architecture client-serveur, les composants principaux du protocole et les modèles de messagerie | [Concepts fondamentaux](./01-CoreConcepts/README.md) |
...
| 3.6 | **Utiliser AI Toolkit** | AI Toolkit est un excellent outil qui vous aidera à gérer votre flux de travail IA et MCP. | [Utiliser AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
| 3.7 | **Tester votre serveur** | Les tests sont une étape importante du développement. Cette section vous aidera à tester avec plusieurs outils différents. | [Tester votre serveur](./03-GettingStarted/07-testing/README.md) |
...
| 05 | **Sujets avancés du MCP** | Workflows IA multimodaux et extensibilité, stratégies de montée en charge sécurisée, MCP dans les écosystèmes d’entreprise | [Sujets avancés](./05-AdvancedTopics/README.md) |
| 5.1 | **Démo MCP OAuth2** | Implémentation de l’authentification OAuth2 avec les serveurs MCP, incluant la validation des tokens d’accès, l’autorisation basée sur les scopes et la protection sécurisée des points d’API | [Démo MCP OAuth2](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
| 5.2 | **Recherche web avec MCP** | Implémentation de capacités de recherche web via le Model Context Protocol, incluant le traitement des requêtes, la gestion des résultats et l’intégration avec des APIs de recherche | [Recherche web MCP](./05-AdvancedTopics/web-search-mcp/README.md) |
...
| 09 | **Études de cas MCP** | Analyses approfondies des architectures de solutions MCP, plans de déploiement et conseils d’intégration, schémas annotés et présentation de projets | [Études de cas](./09-CaseStudy/README.md) |
