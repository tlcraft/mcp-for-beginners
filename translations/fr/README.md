...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-20T20:07:19+00:00",
...
| 3.6 | **Utiliser AI Toolkit** | AI Toolkit est un outil efficace qui vous aide à gérer votre workflow IA et MCP. | [Utiliser AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
| 3.7 | **Tester votre serveur** | Les tests sont une étape cruciale du développement. Cette section vous montre comment utiliser plusieurs outils différents pour tester votre serveur. | [Tester votre serveur](./03-GettingStarted/07-testing/README.md) |
...
| 05 | **Sujets avancés dans MCP** | Workflows IA multimodaux et extensibilité, stratégies sécurisées de montée en charge, MCP dans les écosystèmes d’entreprise | [Sujets avancés](./05-AdvancedTopics/README.md) |
...
Ce projet peut contenir des marques déposées ou des logos pour des projets, produits ou services. L’utilisation autorisée des marques ou logos Microsoft est soumise aux
[Directives sur les marques et la marque déposée de Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
L’usage des marques ou logos Microsoft dans des versions modifiées de ce projet ne doit pas prêter à confusion ni laisser entendre un parrainage par Microsoft.
