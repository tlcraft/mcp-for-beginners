...
Ce jour est destiné aux constructeurs MCP. Nous approfondirons les stratégies d'implémentation et les meilleures pratiques pour créer des serveurs MCP et intégrer MCP dans vos flux de travail IA.
...
| 5.13 | Intégration Foundry | Intégrer avec Azure AI Foundry | [Guide](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
...
| 07 | Retours des Premiers Adopteurs | Histoires d'implémentation dans le monde réel | [Guide](./07-LessonsFromEarlyAdoption/README.md) |
...
| 10 | Atelier Pratique | Construire un serveur MCP avec l'AI Toolkit | [Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
