...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T12:51:07+00:00",
...
Ce laboratoire fournit des instructions complètes pour mettre en œuvre la surveillance, l'observabilité et les alertes pour votre serveur MCP dans des environnements de production. Vous apprendrez à configurer Application Insights, créer des tableaux de bord pertinents, mettre en place des systèmes d'alerte efficaces et établir des workflows de dépannage pour une excellence opérationnelle.

## Vue d'ensemble

Une surveillance et une observabilité efficaces sont essentielles pour maintenir des serveurs MCP fiables en production. Ce laboratoire couvre les trois piliers de l'observabilité—les métriques, les journaux et les traces—et vous montre comment mettre en œuvre une surveillance complète permettant une détection proactive des problèmes et une résolution rapide.

Vous apprendrez à transformer des données de télémétrie brutes en informations exploitables qui vous aideront à comprendre le comportement du système, optimiser les performances et garantir une haute disponibilité.

## Objectifs d'apprentissage

À la fin de ce laboratoire, vous serez capable de :

- **Mettre en œuvre** une intégration complète d'Application Insights pour les serveurs MCP  
- **Concevoir** des modèles de journalisation structurée pour un dépannage efficace  
- **Créer** des systèmes de collecte et d'analyse des métriques de performance  
- **Configurer** des alertes intelligentes avec des notifications exploitables  
- **Construire** des tableaux de bord opérationnels pour une surveillance en temps réel  
- **Établir** des workflows de dépannage efficaces et des runbooks  
...
### Journalisation améliorée avec des données structurées
...
### Mise en œuvre de tableaux de bord personnalisés
...
✅ **Intégration d'Application Insights** : Configuration complète de la télémétrie et de la surveillance  
✅ **Journalisation structurée** : Journalisation prête pour la production avec corrélation et contexte  
✅ **Métriques personnalisées** : Collecte et analyse des métriques métier et techniques  
✅ **Alertes intelligentes** : Alertes proactives avec plusieurs canaux de notification  
✅ **Tableaux de bord opérationnels** : Surveillance en temps réel et informations métier  
✅ **Workflows de dépannage** : Diagnostics automatisés et runbooks opérationnels  

## 🚀 Et après ?

Poursuivez avec **[Lab 12 : Bonnes pratiques et optimisation](../12-Best-Practices/README.md)** pour :

- Appliquer des techniques d'optimisation des performances  
- Mettre en œuvre un renforcement complet de la sécurité  
- Apprendre les meilleures pratiques de déploiement en production  
- Établir des stratégies d'optimisation des coûts  

## 📚 Ressources supplémentaires

### Azure Monitor
- [Documentation Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Guide complet de surveillance  
- [Référence des requêtes KQL](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Langage de requête pour Application Insights  
- [Workbooks Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - Création de tableaux de bord personnalisés  

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - Guide d'instrumentation  
- [Traces distribuées](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - Concepts de traçage  
- [Collecte de métriques](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - Bonnes pratiques pour les métriques  

### Excellence opérationnelle
- [Manuel SRE](https://sre.google/sre-book/table-of-contents/) - Principes de l'ingénierie de fiabilité des sites  
- [Bonnes pratiques de surveillance](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - Bonnes pratiques du secteur  
- [Gestion des incidents](https://response.pagerduty.com/) - Guide de gestion des incidents  

---

**Précédent** : [Lab 10 : Stratégies de déploiement](../10-Deployment/README.md)  
**Suivant** : [Lab 12 : Bonnes pratiques et optimisation](../12-Best-Practices/README.md)  
