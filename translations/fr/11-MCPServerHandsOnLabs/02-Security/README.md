...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T12:47:56+00:00",
...
Ce laboratoire fournit des conseils complets sur la mise en œuvre de la sécurité de niveau entreprise et du multi-tenancy pour les serveurs MCP. Vous apprendrez à concevoir des systèmes sécurisés et conformes qui protègent les données sensibles du commerce tout en permettant des modèles d'accès flexibles pour plusieurs locataires.

## Aperçu

La sécurité est essentielle dans les applications de commerce qui traitent des données clients, des informations de paiement et de l'intelligence commerciale. Ce laboratoire couvre l'architecture complète de sécurité, de l'authentification et l'autorisation à l'isolation des données et la surveillance de la conformité.

Nous mettons en œuvre une stratégie de défense en profondeur combinant les services d'identité Azure, la sécurité au niveau des lignes de PostgreSQL, des contrôles au niveau des applications et une journalisation complète des audits pour créer une plateforme robuste et conforme.

## Objectifs d'apprentissage

À la fin de ce laboratoire, vous serez capable de :

- **Mettre en œuvre** une sécurité au niveau des lignes de qualité entreprise pour l'isolation des données multi-locataires  
- **Concevoir** des modèles sécurisés d'authentification et d'autorisation avec Azure  
- **Configurer** une journalisation complète des audits pour répondre aux exigences de conformité  
- **Appliquer** des stratégies de sécurité en profondeur à tous les niveaux de l'application  
- **Valider** les implémentations de sécurité par des tests systématiques  
- **Surveiller** les événements de sécurité et répondre aux menaces potentielles  

## 🔐 Architecture de sécurité multi-locataires

### Aperçu des couches de sécurité
...
Notre implémentation utilise le modèle **Base de données partagée, Schéma partagé** avec la sécurité au niveau des lignes :

**Avantages :**
- Utilisation rentable des ressources  
- Maintenance et mises à jour simplifiées  
- Isolation forte des données grâce à RLS  
- Traçabilité des audits conforme  

**Inconvénients :**
- Nécessite une conception minutieuse des politiques RLS  
- Les modifications du schéma affectent tous les locataires  
- Besoin de procédures robustes de sauvegarde/restauration  

## 🛡️ Mise en œuvre de la sécurité au niveau des lignes
...
### Gestion du contexte des magasins
...
### Intégration avec Azure Entra ID
...
### Vues de surveillance de la sécurité
...
### Liste de contrôle pour les tests de pénétration
...
✅ **Sécurité multi-locataires** : Mis en œuvre la sécurité au niveau des lignes pour une isolation complète des données  
✅ **Authentification Azure** : Intégré Azure Entra ID avec validation JWT  
✅ **Autorisation basée sur les rôles** : Configuré un système hiérarchique de rôles et permissions  
✅ **Journalisation complète des audits** : Établi le suivi et la surveillance des événements de sécurité  
✅ **Tests de sécurité** : Mis en œuvre des tests de validation de sécurité automatisés  
✅ **Surveillance des menaces** : Créé une détection et des alertes en temps réel pour les événements de sécurité  

## 🚀 Et après

Continuez avec **[Lab 03 : Configuration de l'environnement](../03-Setup/README.md)** pour :

- Configurer des environnements de développement avec les meilleures pratiques de sécurité  
- Mettre en place des services Azure pour l'authentification et la surveillance  
- Implémenter des connexions sécurisées à la base de données et la gestion des secrets  
- Valider les configurations de sécurité dans les environnements de développement  

## 📚 Ressources supplémentaires

### Sécurité Azure
- [Documentation Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - Guide complet de la plateforme d'identité  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Service de gestion des secrets  
- [Meilleures pratiques de sécurité Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Conseils en matière de sécurité  

### Sécurité des bases de données
- [Sécurité au niveau des lignes PostgreSQL](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Documentation officielle de RLS  
- [Liste de contrôle de sécurité des bases de données](https://www.postgresql.org/docs/current/security.html) - Guide de sécurité PostgreSQL  
- [Modèles de bases de données multi-locataires](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Modèles d'architecture  

### Tests de sécurité
- [Guide de test OWASP](https://owasp.org/www-project-web-security-testing-guide/) - Tests de sécurité complets  
- [Meilleures pratiques de sécurité JWT](https://tools.ietf.org/html/rfc8725) - Considérations sur la sécurité des JWT  
- [Tests de sécurité API](https://owasp.org/www-project-api-security/) - Tests de sécurité spécifiques aux API  

---

**Précédent** : [Lab 01 : Concepts d'architecture de base](../01-Architecture/README.md)  
**Suivant** : [Lab 03 : Configuration de l'environnement](../03-Setup/README.md)  
