...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T12:59:08+00:00",
...
Ce laboratoire fournit des instructions détaillées pour déployer votre serveur MCP retail dans des environnements de production en utilisant des approches modernes de conteneurisation et de cloud-native. Vous apprendrez à déployer des serveurs MCP évolutifs, sécurisés et surveillés capables de gérer des charges de travail d'entreprise.

## Aperçu

Le déploiement en production des serveurs MCP nécessite une attention particulière à la conteneurisation, l'orchestration, la sécurité, l'évolutivité et la surveillance. Ce laboratoire couvre le déploiement sur Azure Container Apps avec PostgreSQL Flexible Server, la mise en œuvre de pipelines CI/CD et la configuration de l'auto-scaling pour des charges de travail variables.

Les stratégies de déploiement vont des déploiements simples à conteneur unique pour le développement à des environnements de production sophistiqués multi-régions avec auto-scaling, surveillance complète et fonctionnalités de sécurité avancées.

## Objectifs d'apprentissage

À la fin de ce laboratoire, vous serez capable de :

- **Conteneuriser** les serveurs MCP avec Docker en utilisant des builds multi-étapes
- **Déployer** sur Azure Container Apps avec un réseau sécurisé
- **Configurer** PostgreSQL en production avec haute disponibilité
- **Implémenter** des pipelines CI/CD pour des déploiements automatisés
- **Faire évoluer** les applications automatiquement en fonction de la demande
- **Surveiller** les déploiements en production avec une observabilité complète
...
## ☁️ Déploiement sur Azure Container Apps
...
✅ **Stratégie de Conteneurisation** : Conteneurs Docker prêts pour la production avec renforcement de la sécurité  
✅ **Déploiement Cloud** : Azure Container Apps avec auto-scaling et surveillance  
✅ **Déploiement de Base de Données** : PostgreSQL Flexible Server avec haute disponibilité  
✅ **Pipelines CI/CD** : Workflows automatisés de test, build et déploiement  
✅ **Surveillance des Performances** : Collecte complète de métriques et alertes  
✅ **Configuration de Sécurité** : Politiques de sécurité de niveau production et isolation réseau  

## 🚀 Et ensuite

Continuez avec **[Lab 11 : Surveillance et Observabilité](../11-Monitoring/README.md)** pour :

- Configurer une surveillance complète avec Application Insights
- Mettre en place une journalisation structurée et un traçage distribué
- Implémenter des systèmes d'alerte et de réponse automatisée
- Surveiller les métriques métier et les indicateurs de performance clés

## 📚 Ressources Supplémentaires

### Technologies de Conteneurisation
- [Bonnes Pratiques Docker](https://docs.docker.com/develop/dev-best-practices/) - Bonnes pratiques officielles Docker
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Documentation Azure Container Apps
- [Documentation Kubernetes](https://kubernetes.io/docs/) - Documentation officielle Kubernetes

### CI/CD et DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - Documentation GitHub Actions
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Services Azure DevOps
- [Infrastructure as Code](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Documentation Azure Bicep

### Sécurité et Surveillance
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Recommandations de sécurité Azure
- [Sécurité des Conteneurs](https://kubernetes.io/docs/concepts/security/) - Concepts de sécurité Kubernetes
...
**Précédent** : [Lab 09 : Intégration VS Code](../09-VS-Code/README.md)  
**Suivant** : [Lab 11 : Surveillance et Observabilité](../11-Monitoring/README.md)
