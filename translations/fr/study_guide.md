...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-11T16:35:01+00:00",
...
5. **Implémentation pratique (04-PracticalImplementation/)**
   ...
   - Techniques de débogage, tests et validation
...
6. **Sujets avancés (05-AdvancedTopics/)**
   ...
   - Thèmes spécialisés incluant intégration Azure, multimodalité, OAuth2, contextes racines, routage, échantillonnage, montée en charge, sécurité, intégration recherche web et streaming.
...
8. **Leçons des premières adopteurs (07-LessonsfromEarlyAdoption/)**
   - Implémentations concrètes et retours d’expérience
...
10. **Études de cas (09-CaseStudy/)**
    ...
    - Diagrammes annotés et parcours de projets

11. **Atelier pratique (10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/)**
    - Atelier complet combinant MCP et AI Toolkit de Microsoft pour VS Code
...
Le dépôt comprend plusieurs projets exemples illustrant l’implémentation de MCP dans différents langages :

### Exemples basiques de calculatrice MCP
- Exemple serveur MCP en C#
...
Le dépôt contient des ressources de support :
...
5. **Participation communautaire** : Rejoignez le [Azure AI Foundry Discord](https://discord.com/invite/ByRwuEEgH4) pour échanger avec des experts et d’autres développeurs.
