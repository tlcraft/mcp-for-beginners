...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-02T19:41:11+00:00",
...
L'échantillonnage est un élément crucial du Model Context Protocol (MCP) qui permet un traitement et un routage efficaces des requêtes. Il consiste à analyser les requêtes entrantes afin de déterminer le modèle ou le service le plus approprié pour les traiter, en se basant sur divers critères tels que le type de contenu, le contexte utilisateur et la charge du système.
...
- [Échantillonnage](../mcp-sampling/README.md)
