...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T16:46:26+00:00",
...
> **Nota:** Le informazioni seguenti sono corrette al **29 maggio 2025**. Il protocollo MCP è in continua evoluzione e le future implementazioni potrebbero introdurre nuovi schemi di autenticazione e controlli. Per aggiornamenti e indicazioni più recenti, fai sempre riferimento alla [Specificazione MCP](https://spec.modelcontextprotocol.io/) e al repository ufficiale [MCP GitHub](https://github.com/modelcontextprotocol) e alla [pagina delle best practice di sicurezza](https://modelcontextprotocol.io/specification/draft/basic/security_best_practices).
...
- **Prompt Injection Cross-Domain:** Istruzioni malevole sono nascoste in documenti, pagine web o email, che vengono poi processati dall’AI, causando perdite o manipolazioni di dati.
...
5. **Integrazione con Azure Content Safety:** Prompt Shields fanno parte della suite più ampia Azure AI Content Safety, che offre ulteriori strumenti per rilevare tentativi di jailbreak, contenuti dannosi e altri rischi di sicurezza nelle applicazioni AI.
...
-   Best practice di coding sicuro nella tua applicazione AI – proteggersi contro [l’OWASP Top 10](https://owasp.org/www-project-top-ten/), l’[OWASP Top 10 per LLM](https://genai.owasp.org/download/43299/?tmstv=1731900559), uso di vault sicuri per segreti e token, implementazione di comunicazioni sicure end-to-end tra tutti i componenti dell’applicazione, ecc.
-   Hardening del server – utilizza MFA dove possibile, mantieni aggiornate le patch, integra il server con un provider di identità di terze parti per l’accesso, ecc.
...
- MCP introduce nuovi rischi — come prompt injection, avvelenamento degli strumenti e permessi eccessivi — che richiedono controlli sia tradizionali che specifici per l’AI.
...
- Proteggiti da prompt injection indiretta e avvelenamento degli strumenti validando i metadati degli strumenti, monitorando cambiamenti dinamici e utilizzando soluzioni come Microsoft Prompt Shields.
