...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T17:02:45+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "it"
}
-->
# Progettazione del Database e Schema

## 🎯 Cosa Copre Questo Laboratorio

Questo laboratorio approfondisce la progettazione del database PostgreSQL per il sistema Zava Retail. Imparerai a implementare uno schema retail completo con capacità di ricerca vettoriale, modellazione multi-tenant e Row Level Security (RLS) per l'isolamento dei dati.

## Panoramica

Il database è la base del nostro server MCP, archiviando dati retail di più negozi e mantenendo un rigoroso isolamento dei dati. Utilizziamo PostgreSQL con l'estensione pgvector per abilitare capacità di ricerca semantica, permettendo ai clienti di trovare prodotti utilizzando query in linguaggio naturale.

Il nostro schema segue modelli multi-tenant moderni con Row Level Security che garantisce agli utenti l'accesso solo ai dati dei negozi autorizzati. Questo approccio offre sicurezza di livello aziendale mantenendo prestazioni ottimali.

## Obiettivi di Apprendimento

Alla fine di questo laboratorio, sarai in grado di:

- **Progettare** schemi di database retail multi-tenant scalabili
- **Implementare** PostgreSQL con pgvector per la ricerca vettoriale
- **Configurare** Row Level Security per l'isolamento dei dati
- **Generare** dati di esempio realistici per i test
- **Ottimizzare** le prestazioni del database per carichi di lavoro retail
...
Il nostro database sfrutta le funzionalità aziendali di PostgreSQL combinate con l'estensione pgvector per la ricerca basata sull'intelligenza artificiale:
...
Il database utilizza un modello di multi-tenancy **shared database, shared schema** con Row Level Security:
...
## 📊 Progettazione dello Schema Principale

### Tabella Stores (Master dei Tenant)
...
### Tabella Products con Categorie
...
### Tabella degli Embedding dei Prodotti
...
### Funzioni di Ricerca Vettoriale
...
## 🔐 Configurazione della Row Level Security
...
### Script per Dati di Test Realistici
...
Dopo aver completato questo laboratorio, dovresti essere in grado di:

✅ **Progettazione del Database Multi-Tenant**: Implementare Row Level Security per un isolamento sicuro dei dati  
✅ **Capacità di Ricerca Vettoriale**: Configurare pgvector per la ricerca semantica dei prodotti  
✅ **Schema Completo**: Creare uno schema di database retail pronto per la produzione  
✅ **Generazione di Dati di Esempio**: Costruire dati di test realistici per sviluppo e test  
✅ **Ottimizzazione delle Prestazioni**: Configurare indici e ottimizzazione delle query  
✅ **Backup e Ripristino**: Stabilire strategie robuste di protezione dei dati  

## 🚀 Prossimi Passi

Continua con **[Lab 05: Implementazione del Server MCP](../05-MCP-Server/README.md)** per:

- Costruire il server FastMCP che si connette a questo database
- Implementare strumenti di query del database per il protocollo MCP
- Aggiungere capacità di ricerca semantica utilizzando gli embedding
- Configurare il pooling delle connessioni e la gestione degli errori

## 📚 Risorse Aggiuntive

### PostgreSQL & pgvector
- [Documentazione PostgreSQL](https://www.postgresql.org/docs/) - Riferimento completo di PostgreSQL
- [Estensione pgvector](https://github.com/pgvector/pgvector) - Ricerca di similarità vettoriale per PostgreSQL
- [Ottimizzazione delle Prestazioni PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Best practice per l'ottimizzazione

### Architettura Multi-Tenant
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Documentazione RLS di PostgreSQL
- [Architettura dei Dati Multi-Tenant](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Modelli di architettura Azure
- [Best Practice per la Sicurezza del Database](https://www.postgresql.org/docs/current/security.html) - Guida alla sicurezza di PostgreSQL

### Database Vettoriali
- [Fondamenti della Ricerca Vettoriale](https://www.pinecone.io/learn/vector-database/) - Comprendere i database vettoriali
- [Modelli di Embedding](https://platform.openai.com/docs/guides/embeddings) - Documentazione sugli embedding di OpenAI
- [Algoritmo HNSW](https://arxiv.org/abs/1603.09320) - Grafi Hierarchical Navigable Small World

---

**Precedente**: [Lab 03: Configurazione dell'Ambiente](../03-Setup/README.md)  
**Successivo**: [Lab 05: Implementazione del Server MCP](../05-MCP-Server/README.md)
