...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T17:05:29+00:00",
...
Истраживање објављено у [Microsoft Digital Defense Report](https://aka.ms/mddr) наводи да би 98% пријављених безбедносних пропуста било спречено уз робусну безбедносну хигијену, а најбоља заштита од било каквог пропуста је да се обезбеди основна безбедносна хигијена, најбоље праксе безбедног програмирања и безбедност ланца снабдевања — оне проверене праксе које већ знамо да највише утичу на смањење безбедносног ризика.
...
### Контроле за ублажавање
- **Примена принципа најмањих привилегија:** Доделите MCP серверу само минималне дозволе потребне за извршавање задатака. Редовно прегледајте и ажурирајте ове дозволе како бисте осигурали да не прелазе потребе. За детаљне смернице, погледајте [Secure least-privileged access](https://learn.microsoft.com/entra/identity-platform/secure-least-privileged-access).
...
- **Праћење и ревизија дозвола:** Континуирано пратите коришћење дозвола и ревидирајте логове приступа како бисте брзо открили и исправили прекомерне или неискоришћене привилегије.
...
- **Prompt Injection напади**: Нападачи убацују злонамерна упутства у prompt-ове или спољни садржај, што узрокује да AI систем изврши нежељене радње или процури осетљиве податке. Сазнајте више: [Prompt Injection](https://simonwillison.net/2025/Apr/9/mcp-prompt-injection/)
...
- **Одржавајте безбедне процесе деплоја:** Користите аутоматизоване CI/CD процесе са интегрисаним безбедносним скенирањем како бисте рано открили проблеме. Осигурајте да се у продукцију шаљу само поуздани артефакти.
...
- **Примените принцип најмањих привилегија и контролу приступа:** Ограничите приступ моделима, подацима и услугама само на оно што је неопходно за рад вашег MCP сервера.
- **Брзо реагујте на претње:** Имајте успостављен процес за исправљање или замену компромитованих компоненти, као и за ротацију тајни или акредитива у случају откривања пропуста.

[GitHub Advanced Security](https://github.com/security/advanced-security) пружа функције као што су скенирање тајни, скенирање зависности и CodeQL анализа. Ови алати се интегришу са [Azure DevOps](https://azure.microsoft.com/en-us/products/devops) и [Azure Repos](https://azure.microsoft.com/en-us/products/devops/repos/) како би тимови могли да идентификују и ублаже рањивости како у коду, тако и у компонентама AI ланца снабдевања.

Microsoft такође примењује опсежне праксе безбедности ланца снабдевања унутар компаније за све производе. Сазнајте више у [The Journey to Secure the Software Supply Chain at Microsoft](https://devblogs.microsoft.com/engineering-at-microsoft/the-journey-to-secure-the-software-supply-chain-at-microsoft/).


# Успостављене најбоље праксе безбедности које ће побољшати безбедносни положај ваше MCP имплементације

Свака MCP имплементација наследи постојећи безбедносни положај окружења ваше организације на којем је изграђена, па када разматрате безбедност MCP као компонената ваших укупних AI система, препоручује се да радите на унапређењу вашег укупног постојећег безбедносног положаја. Следеће успостављене безбедносне контроле су посебно релевантне:

-   Најбоље праксе безбедног кодирања у вашој AI апликацији – заштита од [OWASP Top 10](https://owasp.org/www-project-top-ten/), [OWASP Top 10 за LLM-ове](https://genai.owasp.org/download/43299/?tmstv=1731900559), коришћење безбедних складишта за тајне и токене, имплементација крај-до-краја безбедне комуникације између свих компоненти апликације итд.
...
-   Безбедносни надзор – имплементирање логовања и праћења AI апликације (укључујући MCP клијенте/сервере) и слање тих логова у централни SIEM ради откривања аномалних активности
-   Zero trust архитектура – изолација компоненти путем мрежних и идентитетских контрола на логички начин како би се минимализовало бочно кретање у случају компромитовања AI апликације.

# Кључне поуке

- Основе безбедности остају критичне: безбедно кодирање, најмање привилегије, верификација ланца снабдевања и континуирани надзор су неопходни за MCP и AI радне оптерећења.
...
- [Prompt Injection у MCP (Simon Willison)](https://simonwillison.net/2025/Apr/9/mcp-prompt-injection/)
- [Tool Poisoning напади (Invariant Labs)](https://invariantlabs.ai/blog/mcp-security-notification-tool-poisoning-attacks)
- [Rug Pulls у MCP (Wiz Security)](https://www.wiz.io/blog/mcp-security-research-briefing#remote-servers-22)
- [Prompt Shields документација (Microsoft)](https://learn.microsoft.com/azure/ai-services/content-safety/concepts/jailbreak-detection)
- [OWASP Top 10](https://owasp.org/www-project-top-ten/)
- [OWASP Top 10 за LLM-ове](https://genai.owasp.org/download/43299/?tmstv=1731900559)
...
- [Azure API Management као Auth Gateway за MCP](https://techcommunity.microsoft.com/blog/integrationsonazureblog/azure-api-management-your-auth-gateway-for-mcp-servers/4402690)
- [MCP Security Best Practice](https://modelcontextprotocol.io/specification/draft/basic/security_best_practices)
- [Коришћење Microsoft Entra ID за аутентификацију са MCP серверима](https://den.dev/blog/mcp-server-auth-entra-id-session/)
