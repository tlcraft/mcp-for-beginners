...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:14:35+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "sr"
}
-->
# Безбедност и мултитенантност

## 🎯 Шта овај лаб покрива

Овај лаб пружа свеобухватне смернице за имплементацију безбедности на нивоу предузећа и мултитенантности за MCP сервере. Научићете како да дизајнирате сигурне и усклађене системе који штите осетљиве податке из малопродаје, уз омогућавање флексибилних приступних модела за више корисника.

## Преглед

Безбедност је од суштинског значаја у малопродајним апликацијама које обрађују податке о купцима, информације о плаћању и пословну интелигенцију. Овај лаб покрива комплетну архитектуру безбедности, од аутентификације и ауторизације до изолације података и праћења усклађености.

Примењујемо стратегију "одбрана у дубини" која комбинује Azure услуге идентитета, PostgreSQL Row Level Security, контроле на нивоу апликације и свеобухватно логовање ради креирања робусне и усклађене платформе.

## Циљеви учења

На крају овог лаба, бићете у могућности да:

- **Имплементирате** Row Level Security на нивоу предузећа за изолацију података у мултитенант окружењу  
- **Дизајнирате** сигурне моделе аутентификације и ауторизације уз Azure  
- **Конфигуришете** свеобухватно логовање ради испуњавања захтева усклађености  
- **Примените** стратегије безбедности "одбрана у дубини" кроз све слојеве апликације  
- **Потврдите** имплементацију безбедности кроз систематско тестирање  
- **Пратите** безбедносне догађаје и реагујете на потенцијалне претње  

## 🔐 Архитектура безбедности за мултитенантност

### Преглед слојева безбедности
...
### Модели мултитенантности

Наша имплементација користи модел **Заједничка база података, заједничка шема** уз Row Level Security:

**Предности:**
- Исплативо коришћење ресурса  
- Поједностављено одржавање и ажурирање  
- Јака изолација података кроз RLS  
- Логови погодни за усклађеност  

**Недостаци:**
- Захтева пажљив дизајн RLS политика  
- Промене у шеми утичу на све кориснике  
- Потребне су робусне процедуре за резервне копије и враћање података  

## 🛡️ Имплементација Row Level Security
...
### Управљање контекстом продавнице
...
### Прегледи за праћење безбедности
...
## 🧪 Тестирање и валидација безбедности

### Аутоматизовани безбедносни тестови
...
### Контролна листа за пенетрационо тестирање
...
Након завршетка овог лаба, требало би да имате:

✅ **Безбедност за мултитенантност**: Имплементиран Row Level Security за потпуну изолацију података  
✅ **Azure аутентификацију**: Интегрисан Azure Entra ID са JWT валидацијом  
✅ **Ауторизацију засновану на улогама**: Конфигурисан хијерархијски систем улога и дозвола  
✅ **Свеобухватно логовање**: Успостављено праћење и мониторинг безбедносних догађаја  
✅ **Тестирање безбедности**: Имплементирани аутоматизовани тестови за валидацију безбедности  
✅ **Праћење претњи**: Креирано откривање и упозорење у реалном времену за безбедносне догађаје  

## 🚀 Шта следи

Наставите са **[Лаб 03: Постављање окружења](../03-Setup/README.md)** да бисте:

- Конфигурисали развојна окружења уз најбоље праксе за безбедност  
- Поставили Azure услуге за аутентификацију и мониторинг  
- Имплементирали сигурне везе са базом података и управљање тајнама  
- Потврдили конфигурације безбедности у развојним окружењима  

## 📚 Додатни ресурси

### Azure безбедност
- [Azure Entra ID документација](https://docs.microsoft.com/azure/active-directory/) - Комплетан водич за платформу идентитета  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Услуга за управљање тајнама  
- [Azure најбоље праксе за безбедност](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Смернице за безбедност  

### Безбедност базе података
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Званична документација за RLS  
- [Контролна листа за безбедност базе података](https://www.postgresql.org/docs/current/security.html) - Водич за безбедност PostgreSQL-а  
- [Модели мултитенант базе података](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Архитектонски модели  

### Тестирање безбедности
- [OWASP водич за тестирање](https://owasp.org/www-project-web-security-testing-guide/) - Свеобухватно тестирање безбедности  
- [Најбоље праксе за JWT безбедност](https://tools.ietf.org/html/rfc8725) - Препоруке за безбедност JWT-а  
- [Тестирање безбедности API-ја](https://owasp.org/www-project-api-security/) - Тестирање специфично за API безбедност  

---

**Претходно**: [Лаб 01: Основни концепти архитектуре](../01-Architecture/README.md)  
**Следеће**: [Лаб 03: Постављање окружења](../03-Setup/README.md)  
