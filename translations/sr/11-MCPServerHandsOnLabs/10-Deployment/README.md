...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:30:55+00:00",
  "source_file": "11-MCPServerHandsOnLabs/10-Deployment/README.md",
  "language_code": "sr"
}
-->
# Стратегије за распоређивање

## 🎯 Шта овај лабораторијски рад покрива

Овај лабораторијски рад пружа свеобухватне смернице за распоређивање вашег MCP серверa за малопродају у продукциона окружења користећи савремене методе контејнеризације и cloud-native приступе. Научићете како да распоредите скалабилне, безбедне и надгледане MCP сервере који могу да обрађују пословне оптерећења.

## Преглед

Распоређивање MCP сервера у продукцију захтева пажљиво разматрање контејнеризације, оркестрације, безбедности, скалабилности и надгледања. Овај лабораторијски рад покрива распоређивање на Azure Container Apps са PostgreSQL Flexible Server, имплементацију CI/CD цевовода и конфигурацију аутоматског скалирања за променљива оптерећења.

Стратегије распоређивања се крећу од једноставних распоређивања са једним контејнером за развој до сложених продукционих окружења са више региона, аутоматским скалирањем, свеобухватним надгледањем и безбедносним функцијама.

## Циљеви учења

На крају овог лабораторијског рада, бићете у могућности да:

- **Контејнеризујете** MCP сервере користећи Docker са мултифазним билдовима
- **Распоредите** на Azure Container Apps са безбедним умрежавањем
- **Конфигуришете** PostgreSQL за продукцију са високом доступношћу
- **Имплементирате** CI/CD цевоводе за аутоматско распоређивање
- **Скалабилност** апликација аутоматски на основу потражње
- **Надгледате** продукциона распоређивања са свеобухватном опсервабилношћу

## 🐳 Docker контејнеризација

### Мултифазни Dockerfile
...
## ☁️ Распоређивање на Azure Container Apps
...
## 🔐 Конфигурација безбедности за продукцију
...
✅ **Стратегију контејнера**: Docker контејнере спремне за продукцију са ојачаном безбедношћу  
✅ **Cloud распоређивање**: Azure Container Apps са аутоматским скалирањем и надгледањем  
✅ **Распоређивање базе података**: PostgreSQL Flexible Server са високом доступношћу  
✅ **CI/CD цевоводе**: Аутоматизоване радне токове за тестирање, билдовање и распоређивање  
✅ **Надгледање перформанси**: Свеобухватно прикупљање метрика и упозорења  
✅ **Конфигурацију безбедности**: Безбедносне политике спремне за продукцију и изолацију мреже  

## 🚀 Шта следи

Наставите са **[Лабораторијским радом 11: Надгледање и опсервабилност](../11-Monitoring/README.md)** да бисте:

- Поставили свеобухватно надгледање са Application Insights
- Конфигурисали структурисано логовање и дистрибуирано праћење
- Имплементирали упозорења и системе за аутоматски одговор
- Надгледали пословне метрике и KPI перформанси

## 📚 Додатни ресурси

### Технологије контејнера
- [Docker најбоље праксе](https://docs.docker.com/develop/dev-best-practices/) - Званичне Docker најбоље праксе
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Документација за Azure Container Apps
- [Документација за Kubernetes](https://kubernetes.io/docs/) - Званична документација за Kubernetes

### CI/CD и DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - Документација за GitHub Actions
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Услуге Azure DevOps
- [Инфраструктура као код](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Документација за Azure Bicep

### Безбедност и надгледање
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Препоруке за безбедност Azure-а
- [Безбедност контејнера](https://kubernetes.io/docs/concepts/security/) - Концепти безбедности Kubernetes-а
...
**Претходно**: [Лабораторијски рад 09: Интеграција са VS Code](../09-VS-Code/README.md)  
**Следеће**: [Лабораторијски рад 11: Надгледање и опсервабилност](../11-Monitoring/README.md)
