...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:19:24+00:00",
  "source_file": "11-MCPServerHandsOnLabs/11-Monitoring/README.md",
  "language_code": "sr"
}
-->
# Надзор и Опсервабилност

## 🎯 Шта овај лабораторијски рад покрива

Овај лабораторијски рад пружа свеобухватне смернице за имплементацију надзора, опсервабилности и упозорења за ваш MCP сервер у продукцијским окружењима. Научићете како да подесите Application Insights, креирате значајне контролне табле, имплементирате ефикасна упозорења и успоставите радне токове за решавање проблема ради оперативне изврсности.

## Преглед

Ефикасан надзор и опсервабилност су кључни за одржавање поузданих MCP сервера у продукцији. Овај лабораторијски рад покрива три стуба опсервабилности—метрике, логове и трагове—и показује вам како да имплементирате свеобухватан надзор који омогућава проактивно откривање проблема и брзо решавање.

Научићете како да трансформишете сирове телеметријске податке у корисне увиде који вам помажу да разумете понашање система, оптимизујете перформансе и обезбедите високу доступност.

## Циљеви учења

До краја овог лабораторијског рада, бићете у могућности да:

- **Имплементирате** свеобухватну интеграцију Application Insights за MCP сервере
- **Дизајнирате** структуралне шаблоне логова за ефикасно решавање проблема
- **Креирате** системе за прикупљање и анализу перформансних метрика
- **Конфигуришете** интелигентна упозорења са корисним обавештењима
- **Изградите** оперативне контролне табле за надзор у реалном времену
- **Успоставите** ефикасне радне токове за решавање проблема и упутства

## 📊 Интеграција Application Insights

### Подешавање Application Insights
...
### Побољшано логовање са структуралним подацима
...
### Имплементација прилагођених контролних табли
...
## 🔍 Радни токови за решавање проблема

### Аутоматска дијагностика
...
✅ **Интеграцију Application Insights**: Комплетно подешавање телеметрије и надзора  
✅ **Структурално логовање**: Логовање спремно за продукцију са корелацијом и контекстом  
✅ **Прилагођене метрике**: Прикупљање и анализа пословних и техничких метрика  
✅ **Интелигентна упозорења**: Проактивна упозорења са више канала обавештења  
✅ **Оперативне контролне табле**: Надзор у реалном времену и пословни увиди  
✅ **Радни токови за решавање проблема**: Аутоматска дијагностика и оперативна упутства  

## 🚀 Шта следи

Наставите са **[Лабораторијским радом 12: Најбоље праксе и оптимизација](../12-Best-Practices/README.md)** да бисте:

- Применили технике оптимизације перформанси
- Имплементирали свеобухватно јачање безбедности
- Научили најбоље праксе за продукцијско распоређивање
- Успоставили стратегије оптимизације трошкова

## 📚 Додатни ресурси

### Azure Monitor
- [Документација за Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Комплетан водич за надзор
- [Референца за KQL упите](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Језик упита за Application Insights
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - Креирање прилагођених контролних табли

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - Водич за инструментализацију
- [Дистрибуирано праћење](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - Концепти праћења
- [Прикупљање метрика](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - Најбоље праксе за метрике

### Оперативна изврсност
- [SRE приручник](https://sre.google/sre-book/table-of-contents/) - Принципи Site Reliability Engineering-а
- [Најбоље праксе за надзор](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - Индустријске најбоље праксе
- [Одговор на инциденте](https://response.pagerduty.com/) - Водич за управљање инцидентима

---

**Претходно**: [Лабораторијски рад 10: Стратегије распоређивања](../10-Deployment/README.md)  
**Следеће**: [Лабораторијски рад 12: Најбоље праксе и оптимизација](../12-Best-Practices/README.md)
