...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T14:39:02+00:00",
...
Овај водич показује како да интегришете сервере Model Context Protocol (MCP) са агентима Azure AI Foundry, омогућавајући моћну оркестрацију алата и корпоративне AI могућности.
...
Ова интеграција комбинује флексибилност MCP екосистема алата са робусним оквиром агената Azure AI Foundry, пружајући корпоративна AI решења са широким могућностима прилагођавања.
...
- Подесите MCP сервере за коришћење са агентима Azure AI Foundry
...
### 4. Иницијализација Project Client
...
4. **Шкалирање решења**: Размотрите балансирање оптерећења и дистрибуиране архитектуре MCP сервера
