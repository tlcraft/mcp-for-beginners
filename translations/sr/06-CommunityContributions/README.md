...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T11:41:33+00:00",
...
2. **Развојни тимови алата**: Појединци и тимови који креирају MCP алате и сервере
...
- [Заједнички MCP сервери](https://github.com/modelcontextprotocol/servers?tab=readme-ov-file#-community-servers) - Растућа листа MCP сервера које развија заједница
- [Awesome MCP Servers](https://github.com/wong2/awesome-mcp-servers) - Курирана листа MCP сервера
- [PulseMCP](https://www.pulsemcp.com/) - Заједнички центар и билтен за откривање MCP ресурса
- [Discord сервер](https://discord.gg/jHEGxQu2a5) - Повежите се са MCP развојним инжењерима
...
1. **Једноставност и минимализам**: MCP спецификација поставља високе стандарде за додавање нових концепата. Лакше је додати нешто у спецификацију него уклонити.

2. **Конкретан приступ**: Промене спецификације треба да буду засноване на конкретним изазовима у имплементацији, а не на спекулативним идејама.
...
1. **Почните мало**: Започните са документацијом, исправкама грешака или малим унапређењима
2. **Пратите стил**: Држите се кодексних стилова и конвенција пројекта
3. **Пишите тестове**: Укључите јединичне тестове за своје доприносе коду
...
6. **Одговарајте на повратне информације**: Будите отворени и брзи у одговорима на коментаре
...
2. **Заједнички оквири**:
   - [MCP-Framework](https://mcp-framework.com/) - Креирајте MCP сервере елегантно и брзо у TypeScript-у
   - [MCP Declarative Java SDK](https://github.com/codeboyzhou/mcp-declarative-java-sdk) - MCP сервери са анотацијама у Јави
...
1. **Јасноћу**: Да ли је код јасан и добро документован?
...
2. **Компатибилност клијената**: Размотрите уназадну компатибилност
3. **Компатибилност сервера**: Пратите смернице за имплементацију сервера
4. **Прекидајуће промене**: Јасно документујте све прекидајуће промене
...
3. Креирајте мало унапређење, исправку грешке или алат који ће користити заједници
