...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T19:28:30+00:00",
...
**Сценарио:**
Направите MCP сервер и клијента где сервер обрађује листу ставки (нпр. фајлове или документе) и шаље обавештење за сваку обрађену ставку. Клијент треба да приказује сваки долазни сигнал у реалном времену.
