...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T07:44:56+00:00",
...
## **Научите MCP уз практичне примере кода на C#, Java, JavaScript, Rust, Python и TypeScript**

## 🧠 Преглед наставног плана за Model Context Protocol

**Model Context Protocol (MCP)** је савремени оквир дизајниран за стандардизацију интеракција између AI модела и клијентских апликација. Овај отворени наставни план нуди структуриран пут учења, са практичним примерима кода и стварним случајевима употребе, на популарним програмским језицима као што су C#, Java, JavaScript, TypeScript и Python.
...
- 📜 [Оригинална MCP спецификација](https://spec.modelcontextprotocol.io/) – Наслеђене техничке референце (могу садржати додатне детаље)  
- 🧑‍💻 [MCP GitHub репозиторијум](https://github.com/modelcontextprotocol) – SDK-ови отвореног кода, алати и примери кода
...
| 3.7 | AI алатке | Користите AI алатке са MCP-ом | [Водич](./03-GettingStarted/07-aitk/README.md) |
...
| 5.3 | OAuth2 демонстрација | Имплементирајте OAuth2 аутентикацију | [Водич](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
...
| 5.12 | Entra ID аутентикација | Аутентикација са Microsoft Entra ID | [Водич](./05-AdvancedTopics/mcp-security-entra/README.md) |
...
| 07 | Увид из раног усвајања | Приче о стварној имплементацији | [Водич](./07-LessonsFromEarlyAdoption/README.md) |
...
| 10 | Практична радионица | Изградња MCP сервера са AI алаткама | [Лабораторија](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
- (Опционо) Позадинско знање о концептима вештачке интелигенције/машинског учења
...
- Додатне ресурсе за обогаћивање вашег процеса учења
...
Посвећен је оснаживању програмера да користе MCP у свом радном процесу и прослави невероватне MCP заједнице. Придружиће нам се чланови заједнице и партнери као што су Arcade, Block, Okta и Neon како бисмо видели како сарађују са Microsoft-ом на обликовању отвореног, проширивог MCP екосистема. 
...
Посвећен је MCP програмерима. Детаљно ћемо обрадити стратегије имплементације и најбоље праксе за креирање MCP сервера и интеграцију MCP-а у ваше AI радне токове.
...
Учествујте у интензивним видео сесијама како бисте научили како да креирате MCP сервере, интегришете их са VS Code-ом и професионално их примените на Azure-у на основу садржаја из MCP за почетнике курикулума. Стекните практичне вештине у технологији коју већ користе велике компаније.
...
Contributor License Agreement (CLA) који потврђује да имате право да, и заправо, дате нам
...
## ™️ Обавештење о заштитним знацима
