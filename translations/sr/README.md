...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:01:24+00:00",
...
1. **Forkujte репозиторијум**: Кликните [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
...
| 3.7 | AI Toolkit | Користите AI Toolkit са MCP-ом | [Водич](./03-GettingStarted/07-aitk/README.md) |
| 3.8 | Тестирање | Тестирајте своју MCP серверску имплементацију | [Водич](./03-GettingStarted/08-testing/README.md) |
...
| 07 | Увид из ране примене | Приче о стварним имплементацијама | [Водич](./07-LessonsFromEarlyAdoption/README.md) |
...
| Језик | Опис | Линк |
|----------|-------------|------|
| C# | MCP сервер пример | [Погледајте код](./03-GettingStarted/samples/csharp/README.md) |
...
- Познавање концепата REST и HTTP
- (Опционо) Позадину у концептима AI/ML

- Придруживање дискусијама у нашој заједници ради подршке

## 📚 Водич за учење и ресурси

Овај репозиторијум укључује неколико ресурса који ће вам помоћи да се снађете и учите ефикасно:
...
Припремите се за два дана дубоког техничког увида, повезивања са заједницом и практичног учења на MCP Dev Days, виртуелном догађају посвећеном Model Context Protocol (MCP) — новоизлазећем стандарду који повезује AI моделе и алате на које се ослањају.
Можете гледати MCP Dev Days тако што ћете се регистровати на нашој страници догађаја: https://aka.ms/mcpdevdays. 

#### [Дан 1: MCP продуктивност, DevTools и заједница:](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

Посвећен је оснаживању програмера да користе MCP у свом развојном процесу и прослави невероватне MCP заједнице. Придружиће нам се чланови заједнице и партнери као што су Arcade, Block, Okta и Neon да покажу како сарађују са Microsoft-ом на обликовању отвореног, проширивог MCP екосистема. 
...
Без обзира да ли тек почињете са MCP-ом или већ радите са њим, Дан 1 ће поставити основу са инспирацијом и применљивим закључцима.

#### [Дан 2: Изградите MCP сервере са самопоуздањем](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

Посвећен је MCP градитељима. Ући ћемо дубоко у стратегије имплементације и најбоље праксе за креирање MCP сервера и интеграцију MCP-а у ваше AI радне токове.

#### Теме укључују:

- Изградњу MCP сервера и њихову интеграцију у искуства агената
...
Ако сте програмер, градитељ алата или AI стратег за производе, овај дан је препун увида који су вам потребни за изградњу скалабилних, безбедних и будућности спремних MCP решења.

### MCP Boot Camp август 2025
Учите кроз интензивне видео сесије како да креирате MCP сервере, интегришете их са VS Code-ом и професионално их распоредите на Azure-у, на основу садржаја из MCP за почетнике курикулума. Стекните практичне вештине у технологији коју већ користе велике компаније.
...
Хајде да учимо о Model Context Protocol (MCP), напредном оквиру дизајнираном да стандардизује интеракције између AI модела и клијентских апликација. Кроз ову сесију прилагођену почетницима, упознаћемо вас са MCP-ом и водити вас кроз креирање вашег првог MCP сервера.
...
контактирајте [opencode@microsoft.com](mailto:opencode@microsoft.com) са било којим додатним питањима или коментарима.
