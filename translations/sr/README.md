...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T19:07:18+00:00",
...
| 3.4 | Интеграција са VS Code-ом | Конзумирајте MCP сервере у VS Code-у | [Водич](./03-GettingStarted/04-vscode/README.md) |
...
| 5.6 | Семплинг | Технике семплинга у MCP-у | [Водич](./05-AdvancedTopics/mcp-sampling/README.md) |
...
| 5.13 | Интеграција са Foundry-јем | Интеграција са Azure AI Foundry-јем | [Водич](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
...
| 07 | Увид из ране примене | Приче о стварној имплементацији | [Водич](./07-LessonsFromEarlyAdoption/README.md) |
...
| 10 | Практична радионица | Изградња MCP сервера са AI алатом | [Лабораторија](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
- (Опционо) Позадину у концептима вештачке интелигенције/машинског учења
...
Посвећен је MCP програмерима. Ући ћемо дубоко у стратегије имплементације и најбоље праксе за креирање MCP сервера и интеграцију MCP-а у ваше AI процесе.

#### Теме укључују:

- Изградња MCP сервера и њихова интеграција у искуства агената
...
Учите кроз интензивне видео сесије како да креирате MCP сервере, интегришете их са VS Code-ом и професионално их поставите на Azure, на основу садржаја из MCP за почетнике курикулума. Стекните практичне вештине у технологији коју већ користе велике компаније.
...
Научимо о Model Context Protocol-у (MCP), напредном оквиру дизајнираном да стандардизује интеракције између AI модела и клијентских апликација. Кроз ову сесију прилагођену почетницима, представићемо вам MCP и водити вас кроз креирање вашег првог MCP сервера.
...
Хвала Microsoft Valued Professional-у [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) на доприносу важним примерима кода. 
...
Contributor License Agreement (CLA) који изјављује да имате право да, и заправо дајете, права да користимо ваш допринос. За детаље, посетите 
...
- **Основни курикулум (00-10)**: Главни садржај организован у десет узастопних модула
