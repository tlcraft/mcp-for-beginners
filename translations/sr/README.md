...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-19T22:28:12+00:00",
...
**Model Context Protocol (MCP)** je najsavremeniji okvir dizajniran da standardizuje interakcije između AI modela i klijentskih aplikacija. Ovaj otvoreni kurikulum nudi strukturisan put učenja, sa praktičnim primerima koda i stvarnim slučajevima upotrebe, na popularnim programskim jezicima kao što su C#, Java, JavaScript, TypeScript i Python.
...
| Pogl | Naslov | Opis | Link |
|--|--|--|--|
| 00 | **Uvod u MCP** | Pregled Model Context Protocol-a i njegov značaj u AI procesima, šta je MCP, zašto je standardizacija važna i praktični primeri i benefiti | [Uvod](./00-Introduction/README.md) |
...
| 02 | **Bezbednost u MCP-u** | Prepoznavanje bezbednosnih pretnji u MCP sistemima, tehnike i najbolje prakse za bezbednu implementaciju | [Bezbednost](./02-Security/readme.md) |
...
| 3.4 | **Korišćenje servera kroz Visual Studio Code** | Podešavanje Visual Studio Code-a za korišćenje servera putem MCP protokola | [Korišćenje servera kroz Visual Studio Code](./03-GettingStarted/04-vscode/README.md) |
...
| 3.6 | **Korišćenje AI Toolkit-a** | AI Toolkit je sjajan alat koji će vam pomoći da upravljate vašim AI i MCP radnim tokovima. | [Korišćenje AI Toolkit-a](./03-GettingStarted/06-aitk/README.md) |
...
| 3.8 | **Implementacija servera** | Kako preći sa lokalnog razvoja na produkciju? Ovaj deo će vam pomoći da razvijete i implementirate server. | [Implementacija servera](./03-GettingStarted/08-deployment/README.md) |
...
| 06 | **Doprinos zajednice** | Kako doprineti kodom i dokumentacijom, saradnja putem GitHub-a, unapređenja i povratne informacije iz zajednice | [Doprinos zajednice](./06-CommunityContributions/README.md) |
| 07 | **Iskustva ranih korisnika** | Stvarne implementacije i šta je funkcionisalo, izgradnja i implementacija rešenja zasnovanih na MCP-u, trendovi i budući planovi | [Iskustva](./07-LessonsFromEarlyAdoption/README.md) |
...
| 09 | **MCP studije slučaja** | Detaljni prikazi arhitektura MCP rešenja, šabloni implementacije i saveti za integraciju, anotirane dijagrame i vođene projekte | [Studije slučaja](./09-CaseStudy/README.md) |
...
Ovaj projekat prihvata doprinose i predloge. Većina doprinosa zahteva da pristanete na
Contributor License Agreement (CLA) kojim potvrđujete da imate pravo i da nam zaista dajete
...
CLA i označiti PR na odgovarajući način (npr. status check, komentar). Samo sledite uputstva
koja vam bot da. Ovo treba da uradite samo jednom za sve repozitorijume koji koriste naš CLA.
...
Ovaj projekat može sadržati žigove ili logoe projekata, proizvoda ili usluga. Ovlašćena upotreba Microsoft
žigova ili logotipa podleže i mora se pridržavati
[Microsoft-ovih smernica za upotrebu žigova i brenda](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Upotreba Microsoft-ovih žigova ili logotipa u izmenjenim verzijama ovog projekta ne sme izazvati zabunu niti implicirati sponzorstvo Microsoft-a.
Svaka upotreba žigova ili logotipa trećih strana podleže politikama tih trećih strana.

**Одрицање од одговорности**:  
Овај документ је преведен коришћењем AI преводилачке услуге [Co-op Translator](https://github.com/Azure/co-op-translator). Иако се трудимо да превод буде прецизан, молимо имајте у виду да аутоматизовани преводи могу садржати грешке или нетачности. Оригинални документ на његовом изворном језику треба сматрати ауторитетним извором. За критичне информације препоручује се професионални људски превод. Нисмо одговорни за било какве неспоразуме или погрешне интерпретације настале употребом овог превода.