...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:40:11+00:00",
...
## 🎯 Kaj Pokriva Ta Delavnica

Ta delavnica se poglobi v ustvarjanje naprednih MCP orodij, ki AI asistentom omogočajo zmogljive funkcije za poizvedovanje v podatkovnih bazah, introspekcijo shem in analitiko. Naučili se boste graditi orodja, ki so hkrati zmogljiva in varna, z obsežnim obravnavanjem napak ter optimizacijo zmogljivosti.

## Pregled

MCP orodja so vmesnik med AI asistenti in vašimi podatkovnimi sistemi. Dobro zasnovana orodja omogočajo strukturiran in validiran dostop do kompleksnih operacij, hkrati pa ohranjajo varnost in zmogljivost. Ta delavnica pokriva celoten življenjski cikel razvoja orodij, od zasnove do uvedbe.

Naš maloprodajni MCP strežnik izvaja celovit nabor orodij, ki omogočajo naravno jezikovno poizvedovanje prodajnih podatkov, katalogov izdelkov in poslovne analitike, pri čemer ohranja stroge varnostne meje in optimalno zmogljivost.

## Cilji Učenja

Do konca te delavnice boste sposobni:

- **Zasnovati** napredna MCP orodja s kompleksno validacijo parametrov  
- **Izvesti** varna orodja za poizvedovanje v podatkovnih bazah z zaščito pred SQL injekcijami  
- **Ustvariti** introspekcijske funkcije shem za dinamične poizvedbe  
- **Zgraditi** prilagojena analitična orodja za poslovno inteligenco  
- **Uporabiti** obsežno obravnavanje napak in postopno degradacijo  
- **Optimizirati** zmogljivost orodij za produkcijske obremenitve  

## 🛠️ Osnovna Arhitektura Orodij

### Načela Zasnove Orodij
...
### Validacija Poizvedb in Varnost
...
## 🗃️ Orodja za Poizvedovanje v Podatkovnih Bazah

### Orodje za Analizo Prodaje
...
## 📊 Analitična in Pomožna Orodja

### Orodje za Poslovno Inteligenco
...
Po zaključku te delavnice boste pridobili:

✅ **Napredno Arhitekturo Orodij**: Izvedli sofisticirana MCP orodja z obsežnim obravnavanjem napak  
✅ **Validacijo Poizvedb**: Zgradili varno SQL validacijo za preprečevanje napadov z injekcijami  
✅ **Orodja za Podatkovne Baze**: Ustvarili zmogljive funkcije za analizo prodaje in introspekcijo shem  
✅ **Poslovno Inteligenco**: Razvili analitična orodja za celovite poslovne vpoglede  
✅ **Optimizacijo Zmogljivosti**: Uporabili predpomnjenje, upravljanje povezav in optimizacijo poizvedb  
✅ **Integracijo Varnosti**: Izvedli nadzor dostopa na podlagi vlog in beleženje revizij  

## 🚀 Kaj Sledi

Nadaljujte z **[Delavnico 07: Integracija Semantičnega Iskanja](../07-Semantic-Search/README.md)**, da:

- Integrirate zmogljivosti iskanja vektorjev z MCP orodji  
- Zgradite funkcionalnost semantičnega iskanja izdelkov  
- Izvedete AI-podprto razumevanje poizvedb  
- Ustvarite hibridno iskanje, ki združuje tradicionalne in vektorske poizvedbe  

## 📚 Dodatni Viri

### Razvoj MCP Orodij  
- [Dokumentacija Model Context Protocol](https://modelcontextprotocol.io/docs) - Uradna specifikacija MCP  
- [FastMCP Framework](https://github.com/jlowin/fastmcp) - Python implementacija MCP  
- [Vzorci MCP Orodij](https://github.com/modelcontextprotocol/servers) - Primeri implementacij orodij  

### Varnost Podatkovnih Baz  
- [Preprečevanje SQL Injekcij](https://owasp.org/www-community/attacks/SQL_Injection) - OWASP varnostni vodič  
- [Varnost PostgreSQL](https://www.postgresql.org/docs/current/security.html) - Najboljše prakse za varnost podatkovnih baz  
- [Tehnike Validacije Poizvedb](https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html) - Vzorci za varne poizvedbe  

### Optimizacija Zmogljivosti  
- [Optimizacija Poizvedb v Podatkovnih Bazah](https://www.postgresql.org/docs/current/performance-tips.html) - Vodič za zmogljivost PostgreSQL  
...
- [Vzorci Asinhronega Programiranja v Pythonu](https://docs.python.org/3/library/asyncio.html) - Vodič za asinhrono programiranje  

---

**Prejšnje**: [Delavnica 05: Implementacija MCP Strežnika](../05-MCP-Server/README.md)  
**Naslednje**: [Delavnica 07: Integracija Semantičnega Iskanja](../07-Semantic-Search/README.md)  
