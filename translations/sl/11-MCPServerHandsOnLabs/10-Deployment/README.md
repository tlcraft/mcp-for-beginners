...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:31:28+00:00",
...
Ta laboratorij ponuja celovita navodila za uvajanje vašega MCP strežnika za maloprodajo v produkcijska okolja z uporabo sodobnih pristopov k vsebnikom in tehnologijam, zasnovanim za oblak. Naučili se boste uvajati razširljive, varne in nadzorovane MCP strežnike, ki lahko obvladujejo delovne obremenitve na ravni podjetja.

## Pregled

Produkcijsko uvajanje MCP strežnikov zahteva skrbno načrtovanje glede vsebnikov, orkestracije, varnosti, razširljivosti in nadzora. Ta laboratorij zajema uvajanje v Azure Container Apps z PostgreSQL Flexible Server, implementacijo CI/CD procesov ter konfiguracijo samodejnega skaliranja za spremenljive delovne obremenitve.

Strategije uvajanja segajo od preprostih uvajanj z enim vsebnikom za razvoj do kompleksnih produkcijskih okolij z več regijami, samodejnim skaliranjem ter celovitim nadzorom in varnostnimi funkcijami.

## Cilji učenja

Po zaključku tega laboratorija boste sposobni:

- **Vsebiniti** MCP strežnike z uporabo Dockerja in večstopenjskih graditev
- **Uvajati** v Azure Container Apps z varnim omrežjem
- **Konfigurirati** produkcijsko PostgreSQL z visoko razpoložljivostjo
- **Implementirati** CI/CD procese za avtomatizirano uvajanje
- **Skalirati** aplikacije samodejno glede na povpraševanje
- **Nadzorovati** produkcijska uvajanja z obsežnim opazovanjem

## 🐳 Vsebnik Docker

### Večstopenjski Dockerfile
...
## ☁️ Uvajanje v Azure Container Apps

### Infrastruktura kot koda z Bicepom
...
## 🔐 Konfiguracija varnosti v produkciji
...
✅ **Strategija vsebnikov**: Produkcijsko pripravljeni Docker vsebniki z okrepljeno varnostjo  
✅ **Uvajanje v oblak**: Azure Container Apps z samodejnim skaliranjem in nadzorom  
✅ **Uvajanje podatkovne baze**: PostgreSQL Flexible Server z visoko razpoložljivostjo  
✅ **CI/CD procesi**: Avtomatizirani procesi testiranja, gradnje in uvajanja  
✅ **Nadzor zmogljivosti**: Celovito zbiranje metrik in opozarjanje  
✅ **Konfiguracija varnosti**: Varnostne politike na ravni produkcije in izolacija omrežja  

## 🚀 Kaj sledi

Nadaljujte z **[Laboratorijem 11: Nadzor in opazovanje](../11-Monitoring/README.md)**, kjer boste:

- Nastavili celovit nadzor z Application Insights
- Konfigurirali strukturirano beleženje in porazdeljeno sledenje
- Implementirali opozarjanje in avtomatizirane odzivne sisteme
- Nadzorovali poslovne metrike in kazalnike zmogljivosti

## 📚 Dodatni viri

### Tehnologije vsebnikov
- [Najboljše prakse za Docker](https://docs.docker.com/develop/dev-best-practices/) - Uradne najboljše prakse za Docker
...
### Varnost in nadzor
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Priporočila za varnost v Azure
...
**Prejšnje**: [Laboratorij 09: Integracija z VS Code](../09-VS-Code/README.md)  
**Naslednje**: [Laboratorij 11: Nadzor in opazovanje](../11-Monitoring/README.md)
