...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:04:45+00:00",
...
Ta laboratorij ponuja celovita navodila za testiranje in odpravljanje napak na MCP strežnikih v produkcijskih okoljih. Naučili se boste izvajati zanesljive strategije testiranja, odpravljati kompleksne težave in zagotoviti, da vaš MCP strežnik deluje zanesljivo v različnih pogojih.

## Pregled

Testiranje MCP strežnikov zahteva večplastni pristop, ki vključuje enotske teste, integracijske teste, preverjanje zmogljivosti in testiranje v realnih scenarijih. Ta laboratorij pokriva celoten življenjski cikel testiranja, od razvoja do spremljanja v produkciji.

Naša strategija testiranja poudarja zanesljivost, varnost in zmogljivost, kar zagotavlja, da vaš MCP strežnik lahko obvladuje produkcijske obremenitve, hkrati pa ohranja integriteto podatkov in kakovost uporabniške izkušnje.

## Cilji učenja

Do konca tega laboratorija boste sposobni:

- **Izvajati** celovite enotske in integracijske testne sklope
- **Oblikovati** učinkovite strategije testiranja za MCP orodja in operacije z bazami podatkov
- **Odpravljati** kompleksne težave z naprednimi tehnikami odpravljanja napak
- **Preverjati** zmogljivost pod obremenitvijo z realističnimi testnimi scenariji
- **Spremljati** produkcijske sisteme z učinkovitim opozarjanjem in opazovanjem
- **Avtomatizirati** testne delovne tokove za neprekinjeno integracijo

## 🧪 Arhitektura testiranja

### Pregled strategije testiranja
...
### Testiranje delovnega toka od začetka do konca
...
### Okvir za testiranje obremenitve
...
### Napredni okvir za odpravljanje napak
...
✅ **Celovit okvir za testiranje**: Enotski, integracijski in zmogljivostni testi za vse komponente  
✅ **Napredna orodja za odpravljanje napak**: Sofisticirana orodja za odpravljanje napak z sledenjem izvajanja  
✅ **Preverjanje zmogljivosti**: Testiranje obremenitve in analiza skalabilnosti  
✅ **Varnostno testiranje**: Preprečevanje SQL injekcij in preverjanje RLS  
✅ **Integracija spremljanja**: Meritve zmogljivosti in analiza ozkih grl  
✅ **Pripravljeno za CI/CD**: Avtomatizirani testni delovni tokovi za neprekinjeno integracijo  

## 🚀 Kaj sledi

Nadaljujte z **[Laboratorijem 09: Integracija z VS Code](../09-VS-Code/README.md)**, da:

- Konfigurirate VS Code za razvoj MCP strežnika
- Nastavite okolja za odpravljanje napak v VS Code
- Integrirate MCP strežnik z VS Code Chat
- Testirate celoten delovni tok v VS Code

## 📚 Dodatni viri

### Okviri za testiranje
- [pytest Dokumentacija](https://docs.pytest.org/) - Python okvir za testiranje
- [AsyncPG Testiranje](https://magicstack.github.io/asyncpg/current/index.html) - Testiranje asinhronega PostgreSQL
- [FastAPI Testiranje](https://fastapi.tiangolo.com/tutorial/testing/) - Vzorci testiranja API-jev

### Testiranje zmogljivosti
- [Najboljše prakse testiranja obremenitve](https://docs.python.org/3/library/asyncio.html) - Asinhrono testiranje zmogljivosti
- [Testiranje zmogljivosti baz podatkov](https://www.postgresql.org/docs/current/performance-tips.html) - Optimizacija PostgreSQL
- [Profiliranje pomnilnika](https://docs.python.org/3/library/tracemalloc.html) - Analiza pomnilnika v Pythonu

### Orodja za odpravljanje napak
- [Odpravljanje napak v Pythonu](https://docs.python.org/3/library/pdb.html) - Python razhroščevalnik
- [Odpravljanje napak v asinhronih procesih](https://docs.python.org/3/library/asyncio-dev.html) - Debugging asyncio
- [SQL Odpravljanje napak](https://www.postgresql.org/docs/current/runtime-config-logging.html) - PostgreSQL beleženje

---

**Prejšnje**: [Laboratorij 07: Integracija semantičnega iskanja](../07-Semantic-Search/README.md)  
**Naslednje**: [Laboratorij 09: Integracija z VS Code](../09-VS-Code/README.md)
