...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:37:08+00:00",
...
Nadaljujte z **[Laboratorijem 08: Testiranje in odpravljanje napak](../08-Testing/README.md)**, da:
...
### Azure OpenAI
- [Dokumentacija storitve Azure OpenAI](https://docs.microsoft.com/azure/cognitive-services/openai/) - Celoten vodnik po storitvi
- [Referenca API za vgrajene modele](https://platform.openai.com/docs/api-reference/embeddings) - Dokumentacija API
- [Najboljše prakse za vgrajene modele](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Navodila za implementacijo

### Vektorske baze podatkov
- [Dokumentacija pgvector](https://github.com/pgvector/pgvector) - Razširitev za vektorje v PostgreSQL
- [Optimizacija iskanja po vektorjih](https://www.pinecone.io/learn/vector-search-optimization/) - Prilagoditev zmogljivosti
- [Algoritem HNSW](https://arxiv.org/abs/1603.09320) - Hierarhični navigabilni grafi majhnega sveta

### Semantično iskanje
- [Osnove iskanja informacij](https://nlp.stanford.edu/IR-book/) - Učbenik Stanford IR
- [Najboljše prakse za iskanje po vektorjih](https://weaviate.io/blog/vector-search-best-practices) - Vzorci implementacije
- [Strategije hibridnega iskanja](https://blog.vespa.ai/hybrid-search/) - Kombinacija različnih pristopov iskanja

---

**Prejšnje**: [Laboratorij 06: Razvoj orodij](../06-Tools/README.md)  
**Naslednje**: [Laboratorij 08: Testiranje in odpravljanje napak](../08-Testing/README.md)
