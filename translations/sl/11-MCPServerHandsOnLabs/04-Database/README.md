...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:33:49+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "sl"
}
-->
# Oblikovanje baze podatkov in shema

## 🎯 Kaj zajema ta laboratorij

Ta laboratorij se poglobi v oblikovanje baze podatkov PostgreSQL za sistem Zava Retail. Naučili se boste implementirati celovito shemo za maloprodajo z zmogljivostmi iskanja po vektorjih, modeliranjem podatkov za več najemnikov in varnostjo na ravni vrstic (RLS) za izolacijo podatkov.

## Pregled

Baza podatkov je temelj našega MCP strežnika, ki shranjuje podatke o maloprodaji za več trgovin, hkrati pa ohranja strogo izolacijo podatkov. Uporabljamo PostgreSQL z razširitvijo pgvector, ki omogoča semantične zmogljivosti iskanja, kar strankam omogoča iskanje izdelkov z uporabo naravnega jezika.

Naša shema sledi sodobnim vzorcem za več najemnikov, pri čemer varnost na ravni vrstic zagotavlja, da uporabniki lahko dostopajo le do podatkov iz svojih pooblaščenih trgovin. Ta pristop zagotavlja varnost na ravni podjetja ob ohranjanju optimalne zmogljivosti.

## Cilji učenja

Do konca tega laboratorija boste sposobni:

- **Oblikovati** razširljive sheme baze podatkov za več najemnikov v maloprodaji
- **Implementirati** PostgreSQL z pgvector za iskanje po vektorjih
- **Konfigurirati** varnost na ravni vrstic za izolacijo podatkov
- **Generirati** realistične vzorčne podatke za testiranje
- **Optimizirati** zmogljivost baze podatkov za maloprodajne obremenitve
- **Izvesti** strategije varnostnega kopiranja in obnovitve

## 🗃️ Arhitektura baze podatkov

### PostgreSQL z pgvector

Naša baza podatkov združuje funkcije PostgreSQL na ravni podjetja z razširitvijo pgvector za iskanje, ki ga poganja umetna inteligenca:
...
### Arhitektura za več najemnikov

Baza podatkov uporablja model **skupne baze podatkov, skupne sheme** za več najemnikov z varnostjo na ravni vrstic:
...
## 📊 Osnovna zasnova sheme

### Tabela trgovin (glavna tabela najemnikov)
...
### Tabela izdelkov s kategorijami
...
## 🔍 Implementacija iskanja po vektorjih

### Tabela vektorskih predstavitev izdelkov
...
## 🔐 Nastavitev varnosti na ravni vrstic

### Vloge in dovoljenja v bazi podatkov
...
## 📊 Generiranje vzorčnih podatkov

### Skripta za realistične testne podatke
...
### Pogledi za optimizacijo poizvedb
...
✅ **Oblikovanje baze podatkov za več najemnikov**: Implementirali varnost na ravni vrstic za varno izolacijo podatkov  
✅ **Zmogljivosti iskanja po vektorjih**: Konfigurirali pgvector za semantično iskanje izdelkov  
✅ **Celovita shema**: Ustvarili shemo baze podatkov, pripravljeno za produkcijo  
✅ **Generiranje vzorčnih podatkov**: Zgradili realistične testne podatke za razvoj in testiranje  
✅ **Optimizacija zmogljivosti**: Konfigurirali indekse in optimizacijo poizvedb  
✅ **Varnostno kopiranje in obnovitev**: Vzpostavili robustne strategije zaščite podatkov  

## 🚀 Kaj sledi

Nadaljujte z **[Laboratorijem 05: Implementacija MCP strežnika](../05-MCP-Server/README.md)**, da:

- Zgradite strežnik FastMCP, ki se povezuje s to bazo podatkov
- Implementirate orodja za poizvedbe baze podatkov za MCP protokol
- Dodate zmogljivosti semantičnega iskanja z uporabo vektorskih predstavitev
- Konfigurirate združevanje povezav in obravnavo napak

## 📚 Dodatni viri

### PostgreSQL & pgvector
- [Dokumentacija PostgreSQL](https://www.postgresql.org/docs/) - Celotna referenca PostgreSQL
- [Razširitev pgvector](https://github.com/pgvector/pgvector) - Iskanje po podobnosti vektorjev za PostgreSQL
- [Optimizacija zmogljivosti PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Najboljše prakse za optimizacijo

### Arhitektura za več najemnikov
- [Varnost na ravni vrstic](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Dokumentacija PostgreSQL RLS
- [Arhitektura podatkov za več najemnikov](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Vzorci arhitekture Azure
- [Najboljše prakse za varnost baze podatkov](https://www.postgresql.org/docs/current/security.html) - Vodnik za varnost PostgreSQL

### Vektorske baze podatkov
- [Osnove iskanja po vektorjih](https://www.pinecone.io/learn/vector-database/) - Razumevanje vektorskih baz podatkov
- [Modeli vektorskih predstavitev](https://platform.openai.com/docs/guides/embeddings) - Dokumentacija OpenAI za vektorske predstavitve
- [Algoritem HNSW](https://arxiv.org/abs/1603.09320) - Grafi Hierarchical Navigable Small World

---

**Prejšnje**: [Laboratorij 03: Nastavitev okolja](../03-Setup/README.md)  
**Naslednje**: [Laboratorij 05: Implementacija MCP strežnika](../05-MCP-Server/README.md)
