...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:15:13+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "sl"
}
-->
# Varnost in večnajemništvo

## 🎯 Kaj zajema ta laboratorij

Ta laboratorij ponuja celovita navodila za implementacijo varnosti na ravni podjetja in večnajemništva za strežnike MCP. Naučili se boste oblikovati varne in skladne sisteme, ki ščitijo občutljive podatke o maloprodaji, hkrati pa omogočajo prilagodljive vzorce dostopa za več najemnikov.

## Pregled

Varnost je ključnega pomena v maloprodajnih aplikacijah, ki obravnavajo podatke o strankah, informacije o plačilih in poslovno inteligenco. Ta laboratorij zajema celotno varnostno arhitekturo, od avtentikacije in avtorizacije do izolacije podatkov in spremljanja skladnosti.

Implementiramo strategijo "obramba v globino", ki združuje storitve identitete Azure, Row Level Security v PostgreSQL, kontrolne mehanizme na ravni aplikacije in celovito beleženje dogodkov za ustvarjanje robustne in skladne platforme.

## Cilji učenja

Po zaključku tega laboratorija boste sposobni:

- **Implementirati** Row Level Security na ravni podjetja za izolacijo podatkov med najemniki
- **Oblikovati** varne vzorce avtentikacije in avtorizacije z Azure
- **Konfigurirati** celovito beleženje dogodkov za zahteve skladnosti
- **Uporabiti** strategije "obramba v globino" na vseh ravneh aplikacije
- **Validirati** varnostne implementacije s sistematičnim testiranjem
- **Spremljati** varnostne dogodke in se odzvati na morebitne grožnje

## 🔐 Arhitektura varnosti za večnajemništvo

### Pregled varnostnih slojev
...
### Modeli večnajemništva

Naša implementacija uporablja model **Skupna baza podatkov, skupna shema** z Row Level Security:

**Prednosti:**
- Stroškovno učinkovita uporaba virov
- Poenostavljeno vzdrževanje in posodobitve
- Močna izolacija podatkov prek RLS
- Beleženje skladnosti prijazno revizijam

**Slabosti:**
- Zahteva skrbno oblikovanje politik RLS
- Spremembe sheme vplivajo na vse najemnike
- Potrebni so robustni postopki varnostnega kopiranja/obnove
...
### Upravljanje konteksta trgovine
...
### Pogledi za spremljanje varnosti
...
## 🧪 Testiranje in validacija varnosti

### Avtomatizirani varnostni testi
...
### Seznam za penetracijsko testiranje
...
Po zaključku tega laboratorija boste:

✅ **Varnost za večnajemništvo**: Implementirali Row Level Security za popolno izolacijo podatkov  
✅ **Avtentikacija z Azure**: Integrirali Azure Entra ID z validacijo JWT  
✅ **Avtorizacija na podlagi vlog**: Konfigurirali hierarhični sistem vlog in dovoljenj  
✅ **Celovito beleženje dogodkov**: Ustanovili sledenje in spremljanje varnostnih dogodkov  
✅ **Testiranje varnosti**: Implementirali avtomatizirane teste za validacijo varnosti  
✅ **Spremljanje groženj**: Ustvarili sistem za zaznavanje in opozarjanje na varnostne dogodke v realnem času  

## 🚀 Kaj sledi

Nadaljujte z **[Laboratorijem 03: Nastavitev okolja](../03-Setup/README.md)** za:

- Konfiguracijo razvojnih okolij z najboljšimi praksami za varnost
- Nastavitev storitev Azure za avtentikacijo in spremljanje
- Implementacijo varnih povezav z bazo podatkov in upravljanje skrivnosti
- Validacijo varnostnih konfiguracij v razvojnih okoljih

## 📚 Dodatni viri

### Varnost v Azure
- [Dokumentacija Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - Celovit vodnik po platformi identitete
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Storitev za upravljanje skrivnosti
- [Najboljše prakse za varnost v Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Varnostna priporočila

### Varnost baze podatkov
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Uradna dokumentacija RLS
- [Kontrolni seznam za varnost baze podatkov](https://www.postgresql.org/docs/current/security.html) - Vodnik za varnost PostgreSQL
- [Vzorce večnajemniških baz podatkov](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Arhitekturni vzorci

### Testiranje varnosti
- [OWASP Vodnik za testiranje](https://owasp.org/www-project-web-security-testing-guide/) - Celovit vodnik za testiranje varnosti
- [Najboljše prakse za varnost JWT](https://tools.ietf.org/html/rfc8725) - Premisleki o varnosti JWT
- [Testiranje varnosti API-jev](https://owasp.org/www-project-api-security/) - Testiranje varnosti specifično za API-je

---

**Prejšnje**: [Laboratorij 01: Osnovni koncepti arhitekture](../01-Architecture/README.md)  
**Naslednje**: [Laboratorij 03: Nastavitev okolja](../03-Setup/README.md)
