...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:19:57+00:00",
...
Ta laboratorij ponuja celovita navodila za implementacijo spremljanja, opazovanja in opozarjanja za vaš MCP strežnik v produkcijskih okoljih. Naučili se boste nastaviti Application Insights, ustvariti smiselne nadzorne plošče, implementirati učinkovito opozarjanje in vzpostaviti delovne procese za odpravljanje težav, ki zagotavljajo operativno odličnost.

## Pregled

Učinkovito spremljanje in opazovanje sta ključna za zanesljivo delovanje MCP strežnikov v produkciji. Ta laboratorij pokriva tri stebre opazovanja—metrike, dnevnike in sledi—ter vam pokaže, kako implementirati celovito spremljanje, ki omogoča proaktivno zaznavanje težav in hitro reševanje problemov.

Naučili se boste pretvoriti surove telemetrijske podatke v uporabne vpoglede, ki vam pomagajo razumeti vedenje sistema, optimizirati zmogljivost in zagotoviti visoko razpoložljivost.

## Cilji učenja

Do konca tega laboratorija boste sposobni:

- **Implementirati** celovito integracijo Application Insights za MCP strežnike
- **Oblikovati** strukturirane vzorce beleženja za učinkovito odpravljanje težav
- **Ustvariti** sisteme za zbiranje in analizo zmogljivostnih metrik
- **Konfigurirati** inteligentno opozarjanje z uporabnimi obvestili
- **Zgraditi** operativne nadzorne plošče za spremljanje v realnem času
- **Vzpostaviti** učinkovite delovne procese za odpravljanje težav in delovne priročnike

## 📊 Integracija Application Insights

### Nastavitev Application Insights
...
### Izboljšano beleženje s strukturiranimi podatki
...
## 🔔 Konfiguracija opozarjanja

### Inteligentni sistem opozarjanja
...
### Implementacija prilagojenih nadzornih plošč
...
## 🔍 Delovni procesi za odpravljanje težav
...
✅ **Integracijo Application Insights**: Popolna telemetrija in nastavitev spremljanja  
✅ **Strukturirano beleženje**: Beleženje, pripravljeno za produkcijo, z korelacijo in kontekstom  
✅ **Prilagojene metrike**: Zbiranje in analiza poslovnih ter tehničnih metrik  
✅ **Inteligentno opozarjanje**: Proaktivno opozarjanje z več kanali obveščanja  
✅ **Operativne nadzorne plošče**: Spremljanje v realnem času in poslovni vpogledi  
✅ **Delovni procesi za odpravljanje težav**: Avtomatizirana diagnostika in operativni priročniki  

## 🚀 Kaj sledi

Nadaljujte z **[Laboratorijem 12: Najboljše prakse in optimizacija](../12-Best-Practices/README.md)**, da:

- Uporabite tehnike optimizacije zmogljivosti
- Implementirate celovito varnostno utrjevanje
- Naučite se najboljših praks za produkcijsko uvajanje
- Vzpostavite strategije za optimizacijo stroškov

## 📚 Dodatni viri

### Azure Monitor
- [Dokumentacija Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Celovit vodnik za spremljanje
- [Referenca KQL poizvedb](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Jezik poizvedb za Application Insights
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - Ustvarjanje prilagojenih nadzornih plošč

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - Vodnik za instrumentacijo
- [Porazdeljeno sledenje](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - Koncepti sledenja
- [Zbiranje metrik](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - Najboljše prakse za metrike

### Operativna odličnost
- [Priročnik SRE](https://sre.google/sre-book/table-of-contents/) - Načela Site Reliability Engineering
- [Najboljše prakse spremljanja](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - Industrijske najboljše prakse
- [Odgovor na incidente](https://response.pagerduty.com/) - Vodnik za upravljanje incidentov

---

**Prejšnje**: [Laboratorij 10: Strategije uvajanja](../10-Deployment/README.md)  
**Naslednje**: [Laboratorij 12: Najboljše prakse in optimizacija](../12-Best-Practices/README.md)
