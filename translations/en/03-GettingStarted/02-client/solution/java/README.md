...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-11T13:03:06+00:00",
...
**Note**: Make sure the calculator server is running at `http://localhost:8080` before executing any of these commands.
...
3. **Perform Calculations**:
   ...
   - Help: Displays available operations
