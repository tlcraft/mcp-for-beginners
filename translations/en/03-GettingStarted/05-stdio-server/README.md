...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-26T19:15:04+00:00",
...
The stdio transport enables MCP servers to communicate with clients through standard input and output streams. It is the most commonly used and recommended transport mechanism in the current MCP specification, offering a straightforward and efficient way to build MCP servers that can be easily integrated with various client applications.
...
- Do not require web server setup or HTTP endpoints.
...
- Simple subprocess model - client launches server as a child process.
