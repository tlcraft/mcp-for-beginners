...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T18:21:11+00:00",
...
3. [**Join The Azure AI Foundry Discord to connect with experts and other developers**](https://discord.com/invite/ByRwuEEgH4)
...
The **Model Context Protocol (MCP)** is an innovative framework designed to standardize communication between AI models and client applications. This open-source curriculum provides a structured learning path, complete with practical coding examples and real-world applications, across popular programming languages like C#, Java, JavaScript, TypeScript, and Python.

Whether you're an AI developer, system architect, or software engineer, this guide serves as a comprehensive resource for understanding MCP fundamentals and implementation techniques.
...
| 00 | Introduction to MCP | Overview of the Model Context Protocol and its importance in AI workflows | [Read more](./00-Introduction/README.md) |
| 01 | Core Concepts Explained | Detailed exploration of MCP's core principles | [Read more](./01-CoreConcepts/README.md) |
| 02 | Security in MCP | Security risks and best practices | [Read more](./02-Security/README.md) |
| 03 | Getting Started with MCP | Setting up the environment, basic servers/clients, integration | [Read more](./03-GettingStarted/README.md) |
...
| 3.7 | AI Toolkit | Utilize AI Toolkit with MCP | [Guide](./03-GettingStarted/07-aitk/README.md) |
| 3.8 | Testing | Test your MCP server implementation | [Guide](./03-GettingStarted/08-testing/README.md) |
| 3.9 | Deployment | Deploy MCP servers to production environments | [Guide](./03-GettingStarted/09-deployment/README.md) |
...
| 05 | Advanced Topics in MCP | Multi-modal AI, scaling, enterprise applications | [Read more](./05-AdvancedTopics/README.md) |
...
- (Optional) A background in AI/ML concepts
...
We maintain a comprehensive [Changelog](./changelog.md) that documents all significant updates to the curriculum, including:
...
Focuses on empowering developers to integrate MCP into their workflows and celebrating the vibrant MCP community. Join community members and partners like Arcade, Block, Okta, and Neon to see how they are collaborating with Microsoft to shape an open, extensible MCP ecosystem.  
Highlights include:  
...
Geared toward MCP builders, this day dives into implementation strategies and best practices for creating MCP servers and integrating MCP into AI workflows.
...
Learn how to create MCP servers, integrate with VS Code, and deploy professionally on Azure through intensive video sessions based on the MCP for Beginners curriculum. Gain practical skills in a technology that leading companies are already adopting.
...
We welcome contributions and suggestions for this project. Most contributions require you to agree to a Contributor License Agreement (CLA), which ensures you have the rights to grant us permission to use your contribution. For details, visit <https://cla.opensource.microsoft.com>.  

When you submit a pull request, a CLA bot will automatically check if you need to sign a CLA and provide instructions. You only need to do this once across all repositories using our CLA.
...
This project may include trademarks or logos for projects, products, or services. Authorized use of Microsoft trademarks or logos must follow [Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
Use of Microsoft trademarks or logos in modified versions of this project must not cause confusion or imply Microsoft sponsorship.  
Any use of third-party trademarks or logos is subject to their respective policies.  
