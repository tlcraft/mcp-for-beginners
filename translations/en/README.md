...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T22:27:54+00:00",
...
This project may include trademarks or logos related to projects, products, or services. The authorized use of Microsoft trademarks or logos must comply with and adhere to [Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). 

Using Microsoft trademarks or logos in modified versions of this project must not create confusion or suggest sponsorship by Microsoft. Any use of third-party trademarks or logos must follow the policies of the respective third parties.
