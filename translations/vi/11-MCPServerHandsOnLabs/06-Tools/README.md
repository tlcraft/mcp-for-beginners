...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T20:04:54+00:00",
...
Phòng thực hành này đi sâu vào việc tạo ra các công cụ MCP tiên tiến, cung cấp cho trợ lý AI khả năng truy vấn cơ sở dữ liệu mạnh mẽ, kiểm tra cấu trúc dữ liệu, và các chức năng phân tích. Bạn sẽ học cách xây dựng các công cụ vừa mạnh mẽ vừa an toàn, với xử lý lỗi toàn diện và tối ưu hóa hiệu suất.

## Tổng Quan

Các công cụ MCP là giao diện giữa trợ lý AI và hệ thống dữ liệu của bạn. Các công cụ được thiết kế tốt cung cấp quyền truy cập có cấu trúc và được xác thực vào các thao tác phức tạp, đồng thời duy trì tính bảo mật và hiệu suất. Phòng thực hành này bao gồm toàn bộ vòng đời phát triển công cụ từ thiết kế đến triển khai.

Máy chủ MCP bán lẻ của chúng tôi triển khai một bộ công cụ toàn diện cho phép truy vấn dữ liệu bán hàng, danh mục sản phẩm và phân tích kinh doanh bằng ngôn ngữ tự nhiên, đồng thời duy trì các ranh giới bảo mật nghiêm ngặt và hiệu suất tối ưu.

## Mục Tiêu Học Tập

Sau khi hoàn thành phòng thực hành này, bạn sẽ có thể:

- **Thiết kế** các công cụ MCP tiên tiến với khả năng xác thực tham số phức tạp  
- **Triển khai** các công cụ truy vấn cơ sở dữ liệu an toàn với bảo vệ chống SQL injection  
- **Tạo** khả năng kiểm tra cấu trúc dữ liệu cho các truy vấn động  
- **Xây dựng** các công cụ phân tích tùy chỉnh cho trí tuệ kinh doanh  
- **Áp dụng** xử lý lỗi toàn diện và giảm thiểu lỗi một cách hiệu quả  
- **Tối ưu hóa** hiệu suất công cụ cho khối lượng công việc sản xuất  

## 🛠️ Kiến Trúc Công Cụ Cốt Lõi
...
## 🗃️ Công Cụ Truy Vấn Cơ Sở Dữ Liệu
...
### Công Cụ Kiểm Tra Cấu Trúc Dữ Liệu
...
## 📊 Công Cụ Phân Tích và Tiện Ích

### Công Cụ Trí Tuệ Kinh Doanh
...
Sau khi hoàn thành phòng thực hành này, bạn sẽ đạt được:

✅ **Kiến Trúc Công Cụ Tiên Tiến**: Triển khai các công cụ MCP phức tạp với xử lý lỗi toàn diện  
✅ **Xác Thực Truy Vấn**: Xây dựng xác thực SQL an toàn để ngăn chặn các cuộc tấn công injection  
✅ **Công Cụ Cơ Sở Dữ Liệu**: Tạo khả năng phân tích bán hàng và kiểm tra cấu trúc dữ liệu mạnh mẽ  
✅ **Trí Tuệ Kinh Doanh**: Phát triển các công cụ phân tích cho những hiểu biết kinh doanh toàn diện  
✅ **Tối Ưu Hóa Hiệu Suất**: Áp dụng bộ nhớ đệm, quản lý kết nối, và tối ưu hóa truy vấn  
✅ **Tích Hợp Bảo Mật**: Triển khai kiểm soát truy cập dựa trên vai trò và ghi nhật ký kiểm toán  

## 🚀 Tiếp Theo

Tiếp tục với **[Phòng Thực Hành 07: Tích Hợp Tìm Kiếm Ngữ Nghĩa](../07-Semantic-Search/README.md)** để:

- Tích hợp khả năng tìm kiếm vector với các công cụ MCP  
- Xây dựng chức năng tìm kiếm sản phẩm theo ngữ nghĩa  
- Triển khai hiểu truy vấn được hỗ trợ bởi AI  
- Tạo tìm kiếm kết hợp giữa truy vấn truyền thống và vector  

## 📚 Tài Nguyên Bổ Sung

### Phát Triển Công Cụ MCP
- [Tài Liệu Giao Thức Ngữ Cảnh Mô Hình](https://modelcontextprotocol.io/docs) - Đặc tả chính thức của MCP  
- [Khung FastMCP](https://github.com/jlowin/fastmcp) - Triển khai MCP bằng Python  
- [Mẫu Công Cụ MCP](https://github.com/modelcontextprotocol/servers) - Các triển khai công cụ mẫu  

### Bảo Mật Cơ Sở Dữ Liệu
- [Ngăn Chặn SQL Injection](https://owasp.org/www-community/attacks/SQL_Injection) - Hướng dẫn bảo mật của OWASP  
- [Bảo Mật PostgreSQL](https://www.postgresql.org/docs/current/security.html) - Các thực hành tốt nhất về bảo mật cơ sở dữ liệu  
- [Kỹ Thuật Xác Thực Truy Vấn](https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html) - Mẫu truy vấn an toàn  

### Tối Ưu Hóa Hiệu Suất
- [Tối Ưu Hóa Truy Vấn Cơ Sở Dữ Liệu](https://www.postgresql.org/docs/current/performance-tips.html) - Hướng dẫn hiệu suất PostgreSQL  
- [Thực Hành Tốt Nhất Về Quản Lý Kết Nối](https://www.postgresql.org/docs/current/runtime-config-connection.html) - Quản lý kết nối  
- [Mẫu Lập Trình Python Bất Đồng Bộ](https://docs.python.org/3/library/asyncio.html) - Hướng dẫn lập trình bất đồng bộ  

---

**Trước**: [Phòng Thực Hành 05: Triển Khai Máy Chủ MCP](../05-MCP-Server/README.md)  
**Tiếp Theo**: [Phòng Thực Hành 07: Tích Hợp Tìm Kiếm Ngữ Nghĩa](../07-Semantic-Search/README.md)  
