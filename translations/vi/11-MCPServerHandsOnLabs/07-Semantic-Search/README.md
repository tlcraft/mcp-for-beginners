...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T20:02:46+00:00",
...
Bài thực hành này cung cấp hướng dẫn toàn diện về cách triển khai khả năng tìm kiếm ngữ nghĩa bằng cách sử dụng embeddings của Azure OpenAI và tiện ích mở rộng pgvector của PostgreSQL. Bạn sẽ học cách xây dựng hệ thống tìm kiếm sản phẩm dựa trên AI, hiểu các truy vấn ngôn ngữ tự nhiên và cung cấp kết quả phù hợp dựa trên sự tương đồng ngữ nghĩa.

## Tổng quan

Tìm kiếm dựa trên từ khóa truyền thống thường không nắm bắt được ý định của người dùng và ý nghĩa ngữ nghĩa. Tìm kiếm ngữ nghĩa sử dụng vector embeddings cho phép các truy vấn ngôn ngữ tự nhiên như "giày chạy thoải mái cho thời tiết mưa" tìm thấy các sản phẩm liên quan ngay cả khi những từ chính xác đó không xuất hiện trong mô tả sản phẩm.

Triển khai của chúng tôi kết hợp các mô hình embedding mạnh mẽ của Azure OpenAI với tiện ích mở rộng pgvector của PostgreSQL để tạo ra một hệ thống tìm kiếm ngữ nghĩa hiệu suất cao, có khả năng mở rộng, nâng cao trải nghiệm bán lẻ với khả năng khám phá sản phẩm thông minh.

## Mục tiêu học tập

Sau khi hoàn thành bài thực hành này, bạn sẽ có thể:

- **Tích hợp** các mô hình embedding của Azure OpenAI để vector hóa văn bản  
- **Triển khai** pgvector cho các hoạt động tìm kiếm tương đồng hiệu quả  
- **Xây dựng** công cụ tìm kiếm ngữ nghĩa cho các truy vấn sản phẩm bằng ngôn ngữ tự nhiên  
- **Tạo** tìm kiếm kết hợp giữa tìm kiếm truyền thống và tìm kiếm vector  
- **Tối ưu hóa** các truy vấn vector để đạt hiệu suất sản xuất  
- **Thiết kế** hệ thống gợi ý dựa trên sự tương đồng của embeddings  
...
### Quy trình Tạo Embedding Tự động
...
### Công cụ Tìm kiếm Sản phẩm Ngữ nghĩa
...
### Chiến lược Bộ nhớ Cache cho Embedding
...
✅ **Tích hợp Azure OpenAI**: Hoàn thành việc tạo embeddings với bộ nhớ cache và tối ưu hóa  
✅ **Triển khai Tìm kiếm Vector**: Hệ thống tìm kiếm ngữ nghĩa sẵn sàng sản xuất với pgvector  
✅ **Khả năng Tìm kiếm Kết hợp**: Kết hợp tìm kiếm từ khóa và tìm kiếm ngữ nghĩa để đạt kết quả tối ưu  
✅ **Hệ thống Gợi ý**: Gợi ý sản phẩm dựa trên AI sử dụng sự tương đồng  
✅ **Tối ưu hóa Hiệu suất**: Tối ưu hóa chỉ mục vector và bộ nhớ cache thông minh  
✅ **Kiến trúc Có khả năng Mở rộng**: Hạ tầng tìm kiếm ngữ nghĩa sẵn sàng cho doanh nghiệp  

## 🚀 Tiếp theo

Tiếp tục với **[Bài thực hành 08: Kiểm thử và Gỡ lỗi](../08-Testing/README.md)** để:

- Triển khai các chiến lược kiểm thử toàn diện cho tìm kiếm ngữ nghĩa  
- Gỡ lỗi các vấn đề về hiệu suất tìm kiếm vector  
- Xác thực chất lượng và mức độ liên quan của embeddings  
- Kiểm tra độ chính xác của hệ thống gợi ý  

## 📚 Tài liệu bổ sung

### Azure OpenAI  
- [Tài liệu Dịch vụ Azure OpenAI](https://docs.microsoft.com/azure/cognitive-services/openai/) - Hướng dẫn đầy đủ về dịch vụ  
- [Tài liệu API Embeddings](https://platform.openai.com/docs/api-reference/embeddings) - Tài liệu API  
- [Thực hành tốt nhất cho Embeddings](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Hướng dẫn triển khai  

### Cơ sở dữ liệu Vector  
- [Tài liệu pgvector](https://github.com/pgvector/pgvector) - Tiện ích mở rộng vector của PostgreSQL  
- [Tối ưu hóa Tìm kiếm Vector](https://www.pinecone.io/learn/vector-search-optimization/) - Tinh chỉnh hiệu suất  
- [Thuật toán HNSW](https://arxiv.org/abs/1603.09320) - Đồ thị nhỏ thế giới có thể điều hướng theo thứ bậc  

### Tìm kiếm Ngữ nghĩa  
- [Các nguyên tắc cơ bản về Truy xuất Thông tin](https://nlp.stanford.edu/IR-book/) - Sách giáo khoa IR của Stanford  
- [Thực hành tốt nhất cho Tìm kiếm Vector](https://weaviate.io/blog/vector-search-best-practices) - Mẫu triển khai  
- [Chiến lược Tìm kiếm Kết hợp](https://blog.vespa.ai/hybrid-search/) - Kết hợp các phương pháp tìm kiếm khác nhau  

---

**Trước**: [Bài thực hành 06: Phát triển Công cụ](../06-Tools/README.md)  
**Tiếp theo**: [Bài thực hành 08: Kiểm thử và Gỡ lỗi](../08-Testing/README.md)  
