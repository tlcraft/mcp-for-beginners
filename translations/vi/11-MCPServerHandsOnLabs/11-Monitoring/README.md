...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:50:18+00:00",
...
Bài thực hành này cung cấp hướng dẫn toàn diện để triển khai giám sát, khả năng quan sát và cảnh báo cho máy chủ MCP trong môi trường sản xuất. Bạn sẽ học cách thiết lập Application Insights, tạo bảng điều khiển hữu ích, triển khai hệ thống cảnh báo hiệu quả và xây dựng quy trình xử lý sự cố nhằm đạt được sự xuất sắc trong vận hành.

## Tổng quan

Giám sát và khả năng quan sát hiệu quả là yếu tố quan trọng để duy trì độ tin cậy của máy chủ MCP trong môi trường sản xuất. Bài thực hành này tập trung vào ba trụ cột của khả năng quan sát—metrics (chỉ số), logs (nhật ký), và traces (dấu vết)—và hướng dẫn bạn cách triển khai hệ thống giám sát toàn diện giúp phát hiện vấn đề một cách chủ động và giải quyết sự cố nhanh chóng.

Bạn sẽ học cách chuyển đổi dữ liệu telemetry thô thành những thông tin hữu ích, giúp bạn hiểu rõ hành vi hệ thống, tối ưu hóa hiệu suất và đảm bảo tính khả dụng cao.

## Mục tiêu học tập

Sau khi hoàn thành bài thực hành này, bạn sẽ có thể:

- **Triển khai** tích hợp Application Insights toàn diện cho máy chủ MCP  
- **Thiết kế** mẫu nhật ký có cấu trúc để xử lý sự cố hiệu quả  
- **Tạo** hệ thống thu thập và phân tích chỉ số hiệu suất  
- **Cấu hình** hệ thống cảnh báo thông minh với thông báo hành động  
- **Xây dựng** bảng điều khiển vận hành để giám sát theo thời gian thực  
- **Thiết lập** quy trình xử lý sự cố và tài liệu hướng dẫn vận hành  

## 📊 Tích hợp Application Insights

### Thiết lập Application Insights
...
### Nâng cao nhật ký với dữ liệu có cấu trúc
...
### Triển khai bảng điều khiển tùy chỉnh
...
✅ **Tích hợp Application Insights**: Thiết lập đầy đủ hệ thống telemetry và giám sát  
✅ **Nhật ký có cấu trúc**: Hệ thống nhật ký sẵn sàng cho sản xuất với khả năng liên kết và ngữ cảnh  
✅ **Chỉ số tùy chỉnh**: Thu thập và phân tích chỉ số kỹ thuật và kinh doanh  
✅ **Cảnh báo thông minh**: Cảnh báo chủ động với nhiều kênh thông báo  
✅ **Bảng điều khiển vận hành**: Giám sát theo thời gian thực và thông tin kinh doanh  
✅ **Quy trình xử lý sự cố**: Chẩn đoán tự động và tài liệu hướng dẫn vận hành  

## 🚀 Tiếp theo

Tiếp tục với **[Bài thực hành 12: Các phương pháp tốt nhất và tối ưu hóa](../12-Best-Practices/README.md)** để:

- Áp dụng các kỹ thuật tối ưu hóa hiệu suất  
- Triển khai các biện pháp bảo mật toàn diện  
- Tìm hiểu các phương pháp triển khai sản xuất tốt nhất  
- Thiết lập chiến lược tối ưu hóa chi phí  

## 📚 Tài liệu bổ sung

### Azure Monitor
- [Tài liệu Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Hướng dẫn giám sát đầy đủ  
- [Tham khảo KQL Query](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Ngôn ngữ truy vấn cho Application Insights  
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - Tạo bảng điều khiển tùy chỉnh  

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - Hướng dẫn triển khai  
- [Dấu vết phân tán](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - Khái niệm về dấu vết  
- [Thu thập chỉ số](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - Các phương pháp tốt nhất về chỉ số  

### Vận hành xuất sắc
- [SRE Handbook](https://sre.google/sre-book/table-of-contents/) - Nguyên tắc Kỹ thuật Độ tin cậy Trang web  
- [Các phương pháp giám sát tốt nhất](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - Các phương pháp tốt nhất trong ngành  
- [Phản ứng sự cố](https://response.pagerduty.com/) - Hướng dẫn quản lý sự cố  

---

**Trước**: [Bài thực hành 10: Chiến lược triển khai](../10-Deployment/README.md)  
**Tiếp theo**: [Bài thực hành 12: Các phương pháp tốt nhất và tối ưu hóa](../12-Best-Practices/README.md)  
