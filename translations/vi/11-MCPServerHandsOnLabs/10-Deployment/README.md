...
Bài thực hành này cung cấp hướng dẫn toàn diện về cách triển khai máy chủ MCP bán lẻ của bạn vào môi trường sản xuất bằng cách sử dụng các phương pháp hiện đại về container hóa và công nghệ đám mây. Bạn sẽ học cách triển khai các máy chủ MCP có khả năng mở rộng, bảo mật và giám sát để xử lý khối lượng công việc doanh nghiệp.

## Tổng Quan

Việc triển khai máy chủ MCP vào môi trường sản xuất đòi hỏi phải xem xét cẩn thận về container hóa, điều phối, bảo mật, khả năng mở rộng và giám sát. Bài thực hành này hướng dẫn triển khai trên Azure Container Apps với PostgreSQL Flexible Server, thực hiện các pipeline CI/CD, và cấu hình tự động mở rộng cho các khối lượng công việc thay đổi.

Các chiến lược triển khai bao gồm từ triển khai container đơn giản cho môi trường phát triển đến các môi trường sản xuất đa vùng phức tạp, tự động mở rộng với các tính năng giám sát và bảo mật toàn diện.

## Mục Tiêu Học Tập

Sau khi hoàn thành bài thực hành này, bạn sẽ có thể:

- **Container hóa** máy chủ MCP bằng Docker với các bản dựng nhiều giai đoạn
- **Triển khai** trên Azure Container Apps với mạng bảo mật
- **Cấu hình** PostgreSQL cấp sản xuất với tính khả dụng cao
- **Thực hiện** các pipeline CI/CD để triển khai tự động
- **Mở rộng** ứng dụng tự động dựa trên nhu cầu
- **Giám sát** các triển khai sản xuất với khả năng quan sát toàn diện
...
## ☁️ Triển Khai Azure Container Apps

### Hạ Tầng Bằng Code Với Bicep
...
✅ **Chiến Lược Container**: Container Docker sẵn sàng cho sản xuất với tăng cường bảo mật  
✅ **Triển Khai Đám Mây**: Azure Container Apps với tự động mở rộng và giám sát  
✅ **Triển Khai Cơ Sở Dữ Liệu**: PostgreSQL Flexible Server với tính khả dụng cao  
✅ **Pipeline CI/CD**: Workflow tự động kiểm thử, xây dựng và triển khai  
✅ **Giám Sát Hiệu Suất**: Thu thập số liệu toàn diện và cảnh báo  
✅ **Cấu Hình Bảo Mật**: Chính sách bảo mật cấp sản xuất và cô lập mạng  

## 🚀 Tiếp Theo

Tiếp tục với **[Bài Thực Hành 11: Giám Sát và Khả Năng Quan Sát](../11-Monitoring/README.md)** để:

- Thiết lập giám sát toàn diện với Application Insights
- Cấu hình logging có cấu trúc và tracing phân tán
- Thực hiện hệ thống cảnh báo và phản hồi tự động
- Giám sát các số liệu kinh doanh và KPI hiệu suất

## 📚 Tài Nguyên Bổ Sung

### Công Nghệ Container
- [Docker Best Practices](https://docs.docker.com/develop/dev-best-practices/) - Các thực hành tốt nhất của Docker
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Tài liệu về Azure Container Apps
- [Kubernetes Documentation](https://kubernetes.io/docs/) - Tài liệu chính thức của Kubernetes

### CI/CD và DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - Tài liệu về GitHub Actions
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Dịch vụ Azure DevOps
- [Infrastructure as Code](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Tài liệu về Azure Bicep

### Bảo Mật và Giám Sát
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Các khuyến nghị bảo mật của Azure
- [Container Security](https://kubernetes.io/docs/concepts/security/) - Các khái niệm bảo mật của Kubernetes
...
**Trước**: [Bài Thực Hành 09: Tích Hợp VS Code](../09-VS-Code/README.md)  
**Tiếp Theo**: [Bài Thực Hành 11: Giám Sát và Khả Năng Quan Sát](../11-Monitoring/README.md)
