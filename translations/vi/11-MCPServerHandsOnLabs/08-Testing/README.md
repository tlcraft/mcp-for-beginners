...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:35:54+00:00",
...
Bài thực hành này cung cấp hướng dẫn toàn diện về cách kiểm tra và gỡ lỗi các máy chủ MCP trong môi trường sản xuất. Bạn sẽ học cách triển khai các chiến lược kiểm tra mạnh mẽ, gỡ lỗi các vấn đề phức tạp, và đảm bảo máy chủ MCP hoạt động ổn định dưới nhiều điều kiện khác nhau.

## Tổng quan

Việc kiểm tra máy chủ MCP đòi hỏi một cách tiếp cận đa tầng, bao gồm kiểm tra đơn vị, kiểm tra tích hợp, xác thực hiệu năng, và kiểm tra các tình huống thực tế. Bài thực hành này bao quát toàn bộ vòng đời kiểm tra từ phát triển đến giám sát trong sản xuất.

Chiến lược kiểm tra của chúng tôi nhấn mạnh vào độ tin cậy, bảo mật, và hiệu năng, đảm bảo máy chủ MCP có thể xử lý khối lượng công việc trong sản xuất đồng thời duy trì tính toàn vẹn dữ liệu và chất lượng trải nghiệm người dùng.

## Mục tiêu học tập

Sau khi hoàn thành bài thực hành này, bạn sẽ có thể:

- **Triển khai** bộ kiểm tra đơn vị và tích hợp toàn diện  
- **Thiết kế** các chiến lược kiểm tra hiệu quả cho công cụ MCP và các hoạt động cơ sở dữ liệu  
- **Gỡ lỗi** các vấn đề phức tạp bằng các kỹ thuật gỡ lỗi nâng cao  
- **Xác thực** hiệu năng dưới tải với các kịch bản kiểm tra thực tế  
- **Giám sát** hệ thống sản xuất với cảnh báo và khả năng quan sát hiệu quả  
- **Tự động hóa** quy trình kiểm tra cho tích hợp liên tục  

## 🧪 Kiến trúc kiểm tra

### Tổng quan chiến lược kiểm tra
...
### Kiểm tra quy trình từ đầu đến cuối
...
Sau khi hoàn thành bài thực hành này, bạn sẽ có:

✅ **Khung kiểm tra toàn diện**: Kiểm tra đơn vị, tích hợp, và hiệu năng cho tất cả các thành phần  
✅ **Công cụ gỡ lỗi nâng cao**: Các tiện ích gỡ lỗi tinh vi với khả năng theo dõi thực thi  
✅ **Xác thực hiệu năng**: Khả năng kiểm tra tải và phân tích khả năng mở rộng  
✅ **Kiểm tra bảo mật**: Ngăn chặn SQL injection và xác thực RLS  
✅ **Tích hợp giám sát**: Các chỉ số hiệu năng và phân tích điểm nghẽn  
✅ **Sẵn sàng CI/CD**: Quy trình kiểm tra tự động hóa cho tích hợp liên tục  

## 🚀 Tiếp theo

Tiếp tục với **[Bài thực hành 09: Tích hợp VS Code](../09-VS-Code/README.md)** để:

- Cấu hình VS Code cho phát triển máy chủ MCP  
- Thiết lập môi trường gỡ lỗi trong VS Code  
- Tích hợp máy chủ MCP với VS Code Chat  
- Kiểm tra toàn bộ quy trình làm việc với VS Code  

## 📚 Tài liệu bổ sung

### Khung kiểm tra
- [Tài liệu pytest](https://docs.pytest.org/) - Khung kiểm tra Python  
- [Kiểm tra AsyncPG](https://magicstack.github.io/asyncpg/current/index.html) - Kiểm tra PostgreSQL không đồng bộ  
- [Kiểm tra FastAPI](https://fastapi.tiangolo.com/tutorial/testing/) - Mẫu kiểm tra API  

### Kiểm tra hiệu năng
- [Thực hành tốt nhất kiểm tra tải](https://docs.python.org/3/library/asyncio.html) - Kiểm tra hiệu năng không đồng bộ  
- [Kiểm tra hiệu năng cơ sở dữ liệu](https://www.postgresql.org/docs/current/performance-tips.html) - Tối ưu hóa PostgreSQL  
- [Phân tích bộ nhớ](https://docs.python.org/3/library/tracemalloc.html) - Phân tích bộ nhớ Python  

### Công cụ gỡ lỗi
- [Gỡ lỗi Python](https://docs.python.org/3/library/pdb.html) - Trình gỡ lỗi Python  
- [Gỡ lỗi không đồng bộ](https://docs.python.org/3/library/asyncio-dev.html) - Gỡ lỗi asyncio  
- [Gỡ lỗi SQL](https://www.postgresql.org/docs/current/runtime-config-logging.html) - Nhật ký PostgreSQL  

---

**Trước**: [Bài thực hành 07: Tích hợp Tìm kiếm Ngữ nghĩa](../07-Semantic-Search/README.md)  
**Tiếp theo**: [Bài thực hành 09: Tích hợp VS Code](../09-VS-Code/README.md)  
