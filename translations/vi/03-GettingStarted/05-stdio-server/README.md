...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-26T19:39:26+00:00",
...
- **Tiếp theo**: [HTTP Streaming với MCP (Streamable HTTP)](../06-http-streaming/README.md) - Tìm hiểu về cơ chế giao tiếp được hỗ trợ khác cho máy chủ từ xa.
- **Nâng cao**: [Các thực hành bảo mật tốt nhất cho MCP](../../02-Security/README.md) - Triển khai bảo mật trong các máy chủ MCP của bạn.
- **Sản xuất**: [Chiến lược triển khai](../09-deployment/README.md) - Triển khai máy chủ của bạn để sử dụng trong môi trường sản xuất.
