...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-21T14:24:57+00:00",
  "source_file": "09-CaseStudy/docs-mcp/solution/README.md",
  "language_code": "vi"
}
-->
Dưới đây là các giải pháp cho từng runtime:
- [Python](./python/README.md)

Để xem tài liệu trong trình soạn thảo và tích hợp Copilot, xem [Scenario 3: In-Editor Docs with MCP Server in VS Code](./scenario3/README.md) (hoạt động với mọi runtime).
