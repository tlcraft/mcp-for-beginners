...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-23T06:13:05+00:00",
...
**Model Context Protocol (MCP)** là một khuôn khổ tiên tiến được thiết kế để chuẩn hóa các tương tác giữa các mô hình AI và ứng dụng khách. Chương trình đào tạo mã nguồn mở này cung cấp một lộ trình học tập có cấu trúc, kèm theo các ví dụ mã thực tế và các trường hợp sử dụng thực tiễn, trải dài trên các ngôn ngữ lập trình phổ biến như C#, Java, JavaScript, TypeScript và Python.
...
|--|--|--|--|
| 00 | **Giới Thiệu MCP** | Tổng quan về Model Context Protocol và tầm quan trọng của nó trong các pipeline AI, bao gồm MCP là gì, tại sao chuẩn hóa lại quan trọng và các trường hợp sử dụng cùng lợi ích thực tế | [Introduction](./00-Introduction/README.md) |
...
| 03 | **Bắt Đầu Với MCP** | Thiết lập môi trường và cấu hình, tạo server và client MCP cơ bản, tích hợp MCP với ứng dụng hiện có | [Getting Started](./03-GettingStarted/README.md) |
| 3.1 | **Server Đầu Tiên** | Thiết lập server cơ bản sử dụng giao thức MCP, hiểu tương tác server-client và kiểm tra server | [First Server](./03-GettingStarted/01-first-server/README.md) |
| 3.2 | **Client Đầu Tiên**  | Thiết lập client cơ bản sử dụng giao thức MCP, hiểu tương tác client-server và kiểm tra client | [First Client](./03-GettingStarted/02-client/README.md) |
...
| 3.4 | **Sử Dụng Visual Studio Code Để Kết Nối Server** | Thiết lập Visual Studio Code để kết nối và sử dụng server theo giao thức MCP | [Consuming a server with Visual Studio Code](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | **Tạo Server Sử Dụng SSE** | SSE giúp ta công khai server trên internet. Phần này sẽ hướng dẫn bạn tạo server dùng SSE | [Creating a server using SSE](./03-GettingStarted/05-sse-server/README.md) |
| 3.6 | **Sử Dụng AI Toolkit** | AI toolkit là công cụ tuyệt vời giúp bạn quản lý luồng công việc AI và MCP | [Use AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
| 3.7 | **Kiểm Tra Server Của Bạn** | Kiểm tra là phần quan trọng trong quá trình phát triển. Phần này sẽ hướng dẫn bạn dùng nhiều công cụ khác nhau để kiểm thử | [Testing your server](./03-GettingStarted/07-testing/README.md) |
...
| 04 | **Triển Khai Thực Tiễn** | Sử dụng SDK trên nhiều ngôn ngữ, gỡ lỗi, kiểm thử và xác thực, tạo các mẫu prompt và luồng công việc có thể tái sử dụng | [Practical Implementation](./04-PracticalImplementation/README.md) |
| 05 | **Các Chủ Đề Nâng Cao Trong MCP** | Luồng công việc AI đa phương thức và khả năng mở rộng, chiến lược mở rộng an toàn, MCP trong hệ sinh thái doanh nghiệp | [Advanced Topics](./05-AdvancedTopics/README.md) |
| 06 | **Đóng Góp Cộng Đồng** | Cách đóng góp mã và tài liệu, hợp tác qua GitHub, cải tiến và phản hồi do cộng đồng thúc đẩy | [Community Contributions](./06-CommunityContributions/README.md) |
| 07 | **Bài Học Từ Những Người Tiên Phong** | Triển khai thực tế và những gì đã hiệu quả, xây dựng và triển khai giải pháp dựa trên MCP, xu hướng và lộ trình tương lai | [Insights](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | **Thực Hành Tốt Nhất Cho MCP** | Tối ưu hiệu năng và điều chỉnh, thiết kế hệ thống MCP chịu lỗi, chiến lược kiểm thử và tăng độ bền | [Best Practices](./08-BestPractices/README.md) |
| 09 | **Nghiên Cứu Trường Hợp MCP** | Phân tích kiến trúc giải pháp MCP, bản thiết kế triển khai và mẹo tích hợp, sơ đồ chú thích và hướng dẫn dự án | [Case Studies](./09-CaseStudy/README.md) |
...
## 🛠️ Cách sử dụng khóa học này hiệu quả
...
Nội dung này được cấp phép theo **MIT License**. Để biết điều khoản, xem [LICENSE](../../LICENSE).

## 🤝 Hướng dẫn đóng góp

Dự án này hoan nghênh các đóng góp và đề xuất. Hầu hết các đóng góp yêu cầu bạn đồng ý với  
Contributor License Agreement (CLA) xác nhận bạn có quyền và thực sự cấp cho chúng tôi  
...
CLA hay không và đánh dấu PR phù hợp (ví dụ: kiểm tra trạng thái, bình luận). Chỉ cần làm theo  
hướng dẫn của bot. Bạn chỉ cần thực hiện việc này một lần cho tất cả các repo sử dụng CLA của chúng tôi.
...
## 🎒 Các khóa học khác  
Nhóm của chúng tôi còn phát triển các khóa học khác! Hãy xem:
...
phải tuân thủ và theo đúng  
[Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
Việc sử dụng nhãn hiệu hoặc logo Microsoft trên các phiên bản sửa đổi của dự án này không được gây nhầm lẫn hoặc ngụ ý Microsoft tài trợ.  
Việc sử dụng nhãn hiệu hoặc logo của bên thứ ba phải tuân theo chính sách của các bên đó.

**Tuyên bố miễn trừ trách nhiệm**:  
Tài liệu này đã được dịch bằng dịch vụ dịch thuật AI [Co-op Translator](https://github.com/Azure/co-op-translator). Mặc dù chúng tôi cố gắng đảm bảo độ chính xác, xin lưu ý rằng các bản dịch tự động có thể chứa lỗi hoặc không chính xác. Tài liệu gốc bằng ngôn ngữ nguyên bản nên được coi là nguồn thông tin chính thức. Đối với những thông tin quan trọng, nên sử dụng dịch vụ dịch thuật chuyên nghiệp do con người thực hiện. Chúng tôi không chịu trách nhiệm về bất kỳ sự hiểu lầm hoặc diễn giải sai nào phát sinh từ việc sử dụng bản dịch này.