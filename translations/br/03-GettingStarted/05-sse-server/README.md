...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-29T20:23:57+00:00",
...
1. Execute o inspector
    ...
    > ![NOTE]
    > Execute isso em uma janela de terminal separada daquela em que o servidor está rodando. Também note que você precisa ajustar o comando abaixo para corresponder à URL onde seu servidor está rodando.
...
[Solucão](./solution/README.md) Aqui está uma solução possível com código funcionando.
...
- Você pode usar tanto o Inspector quanto o Visual Studio Code para consumir servidores SSE, assim como servidores stdio. Note como há pequenas diferenças entre stdio e SSE. Para SSE, você precisa iniciar o servidor separadamente e depois rodar sua ferramenta inspector. Para o inspector, também há diferenças no fato de que você precisa especificar a URL.
...
- Próximo: [Começando com AI Toolkit para VSCode](/03-GettingStarted/06-aitk/README.md)
