...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-13T02:31:29+00:00",
  "source_file": "03-GettingStarted/07-aitk/solution/README.md",
  "language_code": "br"
}
-->
# 📘 Assignment Solution: Estendendo Seu Servidor MCP de Calculadora com uma Ferramenta de Raiz Quadrada

## Visão Geral  
Nesta tarefa, você aprimorou seu servidor MCP de calculadora adicionando uma nova ferramenta que calcula a raiz quadrada de um número. Essa adição permite que seu agente de IA lide com consultas matemáticas mais avançadas, como "Qual é a raiz quadrada de 16?" ou "Calcule √49", usando comandos em linguagem natural.
...
- **Importe a ferramenta `math.sqrt()` usando `@server.tool()` com o nome `sqrt`.**
- Permitindo que seu agente de IA realize cálculos de raiz quadrada por meio de comandos em linguagem natural.
