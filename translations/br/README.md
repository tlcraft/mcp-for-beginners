...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-02T18:54:44+00:00",
...
|--|--|--|--|
| 00 | **Introdução ao MCP** | Visão geral do Protocolo de Contexto de Modelo e sua importância em pipelines de IA, incluindo o que é o Model Context Protocol, por que a padronização é importante e casos práticos de uso e benefícios | [Introdução](./00-Introduction/README.md) |
| 01 | **Conceitos Básicos Explicados** | Exploração aprofundada dos conceitos centrais do MCP, incluindo arquitetura cliente-servidor, componentes chave do protocolo e padrões de mensagens | [Conceitos Básicos](./01-CoreConcepts/README.md) |
...
| 3.1 | **Primeiro servidor** | Configuração de um servidor básico usando o protocolo MCP, entendendo a interação servidor-cliente e testando o servidor | [Primeiro Servidor](./03-GettingStarted/01-first-server/README.md) |
| 3.2 | **Primeiro cliente**  | Configuração de um cliente básico usando o protocolo MCP, entendendo a interação cliente-servidor e testando o cliente | [Primeiro Cliente](./03-GettingStarted/02-client/README.md) |
...
| 3.4 | **Consumindo um servidor com Visual Studio Code** | Configuração do Visual Studio Code para consumir servidores usando o protocolo MCP | [Consumindo servidor com Visual Studio Code](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | **Criando um servidor usando SSE** | SSE nos ajuda a expor um servidor para a internet. Esta seção ajudará você a criar um servidor usando SSE | [Criando servidor usando SSE](./03-GettingStarted/05-sse-server/README.md) |
| 3.6 | **Usando AI Toolkit** | AI Toolkit é uma ótima ferramenta que ajudará você a gerenciar seu fluxo de trabalho de IA e MCP. | [Usando AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
| 3.7 | **Testando seu servidor** | Testes são parte importante do processo de desenvolvimento. Esta seção ajudará você a testar usando várias ferramentas diferentes. | [Testando seu servidor](./03-GettingStarted/07-testing/README.md) |
| 3.8 | **Deploy do seu servidor** | Como passar do desenvolvimento local para a produção? Esta seção ajudará você a desenvolver e implantar seu servidor. | [Deploy do seu servidor](./03-GettingStarted/08-deployment/README.md) |
| 04 | **Implementação Prática** | Usando SDKs em diferentes linguagens, depuração, testes e validação, criação de templates reutilizáveis de prompts e fluxos de trabalho | [Implementação Prática](./04-PracticalImplementation/README.md) |
| 05 | **Tópicos Avançados em MCP** | Fluxos de trabalho multimodais e extensibilidade, estratégias seguras de escalonamento, MCP em ecossistemas empresariais | [Tópicos Avançados](./05-AdvancedTopics/README.md) |
...
| 5.3 | **Demonstração MCP OAuth2** | Aplicação minimalista Spring Boot mostrando OAuth2 com MCP, tanto como Servidor de Autorização quanto de Recursos. Demonstra emissão segura de tokens, endpoints protegidos, deploy em Azure Container Apps e integração com API Management. | [Demonstração MCP OAuth2](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
...
| 5.7 | **Escalonamento** | Saiba sobre escalonamento de servidores MCP, incluindo estratégias horizontais e verticais, otimização de recursos e ajuste de performance | [Escalonamento](./05-AdvancedTopics/mcp-scaling/README.md) |
...
| 06 | **Contribuições da Comunidade** | Como contribuir com código e documentação, colaboração via GitHub, melhorias e feedbacks impulsionados pela comunidade | [Contribuições da Comunidade](./06-CommunityContributions/README.md) |
| 07 | **Insights das Primeiras Adoções** | Implementações reais e o que funcionou, construção e deploy de soluções baseadas em MCP, tendências e roadmap futuro | [Insights](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | **Melhores Práticas para MCP** | Ajuste de performance e otimização, design de sistemas MCP tolerantes a falhas, estratégias de testes e resiliência | [Melhores Práticas](./08-BestPractices/README.md) |
...
### 🧮 Projetos Exemplo de Calculadora MCP:
<details>
...
Este projeto pode conter marcas registradas ou logos de projetos, produtos ou serviços. O uso autorizado das marcas ou logos da Microsoft está sujeito e deve seguir
as [Diretrizes de Marca & Identidade da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
O uso de marcas ou logos da Microsoft em versões modificadas deste projeto não deve causar confusão nem sugerir patrocínio da Microsoft.
