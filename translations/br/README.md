...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T07:15:59+00:00",
...
## 🧭 Visão Geral do Currículo do MCP
...
| 3.7 | Ferramentas de IA | Use o AI Toolkit com MCP | [Guia](./03-GettingStarted/07-aitk/README.md) |
...
| 10 | Workshop Prático | Construindo um Servidor MCP com Ferramentas de IA | [Laboratório](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
#### Implementações Avançadas do MCP
...
#### [➡️Assista Sob Demanda MCP Bootcamp | Inglês](https://developer.microsoft.com/en-us/reactor/series/s-1568/)
#### [➡️Assista Sob Demanda MCP Bootcamp | Brasil](https://developer.microsoft.com/en-us/reactor/series/S-1566/)
#### [➡️Assista Sob Demanda MCP Bootcamp | Espanhol](https://developer.microsoft.com/en-us/reactor/series/S-1567/)
...
entre em contato pelo e-mail [opencode@microsoft.com](mailto:opencode@microsoft.com) para quaisquer perguntas ou comentários adicionais.
...
- **translations/**: Suporte a múltiplos idiomas com traduções automáticas
...
Este projeto pode conter marcas registradas ou logotipos de projetos, produtos ou serviços. O uso autorizado de marcas registradas ou logotipos da Microsoft está sujeito e deve seguir as [Diretrizes de Marca e Uso da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
