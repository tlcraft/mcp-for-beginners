...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-23T06:43:13+00:00",
...
|--|--|--|--|
| 00 | **Introdução ao MCP** | Visão geral do Protocolo de Contexto do Modelo e sua importância em pipelines de IA, incluindo o que é o MCP, por que a padronização é importante e casos de uso e benefícios práticos | [Introdução](./00-Introduction/README.md) |
| 01 | **Conceitos Básicos Explicados** | Exploração detalhada dos conceitos centrais do MCP, incluindo arquitetura cliente-servidor, componentes principais do protocolo e padrões de mensagens | [Conceitos Básicos](./01-CoreConcepts/README.md) |
...
| 3.8 | **Deploy do seu servidor** | Como sair do desenvolvimento local para produção? Esta seção vai te ajudar a desenvolver e fazer o deploy do seu servidor. | [Deploy do seu servidor](./03-GettingStarted/08-deployment/README.md) |
...
| 08 | **Melhores Práticas para MCP** | Otimização e tuning de performance, design de sistemas MCP tolerantes a falhas, estratégias de testes e resiliência | [Melhores Práticas](./08-BestPractices/README.md) |
| 09 | **Estudos de Caso MCP** | Análises aprofundadas de arquiteturas de soluções MCP, modelos de deploy e dicas de integração, diagramas anotados e walkthroughs de projetos | [Estudos de Caso](./09-CaseStudy/README.md) |
