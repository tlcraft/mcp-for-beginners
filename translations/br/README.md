...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-11T15:26:52+00:00",
...
|--|--|--|--|
| 00 | **Introdução ao MCP** | Visão geral do Protocolo de Contexto de Modelo e sua importância em pipelines de IA, incluindo o que é o MCP, por que a padronização é importante, e casos de uso e benefícios práticos | [Introduction](./00-Introduction/README.md) |
| 01 | **Conceitos Básicos Explicados** | Exploração aprofundada dos conceitos centrais do MCP, incluindo arquitetura cliente-servidor, componentes principais do protocolo e padrões de mensagens | [Core Concepts](./01-CoreConcepts/README.md) |
...
| 3.3 | **Cliente com LLM**  | Configurando um cliente usando o protocolo MCP com um Modelo de Linguagem Grande (LLM) | [Client with LLM](./03-GettingStarted/03-llm-client/README.md) |
...
| 3.5 | **Criando um servidor usando SSE** | SSE nos ajuda a expor um servidor para a internet. Esta seção ajudará você a criar um servidor usando SSE | [Creating a server using SSE](./03-GettingStarted/05-sse-server/README.md) |
| 3.6 | **Usando AI Toolkit** | AI Toolkit é uma ótima ferramenta que vai ajudar você a gerenciar seu fluxo de trabalho de IA e MCP. | [Use AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
| 3.7 | **Testando seu servidor** | Testar é uma parte importante do processo de desenvolvimento. Esta seção ajudará você a testar usando várias ferramentas diferentes. | [Testing your server](./03-GettingStarted/07-testing/README.md) |
| 3.8 | **Implantando seu servidor** | Como sair do desenvolvimento local para produção? Esta seção vai ajudar você a desenvolver e implantar seu servidor. | [Deploy your server](./03-GettingStarted/08-deployment/README.md) |
| 04 | **Implementação Prática** | Usando SDKs em diferentes linguagens, depuração, testes e validação, criação de templates e fluxos de trabalho reutilizáveis para prompts | [Practical Implementation](./04-PracticalImplementation/README.md) |
| 05 | **Tópicos Avançados em MCP** | Fluxos de trabalho multimodais de IA e extensibilidade, estratégias seguras de escalonamento, MCP em ecossistemas empresariais | [Advanced Topics](./05-AdvancedTopics/README.md) |
...
| 5.2 | **Multimodalidade** | Mostrando como trabalhar com diferentes modalidades como imagens e outras | [Multi modality](./05-AdvancedTopics/mcp-multi-modality/README.md) |
...
| 5.5 | **Roteamento** | Conheça os diferentes tipos de roteamento | [Routing](./05-AdvancedTopics/mcp-routing/README.md) |
...
| 5.9 | **Web Search MCP** | Servidor e cliente MCP em Python integrando com SerpAPI para busca em tempo real na web, notícias, produtos e perguntas e respostas. Demonstra orquestração multi-ferramenta, integração com APIs externas e tratamento robusto de erros | [Web Search MCP](./05-AdvancedTopics/web-search-mcp/README.md) |
| 5.10 | **Streaming em Tempo Real** | Streaming de dados em tempo real tornou-se essencial no mundo orientado a dados de hoje, onde negócios e aplicações precisam de acesso imediato à informação para tomar decisões rápidas. | [Realtime Streaming](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
...
| 07 | **Lições da Adoção Inicial** | Implementações no mundo real e o que funcionou, construção e implantação de soluções baseadas em MCP, tendências e roadmap futuro | [Insights](./07-LessonsFromEarlyAdoption/README.md) |
...
| 09 | **Estudos de Caso MCP** | Análises aprofundadas das arquiteturas de solução MCP, modelos de implantação, dicas de integração, diagramas anotados e walkthroughs de projetos | [Case Studies](./09-CaseStudy/README.md) |
| 10 | **Otimização de Fluxos de Trabalho de IA: Construindo um Servidor MCP com AI Toolkit** | Workshop prático completo combinando MCP com o AI Toolkit da Microsoft para VS Code. Aprenda a criar aplicações inteligentes que conectam modelos de IA a ferramentas do mundo real por meio de módulos práticos que cobrem fundamentos, desenvolvimento de servidor customizado e estratégias de implantação em produção. | [Hands On Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
Contributor License Agreement (CLA) declarando que você tem o direito e de fato concede a nós
os direitos de usar sua contribuição. Para detalhes, visite <https://cla.opensource.microsoft.com>.

Ao enviar um pull request, um bot CLA irá automaticamente determinar se você precisa fornecer
