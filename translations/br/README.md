...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-27T14:59:21+00:00",
...
- **02. Segurança no MCP**  
  Ameaças à segurança e melhores práticas. [Leia mais](./02-Security/README.md)
...
- **3.9. Deploy do seu servidor** – [Guia](./03-GettingStarted/09-deployment/README.md)
</details>
...
Este projeto pode conter marcas registradas ou logos de projetos, produtos ou serviços. O uso autorizado das marcas ou logos da Microsoft está sujeito e deve seguir as [Diretrizes de Marcas e Identidade da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
