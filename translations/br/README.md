...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-19T21:54:16+00:00",
...
|--|--|--|--|
| 00 | **Introdução ao MCP** | Visão geral do Protocolo de Contexto de Modelo e sua importância em pipelines de IA, incluindo o que é o MCP, por que a padronização é importante e casos de uso práticos e benefícios | [Introdução](./00-Introduction/README.md) |
| 01 | **Conceitos Básicos Explicados** | Exploração aprofundada dos conceitos fundamentais do MCP, incluindo arquitetura cliente-servidor, componentes principais do protocolo e padrões de mensagens | [Conceitos Básicos](./01-CoreConcepts/README.md) |
...
| 3.6 | **Usando o AI Toolkit** | AI Toolkit é uma ótima ferramenta que ajudará você a gerenciar seu fluxo de trabalho de IA e MCP | [Usando o AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
| 3.7 | **Testando seu servidor** | Testes são uma parte importante do processo de desenvolvimento. Esta seção ajudará você a testar usando várias ferramentas diferentes | [Testando seu servidor](./03-GettingStarted/07-testing/README.md) |
...
| 04 | **Implementação Prática** | Uso de SDKs em diferentes linguagens, depuração, testes e validação, criação de templates reutilizáveis de prompt e fluxos de trabalho | [Implementação Prática](./04-PracticalImplementation/README.md) |
...
| 06 | **Contribuições da Comunidade** | Como contribuir com código e documentação, colaboração via GitHub, melhorias e feedbacks conduzidos pela comunidade | [Contribuições da Comunidade](./06-CommunityContributions/README.md) |
...
| 08 | **Melhores Práticas para MCP** | Otimização e ajuste de desempenho, design de sistemas MCP tolerantes a falhas, estratégias de testes e resiliência | [Melhores Práticas](./08-BestPractices/README.md) |
...
Ao enviar um pull request, um bot de CLA vai automaticamente verificar se você precisa fornecer
um CLA e marcar o PR adequadamente (por exemplo, checagem de status, comentário). Basta seguir as instruções
do bot. Você precisará fazer isso apenas uma vez para todos os repositórios que usam nosso CLA.
...
[Diretrizes de Marca e Branding da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
