...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-29T20:15:49+00:00",
...
|--|--|--|--|
| 00 | **Introdução ao MCP** | Visão geral do Protocolo de Contexto de Modelo e sua importância em pipelines de IA, incluindo o que é o MCP, por que a padronização é importante e casos de uso e benefícios práticos | [Introdução](./00-Introduction/README.md) |
...
| 3.7 | **Testando seu servidor** | Testar é uma parte importante do processo de desenvolvimento. Esta seção vai ajudar você a usar várias ferramentas diferentes para testar. | [Testando seu servidor](./03-GettingStarted/07-testing/README.md) |
| 3.8 | **Implantando seu servidor** | Como sair do desenvolvimento local para produção? Esta seção vai ajudar você a desenvolver e implantar seu servidor. | [Implantando seu servidor](./03-GettingStarted/08-deployment/README.md) |
...
| 07 | **Insights das Adoções Iniciais** | Implementações no mundo real e o que funcionou, construção e implantação de soluções baseadas em MCP, tendências e roadmap futuro | [Insights](./07-LessonsFromEarlyAdoption/README.md) |
...
### 🧮 Projetos Exemplos da Calculadora MCP:
<details>
...
O uso de marcas ou logos da Microsoft em versões modificadas deste projeto não deve causar confusão nem  
sugerir patrocínio da Microsoft.  
