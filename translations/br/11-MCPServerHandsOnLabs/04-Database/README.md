...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T17:02:28+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "br"
}
-->
# Design e Esquema de Banco de Dados

## 🎯 O Que Este Laboratório Abrange

Este laboratório explora em profundidade o design do banco de dados PostgreSQL para o sistema de varejo Zava. Você aprenderá a implementar um esquema de varejo abrangente com capacidades de busca vetorial, modelagem de dados multi-tenant e Segurança em Nível de Linha (RLS) para isolamento de dados.

## Visão Geral

O banco de dados é a base do nosso servidor MCP, armazenando dados de varejo de várias lojas enquanto mantém um isolamento rigoroso de dados. Utilizamos PostgreSQL com a extensão pgvector para habilitar capacidades de busca semântica, permitindo que os clientes encontrem produtos usando consultas em linguagem natural.

Nosso esquema segue padrões modernos de multi-tenancy com Segurança em Nível de Linha, garantindo que os usuários possam acessar apenas os dados das lojas autorizadas. Essa abordagem oferece segurança de nível empresarial enquanto mantém desempenho ideal.

## Objetivos de Aprendizado

Ao final deste laboratório, você será capaz de:

- **Projetar** esquemas de banco de dados de varejo escaláveis para multi-tenancy
- **Implementar** PostgreSQL com pgvector para busca vetorial
- **Configurar** Segurança em Nível de Linha para isolamento de dados
- **Gerar** dados de amostra realistas para testes
- **Otimizar** o desempenho do banco de dados para cargas de trabalho de varejo
...
Nosso banco de dados aproveita os recursos empresariais do PostgreSQL combinados com a extensão pgvector para busca alimentada por IA:
...
O banco de dados utiliza um modelo de multi-tenancy **banco de dados compartilhado, esquema compartilhado** com Segurança em Nível de Linha:
...
## 📊 Design do Esquema Principal

### Tabela de Lojas (Mestre de Locatários)
...
### Tabela de Produtos com Categorias
...
## 🔐 Configuração de Segurança em Nível de Linha

### Papéis e Permissões do Banco de Dados
...
### Script de Dados de Teste Realistas
...
### Visualizações de Otimização de Consultas
...
✅ **Design de Banco de Dados Multi-Tenant**: Implementado Segurança em Nível de Linha para isolamento seguro de dados  
✅ **Capacidades de Busca Vetorial**: Configurado pgvector para busca semântica de produtos  
✅ **Esquema Abrangente**: Criado um esquema de banco de dados de varejo pronto para produção  
✅ **Geração de Dados de Amostra**: Construído dados de teste realistas para desenvolvimento e testes  
✅ **Otimização de Desempenho**: Configurado índices e otimização de consultas  
✅ **Backup e Recuperação**: Estabelecido estratégias robustas de proteção de dados  

## 🚀 O Que Vem a Seguir

Continue com **[Laboratório 05: Implementação do Servidor MCP](../05-MCP-Server/README.md)** para:

- Construir o servidor FastMCP que se conecta a este banco de dados
- Implementar ferramentas de consulta de banco de dados para o protocolo MCP
- Adicionar capacidades de busca semântica usando os embeddings
- Configurar pool de conexões e tratamento de erros

## 📚 Recursos Adicionais

### PostgreSQL & pgvector
- [Documentação do PostgreSQL](https://www.postgresql.org/docs/) - Referência completa do PostgreSQL
- [Extensão pgvector](https://github.com/pgvector/pgvector) - Busca de similaridade vetorial para PostgreSQL
- [Otimização de Desempenho do PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Melhores práticas de otimização

### Arquitetura Multi-Tenant
- [Segurança em Nível de Linha](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Documentação de RLS do PostgreSQL
- [Arquitetura de Dados Multi-Tenant](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Padrões de arquitetura do Azure
- [Melhores Práticas de Segurança de Banco de Dados](https://www.postgresql.org/docs/current/security.html) - Guia de segurança do PostgreSQL

### Bancos de Dados Vetoriais
- [Fundamentos de Busca Vetorial](https://www.pinecone.io/learn/vector-database/) - Entendendo bancos de dados vetoriais
- [Modelos de Embeddings](https://platform.openai.com/docs/guides/embeddings) - Documentação de embeddings da OpenAI
- [Algoritmo HNSW](https://arxiv.org/abs/1603.09320) - Grafos Hierárquicos Navegáveis de Pequeno Mundo

---

**Anterior**: [Laboratório 03: Configuração do Ambiente](../03-Setup/README.md)  
**Próximo**: [Laboratório 05: Implementação do Servidor MCP](../05-MCP-Server/README.md)
