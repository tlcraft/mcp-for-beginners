...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T15:43:31+00:00",
...
[![MCP Verzia](https://img.shields.io/badge/MCP-1.9.3-blue.svg)](https://modelcontextprotocol.io/)
...
[![Vytváranie AI agentov vo VS Code: 4 praktické laboratóriá s MCP a AI Toolkitom](../../../translated_images/11.0f6db6a0fb6068856d0468590a120ffe35dbccc49b93dc88b2003f306c81493a.sk.png)](https://youtu.be/r34Csn3rkeQ)
...
- **🛠️ AI Toolkit pre Visual Studio Code (AITK)**: Výkonný rozšírenie od Microsoftu pre vývoj AI

### 🎓 Čo sa naučíte

Na konci tohto workshopu budete ovládať umenie vytvárania inteligentných aplikácií, ktoré prepájajú AI modely s reálnymi nástrojmi a službami. Od automatizovaného testovania po vlastné API integrácie získate praktické zručnosti na riešenie komplexných obchodných výziev.
...
- 🧰 **Bohatý ekosystém**: Nástroje, prompty a zdroje v jednom protokole
- 🔒 **Pripravené pre podniky**: Zabudovaná bezpečnosť a spoľahlivosť

**🎯 Prečo je MCP dôležitý:**
Rovnako ako USB-C eliminoval chaos s káblami, MCP eliminuje zložitosť AI integrácií. Jeden protokol, nekonečné možnosti.

### 🤖 AI Toolkit pre Visual Studio Code (AITK)

Vlajkové rozšírenie Microsoftu pre vývoj AI, ktoré transformuje VS Code na AI centrum.
...
- 🎭 **Multi-modálnosť**: Podpora textu, vizuálnych dát a štruktúrovaných výstupov

**💡 Výhody vývoja:**

- Nasadenie modelov bez konfigurácie
- Vizualizované navrhovanie promptov
...
- 🎮 Ovládnutie interaktívneho testovacieho prostredia pre testovanie modelov v reálnom čase
- 🤖 Vytvorenie prvého AI agenta pomocou Agent Buildera
- 📊 Hodnotenie výkonu modelov pomocou zabudovaných metrík (F1, relevantnosť, podobnosť, koherencia)
- ⚡ Naučte sa schopnosti dávkového spracovania a podpory multi-modálnosti

**🎯 Výsledok učenia**: Vytvorenie funkčného AI agenta s komplexným pochopením schopností AITK

### [🌐 Modul 2: Základy MCP s AI Toolkitom](./lab2/README.md)
...
- 📊 Konfigurácia a testovanie MCP nástrojov v rámci vašich agentov
- 🚀 Export a nasadenie agentov poháňaných MCP pre produkčné použitie

**🎯 Výsledok učenia**: Nasadenie AI agenta obohateného o externé nástroje prostredníctvom MCP
...
- 📁 Vytvorenie inteligentného manažmentu adresárov a integrácie VS Code
...
- **Inteligentný manažment repozitárov**: AI riadené rozhodnutia o revízii kódu a zlúčení
- **Inteligentné CI/CD**: Automatizovaná optimalizácia pipeline na základe zmien kódu
...
- **Inteligentné generovanie testov**: Automatické vytváranie komplexných testovacích súprav
- **Testovanie vizuálnych regresií**: AI poháňané detekovanie zmien UI
...
- **Adaptívne ETL procesy**: Samo-optimalizujúce transformácie dát
...
- [ ] **Ovládanie AITK**: Expert na používanie AI Toolkitu pre rýchly vývoj
- [ ] **Vývoj vlastných serverov**: Vytváranie, nasadenie a údržba produkčných MCP serverov
...
- [ ] Vytváranie vlastných reťazcov nástrojov pre špecifické domény
- [ ] Mentoring ostatných vo vývoji natívnom pre AI
...
**🚀 Pripravení revolučne zmeniť váš pracovný postup vývoja AI?**
