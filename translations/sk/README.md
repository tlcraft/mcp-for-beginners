...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T21:02:42+00:00",
...
| 5.10 | Realtime Streaming | Vytvorenie funkčnosti realtime streamingu | [Sprievodca](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
...
| 08 | Najlepšie postupy pre MCP | Výkon, odolnosť voči chybám, reziliencia | [Sprievodca](./08-BestPractices/README.md) |
...
- Pripojenie sa k diskusiám v našej komunite pre podporu
...
3. Cvičenia na vytváranie reálnych aplikácií MCP  
...
Pripravte sa na dva dni hlbokých technických poznatkov, spojenia s komunitou a praktického učenia na MCP Dev Days, virtuálnom podujatí venovanom Model Context Protocol (MCP) — vznikajúcemu štandardu, ktorý spája AI modely a nástroje, na ktorých závisia.
...
Je o posilnení vývojárov, aby používali MCP vo svojom vývojárskom pracovnom postupe, a o oslave úžasnej MCP komunity. Pripoja sa k nám členovia komunity a partneri ako Arcade, Block, Okta a Neon, aby ukázali, ako spolupracujú s Microsoftom na formovaní otvoreného, rozšíriteľného ekosystému MCP. 
...
Tento obsah je licencovaný pod **MIT licenciou**. Podmienky a ustanovenia nájdete v [LICENSE](../../LICENSE).
...
Tento projekt môže obsahovať ochranné známky alebo logá pre projekty, produkty alebo služby. Autorizované použitie ochranných známok alebo log Microsoftu podlieha a musí dodržiavať
