...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T21:35:13+00:00",
...
- Vizualizovanú mapu učebných osnov so všetkými pokrytými témami
...
Je o posilnení vývojárov, aby mohli používať MCP vo svojom vývojovom pracovnom toku, a o oslave úžasnej MCP komunity. Pripoja sa k nám členovia komunity a partneri ako Arcade, Block, Okta a Neon, aby ukázali, ako spolupracujú s Microsoftom na formovaní otvoreného, rozšíriteľného ekosystému MCP. 
...
Naučte sa v intenzívnych video reláciách, ako vytvárať MCP servery, integrovať ich s VS Code a profesionálne nasadzovať na Azure na základe obsahu z učebných osnov MCP pre začiatočníkov. Získajte praktické zručnosti v technológii, ktorú už používajú veľké spoločnosti.
...
- **Hlavné učebné osnovy (00-11)**: Hlavný obsah organizovaný v jedenástich sekvenčných moduloch, vrátane komplexných laboratórií integrácie databázy
...
Tento projekt môže obsahovať ochranné známky alebo logá pre projekty, produkty alebo služby. Povolené používanie ochranných známok alebo log Microsoftu podlieha a musí dodržiavať [Microsoftove pokyny pre ochranné známky a značky](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). Používanie ochranných známok alebo log Microsoftu v upravených verziách tohto projektu nesmie spôsobovať zmätok ani naznačovať sponzorstvo zo strany Microsoftu. Akékoľvek používanie ochranných známok alebo log tretích strán podlieha politikám týchto tretích strán.
