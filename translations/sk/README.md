...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T07:52:30+00:00",
...
- 📜 [Pôvodná špecifikácia MCP](https://spec.modelcontextprotocol.io/) – Technické referencie staršej verzie (môže obsahovať ďalšie detaily)  
...
|--------|-------|-------------|------|
| **Modul 1-3: Základy** | | | |
| 00 | Úvod do MCP | Prehľad Model Context Protocol a jeho význam v AI procesoch | [Čítajte viac](./00-Introduction/README.md) |
...
| 3.2 | Prvý klient | Vyvinúť základného MCP klienta | [Sprievodca](./03-GettingStarted/02-client/README.md) |
...
| 3.5 | stdio server | Vytváranie serverov pomocou stdio transportu | [Sprievodca](./03-GettingStarted/05-stdio-server/README.md) |
...
| 05 | Pokročilé témy v MCP | Multimodálna AI, škálovanie, podnikové použitie | [Čítajte viac](./05-AdvancedTopics/README.md) |
...
| 5.10 | Realtime streaming | Vytvorenie funkcie realtime streamingu | [Sprievodca](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
...
| 5.14 | Context Engineering | Techniky efektívneho context engineering | [Sprievodca](./05-AdvancedTopics/mcp-contextengineering/README.md) |
| 5.15 | MCP Custom Transport | Vlastné implementácie transportu | [Sprievodca](./05-AdvancedTopics/mcp-transport/README.md) |
| **Modul 6-10: Komunita a najlepšie postupy** | | | |
| 06 | Príspevky komunity | Ako prispievať do ekosystému MCP | [Sprievodca](./06-CommunityContributions/README.md) |
...
| 11.2 | Základná architektúra | Pochopenie architektúry MCP servera, databázových vrstiev a bezpečnostných vzorov | [Laboratórium 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
| 11.3 | Bezpečnosť a Multi-Tenancy | Riadenie prístupu na úrovni riadkov, autentifikácia a prístup k dátam pre viacerých nájomcov | [Lab 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
Aby ste z tejto učebnej osnovy získali maximum, mali by ste mať:
...
- Doplnkové zdroje na obohatenie vašej učebnej cesty
...
#### [Deň 1: MCP produktivita, vývojové nástroje a komunita:](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

Je zameraný na posilnenie vývojárov pri používaní MCP vo svojom vývojovom pracovnom postupe a oslavu úžasnej MCP komunity. Pripoja sa k nám členovia komunity a partneri ako Arcade, Block, Okta a Neon, aby ukázali, ako spolupracujú s Microsoftom na formovaní otvoreného, rozšíriteľného MCP ekosystému. 
Reálne ukážky vo VS Code, Visual Studio, GitHub Copilot a populárnych komunitných nástrojoch
Praktické, kontextovo riadené vývojové pracovné postupy
...
#### [Deň 2: Vytvárajte MCP servery s istotou](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

Je určený pre tvorcov MCP. Pôjdeme do hĺbky implementačných stratégií a najlepších praktík na vytváranie MCP serverov a integráciu MCP do vašich AI pracovných postupov.
...
#### [➡️Sledovať na požiadanie MCP Bootcamp | Angličtina](https://developer.microsoft.com/en-us/reactor/series/s-1568/)
...
Naučme sa o Model Context Protocol (MCP), špičkovom rámci navrhnutom na štandardizáciu interakcií medzi AI modelmi a klientskými aplikáciami. Prostredníctvom tejto relácie pre začiatočníkov vás zoznámime s MCP a prevedieme vás vytvorením vášho prvého MCP servera.
...
Tento obsah je licencovaný pod **MIT licenciou**. Pre podmienky a pravidlá si pozrite [LICENSE](../../LICENSE).
...
práva na používanie vášho príspevku. Podrobnosti nájdete na <https://cla.opensource.microsoft.com>.
...
Pre viac informácií si pozrite [FAQ kódexu správania](https://opensource.microsoft.com/codeofconduct/faq/) alebo
...
- [Generatívna AI pre začiatočníkov s Javou](https://github.com/microsoft/generative-ai-for-beginners-java?WT.mc_id=academic-105485-koreyst)
...
Tento projekt môže obsahovať ochranné známky alebo logá projektov, produktov alebo služieb. Používanie ochranných známok alebo log Microsoftu je povolené len v súlade s [Microsoftovými pokynmi pre ochranné známky a značky](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). Používanie ochranných známok alebo log Microsoftu v upravených verziách tohto projektu nesmie spôsobovať zmätok ani naznačovať, že ide o sponzoring zo strany Microsoftu. Akékoľvek používanie ochranných známok alebo log tretích strán podlieha pravidlám týchto tretích strán.

## Získanie pomoci

Ak narazíte na problémy alebo máte otázky týkajúce sa vytvárania AI aplikácií, pridajte sa:
