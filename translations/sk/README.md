...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-19T15:49:54+00:00",
...
### ➡️Sledujte na požiadanie - MCP Dev Days  
...
Je zameraný na posilnenie vývojárov, aby používali MCP vo svojom vývojárskom pracovnom postupe, a na oslavu úžasnej komunity MCP. Pripoja sa k nám členovia komunity a partneri ako Arcade, Block, Okta a Neon, aby ukázali, ako spolupracujú s Microsoftom na formovaní otvoreného, rozšíriteľného ekosystému MCP.  
...
Ak ste vývojár, tvorca nástrojov alebo AI produktový stratég, tento deň je plný poznatkov, ktoré potrebujete na vytvorenie škálovateľných, bezpečných a pripravených na budúcnosť MCP riešení.
...
| 3.4 | Integrácia VS Code | Používanie MCP serverov vo VS Code | [Sprievodca](./03-GettingStarted/04-vscode/README.md) |
...
| 5.10 | Realtime streaming | Vytváranie funkcií realtime streamingu | [Sprievodca](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
...
| 07 | Skúsenosti z počiatočného prijatia | Príbehy z reálneho nasadenia | [Guide](./07-LessonsFromEarlyAdoption/README.md) |
