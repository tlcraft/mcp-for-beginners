...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T20:07:43+00:00",
...
### ➡️ Sledujte na požiadanie - MCP Dev Days  
Pripravte sa na dva dni plné technických poznatkov, spojenia s komunitou a praktického učenia na MCP Dev Days, virtuálnom podujatí venovanom Model Context Protocol (MCP) — vznikajúcemu štandardu, ktorý spája AI modely a nástroje, na ktorých závisia.  
...
Je zameraný na posilnenie vývojárov, aby používali MCP vo svojom vývojárskom pracovnom postupe, a na oslavu úžasnej komunity MCP. Pripojíme sa k členom komunity a partnerom, ako sú Arcade, Block, Okta a Neon, aby sme videli, ako spolupracujú s Microsoftom na formovaní otvoreného, rozšíriteľného ekosystému MCP.  
...
- Používanie stavebných blokov, ako sú Funkcie, ACA a API Management  
- Zarovnanie registru a nástroje (1P + 3P)  

Ak ste vývojár, tvorca nástrojov alebo stratég AI produktov, tento deň je plný poznatkov, ktoré potrebujete na vytvorenie škálovateľných, bezpečných a pripravených na budúcnosť MCP riešení.
...
|-------|------|-------|-------|
| **Moduly 1-3: Základy** | | | |
| 00 | Úvod do MCP | Prehľad Model Context Protocol a jeho významu v AI pipeline | [Čítajte viac](./00-Introduction/README.md) |
| 01 | Vysvetlenie základných konceptov | Hĺbkový prieskum základných konceptov MCP | [Čítajte viac](./01-CoreConcepts/README.md) |
| 02 | Bezpečnosť v MCP | Hrozby bezpečnosti a osvedčené postupy | [Čítajte viac](./02-Security/README.md) |
...
| 3.4 | Integrácia VS Code | Spotrebujte MCP servery vo VS Code | [Sprievodca](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | SSE server | Vytvorte servery pomocou Server-Sent Events | [Sprievodca](./03-GettingStarted/05-sse-server/README.md) |
| 3.6 | HTTP streaming | Implementujte HTTP streaming v MCP | [Sprievodca](./03-GettingStarted/06-http-streaming/README.md) |
| 3.7 | AI Toolkit | Používajte AI Toolkit s MCP | [Sprievodca](./03-GettingStarted/07-aitk/README.md) |
| 3.8 | Testovanie | Testujte implementáciu MCP servera | [Sprievodca](./03-GettingStarted/08-testing/README.md) |
...
| 5.1 | Integrácia Azure | Integrácia MCP s Azure | [Sprievodca](./05-AdvancedTopics/mcp-integration/README.md) |
...
| 5.5 | Routing | Stratégie routingu MCP | [Sprievodca](./05-AdvancedTopics/mcp-routing/README.md) |
...
| 5.9 | Web Search | Implementácia schopností webového vyhľadávania | [Sprievodca](./05-AdvancedTopics/web-search-mcp/README.md) |
...
| 06 | Príspevky komunity | Ako prispieť do ekosystému MCP | [Guide](./06-CommunityContributions/README.md) |
| 07 | Postrehy z počiatočného používania | Skutočné príbehy implementácie | [Guide](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | Najlepšie postupy pre MCP | Výkon, odolnosť voči chybám, reziliencia | [Guide](./08-BestPractices/README.md) |
| 09 | Prípadové štúdie MCP | Praktické príklady implementácie | [Guide](./09-CaseStudy/README.md) |
| 10 | Praktický workshop | Vytvorenie MCP servera s AI Toolkit | [Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
| Jazyk | Popis | Odkaz |
|-------|-------|-------|
| C# | Príklad MCP servera | [View Code](./03-GettingStarted/samples/csharp/README.md) |
...
| TypeScript | Príklad MCP | [View Code](./03-GettingStarted/samples/typescript/README.md) |
| Rust | Príklad MCP | [View Code](./03-GettingStarted/samples/rust/README.md) |

#### Pokročilé implementácie MCP

| Jazyk | Popis | Odkaz |
|-------|-------|-------|
| C# | Pokročilá ukážka | [View Code](./04-PracticalImplementation/samples/csharp/README.md) |
| Java so Spring | Príklad aplikácie v kontajneri | [View Code](./04-PracticalImplementation/samples/java/containerapp/README.md) |
| JavaScript | Pokročilá ukážka | [View Code](./04-PracticalImplementation/samples/javascript/README.md) |
| Python | Komplexná implementácia | [View Code](../../04-PracticalImplementation/samples/python/READMEmd) |
| TypeScript | Ukážka kontajnera | [View Code](./04-PracticalImplementation/samples/typescript/README.md) |
...
- Účasť na diskusiách komunity pre podporu
...
- Ďalšie zdroje na doplnenie vašej učebnej cesty
...
3. Cvičenia na vytvorenie skutočných aplikácií MCP  
...
[Pokyny pre ochranné známky a značky Microsoftu](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
