...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T19:03:47+00:00",
...
| 01 | Vysvetlenie základných konceptov | Hlbší pohľad na základné koncepty MCP | [Čítajte viac](./01-CoreConcepts/README.md) |
...
| 3.4 | Integrácia s VS Code | Použitie MCP serverov vo VS Code | [Sprievodca](./03-GettingStarted/04-vscode/README.md) |
...
| 05 | Pokročilé témy v MCP | Multimodálna AI, škálovanie, použitie v podnikoch | [Čítajte viac](./05-AdvancedTopics/README.md) |
...
| 5.8 | Bezpečnosť | Pokročilé úvahy o bezpečnosti | [Sprievodca](./05-AdvancedTopics/mcp-security/README.md) |
...
| 5.13 | Integrácia Foundry | Integrácia s Azure AI Foundry | [Sprievodca](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
...
Udržiavame podrobný [Zoznam zmien](./changelog.md), ktorý sleduje všetky významné aktualizácie učebných materiálov, vrátane:
...
2. Živé ukážky kódu v rôznych jazykoch  
...
Je o posilnení vývojárov, aby používali MCP vo svojom vývojárskom pracovnom toku, a o oslave úžasnej MCP komunity. Pripoja sa k nám členovia komunity a partneri ako Arcade, Block, Okta a Neon, aby ukázali, ako spolupracujú s Microsoftom na formovaní otvoreného, rozšíriteľného MCP ekosystému. 
...
Je určený pre tvorcov MCP. Pôjdeme do hĺbky implementačných stratégií a osvedčených postupov na vytváranie MCP serverov a integráciu MCP do vašich AI pracovných tokov.
...
Naučte sa v intenzívnych video reláciách, ako vytvárať MCP servery, integrovať ich s VS Code a profesionálne ich nasadzovať na Azure na základe obsahu z učebnej osnovy MCP pre začiatočníkov. Získajte praktické zručnosti v technológii, ktorú už používajú veľké spoločnosti.
...
### Poďme sa učiť MCP s C# - séria tutoriálov
Poďme sa naučiť o Model Context Protocol (MCP), špičkovom rámci navrhnutom na štandardizáciu interakcií medzi AI modelmi a klientskými aplikáciami. Prostredníctvom tejto relácie pre začiatočníkov vám predstavíme MCP a prevedieme vás procesom vytvorenia vášho prvého MCP servera.
...
Tento projekt môže obsahovať ochranné známky alebo logá pre projekty, produkty alebo služby. Autorizované používanie ochranných známok alebo log Microsoftu podlieha a musí dodržiavať
