...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T20:09:56+00:00",
...
V tomto konkrétnom prípade sa naučíme zverejniť API koncové body ako MCP server. Týmto spôsobom môžeme ľahko začleniť tieto koncové body do agentickej aplikácie a zároveň využiť funkcie Azure API Management.
...
- [AI Gateway workshopy](https://azure-samples.github.io/AI-Gateway/) Obsahuje workshopy pomocou Azure Portal, čo je skvelý spôsob, ako začať hodnotiť AI schopnosti.
