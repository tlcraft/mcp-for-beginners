...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T22:07:31+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "sk"
}
-->
# Návrh databázy a schéma

## 🎯 Čo tento lab pokrýva

Tento lab sa podrobne zaoberá návrhom databázy PostgreSQL pre systém Zava Retail. Naučíte sa implementovať komplexnú maloobchodnú schému s funkciami vyhľadávania pomocou vektorov, modelovaním dát pre viacerých nájomcov a Row Level Security (RLS) na izoláciu dát.

## Prehľad

Databáza je základom nášho MCP servera, uchováva maloobchodné dáta naprieč viacerými predajňami a zároveň zabezpečuje prísnu izoláciu dát. Používame PostgreSQL s rozšírením pgvector na umožnenie semantického vyhľadávania, ktoré zákazníkom umožňuje nájsť produkty pomocou prirodzených jazykových dotazov.

Naša schéma sleduje moderné vzory pre viacerých nájomcov, pričom Row Level Security zaručuje, že používatelia majú prístup iba k dátam z autorizovaných predajní. Tento prístup poskytuje bezpečnosť na úrovni podnikov pri zachovaní optimálneho výkonu.

## Ciele učenia

Na konci tohto labu budete schopní:

- **Navrhnúť** škálovateľné databázové schémy pre viacerých nájomcov v maloobchode
- **Implementovať** PostgreSQL s pgvector na vyhľadávanie pomocou vektorov
- **Konfigurovať** Row Level Security na izoláciu dát
- **Generovať** realistické vzorové dáta na testovanie
- **Optimalizovať** výkon databázy pre maloobchodné pracovné zaťaženie
- **Implementovať** stratégie zálohovania a obnovy

## 🗃️ Architektúra databázy

### PostgreSQL s pgvector

Naša databáza využíva podnikové funkcie PostgreSQL v kombinácii s rozšírením pgvector na vyhľadávanie poháňané AI:
...
Databáza používa model **zdieľaná databáza, zdieľaná schéma** pre viacerých nájomcov s Row Level Security:
...
## 📊 Návrh základnej schémy

### Tabuľka predajní (Tenant Master)
...
### Tabuľka produktov s kategóriami
...
## 🔍 Implementácia vyhľadávania pomocou vektorov

### Tabuľka produktových embeddingov
...
### Funkcie vyhľadávania pomocou vektorov
...
## 🔐 Nastavenie Row Level Security

### Role a oprávnenia v databáze
...
### Skript na realistické testovacie dáta
...
### Pohľady na optimalizáciu dotazov
...
✅ **Návrh databázy pre viacerých nájomcov**: Implementovanú Row Level Security na bezpečnú izoláciu dát  
✅ **Funkcie vyhľadávania pomocou vektorov**: Konfigurovaný pgvector na semantické vyhľadávanie produktov  
✅ **Komplexnú schému**: Vytvorenú produkčne pripravenú maloobchodnú databázovú schému  
✅ **Generovanie vzorových dát**: Vytvorené realistické testovacie dáta na vývoj a testovanie  
✅ **Optimalizáciu výkonu**: Konfigurované indexy a optimalizáciu dotazov  
✅ **Zálohovanie a obnovu**: Zavedené robustné stratégie ochrany dát  

## 🚀 Čo ďalej

Pokračujte s **[Lab 05: Implementácia MCP servera](../05-MCP-Server/README.md)** na:

- Vytvorenie FastMCP servera, ktorý sa pripája k tejto databáze
- Implementáciu nástrojov na dotazovanie databázy pre MCP protokol
- Pridanie funkcií semantického vyhľadávania pomocou embeddingov
- Konfiguráciu pooling pripojení a spracovanie chýb

## 📚 Ďalšie zdroje

### PostgreSQL & pgvector
- [PostgreSQL Dokumentácia](https://www.postgresql.org/docs/) - Kompletný referenčný materiál PostgreSQL
- [pgvector Rozšírenie](https://github.com/pgvector/pgvector) - Vyhľadávanie podobnosti vektorov pre PostgreSQL
- [Optimalizácia výkonu PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Najlepšie praktiky optimalizácie

### Architektúra pre viacerých nájomcov
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Dokumentácia PostgreSQL RLS
- [Architektúra dát pre viacerých nájomcov](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Vzory architektúry Azure
- [Najlepšie praktiky bezpečnosti databázy](https://www.postgresql.org/docs/current/security.html) - Sprievodca bezpečnosťou PostgreSQL

### Vektorové databázy
- [Základy vyhľadávania pomocou vektorov](https://www.pinecone.io/learn/vector-database/) - Pochopenie vektorových databáz
- [Embedding modely](https://platform.openai.com/docs/guides/embeddings) - Dokumentácia embeddingov OpenAI
- [HNSW Algoritmus](https://arxiv.org/abs/1603.09320) - Hierarchické navigovateľné malé svety (HNSW)

---

**Predchádzajúce**: [Lab 03: Nastavenie prostredia](../03-Setup/README.md)  
**Ďalšie**: [Lab 05: Implementácia MCP servera](../05-MCP-Server/README.md)
