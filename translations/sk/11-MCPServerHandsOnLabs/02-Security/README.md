...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T21:55:41+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "sk"
}
-->
# Bezpečnosť a Multi-Tenancy

## 🎯 Čo tento lab pokrýva

Tento lab poskytuje komplexné pokyny na implementáciu bezpečnosti na podnikovej úrovni a multi-tenancy pre MCP servery. Naučíte sa navrhnúť bezpečné a súladné systémy, ktoré chránia citlivé údaje z maloobchodu a zároveň umožňujú flexibilné prístupy pre viacerých nájomcov.

## Prehľad

Bezpečnosť je kľúčová v maloobchodných aplikáciách, ktoré spracovávajú údaje zákazníkov, informácie o platbách a obchodnú inteligenciu. Tento lab pokrýva kompletnú bezpečnostnú architektúru od autentifikácie a autorizácie až po izoláciu dát a monitorovanie súladu.

Implementujeme stratégiu obrany v hĺbke, ktorá kombinuje služby identity Azure, Row Level Security v PostgreSQL, kontrolu na úrovni aplikácie a komplexné auditné logovanie na vytvorenie robustnej a súladnej platformy.

## Ciele učenia

Na konci tohto labu budete schopní:

- **Implementovať** Row Level Security na podnikovej úrovni pre izoláciu dát viacerých nájomcov
- **Navrhnúť** bezpečné vzory autentifikácie a autorizácie pomocou Azure
- **Konfigurovať** komplexné auditné logovanie pre požiadavky na súlad
- **Aplikovať** stratégie obrany v hĺbke naprieč všetkými vrstvami aplikácie
- **Validovať** bezpečnostné implementácie prostredníctvom systematického testovania
- **Monitorovať** bezpečnostné udalosti a reagovať na potenciálne hrozby

## 🔐 Architektúra bezpečnosti pre multi-tenancy

### Prehľad bezpečnostných vrstiev
...
Naša implementácia používa model **Shared Database, Shared Schema** s Row Level Security:

**Výhody:**
- Nákladovo efektívne využívanie zdrojov
- Zjednodušená údržba a aktualizácie
- Silná izolácia dát prostredníctvom RLS
- Auditné stopy vhodné pre súlad

**Nevýhody:**
- Vyžaduje starostlivý návrh RLS politík
- Zmeny v schéme ovplyvňujú všetkých nájomcov
- Potreba robustných postupov zálohovania/obnovy

## 🛡️ Implementácia Row Level Security
...
## 🔍 Audit bezpečnosti a súlad

### Komplexné auditné logovanie
...
### Pohľady na monitorovanie bezpečnosti
...
### Automatizované bezpečnostné testy
...
### Kontrolný zoznam pre penetračné testovanie
...
✅ **Bezpečnosť pre multi-tenancy**: Implementovanú Row Level Security pre úplnú izoláciu dát  
✅ **Autentifikáciu Azure**: Integrované Azure Entra ID s validáciou JWT  
✅ **Autorizáciu na základe rolí**: Konfigurovaný hierarchický systém rolí a oprávnení  
✅ **Komplexné auditné logovanie**: Zriadené sledovanie a monitorovanie bezpečnostných udalostí  
✅ **Testovanie bezpečnosti**: Implementované automatizované testy na validáciu bezpečnosti  
✅ **Monitorovanie hrozieb**: Vytvorené detekcie bezpečnostných udalostí v reálnom čase a upozornenia  

## 🚀 Čo ďalej

Pokračujte s **[Lab 03: Nastavenie prostredia](../03-Setup/README.md)** na:

- Konfiguráciu vývojových prostredí s najlepšími bezpečnostnými praktikami
- Nastavenie služieb Azure pre autentifikáciu a monitorovanie
- Implementáciu bezpečných pripojení k databáze a správu tajomstiev
- Validáciu bezpečnostných konfigurácií vo vývojových prostrediach

## 📚 Ďalšie zdroje

### Bezpečnosť Azure
- [Dokumentácia Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - Kompletný sprievodca platformou identity
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Služba na správu tajomstiev
- [Najlepšie bezpečnostné praktiky Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Pokyny k bezpečnosti

### Bezpečnosť databázy
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Oficiálna dokumentácia RLS
- [Kontrolný zoznam bezpečnosti databázy](https://www.postgresql.org/docs/current/security.html) - Sprievodca bezpečnosťou PostgreSQL
- [Vzory databáz pre multi-tenancy](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Architektonické vzory

### Testovanie bezpečnosti
- [OWASP Testing Guide](https://owasp.org/www-project-web-security-testing-guide/) - Komplexné testovanie bezpečnosti
- [Najlepšie praktiky bezpečnosti JWT](https://tools.ietf.org/html/rfc8725) - Úvahy o bezpečnosti JWT
- [Testovanie bezpečnosti API](https://owasp.org/www-project-api-security/) - Testovanie bezpečnosti špecifické pre API

---

**Predchádzajúce**: [Lab 01: Základné koncepty architektúry](../01-Architecture/README.md)  
**Ďalšie**: [Lab 03: Nastavenie prostredia](../03-Setup/README.md)
