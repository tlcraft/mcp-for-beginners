...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T22:05:55+00:00",
...
Tento lab poskytuje komplexné pokyny na nasadenie MCP retail servera do produkčného prostredia pomocou moderných prístupov k kontajnerizácii a cloud-native technológiám. Naučíte sa nasadiť škálovateľné, bezpečné a monitorované MCP servery, ktoré zvládnu podnikové zaťaženie.

## Prehľad

Produkčné nasadenie MCP serverov si vyžaduje dôkladné zváženie kontajnerizácie, orchestrácie, bezpečnosti, škálovateľnosti a monitorovania. Tento lab pokrýva nasadenie do Azure Container Apps s PostgreSQL Flexible Server, implementáciu CI/CD pipeline a konfiguráciu automatického škálovania pre variabilné zaťaženie.

Stratégie nasadenia sa pohybujú od jednoduchých nasadení jedného kontajnera pre vývoj až po sofistikované produkčné prostredia s viacerými regiónmi, automatickým škálovaním, komplexným monitorovaním a bezpečnostnými funkciami.

## Ciele učenia

Na konci tohto labu budete schopní:

- **Kontajnerizovať** MCP servery pomocou Dockeru s multi-stage buildami
- **Nasadiť** do Azure Container Apps s bezpečnou sieťovou konfiguráciou
- **Konfigurovať** produkčný PostgreSQL s vysokou dostupnosťou
- **Implementovať** CI/CD pipeline pre automatizované nasadenie
- **Škálovať** aplikácie automaticky na základe dopytu
- **Monitorovať** produkčné nasadenia s komplexnou observabilitou

## 🐳 Kontajnerizácia pomocou Dockeru
...
## ☁️ Nasadenie do Azure Container Apps

### Infrastruktúra ako kód pomocou Bicep
...
## 🔐 Konfigurácia bezpečnosti pre produkciu
...
✅ **Stratégiu kontajnerov**: Produkčne pripravené Docker kontajnery s posilnenou bezpečnosťou  
✅ **Cloudové nasadenie**: Azure Container Apps s automatickým škálovaním a monitorovaním  
✅ **Nasadenie databázy**: PostgreSQL Flexible Server s vysokou dostupnosťou  
✅ **CI/CD pipeline**: Automatizované testovanie, buildovanie a nasadzovanie  
✅ **Monitorovanie výkonu**: Komplexné zbieranie metrik a upozornení  
✅ **Konfiguráciu bezpečnosti**: Produkčne pripravené bezpečnostné politiky a izoláciu siete  

## 🚀 Čo ďalej

Pokračujte s **[Lab 11: Monitorovanie a observabilita](../11-Monitoring/README.md)**, kde sa naučíte:

- Nastaviť komplexné monitorovanie pomocou Application Insights
- Konfigurovať štruktúrované logovanie a distribuované trasovanie
- Implementovať upozornenia a automatizované reakčné systémy
- Monitorovať obchodné metriky a výkonnostné KPI

## 📚 Dodatočné zdroje

### Technológie kontajnerov
- [Najlepšie praktiky Dockeru](https://docs.docker.com/develop/dev-best-practices/) - Oficiálne odporúčania Dockeru
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Dokumentácia Azure Container Apps
- [Dokumentácia Kubernetes](https://kubernetes.io/docs/) - Oficiálna dokumentácia Kubernetes

### CI/CD a DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - Dokumentácia GitHub Actions
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Služby Azure DevOps
- [Infrastruktúra ako kód](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Dokumentácia Azure Bicep

### Bezpečnosť a monitorovanie
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Odporúčania pre bezpečnosť Azure
- [Bezpečnosť kontajnerov](https://kubernetes.io/docs/concepts/security/) - Koncepty bezpečnosti Kubernetes
...
**Predchádzajúce**: [Lab 09: Integrácia VS Code](../09-VS-Code/README.md)  
**Ďalšie**: [Lab 11: Monitorovanie a observabilita](../11-Monitoring/README.md)
