...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T22:09:40+00:00",
...
Tento lab poskytuje komplexné pokyny na implementáciu semantických vyhľadávacích funkcií pomocou Azure OpenAI embeddings a rozšírenia pgvector v PostgreSQL. Naučíte sa vytvoriť AI-poháňané vyhľadávanie produktov, ktoré rozumie prirodzeným jazykovým dotazom a poskytuje relevantné výsledky na základe semantickej podobnosti.

## Prehľad

Tradičné vyhľadávanie založené na kľúčových slovách často nedokáže zachytiť zámer používateľa a semantický význam. Semantické vyhľadávanie pomocou vektorových embeddings umožňuje prirodzené jazykové dotazy, ako napríklad „pohodlné bežecké topánky do daždivého počasia“, nájsť relevantné produkty, aj keď tieto presné slová nie sú uvedené v popisoch produktov.

Naša implementácia kombinuje výkonné embedding modely Azure OpenAI s rozšírením pgvector v PostgreSQL, aby vytvorila vysokovýkonný, škálovateľný systém semantického vyhľadávania, ktorý zlepšuje maloobchodný zážitok inteligentným objavovaním produktov.

## Ciele učenia

Po dokončení tohto labu budete schopní:

- **Integrovať** embedding modely Azure OpenAI na vektorizáciu textu
- **Implementovať** pgvector na efektívne operácie vyhľadávania podobnosti
- **Vytvoriť** nástroje semantického vyhľadávania pre dotazy na produkty v prirodzenom jazyku
- **Navrhnúť** hybridné vyhľadávanie kombinujúce tradičné a vektorové vyhľadávanie
- **Optimalizovať** vektorové dotazy pre produkčný výkon
- **Vytvoriť** odporúčacie systémy pomocou podobnosti embeddings

## 🧠 Architektúra semantického vyhľadávania

### Pipeline vektorového vyhľadávania
...
### Stratégia generovania embeddings
...
## 🔍 Generovanie embeddings pre produkty

### Automatizovaný pipeline embeddings
...
## 🔎 Nástroje semantického vyhľadávania

### Nástroj semantického vyhľadávania produktov
...
### Optimalizácia vektorových dotazov
...
✅ **Integráciu Azure OpenAI**: Kompletné generovanie embeddings s cache a optimalizáciou  
✅ **Implementáciu vektorového vyhľadávania**: Produkčne pripravené semantické vyhľadávanie s pgvector  
✅ **Hybridné vyhľadávacie schopnosti**: Kombinované vyhľadávanie na základe kľúčových slov a semantiky pre optimálne výsledky  
✅ **Odporúčacie systémy**: AI-poháňané odporúčania produktov pomocou podobnosti  
✅ **Optimalizáciu výkonu**: Optimalizácia indexov vektorov a inteligentné cache  
✅ **Škálovateľnú architektúru**: Semantické vyhľadávanie pripravené pre podnikové prostredie  

## 🚀 Čo ďalej

Pokračujte s **[Lab 08: Testovanie a ladenie](../08-Testing/README.md)**, kde sa naučíte:

- Implementovať komplexné testovacie stratégie pre semantické vyhľadávanie
- Ladiť problémy s výkonom vektorového vyhľadávania
- Validovať kvalitu a relevantnosť embeddings
- Testovať presnosť odporúčacieho systému

## 📚 Ďalšie zdroje

### Azure OpenAI
- [Dokumentácia služby Azure OpenAI](https://docs.microsoft.com/azure/cognitive-services/openai/) - Kompletný sprievodca službou
- [Referenčná dokumentácia API embeddings](https://platform.openai.com/docs/api-reference/embeddings) - Dokumentácia API
- [Najlepšie praktiky pre embeddings](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Pokyny na implementáciu

### Vektorové databázy
- [Dokumentácia pgvector](https://github.com/pgvector/pgvector) - Rozšírenie PostgreSQL pre vektory
- [Optimalizácia vektorového vyhľadávania](https://www.pinecone.io/learn/vector-search-optimization/) - Ladenie výkonu
- [Algoritmus HNSW](https://arxiv.org/abs/1603.09320) - Hierarchické navigovateľné malé svety

### Semantické vyhľadávanie
- [Základy informačného vyhľadávania](https://nlp.stanford.edu/IR-book/) - Učebnica Stanford IR
- [Najlepšie praktiky vektorového vyhľadávania](https://weaviate.io/blog/vector-search-best-practices) - Vzorové implementácie
- [Stratégie hybridného vyhľadávania](https://blog.vespa.ai/hybrid-search/) - Kombinovanie rôznych prístupov vyhľadávania

---

**Predchádzajúce**: [Lab 06: Vývoj nástrojov](../06-Tools/README.md)  
**Ďalšie**: [Lab 08: Testovanie a ladenie](../08-Testing/README.md)
