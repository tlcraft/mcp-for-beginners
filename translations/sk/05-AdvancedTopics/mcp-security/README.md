...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T20:17:49+00:00",
...
Táto lekcia skúma pokročilé bezpečnostné implementácie založené na najnovšej MCP špecifikácii (2025-06-18), bezpečnostných riešeniach od Microsoftu a zavedených podnikových bezpečnostných vzoroch.
...
- **Zabezpečiť vykonávanie nástrojov**: Navrhnúť izolované prostredia s riadnou izoláciou a kontrolou zdrojov
- **Riešiť zraniteľnosti MCP**: Identifikovať a zmierniť problémy zmätku zástupcu, zraniteľnosti pri prechode tokenov a riziká dodávateľského reťazca
- **Integrovať bezpečnostné riešenia od Microsoftu**: Využiť Azure bezpečnostné služby a GitHub Advanced Security pre komplexnú ochranu

## **POVINNÉ bezpečnostné požiadavky**

### **Kritické požiadavky podľa MCP Špecifikácie (2025-06-18):**
...
Aktuálna MCP špecifikácia (2025-06-18) umožňuje delegáciu externým poskytovateľom identity, ako je Microsoft Entra ID, poskytujúc podnikové bezpečnostné funkcie:
...
## Bezpečnostné kontroly špecifické pre AI & riešenia od Microsoftu

### **Obrana proti injekcii promptov pomocou Microsoft Prompt Shields**

Moderné implementácie MCP čelia sofistikovaným útokom špecifickým pre AI, ktoré vyžadujú špecializované obranné mechanizmy:
...
### **1. Prevencia útokov zmätku zástupcu**

**Vylepšená implementácia podľa MCP Špecifikácie (2025-06-18):**
...
Podniková integrácia:
  Azure Key Vault pre správu tajomstiev
  Application Insights pre monitorovanie bezpečnosti
...
- **Pokročilá ochrana AI**: Obranné mechanizmy špecifické pre AI  
...
- **Škálovateľná architektúra**: Podnikové škálovanie s udržaním bezpečnostných kontrol
...
> **Bezpečnostné upozornenie**: Tento pokročilý implementačný sprievodca odráža aktuálne požiadavky MCP špecifikácie (2025-06-18). Vždy overte podľa najnovšej oficiálnej dokumentácie a zvážte vaše konkrétne bezpečnostné požiadavky a model hrozieb pri implementácii týchto kontrol.
