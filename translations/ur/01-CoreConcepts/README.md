...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T12:33:41+00:00",
  "source_file": "01-CoreConcepts/README.md",
  "language_code": "ur"
}
-->
# ایم سی پی کے بنیادی تصورات: ماڈل کانٹیکسٹ پروٹوکول کے ذریعے اے آئی انضمام میں مہارت حاصل کریں
...
ایم سی پی پروٹوکول ایک ارتقائی معیار ہے جو تاریخ پر مبنی ورژننگ (YYYY-MM-DD فارمیٹ) استعمال کرتا ہے۔ موجودہ پروٹوکول ورژن **2025-06-18** ہے۔ آپ پروٹوکول کی تازہ ترین اپ ڈیٹس [پروٹوکول کی وضاحت](https://modelcontextprotocol.io/specification/2025-06-18/) پر دیکھ سکتے ہیں۔
...
**ٹولز** وہ قابل عمل افعال ہیں جنہیں اے آئی ماڈلز مخصوص اعمال انجام دینے کے لیے استعمال کر سکتے ہیں۔ یہ ایم سی پی ایکو سسٹم کے "افعال" کی نمائندگی کرتے ہیں، جو ماڈلز کو بیرونی نظاموں کے ساتھ تعامل کرنے کے قابل بناتے ہیں:
...
یہ جاوا اسکرپٹ مثال دکھاتی ہے کہ MCP کلائنٹ کیسے بنایا جائے جو سرور سے جڑتا ہے، ایک پرامپٹ بھیجتا ہے، اور جواب کو پروسیس کرتا ہے جس میں کیے گئے کسی بھی ٹول کالز شامل ہیں۔
...
- **`notifications/initialized`**: اشارہ کرتا ہے کہ ابتدا مکمل ہو گئی ہے اور سیشن تیار ہے  
...
#### **عملدرآمد کے پیغامات**  
- **`tools/call` درخواست**: فراہم کردہ پیرامیٹرز کے ساتھ مخصوص ٹول کو نافذ کرتا ہے  
- **`resources/read` درخواست**: مخصوص وسائل سے مواد حاصل کرتا ہے  
...
- **نوٹیفیکیشن پیغامات**: `method` اور اختیاری `params` شامل کرتے ہیں (کوئی `id` یا جواب کی توقع نہیں)  
...
2. کون سے پیرامیٹرز قبول کرے گا  
3. کون سا آؤٹ پٹ واپس کرے گا  
