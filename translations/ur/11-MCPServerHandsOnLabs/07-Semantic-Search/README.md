...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T15:42:16+00:00",
...
یہ لیب Azure OpenAI ایمبیڈنگز اور PostgreSQL کے pgvector ایکسٹینشن کا استعمال کرتے ہوئے سیمینٹک سرچ کی صلاحیتوں کو نافذ کرنے کے لیے جامع رہنمائی فراہم کرتی ہے۔ آپ AI سے چلنے والی پروڈکٹ سرچ بنانا سیکھیں گے جو قدرتی زبان کے سوالات کو سمجھتی ہے اور سیمینٹک مماثلت کی بنیاد پر متعلقہ نتائج فراہم کرتی ہے۔

## جائزہ

روایتی کی ورڈ پر مبنی سرچ اکثر صارف کے ارادے اور سیمینٹک معنی کو سمجھنے میں ناکام رہتی ہے۔ ویکٹر ایمبیڈنگز کا استعمال کرتے ہوئے سیمینٹک سرچ قدرتی زبان کے سوالات جیسے "بارش کے موسم کے لیے آرام دہ دوڑنے والے جوتے" کو متعلقہ پروڈکٹس تلاش کرنے کی اجازت دیتی ہے، چاہے وہ الفاظ پروڈکٹ کی تفصیلات میں موجود نہ ہوں۔

ہماری امپلیمنٹیشن Azure OpenAI کے طاقتور ایمبیڈنگ ماڈلز کو PostgreSQL کے pgvector ایکسٹینشن کے ساتھ جوڑتی ہے تاکہ ایک اعلیٰ کارکردگی، قابل توسیع سیمینٹک سرچ سسٹم بنایا جا سکے جو ذہین پروڈکٹ دریافت کے ساتھ ریٹیل تجربے کو بہتر بناتا ہے۔

## سیکھنے کے مقاصد

اس لیب کے اختتام تک، آپ قابل ہوں گے:

- **انٹیگریٹ کریں** Azure OpenAI ایمبیڈنگ ماڈلز کو ٹیکسٹ ویکٹرائزیشن کے لیے  
- **نافذ کریں** pgvector کو مؤثر مماثلت سرچ آپریشنز کے لیے  
- **بنائیں** سیمینٹک سرچ ٹولز قدرتی زبان کے پروڈکٹ سوالات کے لیے  
- **تخلیق کریں** ہائبرڈ سرچ جو روایتی اور ویکٹر سرچ کو یکجا کرتی ہے  
- **آپٹمائز کریں** ویکٹر سوالات کو پروڈکشن کارکردگی کے لیے  
- **ڈیزائن کریں** ایمبیڈنگ مماثلت کا استعمال کرتے ہوئے ریکمنڈیشن سسٹمز  

## 🧠 سیمینٹک سرچ آرکیٹیکچر
...
## 🔍 پروڈکٹ ایمبیڈنگ جنریشن

### خودکار ایمبیڈنگ پائپ لائن
...
✅ **Azure OpenAI انٹیگریشن**: ایمبیڈنگ جنریشن مکمل کیشنگ اور اصلاح کے ساتھ  
✅ **ویکٹر سرچ امپلیمنٹیشن**: پروڈکشن کے لیے تیار سیمینٹک سرچ pgvector کے ساتھ  
✅ **ہائبرڈ سرچ صلاحیتیں**: بہترین نتائج کے لیے کی ورڈ اور سیمینٹک سرچ کا امتزاج  
✅ **ریکمنڈیشن سسٹمز**: AI سے چلنے والی پروڈکٹ ریکمنڈیشنز مماثلت کے ذریعے  
✅ **کارکردگی کی اصلاح**: ویکٹر انڈیکس کی اصلاح اور ذہین کیشنگ  
✅ **قابل توسیع آرکیٹیکچر**: انٹرپرائز کے لیے تیار سیمینٹک سرچ انفراسٹرکچر  

## 🚀 آگے کیا ہے؟

**[لیب 08: ٹیسٹنگ اور ڈیبگنگ](../08-Testing/README.md)** کے ساتھ جاری رکھیں تاکہ:

- سیمینٹک سرچ کے لیے جامع ٹیسٹنگ اسٹریٹجیز نافذ کریں  
- ویکٹر سرچ کی کارکردگی کے مسائل کو ڈیبگ کریں  
- ایمبیڈنگ کی کوالٹی اور مطابقت کی توثیق کریں  
- ریکمنڈیشن سسٹم کی درستگی کو ٹیسٹ کریں  

## 📚 اضافی وسائل

### Azure OpenAI  
- [Azure OpenAI سروس دستاویزات](https://docs.microsoft.com/azure/cognitive-services/openai/) - مکمل سروس گائیڈ  
- [ایمبیڈنگز API ریفرنس](https://platform.openai.com/docs/api-reference/embeddings) - API دستاویزات  
- [ایمبیڈنگز کے لیے بہترین طریقے](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - نفاذ کی رہنمائی  

### ویکٹر ڈیٹابیسز  
- [pgvector دستاویزات](https://github.com/pgvector/pgvector) - PostgreSQL ویکٹر ایکسٹینشن  
- [ویکٹر سرچ کی اصلاح](https://www.pinecone.io/learn/vector-search-optimization/) - کارکردگی کی ٹیوننگ  
- [HNSW الگورتھم](https://arxiv.org/abs/1603.09320) - ہائیرارکل نیویگیبل اسمال ورلڈ گراف  

### سیمینٹک سرچ  
- [انفارمیشن ریٹریول کے بنیادی اصول](https://nlp.stanford.edu/IR-book/) - اسٹینفورڈ IR ٹیکسٹ بک  
- [ویکٹر سرچ کے بہترین طریقے](https://weaviate.io/blog/vector-search-best-practices) - نفاذ کے پیٹرنز  
- [ہائبرڈ سرچ اسٹریٹجیز](https://blog.vespa.ai/hybrid-search/) - مختلف سرچ اپروچز کو یکجا کرنا  

---

**پچھلا**: [لیب 06: ٹول ڈیولپمنٹ](../06-Tools/README.md)  
**اگلا**: [لیب 08: ٹیسٹنگ اور ڈیبگنگ](../08-Testing/README.md)  
