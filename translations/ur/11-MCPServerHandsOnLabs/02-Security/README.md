...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T15:25:07+00:00",
...
یہ لیب MCP سرورز کے لیے انٹرپرائز گریڈ سیکیورٹی اور ملٹی ٹیننسی کو نافذ کرنے کے لیے جامع رہنمائی فراہم کرتی ہے۔ آپ سیکھیں گے کہ حساس ریٹیل ڈیٹا کی حفاظت کرتے ہوئے اور متعدد ٹیننٹس کے درمیان لچکدار رسائی کے نمونے کو فعال کرتے ہوئے محفوظ اور تعمیل شدہ نظام کیسے ڈیزائن کریں۔

## جائزہ

ریٹیل ایپلیکیشنز میں سیکیورٹی انتہائی اہم ہے جو کسٹمر ڈیٹا، ادائیگی کی معلومات، اور بزنس انٹیلیجنس کو ہینڈل کرتی ہیں۔ یہ لیب مکمل سیکیورٹی آرکیٹیکچر کا احاطہ کرتی ہے، جس میں تصدیق اور اجازت سے لے کر ڈیٹا آئسولیشن اور تعمیل کی نگرانی شامل ہے۔

ہم Azure شناختی خدمات، PostgreSQL Row Level Security، ایپلیکیشن لیول کنٹرولز، اور جامع آڈٹ لاگنگ کو یکجا کرتے ہوئے ایک مضبوط اور تعمیل شدہ پلیٹ فارم بنانے کے لیے دفاعی حکمت عملی نافذ کرتے ہیں۔

## سیکھنے کے مقاصد

اس لیب کے اختتام تک، آپ قابل ہوں گے:

- **نافذ کریں** انٹرپرائز گریڈ Row Level Security برائے ملٹی ٹیننٹ ڈیٹا آئسولیشن  
- **ڈیزائن کریں** Azure کے ساتھ محفوظ تصدیق اور اجازت کے نمونے  
- **تشکیل دیں** تعمیل کی ضروریات کے لیے جامع آڈٹ لاگنگ  
- **لاگو کریں** دفاعی حکمت عملی ایپلیکیشن کی تمام تہوں میں  
- **تصدیق کریں** سیکیورٹی کے نفاذ کو منظم جانچ کے ذریعے  
- **نگرانی کریں** سیکیورٹی ایونٹس اور ممکنہ خطرات کا جواب دیں  

## 🔐 ملٹی ٹیننٹ سیکیورٹی آرکیٹیکچر

### سیکیورٹی تہوں کا جائزہ
...
ہماری نفاذ **Shared Database, Shared Schema** ماڈل کو Row Level Security کے ساتھ استعمال کرتی ہے:

**فوائد:**  
- وسائل کا مؤثر استعمال  
- دیکھ بھال اور اپڈیٹس میں آسانی  
- RLS کے ذریعے مضبوط ڈیٹا آئسولیشن  
- تعمیل کے لیے دوستانہ آڈٹ ٹریلز  

**تبادلے:**  
- RLS پالیسی ڈیزائن میں احتیاط کی ضرورت  
- اسکیمہ میں تبدیلیاں تمام ٹیننٹس کو متاثر کرتی ہیں  
- مضبوط بیک اپ/ریسٹور طریقہ کار کی ضرورت  

## 🛡️ Row Level Security کا نفاذ
...
## 🧪 سیکیورٹی کی جانچ اور تصدیق

### خودکار سیکیورٹی ٹیسٹس
...
✅ **ملٹی ٹیننٹ سیکیورٹی**: مکمل ڈیٹا آئسولیشن کے لیے Row Level Security نافذ کیا  
✅ **Azure تصدیق**: Azure Entra ID کے ساتھ JWT کی تصدیق کو مربوط کیا  
✅ **رول بیسڈ اجازت**: درجہ بندی شدہ رول اور اجازت کا نظام تشکیل دیا  
✅ **جامع آڈٹ لاگنگ**: سیکیورٹی ایونٹ کی ٹریکنگ اور نگرانی قائم کی  
✅ **سیکیورٹی کی جانچ**: خودکار سیکیورٹی کی تصدیق کے ٹیسٹس نافذ کیے  
✅ **خطرات کی نگرانی**: حقیقی وقت میں سیکیورٹی ایونٹ کی شناخت اور الرٹنگ بنائی  

## 🚀 آگے کیا ہے

**[Lab 03: Environment Setup](../03-Setup/README.md)** کے ساتھ جاری رکھیں تاکہ:  

- سیکیورٹی کے بہترین طریقوں کے ساتھ ترقیاتی ماحول کو تشکیل دیں  
- تصدیق اور نگرانی کے لیے Azure خدمات کو ترتیب دیں  
- محفوظ ڈیٹا بیس کنکشنز اور رازوں کے انتظام کو نافذ کریں  
- ترقیاتی ماحول میں سیکیورٹی کی تشکیل کی تصدیق کریں  

## 📚 اضافی وسائل

### Azure سیکیورٹی  
- [Azure Entra ID Documentation](https://docs.microsoft.com/azure/active-directory/) - مکمل شناختی پلیٹ فارم گائیڈ  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - رازوں کے انتظام کی خدمت  
- [Azure Security Best Practices](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - سیکیورٹی رہنمائی  

### ڈیٹا بیس سیکیورٹی  
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - آفیشل RLS دستاویزات  
- [Database Security Checklist](https://www.postgresql.org/docs/current/security.html) - PostgreSQL سیکیورٹی گائیڈ  
- [Multi-Tenant Database Patterns](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - آرکیٹیکچر پیٹرنز  

### سیکیورٹی کی جانچ  
- [OWASP Testing Guide](https://owasp.org/www-project-web-security-testing-guide/) - جامع سیکیورٹی ٹیسٹنگ  
- [JWT Security Best Practices](https://tools.ietf.org/html/rfc8725) - JWT سیکیورٹی کے تحفظات  
- [API Security Testing](https://owasp.org/www-project-api-security/) - API مخصوص سیکیورٹی ٹیسٹنگ  

---

**پچھلا**: [Lab 01: Core Architecture Concepts](../01-Architecture/README.md)  
**اگلا**: [Lab 03: Environment Setup](../03-Setup/README.md)  
