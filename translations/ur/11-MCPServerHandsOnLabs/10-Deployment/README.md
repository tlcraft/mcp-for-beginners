...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T15:38:10+00:00",
...
یہ لیب آپ کو جدید کنٹینرائزیشن اور کلاؤڈ نیٹو طریقوں کے ذریعے اپنے MCP ریٹیل سرور کو پروڈکشن ماحول میں تعینات کرنے کے لیے جامع رہنمائی فراہم کرتی ہے۔ آپ سیکھیں گے کہ کیسے قابل توسیع، محفوظ، اور مانیٹر شدہ MCP سرورز تعینات کیے جائیں جو انٹرپرائز ورک لوڈز کو سنبھال سکیں۔

## جائزہ

MCP سرورز کی پروڈکشن تعیناتی کے لیے کنٹینرائزیشن، آرکیسٹریشن، سیکیورٹی، اسکیل ایبلٹی، اور مانیٹرنگ پر غور کرنا ضروری ہے۔ یہ لیب Azure Container Apps کے ساتھ PostgreSQL Flexible Server پر تعیناتی، CI/CD پائپ لائنز کا نفاذ، اور متغیر ورک لوڈز کے لیے آٹو اسکیلنگ کی تشکیل کا احاطہ کرتی ہے۔

تعیناتی کی حکمت عملیاں سادہ سنگل کنٹینر تعیناتیوں سے لے کر پیچیدہ ملٹی ریجن، آٹو اسکیلنگ پروڈکشن ماحول تک ہوتی ہیں، جن میں جامع مانیٹرنگ اور سیکیورٹی خصوصیات شامل ہیں۔

## سیکھنے کے مقاصد

اس لیب کے اختتام تک، آپ قابل ہوں گے:

- **کنٹینرائز** کریں MCP سرورز کو Docker کے ذریعے ملٹی اسٹیج بلڈز کے ساتھ  
- **تعینات** کریں Azure Container Apps پر محفوظ نیٹ ورکنگ کے ساتھ  
- **تشکیل دیں** پروڈکشن گریڈ PostgreSQL کو اعلی دستیابی کے ساتھ  
- **نافذ کریں** CI/CD پائپ لائنز کو خودکار تعیناتی کے لیے  
- **اسکیل کریں** ایپلیکیشنز کو طلب کے مطابق خودکار طور پر  
- **مانیٹر کریں** پروڈکشن تعیناتیوں کو جامع مشاہدے کے ساتھ  

## 🐳 Docker کنٹینرائزیشن

### ملٹی اسٹیج Dockerfile
...
## ☁️ Azure Container Apps تعیناتی

### بائسپ کے ساتھ انفراسٹرکچر کوڈ کے طور پر
...
## 🔐 پروڈکشن سیکیورٹی کی تشکیل

### سیکیورٹی کو مضبوط بنانا
...
✅ **کنٹینر حکمت عملی**: پروڈکشن کے لیے تیار Docker کنٹینرز سیکیورٹی مضبوطی کے ساتھ  
✅ **کلاؤڈ تعیناتی**: Azure Container Apps آٹو اسکیلنگ اور مانیٹرنگ کے ساتھ  
✅ **ڈیٹا بیس تعیناتی**: PostgreSQL Flexible Server اعلی دستیابی کے ساتھ  
✅ **CI/CD پائپ لائنز**: خودکار ٹیسٹنگ، بلڈنگ، اور تعیناتی ورک فلو  
✅ **کارکردگی کی مانیٹرنگ**: جامع میٹرکس جمع کرنا اور الرٹس  
✅ **سیکیورٹی کی تشکیل**: پروڈکشن گریڈ سیکیورٹی پالیسیاں اور نیٹ ورک آئسولیشن  

## 🚀 آگے کیا ہے؟

**[لیب 11: مانیٹرنگ اور مشاہدہ](../11-Monitoring/README.md)** کے ساتھ جاری رکھیں تاکہ:

- جامع مانیٹرنگ کو Application Insights کے ساتھ ترتیب دیں  
- ساختی لاگنگ اور تقسیم شدہ ٹریسنگ کو تشکیل دیں  
- الرٹس اور خودکار ردعمل کے نظام کو نافذ کریں  
- کاروباری میٹرکس اور کارکردگی کے KPIs کو مانیٹر کریں  

## 📚 اضافی وسائل

### کنٹینر ٹیکنالوجیز  
- [Docker بہترین طریقے](https://docs.docker.com/develop/dev-best-practices/) - Docker کے آفیشل بہترین طریقے  
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Azure Container Apps کی دستاویزات  
- [Kubernetes دستاویزات](https://kubernetes.io/docs/) - Kubernetes کی آفیشل دستاویزات  

### CI/CD اور DevOps  
- [GitHub Actions](https://docs.github.com/en/actions) - GitHub Actions کی دستاویزات  
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Azure DevOps سروسز  
- [انفراسٹرکچر کوڈ کے طور پر](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Azure Bicep کی دستاویزات  

### سیکیورٹی اور مانیٹرنگ  
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Azure سیکیورٹی کی سفارشات  
- [کنٹینر سیکیورٹی](https://kubernetes.io/docs/concepts/security/) - Kubernetes سیکیورٹی کے تصورات  
...
**پچھلا**: [لیب 09: VS Code انٹیگریشن](../09-VS-Code/README.md)  
**اگلا**: [لیب 11: مانیٹرنگ اور مشاہدہ](../11-Monitoring/README.md)  
