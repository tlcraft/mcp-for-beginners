...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T15:16:35+00:00",
...
یہ لیب پروڈکشن ماحول میں MCP سرورز کی ٹیسٹنگ اور ڈیبگنگ کے لیے مکمل رہنمائی فراہم کرتی ہے۔ آپ مضبوط ٹیسٹنگ حکمت عملیوں کو نافذ کرنا، پیچیدہ مسائل کو ڈیبگ کرنا، اور یہ یقینی بنانا سیکھیں گے کہ آپ کا MCP سرور مختلف حالات میں قابل اعتماد طریقے سے کام کرے۔

## جائزہ

MCP سرورز کی ٹیسٹنگ کے لیے ایک کثیر پرتوں والا طریقہ کار ضروری ہے، جس میں یونٹ ٹیسٹس، انٹیگریشن ٹیسٹس، پرفارمنس کی توثیق، اور حقیقی دنیا کے منظرناموں کی جانچ شامل ہے۔ یہ لیب ترقی سے لے کر پروڈکشن مانیٹرنگ تک مکمل ٹیسٹنگ لائف سائیکل کا احاطہ کرتی ہے۔

ہماری ٹیسٹنگ حکمت عملی قابل اعتماد، سیکیورٹی، اور کارکردگی پر زور دیتی ہے، تاکہ آپ کا MCP سرور پروڈکشن ورک لوڈز کو سنبھال سکے اور ڈیٹا کی سالمیت اور صارف کے تجربے کے معیار کو برقرار رکھ سکے۔

## سیکھنے کے مقاصد

اس لیب کے اختتام تک، آپ قابل ہوں گے:

- **نافذ کریں** جامع یونٹ اور انٹیگریشن ٹیسٹ سوٹس  
- **ڈیزائن کریں** MCP ٹولز اور ڈیٹا بیس آپریشنز کے لیے مؤثر ٹیسٹنگ حکمت عملیاں  
- **ڈیبگ کریں** پیچیدہ مسائل کو جدید ڈیبگنگ تکنیکوں کے ذریعے  
- **توثیق کریں** لوڈ کے تحت کارکردگی کو حقیقی منظرناموں کے ساتھ  
- **مانیٹر کریں** پروڈکشن سسٹمز کو مؤثر الرٹ اور مشاہدہ کاری کے ساتھ  
- **خودکار بنائیں** مسلسل انضمام کے لیے ٹیسٹنگ ورک فلو  

## 🧪 ٹیسٹنگ آرکیٹیکچر

### ٹیسٹنگ حکمت عملی کا جائزہ
...
اس لیب کو مکمل کرنے کے بعد، آپ کے پاس ہوں گے:

✅ **جامع ٹیسٹنگ فریم ورک**: تمام اجزاء کے لیے یونٹ، انٹیگریشن، اور کارکردگی کے ٹیسٹس  
✅ **جدید ڈیبگنگ ٹولز**: نفیس ڈیبگنگ یوٹیلیٹیز کے ساتھ عمل کی ٹریسنگ  
✅ **کارکردگی کی توثیق**: لوڈ ٹیسٹنگ اور اسکیل ایبلٹی تجزیہ کی صلاحیتیں  
✅ **سیکیورٹی ٹیسٹنگ**: SQL انجیکشن کی روک تھام اور RLS کی توثیق  
✅ **مانیٹرنگ انٹیگریشن**: کارکردگی کے میٹرکس اور رکاوٹوں کا تجزیہ  
✅ **CI/CD کے لیے تیار**: مسلسل انضمام کے لیے خودکار ٹیسٹنگ ورک فلو  

## 🚀 آگے کیا ہے؟

**[لیب 09: VS کوڈ انٹیگریشن](../09-VS-Code/README.md)** کے ساتھ جاری رکھیں تاکہ:

- MCP سرور کی ترقی کے لیے VS کوڈ کو ترتیب دیں  
- VS کوڈ میں ڈیبگنگ ماحول ترتیب دیں  
- MCP سرور کو VS کوڈ چیٹ کے ساتھ مربوط کریں  
- مکمل VS کوڈ ورک فلو کی جانچ کریں  

## 📚 اضافی وسائل

### ٹیسٹنگ فریم ورک
- [pytest دستاویزات](https://docs.pytest.org/) - پائتھون ٹیسٹنگ فریم ورک  
- [AsyncPG ٹیسٹنگ](https://magicstack.github.io/asyncpg/current/index.html) - Async PostgreSQL ٹیسٹنگ  
- [FastAPI ٹیسٹنگ](https://fastapi.tiangolo.com/tutorial/testing/) - API ٹیسٹنگ پیٹرنز  

### کارکردگی کی جانچ
- [لوڈ ٹیسٹنگ کے بہترین طریقے](https://docs.python.org/3/library/asyncio.html) - Async کارکردگی کی جانچ  
- [ڈیٹا بیس کارکردگی کی جانچ](https://www.postgresql.org/docs/current/performance-tips.html) - PostgreSQL کی اصلاح  
- [میموری پروفائلنگ](https://docs.python.org/3/library/tracemalloc.html) - پائتھون میموری تجزیہ  

### ڈیبگنگ ٹولز
- [پائتھون ڈیبگنگ](https://docs.python.org/3/library/pdb.html) - پائتھون ڈیبگر  
- [Async ڈیبگنگ](https://docs.python.org/3/library/asyncio-dev.html) - Asyncio ڈیبگنگ  
- [SQL ڈیبگنگ](https://www.postgresql.org/docs/current/runtime-config-logging.html) - PostgreSQL لاگنگ  

---

**پچھلا**: [لیب 07: سیمینٹک سرچ انٹیگریشن](../07-Semantic-Search/README.md)  
**اگلا**: [لیب 09: VS کوڈ انٹیگریشن](../09-VS-Code/README.md)  
