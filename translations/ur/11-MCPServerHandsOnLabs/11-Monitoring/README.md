...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T15:29:11+00:00",
...
یہ لیب آپ کے MCP سرور کے لیے پروڈکشن ماحول میں مانیٹرنگ، مشاہدہ، اور الرٹنگ کو نافذ کرنے کے لیے جامع رہنمائی فراہم کرتی ہے۔ آپ سیکھیں گے کہ ایپلیکیشن انسائٹس کو کیسے ترتیب دیا جائے، بامعنی ڈیش بورڈز کیسے بنائے جائیں، مؤثر الرٹنگ کو کیسے نافذ کیا جائے، اور آپریشنل بہترین کارکردگی کے لیے خرابیوں کو دور کرنے کے ورک فلو کیسے قائم کیے جائیں۔

## جائزہ

پروڈکشن میں قابل اعتماد MCP سرورز کو برقرار رکھنے کے لیے مؤثر مانیٹرنگ اور مشاہدہ بہت ضروری ہیں۔ یہ لیب مشاہدہ کے تین ستونوں—میٹرکس، لاگز، اور ٹریسز—کا احاطہ کرتی ہے اور آپ کو جامع مانیٹرنگ کو نافذ کرنے کا طریقہ دکھاتی ہے جو مسائل کی پیشگی شناخت اور تیز رفتار مسئلہ حل کرنے کو ممکن بناتی ہے۔

آپ سیکھیں گے کہ خام ٹیلیمیٹری ڈیٹا کو قابل عمل بصیرت میں کیسے تبدیل کیا جائے جو آپ کو سسٹم کے رویے کو سمجھنے، کارکردگی کو بہتر بنانے، اور اعلی دستیابی کو یقینی بنانے میں مدد فراہم کرے۔

## سیکھنے کے مقاصد

اس لیب کے اختتام تک، آپ قابل ہوں گے:

- **نافذ کریں** جامع ایپلیکیشن انسائٹس انٹیگریشن MCP سرورز کے لیے  
- **ڈیزائن کریں** مؤثر خرابیوں کو دور کرنے کے لیے ساختی لاگنگ پیٹرنز  
- **بنائیں** کارکردگی میٹرکس جمع کرنے اور تجزیہ کرنے کے نظام  
- **ترتیب دیں** ذہین الرٹنگ کے ساتھ قابل عمل نوٹیفیکیشنز  
- **بنائیں** آپریشنل ڈیش بورڈز حقیقی وقت کی مانیٹرنگ کے لیے  
- **قائم کریں** مؤثر خرابیوں کو دور کرنے کے ورک فلو اور رن بکس  

## 📊 ایپلیکیشن انسائٹس انٹیگریشن

### ایپلیکیشن انسائٹس ترتیب دینا
...
## 🔍 خرابیوں کو دور کرنے کے ورک فلو
...
✅ **ایپلیکیشن انسائٹس انٹیگریشن**: مکمل ٹیلیمیٹری اور مانیٹرنگ سیٹ اپ  
✅ **ساختی لاگنگ**: پروڈکشن کے لیے تیار لاگنگ، تعلق اور سیاق و سباق کے ساتھ  
✅ **کسٹم میٹرکس**: کاروباری اور تکنیکی میٹرکس جمع کرنا اور تجزیہ  
✅ **ذہین الرٹنگ**: پیشگی الرٹنگ، متعدد نوٹیفیکیشن چینلز کے ساتھ  
✅ **آپریشنل ڈیش بورڈز**: حقیقی وقت کی مانیٹرنگ اور کاروباری بصیرت  
✅ **خرابیوں کو دور کرنے کے ورک فلو**: خودکار تشخیص اور آپریشنل رن بکس  

## 🚀 آگے کیا ہے

**[لیب 12: بہترین طریقے اور اصلاح](../12-Best-Practices/README.md)** کے ساتھ جاری رکھیں:

- کارکردگی کو بہتر بنانے کی تکنیکیں نافذ کریں  
- جامع سیکیورٹی سختی کو نافذ کریں  
- پروڈکشن تعیناتی کے بہترین طریقے سیکھیں  
- لاگت کو بہتر بنانے کی حکمت عملی قائم کریں  

## 📚 اضافی وسائل

### Azure Monitor
- [ایپلیکیشن انسائٹس دستاویزات](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - مکمل مانیٹرنگ گائیڈ  
- [KQL کوئری حوالہ](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - ایپلیکیشن انسائٹس کے لیے کوئری زبان  
- [Azure Monitor ورک بکس](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - کسٹم ڈیش بورڈ تخلیق  

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - انسٹرومنٹیشن گائیڈ  
- [ڈسٹریبیوٹڈ ٹریسنگ](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - ٹریسنگ کے تصورات  
- [میٹرکس جمع کرنا](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - میٹرکس کے بہترین طریقے  

### آپریشنل بہترین کارکردگی
- [SRE ہینڈ بک](https://sre.google/sre-book/table-of-contents/) - سائٹ ریلائیبلٹی انجینئرنگ کے اصول  
- [مانیٹرنگ کے بہترین طریقے](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - انڈسٹری کے بہترین طریقے  
- [واقعہ کا جواب](https://response.pagerduty.com/) - واقعہ کے انتظام کی گائیڈ  

---

**پچھلا**: [لیب 10: تعیناتی کی حکمت عملی](../10-Deployment/README.md)  
**اگلا**: [لیب 12: بہترین طریقے اور اصلاح](../12-Best-Practices/README.md)  
