...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T05:20:25+00:00",
...
| تاریخ | تبدیلیاں |  
|-------|----------|  
| 16 جولائی، 2025 | - موجودہ مواد کی عکاسی کے لیے ریپوزیٹری کی ساخت کو اپ ڈیٹ کیا گیا<br>- MCP کلائنٹس اور ٹولز سیکشن شامل کیا گیا<br>- مقبول MCP سرورز سیکشن شامل کیا گیا<br>- تمام موجودہ موضوعات کے ساتھ بصری نصاب کا نقشہ اپ ڈیٹ کیا گیا<br>- تمام خصوصی شعبوں کے ساتھ جدید موضوعات سیکشن کو بہتر بنایا گیا<br>- حقیقی مثالوں کی عکاسی کے لیے کیس اسٹڈیز کو اپ ڈیٹ کیا گیا<br>- MCP کی ابتدا کو Anthropic کی تخلیق کے طور پر واضح کیا گیا |  
