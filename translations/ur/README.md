...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T13:53:57+00:00",
...
### ➡️ آن ڈیمانڈ دیکھیں - MCP ڈیو ڈیز

دو دن کی گہری تکنیکی بصیرت، کمیونٹی کنکشن، اور عملی سیکھنے کے لیے تیار ہو جائیں MCP ڈیو ڈیز میں، ایک ورچوئل ایونٹ جو ماڈل کانٹیکسٹ پروٹوکول (MCP) کے لیے وقف ہے — ابھرتا ہوا معیار جو AI ماڈلز اور ان کے استعمال کردہ ٹولز کے درمیان پل کا کام کرتا ہے۔  
آپ ہمارے ایونٹ پیج پر رجسٹر کر کے MCP ڈیو ڈیز دیکھ سکتے ہیں: https://aka.ms/mcpdevdays۔

#### دن 1: MCP پیداواریت، ڈیو ٹولز، اور کمیونٹی:

یہ دن ڈویلپرز کو MCP کو اپنے ڈویلپر ورک فلو میں استعمال کرنے کے قابل بنانے اور حیرت انگیز MCP کمیونٹی کا جشن منانے کے بارے میں ہے۔ ہم کمیونٹی ممبران اور Arcade، Block، Okta، اور Neon جیسے پارٹنرز کے ساتھ شامل ہوں گے تاکہ یہ دیکھ سکیں کہ وہ Microsoft کے ساتھ مل کر ایک اوپن، قابل توسیع MCP ایکو سسٹم کو کیسے تشکیل دے رہے ہیں۔  
حقیقی دنیا کے ڈیمو VS Code، Visual Studio، GitHub Copilot، اور مشہور کمیونٹی ٹولز کے ساتھ  
عملی، سیاق و سباق پر مبنی ڈویلپر ورک فلو  
کمیونٹی کی قیادت میں سیشنز اور بصیرت  
چاہے آپ MCP کے ساتھ ابھی شروعات کر رہے ہوں یا پہلے ہی اس پر کام کر رہے ہوں، دن 1 آپ کو تحریک اور قابل عمل نتائج کے ساتھ تیار کرے گا۔

#### دن 2: اعتماد کے ساتھ MCP سرورز بنائیں

یہ دن MCP بنانے والوں کے لیے ہے۔ ہم MCP سرورز بنانے اور انہیں AI ورک فلو میں ضم کرنے کے لیے نفاذ کی حکمت عملیوں اور بہترین طریقوں پر گہرائی سے جائیں گے۔
...
اگر آپ ڈویلپر، ٹول بلڈر، یا AI پروڈکٹ اسٹریٹجسٹ ہیں، تو یہ دن آپ کو قابل پیمائش، محفوظ، اور مستقبل کے لیے تیار MCP حل بنانے کے لیے ضروری بصیرت فراہم کرے گا۔
...
| 01 | بنیادی تصورات کی وضاحت | MCP کے بنیادی تصورات کی گہرائی سے وضاحت | [مزید پڑھیں](./01-CoreConcepts/README.md) |
...
| 3.3 | LLM کے ساتھ کلائنٹ | بڑے زبان کے ماڈلز کو ضم کریں | [گائیڈ](./03-GettingStarted/03-llm-client/README.md) |
| 3.4 | VS Code انضمام | MCP سرورز کو VS Code میں استعمال کریں | [گائیڈ](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | SSE سرور | Server-Sent Events کا استعمال کرتے ہوئے سرورز بنائیں | [گائیڈ](./03-GettingStarted/05-sse-server/README.md) |
...
| 06 | کمیونٹی کی شراکتیں | MCP ایکو سسٹم میں شراکت کا طریقہ | [Guide](./06-CommunityContributions/README.md) |
| 07 | ابتدائی اپنانے کے تجربات | حقیقی دنیا کی عمل درآمد کی کہانیاں | [Guide](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | MCP کے لیے بہترین طریقے | کارکردگی، فالٹ ٹالرنس، لچک | [Guide](./08-BestPractices/README.md) |
| 09 | MCP کیس اسٹڈیز | عملی عمل درآمد کی مثالیں | [Guide](./09-CaseStudy/README.md) |
| 10 | عملی ورکشاپ | AI ٹول کٹ کے ساتھ MCP سرور بنانا | [Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
| جاوا | MCP کیلکولیٹر | [View Code](./03-GettingStarted/samples/java/calculator/README.md) |
| جاوا اسکرپٹ | MCP ڈیمو | [View Code](./03-GettingStarted/samples/javascript/README.md) |
| پائتھون | MCP سرور | [View Code](../../03-GettingStarted/samples/python/mcp_calculator_server.py) |
| ٹائپ اسکرپٹ | MCP مثال | [View Code](./03-GettingStarted/samples/typescript/README.md) |
| رسٹ | MCP مثال | [View Code](./03-GettingStarted/samples/rust/README.md) |
...
ہم ایک تفصیلی [تبدیلیوں کا ریکارڈ](./changelog.md) برقرار رکھتے ہیں جو نصاب کے مواد میں تمام اہم اپ ڈیٹس کو ٹریک کرتا ہے، بشمول:
...
مائیکروسافٹ ویلیوڈ پروفیشنل [شیوم گوئل](https://www.linkedin.com/in/shivam2003/) کا اہم کوڈ نمونوں میں تعاون کرنے کے لیے شکریہ۔
...
Contributor License Agreement (CLA) پر اتفاق کرنا ہوگا، جس میں یہ اعلان کیا جائے گا کہ آپ کے پاس تعاون کے حقوق ہیں اور آپ ہمیں ان کے استعمال کا حق دیتے ہیں۔ تفصیلات کے لیے دیکھیں  
<https://cla.opensource.microsoft.com>۔

جب آپ ایک پل ریکویسٹ جمع کراتے ہیں، تو CLA بوٹ خود بخود یہ طے کرے گا کہ آیا آپ کو CLA فراہم کرنے کی ضرورت ہے اور PR کو مناسب طریقے سے سجائے گا (مثلاً، اسٹیٹس چیک، تبصرہ)۔ بس بوٹ کی فراہم کردہ ہدایات پر عمل کریں۔ آپ کو یہ صرف ایک بار ان تمام ریپوز کے لیے کرنا ہوگا جو ہمارے CLA کا استعمال کرتے ہیں۔
...
ریپوزٹری درج ذیل کے طور پر منظم ہے:

- **کور نصاب (00-10)**: دس ترتیب وار ماڈیولز میں منظم مرکزی مواد
...
یہ پروجیکٹ ان منصوبوں، مصنوعات، یا خدمات کے ٹریڈ مارکس یا لوگوز پر مشتمل ہو سکتا ہے۔ مائیکروسافٹ کے ٹریڈ مارکس یا لوگوز کے مجاز استعمال کو [Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) کی پیروی کرنی چاہیے۔  
پروجیکٹ کے ترمیم شدہ ورژنز میں مائیکروسافٹ کے ٹریڈ مارکس یا لوگوز کا استعمال الجھن پیدا نہیں کرنا چاہیے یا مائیکروسافٹ کی سرپرستی کا اشارہ نہیں دینا چاہیے۔  
