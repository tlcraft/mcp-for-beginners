...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T05:19:33+00:00",
...
- 📜 [MCP Specification](https://modelcontextprotocol.io/docs/) – پروٹوکول کی ساخت اور تکنیکی حوالہ جات  
- 📜 [Original MCP Specification](https://spec.modelcontextprotocol.io/) – پرانا تکنیکی حوالہ جات (مزید تفصیلات شامل ہو سکتی ہیں)  
- 🧑‍💻 [MCP GitHub Repository](https://github.com/modelcontextprotocol) – اوپن سورس SDKs، ٹولز، اور کوڈ نمونے
- 🌐 [MCP Community](https://github.com/orgs/modelcontextprotocol/discussions) – مباحثوں میں شامل ہوں اور کمیونٹی میں حصہ لیں
...
| 3.3 | LLM کے ساتھ کلائنٹ | بڑے زبان کے ماڈلز کو شامل کریں | [رہنمائی](./03-GettingStarted/03-llm-client/README.md) |
| 3.4 | VS Code انٹیگریشن | VS Code میں MCP سرورز استعمال کریں | [رہنمائی](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | SSE سرور | Server-Sent Events کے ذریعے سرورز بنائیں | [رہنمائی](./03-GettingStarted/05-sse-server/README.md) |
| 3.6 | HTTP سٹریمنگ | MCP میں HTTP سٹریمنگ نافذ کریں | [رہنمائی](./03-GettingStarted/06-http-streaming/README.md) |
| 3.7 | AI Toolkit | MCP کے ساتھ AI Toolkit استعمال کریں | [رہنمائی](./03-GettingStarted/07-aitk/README.md) |
| 3.8 | ٹیسٹنگ | اپنے MCP سرور کے نفاذ کی جانچ کریں | [رہنمائی](./03-GettingStarted/08-testing/README.md) |
...
| 05 | MCP میں اعلیٰ درجے کے موضوعات | ملٹی موڈل AI، اسکیلنگ، انٹرپرائز استعمال | [مزید پڑھیں](./05-AdvancedTopics/README.md) |
| 5.1 | Azure انٹیگریشن | MCP کا Azure کے ساتھ انضمام | [رہنمائی](./05-AdvancedTopics/mcp-integration/README.md) |
| 5.2 | ملٹی موڈیلٹی | متعدد موڈالٹیز کے ساتھ کام کرنا | [رہنمائی](./05-AdvancedTopics/mcp-multi-modality/README.md) |
| 5.3 | OAuth2 ڈیمو | OAuth2 تصدیق کا نفاذ | [رہنمائی](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
...
| 5.6 | سیمپلنگ | MCP میں سیمپلنگ کی تکنیکیں | [رہنمائی](./05-AdvancedTopics/mcp-sampling/README.md) |
| 5.7 | اسکیلنگ | MCP نفاذ کو اسکیل کریں | [رہنمائی](./05-AdvancedTopics/mcp-scaling/README.md) |
| 5.8 | سیکیورٹی | اعلیٰ درجے کی سیکیورٹی کے پہلو | [رہنمائی](./05-AdvancedTopics/mcp-security/README.md) |
| 5.9 | ویب سرچ | ویب سرچ کی صلاحیتیں نافذ کریں | [رہنمائی](./05-AdvancedTopics/web-search-mcp/README.md) |
| 5.10 | ریئل ٹائم سٹریمنگ | ریئل ٹائم سٹریمنگ کی فعالیت بنائیں | [رہنمائی](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
| 5.11 | ریئل ٹائم سرچ | ریئل ٹائم سرچ نافذ کریں | [رہنمائی](./05-AdvancedTopics/mcp-realtimesearch/README.md) |
| 5.12 | Entra ID Auth | Microsoft Entra ID کے ساتھ توثیق | [Guide](./05-AdvancedTopics/mcp-security-entra/README.md) |
| 5.13 | Foundry Integration | Azure AI Foundry کے ساتھ انضمام | [Guide](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
| 5.14 | Context Engineering | مؤثر کانٹیکسٹ انجینئرنگ کی تکنیکیں | [Guide](./05-AdvancedTopics/mcp-contextengineering/README.md) |
| **Module 6-10: Community & Best Practices** | | | |
| 06 | کمیونٹی میں شراکتیں | MCP ماحولیاتی نظام میں حصہ ڈالنے کا طریقہ | [Guide](./06-CommunityContributions/README.md) |
| 07 | ابتدائی اپنانے سے بصیرتیں | حقیقی دنیا کی نفاذ کی کہانیاں | [Guide](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | MCP کے لیے بہترین طریقے | کارکردگی، فالٹ ٹولیرنس، لچک | [Guide](./08-BestPractices/README.md) |
| 09 | MCP کیس اسٹڈیز | عملی نفاذ کی مثالیں | [Guide](./09-CaseStudy/README.md) |
| 10 | ہینڈز آن ورکشاپ | AI Toolkit کے ساتھ MCP سرور کی تعمیر | [Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
| TypeScript | MCP کی مثال | [View Code](./03-GettingStarted/samples/typescript/README.md) |

#### اعلیٰ درجے کی MCP نفاذات

| Language | Description | Link |
|----------|-------------|------|
| C# | اعلیٰ درجے کا نمونہ | [View Code](./04-PracticalImplementation/samples/csharp/README.md) |
| Java | کنٹینر ایپ کی مثال | [View Code](./04-PracticalImplementation/samples/java/containerapp/README.md) |
| JavaScript | اعلیٰ درجے کا نمونہ | [View Code](./04-PracticalImplementation/samples/javascript/README.md) |
| Python | پیچیدہ نفاذ | [View Code](../../04-PracticalImplementation/samples/python/mcp_sample.py) |
| TypeScript | کنٹینر نمونہ | [View Code](./04-PracticalImplementation/samples/typescript/README.md) |
...
ایک جامع [مطالعہ گائیڈ](./study_guide.md) دستیاب ہے جو آپ کو اس ریپوزیٹری میں مؤثر طریقے سے رہنمائی فراہم کرتی ہے۔ اس گائیڈ میں شامل ہیں:
...
ہم ایک تفصیلی [چینج لاگ](./changelog.md) برقرار رکھتے ہیں جو نصاب کے مواد میں تمام اہم اپ ڈیٹس کو ٹریک کرتا ہے، بشمول:
...
Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) کا اہم کوڈ نمونوں میں تعاون کرنے کے لیے شکریہ۔
...
Contributor License Agreement (CLA) پر رضامندی دینی ہوتی ہے جس میں آپ یہ اعلان کرتے ہیں کہ آپ کے پاس
اپنا تعاون فراہم کرنے کے حقوق ہیں اور آپ واقعی ہمیں ان حقوق کی اجازت دیتے ہیں۔ تفصیلات کے لیے ملاحظہ کریں
<https://cla.opensource.microsoft.com>۔

جب آپ پل ریکویسٹ جمع کرواتے ہیں، تو CLA بوٹ خود بخود فیصلہ کرے گا کہ آیا آپ کو CLA فراہم کرنے کی ضرورت ہے
...
یہ پروجیکٹ ممکنہ طور پر پروجیکٹس، مصنوعات، یا خدمات کے ٹریڈ مارکس یا لوگوز پر مشتمل ہو سکتا ہے۔ Microsoft کے
