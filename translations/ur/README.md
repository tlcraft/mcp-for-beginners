...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:20:46+00:00",
...
| 5.7 | اسکیلنگ | MCP کے نفاذ کو اسکیل کریں | [گائیڈ](./05-AdvancedTopics/mcp-scaling/README.md) |
...
| جاوا اور اسپرنگ | کنٹینر ایپ مثال | [کوڈ دیکھیں](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
## 🎯 MCP سیکھنے کے لیے ضروری شرائط

اس نصاب سے زیادہ سے زیادہ فائدہ اٹھانے کے لیے آپ کو درج ذیل چیزوں کا علم ہونا چاہیے:

- کم از کم ایک زبان میں پروگرامنگ کی بنیادی معلومات: C#, جاوا، جاوا اسکرپٹ، پائتھون، یا ٹائپ اسکرپٹ
...
- بصری نصاب کا نقشہ جو تمام موضوعات کو ظاہر کرتا ہے
...
یہ دن ڈیولپرز کو MCP کو اپنے ڈیولپمنٹ ورک فلو میں استعمال کرنے کے قابل بنانے اور حیرت انگیز MCP کمیونٹی کا جشن منانے کے بارے میں ہے۔ ہم کمیونٹی ممبران اور پارٹنرز جیسے Arcade، Block، Okta، اور Neon کے ساتھ شامل ہوں گے تاکہ دیکھ سکیں کہ وہ Microsoft کے ساتھ مل کر ایک کھلا، قابل توسیع MCP ایکو سسٹم کیسے تشکیل دے رہے ہیں۔  
حقیقی دنیا کے ڈیمو VS کوڈ، ویژول اسٹوڈیو، GitHub Copilot، اور مقبول کمیونٹی ٹولز کے ساتھ  
عملی، سیاق و سباق پر مبنی ڈیولپمنٹ ورک فلو  
کمیونٹی کی قیادت میں سیشنز اور بصیرت  
چاہے آپ MCP کے ساتھ ابھی شروعات کر رہے ہوں یا پہلے ہی اس پر کام کر رہے ہوں، دن 1 آپ کو تحریک اور قابل عمل تجاویز کے ساتھ تیار کرے گا۔

#### [دن 2: اعتماد کے ساتھ MCP سرورز بنائیں](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

یہ دن MCP بنانے والوں کے لیے ہے۔ ہم MCP سرورز بنانے اور انہیں AI ورک فلو میں ضم کرنے کے لیے عمل درآمد کی حکمت عملیوں اور بہترین طریقوں پر گہرائی سے جائیں گے۔
...
ویڈیو سیشنز میں شدت سے سیکھیں کہ MCP سرورز کیسے بنائیں، VS کوڈ کے ساتھ ضم کریں، اور Azure پر پیشہ ورانہ طور پر تعینات کریں، MCP فار بیگنرز نصاب کے مواد کی بنیاد پر۔ ایک ایسی ٹیکنالوجی میں عملی مہارت حاصل کریں جسے بڑی کمپنیاں پہلے ہی استعمال کر رہی ہیں۔
...
### آئیے MCP سیکھیں C# کے ساتھ - ٹیوٹوریل سیریز
آئیے ماڈل کانٹیکسٹ پروٹوکول (MCP) کے بارے میں سیکھیں، ایک جدید فریم ورک جو AI ماڈلز اور کلائنٹ ایپلیکیشنز کے درمیان تعامل کو معیاری بنانے کے لیے ڈیزائن کیا گیا ہے۔ اس ابتدائی دوستانہ سیشن کے ذریعے، ہم آپ کو MCP سے متعارف کرائیں گے اور آپ کو اپنا پہلا MCP سرور بنانے کے لیے رہنمائی کریں گے۔
...
Microsoft Valued Professional [شِوَم گوئل](https://www.linkedin.com/in/shivam2003/) کا شکریہ جنہوں نے اہم کوڈ نمونے فراہم کیے۔ 
...
- [**نیا** Edge AI فار بیگنرز](https://github.com/microsoft/edgeai-for-beginners?WT.mc_id=academic-105485-koreyst)
- [AI ایجنٹس فار بیگنرز](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)
- [Generative AI فار بیگنرز .NET کے ساتھ](https://github.com/microsoft/Generative-AI-for-beginners-dotnet?WT.mc_id=academic-105485-koreyst)
- [Generative AI فار بیگنرز جاوا اسکرپٹ کے ساتھ](https://github.com/microsoft/generative-ai-with-javascript?WT.mc_id=academic-105485-koreyst)
- [Generative AI فار بیگنرز](https://github.com/microsoft/generative-ai-for-beginners?WT.mc_id=academic-105485-koreyst)
- [Generative AI فار بیگنرز جاوا کے ساتھ](https://github.com/microsoft/generative-ai-for-beginners-java?WT.mc_id=academic-105485-koreyst)
...
یہ پروجیکٹ ممکنہ طور پر پروجیکٹس، مصنوعات، یا خدمات کے لیے ٹریڈ مارکس یا لوگوز پر مشتمل ہو سکتا ہے۔ Microsoft کے  
ٹریڈ مارکس یا لوگوز کے مجاز استعمال کو [Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) کی پیروی کرنی چاہیے۔  
