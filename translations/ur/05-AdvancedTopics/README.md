...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-02T11:59:25+00:00",
...
یہ سبق Model Context Protocol کی نفاذ میں اعلیٰ تصورات کا جائزہ لیتا ہے، جس میں ملٹی موڈل انٹیگریشن، توسیع پذیری، سیکیورٹی کی بہترین مشقیں، اور انٹرپرائز انٹیگریشن پر توجہ دی گئی ہے۔ یہ موضوعات پروڈکشن گریڈ MCP ایپلیکیشنز بنانے کے لیے ضروری ہیں جو انٹرپرائز ماحول میں پیچیدہ ضروریات کو سنبھال سکیں۔

## سیکھنے کے مقاصد

اس سبق کے اختتام تک، آپ قابل ہوں گے:
- MCP فریم ورکس میں ملٹی موڈل صلاحیتوں کو نافذ کریں
- اعلیٰ طلب والے منظرناموں کے لیے MCP کے اسکیل ایبل آرکیٹیکچرز ڈیزائن کریں
...
| لنک | عنوان | تفصیل |
|------|-------|-------------|
| [mcp-oauth2-demo](../../../05-AdvancedTopics/mcp-oauth2-demo) | MCP OAuth2 Demo | ایک مختصر Spring Boot ایپ جو MCP کے ساتھ OAuth2 کو بطور Authorization اور Resource Server دکھاتی ہے۔ محفوظ ٹوکن اجرا، محفوظ اینڈ پوائنٹس، Azure Container Apps کی تعیناتی، اور API Management انٹیگریشن کو ظاہر کرتی ہے۔ |
| [web-search-mcp](../../../05-AdvancedTopics/web-search-mcp) | Web Search MCP | Python MCP سرور اور کلائنٹ جو SerpAPI کے ساتھ حقیقی وقت کی ویب، خبریں، مصنوعات کی تلاش، اور سوال و جواب کو مربوط کرتا ہے۔ ملٹی ٹول آرکسٹریشن، بیرونی API انٹیگریشن، اور مضبوط ایرر ہینڈلنگ کو ظاہر کرتا ہے۔ |

## اضافی حوالہ جات

جدید MCP موضوعات کی تازہ ترین معلومات کے لیے رجوع کریں:
...
MCP صرف متن پر مبنی تعاملات کی حمایت نہیں کرتا بلکہ ملٹی موڈل صلاحیتیں بھی فراہم کرتا ہے، جو ماڈلز کو تصاویر، آڈیو، اور دیگر ڈیٹا کی اقسام کے ساتھ کام کرنے کی اجازت دیتی ہیں۔

### ملٹی موڈل سپورٹ کے لیے آرکیٹیکچر

ملٹی موڈل MCP نفاذ عام طور پر شامل ہوتے ہیں:

1. **موڈل مخصوص پارسرز**: وہ اجزاء جو مختلف میڈیا اقسام کو ایسے فارمیٹس میں تبدیل کرتے ہیں جو ماڈل پروسیس کر سکے
2. **موڈل مخصوص ٹولز**: خاص ٹولز جو مخصوص موڈالٹیز (تصویر کا تجزیہ، آڈیو پروسیسنگ) کو ہینڈل کرنے کے لیے بنائے گئے ہیں
3. **متحدہ کانٹیکسٹ مینجمنٹ**: مختلف موڈالٹیز کے درمیان کانٹیکسٹ کو برقرار رکھنے کا نظام
4. **جواب کی تخلیق**: ایسی صلاحیت جو کئی موڈالٹیز پر مشتمل جوابات تیار کر سکے

### C# ملٹی موڈل مثال: تصویر کا تجزیہ
...
### Java ملٹی موڈل مثال: آڈیو پروسیسنگ
...
### Python ملٹی موڈل مثال: ملٹی موڈل جواب کی تخلیق
...
روٹ کانٹیکسٹس Model Context Protocol کا ایک بنیادی تصور ہیں جو متعدد درخواستوں اور سیشنز کے دوران بات چیت کی تاریخ اور مشترکہ حالت کو برقرار رکھنے کے لیے ایک مستقل سطح فراہم کرتے ہیں۔

### روٹ کانٹیکسٹس کو سمجھنا

روٹ کانٹیکسٹس کنٹینرز کے طور پر کام کرتے ہیں جو متعلقہ تعاملات کی تاریخ اور حالت کو رکھتے ہیں۔ یہ قابل بناتے ہیں:

- **بات چیت کی مستقل مزاجی**: مربوط ملٹی ٹرن بات چیت کو برقرار رکھنا
- **میموری مینجمنٹ**: تعاملات کے دوران معلومات کو ذخیرہ اور بازیافت کرنا
- **حالت کا انتظام**: پیچیدہ ورک فلو میں پیش رفت کو ٹریک کرنا
- **کانٹیکسٹ شیئرنگ**: متعدد کلائنٹس کو ایک ہی بات چیت کی حالت تک رسائی کی اجازت دینا

MCP میں، روٹ کانٹیکسٹس کی یہ اہم خصوصیات ہیں:

- ہر روٹ کانٹیکسٹ کا منفرد شناخت کنندہ ہوتا ہے
- یہ بات چیت کی تاریخ، صارف کی ترجیحات، اور دیگر میٹا ڈیٹا رکھ سکتے ہیں
- ضرورت کے مطابق انہیں بنایا، رسائی حاصل کی، اور آرکائیو کیا جا سکتا ہے
- یہ باریک بینی سے رسائی کنٹرول اور اجازتیں سپورٹ کرتے ہیں

### روٹ کانٹیکسٹ کا لائف سائیکل
...
### Java مثال: روٹ کانٹیکسٹ کا نفاذ
...
### JavaScript مثال: روٹ کانٹیکسٹ مینجمنٹ
...
### Python مثال: ملٹی ٹرن معاونت کے لیے روٹ کانٹیکسٹ
...
### روٹ کانٹیکسٹ کی بہترین مشقیں

1. **مخصوص کانٹیکسٹس بنائیں**: مختلف بات چیت کے مقاصد یا ڈومینز کے لیے علیحدہ روٹ کانٹیکسٹس بنائیں تاکہ وضاحت برقرار رہے۔

2. **میعاد ختم ہونے کی پالیسیاں مقرر کریں**: پرانے کانٹیکسٹس کو آرکائیو یا حذف کرنے کی پالیسیاں نافذ کریں تاکہ اسٹوریج کا انتظام ہو اور ڈیٹا رکھنے کی پالیسیوں کی پابندی ہو۔

3. **متعلقہ میٹا ڈیٹا محفوظ کریں**: کانٹیکسٹ میٹا ڈیٹا کا استعمال کریں تاکہ بات چیت کے بارے میں اہم معلومات محفوظ کی جا سکیں جو بعد میں مفید ہو سکتی ہیں۔

4. **کانٹیکسٹ IDs کو مستقل طور پر استعمال کریں**: ایک بار کانٹیکسٹ بننے کے بعد، اس کا ID تمام متعلقہ درخواستوں میں مستقل طور پر استعمال کریں تاکہ تسلسل برقرار رہے۔

5. **خلاصے تیار کریں**: جب کانٹیکسٹ بڑا ہو جائے، تو اہم معلومات کو قید کرنے کے لیے خلاصے تیار کرنے پر غور کریں تاکہ کانٹیکسٹ کا سائز کنٹرول میں رہے۔

6. **رسائی کنٹرول نافذ کریں**: ملٹی یوزر سسٹمز کے لیے مناسب رسائی کنٹرول نافذ کریں تاکہ بات چیت کے کانٹیکسٹس کی رازداری اور سیکیورٹی یقینی بنائی جا سکے۔

7. **کانٹیکسٹ کی حدود کو سنبھالیں**: کانٹیکسٹ کے سائز کی حدود سے آگاہ رہیں اور بہت طویل بات چیت کے لیے حکمت عملی اپنائیں۔

8. **مکمل ہونے پر آرکائیو کریں**: بات چیت مکمل ہونے پر کانٹیکسٹس کو آرکائیو کریں تاکہ وسائل آزاد ہوں اور بات چیت کی تاریخ محفوظ رہے۔

## Model Context Protocol میں سیمپلنگ

سیمپلنگ کی حکمت عملیاں MCP نفاذ میں ماڈل کے جوابات کو بہتر بنانے کے لیے اہم ہیں۔ درست سیمپلنگ کنفیگریشن جواب کے معیار اور کارکردگی کو نمایاں طور پر بہتر بنا سکتی ہے۔ MCP ایک معیاری طریقہ فراہم کرتا ہے کہ ماڈلز کس طرح مخصوص پیرامیٹرز کے ساتھ متن پیدا کریں جو randomness، creativity، اور coherence کو متاثر کرتے ہیں۔

### سیمپلنگ پیرامیٹرز کا جائزہ

MCP درج ذیل سیمپلنگ پیرامیٹرز کی وضاحت کرتا ہے جنہیں کلائنٹ کی درخواستوں میں ترتیب دیا جا سکتا ہے:
...
| `stop_sequences` | کسٹم سیکوینسز جو جنریشن کو روک دیتے ہیں جب ملتے ہیں | سٹرنگز کی ارے |

### Temperature اور Top-K/Top-P سیمپلنگ

سیمپلنگ پیرامیٹرز زبان کے ماڈلز کے رویے کو باریک بینی سے ایڈجسٹ کرنے کی اجازت دیتے ہیں تاکہ متوقع توازن حاصل کیا جا سکے جو deterministic اور تخلیقی آؤٹ پٹس کے درمیان ہو۔
...
### Deterministic سیمپلنگ

ایسی ایپلیکیشنز کے لیے جو مستقل آؤٹ پٹس کی ضرورت رکھتی ہیں، deterministic سیمپلنگ قابلِ تکرار نتائج کو یقینی بناتی ہے۔
...
### Dynamic سیمپلنگ کنفیگریشن

ذہین سیمپلنگ پیرامیٹرز کو ہر درخواست کے کانٹیکسٹ اور ضروریات کے مطابق ڈھالتا ہے۔
...
## Model Context Protocol میں روٹنگ

روٹنگ MCP ایکو سسٹم میں درخواستوں کو مناسب ماڈلز، ٹولز، یا سروسز کی طرف بھیجنے کے لیے ضروری ہے۔

### مواد کی بنیاد پر روٹنگ

مواد کی بنیاد پر روٹنگ درخواستوں کو درخواست کے مواد کی بنیاد پر مخصوص سروسز کی طرف بھیجتی ہے۔
...
لوڈ بیلنسنگ وسائل کے استعمال کو بہتر بناتی ہے اور MCP سروسز کے لیے اعلی دستیابی کو یقینی بناتی ہے۔
...
ٹول روٹنگ اس بات کو یقینی بناتی ہے کہ ٹول کالز سیاق و سباق کی بنیاد پر سب سے مناسب سروس کی طرف بھیجی جائیں۔
...
### MCP میں سیمپلنگ اور روٹنگ آرکیٹیکچر

نیچے دیا گیا خاکہ دکھاتا ہے کہ سیمپلنگ اور روٹنگ کس طرح مل کر ایک جامع MCP آرکیٹیکچر میں کام کرتے ہیں:
...
## MCP کی توسیع پذیری اور اعلیٰ کارکردگی

انٹرپرائز تعیناتیوں کے لیے، MCP نفاذ کو اکثر کم سے کم تاخیر کے ساتھ اعلیٰ حجم کی درخواستوں کو سنبھالنا ہوتا ہے۔
...
سیکیورٹی MCP نفاذ کے لیے خاص طور پر انٹرپرائز ماحول میں انتہائی اہم ہے۔
...
MCP کو Azure OpenAI اور Microsoft AI Foundry جیسے انٹرپرائز سسٹمز کے ساتھ مربوط کرنا۔
...
### Python انٹرپرائز انٹیگریشن مثال
...
- Azure OpenAI اور Microsoft AI Foundry جیسے پلیٹ فارمز کے ساتھ انٹرپرائز انٹیگریشن MCP صلاحیتوں کو بڑھاتی ہے
...
3. مختلف بوجھ کو سنبھالنے کے قابل توسیع آرکیٹیکچر ڈیزائن کریں
4. انٹرپرائز AI سسٹمز کے ساتھ انٹیگریشن پوائنٹس کی منصوبہ بندی کریں
5. ممکنہ کارکردگی کے مسائل اور ان کے حل کی حکمت عملیاں دستاویز کریں
...
**اعلانِ ذمہ داری**:  
یہ دستاویز AI ترجمہ سروس [Co-op Translator](https://github.com/Azure/co-op-translator) کے ذریعے ترجمہ کی گئی ہے۔ اگرچہ ہم درستگی کے لیے کوشاں ہیں، براہ کرم آگاہ رہیں کہ خودکار ترجموں میں غلطیاں یا بے قاعدگیاں ہو سکتی ہیں۔ اصل دستاویز اپنی مادری زبان میں معتبر ماخذ سمجھی جانی چاہیے۔ اہم معلومات کے لیے پیشہ ور انسانی ترجمہ تجویز کیا جاتا ہے۔ اس ترجمے کے استعمال سے پیدا ہونے والی کسی بھی غلط فہمی یا غلط تشریح کی ذمہ داری ہم پر عائد نہیں ہوتی۔