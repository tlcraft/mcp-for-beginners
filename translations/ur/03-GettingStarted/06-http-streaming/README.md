...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-10T15:57:19+00:00",
...
یہ سیکشن MCP میں دستیاب مختلف ٹرانسپورٹ میکانزمز اور ان کے کلائنٹس اور سرورز کے درمیان حقیقی وقت کی مواصلات کے لیے اسٹریمنگ کی صلاحیتوں کو فعال کرنے میں ان کے کردار کو دریافت کرتا ہے۔
...
نیچے دیے گئے موازنہ جدول کو دیکھیں تاکہ ان ٹرانسپورٹ میکانزمز کے درمیان فرق کو سمجھ سکیں:
...
نوٹ کریں کہ stdio اور SSE ٹرانسپورٹس جو آپ کو پچھلے ابواب میں دکھائے گئے تھے اور اس باب میں Streamable HTTP ٹرانسپورٹ کو کور کیا گیا ہے۔
...
- `WebClient` `bodyToFlux()` کے ساتھ reactive اسٹریمنگ کنزمپشن کو فعال کرتا ہے
...
کلاسیکی طریقے سے اسٹریمنگ اور MCP میں اسٹریمنگ کے درمیان فرق کو یوں دکھایا جا سکتا ہے:
...
| کلائنٹ کی ضروریات     | اسٹریم کو پراسیس کرنا ضروری ہے | میسج ہینڈلر نافذ کرنا ضروری ہے    |
...
- **مواصلاتی پیٹرن:**
   - کلاسیکی HTTP اسٹریمنگ: سادہ چنکڈ ٹرانسفر انکوڈنگ استعمال کرتا ہے ڈیٹا چنکس بھیجنے کے لیے
...
کچھ چیزیں ہم سفارش کرتے ہیں جب کلاسیکی اسٹریمنگ (جیسا کہ اوپر `/stream` اینڈپوائنٹ کے ذریعے دکھایا گیا) اور MCP کے ذریعے اسٹریمنگ کے درمیان انتخاب کی بات آتی ہے:
...
ٹھیک ہے، تو آپ نے اب تک کلاسیکی اسٹریمنگ اور MCP اسٹریمنگ کے درمیان کچھ سفارشات اور موازنہ دیکھ لیے ہیں۔ آئیے تفصیل میں جانتے ہیں کہ آپ MCP میں اسٹریمنگ کو کیسے استعمال کر سکتے ہیں۔
...
> [!NOTE]
> استعمال شدہ SDK پر منحصر ہے، لاگنگ ڈیفالٹ کے طور پر فعال ہو سکتی ہے، یا آپ کو اسے اپنے سرور کی کنفیگریشن میں واضح طور پر فعال کرنا پڑ سکتا ہے۔
...
کلائنٹ کو ایک میسج ہینڈلر نافذ کرنا چاہیے جو نوٹیفیکیشنز کو وصول کرے اور انہیں ظاہر کرے۔
...
پچھلے کوڈ میں، `message_handler` فنکشن چیک کرتا ہے کہ آیا آنے والا پیغام نوٹیفیکیشن ہے۔ اگر ہے تو یہ نوٹیفیکیشن پرنٹ کرتا ہے؛ ورنہ اسے ایک عام سرور پیغام کے طور پر پراسیس کرتا ہے۔ نیز، `ClientSession` کو `message_handler` کے ساتھ انیشیئلائز کیا گیا ہے تاکہ آنے والی نوٹیفیکیشنز کو ہینڈل کیا جا سکے۔
...
اس .NET مثال میں، `MessageHandler` فنکشن چیک کرتا ہے کہ آیا آنے والا پیغام نوٹیفیکیشن ہے۔ اگر ہے تو یہ نوٹیفیکیشن پرنٹ کرتا ہے؛ ورنہ اسے ایک عام سرور پیغام کے طور پر پراسیس کرتا ہے۔ `ClientSession` کو `ClientSessionOptions` کے ذریعے میسج ہینڈلر کے ساتھ انیشیئلائز کیا گیا ہے۔
...
پروگریس نوٹیفیکیشنز وہ حقیقی وقت کے پیغامات ہیں جو سرور سے کلائنٹ کو طویل مدتی آپریشنز کے دوران بھیجے جاتے ہیں۔ پورے عمل کے ختم ہونے کا انتظار کرنے کے بجائے، سرور کلائنٹ کو موجودہ اسٹیٹس کے بارے میں اپ ڈیٹ رکھتا ہے۔ یہ شفافیت، صارف کے تجربے کو بہتر بناتا ہے
...
جب MCP سرورز کو HTTP پر مبنی ٹرانسپورٹس کے ساتھ نافذ کیا جاتا ہے، تو سیکیورٹی ایک نہایت اہم مسئلہ بن جاتی ہے جس کے لیے مختلف حملوں کے راستوں اور حفاظتی طریقوں پر خاص توجہ دینا ضروری ہے۔
...
- **Localhost بائنڈنگ**: مقامی ترقی کے لیے سرورز کو `localhost` پر بائنڈ کریں تاکہ انہیں عوامی انٹرنیٹ پر ظاہر نہ کیا جائے۔
...
اپنی MCP ایپلیکیشنز میں SSE سے Streamable HTTP پر منتقلی کے لیے یہ اقدامات کریں:
...
منتقلی کے دوران درج ذیل چیلنجز کا سامنا ہو سکتا ہے:

- تمام کلائنٹس کو اپ ڈیٹ کرنا یقینی بنانا
- نوٹیفیکیشن کی ترسیل میں فرق کو سنبھالنا

## سیکیورٹی کے پہلو

کسی بھی سرور کو نافذ کرتے وقت، خاص طور پر MCP میں Streamable HTTP جیسے HTTP پر مبنی ٹرانسپورٹس استعمال کرتے ہوئے، سیکیورٹی کو اولین ترجیح دینی چاہیے۔
...
### مشق: اپنی خود کی اسٹریمنگ MCP ایپ بنائیں

**صورت حال:**
ایک MCP سرور اور کلائنٹ بنائیں جہاں سرور اشیاء کی فہرست (مثلاً فائلز یا دستاویزات) کو پروسیس کرے اور ہر پروسیس کی گئی آئٹم کے لیے نوٹیفیکیشن بھیجے۔ کلائنٹ کو چاہیے کہ وہ ہر نوٹیفیکیشن کو جیسے ہی آئے دکھائے۔

**مراحل:**

1. ایک سرور ٹول نافذ کریں جو فہرست کو پروسیس کرے اور ہر آئٹم کے لیے نوٹیفیکیشن بھیجے۔
2. ایک کلائنٹ نافذ کریں جس میں میسج ہینڈلر ہو تاکہ نوٹیفیکیشنز کو حقیقی وقت میں دکھایا جا سکے۔
