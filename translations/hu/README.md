...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T07:49:40+00:00",
...
| 3.7 | AI Toolkit | Használj AI Toolkitet az MCP-vel | [Útmutató](./03-GettingStarted/07-aitk/README.md) |
...
| 5.9 | Webes keresés | Valósíts meg webes keresési képességeket | [Útmutató](./05-AdvancedTopics/web-search-mcp/README.md) |
| 5.10 | Valós idejű streaming | Építs valós idejű streaming funkciót | [Útmutató](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
| 5.11 | Valós idejű keresés | Valósíts meg valós idejű keresést | [Útmutató](./05-AdvancedTopics/mcp-realtimesearch/README.md) |
...
| 11 | MCP szerver adatbázis integráció | Átfogó, 13-laboros tanulási útvonal PostgreSQL integrációval | [Laborok](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.2 | Alapvető architektúra | MCP szerver architektúra, adatbázis rétegek és biztonsági minták megértése | [Labor 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
...
| 11.6 | MCP Szerver Implementáció | FastMCP szerver építése adatbázis integrációval | [Lab 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
...
| 11.13 | Legjobb Gyakorlatok | Teljesítmény optimalizálás, biztonsági megerősítés és produkciós tippek | [Lab 12](./11-MCPServerHandsOnLabs/12-Best-Practices/README.md) |
...
Ez a repozitórium számos forrást tartalmaz, amelyek segítenek hatékonyan tanulni és eligazodni:

### Tanulási Útmutató

Egy átfogó [Tanulási Útmutató](./study_guide.md) áll rendelkezésre, amely segít eligazodni ebben a repozitóriumban. Az útmutató tartalmazza:

- Vizualizált tananyag térképet, amely bemutatja az összes lefedett témát
- Az egyes repozitórium szekciók részletes bontását
...
1. MCP fogalmak világos magyarázatát  
...
Készülj fel két nap mély technikai betekintésre, közösségi kapcsolódásra és gyakorlati tanulásra az MCP Fejlesztői Napokon, egy virtuális eseményen, amely a Model Context Protocol (MCP) köré épül — az új szabvány, amely hidat képez az AI modellek és az általuk használt eszközök között.
...
Az első nap célja, hogy a fejlesztőket felhatalmazza MCP használatára a fejlesztői munkafolyamatukban, és megünnepelje az MCP közösséget. Közösségi tagokkal és partnerekkel, mint Arcade, Block, Okta és Neon, együttműködve bemutatjuk, hogyan dolgoznak a Microsofttal egy nyílt, bővíthető MCP ökoszisztéma kialakításán. Valós példák VS Code, Visual Studio, GitHub Copilot és népszerű közösségi eszközök használatával
Gyakorlati, kontextusvezérelt fejlesztői munkafolyamatok
Közösség által vezetett szekciók és betekintések
Akár most kezded az MCP-t, akár már építed vele, az első nap inspirációval és cselekvésre ösztönző tanulságokkal szolgál.

#### [2. nap: MCP Szerverek Magabiztos Építése](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

A második nap az MCP építőknek szól. Mélyen belemegyünk az implementációs stratégiákba és legjobb gyakorlatokba MCP szerverek létrehozásához és MCP integrálásához az AI munkafolyamatokba.
...
- Építőelemek, mint Functions, ACA és API Management használata
...
Tanulj intenzív videós szekciókban, hogyan hozhatsz létre MCP szervereket, integrálhatod őket VS Code-ba, és telepítheted professzionálisan Azure-ra az MCP kezdőknek szóló tananyag alapján. Szerezz gyakorlati készségeket egy technológiában, amelyet már nagy cégek is használnak.
...
Ismerjük meg a Model Context Protocol-t (MCP), egy korszerű keretrendszert, amely az AI modellek és kliensalkalmazások közötti interakciók szabványosítására készült. Ebben a kezdőbarát szekcióban bemutatjuk az MCP-t, és végigvezetünk az első MCP szerver létrehozásán.
...
a jogokat a hozzájárulásod használatához. Részletekért látogass el ide: <https://cla.opensource.microsoft.com>.

Amikor benyújtasz egy pull requestet, egy CLA bot automatikusan meghatározza, hogy szükséges-e
CLA-t biztosítanod, és megfelelően megjelöli a PR-t (pl. állapotellenőrzés, megjegyzés). Egyszerűen kövesd az utasításokat,
amelyeket a bot biztosít. Ezt csak egyszer kell megtenned az összes CLA-t használó repóban.
...
- **11-MCPServerHandsOnLabs/**: Teljes 13-laboros tanulási útvonal produkcióra kész MCP szerverek építéséhez PostgreSQL integrációval
...
- **translated_images/**: Lokalizált diagramok és illusztrációk verziói
...
## ™️ Védjegy Megjegyzés

Ez a projekt tartalmazhat védjegyeket vagy logókat projektekhez, termékekhez vagy szolgáltatásokhoz. A Microsoft védjegyek vagy logók engedélyezett használata a [Microsoft Védjegy- és Márkaútmutató](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) előírásainak megfelelően történhet. A Microsoft védjegyek vagy logók módosított verzióinak használata nem okozhat zavart, és nem sugallhatja a Microsoft támogatását. Harmadik fél védjegyeinek vagy logóinak használata az adott harmadik fél szabályzata szerint történik.
...
Ha termékvisszajelzést szeretnél adni, vagy hibát tapasztalsz az építés során, látogasd meg:
