...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:55:16+00:00",
...
| 3.9 | Telepítés | Telepíts MCP szervereket éles környezetbe | [Útmutató](./03-GettingStarted/09-deployment/README.md) |
...
| 5.4 | Gyökérkontekstek | Gyökérkontekstek megértése és megvalósítása | [Útmutató](./05-AdvancedTopics/mcp-root-contexts/README.md) |
...
| 08 | Legjobb gyakorlatok az MCP-hez | Teljesítmény, hibatűrés, rugalmasság | [Útmutató](./08-BestPractices/README.md) |
...
| Nyelv | Leírás | Link |
|-------|--------|------|
| C# | Fejlett példa | [Kód megtekintése](./04-PracticalImplementation/samples/csharp/README.md) |
...
| JavaScript | Fejlett példa | [Kód megtekintése](./04-PracticalImplementation/samples/javascript/README.md) |
...
## 🎯 Előfeltételek az MCP elsajátításához
...
Ez a repozitórium számos forrást tartalmaz, amelyek segítenek hatékonyan eligazodni és tanulni:
...
Részletes [Változásnaplót](./changelog.md) tartunk fenn, amely nyomon követi a tananyagokkal kapcsolatos összes jelentős frissítést, beleértve:
...
Tanulj intenzív videós szekciókban, hogyan hozhatsz létre MCP szervereket, integrálhatod őket a VS Code-ba, és telepítheted professzionálisan az Azure-ra az MCP kezdőknek szóló tananyag alapján. Szerezz gyakorlati készségeket egy olyan technológiában, amelyet már nagyvállalatok is használnak.
...
### Tanuljuk meg az MCP-t C#-ban - Oktatási sorozat
Ismerd meg a Model Context Protocol-t (MCP), egy korszerű keretrendszert, amely az AI modellek és kliensalkalmazások közötti interakciók szabványosítására készült. Ebben a kezdőbarát szekcióban bemutatjuk az MCP-t, és végigvezetünk az első MCP szerver létrehozásán.
...
- **changelog.md**: A tananyagokkal kapcsolatos összes jelentős változás nyilvántartása
...
- [GitHub Copilot Elsajátítása AI Párosított Programozáshoz](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
védjegyek vagy logók engedélyezett használata a következőket kell, hogy kövesse:
[Microsoft Védjegy és Márka Irányelvek](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Harmadik fél védjegyek vagy logók használata a harmadik felek irányelveinek hatálya alá tartozik.
