...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-02T09:48:30+00:00",
...
1. **Forkold a tárhelyet**: Kattints [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
...
Legyél akár AI fejlesztő, rendszertervező vagy szoftvermérnök, ez az útmutató átfogó forrásként szolgál az MCP alapjainak és megvalósítási stratégiáinak elsajátításához.

## 🔗 Hivatalos MCP források

- 📘 [MCP dokumentáció](https://modelcontextprotocol.io/) – Részletes oktatóanyagok és felhasználói útmutatók  
- 📜 [MCP specifikáció](https://spec.modelcontextprotocol.io/) – Protokoll felépítés és technikai hivatkozások  
...
Készülj két nap mély technikai betekintésre, közösségi kapcsolódásra és gyakorlati tanulásra az MCP Dev Days-en, egy virtuális eseményen, amely a Model Context Protocol (MCP) köré épül — az AI modellek és az általuk használt eszközök közötti kapcsolat új szabványa.

➡️ [Regisztrálj az MCP Dev Days-re](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

Az MCP Dev Days eseményt megtekintheted, ha regisztrálsz az esemény oldalán: https://aka.ms/mcpdevdays. Innen élő közvetítésen csatlakozhatsz YouTube-on vagy Twitch-en. Az összes tartalom felvételre kerül, és később elérhető lesz a Microsoft Developer YouTube csatornáján. A demók forráskódja is elérhető lesz GitHub-on.

### Esemény részletei
- Időpontok: július 29. (1. nap) és július 30. (2. nap)
- Időpont: napi 9:00 AM PST
- Helyszín: online – bárhonnan csatlakozhatsz!

#### 1. nap: MCP produktivitás, fejlesztői eszközök és közösség

A nap célja, hogy a fejlesztőket támogassa az MCP használatában a mindennapi munkafolyamatukban, és megünnepelje az MCP közösség fantasztikus tagjait. Közösségi tagokkal és partnerekkel, mint az Arcade, Block, Okta és Neon együttműködve mutatjuk be, hogyan alakítják az MCP nyílt és bővíthető ökoszisztémáját a Microsofttal. Valós példák VS Code, Visual Studio, GitHub Copilot és népszerű közösségi eszközök használatával  
Gyakorlati, kontextus-alapú fejlesztői munkafolyamatok  
Közösségi vezetésű előadások és betekintések  
Akár most ismerkedsz az MCP-vel, akár már építesz vele, az 1. nap inspirációt és hasznos tanácsokat nyújt.
...
- Építőelemek használata, mint a Functions, ACA és API Management  
- Registry összehangolás és eszközök (1P + 3P)

Ha fejlesztő, eszközfejlesztő vagy AI termékstratégia szakértő vagy, ez a nap tele lesz olyan ismeretekkel, amelyek segítenek skálázható, biztonságos és jövőálló MCP megoldások építésében.
...
- **00. Bevezetés az MCP-be**  
  Áttekintés a Model Context Protocol-ról és annak jelentőségéről az AI folyamatokban. [Tovább](./00-Introduction/README.md)  
...
- **03. Első lépések az MCP-vel**  
  Környezet beállítása, alap szerverek/kliens oldalak, integráció. [Tovább](./03-GettingStarted/README.md)  
</details>
...
<details>
  <summary><strong> 4-5. leckék: Gyakorlati & Haladó témák</strong></summary>
...
- **5.3. MCP OAuth2 demo** – [Útmutató](./05-AdvancedTopics/mcp-oauth2-demo/README.md)  
...
<details>
  <summary><strong>6-9. leckék: Közösség, legjobb gyakorlatok és laborok</strong></summary>
...
- **10. Az AI munkafolyamatok egyszerűsítése: MCP szerver építése AI Toolkit segítségével** – [Gyakorlati labor](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md)
</details>
...
### 💡 MCP haladó példa megoldás: Számológép projektek C#, Java, JavaScript, TypeScript és Python nyelveken
<details>
...
Egy átfogó [Tanulmányi útmutató](./study_guide.md) áll rendelkezésedre, amely segít hatékonyan eligazodni ebben a tárházban. Az útmutató tartalmazza:
...
A tartalom az **MIT Licenc** alatt áll. A feltételekért lásd a [LICENSE](../../LICENSE) fájlt.

## 🤝 Hozzájárulási irányelvek

Ez a projekt szívesen fogad hozzájárulásokat és javaslatokat. A legtöbb hozzájáruláshoz el kell fogadnod egy Contributor License Agreement-et (CLA), amely igazolja, hogy jogosult vagy a hozzájárulás használatára, és ténylegesen megadod nekünk a használati jogokat. Részletekért látogass el ide: <https://cla.opensource.microsoft.com>.

Amikor pull request-et nyújtasz be, egy CLA bot automatikusan megállapítja, hogy szükséges-e CLA-t benyújtanod, és ennek megfelelően jelöli a PR-t (pl. státusz ellenőrzés, komment). Csak kövesd a bot utasításait. Ezt a folyamatot csak egyszer kell elvégezni az összes CLA-t használó tárházban.

Ez a projekt elfogadta a [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/) szabályzatát. További információkért lásd a [Code of Conduct GYIK](https://opensource.microsoft.com/codeofconduct/faq/) oldalt, vagy írj az [opencode@microsoft.com](mailto:opencode@microsoft.com) címre, ha további kérdéseid vagy észrevételeid vannak.
...
- [GitHub Copilot mesterszintű használata AI páros programozáshoz](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
- [GitHub Copilot mesterszintű használata C#/.NET fejlesztőknek](https://github.com/microsoft/mastering-github-copilot-for-dotnet-csharp-developers?WT.mc_id=academic-105485-koreyst)
- [Válaszd ki a saját Copilot kalandodat](https://github.com/microsoft/CopilotAdventures?WT.mc_id=academic-105485-koreyst)


## ™️ Védjegy értesítés

Ez a projekt tartalmazhat védjegyeket vagy logókat projektekhez, termékekhez vagy szolgáltatásokhoz. A Microsoft védjegyek vagy logók jogos használata alá esik, és követnie kell a 
