...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T19:23:26+00:00",
...
A Model Context Protocol egyedi biztonsági kihívásokat vezet be, amelyek túlmutatnak a hagyományos szoftverbiztonságon. Ezek a gyakorlatok az alapvető biztonsági követelményeket és az MCP-specifikus fenyegetéseket kezelik, beleértve a prompt injekciót, eszközmérgezést, munkamenet-eltérítést, összezavart helyettes problémákat és token átadási sebezhetőségeket.
...
>  
> **NEM SZABAD**: MCP szerverek **NEM SZABAD** munkameneteket használniuk hitelesítéshez  
>
...
**Hitelesítési és Engedélyezési Ellenőrzések:**
   ...
   - **Token Célközönség Ellenőrzése**: Mindig ellenőrizze, hogy a tokeneket kifejezetten az MCP szerver számára bocsátották-e ki - soha ne fogadjon el upstream tokeneket  
...
**Biztonságos Munkamenet Gyakorlatok:**
   ...
   - **Munkamenet Életciklus Kezelés**: Valósítson meg megfelelő lejáratot, forgatást és érvénytelenítést a sebezhetőségi ablakok korlátozása érdekében  
...
**Prompt Injekció Védelem:**
   ...
   - **Bemenet Tisztítás**: Ellenőrizze és tisztítsa meg az összes bemenetet, hogy megakadályozza az injekciós támadásokat és az összezavart helyettes problémákat  
...
**Eszközmérgezés Megelőzése:**
   - **Eszköz Metaadat Ellenőrzés**: Valósítson meg integritás ellenőrzéseket az eszközdefiníciókhoz, és monitorozza a váratlan változásokat  
...
## 7. **OAuth Biztonság és Összezavart Helyettes Megelőzés**

**OAuth 2.1 Megvalósítás:**
   - **PKCE Megvalósítás**: Használjon Proof Key for Code Exchange (PKCE) minden engedélykéréshez  
   - **Kifejezett Beleegyezés**: Szerezzen felhasználói beleegyezést minden dinamikusan regisztrált klienshez, hogy megakadályozza az összezavart helyettes támadásokat  
   - **Átirányítás URI Ellenőrzés**: Valósítson meg szigorú ellenőrzést az átirányítás URI-k és kliensazonosítók esetében  
...
**Szabályozási Megfelelőség:**
   ...
   - Valósítson meg adat osztályozási és adatvédelmi ellenőrzéseket az AI adatfeldolgozáshoz  
...
**Identitás és Hozzáférés Kezelés:**
   ...
   - **Privilegizált Identitás Kezelés (PIM)**: Just-in-time hozzáférés és jóváhagyási munkafolyamatok adminisztratív funkciókhoz  
...
**Naprakészség:**
   - **Specifikáció Monitorozás**: Rendszeres felülvizsgálat az MCP specifikáció frissítéseiről és biztonsági útmutatás változásairól  
   - **Fenyegetés Intelligencia**: AI-specifikus fenyegetés hírcsatornák és kompromisszum indikátorok integrációja  
...
- [OAuth 2.0 Biztonsági Legjobb Gyakorlatok (
