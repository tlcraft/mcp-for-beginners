...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T14:35:04+00:00",
...
3. **Felhasználói Hozzájárulás**: Az MCP proxy szerverek, amelyek statikus kliensazonosítókat használnak, **KÖTELESEK** kifejezett felhasználói hozzájárulást kérni minden dinamikusan regisztrált kliens esetében.
4. **Biztonságos Munkamenet-azonosítók**: MCP szervereknek **KRIPTOGRAFIAILAG BIZTONSÁGOS**, nem determinisztikus munkamenet-azonosítókat kell használniuk, amelyeket biztonságos véletlenszám-generátorokkal hoznak létre.
...
- **Paraméter Sémák Betartása**: Valósítson meg szigorú JSON sémaellenőrzést minden eszközparaméter és API bemenet esetében.
...
- **Finomhangolt Engedélyek**: Valósítson meg eszközspecifikus, granuláris engedélyeket a legkisebb jogosultság elve alapján.
...
- **Többfaktoros Hitelesítés**: Követelje meg a MFA-t minden adminisztratív hozzáféréshez és érzékeny művelethez.
...
- **Végponttól Végpontig Terjedő Titkosítás**: Valósítson meg további titkosítási rétegeket a rendkívül érzékeny adatok átviteléhez és tárolásához.
- **Tanúsítványkezelés**: Tartsa fenn a tanúsítványok megfelelő életciklus-kezelését automatizált megújítási folyamatokkal.
- **Protokoll Verzió Betartása**: Használja az aktuális MCP protokoll verziót (2025-06-18) megfelelő verzióegyeztetéssel.
...
- **Kriptográfiai Munkamenet-azonosítók**: Generáljon munkamenet-azonosítókat kriptográfiailag biztonságos véletlenszám-generátorokkal (nem előre jelezhető sorozatokkal).
...
- **Modellek Kimeneti Ellenőrzése**: Vizsgálja meg a modellek kimeneteit az esetleges adatvesztés, káros tartalom vagy biztonsági szabályzat megsértése miatt.
...
- **Biztonsági Kódellenőrzések**: Valósítson meg kötelező biztonsági ellenőrzéseket minden MCP-vel kapcsolatos kódváltoztatás esetében.
...
- **Függőség Kezelés**: Tartson naprakész nyilvántartást az összes szoftver- és AI-függőségről sebezhetőség követéssel.
...
- **Federált Tanulás**: Valósítson meg elosztott tanulási megközelítéseket, amelyek megőrzik az adatok helyi jellegét és adatvédelmét.
...
- **Automatizált Válasz**: Valósítson meg automatizált izolálást és helyreállítást a gyakori AI biztonsági incidensekhez.  
- **Forenzikai Képességek**: Tartsa fenn a forenzikai készenlétet az AI rendszerek kompromittálása és adatvesztése esetén.
- **Helyreállítási Eljárások**: Hozzon létre eljárásokat az AI modell mérgezés, prompt injekciós támadások és szolgáltatás kompromittálások utáni helyreállításhoz.
...
*Ez a dokumentum az MCP biztonsági bevált gyakorlatokat tükrözi 2025. augusztus 18-i állapot szerint, az MCP 2025-06-18 specifikáció alapján. A biztonsági gyakorlatokat rendszeresen felül kell vizsgálni és frissíteni, ahogy a protokoll és a fenyegetettségi környezet változik.*
