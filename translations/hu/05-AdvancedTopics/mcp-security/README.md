...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-19T15:01:07+00:00",
...
A biztonság kulcsfontosságú az MCP megvalósításoknál, különösen vállalati környezetben. Ez a haladó útmutató átfogó biztonsági gyakorlatokat mutat be az MCP éles telepítéseihez, amelyek a hagyományos biztonsági aggályokat és az MCP-re jellemző AI-specifikus fenyegetéseket is kezelik.

## Bevezetés

A Model Context Protocol (MCP) egyedi biztonsági kihívásokat vet fel, amelyek túlmutatnak a hagyományos szoftverbiztonságon. Ahogy az AI rendszerek hozzáférést kapnak eszközökhöz, adatokhoz és külső szolgáltatásokhoz, új támadási felületek jelennek meg, például prompt injekció, eszközmérgezés, munkamenet-eltérítés, összezavart helyettesítő problémák és token továbbítási sérülékenységek.
...
- **Kötelező Ellenőrzés**: Minden bejövő kérést **KÖTELEZŐ** ellenőrizni, és a felhasználói beleegyezést **KÖTELEZŐ** megszerezni proxy műveletekhez.
- **Biztonságos Alapértelmezések**: Alkalmazzon hibabiztos biztonsági vezérlőket mélyreható védelemmel.
- **Felhasználói Irányítás**: A felhasználóknak kifejezett beleegyezést kell adniuk bármilyen adat-hozzáféréshez vagy eszközhasználathoz.

## Tanulási Célok

A lecke végére képes leszel:

- **Haladó Hitelesítés Megvalósítása**: Külső identitásszolgáltató integráció bevezetése Microsoft Entra ID-vel és OAuth 2.1 biztonsági mintákkal.
- **AI-specifikus Támadások Megelőzése**: Védelem prompt injekció, eszközmérgezés és munkamenet-eltérítés ellen Microsoft Prompt Shields és Azure Content Safety használatával.
- **Vállalati Biztonság Alkalmazása**: Átfogó naplózás, monitorozás és incidenskezelés megvalósítása MCP éles telepítésekhez.
- **Eszközhasználat Biztonságossá Tétele**: Homokozó környezetek tervezése megfelelő izolációval és erőforrás-vezérléssel.
- **MCP Sérülékenységek Kezelése**: Azonosítás és enyhítés összezavart helyettesítő problémák, token továbbítási sérülékenységek és ellátási lánc kockázatok esetén.
- **Microsoft Biztonsági Integráció**: Azure biztonsági szolgáltatások és GitHub Advanced Security használata átfogó védelem érdekében.
...
A modern MCP megvalósítások előnyt élveznek a specifikáció fejlődéséből, amely a külső identitásszolgáltatók delegálását támogatja, jelentősen javítva a biztonsági helyzetet a saját hitelesítési megoldásokhoz képest.

### **Microsoft Entra ID Integráció**

A jelenlegi MCP specifikáció (2025-06-18) lehetővé teszi a külső identitásszolgáltatók, például a Microsoft Entra ID delegálását, amely vállalati szintű biztonsági funkciókat kínál:
...
Fejlett megvalósítás a Microsoft biztonsági ökoszisztéma használatával:
...
### **Prompt Injekció Elleni Védelem Microsoft Prompt Shields-szel**
...
### **Átfogó Naplózás Azure Application Insights-szal**
...
OAuth és Proxy Biztonság:
  ...
  Nincs token továbbítás (KÖTELEZŐ)
...
- **Fenyegetésfelderítés**: Globális fenyegetésfelderítési integráció proaktív védelemhez
