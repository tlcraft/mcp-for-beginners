...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T22:06:51+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "hu"
}
-->
# Adatbázis-tervezés és séma

## 🎯 Mit tartalmaz ez a labor?

Ez a labor mélyrehatóan foglalkozik a Zava Retail rendszer PostgreSQL adatbázis-tervezésével. Megtanulhatod, hogyan valósíts meg egy átfogó kiskereskedelmi sémát vektorkeresési képességekkel, több bérlős adatmodellezéssel és sor szintű biztonsággal (Row Level Security, RLS) az adatok elkülönítéséhez.

## Áttekintés

Az adatbázis az MCP szerver alapja, amely több üzlet kiskereskedelmi adatait tárolja, miközben szigorú adatelkülönítést biztosít. PostgreSQL-t használunk a pgvector kiterjesztéssel, amely lehetővé teszi a szemantikai keresési képességeket, így az ügyfelek természetes nyelvi lekérdezésekkel találhatnak termékeket.

Sémánk modern több bérlős mintákat követ, a sor szintű biztonság biztosítja, hogy a felhasználók csak az általuk engedélyezett üzletek adataihoz férjenek hozzá. Ez a megközelítés vállalati szintű biztonságot nyújt, miközben optimális teljesítményt biztosít.

## Tanulási célok

A labor végére képes leszel:

- **Tervezni** skálázható több bérlős kiskereskedelmi adatbázis-sémákat  
- **Megvalósítani** PostgreSQL-t pgvectorral vektorkereséshez  
- **Konfigurálni** sor szintű biztonságot az adatok elkülönítéséhez  
- **Generálni** valósághű mintaadatokat teszteléshez  
- **Optimalizálni** az adatbázis teljesítményét kiskereskedelmi terhelésekhez  
- **Megvalósítani** biztonsági mentési és helyreállítási stratégiákat  

## 🗃️ Adatbázis-architektúra

### PostgreSQL pgvectorral

Adatbázisunk a PostgreSQL vállalati funkcióit kombinálja a pgvector kiterjesztéssel az AI-alapú kereséshez:
...
Az adatbázis **megosztott adatbázis, megosztott séma** több bérlős modellt használ sor szintű biztonsággal:
...
### Üzletek táblázat (bérlői főtábla)
...
### Termékek táblázat kategóriákkal
...
## 🔍 Vektorkeresés megvalósítása

### Termékbeágyazások táblázat
...
## 🔐 Sor szintű biztonság beállítása

### Adatbázis-szerepkörök és jogosultságok
...
### Valósághű tesztadatok szkriptje
...
### Lekérdezés-optimalizálási nézetek
...
✅ **Több bérlős adatbázis-tervezés**: Sor szintű biztonságot valósítottál meg az adatok biztonságos elkülönítéséhez  
✅ **Vektorkeresési képességek**: Konfiguráltad a pgvector-t szemantikai termékkereséshez  
✅ **Átfogó séma**: Létrehoztál egy gyártásra kész kiskereskedelmi adatbázis-sémát  
✅ **Mintaadatok generálása**: Valósághű tesztadatokat készítettél fejlesztéshez és teszteléshez  
✅ **Teljesítményoptimalizálás**: Indexeket és lekérdezés-optimalizálást konfiguráltál  
✅ **Biztonsági mentés és helyreállítás**: Robusztus adatvédelmi stratégiákat alakítottál ki  

## 🚀 Hogyan tovább?

Folytasd a **[05. labor: MCP szerver megvalósítása](../05-MCP-Server/README.md)** című anyaggal, hogy:

- Felépítsd a FastMCP szervert, amely kapcsolódik ehhez az adatbázishoz  
- Megvalósítsd az MCP protokollhoz szükséges adatbázis-lekérdezési eszközöket  
- Hozzáadd a szemantikai keresési képességeket a beágyazások segítségével  
- Konfiguráld a kapcsolatkezelést és a hibakezelést  

## 📚 További források

### PostgreSQL & pgvector
- [PostgreSQL dokumentáció](https://www.postgresql.org/docs/) - Teljes PostgreSQL referencia  
- [pgvector kiterjesztés](https://github.com/pgvector/pgvector) - Vektorhasonlósági keresés PostgreSQL-hez  
- [PostgreSQL teljesítményhangolás](https://wiki.postgresql.org/wiki/Performance_Optimization) - Optimalizálási legjobb gyakorlatok  

### Több bérlős architektúra
- [Sor szintű biztonság](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS dokumentáció  
- [Több bérlős adatarchitektúra](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure architektúra minták  
- [Adatbázis-biztonsági legjobb gyakorlatok](https://www.postgresql.org/docs/current/security.html) - PostgreSQL biztonsági útmutató  

### Vektoradatbázisok
- [Vektorkeresés alapjai](https://www.pinecone.io/learn/vector-database/) - Vektoradatbázisok megértése  
- [Beágyazási modellek](https://platform.openai.com/docs/guides/embeddings) - OpenAI beágyazási dokumentáció  
- [HNSW algoritmus](https://arxiv.org/abs/1603.09320) - Hierarchikus Navigálható Kis Világ gráfok  

---

**Előző**: [03. labor: Környezet beállítása](../03-Setup/README.md)  
**Következő**: [05. labor: MCP szerver megvalósítása](../05-MCP-Server/README.md)  
