...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T21:55:03+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "hu"
}
-->
# Biztonság és Több-bérlős Környezet

## 🎯 Mit Tartalmaz Ez a Labor

Ez a labor átfogó útmutatást nyújt vállalati szintű biztonság és több-bérlős környezet megvalósításához MCP szervereken. Megtanulhatod, hogyan tervezz biztonságos, megfelelőségi követelményeknek megfelelő rendszereket, amelyek védik az érzékeny kiskereskedelmi adatokat, miközben rugalmas hozzáférési mintákat biztosítanak több bérlő számára.

## Áttekintés

A biztonság kiemelten fontos a kiskereskedelmi alkalmazásokban, amelyek ügyféladatokat, fizetési információkat és üzleti intelligenciát kezelnek. Ez a labor lefedi a teljes biztonsági architektúrát az autentikációtól és autorizációtól kezdve az adatok elkülönítésén és megfelelőségi monitorozáson át.

Egy mélységi védekezési stratégiát valósítunk meg, amely kombinálja az Azure identitás szolgáltatásait, a PostgreSQL sor szintű biztonságát, alkalmazásszintű kontrollokat és átfogó audit naplózást, hogy egy robusztus, megfelelőségi követelményeknek megfelelő platformot hozzunk létre.

## Tanulási Célok

A labor végére képes leszel:

- **Megvalósítani** vállalati szintű sor szintű biztonságot több-bérlős adat elkülönítéshez
- **Tervezni** biztonságos autentikációs és autorizációs mintákat az Azure segítségével
- **Konfigurálni** átfogó audit naplózást a megfelelőségi követelményekhez
- **Alkalmazni** mélységi védekezési biztonsági stratégiákat az alkalmazás minden rétegében
- **Validálni** a biztonsági megvalósításokat szisztematikus teszteléssel
- **Monitorozni** biztonsági eseményeket és reagálni a potenciális fenyegetésekre

## 🔐 Több-bérlős Biztonsági Architektúra

### Biztonsági Rétegek Áttekintése
...
### Több-bérlős Modellek

A megvalósításunk a **Megosztott Adatbázis, Megosztott Séma** modellt használja sor szintű biztonsággal:

**Előnyök:**
- Költséghatékony erőforrás-használat
- Egyszerűbb karbantartás és frissítések
- Erős adat elkülönítés RLS segítségével
- Megfelelőségi szempontból barátságos audit nyomvonalak

**Hátrányok:**
- Gondos RLS politika tervezést igényel
- Sémaváltozások minden bérlőt érintenek
- Robusztus mentési/visszaállítási eljárások szükségesek

## 🛡️ Sor Szintű Biztonság Megvalósítása
...
### Biztonsági Monitorozási Nézetek
...
### Automatikus Biztonsági Tesztek
...
### Penetrációs Tesztelési Ellenőrzőlista
...
A labor elvégzése után képes leszel:

✅ **Több-bérlős Biztonság**: Sor szintű biztonságot valósítottál meg teljes adat elkülönítéshez  
✅ **Azure Autentikáció**: Integráltad az Azure Entra ID-t JWT validációval  
✅ **Szerepkör-alapú Autorizáció**: Hierarchikus szerepkör és jogosultsági rendszert konfiguráltál  
✅ **Átfogó Audit Naplózás**: Biztonsági események nyomon követését és monitorozását valósítottad meg  
✅ **Biztonsági Tesztelés**: Automatikus biztonsági validációs teszteket valósítottál meg  
✅ **Fenyegetés Monitorozás**: Valós idejű biztonsági események észlelését és riasztását hoztad létre  

## 🚀 Mi Következik

Folytasd a **[Lab 03: Környezet Beállítása](../03-Setup/README.md)** című laborral, hogy:

- Biztonsági legjobb gyakorlatokkal konfiguráld a fejlesztési környezeteket
- Beállítsd az Azure szolgáltatásokat autentikációhoz és monitorozáshoz
- Biztonságos adatbázis-kapcsolatokat és titkosításkezelést valósíts meg
- Validáld a biztonsági konfigurációkat a fejlesztési környezetekben

## 📚 További Források

### Azure Biztonság
- [Azure Entra ID Dokumentáció](https://docs.microsoft.com/azure/active-directory/) - Teljes identitás platform útmutató
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Titkosításkezelési szolgáltatás
- [Azure Biztonsági Legjobb Gyakorlatok](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Biztonsági útmutató

### Adatbázis Biztonság
- [PostgreSQL Sor Szintű Biztonság](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Hivatalos RLS dokumentáció
- [Adatbázis Biztonsági Ellenőrzőlista](https://www.postgresql.org/docs/current/security.html) - PostgreSQL biztonsági útmutató
- [Több-bérlős Adatbázis Minták](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Architektúra minták

### Biztonsági Tesztelés
- [OWASP Tesztelési Útmutató](https://owasp.org/www-project-web-security-testing-guide/) - Átfogó biztonsági tesztelés
- [JWT Biztonsági Legjobb Gyakorlatok](https://tools.ietf.org/html/rfc8725) - JWT biztonsági megfontolások
- [API Biztonsági Tesztelés](https://owasp.org/www-project-api-security/) - API-specifikus biztonsági tesztelés

---

**Előző**: [Lab 01: Alapvető Architektúra Fogalmak](../01-Architecture/README.md)  
**Következő**: [Lab 03: Környezet Beállítása](../03-Setup/README.md)
