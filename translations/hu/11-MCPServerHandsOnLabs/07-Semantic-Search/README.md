...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T22:08:52+00:00",
  "source_file": "11-MCPServerHandsOnLabs/07-Semantic-Search/README.md",
  "language_code": "hu"
}
-->
# Szemantikus keresés integrációja

## 🎯 Mit tartalmaz ez a labor

Ez a labor átfogó útmutatót nyújt a szemantikus keresési képességek megvalósításához az Azure OpenAI beágyazások és a PostgreSQL pgvector kiterjesztésének segítségével. Megtanulhatod, hogyan építs AI-alapú termékkeresést, amely megérti a természetes nyelvű lekérdezéseket, és releváns eredményeket nyújt szemantikai hasonlóság alapján.

## Áttekintés

A hagyományos kulcsszó-alapú keresés gyakran nem képes megragadni a felhasználói szándékot és a szemantikai jelentést. A szemantikus keresés vektoros beágyazásokkal lehetővé teszi, hogy olyan természetes nyelvű lekérdezések, mint például "kényelmes futócipő esős időre", releváns termékeket találjanak, még akkor is, ha ezek a pontos szavak nem szerepelnek a termékleírásokban.

A megvalósításunk az Azure OpenAI erőteljes beágyazási modelljeit kombinálja a PostgreSQL pgvector kiterjesztésével, hogy egy nagy teljesítményű, skálázható szemantikus keresési rendszert hozzon létre, amely intelligens termékfelfedezéssel javítja a kiskereskedelmi élményt.

## Tanulási célok

A labor végére képes leszel:

- **Integrálni** az Azure OpenAI beágyazási modelleket szöveg vektorizálásához  
- **Megvalósítani** a pgvector-t hatékony hasonlósági keresési műveletekhez  
- **Felépíteni** szemantikus keresési eszközöket természetes nyelvű terméklekérdezésekhez  
- **Létrehozni** hibrid keresést, amely ötvözi a hagyományos és vektoros keresést  
- **Optimalizálni** vektorkereséseket a termelési teljesítmény érdekében  
- **Tervezni** ajánlórendszereket beágyazási hasonlóság alapján  

## 🧠 Szemantikus keresési architektúra

### Vektorkeresési folyamat
...
### Beágyazási generálási stratégia
...
## 🔍 Termékbeágyazások generálása

### Automatizált beágyazási folyamat
...
## 🔎 Szemantikus keresési eszközök

### Szemantikus termékkeresési eszköz
...
### Beágyazási gyorsítótár stratégia
...
✅ **Azure OpenAI integráció**: Teljes beágyazási generálás gyorsítótárral és optimalizálással  
✅ **Vektorkeresés megvalósítása**: Termelésre kész szemantikus keresés pgvector segítségével  
✅ **Hibrid keresési képességek**: Kulcsszó és szemantikus keresés kombinálása az optimális eredményekért  
✅ **Ajánlórendszerek**: AI-alapú termékajánlások hasonlóság alapján  
✅ **Teljesítményoptimalizálás**: Vektorindex optimalizálása és intelligens gyorsítótárazás  
✅ **Skálázható architektúra**: Vállalati szintű szemantikus keresési infrastruktúra  

## 🚀 Mi következik

Folytasd a **[08. labor: Tesztelés és hibakeresés](../08-Testing/README.md)** című résszel, hogy:

- Átfogó tesztelési stratégiákat valósíts meg szemantikus kereséshez  
- Hibakeresést végezz vektorkeresési teljesítményproblémák esetén  
- Értékeld a beágyazások minőségét és relevanciáját  
- Teszteld az ajánlórendszer pontosságát  

## 📚 További források

### Azure OpenAI
- [Azure OpenAI szolgáltatás dokumentációja](https://docs.microsoft.com/azure/cognitive-services/openai/) - Teljes szolgáltatási útmutató  
- [Beágyazások API referencia](https://platform.openai.com/docs/api-reference/embeddings) - API dokumentáció  
- [Beágyazások legjobb gyakorlatai](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Megvalósítási útmutató  

### Vektoralapú adatbázisok
- [pgvector dokumentáció](https://github.com/pgvector/pgvector) - PostgreSQL vektor kiterjesztés  
- [Vektorkeresési optimalizálás](https://www.pinecone.io/learn/vector-search-optimization/) - Teljesítményhangolás  
- [HNSW algoritmus](https://arxiv.org/abs/1603.09320) - Hierarchikus navigálható kis világ gráfok  

### Szemantikus keresés
- [Információkeresés alapjai](https://nlp.stanford.edu/IR-book/) - Stanford IR tankönyv  
- [Vektorkeresés legjobb gyakorlatai](https://weaviate.io/blog/vector-search-best-practices) - Megvalósítási minták  
- [Hibrid keresési stratégiák](https://blog.vespa.ai/hybrid-search/) - Különböző keresési megközelítések kombinálása  

---

**Előző**: [06. labor: Eszközfejlesztés](../06-Tools/README.md)  
**Következő**: [08. labor: Tesztelés és hibakeresés](../08-Testing/README.md)  
