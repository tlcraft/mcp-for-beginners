...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T20:25:44+00:00",
...
| SSE               | نعم                        | نعم        | متوسطة          | الويب، التحديثات الحية   |
...
**البث** هو تقنية في برمجة الشبكات تسمح بإرسال واستقبال البيانات على شكل أجزاء صغيرة يمكن إدارتها أو كسلسلة من الأحداث، بدلاً من الانتظار حتى يصبح الرد كاملاً. هذا مفيد بشكل خاص لـ:
...
| حالة الاستخدام        | ملفات كبيرة، تدفقات رموز AI   | التقدم، السجلات، ردود فعل حية  |
...
فهم كيفية عمل البث داخل إطار MCP ضروري لبناء تطبيقات تفاعلية توفر ردود فعل في الوقت الحقيقي للمستخدمين أثناء العمليات طويلة الأمد.
...
> [!NOTE]
> اعتمادًا على SDK المستخدم، قد يتم تمكين التسجيل تلقائيًا، أو قد تحتاج إلى تمكينه صراحة في تكوين الخادم.
...
- **اختبار التوافق** مع الأدوات وسير العمل الحالي.
