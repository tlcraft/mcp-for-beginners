...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T23:40:13+00:00",
...
| [5.3 MCP OAuth2 sample](../../../05-AdvancedTopics/mcp-oauth2-demo) | عرض توضيحي لـ MCP OAuth2 | تطبيق Spring Boot بسيط يعرض OAuth2 مع MCP، كخادم تفويض وموارد. يوضح إصدار رموز آمنة، نقاط نهاية محمية، نشر تطبيقات Azure Container، وتكامل إدارة API. |
...
| [5.9 Web Search sample](./web-search-mcp/README.md) | بحث الويب MCP | خادم وعميل MCP بلغة Python يتكامل مع SerpAPI للبحث في الويب، الأخبار، المنتجات، والأسئلة والأجوبة في الوقت الحقيقي. يوضح تنسيق أدوات متعددة، تكامل API خارجي، ومعالجة أخطاء قوية. |
