...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T13:37:56+00:00",
  "source_file": "05-AdvancedTopics/mcp-security/README.md",
  "language_code": "ar"
}
-->
# دليل تنفيذ ممارسات الأمان المتقدمة لـ MCP

> **المعيار الحالي**: يعكس هذا الدليل متطلبات الأمان وفقًا لـ [MCP Specification 2025-06-18](https://spec.modelcontextprotocol.io/specification/2025-06-18/) وممارسات الأمان الرسمية لـ [MCP Security Best Practices](https://modelcontextprotocol.io/specification/2025-06-18/basic/security_best_practices).

الأمان أمر بالغ الأهمية لتطبيقات MCP، خاصة في بيئات المؤسسات. يستكشف هذا الدليل المتقدم ممارسات الأمان الشاملة لنشر MCP في بيئات الإنتاج، مع معالجة المخاوف الأمنية التقليدية والتهديدات الفريدة المتعلقة بالذكاء الاصطناعي التي تخص بروتوكول Model Context Protocol.

## المقدمة

يقدم بروتوكول Model Context Protocol (MCP) تحديات أمنية فريدة تتجاوز أمان البرمجيات التقليدية. مع وصول أنظمة الذكاء الاصطناعي إلى الأدوات والبيانات والخدمات الخارجية، تظهر نواقل هجوم جديدة مثل حقن التعليمات، تسميم الأدوات، اختطاف الجلسات، مشاكل الوكيل المربك، وثغرات تمرير الرموز.

تتناول هذه الدرس تنفيذات الأمان المتقدمة بناءً على أحدث مواصفات MCP (2025-06-18)، حلول الأمان من Microsoft، وأنماط الأمان المؤسسية المعتمدة.

### **مبادئ الأمان الأساسية**

**من مواصفات MCP (2025-06-18):**

- **الحظر الصريح**: يجب على خوادم MCP **عدم قبول** الرموز التي لم تصدر لها، و**عدم استخدام** الجلسات للمصادقة.
- **التحقق الإجباري**: يجب التحقق من جميع الطلبات الواردة، ويجب الحصول على موافقة المستخدم لعمليات الوكيل.
- **الإعدادات الافتراضية الآمنة**: تنفيذ ضوابط أمان آمنة مع نهج الدفاع المتعدد الطبقات.
- **تحكم المستخدم**: يجب أن يقدم المستخدمون موافقة صريحة قبل الوصول إلى البيانات أو تنفيذ الأدوات.

## أهداف التعلم

بحلول نهاية هذا الدرس المتقدم، ستكون قادرًا على:

- **تنفيذ المصادقة المتقدمة**: دمج مزود هوية خارجي باستخدام Microsoft Entra ID وأنماط أمان OAuth 2.1.
- **منع الهجمات الخاصة بالذكاء الاصطناعي**: الحماية من حقن التعليمات، تسميم الأدوات، واختطاف الجلسات باستخدام Microsoft Prompt Shields وAzure Content Safety.
- **تطبيق أمان المؤسسات**: تنفيذ تسجيل شامل، مراقبة، واستجابة للحوادث لنشر MCP في بيئات الإنتاج.
- **تأمين تنفيذ الأدوات**: تصميم بيئات تنفيذ معزولة مع ضوابط مناسبة للعزل والتحكم في الموارد.
- **معالجة ثغرات MCP**: تحديد ومعالجة مشاكل الوكيل المربك، ثغرات تمرير الرموز، ومخاطر سلسلة التوريد.
- **دمج أمان Microsoft**: الاستفادة من خدمات أمان Azure وGitHub Advanced Security للحماية الشاملة.

## **متطلبات الأمان الإلزامية**

### **المتطلبات الحرجة من مواصفات MCP (2025-06-18):**
...
تستفيد تطبيقات MCP الحديثة من تطور المواصفات نحو تفويض مزود هوية خارجي، مما يحسن بشكل كبير من وضع الأمان مقارنة بتنفيذات المصادقة المخصصة.

### **دمج Microsoft Entra ID**

تسمح مواصفات MCP الحالية (2025-06-18) بالتفويض لمزودي الهوية الخارجيين مثل Microsoft Entra ID، مما يوفر ميزات أمان على مستوى المؤسسات:

**فوائد الأمان:**
- مصادقة متعددة العوامل (MFA) على مستوى المؤسسات.
- سياسات الوصول المشروط بناءً على تقييم المخاطر.
- إدارة دورة حياة الهوية المركزية.
- حماية متقدمة من التهديدات واكتشاف الشذوذ.
- الامتثال لمعايير أمان المؤسسات.

### تنفيذ .NET مع Entra ID

تنفيذ محسّن يستفيد من نظام أمان Microsoft:
...
### Java Spring Security مع دمج OAuth 2.1

تنفيذ Spring Security المحسن وفقًا لأنماط أمان OAuth 2.1 المطلوبة بموجب مواصفات MCP:
...
## ضوابط الأمان الخاصة بالذكاء الاصطناعي وحلول Microsoft

### **الدفاع ضد حقن التعليمات باستخدام Microsoft Prompt Shields**
...
### **1. منع هجمات الوكيل المربك**

**تنفيذ محسّن وفقًا لمواصفات MCP (2025-06-18):**
...
### **قائمة التحقق للتنفيذ الحرج**

المصادقة والتفويض:
  دمج مزود هوية خارجي (Microsoft Entra ID)
...
دمج المؤسسات:
  ...
  دمج Microsoft Defender for DevOps

المراقبة والاستجابة:
  تسجيل شامل لأحداث الأمان
  اكتشاف التهديدات في الوقت الفعلي
  استجابة تلقائية للحوادث
  تنبيه قائم على المخاطر

### **فوائد نظام أمان Microsoft**

- **وضع أمان متكامل**: أمان موحد عبر الهوية، البنية التحتية، والتطبيقات.
...
- **ذكاء التهديدات**: دمج عالمي لذكاء التهديدات للحماية الاستباقية.
- **هيكلية قابلة للتوسع**: توسع على مستوى المؤسسات مع الحفاظ على ضوابط الأمان.
...
> **ملاحظة أمان**: يعكس هذا الدليل المتقدم متطلبات مواصفات MCP الحالية (2025-06-18). تحقق دائمًا من أحدث الوثائق الرسمية واعتبر متطلبات الأمان المحددة ونموذج التهديد الخاص بك عند تنفيذ هذه الضوابط.

## الخطوة التالية

- [5.9 البحث عبر الويب](../web-search-mcp/README.md)
