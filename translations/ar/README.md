...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-01T09:26:07+00:00",
...
3. [**انضم إلى خادم Azure AI Foundry على Discord وتواصل مع الخبراء والمطورين الآخرين**](https://discord.com/invite/ByRwuEEgH4)
...
## **تعلم MCP من خلال أمثلة عملية بالبرمجة بلغة C#، Java، JavaScript، Python، وTypeScript**

## 🧠 نظرة عامة على منهج بروتوكول سياق النموذج

بروتوكول سياق النموذج (MCP) هو إطار عمل متطور يهدف إلى توحيد التفاعلات بين نماذج الذكاء الاصطناعي وتطبيقات العملاء. يقدم هذا المنهج المفتوح المصدر مسار تعلم منظم، مع أمثلة برمجية عملية وحالات استخدام حقيقية، عبر لغات البرمجة الشهيرة مثل C#، Java، JavaScript، TypeScript، وPython.
...
### بناء ونشر أول خادم وعميل MCP والتدريب العملي والسيناريوهات  
<details>
...
- **3.4. استخدام خادم عبر Visual Studio Code** – [الدليل](./03-GettingStarted/04-vscode/README.md)
...
### تطبيقات عملية ومحتوى متقدم في بروتوكول سياق النموذج  
<details>
...
<details>
  <summary><strong> الدروس 6-9: المجتمع، أفضل الممارسات والتدريبات</strong></summary>
...
## مشاريع نموذجية لبروتوكول سياق النموذج: بناء مشروع آلة حاسبة MCP بلغة Java و C# و JavaScript و TypeScript و Python

### 🧮 مشاريع نموذجية لآلة حاسبة MCP بلغة Java و C# و JavaScript و TypeScript و Python
<details>
...
### 💡 حل متقدم لمثال MCP: مشاريع آلة حاسبة بلغة C# و Java و JavaScript و TypeScript و Python
<details>
...
شكر خاص للخبير المعترف به من مايكروسوفت [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) لمساهمته بعينات كود مهمة.
...
اتفاقية ترخيص المساهمين (CLA) التي تُصرح بأن لديك الحق، وأنك تمنحنا بالفعل
...
اعتمد هذا المشروع [مدونة قواعد السلوك لمصدر مايكروسوفت المفتوح](https://opensource.microsoft.com/codeofconduct/).
