...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:18:18+00:00",
...
**بروتوكول سياق النموذج (MCP)** هو إطار عمل متطور يهدف إلى توحيد التفاعلات بين نماذج الذكاء الاصطناعي وتطبيقات العملاء. يقدم هذا المنهج المفتوح المصدر مسارًا تعليميًا منظمًا، يتضمن أمثلة عملية على البرمجة وحالات استخدام واقعية، عبر لغات البرمجة الشهيرة مثل C#، Java، JavaScript، TypeScript، وPython.
...
- 🧑‍💻 [مستودع MCP على GitHub](https://github.com/modelcontextprotocol) – أدوات مفتوحة المصدر وعينات من الأكواد  
...
- موارد إضافية لتعزيز رحلتك التعليمية  
...
استعد ليومين من التعمق التقني، والتواصل المجتمعي، والتعلم العملي في أيام مطوري MCP، وهو حدث افتراضي مخصص لبروتوكول نموذج السياق (MCP) — المعيار الناشئ الذي يربط بين نماذج الذكاء الاصطناعي والأدوات التي تعتمد عليها.  
...
يركز على تمكين المطورين من استخدام MCP في سير عملهم الاحترافي والاحتفاء بالمجتمع الرائع لـ MCP. سنكون برفقة أعضاء المجتمع وشركاء مثل Arcade، Block، Okta، وNeon لاستكشاف كيفية تعاونهم مع Microsoft لتشكيل نظام MCP مفتوح وقابل للتوسيع.  
...
#### [➡️شاهد عند الطلب معسكر MCP التدريبي | الإنجليزية](https://developer.microsoft.com/en-us/reactor/series/s-1568/)  
#### [➡️شاهد عند الطلب معسكر MCP التدريبي | البرتغالية](https://developer.microsoft.com/en-us/reactor/series/S-1566/)  
#### [➡️شاهد عند الطلب معسكر MCP التدريبي | الإسبانية](https://developer.microsoft.com/en-us/reactor/series/S-1567/)  

### لنتعلم MCP مع C# - سلسلة دروس  
لنتعرف على بروتوكول نموذج السياق (MCP)، وهو إطار عمل متطور مصمم لتوحيد التفاعلات بين نماذج الذكاء الاصطناعي وتطبيقات العميل. من خلال هذه الجلسة الصديقة للمبتدئين، سنقدم لك MCP ونرشدك خلال إنشاء أول خادم MCP خاص بك.  
...
شكر خاص لـ Microsoft Valued Professional [شيفام جويال](https://www.linkedin.com/in/shivam2003/) على مساهمته بعينات كود مهمة.  
...
يرحب هذا المشروع بالمساهمات والاقتراحات. تتطلب معظم المساهمات منك الموافقة على  
اتفاقية ترخيص المساهم (CLA) التي تعلن أنك تمتلك الحق في، وتقوم فعليًا، بمنحنا  
...
CLA ويزين طلب السحب بشكل مناسب (مثل فحص الحالة، التعليق). ما عليك سوى اتباع التعليمات  
المقدمة من الروبوت. ستحتاج إلى القيام بذلك مرة واحدة فقط عبر جميع المستودعات التي تستخدم CLA الخاص بنا.  

لقد تبنى هذا المشروع [مدونة قواعد السلوك مفتوحة المصدر من Microsoft](https://opensource.microsoft.com/codeofconduct/).  
...
قد يحتوي هذا المشروع على علامات تجارية أو شعارات لمشاريع أو منتجات أو خدمات. الاستخدام المصرح به  
لعلامات Microsoft التجارية أو الشعارات يخضع ويجب أن يتبع  
