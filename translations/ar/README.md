...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T23:30:30+00:00",
...
استعد ليومين من الغوص العميق في التقنية، التواصل المجتمعي، والتعلم العملي في MCP Dev Days، الحدث الافتراضي المخصص لبروتوكول سياق النموذج (MCP) — المعيار الناشئ الذي يربط بين نماذج الذكاء الاصطناعي والأدوات التي تعتمد عليها.
...
- تطوير مدفوع بالمطالبات (Prompt-driven development)
- أفضل ممارسات الأمان
...
| 3.2 | أول عميل | طور عميل MCP أساسي | [الدليل](./03-GettingStarted/02-client/README.md) |
...
### 💻 مشاريع عينات الشيفرة

#### عينات حاسبة MCP الأساسية

| اللغة | الوصف | الرابط |
|----------|-------------|------|
| C# | مثال خادم MCP | [عرض الشيفرة](./03-GettingStarted/samples/csharp/README.md) |
| Java | حاسبة MCP | [عرض الشيفرة](./03-GettingStarted/samples/java/calculator/README.md) |
| JavaScript | عرض توضيحي لـ MCP | [عرض الشيفرة](./03-GettingStarted/samples/javascript/README.md) |
| Python | خادم MCP | [عرض الشيفرة](../../03-GettingStarted/samples/python/mcp_calculator_server.py) |
| TypeScript | مثال MCP | [عرض الشيفرة](./03-GettingStarted/samples/typescript/README.md) |

#### تطبيقات MCP المتقدمة

| اللغة | الوصف | الرابط |
|----------|-------------|------|
| C# | عينة متقدمة | [عرض الشيفرة](./04-PracticalImplementation/samples/csharp/README.md) |
| Java | مثال تطبيق الحاوية | [عرض الشيفرة](./04-PracticalImplementation/samples/java/containerapp/README.md) |
| JavaScript | عينة متقدمة | [عرض الشيفرة](./04-PracticalImplementation/samples/javascript/README.md) |
| Python | تطبيق معقد | [عرض الشيفرة](../../04-PracticalImplementation/samples/python/mcp_sample.py) |
| TypeScript | عينة الحاوية | [عرض الشيفرة](./04-PracticalImplementation/samples/typescript/README.md) |
...
- المشاركة في مناقشات المجتمع للحصول على الدعم  
...
- إرشادات حول كيفية استخدام مشاريع العينات  
- مسارات تعلم موصى بها لمستويات مهارة مختلفة  
- موارد إضافية تكمل رحلة تعلمك  

### سجل التغييرات

نحتفظ بسجل [التغييرات](./changelog.md) المفصل الذي يتتبع جميع التحديثات المهمة لمواد المنهج، بما في ذلك:
...
شكر خاص للخبير المعتمد من مايكروسوفت [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) لمساهمته بعينات شيفرة مهمة.
...
- **المنهج الأساسي (00-10)**: المحتوى الرئيسي منظم في عشر وحدات متتالية  
...
- **alternative_layouts/**: تنسيقات عرض مختلفة لمحتوى المنهج  
