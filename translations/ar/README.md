...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-23T05:53:15+00:00",
...
يُعد **بروتوكول سياق النموذج (MCP)** إطار عمل متطور يهدف إلى توحيد التفاعلات بين نماذج الذكاء الاصطناعي وتطبيقات العملاء. يوفر هذا المنهج مفتوح المصدر مسار تعلم منظم، مع أمثلة برمجية عملية وحالات استخدام واقعية، عبر لغات البرمجة الشهيرة مثل C#، Java، JavaScript، TypeScript، وPython.

سواء كنت مطور ذكاء اصطناعي، مهندس نظم، أو مهندس برمجيات، فإن هذا الدليل هو موردك الشامل لإتقان أساسيات MCP واستراتيجيات تنفيذه.
...
- 🧑‍💻 [مستودع MCP على GitHub](https://github.com/modelcontextprotocol) – مجموعات تطوير البرمجيات مفتوحة المصدر، الأدوات، وأمثلة الشيفرة  

## 🧭 هيكل منهج MCP الكامل

| الفصل | العنوان | الوصف | الرابط |
|--|--|--|--|
| 00 | **مقدمة في MCP** | نظرة عامة على بروتوكول سياق النموذج وأهميته في خطوط أنابيب الذكاء الاصطناعي، بما في ذلك ماهية MCP، سبب أهمية التوحيد، وحالات الاستخدام والفوائد العملية | [مقدمة](./00-Introduction/README.md) |
...
| 04 | **التنفيذ العملي** | استخدام مجموعات تطوير البرمجيات عبر لغات مختلفة، التصحيح، الاختبار، والتحقق، صياغة قوالب مطالبات قابلة لإعادة الاستخدام وسير العمل | [التنفيذ العملي](./04-PracticalImplementation/README.md) |
...
| 06 | **مساهمات المجتمع** | كيفية المساهمة بالشيفرة والوثائق، التعاون عبر GitHub، التحسينات والتعليقات المدفوعة من المجتمع | [مساهمات المجتمع](./06-CommunityContributions/README.md) |
| 07 | **دروس من الاعتماد المبكر** | تطبيقات واقعية وما نجح منها، بناء ونشر حلول تعتمد على MCP، الاتجاهات وخارطة الطريق المستقبلية | [الدروس](./07-LessonsFromEarlyAdoption/README.md) |
...
| 09 | **دراسات حالة MCP** | تحليل معمق لهياكل حلول MCP، مخططات النشر ونصائح التكامل، مخططات مشروحة وجولات في المشاريع | [دراسات الحالة](./09-CaseStudy/README.md) |

## مشاريع نموذجية

### 🧮 مشاريع عينة لحاسبة MCP:
<details>
  <summary><strong>استكشاف تنفيذات الشيفرة حسب اللغة</strong></summary>
...
2. أمثلة حية على الشيفرة بعدة لغات  
...
اتفاقية ترخيص المساهم (CLA) التي تؤكد أن لديك الحق، وأنك بالفعل تمنحنا
...
يجب ألا يتسبب استخدام علامات أو شعارات مايكروسوفت في نسخ معدلة من هذا المشروع في حدوث ارتباك أو يوحي برعاية مايكروسوفت.
