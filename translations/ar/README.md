...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T19:42:47+00:00",
...
## **تعلم MCP من خلال أمثلة عملية بلغة C#، Java، JavaScript، Rust، Python، وTypeScript**
...
| 00 | مقدمة عن MCP | نظرة عامة على بروتوكول سياق النموذج وأهميته في خطوط الذكاء الاصطناعي | [اقرأ المزيد](./00-Introduction/README.md) |
...
| 3.5 | خادم stdio | إنشاء خوادم باستخدام stdio transport | [دليل](./03-GettingStarted/05-stdio-server/README.md) |
...
| 5.10 | البث في الوقت الحقيقي | بناء وظيفة البث في الوقت الحقيقي | [دليل](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
...
- خريطة منهجية مرئية تعرض جميع المواضيع المغطاة  
- تحليل تفصيلي لكل قسم في المستودع  
- إرشادات حول كيفية استخدام المشاريع النموذجية  
- مسارات تعليمية موصى بها لمستويات المهارة المختلفة  
- موارد إضافية لتعزيز رحلة التعلم الخاصة بك  
...
### [أيام MCP Dev يوليو 2025](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
#### [➡️مشاهدة عند الطلب - أيام MCP Dev](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
استعد ليومين من الرؤى التقنية العميقة، التواصل المجتمعي، والتعلم العملي في أيام MCP Dev، وهو حدث افتراضي مخصص لبروتوكول سياق النموذج (MCP) — المعيار الناشئ الذي يربط بين نماذج الذكاء الاصطناعي والأدوات التي تعتمد عليها.  
يمكنك مشاهدة أيام MCP Dev من خلال التسجيل في صفحة الحدث الخاصة بنا: https://aka.ms/mcpdevdays.  

#### [اليوم الأول: إنتاجية MCP، أدوات التطوير، والمجتمع:](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

يركز على تمكين المطورين من استخدام MCP في سير عملهم الاحترافي والاحتفاء بالمجتمع الرائع لـ MCP. سنكون برفقة أعضاء المجتمع وشركاء مثل Arcade، Block، Okta، وNeon لرؤية كيف يتعاونون مع Microsoft لتشكيل نظام MCP مفتوح وقابل للتوسيع.  
...
سواء كنت مبتدئًا في MCP أو تعمل بالفعل على بنائه، فإن اليوم الأول سيضع الأساس للإلهام والنصائح العملية.  
...
لنتعلم عن بروتوكول سياق النموذج (MCP)، وهو إطار عمل متقدم مصمم لتوحيد التفاعلات بين نماذج الذكاء الاصطناعي وتطبيقات العميل. من خلال هذه الجلسة المناسبة للمبتدئين، سنقدم لك MCP ونرشدك خلال إنشاء أول خادم MCP.  
...
CLA وتزيين الطلب بشكل مناسب (مثل فحص الحالة، التعليق). ما عليك سوى اتباع التعليمات  
...
- **images/**: الرسوم البيانية والرسوم التوضيحية المستخدمة في المنهج  
...
[إرشادات العلامة التجارية من Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
