...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T18:26:11+00:00",
...
**بروتوكول سياق النموذج (MCP)** هو إطار عمل متطور يهدف إلى توحيد التفاعلات بين نماذج الذكاء الاصطناعي وتطبيقات العملاء. يقدم هذا المنهج المفتوح المصدر مسارًا تعليميًا منظمًا، يتضمن أمثلة عملية على البرمجة وحالات استخدام واقعية، عبر لغات برمجة شائعة مثل C#، Java، JavaScript، TypeScript، وPython.
...
- خريطة منهج مرئية تعرض جميع المواضيع المغطاة  
...
يركز على تمكين المطورين من استخدام MCP في سير عملهم الاحترافي والاحتفاء بمجتمع MCP الرائع. سنكون برفقة أعضاء المجتمع وشركاء مثل Arcade، Block، Okta، وNeon لرؤية كيف يتعاونون مع Microsoft لتشكيل نظام MCP مفتوح وقابل للتوسيع.  
...
### دعونا نتعلم MCP مع C# - سلسلة تعليمية
دعونا نتعلم عن بروتوكول سياق النموذج (MCP)، وهو إطار عمل متقدم مصمم لتوحيد التفاعلات بين نماذج الذكاء الاصطناعي وتطبيقات العميل. من خلال هذه الجلسة المناسبة للمبتدئين، سنقدم لك MCP ونرشدك خلال إنشاء أول خادم MCP.  
...
CLA ويزين طلب السحب بشكل مناسب (مثل فحص الحالة، تعليق). ما عليك سوى اتباع التعليمات  
