...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T07:03:32+00:00",
...
| 10 | ورشة عمل عملية | بناء خادم MCP باستخدام أدوات الذكاء الاصطناعي | [المعمل](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
| **الوحدة 11: معمل عملي لخادم MCP** | | | |
| 11 | تكامل قاعدة بيانات خادم MCP | مسار تعليمي عملي شامل من 13 معمل لتكامل PostgreSQL | [المعامل](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | المقدمة | نظرة عامة على MCP مع تكامل قاعدة البيانات وحالة استخدام تحليلات البيع بالتجزئة | [المعمل 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
| 11.2 | الهيكل الأساسي | فهم هيكل خادم MCP، طبقات قاعدة البيانات، وأنماط الأمان | [المعمل 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
| 11.3 | الأمن وتعدد المستأجرين | أمان على مستوى الصفوف، المصادقة، والوصول إلى بيانات متعددة المستأجرين | [المختبر 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.8 | البحث الدلالي | تنفيذ تضمينات المتجه باستخدام Azure OpenAI و pgvector | [المختبر 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
...
يتضمن هذا المستودع العديد من الموارد لمساعدتك على التعلم بفعالية:

### دليل الدراسة

يتوفر [دليل دراسة شامل](./study_guide.md) لمساعدتك على التنقل في هذا المستودع بفعالية. يتضمن الدليل:

- خريطة مرئية للمنهج تعرض جميع الموضوعات المشمولة
...
يركز على تمكين المطورين من استخدام MCP في سير عملهم الاحترافي والاحتفاء بمجتمع MCP الرائع. سنكون برفقة أعضاء المجتمع وشركاء مثل Arcade، Block، Okta، و Neon لنرى كيف يتعاونون مع Microsoft لتشكيل نظام MCP مفتوح وقابل للتوسيع.  
عروض حية عبر VS Code، Visual Studio، GitHub Copilot، وأدوات المجتمع الشهيرة  
تدفقات عمل عملية موجهة بالسياق  
جلسات ورؤى يقودها المجتمع  
سواء كنت مبتدئًا في MCP أو تعمل بالفعل معه، سيضع اليوم الأول الأساس للإلهام والنصائح العملية.
...
- استخدام اللبنات الأساسية مثل Functions، ACA، و API Management
...
#### [➡️مشاهدة عند الطلب معسكر تدريب MCP | الإنجليزية](https://developer.microsoft.com/en-us/reactor/series/s-1568/)
#### [➡️مشاهدة عند الطلب معسكر تدريب MCP | البرتغالية](https://developer.microsoft.com/en-us/reactor/series/S-1566/)
#### [➡️مشاهدة عند الطلب معسكر تدريب MCP | الإسبانية](https://developer.microsoft.com/en-us/reactor/series/S-1567/)
...
شكرًا للمحترف المقدر من Microsoft [شيفام جويال](https://www.linkedin.com/in/shivam2003/) على مساهمته في نماذج الكود المهمة.
...
الحقوق لاستخدام مساهمتك. للحصول على التفاصيل، قم بزيارة <https://cla.opensource.microsoft.com>.

عندما تقدم طلب سحب، سيحدد روبوت CLA تلقائيًا ما إذا كنت بحاجة إلى تقديم
