...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-14T17:14:54+00:00",
...
2. Εκτελέστε αυτή την εντολή [azd](https://aka.ms/azd) για να προμηθευτείτε την υπηρεσία διαχείρισης API, την εφαρμογή λειτουργιών (με κώδικα) και όλους τους άλλους απαραίτητους πόρους Azure
