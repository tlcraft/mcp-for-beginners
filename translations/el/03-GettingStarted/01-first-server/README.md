...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-02T17:33:41+00:00",
...
Το inspector είναι ένα εξαιρετικό εργαλείο που μπορεί να ξεκινήσει τον διακομιστή σας και σας επιτρέπει να αλληλεπιδράσετε με αυτόν ώστε να δοκιμάσετε ότι λειτουργεί. Ας το ξεκινήσουμε:
...
- Η ρύθμιση περιβάλλοντος ανάπτυξης MCP είναι απλή με τα γλωσσικά SDKs
- Η κατασκευή MCP servers περιλαμβάνει τη δημιουργία και καταχώρηση εργαλείων με σαφή σχήματα
...
3. Εκτελέστε το εργαλείο inspector για να βεβαιωθείτε ότι ο διακομιστής λειτουργεί όπως αναμένεται.
