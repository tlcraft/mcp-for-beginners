...
- Ρυθμίσει το στιγμιότυπο του LLM μας να χρησιμοποιεί GitHub Models ορίζοντας το `baseUrl` ώστε να δείχνει στο inference API.
...
- **Δημιουργήσει ένα `ChatLanguageModel`**: Ρυθμισμένο να χρησιμοποιεί GitHub Models με το GitHub token σας
...
- Εμφανίσει τα διαθέσιμα εργαλεία στον MCP Server
- Για κάθε εργαλείο, εμφανίσει το όνομα, την περιγραφή και το σχήμα του. Το τελευταίο θα το χρησιμοποιήσουμε για να καλέσουμε τα εργαλεία σύντομα.
...
Το επόμενο βήμα μετά την καταγραφή των δυνατοτήτων του διακομιστή είναι να τις μετατρέψουμε σε μορφή που καταλαβαίνει το LLM. Μόλις το κάνουμε αυτό, μπορούμε να παρέχουμε αυτές τις δυνατότητες ως εργαλεία στο LLM μας.
...
1. Προσθέστε τον παρακάτω κώδικα για να μετατρέψετε την απάντηση από τον MCP Server σε μορφή εργαλείου που μπορεί να χρησιμοποιήσει το LLM:
    ...
    Ο παραπάνω κώδικας παίρνει μια απάντηση από τον MCP Server και την μετατρέπει σε ορισμό εργαλείου που καταλαβαίνει το LLM.
...
- Ορίσει λειτουργικότητα που δημιουργεί ένα `FunctionDefinition` που περνάει σε `ChatCompletionsDefinition`. Το τελευταίο είναι κάτι που καταλαβαίνει το LLM.
...
1. Ας δούμε πώς μπορούμε να ενημερώσουμε υπάρχοντα κώδικα για να εκμεταλλευτούμε αυτή τη συνάρτηση:
    ...
    - Ενημερώσει τη συνάρτηση για να μετατρέπει την απάντηση εργαλείου MCP σε εργαλείο LLM. Ας επισημάνουμε τον κώδικα που προσθέσαμε:
        ...
        Το σχήμα εισόδου είναι μέρος της απάντησης εργαλείου αλλά στο χαρακτηριστικό "properties", οπότε πρέπει να το εξάγουμε. Επιπλέον, τώρα καλούμε το `ConvertFrom` με τις λεπτομέρειες του εργαλείου. Τώρα που έχουμε κάνει το βασικό έργο, ας δούμε πώς συνδυάζεται η κλήση καθώς διαχειριζόμαστε ένα prompt χρήστη στη συνέχεια.
