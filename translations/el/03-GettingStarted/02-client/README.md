...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T05:46:48+00:00",
...
Οι πελάτες είναι προσαρμοσμένες εφαρμογές ή σενάρια που επικοινωνούν απευθείας με έναν MCP Server για να ζητήσουν πόρους, εργαλεία και προτροπές. Σε αντίθεση με τη χρήση του εργαλείου επιθεώρησης, που παρέχει γραφικό περιβάλλον για αλληλεπίδραση με τον διακομιστή, η δημιουργία του δικού σας πελάτη επιτρέπει προγραμματιστική και αυτοματοποιημένη αλληλεπίδραση. Αυτό δίνει τη δυνατότητα στους προγραμματιστές να ενσωματώσουν τις δυνατότητες του MCP στις δικές τους ροές εργασίας, να αυτοματοποιήσουν εργασίες και να δημιουργήσουν προσαρμοσμένες λύσεις που ανταποκρίνονται σε συγκεκριμένες ανάγκες.
...
- Συνδεθείτε και δοκιμάσετε τον πελάτη με έναν MCP server για να βεβαιωθείτε ότι λειτουργεί όπως αναμένεται.
...
- **Απόφαση για το ποιοι πόροι θα εμφανιστούν**. Ο MCP server σας διαθέτει πόρους, εργαλεία και προτροπές, πρέπει να αποφασίσετε ποια από αυτά θα εμφανίσετε.
...
- Δημιουργήσει μια παρουσία μεταφοράς stdio. Σημειώστε πώς καθορίζει την εντολή και τα ορίσματα για το πώς να βρει και να ξεκινήσει τον διακομιστή, καθώς αυτό είναι κάτι που θα χρειαστεί να κάνουμε καθώς δημιουργούμε τον πελάτη.
...
- Εισάγει τις απαραίτητες βιβλιοθήκες.
- Δημιουργήσει μια μεταφορά stdio και έναν πελάτη `mcpClient`. Αυτό θα το χρησιμοποιήσουμε για να εμφανίσουμε και να καλέσουμε λειτουργίες στον MCP Server.
...
- Δημιουργήσει μια μέθοδο main που ρυθμίζει μια μεταφορά SSE που δείχνει στο `http://localhost:8080` όπου θα τρέχει ο MCP server μας.
...
- Παίρνουμε μια προτροπή, για να πάρουμε μια προτροπή, καλούμε `getPrompt()` με `name` και `arguments`. Ο κώδικας του διακομιστή φαίνεται έτσι:
    ...
    και ο αντίστοιχος κώδικας πελάτη φαίνεται έτσι για να ταιριάζει με όσα δηλώνονται στον διακομιστή:
...
Σε αυτή την ανάθεση, θα χρησιμοποιήσετε όσα μάθατε για να δημιουργήσετε έναν πελάτη δικό σας.

Εδώ είναι ένας διακομιστής που μπορείτε να χρησιμοποιήσετε και πρέπει να καλέσετε μέσω του κώδικα του πελάτη σας. Δοκιμάστε να προσθέσετε περισσότερες λειτουργίες στον διακομιστή για να τον κάνετε πιο ενδιαφέροντα.
...
Τα κύρια σημεία αυτού του κεφαλαίου σχετικά με τους πελάτες είναι τα εξής:

- Μπορούν να χρησιμοποιηθούν τόσο για την ανακάλυψη όσο και για την κλήση λειτουργιών στον διακομιστή.
- Μπορούν να ξεκινήσουν έναν διακομιστή ενώ ξεκινούν και οι ίδιοι (όπως σε αυτό το κεφάλαιο), αλλά οι πελάτες μπορούν επίσης να συνδεθούν σε ήδη τρέχοντες διακομιστές.
- Αποτελούν έναν εξαιρετικό τρόπο για να δοκιμάσετε τις δυνατότητες του διακομιστή σε σύγκριση με εναλλακτικές όπως το Inspector, όπως περιγράφηκε στο προηγούμενο κεφάλαιο.
