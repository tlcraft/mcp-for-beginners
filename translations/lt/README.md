...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:07:17+00:00",
...
1. **Fork Repository**: Spustelėkite [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
2. **Klonuokite Repository**:   `git clone https://github.com/microsoft/mcp-for-beginners.git`
...
# 🚀 Model Context Protocol (MCP) mokymo programa pradedantiesiems

## **Išmokite MCP su praktiniais kodavimo pavyzdžiais C#, Java, JavaScript, Rust, Python ir TypeScript**

## 🧠 Model Context Protocol mokymo programos apžvalga

**Model Context Protocol (MCP)** yra pažangus pagrindas, skirtas standartizuoti sąveiką tarp AI modelių ir klientų programų. Ši atvirojo kodo mokymo programa siūlo struktūrizuotą mokymosi kelią su praktiniais kodavimo pavyzdžiais ir realaus pasaulio naudojimo atvejais, naudojant populiarias programavimo kalbas, tokias kaip C#, Java, JavaScript, TypeScript ir Python.
...
- 🧑‍💻 [MCP GitHub Repository](https://github.com/modelcontextprotocol) – Atvirojo kodo SDK, įrankiai ir kodų pavyzdžiai
...
| **4-5 moduliai: Praktiniai ir pažangūs** | | | |
...
## 🎯 Mokymosi MCP reikalavimai

Norint maksimaliai pasinaudoti šia mokymo programa, rekomenduojama turėti:
...
- Papildomus išteklius, kurie praturtins jūsų mokymosi kelionę

### Pakeitimų žurnalas

Mes palaikome išsamų [Pakeitimų žurnalą](./changelog.md), kuriame fiksuojami visi svarbūs mokymo medžiagos atnaujinimai, įskaitant:
...
Skirta padėti kūrėjams naudoti MCP savo darbo eigoje ir švęsti nuostabią MCP bendruomenę. Prisijungsime prie bendruomenės narių ir partnerių, tokių kaip Arcade, Block, Okta ir Neon, kad pamatytume, kaip jie bendradarbiauja su Microsoft, formuodami atvirą, išplečiamą MCP ekosistemą. 
Realių pavyzdžių demonstracijos su VS Code, Visual Studio, GitHub Copilot ir populiariais bendruomenės įrankiais
Praktiški, konteksto pagrindu sukurti kūrimo darbo srautai
...
Jei esate kūrėjas, įrankių kūrėjas ar AI produktų strategas, ši diena suteiks jums įžvalgų, reikalingų kurti mastelio, saugius ir ateities MCP sprendimus.
...
CLA ir pažymės PR atitinkamai (pvz., statuso patikrinimas, komentaras). Tiesiog vykdykite bot pateiktas instrukcijas.
Tai reikės padaryti tik vieną kartą visose saugyklose, naudojančiose mūsų CLA.
...
- **changelog.md**: Visų svarbių mokymo medžiagos pakeitimų įrašai
