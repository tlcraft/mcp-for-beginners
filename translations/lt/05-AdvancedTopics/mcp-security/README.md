...
Saugumas yra itin svarbus MCP įgyvendinimui, ypač verslo aplinkoje. Šiame pažangiame vadove nagrinėjamos išsamios saugumo praktikos, skirtos MCP diegimui gamyboje, apimant tiek tradicinius saugumo klausimus, tiek AI specifines grėsmes, būdingas Model Context Protocol.

## Įvadas

Model Context Protocol (MCP) kelia unikalius saugumo iššūkius, kurie peržengia tradicinio programinės įrangos saugumo ribas. Kadangi AI sistemos gauna prieigą prie įrankių, duomenų ir išorinių paslaugų, atsiranda nauji atakų vektoriai, tokie kaip komandų injekcija, įrankių užnuodijimas, sesijos užgrobimas, klaidingo tarpininko problemos ir žetonų perdavimo pažeidžiamumai.

Ši pamoka nagrinėja pažangius saugumo įgyvendinimus, remiantis naujausia MCP specifikacija (2025-06-18), „Microsoft“ saugumo sprendimais ir įsitvirtinusiais verslo saugumo modeliais.

### **Pagrindiniai saugumo principai**

**Pagal MCP specifikaciją (2025-06-18):**

- **Aiškūs draudimai**: MCP serveriai **NETURI** priimti žetonų, kurie nėra jiems išduoti, ir **NETURI** naudoti sesijų autentifikacijai
- **Privalomas patikrinimas**: Visi gaunami užklausos **PRIVALOMAI** turi būti patikrintos, o vartotojo sutikimas **PRIVALOMAI** turi būti gautas tarpininkavimo operacijoms
- **Saugūs numatytieji nustatymai**: Įgyvendinkite saugumo kontrolę, kuri užtikrina saugumą net ir gedimo atveju, taikant gynybos sluoksnių metodą
- **Vartotojo kontrolė**: Vartotojai turi aiškiai sutikti prieš bet kokį duomenų pasiekimą ar įrankių vykdymą

## Mokymosi tikslai

Šios pažangios pamokos pabaigoje galėsite:

- **Įgyvendinti pažangų autentifikavimą**: Diegti išorinių tapatybės tiekėjų integraciją su „Microsoft Entra ID“ ir OAuth 2.1 saugumo modeliais
- **Užkirsti kelią AI specifinėms atakoms**: Apsaugoti nuo komandų injekcijos, įrankių užnuodijimo ir sesijos užgrobimo naudojant „Microsoft Prompt Shields“ ir „Azure Content Safety“
- **Taikyti verslo saugumą**: Įgyvendinti išsamų žurnalų vedimą, stebėjimą ir incidentų valdymą MCP diegimui gamyboje  
- **Užtikrinti saugų įrankių vykdymą**: Projektuoti izoliuotas vykdymo aplinkas su tinkama izoliacija ir išteklių kontrolėmis
- **Spręsti MCP pažeidžiamumus**: Nustatyti ir sumažinti klaidingo tarpininko problemas, žetonų perdavimo pažeidžiamumus ir tiekimo grandinės rizikas
...
### **Kritiniai reikalavimai pagal MCP specifikaciją (2025-06-18):**
...
Šiuolaikiniai MCP įgyvendinimai naudoja specifikacijos evoliuciją link išorinių tapatybės tiekėjų delegavimo, žymiai pagerindami saugumo lygį, palyginti su individualiais autentifikavimo sprendimais.

### **„Microsoft Entra ID“ integracija**

Dabartinė MCP specifikacija (2025-06-18) leidžia deleguoti išoriniams tapatybės tiekėjams, tokiems kaip „Microsoft Entra ID“, suteikiant verslo lygio saugumo funkcijas:

**Saugumo privalumai:**
- Verslo lygio daugiafaktorinis autentifikavimas (MFA)
...
- Atitiktis verslo saugumo standartams

### .NET įgyvendinimas su „Entra ID“

Patobulintas įgyvendinimas, pasinaudojant „Microsoft“ saugumo ekosistema:
...
Patobulintas „Spring Security“ įgyvendinimas, laikantis OAuth 2.1 saugumo modelių, reikalaujamų MCP specifikacijoje:
...
## AI specifinės saugumo kontrolės ir „Microsoft“ sprendimai

### **Komandų injekcijos apsauga su „Microsoft Prompt Shields“**

Šiuolaikiniai MCP įgyvendinimai susiduria su sudėtingomis AI specifinėmis atakomis, reikalaujančiomis specializuotų apsaugos priemonių:
...
## Pažangi MCP saugumo grėsmių mažinimo strategija

### **1. Klaidingo tarpininko atakų prevencija**

**Patobulintas įgyvendinimas pagal MCP specifikaciją (2025-06-18):**
...
### **3. Sesijos užgrobimo prevencija**

**Pažangi sesijos sauga:**
...
## Verslo saugumo integracija ir stebėjimas

### **Išsamus žurnalų vedimas su „Azure Application Insights“**
...
## Geriausių praktikų santrauka ir verslo gairės

### **Kritinis įgyvendinimo kontrolinis sąrašas**

Autentifikavimas ir autorizacija:
  Išorinių tapatybės tiekėjų integracija („Microsoft Entra ID“)
  Žetonų auditorijos patikrinimas (PRIVALOMA)
  Jokio sesijomis pagrįsto autentifikavimo
...
AI saugumo kontrolės:
  ...
  Išvesties turinio patikrinimas
  
Sesijos saugumas:
  Kriptografiškai saugūs sesijos ID
  Vartotojui specifinis sesijos susiejimas
  Sesijos užgrobimo aptikimas
  HTTPS transporto užtikrinimas
  
OAuth ir tarpininko saugumas:
  PKCE įgyvendinimas (OAuth 2.1)
  Aiškus vartotojo sutikimas dinamiškiems klientams
  Griežtas peradresavimo URI patikrinimas
  Jokio žetonų perdavimo (PRIVALOMA)

Verslo integracija:
  „Azure Key Vault“ slaptažodžių valdymui
  „Application Insights“ saugumo stebėjimui
  „GitHub Advanced Security“ tiekimo grandinei
  „Microsoft Defender for DevOps“ integracija

Stebėjimas ir reagavimas:
  Išsamus saugumo įvykių žurnalų vedimas
  Realaus laiko grėsmių aptikimas
  Automatinis incidentų valdymas
  Rizika pagrįstas įspėjimas

### **„Microsoft“ saugumo ekosistemos privalumai**

- **Integruotas saugumo lygis**: Vieningas saugumas tapatybės, infrastruktūros ir programų srityse
- **Pažangi AI apsauga**: Specialiai sukurtos apsaugos priemonės nuo AI specifinių grėsmių  
- **Verslo atitiktis**: Įmontuota parama reguliavimo reikalavimams ir pramonės standartams
- **Grėsmių žvalgyba**: Pasaulinės grėsmių žvalgybos integracija proaktyviai apsaugai
- **Mastelio pritaikymas**: Verslo lygio mastelio pritaikymas išlaikant saugumo kontrolę
...
> **Saugumo pranešimas**: Šis pažangus įgyvendinimo vadovas atspindi dabartinius MCP specifikacijos (2025-06-18) reikalavimus. Visada patikrinkite pagal naujausią oficialią dokumentaciją ir atsižvelkite į savo specifinius saugumo reikalavimus bei grėsmių modelį, įgyvendindami šias kontrolės priemones.

## Kas toliau

- [5.9 Interneto paieška](../web-search-mcp/README.md)
