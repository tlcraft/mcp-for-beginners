...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:05:34+00:00",
...
Šis laboratorinis darbas pateikia išsamias gaires, kaip testuoti ir derinti MCP serverius gamybos aplinkoje. Išmoksite įgyvendinti patikimas testavimo strategijas, spręsti sudėtingas problemas ir užtikrinti, kad MCP serveris veiktų patikimai įvairiomis sąlygomis.

## Apžvalga

MCP serverių testavimas reikalauja daugiapakopio požiūrio, apimančio vienetinius testus, integracijos testus, našumo patikrinimą ir realių scenarijų testavimą. Šis laboratorinis darbas apima visą testavimo ciklą nuo kūrimo iki gamybos stebėjimo.

Mūsų testavimo strategija pabrėžia patikimumą, saugumą ir našumą, užtikrindama, kad MCP serveris galėtų tvarkyti gamybos apkrovas, išlaikydamas duomenų vientisumą ir aukštą naudotojo patirties kokybę.

## Mokymosi tikslai

Baigę šį laboratorinį darbą, galėsite:

- **Įgyvendinti** išsamius vienetinių ir integracijos testų rinkinius
- **Sukurti** veiksmingas testavimo strategijas MCP įrankiams ir duomenų bazės operacijoms
- **Derinti** sudėtingas problemas naudojant pažangias derinimo technikas
- **Patikrinti** našumą esant apkrovai, pasitelkiant realistiškus testavimo scenarijus
- **Stebėti** gamybos sistemas naudojant efektyvų įspėjimų ir stebėjimo mechanizmą
- **Automatizuoti** testavimo procesus nuolatinei integracijai

## 🧪 Testavimo architektūra

### Testavimo strategijos apžvalga
...
Baigę šį laboratorinį darbą, turėtumėte turėti:

✅ **Išsamų testavimo pagrindą**: Vienetinius, integracijos ir našumo testus visiems komponentams  
✅ **Pažangius derinimo įrankius**: Sudėtingus derinimo įrankius su vykdymo sekimu  
✅ **Našumo patikrinimą**: Apkrovos testavimo ir mastelio analizės galimybes  
✅ **Saugumo testavimą**: SQL injekcijų prevenciją ir RLS patikrinimą  
✅ **Stebėjimo integraciją**: Našumo metrikas ir kliūčių analizę  
✅ **CI/CD paruošimą**: Automatizuotus testavimo procesus nuolatinei integracijai  

## 🚀 Kas toliau

Tęskite su **[Laboratorinis darbas 09: VS Code integracija](../09-VS-Code/README.md)**, kad:

- Konfigūruotumėte VS Code MCP serverio kūrimui
- Paruoštumėte derinimo aplinkas VS Code
- Integruotumėte MCP serverį su VS Code Chat
- Ištestuotumėte visą VS Code darbo eigą

## 📚 Papildomi ištekliai

### Testavimo sistemos
- [pytest dokumentacija](https://docs.pytest.org/) - Python testavimo sistema
- [AsyncPG testavimas](https://magicstack.github.io/asyncpg/current/index.html) - Asinchroninis PostgreSQL testavimas
- [FastAPI testavimas](https://fastapi.tiangolo.com/tutorial/testing/) - API testavimo modeliai

### Našumo testavimas
- [Geriausios apkrovos testavimo praktikos](https://docs.python.org/3/library/asyncio.html) - Asinchroninis našumo testavimas
- [Duomenų bazės našumo testavimas](https://www.postgresql.org/docs/current/performance-tips.html) - PostgreSQL optimizavimas
- [Atminties profiliavimas](https://docs.python.org/3/library/tracemalloc.html) - Python atminties analizė

### Derinimo įrankiai
- [Python derinimas](https://docs.python.org/3/library/pdb.html) - Python derinimo įrankis
- [Asinchroninis derinimas](https://docs.python.org/3/library/asyncio-dev.html) - Asyncio derinimas
- [SQL derinimas](https://www.postgresql.org/docs/current/runtime-config-logging.html) - PostgreSQL žurnalų konfigūracija

---

**Ankstesnis**: [Laboratorinis darbas 07: Semantinės paieškos integracija](../07-Semantic-Search/README.md)  
**Kitas**: [Laboratorinis darbas 09: VS Code integracija](../09-VS-Code/README.md)
