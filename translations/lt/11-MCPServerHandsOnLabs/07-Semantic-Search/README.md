...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:38:16+00:00",
...
Šis praktinis darbas pateikia išsamias instrukcijas, kaip įgyvendinti semantinės paieškos funkcijas naudojant Azure OpenAI įterpimus ir PostgreSQL pgvector plėtinį. Išmoksite kurti dirbtinio intelekto pagrindu veikiančią produktų paiešką, kuri supranta natūralios kalbos užklausas ir pateikia aktualius rezultatus pagal semantinį panašumą.

## Apžvalga

Tradicinė paieška pagal raktinius žodžius dažnai nesugeba suprasti vartotojo ketinimų ir semantinės prasmės. Semantinė paieška, naudojant vektorių įterpimus, leidžia natūralios kalbos užklausoms, tokioms kaip „patogūs bėgimo bateliai lietingam orui“, rasti aktualius produktus, net jei šie tikslūs žodžiai neatsiranda produktų aprašymuose.

Mūsų įgyvendinimas sujungia galingus Azure OpenAI įterpimo modelius su PostgreSQL pgvector plėtiniu, kad sukurtų aukštos kokybės, mastelio keičiamą semantinės paieškos sistemą, kuri pagerina mažmeninės prekybos patirtį su išmaniu produktų atradimu.

## Mokymosi tikslai

Baigę šį praktinį darbą, galėsite:

- **Integruoti** Azure OpenAI įterpimo modelius tekstų vektorizavimui
- **Įgyvendinti** pgvector efektyvioms panašumo paieškos operacijoms
- **Kurti** semantinės paieškos įrankius natūralios kalbos produktų užklausoms
- **Sukurti** hibridinę paiešką, derinant tradicinę ir vektorinę paiešką
- **Optimizuoti** vektorių užklausas, kad jos būtų tinkamos gamybai
- **Projektuoti** rekomendacijų sistemas, naudojant įterpimų panašumą

## 🧠 Semantinės paieškos architektūra

### Vektorinės paieškos procesas
...
### Įterpimų generavimo strategija
...
## 🔍 Produktų įterpimų generavimas

### Automatinis įterpimų generavimo procesas
...
## 🔎 Semantinės paieškos įrankiai

### Semantinės produktų paieškos įrankis
...
### Vektorių užklausų optimizavimas
...
✅ **Azure OpenAI integracija**: Pilnas įterpimų generavimas su talpyklomis ir optimizavimu  
✅ **Vektorinės paieškos įgyvendinimas**: Gamybai paruošta semantinė paieška su pgvector  
✅ **Hibridinės paieškos galimybės**: Derinama raktinių žodžių ir semantinė paieška optimaliems rezultatams  
✅ **Rekomendacijų sistemos**: Dirbtinio intelekto pagrindu veikiančios produktų rekomendacijos, naudojant panašumą  
✅ **Našumo optimizavimas**: Vektorių indeksų optimizavimas ir išmanus talpyklų naudojimas  
✅ **Mastelio keičiamas architektūra**: Įmonės lygio semantinės paieškos infrastruktūra  

## 🚀 Kas toliau

Tęskite su **[Laboratorija 08: Testavimas ir derinimas](../08-Testing/README.md)**, kad:

- Įgyvendintumėte išsamias semantinės paieškos testavimo strategijas
- Derintumėte vektorinės paieškos našumo problemas
- Patikrintumėte įterpimų kokybę ir aktualumą
- Testuotumėte rekomendacijų sistemos tikslumą

## 📚 Papildomi ištekliai

### Azure OpenAI
- [Azure OpenAI paslaugos dokumentacija](https://docs.microsoft.com/azure/cognitive-services/openai/) - Išsamus paslaugos vadovas
- [Įterpimų API nuoroda](https://platform.openai.com/docs/api-reference/embeddings) - API dokumentacija
- [Geriausios praktikos įterpimams](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Įgyvendinimo gairės

### Vektorinės duomenų bazės
- [pgvector dokumentacija](https://github.com/pgvector/pgvector) - PostgreSQL vektorinės plėtinys
- [Vektorinės paieškos optimizavimas](https://www.pinecone.io/learn/vector-search-optimization/) - Našumo derinimas
- [HNSW algoritmas](https://arxiv.org/abs/1603.09320) - Hierarchiniai naviguojami mažo pasaulio grafai

### Semantinė paieška
- [Informacijos paieškos pagrindai](https://nlp.stanford.edu/IR-book/) - Stanfordo informacijos paieškos vadovėlis
- [Vektorinės paieškos geriausios praktikos](https://weaviate.io/blog/vector-search-best-practices) - Įgyvendinimo modeliai
- [Hibridinės paieškos strategijos](https://blog.vespa.ai/hybrid-search/) - Skirtingų paieškos metodų derinimas

---

**Ankstesnis**: [Laboratorija 06: Įrankių kūrimas](../06-Tools/README.md)  
**Kitas**: [Laboratorija 08: Testavimas ir derinimas](../08-Testing/README.md)
