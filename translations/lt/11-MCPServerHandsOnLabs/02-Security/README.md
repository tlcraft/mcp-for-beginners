...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:16:29+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "lt"
}
-->
# Saugumas ir daugiabučių sistema

## 🎯 Ką apima šis praktinis darbas

Šis praktinis darbas pateikia išsamias instrukcijas, kaip įgyvendinti įmonės lygio saugumą ir daugiabučių sistemą MCP serveriams. Išmoksite kurti saugias ir atitiktį užtikrinančias sistemas, kurios apsaugo jautrius mažmeninės prekybos duomenis ir leidžia lanksčiai valdyti prieigą tarp skirtingų nuomininkų.

## Apžvalga

Saugumas yra itin svarbus mažmeninės prekybos programoms, kurios tvarko klientų duomenis, mokėjimo informaciją ir verslo analizę. Šiame praktiniame darbe aptariama visa saugumo architektūra – nuo autentifikacijos ir autorizacijos iki duomenų izoliacijos ir atitikties stebėjimo.

Mes įgyvendiname gynybos strategiją, apimančią „Azure“ identiteto paslaugas, PostgreSQL eilutės lygio saugumą (Row Level Security), programų lygio kontrolę ir išsamų audito žurnalų vedimą, kad sukurtume tvirtą ir atitiktį užtikrinančią platformą.

## Mokymosi tikslai

Baigę šį praktinį darbą, galėsite:

- **Įgyvendinti** įmonės lygio eilutės lygio saugumą daugiabučių duomenų izoliacijai
- **Sukurti** saugius autentifikacijos ir autorizacijos modelius naudojant „Azure“
- **Konfigūruoti** išsamų audito žurnalų vedimą atitikties reikalavimams
- **Taikyti** gynybos strategijas visiems programų sluoksniams
- **Patikrinti** saugumo įgyvendinimą sistemingais testais
- **Stebėti** saugumo įvykius ir reaguoti į galimas grėsmes

## 🔐 Daugiabučių saugumo architektūra

### Saugumo sluoksnių apžvalga
...
### Daugiabučių modeliai

Mūsų įgyvendinimas naudoja **bendrą duomenų bazę, bendrą schemą** su eilutės lygio saugumu:

**Privalumai:**
- Ekonomiškas resursų naudojimas
- Supaprastinta priežiūra ir atnaujinimai
- Stipri duomenų izoliacija per RLS
- Atitiktį užtikrinantys audito žurnalai

**Trūkumai:**
- Reikalauja kruopštaus RLS politikos kūrimo
- Schemos pakeitimai veikia visus nuomininkus
- Reikia patikimų atsarginių kopijų ir atkūrimo procedūrų

## 🛡️ Eilutės lygio saugumo įgyvendinimas
...
### Parduotuvės konteksto valdymas
...
### Išsamus audito žurnalų vedimas
...
## 🧪 Saugumo testavimas ir validacija

### Automatiniai saugumo testai
...
### Įsilaužimo testavimo kontrolinis sąrašas
...
✅ **Daugiabučių saugumas**: Įgyvendintas eilutės lygio saugumas visiškai duomenų izoliacijai  
✅ **„Azure“ autentifikacija**: Integruotas „Azure Entra ID“ su JWT validacija  
✅ **Autorizacija pagal vaidmenis**: Sukonfigūruota hierarchinė vaidmenų ir leidimų sistema  
✅ **Išsamus audito žurnalų vedimas**: Sukurtas saugumo įvykių stebėjimas ir stebėsena  
✅ **Saugumo testavimas**: Įgyvendinti automatiniai saugumo validacijos testai  
✅ **Grėsmių stebėjimas**: Sukurtas realaus laiko saugumo įvykių aptikimas ir įspėjimai  

## 🚀 Kas toliau

Tęskite su **[Praktinis darbas 03: Aplinkos nustatymas](../03-Setup/README.md)**, kad:

- Konfigūruotumėte kūrimo aplinkas pagal saugumo geriausią praktiką
- Nustatytumėte „Azure“ paslaugas autentifikacijai ir stebėjimui
- Įgyvendintumėte saugius duomenų bazės ryšius ir slaptažodžių valdymą
- Patikrintumėte saugumo konfigūracijas kūrimo aplinkose

## 📚 Papildomi ištekliai

### „Azure“ saugumas
- [„Azure Entra ID“ dokumentacija](https://docs.microsoft.com/azure/active-directory/) - Išsamus identiteto platformos vadovas
- [„Azure Key Vault“](https://docs.microsoft.com/azure/key-vault/) - Slaptažodžių valdymo paslauga
- [„Azure“ saugumo geriausia praktika](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Saugumo gairės

### Duomenų bazės saugumas
- [PostgreSQL eilutės lygio saugumas](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Oficialus RLS dokumentas
- [Duomenų bazės saugumo kontrolinis sąrašas](https://www.postgresql.org/docs/current/security.html) - PostgreSQL saugumo vadovas
- [Daugiabučių duomenų bazės modeliai](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Architektūros modeliai

### Saugumo testavimas
- [OWASP testavimo vadovas](https://owasp.org/www-project-web-security-testing-guide/) - Išsamus saugumo testavimas
- [JWT saugumo geriausia praktika](https://tools.ietf.org/html/rfc8725) - JWT saugumo rekomendacijos
- [API saugumo testavimas](https://owasp.org/www-project-api-security/) - API specifinis saugumo testavimas

---

**Ankstesnis**: [Praktinis darbas 01: Pagrindinės architektūros sąvokos](../01-Architecture/README.md)  
**Kitas**: [Praktinis darbas 03: Aplinkos nustatymas](../03-Setup/README.md)
