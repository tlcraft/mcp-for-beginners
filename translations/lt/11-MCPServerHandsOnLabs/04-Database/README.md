...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:34:51+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "lt"
}
-->
# Duomenų bazės dizainas ir schema

## 🎯 Ką apima šis praktinis darbas

Šiame praktiniame darbe gilinamasi į PostgreSQL duomenų bazės dizainą Zava Retail sistemai. Išmoksite įgyvendinti išsamią mažmeninės prekybos schemą su vektorine paieška, daugiaklientiniu duomenų modeliavimu ir eilučių lygio saugumu (RLS) duomenų izoliacijai užtikrinti.

## Apžvalga

Duomenų bazė yra mūsų MCP serverio pagrindas, saugantis mažmeninės prekybos duomenis iš kelių parduotuvių, tuo pačiu užtikrinant griežtą duomenų izoliaciją. Naudojame PostgreSQL su pgvector plėtiniu, kad galėtume įgyvendinti semantinę paiešką, leidžiančią klientams rasti produktus naudojant natūralios kalbos užklausas.

Mūsų schema atitinka šiuolaikinius daugiaklientinius modelius, o eilučių lygio saugumas užtikrina, kad vartotojai galėtų pasiekti tik savo autorizuotų parduotuvių duomenis. Šis požiūris suteikia įmonės lygio saugumą ir optimalų našumą.

## Mokymosi tikslai

Baigę šį praktinį darbą, galėsite:

- **Sukurti** mastelio keičiamas daugiaklientines mažmeninės prekybos duomenų bazės schemas
- **Įgyvendinti** PostgreSQL su pgvector vektorinei paieškai
- **Konfigūruoti** eilučių lygio saugumą duomenų izoliacijai
- **Generuoti** realistiškus testinius duomenis
- **Optimizuoti** duomenų bazės našumą mažmeninės prekybos užkrovoms
- **Įgyvendinti** atsarginių kopijų ir atkūrimo strategijas

## 🗃️ Duomenų bazės architektūra

### PostgreSQL su pgvector

Mūsų duomenų bazė naudoja PostgreSQL įmonės funkcijas kartu su pgvector plėtiniu AI pagrįstai paieškai:
...
### Daugiaklientinė architektūra

Duomenų bazė naudoja **bendrą duomenų bazę, bendrą schemą** daugiaklientinį modelį su eilučių lygio saugumu:
...
## 📊 Pagrindinės schemos dizainas

### Parduotuvės lentelė (klientų pagrindinė lentelė)
...
### Produktų lentelė su kategorijomis
...
## 🔍 Vektorinių paieškų įgyvendinimas

### Produktų įterpimų lentelė
...
## 🔐 Eilučių lygio saugumo nustatymas

### Duomenų bazės vaidmenys ir leidimai
...
### Realistiškų testinių duomenų scenarijus
...
### Užklausų optimizavimo peržiūros
...
✅ **Daugiaklientinės duomenų bazės dizainas**: Įgyvendintas eilučių lygio saugumas saugiai duomenų izoliacijai  
✅ **Vektorinių paieškų galimybės**: Konfigūruotas pgvector semantinei produktų paieškai  
✅ **Išsami schema**: Sukurta gamybai paruošta mažmeninės prekybos duomenų bazės schema  
✅ **Testinių duomenų generavimas**: Sukurti realistiški testiniai duomenys vystymui ir testavimui  
✅ **Našumo optimizavimas**: Konfigūruoti indeksai ir užklausų optimizavimas  
✅ **Atsarginės kopijos ir atkūrimas**: Sukurtos patikimos duomenų apsaugos strategijos  

## 🚀 Kas toliau

Tęskite su **[Lab 05: MCP serverio įgyvendinimas](../05-MCP-Server/README.md)**, kad:

- Sukurtumėte FastMCP serverį, kuris jungiasi prie šios duomenų bazės
- Įgyvendintumėte duomenų bazės užklausų įrankius MCP protokolui
- Pridėtumėte semantinės paieškos galimybes naudojant įterpimus
- Konfigūruotumėte ryšio telkinį ir klaidų tvarkymą

## 📚 Papildomi ištekliai

### PostgreSQL ir pgvector
- [PostgreSQL dokumentacija](https://www.postgresql.org/docs/) - Išsamus PostgreSQL vadovas
- [pgvector plėtinys](https://github.com/pgvector/pgvector) - Vektorinė panašumo paieška PostgreSQL
- [PostgreSQL našumo optimizavimas](https://wiki.postgresql.org/wiki/Performance_Optimization) - Geriausios optimizavimo praktikos

### Daugiaklientinė architektūra
- [Eilučių lygio saugumas](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS dokumentacija
- [Daugiaklientinė duomenų architektūra](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure architektūros modeliai
- [Duomenų bazės saugumo geriausios praktikos](https://www.postgresql.org/docs/current/security.html) - PostgreSQL saugumo vadovas

### Vektorinės duomenų bazės
- [Vektorinių paieškų pagrindai](https://www.pinecone.io/learn/vector-database/) - Vektorinės duomenų bazės supratimas
- [Įterpimo modeliai](https://platform.openai.com/docs/guides/embeddings) - OpenAI įterpimų dokumentacija
- [HNSW algoritmas](https://arxiv.org/abs/1603.09320) - Hierarchiniai naviguojami mažo pasaulio grafai

---

**Ankstesnis**: [Lab 03: Aplinkos nustatymas](../03-Setup/README.md)  
**Kitas**: [Lab 05: MCP serverio įgyvendinimas](../05-MCP-Server/README.md)
