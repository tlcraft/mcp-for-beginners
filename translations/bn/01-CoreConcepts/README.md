...
[মডেল কনটেক্সট প্রোটোকল (এমসিপি)](https://github.com/modelcontextprotocol) একটি শক্তিশালী, মানসম্মত কাঠামো যা বড় ভাষা মডেল (LLMs) এবং বাহ্যিক টুল, অ্যাপ্লিকেশন এবং ডেটা সোর্সের মধ্যে যোগাযোগকে অপ্টিমাইজ করে।  
...
এমসিপি প্রোটোকল একটি ক্রমবর্ধমান মান যা তারিখ-ভিত্তিক সংস্করণিং (YYYY-MM-DD ফরম্যাট) ব্যবহার করে। বর্তমান প্রোটোকল সংস্করণ **2025-06-18**। প্রোটোকল স্পেসিফিকেশনের সর্বশেষ আপডেট দেখতে পারেন [এখানে](https://modelcontextprotocol.io/specification/2025-06-18/)।
...
**টুল** হলো কার্যকরী ফাংশন যা এআই মডেল নির্দিষ্ট কাজ সম্পাদনের জন্য আহ্বান করতে পারে। এগুলি এমসিপি ইকোসিস্টেমের "ক্রিয়া" উপস্থাপন করে, যা মডেলগুলিকে বাহ্যিক সিস্টেমের সাথে ইন্টারঅ্যাক্ট করতে সক্ষম করে:  
...
এই জাভাস্ক্রিপ্ট উদাহরণটি দেখায় কীভাবে একটি MCP ক্লায়েন্ট তৈরি করতে হয়, যা একটি সার্ভারের সাথে সংযোগ স্থাপন করে, একটি প্রম্পট পাঠায় এবং প্রতিক্রিয়া প্রক্রিয়া করে, যার মধ্যে কোনো টুল কল করা হয়েছে কিনা তা অন্তর্ভুক্ত।
