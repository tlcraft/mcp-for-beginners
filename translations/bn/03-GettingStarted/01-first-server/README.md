...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T09:40:08+00:00",
...
ইন্সপেক্টর একটি চমৎকার টুল যা আপনার সার্ভার চালু করতে সাহায্য করে এবং এর সাথে ইন্টারঅ্যাক্ট করার সুযোগ দেয় যাতে আপনি পরীক্ষা করতে পারেন এটি সঠিকভাবে কাজ করছে কিনা। চলুন এটি চালু করি:
> [!NOTE]
...
1. Connect বোতামটি নির্বাচন করে সার্ভারের সাথে সংযোগ করুন  
  একবার আপনি সার্ভারের সাথে সংযোগ করলে, আপনি এখন নিম্নলিখিত দেখতে পাবেন:
...
- পরীক্ষণ এবং ডিবাগিং নির্ভরযোগ্য MCP ইমপ্লিমেন্টেশনের জন্য অপরিহার্য
