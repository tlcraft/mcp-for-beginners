...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T15:05:40+00:00",
...
**মডেল কনটেক্সট প্রোটোকল (MCP)** একটি আধুনিক ফ্রেমওয়ার্ক যা AI মডেল এবং ক্লায়েন্ট অ্যাপ্লিকেশনের মধ্যে যোগাযোগকে মানসম্মত করার জন্য ডিজাইন করা হয়েছে। এই ওপেন-সোর্স শিক্ষাক্রমটি একটি গঠনমূলক শিক্ষার পথ প্রদান করে, যেখানে জনপ্রিয় প্রোগ্রামিং ভাষাগুলোর মাধ্যমে বাস্তব কোড উদাহরণ এবং বাস্তব জীবনের ব্যবহারিক কেস অন্তর্ভুক্ত রয়েছে, যেমন C#, Java, JavaScript, TypeScript, এবং Python।
...
| 00 | MCP পরিচিতি | মডেল কনটেক্সট প্রোটোকলের সংক্ষিপ্ত বিবরণ এবং AI পাইপলাইনে এর গুরুত্ব | [আরও পড়ুন](./00-Introduction/README.md) |
| 01 | মূল ধারণাগুলো ব্যাখ্যা | MCP-এর মূল ধারণাগুলোর গভীর বিশ্লেষণ | [আরও পড়ুন](./01-CoreConcepts/README.md) |
| 02 | MCP-এ নিরাপত্তা | নিরাপত্তা ঝুঁকি এবং সেরা পদ্ধতি | [আরও পড়ুন](./02-Security/README.md) |
...
| 04 | ব্যবহারিক বাস্তবায়ন | SDK, ডিবাগিং, টেস্টিং, পুনঃব্যবহারযোগ্য প্রম্পট টেমপ্লেট | [আরও পড়ুন](./04-PracticalImplementation/README.md) |
| 05 | MCP-এর উন্নত বিষয় | মাল্টি-মডাল AI, স্কেলিং, এন্টারপ্রাইজ ব্যবহার | [আরও পড়ুন](./05-AdvancedTopics/README.md) |
...
| 5.12 | Entra ID অথেন্টিকেশন | Microsoft Entra ID-এর সাথে অথেন্টিকেশন | [গাইড](./05-AdvancedTopics/mcp-security-entra/README.md) |
...
| **মডিউল 6-10: কমিউনিটি এবং সেরা পদ্ধতি** | | | |
...
| 08 | MCP-এর সেরা পদ্ধতি | পারফরম্যান্স, ফল্ট-টলারেন্স, রেজিলিয়েন্স | [গাইড](./08-BestPractices/README.md) |
...
| 11 | MCP সার্ভার ডাটাবেস ইন্টিগ্রেশন | PostgreSQL ইন্টিগ্রেশনের জন্য 13-ল্যাবের সম্পূর্ণ হাতে-কলমে শিক্ষার পথ | [ল্যাব](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.7 | টুল ডেভেলপমেন্ট | ডেটাবেস কোয়েরি টুল এবং স্কিমা ইনট্রোস্পেকশন তৈরি | [ল্যাব ০৬](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
| 11.8 | সেমান্টিক সার্চ | Azure OpenAI এবং pgvector ব্যবহার করে ভেক্টর এমবেডিং ইমপ্লিমেন্টেশন | [ল্যাব ০৭](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
...
| 11.11 | ডিপ্লয়মেন্ট স্ট্র্যাটেজি | ডকার ডিপ্লয়মেন্ট, Azure Container Apps, এবং স্কেলিং বিবেচনা | [ল্যাব ১০](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
...
- C#, Java, JavaScript, Python, বা TypeScript-এর যেকোনো একটি ভাষায় প্রোগ্রামিংয়ের মৌলিক জ্ঞান
...
একটি বিস্তারিত [স্টাডি গাইড](./study_guide.md) উপলব্ধ রয়েছে যা আপনাকে এই রিপোজিটরিটি কার্যকরভাবে নেভিগেট করতে সাহায্য করবে। গাইডে রয়েছে:
...
আপনি MCP-এ নতুন হোন বা ইতিমধ্যেই এটি নিয়ে কাজ করছেন, দিন ১ আপনাকে অনুপ্রেরণা এবং কার্যকর টেকঅ্যাওয়ে প্রদান করবে।

#### [দিন ২: আত্মবিশ্বাসের সাথে MCP সার্ভার তৈরি করুন](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

এটি MCP নির্মাতাদের জন্য। আমরা MCP সার্ভার তৈরি এবং MCP-কে AI ওয়ার্কফ্লোতে ইন্টিগ্রেট করার জন্য ইমপ্লিমেন্টেশন কৌশল এবং সেরা অনুশীলন নিয়ে গভীর আলোচনা করব।
...
আপনি যদি একজন ডেভেলপার, টুল নির্মাতা, বা AI প্রোডাক্ট স্ট্র্যাটেজিস্ট হন, এই দিনটি স্কেলযোগ্য, নিরাপদ, এবং ভবিষ্যৎ-প্রস্তুত MCP সমাধান তৈরি করার জন্য প্রয়োজনীয় অন্তর্দৃষ্টি প্রদান করবে।

### MCP বুট ক্যাম্প আগস্ট ২০২৫
ইন্টেনসিভ ভিডিও সেশনে শিখুন কীভাবে MCP সার্ভার তৈরি করবেন, VS Code-এর সাথে ইন্টিগ্রেট করবেন, এবং MCP ফর বিগিনারস কারিকুলামের বিষয়বস্তুর উপর ভিত্তি করে Azure-এ পেশাদারভাবে ডিপ্লয় করবেন। একটি প্রযুক্তিতে ব্যবহারিক দক্ষতা অর্জন করুন যা বড় কোম্পানিগুলি ইতিমধ্যেই ব্যবহার করছে।
...
Model Context Protocol (MCP) সম্পর্কে শিখুন, একটি অত্যাধুনিক ফ্রেমওয়ার্ক যা AI মডেল এবং ক্লায়েন্ট অ্যাপ্লিকেশনের মধ্যে ইন্টারঅ্যাকশনকে স্ট্যান্ডার্ডাইজ করতে ডিজাইন করা হয়েছে। এই বিগিনার-ফ্রেন্ডলি সেশনের মাধ্যমে, আমরা আপনাকে MCP-এর সাথে পরিচয় করিয়ে দেব এবং আপনার প্রথম MCP সার্ভার তৈরি করার জন্য গাইড করব।  
...
এই প্রকল্পটি কন্ট্রিবিউশন এবং পরামর্শকে স্বাগত জানায়। বেশিরভাগ কন্ট্রিবিউশন আপনাকে একটি  
Contributor License Agreement (CLA) সম্মত হতে হবে যা ঘোষণা করে যে আপনার অধিকার রয়েছে এবং আপনি আমাদের আপনার কন্ট্রিবিউশন ব্যবহার করার অধিকার প্রদান করেন। বিস্তারিত জানতে <https://cla.opensource.microsoft.com> দেখুন।
...
- **কোর কারিকুলাম (00-11)**: প্রধান বিষয়বস্তু যা এগারোটি ধারাবাহিক মডিউলে সংগঠিত, যার মধ্যে রয়েছে বিস্তৃত ডেটাবেস ইন্টিগ্রেশন ল্যাব  
...
এই প্রকল্পে প্রকল্প, পণ্য, বা পরিষেবার ট্রেডমার্ক বা লোগো থাকতে পারে। Microsoft-এর ট্রেডমার্ক বা লোগো ব্যবহারের অনুমোদিত নিয়ম Microsoft-এর [ট্রেডমার্ক ও ব্র্যান্ড নির্দেশিকা](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) অনুসরণ করতে হবে। 

এই প্রকল্পের পরিবর্তিত সংস্করণে Microsoft-এর ট্রেডমার্ক বা লোগো ব্যবহার এমন কোনো বিভ্রান্তি সৃষ্টি করতে পারে না বা Microsoft-এর পৃষ্ঠপোষকতার ইঙ্গিত দিতে পারে না। তৃতীয় পক্ষের ট্রেডমার্ক বা লোগো ব্যবহারের ক্ষেত্রে সেই তৃতীয় পক্ষের নীতিমালা অনুসরণ করতে হবে।
