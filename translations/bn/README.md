...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:29:36+00:00",
...
**মডেল কনটেক্সট প্রোটোকল (MCP)** একটি আধুনিক ফ্রেমওয়ার্ক যা AI মডেল এবং ক্লায়েন্ট অ্যাপ্লিকেশনের মধ্যে যোগাযোগকে মানসম্মত করার জন্য ডিজাইন করা হয়েছে। এই ওপেন-সোর্স শিক্ষাক্রমটি একটি কাঠামোগত শেখার পথ প্রদান করে, যেখানে জনপ্রিয় প্রোগ্রামিং ভাষাগুলোর মাধ্যমে বাস্তব কোড উদাহরণ এবং বাস্তব জীবনের ব্যবহার কেস অন্তর্ভুক্ত রয়েছে, যেমন C#, Java, JavaScript, TypeScript, এবং Python।
...
| 5.10 | রিয়েলটাইম স্ট্রিমিং | রিয়েলটাইম স্ট্রিমিং ফাংশন তৈরি করুন | [গাইড](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
...
| 09 | MCP কেস স্টাডি | ব্যবহারিক বাস্তবায়ন উদাহরণ | [গাইড](./09-CaseStudy/README.md) |
...
আমরা একটি বিস্তারিত [চেঞ্জলগ](./changelog.md) রক্ষণ করি যা পাঠ্যক্রমের উপকরণে সমস্ত গুরুত্বপূর্ণ আপডেট ট্র্যাক করে, যেমন:
...
দুই দিনের গভীর প্রযুক্তিগত অন্তর্দৃষ্টি, কমিউনিটি সংযোগ এবং হাতে-কলমে শেখার জন্য প্রস্তুত হন MCP Dev Days-এ, একটি ভার্চুয়াল ইভেন্ট যা Model Context Protocol (MCP)-এর জন্য নিবেদিত — উদীয়মান মান যা AI মডেল এবং তাদের নির্ভরশীল টুলগুলির মধ্যে সেতু তৈরি করে।
...
এটি MCP-কে ডেভেলপার ওয়ার্কফ্লোতে ব্যবহার করার ক্ষমতা প্রদান এবং অসাধারণ MCP কমিউনিটিকে উদযাপন করার বিষয়ে। আমরা কমিউনিটি সদস্য এবং Arcade, Block, Okta, এবং Neon-এর মতো অংশীদারদের সাথে যোগ দেব, যারা Microsoft-এর সাথে সহযোগিতা করে একটি ওপেন, এক্সটেনসিবল MCP ইকোসিস্টেম তৈরি করছে।  
বাস্তব-জীবনের ডেমো VS Code, Visual Studio, GitHub Copilot, এবং জনপ্রিয় কমিউনিটি টুলগুলির উপর ভিত্তি করে  
প্রায়োগিক, প্রসঙ্গ-চালিত ডেভেলপার ওয়ার্কফ্লো  
কমিউনিটি-নেতৃত্বাধীন সেশন এবং অন্তর্দৃষ্টি  
আপনি MCP-তে নতুন হোন বা ইতিমধ্যেই এটি নিয়ে কাজ করছেন, দিন ১ আপনাকে অনুপ্রেরণা এবং কার্যকরী টেকওয়েতে পূর্ণ করবে।

#### [দিন ২: আত্মবিশ্বাসের সাথে MCP সার্ভার তৈরি করুন](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

এটি MCP নির্মাতাদের জন্য। আমরা MCP সার্ভার তৈরি এবং AI ওয়ার্কফ্লোতে MCP একীভূত করার জন্য বাস্তবায়ন কৌশল এবং সেরা অনুশীলন নিয়ে গভীরভাবে আলোচনা করব।

#### আলোচ্য বিষয়:

- MCP সার্ভার তৈরি এবং সেগুলিকে এজেন্ট অভিজ্ঞতায় একীভূত করা
...
ইন্টেনসিভ ভিডিও সেশনের মাধ্যমে শিখুন কীভাবে MCP সার্ভার তৈরি করবেন, VS Code-এর সাথে একীভূত করবেন, এবং MCP ফর বিগিনারস পাঠ্যক্রমের বিষয়বস্তু অনুযায়ী Azure-এ পেশাদারভাবে ডিপ্লয় করবেন। একটি প্রযুক্তিতে ব্যবহারিক দক্ষতা অর্জন করুন যা বড় কোম্পানিগুলি ইতিমধ্যেই ব্যবহার করছে।
...
এই প্রকল্পটি কন্ট্রিবিউশন এবং পরামর্শকে স্বাগত জানায়। বেশিরভাগ কন্ট্রিবিউশন আপনাকে একটি Contributor License Agreement (CLA) সম্মত করতে হবে যা ঘোষণা করে যে আপনার অধিকার রয়েছে এবং আপনি আমাদের আপনার কন্ট্রিবিউশন ব্যবহার করার অধিকার প্রদান করেন। বিস্তারিত জানতে <https://cla.opensource.microsoft.com> দেখুন।
...
- **images/**: পাঠ্যক্রমে ব্যবহৃত ডায়াগ্রাম এবং চিত্র
...
- **changelog.md**: পাঠ্যক্রমের উপকরণে সমস্ত গুরুত্বপূর্ণ পরিবর্তনের রেকর্ড
...
Microsoft ট্রেডমার্ক বা লোগো পরিবর্তিত সংস্করণে ব্যবহার বিভ্রান্তি সৃষ্টি করতে বা Microsoft স্পনসরশিপ বোঝাতে পারে না।  
