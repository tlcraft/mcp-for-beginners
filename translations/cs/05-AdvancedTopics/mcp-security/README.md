...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T19:53:00+00:00",
...
Bezpečnost je klíčová pro implementace MCP, zejména v podnikových prostředích. Tento pokročilý průvodce se zabývá komplexními bezpečnostními praktikami pro produkční nasazení MCP, řeší tradiční bezpečnostní problémy i hrozby specifické pro AI, které jsou jedinečné pro Model Context Protocol.
...
- **Kontrola uživatele**: Uživatelé musí poskytnout explicitní souhlas před jakýmkoli přístupem k datům nebo spuštěním nástrojů  
...
- **Řešit zranitelnosti MCP**: Identifikovat a zmírnit problémy zmateného zástupce, zranitelnosti při předávání tokenů a rizika v dodavatelském řetězci  
- **Integrovat bezpečnost Microsoftu**: Využít bezpečnostní služby Azure a GitHub Advanced Security pro komplexní ochranu  

## **POVINNÉ bezpečnostní požadavky**

### **Kritické požadavky ze specifikace MCP (2025-06-18):**
...
Aktuální specifikace MCP (2025-06-18) umožňuje delegaci externím poskytovatelům identity, jako je Microsoft Entra ID, což poskytuje bezpečnostní funkce na podnikové úrovni:
...
**Vylepšená implementace podle specifikace MCP (2025-06-18):**
...
> **Bezpečnostní upozornění**: Tento pokročilý implementační průvodce odráží aktuální požadavky specifikace MCP (2025-06-18). Vždy ověřujte podle nejnovější oficiální dokumentace a zvažte své specifické bezpečnostní požadavky a model hrozeb při implementaci těchto kontrol.
