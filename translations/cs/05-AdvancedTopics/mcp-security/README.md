...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T15:01:32+00:00",
  "source_file": "05-AdvancedTopics/mcp-security/README.md",
  "language_code": "cs"
}
-->
# MCP Bezpečnostní osvědčené postupy - Pokročilý implementační průvodce

> **Aktuální standard**: Tento průvodce odráží bezpečnostní požadavky [MCP Specifikace 2025-06-18](https://spec.modelcontextprotocol.io/specification/2025-06-18/) a oficiální [MCP Bezpečnostní osvědčené postupy](https://modelcontextprotocol.io/specification/2025-06-18/basic/security_best_practices).

Bezpečnost je klíčová pro implementace MCP, zejména v podnikových prostředích. Tento pokročilý průvodce se zabývá komplexními bezpečnostními postupy pro produkční nasazení MCP, přičemž řeší jak tradiční bezpečnostní problémy, tak hrozby specifické pro AI, které jsou unikátní pro Model Context Protocol.
...
- **Výslovné zákazy**: MCP servery **NESMÍ** přijímat tokeny, které pro ně nebyly vydány, a **NESMÍ** používat relace pro autentizaci  
- **Povinné ověřování**: Všechny příchozí požadavky **MUSÍ** být ověřeny a souhlas uživatele **MUSÍ** být získán pro proxy operace  
- **Bezpečné výchozí nastavení**: Implementujte bezpečnostní kontroly s přístupem obrany v hloubce  
- **Kontrola uživatele**: Uživatelé musí poskytnout výslovný souhlas před jakýmkoli přístupem k datům nebo spuštěním nástrojů  
...
- **Zabránit útokům specifickým pro AI**: Chránit se před injekcí promptů, otravou nástrojů a únosem relací pomocí Microsoft Prompt Shields a Azure Content Safety  
- **Aplikovat podnikové bezpečnostní postupy**: Implementovat komplexní logování, monitorování a reakci na incidenty pro produkční nasazení MCP  
...
Moderní implementace MCP těží z vývoje specifikace směrem k delegaci na externí poskytovatele identity, což výrazně zlepšuje bezpečnostní postoj oproti vlastním implementacím autentizace.

### **Integrace Microsoft Entra ID**

Aktuální specifikace MCP (2025-06-18) umožňuje delegaci na externí poskytovatele identity, jako je Microsoft Entra ID, což poskytuje bezpečnostní funkce na podnikové úrovni:
...
## Bezpečnostní kontroly specifické pro AI a řešení Microsoftu

### **Obrana proti injekci promptů s Microsoft Prompt Shields**
...
## Integrace podnikové bezpečnosti a monitorování
...
## Shrnutí osvědčených postupů a podnikové pokyny
...
Bezpečnost relací:  
  ...
  Vazba relace na konkrétního uživatele  
  Detekce únosu relací  
  Vynucení přenosu přes HTTPS  

OAuth a proxy bezpečnost:  
  Implementace PKCE (OAuth 2.1)  
  Výslovný souhlas uživatele pro dynamické klienty  
...
- **Integrovaný bezpečnostní postoj**: Sjednocená bezpečnost napříč identitami, infrastrukturou a aplikacemi  
- **Pokročilá ochrana AI**: Obrana navržená speciálně proti hrozbám specifickým pro AI  
- **Podniková shoda**: Vestavěná podpora regulačních požadavků a průmyslových standardů  
- **Zpravodajství o hrozbách**: Integrace globálního zpravodajství o hrozbách pro proaktivní ochranu  
...
> **Bezpečnostní upozornění**: Tento pokročilý implementační průvodce odráží požadavky aktuální specifikace MCP (2025-06-18). Vždy ověřujte podle nejnovější oficiální dokumentace a zvažte své specifické bezpečnostní požadavky a model hrozeb při implementaci těchto kontrol.
