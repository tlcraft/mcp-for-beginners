...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T19:53:26+00:00",
...
- Využívat Azure Machine Learning (ML) pro spouštění ML pipeline a registraci modelů jako nástrojů MCP.

## Integrace s Azure OpenAI

Azure OpenAI poskytuje přístup k výkonným AI modelům, jako je GPT-4 a další. Integrace MCP s Azure OpenAI vám umožní využívat tyto modely při zachování flexibility orchestrace nástrojů MCP.
...
Doporučujeme implementovat vlastní logiku pro zpracování nástrojů na základě konkrétního nastavení vašeho MCP serveru.

## Integrace s Microsoft AI Foundry

Azure AI Foundry poskytuje platformu pro vytváření a nasazování AI agentů. Integrace MCP s AI Foundry vám umožní využívat jeho schopnosti při zachování flexibility MCP.

V následujícím kódu vyvíjíme integraci agenta, který zpracovává požadavky a volání nástrojů pomocí MCP.
...
Integrace MCP s Azure Machine Learning (ML) vám umožní využívat výkonné ML schopnosti Azure při zachování flexibility MCP. Tato integrace může být použita pro spouštění ML pipeline, registraci modelů jako nástrojů a správu výpočetních zdrojů.
