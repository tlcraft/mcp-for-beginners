...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-13T00:58:26+00:00",
...
Integrace MCP s Azure Machine Learning (ML) vám umožňuje využít výkonné ML schopnosti Azure při zachování flexibility MCP. Tato integrace může být použita k vykonávání ML pipeline, registraci modelů jako nástrojů a správě výpočetních zdrojů.
