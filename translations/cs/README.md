...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-19T15:21:43+00:00",
...
3. [**Připojte se na Azure AI Foundry Discord a setkejte se s experty a dalšími vývojáři**](https://discord.com/invite/ByRwuEEgH4)
...
## **Naučte se MCP pomocí praktických příkladů v C#, Java, JavaScript, Rust, Python a TypeScript**
...
### ➡️ Sledujte na vyžádání - MCP Dev Days
Připravte se na dva dny hlubokých technických poznatků, propojení s komunitou a praktického učení na MCP Dev Days, virtuální akci věnované Model Context Protocol (MCP) — vznikajícímu standardu, který propojuje AI modely a nástroje, na které spoléhají.
...
Je zaměřen na posílení vývojářů při používání MCP v jejich pracovním postupu a oslavu úžasné komunity MCP. Připojí se k nám členové komunity a partneři jako Arcade, Block, Okta a Neon, aby ukázali, jak spolupracují s Microsoftem na formování otevřeného, rozšiřitelného ekosystému MCP. 
- Reálné ukázky ve VS Code, Visual Studio, GitHub Copilot a populárních komunitních nástrojích
- Praktické, kontextově řízené vývojářské pracovní postupy
- Sezení vedená komunitou a postřehy
Ať už s MCP teprve začínáte, nebo s ním již pracujete, Den 1 vám poskytne inspiraci a konkrétní tipy.

#### Den 2: Vytvářejte MCP servery s jistotou
...
|--------|-------|-------------|------|
| **Modul 1-3: Základy** | | | |
| 00 | Úvod do MCP | Přehled Model Context Protocol a jeho významu v AI pipelinech | [Více zde](./00-Introduction/README.md) |
| 01 | Vysvětlení základních konceptů | Podrobný průzkum základních konceptů MCP | [Více zde](./01-CoreConcepts/README.md) |
| 02 | Bezpečnost v MCP | Hrozby a osvědčené bezpečnostní postupy | [Více zde](./02-Security/README.md) |
| 03 | Začínáme s MCP | Nastavení prostředí, základní servery/klienti, integrace | [Více zde](./03-GettingStarted/README.md) |
...
| 04 | Praktická implementace | SDK, ladění, testování, znovupoužitelné šablony promptů | [Více zde](./04-PracticalImplementation/README.md) |
| 05 | Pokročilá témata v MCP | Multimodální AI, škálování, podnikové využití | [Více zde](./05-AdvancedTopics/README.md) |
| 5.1 | Integrace Azure | Integrace MCP s Azure | [Průvodce](./05-AdvancedTopics/mcp-integration/README.md) |
...
| 5.8 | Bezpečnost | Pokročilé bezpečnostní úvahy | [Průvodce](./05-AdvancedTopics/mcp-security/README.md) |
| 5.9 | Webové vyhledávání | Implementace schopností webového vyhledávání | [Průvodce](./05-AdvancedTopics/web-search-mcp/README.md) |
| 5.10 | Realtime streaming | Vytváření funkcí pro realtime streaming | [Průvodce](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
...
| 08 | Osvědčené postupy pro MCP | Výkon, odolnost proti chybám, rezilience | [Průvodce](./08-BestPractices/README.md) |
| 09 | Případové studie MCP | Praktické příklady implementace | [Průvodce](./09-CaseStudy/README.md) |
| 10 | Praktický workshop | Vytvoření MCP serveru s AI nástroji | [Laboratoř](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
- Připojení k diskusím komunity pro podporu
...
- Vizualizovanou mapu kurikula se všemi pokrytými tématy
- Podrobný rozpis jednotlivých sekcí repozitáře
- Pokyny, jak používat ukázkové projekty
- Doporučené vzdělávací cesty pro různé úrovně dovedností
- Další zdroje pro doplnění vašeho vzdělávání

### Changelog

Udržujeme podrobný [Changelog](./changelog.md), který sleduje všechny významné aktualizace vzdělávacích materiálů, včetně:
...
3. Cvičení na vytvoření reálných MCP aplikací  
...
Contributor License Agreement (CLA), který potvrzuje, že máte právo a skutečně udělujete práva k použití vašeho příspěvku. Podrobnosti naleznete na 
<https://cla.opensource.microsoft.com>.

Když odešlete pull request, CLA bot automaticky určí, zda musíte poskytnout CLA, a příslušně označí PR (např. kontrola stavu, komentář). Jednoduše postupujte podle pokynů bota. Tento proces musíte provést pouze jednou pro všechny repozitáře využívající náš CLA.

Tento projekt přijal [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
Další informace naleznete v [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) nebo kontaktujte [opencode@microsoft.com](mailto:opencode@microsoft.com) s dalšími dotazy nebo komentáři.

## 📂 Struktura repozitáře

Repozitář je organizován následovně:

- **Hlavní kurikulum (00-10)**: Hlavní obsah organizovaný do deseti po sobě jdoucích modulů
...
- **study_guide.md**: Komplexní průvodce pro orientaci v repozitáři
- **changelog.md**: Záznam všech významných změn vzdělávacích materiálů
