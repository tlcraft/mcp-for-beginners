...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:56:38+00:00",
...
|-------|------|-------|-------|
| **Modul 1-3: Základy** | | | |
| 00 | Úvod do MCP | Přehled Model Context Protocol a jeho významu v AI procesech | [Více informací](./00-Introduction/README.md) |
...
| 5.14 | Context Engineering | Techniky pro efektivní context engineering | [Průvodce](./05-AdvancedTopics/mcp-contextengineering/README.md) |
...
- Vizualizaci učebního plánu zobrazující všechny pokryté témata
...
Udržujeme podrobný [Seznam změn](./changelog.md), který sleduje všechny významné aktualizace učebních materiálů, včetně:
...
## 🛠️ Jak efektivně používat tento učební plán
...
Je zaměřen na posílení vývojářů při používání MCP v jejich pracovním procesu a oslavu úžasné komunity MCP. Připojí se k nám členové komunity a partneři jako Arcade, Block, Okta a Neon, aby ukázali, jak spolupracují s Microsoftem na formování otevřeného, rozšiřitelného ekosystému MCP. 
Reálné ukázky napříč VS Code, Visual Studio, GitHub Copilot a populárními komunitními nástroji
Praktické, kontextově řízené pracovní postupy pro vývojáře
Sezení vedená komunitou a poznatky
...
- Stavba MCP serverů a jejich integrace do agentních prostředí
...
Pokud jste vývojář, tvůrce nástrojů nebo AI produktový stratég, tento den je plný poznatků, které potřebujete k vytvoření škálovatelných, bezpečných a budoucnosti připravených řešení MCP.

### MCP Boot Camp srpen 2025
Naučte se v intenzivních video lekcích, jak vytvářet MCP servery, integrovat je s VS Code a profesionálně nasazovat na Azure na základě obsahu z kurzu MCP pro začátečníky. Získejte praktické dovednosti v technologii, kterou již používají velké společnosti.

#### [➡️Sledujte na vyžádání MCP Bootcamp | Anglicky](https://developer.microsoft.com/en-us/reactor/series/s-1568/)
#### [➡️Sledujte na vyžádání MCP Bootcamp | Brazil](https://developer.microsoft.com/en-us/reactor/series/S-1566/)
...
Naučme se Model Context Protocol (MCP), moderní rámec navržený k standardizaci interakcí mezi AI modely a klientskými aplikacemi. Prostřednictvím této přátelské lekce pro začátečníky vás seznámíme s MCP a provedeme vás vytvořením vašeho prvního MCP serveru.
...
Když odešlete pull request, CLA bot automaticky určí, zda potřebujete poskytnout
...
- **Hlavní učební plán (00-10)**: Hlavní obsah organizovaný v deseti po sobě jdoucích modulech
- **images/**: Diagramy a ilustrace použité v celém učebním plánu
...
- **changelog.md**: Záznam všech významných změn učebních materiálů
