...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T20:02:04+00:00",
...
Představte si, že připojíte agenta k vašemu MCP serveru kalkulačky. Najednou váš agent dokáže provádět matematické operace jen na základě zadání, jako je „Kolik je 47 krát 89?“—není třeba hardcodovat logiku nebo vytvářet vlastní API.
...
AI Toolkit je výkonné rozšíření pro Visual Studio Code, které zjednodušuje vývoj agentů. AI inženýři mohou snadno vytvářet AI aplikace vývojem a testováním generativních AI modelů—lokálně nebo v cloudu. Rozšíření podporuje většinu hlavních generativních modelů dostupných dnes.
...
**Agent (Prompt) Builder** umožňuje vytvářet a přizpůsobovat vlastní AI agenty. V této části vytvoříte nového agenta a přiřadíte mu model pro konverzaci.
...
AI Toolkit je vybaven šablonami pro snadné vytváření vlastních MCP serverů. Použijeme šablonu pro Python k vytvoření MCP serveru kalkulačky.
...
1. Zadejte další prompty, abyste agenta dále otestovali. Můžete upravit existující prompt v poli **User prompt** kliknutím do pole a nahrazením stávajícího promptu.
