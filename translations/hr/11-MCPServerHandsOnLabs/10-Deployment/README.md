...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:31:14+00:00",
...
Ovaj laboratorij pruža detaljne upute za implementaciju MCP maloprodajnog servera u produkcijskim okruženjima koristeći moderne pristupe kontejnerizacije i cloud-native tehnologije. Naučit ćete kako implementirati skalabilne, sigurne i nadzirane MCP servere koji mogu podnijeti poslovne opterećenja.

## Pregled

Produkcijska implementacija MCP servera zahtijeva pažljivo razmatranje kontejnerizacije, orkestracije, sigurnosti, skalabilnosti i nadzora. Ovaj laboratorij pokriva implementaciju na Azure Container Apps s PostgreSQL Flexible Serverom, postavljanje CI/CD cjevovoda i konfiguraciju automatskog skaliranja za promjenjiva opterećenja.

Strategije implementacije kreću se od jednostavnih implementacija s jednim kontejnerom za razvoj do sofisticiranih produkcijskih okruženja s više regija, automatskim skaliranjem, sveobuhvatnim nadzorom i sigurnosnim značajkama.

## Ciljevi učenja

Na kraju ovog laboratorija, moći ćete:

- **Kontejnerizirati** MCP servere koristeći Docker s višestupanjskim buildovima
- **Implementirati** na Azure Container Apps s sigurnim mrežnim povezivanjem
- **Konfigurirati** PostgreSQL za produkciju s visokom dostupnošću
- **Primijeniti** CI/CD cjevovode za automatiziranu implementaciju
- **Skalirati** aplikacije automatski prema potražnji
- **Nadzirati** produkcijske implementacije uz sveobuhvatnu vidljivost

## 🐳 Kontejnerizacija s Dockerom

### Višestupanjski Dockerfile
...
## ☁️ Implementacija na Azure Container Apps
...
## 🔐 Konfiguracija sigurnosti za produkciju

### Pojačanje sigurnosti
...
✅ **Strategiju kontejnerizacije**: Produkcijski spremne Docker kontejnere s pojačanom sigurnošću  
✅ **Cloud implementaciju**: Azure Container Apps s automatskim skaliranjem i nadzorom  
✅ **Implementaciju baze podataka**: PostgreSQL Flexible Server s visokom dostupnošću  
✅ **CI/CD cjevovode**: Automatizirane tijekove testiranja, buildanja i implementacije  
✅ **Nadzor performansi**: Sveobuhvatno prikupljanje metrika i upozorenja  
✅ **Sigurnosnu konfiguraciju**: Sigurnosne politike za produkciju i izolaciju mreže  

## 🚀 Što slijedi

Nastavite s **[Laboratorijem 11: Nadzor i vidljivost](../11-Monitoring/README.md)** kako biste:

- Postavili sveobuhvatan nadzor s Application Insights
- Konfigurirali strukturirano logiranje i distribuirano praćenje
- Implementirali sustave upozorenja i automatiziranog odgovora
- Nadzirali poslovne metrike i KPI-jeve performansi

## 📚 Dodatni resursi

### Tehnologije kontejnera
- [Docker Best Practices](https://docs.docker.com/develop/dev-best-practices/) - Službene najbolje prakse za Docker
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Dokumentacija za Azure Container Apps
- [Kubernetes Documentation](https://kubernetes.io/docs/) - Službena dokumentacija za Kubernetes

### CI/CD i DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - Dokumentacija za GitHub Actions
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Usluge Azure DevOps
- [Infrastructure as Code](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Dokumentacija za Azure Bicep

### Sigurnost i nadzor
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Preporuke za sigurnost na Azureu
- [Container Security](https://kubernetes.io/docs/concepts/security/) - Sigurnosni koncepti za Kubernetes
- [Application Insights](https://docs.microsoft.com/en-us/azure/azure-monitor/app/app-insights-overview) - Pregled Azure Application Insights

---

**Prethodno**: [Laboratorij 09: Integracija s VS Code](../09-VS-Code/README.md)  
**Sljedeće**: [Laboratorij 11: Nadzor i vidljivost](../11-Monitoring/README.md)
