...
-->
# Dizajn baze podataka i shema

## 🎯 Što pokriva ovaj laboratorij

Ovaj laboratorij detaljno istražuje dizajn PostgreSQL baze podataka za Zava Retail sustav. Naučit ćete implementirati sveobuhvatnu shemu za maloprodaju s mogućnostima pretraživanja pomoću vektora, modeliranjem podataka za više korisnika (multi-tenant) i Row Level Security (RLS) za izolaciju podataka.

## Pregled

Baza podataka je temelj našeg MCP servera, pohranjujući maloprodajne podatke za više trgovina uz strogu izolaciju podataka. Koristimo PostgreSQL s ekstenzijom pgvector kako bismo omogućili semantičke mogućnosti pretraživanja, omogućujući kupcima pronalaženje proizvoda pomoću prirodnog jezika.

Naša shema slijedi moderne obrasce za više korisnika, pri čemu Row Level Security osigurava da korisnici mogu pristupiti samo podacima iz svojih ovlaštenih trgovina. Ovaj pristup pruža sigurnost na razini poduzeća uz optimalne performanse.

## Ciljevi učenja

Na kraju ovog laboratorija, moći ćete:

- **Dizajnirati** skalabilne sheme baza podataka za više korisnika u maloprodaji
- **Implementirati** PostgreSQL s pgvector za pretraživanje pomoću vektora
- **Konfigurirati** Row Level Security za izolaciju podataka
- **Generirati** realistične uzorke podataka za testiranje
- **Optimizirati** performanse baze podataka za maloprodajne radne opterećenja
- **Implementirati** strategije za sigurnosne kopije i oporavak podataka

## 🗃️ Arhitektura baze podataka

### PostgreSQL s pgvector

Naša baza podataka koristi napredne značajke PostgreSQL-a u kombinaciji s ekstenzijom pgvector za pretraživanje temeljeno na umjetnoj inteligenciji:
...
### Arhitektura za više korisnika

Baza podataka koristi model **zajedničke baze podataka, zajedničke sheme** za više korisnika uz Row Level Security:
...
## 📊 Dizajn osnovne sheme

### Tablica trgovina (glavna tablica korisnika)
...
### Tablica proizvoda s kategorijama
...
## 🔍 Implementacija pretraživanja pomoću vektora

### Tablica ugrađenih vektora proizvoda
...
### Funkcije za pretraživanje pomoću vektora
...
## 🔐 Postavljanje Row Level Security

### Uloge i dozvole baze podataka
...
✅ **Dizajn baze podataka za više korisnika**: Implementirali Row Level Security za sigurnu izolaciju podataka  
✅ **Mogućnosti pretraživanja pomoću vektora**: Konfigurirali pgvector za semantičko pretraživanje proizvoda  
✅ **Sveobuhvatnu shemu**: Kreirali shemu baze podataka spremnu za produkciju u maloprodaji  
✅ **Generiranje uzoraka podataka**: Izradili realistične testne podatke za razvoj i testiranje  
✅ **Optimizaciju performansi**: Konfigurirali indekse i optimizaciju upita  
✅ **Sigurnosne kopije i oporavak**: Uspostavili robusne strategije zaštite podataka  

## 🚀 Što slijedi

Nastavite s **[Laboratorijem 05: Implementacija MCP servera](../05-MCP-Server/README.md)** kako biste:

- Izgradili FastMCP server koji se povezuje s ovom bazom podataka
- Implementirali alate za upite baze podataka za MCP protokol
- Dodali mogućnosti semantičkog pretraživanja pomoću ugrađenih vektora
- Konfigurirali pooling konekcija i rukovanje greškama

## 📚 Dodatni resursi

### PostgreSQL & pgvector
- [PostgreSQL Dokumentacija](https://www.postgresql.org/docs/) - Kompletna referenca za PostgreSQL
- [pgvector Ekstenzija](https://github.com/pgvector/pgvector) - Pretraživanje sličnosti vektora za PostgreSQL
- [Optimizacija performansi PostgreSQL-a](https://wiki.postgresql.org/wiki/Performance_Optimization) - Najbolje prakse za optimizaciju

### Arhitektura za više korisnika
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Dokumentacija za RLS u PostgreSQL-u
- [Arhitektura podataka za više korisnika](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Obrasci arhitekture na Azureu
- [Najbolje prakse za sigurnost baze podataka](https://www.postgresql.org/docs/current/security.html) - Vodič za sigurnost PostgreSQL-a

### Vektorske baze podataka
- [Osnove pretraživanja pomoću vektora](https://www.pinecone.io/learn/vector-database/) - Razumijevanje vektorskih baza podataka
- [Modeli ugrađivanja](https://platform.openai.com/docs/guides/embeddings) - Dokumentacija za ugrađivanja OpenAI-a
- [HNSW Algoritam](https://arxiv.org/abs/1603.09320) - Grafovi za hijerarhijski navigabilni mali svijet

---

**Prethodno**: [Laboratorij 03: Postavljanje okruženja](../03-Setup/README.md)  
**Sljedeće**: [Laboratorij 05: Implementacija MCP servera](../05-MCP-Server/README.md)
