...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:14:55+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "hr"
}
-->
# Sigurnost i Višekorisnički Sustavi

## 🎯 Što Ovaj Laboratorij Pokriva

Ovaj laboratorij pruža detaljne upute za implementaciju sigurnosti na razini poduzeća i višekorisničkih sustava za MCP servere. Naučit ćete kako dizajnirati sigurne i usklađene sustave koji štite osjetljive podatke iz maloprodaje, omogućujući fleksibilne obrasce pristupa za više korisnika.

## Pregled

Sigurnost je ključna u maloprodajnim aplikacijama koje obrađuju podatke o kupcima, informacije o plaćanju i poslovnu inteligenciju. Ovaj laboratorij pokriva kompletnu sigurnosnu arhitekturu, od autentifikacije i autorizacije do izolacije podataka i praćenja usklađenosti.

Primjenjujemo strategiju dubinske obrane kombinirajući Azure identitetske usluge, PostgreSQL Row Level Security, kontrole na razini aplikacije i sveobuhvatno zapisivanje aktivnosti kako bismo stvorili robustan i usklađen sustav.

## Ciljevi Učenja

Na kraju ovog laboratorija, moći ćete:

- **Implementirati** Row Level Security na razini poduzeća za izolaciju podataka u višekorisničkim sustavima  
- **Dizajnirati** sigurne obrasce autentifikacije i autorizacije koristeći Azure  
- **Konfigurirati** sveobuhvatno zapisivanje aktivnosti za zahtjeve usklađenosti  
- **Primijeniti** strategije dubinske obrane kroz sve slojeve aplikacije  
- **Validirati** sigurnosne implementacije kroz sustavno testiranje  
- **Pratiti** sigurnosne događaje i reagirati na potencijalne prijetnje  

## 🔐 Arhitektura Sigurnosti za Višekorisničke Sustave

### Pregled Sigurnosnih Slojeva
...
### Modeli Višekorisničkih Sustava

Naša implementacija koristi model **Zajednička Baza Podataka, Zajednička Shema** s Row Level Security:

**Prednosti:**
- Isplativo korištenje resursa  
- Pojednostavljeno održavanje i ažuriranja  
- Snažna izolacija podataka putem RLS-a  
- Audit trailovi prilagođeni usklađenosti  

**Nedostaci:**
- Zahtijeva pažljivo dizajniranje RLS politika  
- Promjene u shemi utječu na sve korisnike  
- Potrebne su robusne procedure za backup/restore  

## 🛡️ Implementacija Row Level Security
...
### Upravljanje Kontekstom Trgovine
...
## 🔍 Sigurnosni Audit i Usklađenost

### Sveobuhvatno Zapisivanje Aktivnosti
...
### Pregledi za Praćenje Sigurnosti
...
## 🧪 Testiranje i Validacija Sigurnosti

### Automatizirani Sigurnosni Testovi
...
### Popis za Penetracijsko Testiranje
...
✅ **Sigurnost za Višekorisničke Sustave**: Implementirali Row Level Security za potpunu izolaciju podataka  
✅ **Azure Autentifikaciju**: Integrirali Azure Entra ID s validacijom JWT-a  
✅ **Autorizaciju na Temelju Uloga**: Konfigurirali hijerarhijski sustav uloga i dozvola  
✅ **Sveobuhvatno Zapisivanje Aktivnosti**: Uspostavili praćenje i nadzor sigurnosnih događaja  
✅ **Testiranje Sigurnosti**: Implementirali automatizirane testove za validaciju sigurnosti  
✅ **Praćenje Prijetnji**: Kreirali sustav za detekciju i upozorenje na sigurnosne događaje u stvarnom vremenu  

## 🚀 Što Slijedi

Nastavite s **[Laboratorijem 03: Postavljanje Okruženja](../03-Setup/README.md)** kako biste:

- Konfigurirali razvojna okruženja prema najboljim praksama sigurnosti  
- Postavili Azure usluge za autentifikaciju i praćenje  
- Implementirali sigurne veze s bazom podataka i upravljanje tajnama  
- Validirali sigurnosne konfiguracije u razvojnim okruženjima  

## 📚 Dodatni Resursi

### Sigurnost u Azureu
- [Azure Entra ID Dokumentacija](https://docs.microsoft.com/azure/active-directory/) - Vodič za kompletnu platformu identiteta  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Usluga za upravljanje tajnama  
- [Najbolje Prakse Sigurnosti u Azureu](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Smjernice za sigurnost  

### Sigurnost Baza Podataka
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Službena dokumentacija za RLS  
- [Popis za Sigurnost Baza Podataka](https://www.postgresql.org/docs/current/security.html) - Vodič za sigurnost PostgreSQL-a  
- [Obrasci za Višekorisničke Baze Podataka](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Obrasci arhitekture  

### Testiranje Sigurnosti
- [OWASP Vodič za Testiranje](https://owasp.org/www-project-web-security-testing-guide/) - Sveobuhvatno testiranje sigurnosti  
- [Najbolje Prakse za JWT Sigurnost](https://tools.ietf.org/html/rfc8725) - Razmatranja sigurnosti za JWT  
- [Testiranje Sigurnosti API-ja](https://owasp.org/www-project-api-security/) - Testiranje specifično za API-je  

---

**Prethodno**: [Laboratorij 01: Osnovni Koncepti Arhitekture](../01-Architecture/README.md)  
**Sljedeće**: [Laboratorij 03: Postavljanje Okruženja](../03-Setup/README.md)  
