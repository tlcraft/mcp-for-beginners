...
Ovaj laboratorij pruža detaljne smjernice za testiranje i otklanjanje pogrešaka MCP servera u produkcijskim okruženjima. Naučit ćete kako implementirati robusne strategije testiranja, otkloniti složene probleme i osigurati pouzdan rad MCP servera u različitim uvjetima.

## Pregled

Testiranje MCP servera zahtijeva višeslojni pristup koji obuhvaća jedinične testove, integracijske testove, validaciju performansi i testiranje stvarnih scenarija. Ovaj laboratorij pokriva cijeli životni ciklus testiranja, od razvoja do praćenja u produkciji.

Naša strategija testiranja naglašava pouzdanost, sigurnost i performanse, osiguravajući da MCP server može podnijeti produkcijska opterećenja uz očuvanje integriteta podataka i kvalitete korisničkog iskustva.

## Ciljevi učenja

Na kraju ovog laboratorija, moći ćete:

- **Implementirati** sveobuhvatne jedinične i integracijske testne pakete
- **Dizajnirati** učinkovite strategije testiranja za MCP alate i operacije baze podataka
- **Otkloniti** složene probleme koristeći napredne tehnike otklanjanja pogrešaka
- **Validirati** performanse pod opterećenjem kroz realistične scenarije testiranja
- **Pratiti** produkcijske sustave uz učinkovito upozoravanje i promatranje
- **Automatizirati** tijekove testiranja za kontinuiranu integraciju
...
### Testiranje tijeka rada od početka do kraja
...
### Okvir za testiranje opterećenja
...
### Napredni okvir za otklanjanje pogrešaka
...
✅ **Sveobuhvatan okvir za testiranje**: Jedinične, integracijske i testove performansi za sve komponente  
✅ **Napredne alate za otklanjanje pogrešaka**: Sofisticirani alati za otklanjanje pogrešaka s praćenjem izvršenja  
✅ **Validaciju performansi**: Testiranje opterećenja i analizu skalabilnosti  
✅ **Sigurnosno testiranje**: Prevencija SQL injekcija i validacija RLS-a  
✅ **Integraciju praćenja**: Metrike performansi i analizu uskih grla  
✅ **Spremnost za CI/CD**: Automatizirani tijekovi testiranja za kontinuiranu integraciju  

## 🚀 Što slijedi

Nastavite s **[Lab 09: Integracija s VS Code](../09-VS-Code/README.md)** kako biste:

- Konfigurirali VS Code za razvoj MCP servera
- Postavili okruženja za otklanjanje pogrešaka u VS Code-u
- Integrirali MCP server s VS Code Chatom
- Testirali cijeli tijek rada u VS Code-u

## 📚 Dodatni resursi

### Okviri za testiranje
- [pytest Dokumentacija](https://docs.pytest.org/) - Python okvir za testiranje
- [AsyncPG Testiranje](https://magicstack.github.io/asyncpg/current/index.html) - Testiranje Async PostgreSQL-a
- [FastAPI Testiranje](https://fastapi.tiangolo.com/tutorial/testing/) - Obrasci za testiranje API-ja

### Testiranje performansi
- [Najbolje prakse za testiranje opterećenja](https://docs.python.org/3/library/asyncio.html) - Testiranje performansi s Async-om
- [Testiranje performansi baze podataka](https://www.postgresql.org/docs/current/performance-tips.html) - Optimizacija PostgreSQL-a
- [Profiliranje memorije](https://docs.python.org/3/library/tracemalloc.html) - Analiza memorije u Pythonu

### Alati za otklanjanje pogrešaka
- [Otklanjanje pogrešaka u Pythonu](https://docs.python.org/3/library/pdb.html) - Python debugger
- [Otklanjanje pogrešaka u Async-u](https://docs.python.org/3/library/asyncio-dev.html) - Debugging Asyncio-a
- [SQL Otklanjanje pogrešaka](https://www.postgresql.org/docs/current/runtime-config-logging.html) - PostgreSQL logiranje

---

**Prethodno**: [Lab 07: Integracija semantičkog pretraživanja](../07-Semantic-Search/README.md)  
**Sljedeće**: [Lab 09: Integracija s VS Code](../09-VS-Code/README.md)
