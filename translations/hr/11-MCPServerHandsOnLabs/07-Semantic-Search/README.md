...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:36:51+00:00",
  "source_file": "11-MCPServerHandsOnLabs/07-Semantic-Search/README.md",
  "language_code": "hr"
}
-->
# Integracija semantičke pretrage

## 🎯 Što ovaj laboratorij pokriva

Ovaj laboratorij pruža detaljne upute za implementaciju mogućnosti semantičke pretrage koristeći Azure OpenAI ugrađivanja i PostgreSQL-ov pgvector proširenje. Naučit ćete kako izgraditi AI-pokretanu pretragu proizvoda koja razumije upite u prirodnom jeziku i pruža relevantne rezultate na temelju semantičke sličnosti.

## Pregled

Tradicionalna pretraga temeljena na ključnim riječima često ne uspijeva uhvatiti namjeru korisnika i semantičko značenje. Semantička pretraga pomoću vektorskih ugrađivanja omogućuje upite u prirodnom jeziku poput "udobne tenisice za trčanje po kišnom vremenu" da pronađu relevantne proizvode čak i ako te točne riječi ne postoje u opisima proizvoda.

Naša implementacija kombinira moćne modele ugrađivanja Azure OpenAI-a s PostgreSQL-ovim pgvector proširenjem kako bi stvorila visokoučinkovit, skalabilan sustav semantičke pretrage koji poboljšava iskustvo kupovine inteligentnim otkrivanjem proizvoda.

## Ciljevi učenja

Na kraju ovog laboratorija, moći ćete:

- **Integrirati** Azure OpenAI modele ugrađivanja za vektorizaciju teksta
- **Implementirati** pgvector za učinkovite operacije pretrage po sličnosti
- **Izgraditi** alate za semantičku pretragu za upite o proizvodima u prirodnom jeziku
- **Kreirati** hibridnu pretragu koja kombinira tradicionalnu i vektorsku pretragu
- **Optimizirati** vektorske upite za performanse u produkciji
- **Dizajnirati** sustave preporuka koristeći sličnost ugrađivanja

## 🧠 Arhitektura semantičke pretrage

### Cjevovod vektorske pretrage
...
### Strategija generiranja ugrađivanja
...
## 🔍 Generiranje ugrađivanja proizvoda

### Automatizirani cjevovod za ugrađivanje
...
## 🔎 Alati za semantičku pretragu

### Alat za semantičku pretragu proizvoda
...
### Strategija predmemoriranja ugrađivanja
...
✅ **Integraciju Azure OpenAI-a**: Kompletno generiranje ugrađivanja s predmemoriranjem i optimizacijom  
✅ **Implementaciju vektorske pretrage**: Semantičku pretragu spremnu za produkciju s pgvectorom  
✅ **Hibridne mogućnosti pretrage**: Kombinaciju pretrage po ključnim riječima i semantičke pretrage za optimalne rezultate  
✅ **Sustave preporuka**: AI-pokretane preporuke proizvoda koristeći sličnost  
✅ **Optimizaciju performansi**: Optimizaciju vektorskih indeksa i inteligentno predmemoriranje  
✅ **Skalabilnu arhitekturu**: Semantičku pretragu spremnu za poduzeća  

## 🚀 Što slijedi

Nastavite s **[Laboratorijem 08: Testiranje i otklanjanje pogrešaka](../08-Testing/README.md)** kako biste:

- Implementirali sveobuhvatne strategije testiranja za semantičku pretragu
- Otklonili probleme s performansama vektorske pretrage
- Validirali kvalitetu i relevantnost ugrađivanja
- Testirali točnost sustava preporuka

## 📚 Dodatni resursi

### Azure OpenAI
- [Dokumentacija za Azure OpenAI uslugu](https://docs.microsoft.com/azure/cognitive-services/openai/) - Kompletan vodič za uslugu
- [Referenca za Embeddings API](https://platform.openai.com/docs/api-reference/embeddings) - Dokumentacija API-ja
- [Najbolje prakse za ugrađivanja](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Smjernice za implementaciju

### Vektorske baze podataka
- [Dokumentacija za pgvector](https://github.com/pgvector/pgvector) - PostgreSQL proširenje za vektore
- [Optimizacija vektorske pretrage](https://www.pinecone.io/learn/vector-search-optimization/) - Podešavanje performansi
- [HNSW algoritam](https://arxiv.org/abs/1603.09320) - Hijerarhijski navigabilni mali svjetovi

### Semantička pretraga
- [Osnove pretraživanja informacija](https://nlp.stanford.edu/IR-book/) - Stanfordov udžbenik o pretraživanju informacija
- [Najbolje prakse za vektorsku pretragu](https://weaviate.io/blog/vector-search-best-practices) - Obrasci implementacije
- [Strategije hibridne pretrage](https://blog.vespa.ai/hybrid-search/) - Kombiniranje različitih pristupa pretrazi

---

**Prethodno**: [Laboratorij 06: Razvoj alata](../06-Tools/README.md)  
**Sljedeće**: [Laboratorij 08: Testiranje i otklanjanje pogrešaka](../08-Testing/README.md)
