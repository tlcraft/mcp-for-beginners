...
## 🎯 Što Ova Radionica Obuhvaća

Ova radionica pruža detaljne upute za implementaciju praćenja, promatranja i upozorenja za vaš MCP poslužitelj u produkcijskim okruženjima. Naučit ćete kako postaviti Application Insights, kreirati korisne nadzorne ploče, implementirati učinkovita upozorenja i uspostaviti radne procese za rješavanje problema radi operativne izvrsnosti.

## Pregled

Učinkovito praćenje i promatranje ključni su za održavanje pouzdanih MCP poslužitelja u produkciji. Ova radionica obuhvaća tri stupa promatranja—metrike, zapise i tragove—i pokazuje kako implementirati sveobuhvatno praćenje koje omogućuje proaktivno otkrivanje problema i brzo rješavanje.

Naučit ćete kako pretvoriti sirove podatke telemetrije u korisne uvide koji pomažu u razumijevanju ponašanja sustava, optimizaciji performansi i osiguravanju visoke dostupnosti.

## Ciljevi Učenja

Na kraju ove radionice, moći ćete:

- **Implementirati** sveobuhvatnu integraciju Application Insights za MCP poslužitelje
- **Dizajnirati** strukturirane obrasce zapisivanja za učinkovito rješavanje problema
- **Kreirati** sustave za prikupljanje i analizu performansnih metrika
- **Konfigurirati** inteligentna upozorenja s korisnim obavijestima
- **Izgraditi** operativne nadzorne ploče za praćenje u stvarnom vremenu
- **Uspostaviti** učinkovite radne procese za rješavanje problema i priručnike

## 📊 Integracija Application Insights

### Postavljanje Application Insights
...
### Poboljšano Zapisivanje sa Strukturiranim Podacima
...
### Inteligentni Sustav Upozorenja
...
### Implementacija Prilagođenih Nadzornih Ploča
...
## 🔍 Radni Procesi za Rješavanje Problema
...
✅ **Integraciju Application Insights**: Potpuno postavljen sustav telemetrije i praćenja  
✅ **Strukturirano Zapisivanje**: Zapisivanje spremno za produkciju s korelacijom i kontekstom  
✅ **Prilagođene Metrike**: Prikupljanje i analiza poslovnih i tehničkih metrika  
✅ **Inteligentna Upozorenja**: Proaktivna upozorenja s više kanala obavijesti  
✅ **Operativne Nadzorne Ploče**: Praćenje u stvarnom vremenu i poslovni uvidi  
✅ **Radni Procesi za Rješavanje Problema**: Automatizirana dijagnostika i operativni priručnici  

## 🚀 Što Slijedi

Nastavite s **[Radionicom 12: Najbolje Prakse i Optimizacija](../12-Best-Practices/README.md)** kako biste:

- Primijenili tehnike optimizacije performansi
- Implementirali sveobuhvatno jačanje sigurnosti
- Naučili najbolje prakse za produkcijsko postavljanje
- Uspostavili strategije za optimizaciju troškova

## 📚 Dodatni Resursi

### Azure Monitor
- [Dokumentacija Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Potpuni vodič za praćenje
- [Referenca KQL Upita](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Jezik upita za Application Insights
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - Kreiranje prilagođenih nadzornih ploča

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - Vodič za instrumentaciju
- [Distribuirano Praćenje](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - Koncepti praćenja
- [Prikupljanje Metrika](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - Najbolje prakse za metrike

### Operativna Izvrsnost
- [SRE Priručnik](https://sre.google/sre-book/table-of-contents/) - Principi Site Reliability Engineeringa
- [Najbolje Prakse za Praćenje](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - Industrijske najbolje prakse
- [Odgovor na Incidente](https://response.pagerduty.com/) - Vodič za upravljanje incidentima

---

**Prethodno**: [Radionica 10: Strategije Postavljanja](../10-Deployment/README.md)  
**Sljedeće**: [Radionica 12: Najbolje Prakse i Optimizacija](../12-Best-Practices/README.md)
