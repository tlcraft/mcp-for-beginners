...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T22:11:29+00:00",
...
Evo kako ćemo pristupiti zadatku na visokoj razini:
...
Odlično, sada kada razumijemo tijek, konfigurirajmo AI agenta kako bi koristio vanjske alate putem MCP-a, čime ćemo poboljšati njegove mogućnosti!
...
1. U sekciji **Catalog**, odaberite **Models** za otvaranje **Model Catalog**. Odabirom **Models** otvara se **Model Catalog** u novom editor tabu.
1. U traku za pretraživanje **Model Catalog**, unesite **OpenAI GPT-4o**.
...
1. Otvorite **AI Toolkit** ekstenziju iz **Activity Bar**.
1. U sekciji **Tools**, odaberite **Agent (Prompt) Builder**. Odabirom **Agent (Prompt) Builder** otvara se **Agent (Prompt) Builder** u novom editor tabu.
...
Sada kada ste definirali sistemski prompt agenta—usmjeravajući njegovo ponašanje i odgovore—vrijeme je da opremite agenta praktičnim mogućnostima. U ovom dijelu kreirat ćete MCP server kalkulatora s alatima za izvođenje zbrajanja, oduzimanja, množenja i dijeljenja. Ovaj server omogućit će vašem agentu da izvodi matematičke operacije u stvarnom vremenu kao odgovor na upite prirodnog jezika.
...
1. Pritisnite `F5` za pokretanje MCP servera u načinu za ispravljanje pogrešaka. **Agent (Prompt) Builder** će se otvoriti u novom editor tabu. Status servera vidljiv je u terminalu.
...
1. Evo što bi se trebalo dogoditi:
    ...
    - Odgovor svakog alata prikazuje se u odgovarajućem **Tool Response**.
    - Konačni izlaz modela prikazuje se u **Model Response**.
1. Pošaljite dodatne upite kako biste dodatno testirali agenta. Možete izmijeniti postojeći upit u polju **User prompt** klikom na polje i zamjenom postojećeg upita.
