...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T17:31:53+00:00",
...
1. U sekciji **Catalog**, odaberite **Models** za otvaranje **Model Catalog**. Odabir **Models** otvara **Model Catalog** u novom editor tabu.
...
1. Pritisnite `F5` za pokretanje debugiranja MCP servera. **Agent (Prompt) Builder** će se otvoriti u novom editor tabu. Status servera vidljiv je u terminalu.
1. U polju **User prompt** u **Agent (Prompt) Builder**, unesite sljedeći upit: `Kupio sam 3 artikla po cijeni od $25 svaki, a zatim iskoristio popust od $20. Koliko sam platio?`
