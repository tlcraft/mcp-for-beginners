...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T17:23:28+00:00",
...
> **Trenutni Standard**: Ovaj vodič odražava sigurnosne zahtjeve [MCP Specifikacije 2025-06-18](https://spec.modelcontextprotocol.io/specification/2025-06-18/) i službene [MCP Sigurnosne Najbolje Prakse](https://modelcontextprotocol.io/specification/2025-06-18/basic/security_best_practices).

Sigurnost je ključna za MCP implementacije, posebno u poslovnim okruženjima. Ovaj napredni vodič istražuje sveobuhvatne sigurnosne prakse za MCP implementacije u produkciji, obrađujući kako tradicionalne sigurnosne izazove, tako i prijetnje specifične za umjetnu inteligenciju koje su jedinstvene za Model Context Protocol.

## Uvod

Model Context Protocol (MCP) donosi jedinstvene sigurnosne izazove koji nadilaze tradicionalnu sigurnost softvera. Kako AI sustavi dobivaju pristup alatima, podacima i vanjskim uslugama, pojavljuju se novi vektori napada, uključujući ubrizgavanje prompta, trovanje alata, otmicu sesija, probleme s "zbunjenim zamjenikom" i ranjivosti prijenosa tokena.

Ova lekcija istražuje napredne sigurnosne implementacije temeljene na najnovijoj MCP specifikaciji (2025-06-18), Microsoftovim sigurnosnim rješenjima i uspostavljenim sigurnosnim obrascima za poduzeća.

### **Osnovna Sigurnosna Načela**

**Iz MCP Specifikacije (2025-06-18):**

- **Izričite Zabrane**: MCP serveri **NE SMIJU** prihvaćati tokene koji nisu izdani za njih i **NE SMIJU** koristiti sesije za autentifikaciju  
- **Obavezna Provjera**: Svi dolazni zahtjevi **MORAJU** biti provjereni, a korisnički pristanak **MORA** biti dobiven za proxy operacije  
- **Sigurni Zadani Postavci**: Implementirati sigurnosne kontrole koje su otporne na kvarove s višeslojnim pristupom obrani  
- **Kontrola Korisnika**: Korisnici moraju dati izričit pristanak prije pristupa podacima ili izvršavanja alata  

## Ciljevi Učenja

Na kraju ove napredne lekcije, moći ćete:

- **Implementirati Naprednu Autentifikaciju**: Postaviti integraciju s vanjskim pružateljima identiteta poput Microsoft Entra ID-a i sigurnosne obrasce OAuth 2.1  
- **Spriječiti Napade Specifične za AI**: Zaštititi se od ubrizgavanja prompta, trovanja alata i otmice sesija koristeći Microsoft Prompt Shields i Azure Content Safety  
- **Primijeniti Sigurnost za Poduzeća**: Implementirati sveobuhvatno bilježenje, praćenje i odgovor na incidente za MCP implementacije u produkciji  
- **Osigurati Izvršavanje Alata**: Dizajnirati izolirana okruženja za izvršavanje s odgovarajućim kontrolama resursa  
- **Rješavati MCP Ranjivosti**: Identificirati i ublažiti probleme s "zbunjenim zamjenikom", ranjivosti prijenosa tokena i rizike u opskrbnom lancu  
...
### **Kritični Zahtjevi iz MCP Specifikacije (2025-06-18):**
...
## Napredna Autentifikacija i Autorizacija

Moderne MCP implementacije imaju koristi od evolucije specifikacije prema delegaciji vanjskim pružateljima identiteta, značajno poboljšavajući sigurnosni položaj u odnosu na prilagođene implementacije autentifikacije.

### **Integracija Microsoft Entra ID-a**

Trenutna MCP specifikacija (2025-06-18) omogućuje delegaciju vanjskim pružateljima identiteta poput Microsoft Entra ID-a, pružajući sigurnosne značajke na razini poduzeća:

**Sigurnosne Prednosti:**
- Višefaktorska autentifikacija (MFA) na razini poduzeća  
- Pravila uvjetnog pristupa temeljena na procjeni rizika  
- Centralizirano upravljanje životnim ciklusom identiteta  
- Napredna zaštita od prijetnji i otkrivanje anomalija  
- Usklađenost s sigurnosnim standardima za poduzeća  

### .NET Implementacija s Entra ID-om
...
### Java Spring Security s OAuth 2.1 Integracijom

Poboljšana implementacija Spring Security-ja koja slijedi sigurnosne obrasce OAuth 2.1 zahtijevane MCP specifikacijom:
...
## Sigurnosne Kontrole Specifične za AI i Microsoft Rješenja

### **Obrana od Ubrizgavanja Prompta s Microsoft Prompt Shields**

Moderne MCP implementacije suočavaju se sa sofisticiranim napadima specifičnim za AI koji zahtijevaju specijalizirane obrane:
...
## Napredno Ublažavanje MCP Sigurnosnih Prijetnji

### **1. Prevencija Napada "Zbunjenog Zamjenika"**

**Poboljšana Implementacija Prema MCP Specifikaciji (2025-06-18):**
...
## Integracija i Praćenje Sigurnosti za Poduzeća

### **Sveobuhvatno Bilježenje s Azure Application Insights**
...
## Sažetak Najboljih Praksi i Smjernice za Poduzeća

### **Kritična Lista za Implementaciju**

Autentifikacija i Autorizacija:
  Integracija s vanjskim pružateljem identiteta (Microsoft Entra ID)  
  Provjera publike tokena (OBAVEZNO)  
  Bez autentifikacije temeljene na sesijama  
  Sveobuhvatna provjera zahtjeva  

Sigurnosne Kontrole za AI:
  Integracija Microsoft Prompt Shields  
  Pregledavanje sadržaja s Azure Content Safety  
  Otkrivanje trovanja alata  
  Provjera izlaznog sadržaja  

Sigurnost Sesija:
  Kriptografski sigurni ID-ovi sesija  
  Vezivanje sesija za specifične korisnike  
  Otkrivanje otmice sesija  
  Provođenje HTTPS transporta  

OAuth i Proxy Sigurnost:
  Implementacija PKCE (OAuth 2.1)  
  Izričit korisnički pristanak za dinamičke klijente  
  Stroga provjera URI-ja za preusmjeravanje  
  Bez prijenosa tokena (OBAVEZNO)  

Integracija za Poduzeća:
  Azure Key Vault za upravljanje tajnama  
  Application Insights za praćenje sigurnosti  
  GitHub Advanced Security za opskrbni lanac  
  Microsoft Defender za DevOps integraciju  

Praćenje i Odgovor:
  Sveobuhvatno bilježenje sigurnosnih događaja  
...
- **Integrirani Sigurnosni Položaj**: Ujedinjena sigurnost za identitet, infrastrukturu i aplikacije  
- **Napredna AI Zaštita**: Obrane posebno dizajnirane za prijetnje specifične za AI  
- **Usklađenost za Poduzeća**: Ugrađena podrška za regulatorne zahtjeve i industrijske standarde  
- **Obavještajni Podaci o Prijetnjama**: Integracija globalnih obavještajnih podataka za proaktivnu zaštitu  
- **Skalabilna Arhitektura**: Skaliranje na razini poduzeća uz održavanje sigurnosnih kontrola  
...
- **[MCP Specifikacija za Autorizaciju](https://modelcontextprotocol.io/specification/2025-06-18/basic/authorization)**  
...
> **Sigurnosna Napomena**: Ovaj vodič za naprednu implementaciju odražava trenutne zahtjeve MCP specifikacije (2025-06-18). Uvijek provjerite najnoviju službenu dokumentaciju i uzmite u obzir svoje specifične sigurnosne zahtjeve i model prijetnji prilikom implementacije ovih kontrola.
