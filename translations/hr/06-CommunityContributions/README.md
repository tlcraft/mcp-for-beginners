...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T17:36:59+00:00",
...
Jedan od najvrjednijih načina doprinosa MCP ekosustavu je kreiranje i dijeljenje prilagođenih MCP servera. Zajednica je već razvila stotine servera za različite usluge i slučajeve upotrebe.
...
- Stack Overflow (tagovi: `model-context-protocol` ili `mcp`)
...
- Doprinos MCP-u može uključivati poboljšanja osnovnog protokola, prilagođene alate i više
