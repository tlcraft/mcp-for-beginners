...
> **NE SMIJE**: MCP serveri **NE SMIJU** prihvaćati tokene koji nisu izričito izdani za MCP server  
> 
...
**Kontrole Autentifikacije i Autorizacije:**  
   ...
   - **Validacija Publike Tokena**: Uvijek provjerite jesu li tokeni izričito izdani za vaš MCP server - nikada ne prihvaćajte uzvodne tokene  
...
**Sigurne Prakse za Sesije:**  
   ...
   - **Veza Specifična za Korisnika**: Povežite ID-ove sesija s identitetima korisnika koristeći formate poput `<user_id>:<session_id>` kako biste spriječili zloupotrebu sesija među korisnicima  
...
**Implementacija Sigurnosti Sadržaja:**  
   ...
   - **Analiza Ponašanja**: Implementirajte praćenje ponašanja u stvarnom vremenu kako biste otkrili anomalije u MCP serveru i izvršavanju alata  
   - **Sveobuhvatno Logiranje**: Zabilježite sve pokušaje autentifikacije, pozive alata i sigurnosne događaje uz sigurnu, nepromjenjivu pohranu  
...
**Održavanje Ažurnosti:**  
   ...
   - **Angažman u Sigurnosnoj Zajednici**: Aktivno sudjelovanje u MCP sigurnosnoj zajednici i programima otkrivanja ranjivosti  
