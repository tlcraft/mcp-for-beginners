...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T22:07:56+00:00",
...
**Trenutni MCP Standard (2025-06-18)** omogućuje MCP poslužiteljima delegiranje autentifikacije vanjskim davateljima identiteta, što predstavlja značajno sigurnosno poboljšanje:
...
2. **Sigurnost na Razini Poduzeća**: Koristi etablirane davatelje identiteta poput Microsoft Entra ID s naprednim sigurnosnim značajkama  
...
4. **Višefaktorska Autentifikacija**: Nasljeđuje MFA mogućnosti od davatelja identiteta na razini poduzeća  
...
- **Provjera Izdavatelja**: Validirajte da izdavatelj tokena odgovara očekivanom davatelju identiteta  
...
- **Granice Dozvola**: Jasna razdvajanja između različitih razina privilegija i pristupa resursima  
- **Revizijski Zapisnici**: Potpuno bilježenje svih odluka o autorizaciji za sigurnosno praćenje  
- **Redovite Revizije Pristupa**: Periodična validacija korisničkih dozvola i dodijeljenih privilegija  
...
- **Narušavanje Odgovornosti**: Onemogućuje identifikaciju klijenta, što kvari revizijske tragove i istrage incidenata  
...
- **Sigurno Pohranjivanje**: Koristite hardverske sigurnosne module (HSM) ili sigurne trezore ključeva  
- **Vezivanje Tokena**: Vežite tokene za specifične klijente, sesije ili operacije gdje je to moguće  
- **Praćenje i Upozorenja**: Detekcija u stvarnom vremenu zloupotrebe tokena ili neovlaštenih obrazaca pristupa  
...
- **Imitacija Sesije**: Neovlašteno korištenje ukradenih ID-ova sesija za zaobilaženje autentifikacije  
...
- **Integracija Obavještajnih Podataka o Prijetnjama**: Ažuriranja u stvarnom vremenu o novim prijetnjama u opskrbnom lancu  
