...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T21:13:03+00:00",
...
| **Modul 3: Izrada prvog servera i klijenta** | | | |
...
| 5.13 | Integracija s Foundryjem | Integracija s Azure AI Foundryjem | [Vodič](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
...
| 07 | Uvidi iz rane primjene | Priče o stvarnim implementacijama | [Vodič](./07-LessonsFromEarlyAdoption/README.md) |
...
| 10 | Radionica | Izrada MCP servera s AI Toolkitom | [Laboratorij](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
- Pridruživanje našim zajedničkim diskusijama za podršku

## 📚 Vodič za učenje i resursi

Ovaj repozitorij uključuje nekoliko resursa koji će vam pomoći da se snađete i učite učinkovito:

### Vodič za učenje

Dostupan je sveobuhvatan [Vodič za učenje](./study_guide.md) koji će vam pomoći da učinkovito navigirate ovim repozitorijem. Vodič uključuje:
...
Prikazi stvarnog svijeta kroz VS Code, Visual Studio, GitHub Copilot i popularne alate zajednice
...
Naučite kroz intenzivne video sesije kako stvoriti MCP servere, integrirati ih s VS Codeom i profesionalno ih implementirati na Azureu na temelju sadržaja iz MCP za početnike kurikuluma. Steknite praktične vještine u tehnologiji koju već koriste velike tvrtke.
...
Naučimo o Model Context Protocolu (MCP), naprednom okviru dizajniranom za standardizaciju interakcija između AI modela i klijentskih aplikacija. Kroz ovu sesiju prilagođenu početnicima, predstavit ćemo vam MCP i voditi vas kroz stvaranje vašeg prvog MCP servera.
...
Ugovorom o licenci za doprinos (CLA) koji izjavljuje da imate pravo i stvarno dajete
prava za korištenje vašeg doprinosa. Za detalje, posjetite 
<https://cla.opensource.microsoft.com>.

Kada pošaljete pull request, CLA bot automatski će odrediti trebate li dostaviti
