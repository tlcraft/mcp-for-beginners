...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T17:11:32+00:00",
...
- **4 Использование режима агента GitHub Copilot сервера в Visual Studio Code** — здесь мы рассмотрим запуск MCP Server прямо из Visual Studio Code, [к уроку](04-vscode/README.md)
...
- **7 Использование AI Toolkit для VSCode** для работы с MCP-клиентами и серверами и их тестирования, [к уроку](07-aitk/README.md)
...
Model Context Protocol (MCP) — это открытый протокол, стандартизирующий способ предоставления контекста LLM-приложениям. Представьте MCP как USB-C порт для AI-приложений — он обеспечивает единый способ подключения AI-моделей к различным источникам данных и инструментам.
