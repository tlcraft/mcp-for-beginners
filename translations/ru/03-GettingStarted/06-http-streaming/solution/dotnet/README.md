...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T21:02:21+00:00",
...
Перед выполнением следующей команды откройте отдельный терминал (убедитесь, что сервер всё ещё запущен).
...
Это запустит веб-сервер с визуальным интерфейсом, позволяющим тестировать пример.

> Убедитесь, что в качестве типа транспорта выбран **Streamable HTTP**, а URL — `http://localhost:3001/mcp`.
