...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-02T16:52:57+00:00",
...
> [!NOTE]
> В поле "command" команда может выглядеть иначе, так как содержит команду запуска сервера для вашего конкретного окружения/рантайма.
...
- Настройка среды разработки MCP проста благодаря SDK для разных языков
- Создание MCP серверов включает в себя создание и регистрацию инструментов с четко определёнными схемами
