...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-02T10:26:25+00:00",
...
> [!NOTE]
> Команда в поле "command" может выглядеть иначе, так как она содержит команду для запуска сервера с вашим конкретным рантаймом.

Вы увидите следующий интерфейс пользователя:
