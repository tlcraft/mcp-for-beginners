...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T14:50:09+00:00",
...
7. **Вклад сообщества (06-CommunityContributions/)**
   ...
   - Улучшения и обратная связь, инициированные сообществом
...
8. **Уроки раннего внедрения (07-LessonsfromEarlyAdoption/)**
   - Реальные реализации и успешные примеры
...
11. **Практический семинар (10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/)**
    ...
    - **Структура лабораторий**:
      - Лаборатория 1: Основы серверов MCP
      - Лаборатория 2: Продвинутая разработка серверов MCP
...
12. **Лаборатории интеграции серверов MCP с базами данных (11-MCPServerHandsOnLabs/)**
    ...
    - **Корпоративные шаблоны** включая безопасность на уровне строк (RLS), семантический поиск и доступ к данным для нескольких арендаторов
    ...
    - **Результаты обучения**: Готовые к производству серверы MCP, шаблоны интеграции баз данных, аналитика на основе AI, корпоративная безопасность
...
4. **Продвинутое изучение**: После освоения основ углубитесь в продвинутые темы для расширения знаний.
