...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T15:28:23+00:00",
...
Этот практикум предоставляет подробное руководство по внедрению мониторинга, наблюдаемости и оповещений для вашего MCP сервера в производственных средах. Вы научитесь настраивать Application Insights, создавать информативные панели мониторинга, реализовывать эффективные оповещения и устанавливать рабочие процессы для устранения неполадок, обеспечивая высокий уровень операционной эффективности.

## Обзор

Эффективный мониторинг и наблюдаемость играют ключевую роль в поддержании надежности MCP серверов в производственной среде. В этом практикуме рассматриваются три столпа наблюдаемости — метрики, логи и трассировки — и показано, как реализовать комплексный мониторинг, который позволяет заранее выявлять проблемы и быстро их решать.

Вы научитесь преобразовывать необработанные данные телеметрии в полезные инсайты, которые помогут вам понять поведение системы, оптимизировать производительность и обеспечить высокую доступность.

## Цели обучения

К концу этого практикума вы сможете:

- **Реализовать** комплексную интеграцию Application Insights для MCP серверов  
- **Разработать** структурированные шаблоны логирования для эффективного устранения неполадок  
- **Создать** системы сбора и анализа производственных метрик  
- **Настроить** интеллектуальные оповещения с полезными уведомлениями  
- **Построить** операционные панели мониторинга для наблюдения в реальном времени  
- **Установить** эффективные рабочие процессы и инструкции для устранения неполадок  
...
### Улучшенное логирование с использованием структурированных данных
...
### Реализация пользовательских панелей мониторинга
...
✅ **Интеграцию Application Insights**: Полная настройка телеметрии и мониторинга  
✅ **Структурированное логирование**: Логирование, готовое к производственной среде, с корреляцией и контекстом  
✅ **Пользовательские метрики**: Сбор и анализ бизнес- и технических метрик  
✅ **Интеллектуальные оповещения**: Проактивные оповещения с использованием нескольких каналов уведомлений  
✅ **Операционные панели мониторинга**: Наблюдение в реальном времени и бизнес-аналитика  
✅ **Рабочие процессы устранения неполадок**: Автоматизированная диагностика и операционные инструкции  

## 🚀 Что дальше

Продолжите с **[Практикум 12: Лучшие практики и оптимизация](../12-Best-Practices/README.md)**, чтобы:

- Применить методы оптимизации производительности  
- Реализовать комплексное усиление безопасности  
- Узнать лучшие практики развертывания в производственной среде  
- Установить стратегии оптимизации затрат  

## 📚 Дополнительные ресурсы

### Azure Monitor
- [Документация Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Полное руководство по мониторингу  
- [Справочник запросов KQL](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Язык запросов для Application Insights  
- [Рабочие книги Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - Создание пользовательских панелей мониторинга  

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - Руководство по инструментированию  
- [Распределённая трассировка](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - Концепции трассировки  
- [Сбор метрик](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - Лучшие практики для метрик  

### Операционная эффективность
- [Руководство SRE](https://sre.google/sre-book/table-of-contents/) - Принципы инженерии надёжности сайта  
- [Лучшие практики мониторинга](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - Отраслевые лучшие практики  
- [Управление инцидентами](https://response.pagerduty.com/) - Руководство по управлению инцидентами  

---

**Предыдущий**: [Практикум 10: Стратегии развертывания](../10-Deployment/README.md)  
**Следующий**: [Практикум 12: Лучшие практики и оптимизация](../12-Best-Practices/README.md)  
