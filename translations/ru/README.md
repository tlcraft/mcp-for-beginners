...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-02T05:56:47+00:00",
...
Независимо от того, являетесь ли вы разработчиком AI, системным архитектором или инженером-программистом, это руководство станет вашим универсальным ресурсом для освоения основ MCP и стратегий его внедрения.

## 🔗 Официальные ресурсы MCP

- 📘 [Документация MCP](https://modelcontextprotocol.io/) – Подробные руководства и туториалы  
...
Приготовьтесь к двум дням глубоких технических знаний, общения с сообществом и практического обучения на MCP Dev Days — виртуальном событии, посвящённом Model Context Protocol (MCP), новому стандарту, который объединяет AI-модели и инструменты, на которых они основаны.

➡️ [Регистрация на MCP Dev Days](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

Вы сможете смотреть MCP Dev Days, зарегистрировавшись на странице мероприятия: https://aka.ms/mcpdevdays. Оттуда будет доступна прямая трансляция на YouTube или Twitch. Все материалы будут записаны и доступны позже на канале Microsoft Developer на YouTube. Исходный код демонстраций также будет опубликован на GitHub.

### Информация о мероприятии
- Даты: 29 июля (День 1) и 30 июля (День 2)
- Время: ежедневно в 9:00 по тихоокеанскому времени
- Место проведения: онлайн — присоединяйтесь откуда угодно!

#### День 1: Производительность MCP, DevTools и сообщество

Посвящён тому, чтобы помочь разработчикам эффективно использовать MCP в своей работе и отметить вклад сообщества MCP. В мероприятии примут участие участники сообщества и партнёры, такие как Arcade, Block, Okta и Neon, чтобы показать, как они сотрудничают с Microsoft для создания открытой и расширяемой экосистемы MCP. Реальные демонстрации в VS Code, Visual Studio, GitHub Copilot и популярных инструментах сообщества.  
Практические, ориентированные на контекст рабочие процессы разработки  
Сессии и инсайты от сообщества  
Если вы только начинаете знакомиться с MCP или уже работаете с ним, День 1 даст вам вдохновение и полезные советы для дальнейшей работы.

#### День 2: Уверенная разработка MCP серверов

Для разработчиков MCP. Мы подробно рассмотрим стратегии реализации и лучшие практики создания MCP серверов и интеграции MCP в AI-рабочие процессы.

### Темы включают:

- Создание MCP серверов и их интеграция в агентские решения  
- Разработка с использованием prompt-driven подхода  
- Лучшие практики безопасности  
- Использование строительных блоков, таких как Functions, ACA и API Management  
- Согласование с реестром и инструменты (1P + 3P)

Если вы разработчик, создатель инструментов или AI-продуктовый стратег, этот день будет наполнен важными знаниями для создания масштабируемых, безопасных и готовых к будущему MCP решений.
...
- **3.6. HTTP Streaming** – [Руководство](./03-GettingStarted/06-http-streaming/README.md)
...
- **04. Практическая реализация**  
  SDK, отладка, тестирование, переиспользуемые шаблоны prompt’ов. [Подробнее](./04-PracticalImplementation/README.md)
...
- **07. Опыт раннего внедрения** – [Руководство](./07-LessonsFromEarlyAdoption/README.md)
- **08. Лучшие практики MCP** – [Руководство](./08-BestPractices/README.md)
- **09. Кейсы MCP** – [Руководство](./09-CaseStudy/README.md)
</details>

### Практическая лабораторная работа Model Context Protocol с AI Toolkit для VScode  
<details>
  <summary><strong>Урок 10: Практическая лабораторная работа по созданию MCP сервера с AI Toolkit для VScode</strong></summary>
    
- **10. Оптимизация AI рабочих процессов: создание MCP сервера с AI Toolkit** – [Практическая работа](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md)
</details>

## Пример проектов Model Context Protocol: создание MCP калькулятора на Java, C#, JavaScript, TypeScript и Python

### 🧮 Примеры MCP калькулятора на Java, C#, JavaScript, TypeScript и Python  
<details>
  <summary><strong>Изучите реализацию кода по языкам</strong></summary>
...
### 💡 Продвинутые примеры MCP: проекты калькулятора на C#, Java, JavaScript, TypeScript и Python  
<details>
  ...
  - [Пример Java контейнерного приложения](./04-PracticalImplementation/samples/java/containerapp/README.md)
...
Чтобы максимально эффективно усвоить материал, рекомендуется иметь:
...
Доступно подробное [Учебное руководство](./study_guide.md), которое поможет вам эффективно ориентироваться в этом репозитории. В руководстве представлены:
...
Этот проект приветствует ваши предложения и вклад. Большинство вкладов требует согласия с  
...
При отправке pull request, бот CLA автоматически определит, нужно ли вам подписывать CLA, и отметит PR соответствующим образом (например, проверкой статуса, комментарием). Просто следуйте инструкциям бота. Это нужно сделать только один раз для всех репозиториев, использующих наш CLA.

В проекте принят [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).  
Больше информации в [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) или по адресу [opencode@microsoft.com](mailto:opencode@microsoft.com) для любых вопросов или комментариев.
...
Использование товарных знаков или логотипов Microsoft в изменённых версиях этого проекта не должно вызывать путаницу или подразумевать спонсорство со стороны Microsoft.
Использование товарных знаков или логотипов третьих лиц подчиняется политикам соответствующих третьих сторон.
