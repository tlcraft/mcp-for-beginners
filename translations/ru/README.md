...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-20T20:15:09+00:00",
...
**Model Context Protocol (MCP)** — это передовая платформа, разработанная для стандартизации взаимодействия между AI-моделями и клиентскими приложениями. Этот открытый курс предлагает структурированный путь обучения с практическими примерами кода и реальными кейсами на популярных языках программирования, таких как C#, Java, JavaScript, TypeScript и Python.
...
| 02 | **Безопасность в MCP** | Определение угроз безопасности в системах на базе MCP, методы и лучшие практики по защите реализации | [Безопасность](./02-Security/README.md) |
...
| 3.1 | **Первый сервер** | Создание простого сервера на основе протокола MCP, понимание взаимодействия клиент-сервер, тестирование сервера | [Первый сервер](./03-GettingStarted/01-first-server/README.md) |
| 3.2 | **Первый клиент** | Создание простого клиента на основе протокола MCP, понимание взаимодействия клиент-сервер, тестирование клиента | [Первый клиент](./03-GettingStarted/02-client/README.md) |
...
| 3.4 | **Использование сервера через Visual Studio Code** | Настройка Visual Studio Code для работы с серверами MCP | [Использование сервера через Visual Studio Code](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | **Создание сервера с SSE** | SSE позволяет сделать сервер доступным через интернет. В этом разделе вы научитесь создавать сервер с помощью SSE | [Создание сервера с SSE](./03-GettingStarted/05-sse-server/README.md) |
...
| 07 | **Уроки раннего внедрения** | Реальные внедрения и успешные практики, создание и развертывание решений на базе MCP, тренды и планы на будущее | [Уроки](./07-LessonsFromEarlyAdoption/README.md) |
...
Чтобы максимально эффективно освоить эту программу, вам понадобятся:
...
Этот проект открыт для вкладов и предложений. Большинство вкладов требуют вашего согласия с  
...
При создании pull request, бот CLA автоматически определит, нужно ли предоставлять CLA, и отметит PR соответствующим образом (например, проверкой статуса или комментарием). Просто следуйте инструкциям бота. Это нужно сделать только один раз для всех репозиториев, использующих наш CLA.

В проекте принят [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).  
Дополнительную информацию смотрите в [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) или  
...
Использование товарных знаков или логотипов Microsoft в изменённых версиях проекта не должно вводить в заблуждение или подразумевать спонсорство со стороны Microsoft.  
Любое использование товарных знаков или логотипов третьих сторон подчиняется их собственным правилам.
