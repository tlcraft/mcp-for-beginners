...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-19T21:28:02+00:00",
...
Независимо от того, являетесь ли вы разработчиком AI, системным архитектором или инженером-программистом, это руководство станет вашим всеобъемлющим ресурсом для освоения основ MCP и стратегий его внедрения.
...
| 01 | **Основные концепции** | Глубокое изучение ключевых понятий MCP, включая архитектуру клиент-сервер, основные компоненты протокола и паттерны обмена сообщениями | [Основные концепции](./01-CoreConcepts/README.md) |
...
| 3.4 | **Работа с сервером через Visual Studio Code** | Настройка Visual Studio Code для работы с серверами через протокол MCP | [Работа с сервером через Visual Studio Code](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | **Создание сервера с использованием SSE** | SSE помогает сделать сервер доступным в интернете. В этом разделе вы научитесь создавать сервер с использованием SSE | [Создание сервера с использованием SSE](./03-GettingStarted/05-sse-server/README.md) |
| 3.6 | **Использование AI Toolkit** | AI Toolkit — отличный инструмент для управления AI и MCP-воркфлоу | [Использование AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
| 3.7 | **Тестирование сервера** | Тестирование — важный этап разработки. В этом разделе вы узнаете, как тестировать с помощью разных инструментов | [Тестирование сервера](./03-GettingStarted/07-testing/README.md) |
...
| 09 | **Кейсы MCP** | Глубокий разбор архитектур решений MCP, шаблоны развертывания и советы по интеграции, аннотированные диаграммы и пошаговые проекты | [Кейсы](./09-CaseStudy/README.md) |

## Примеры проектов

### 🧮 Примеры калькуляторов MCP:
<details>
  <summary><strong>Изучите примеры кода по языкам</strong></summary>
...
### 💡 Продвинутые проекты калькуляторов MCP:
<details>
...
Чтобы максимально эффективно освоить этот курс, у вас должны быть:
...
Этот проект приветствует ваши вклады и предложения. Большинство изменений требуют согласия с Contributor License Agreement (CLA), подтверждающим, что вы имеете право и действительно предоставляете нам права на использование вашего вклада. Подробнее на <https://cla.opensource.microsoft.com>.
...
Для дополнительной информации смотрите [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) или пишите на [opencode@microsoft.com](mailto:opencode@microsoft.com).
