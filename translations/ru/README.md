...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:17:01+00:00",
...
- 📜 [Оригинальная спецификация MCP](https://spec.modelcontextprotocol.io/) – Технические ссылки на старую версию (могут содержать дополнительные детали)  
...
| Java с Spring | Пример приложения-контейнера | [Посмотреть код](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
Доступно подробное [Руководство по обучению](./study_guide.md), которое поможет вам ориентироваться в этом репозитории. В руководстве содержится:

- Визуальная карта учебной программы с охватом всех тем
- Детальный обзор каждой секции репозитория
...
#### [День 1: MCP для продуктивности, DevTools и сообщества](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
...
#### [➡️Смотреть запись MCP Bootcamp | Бразильский](https://developer.microsoft.com/en-us/reactor/series/S-1566/)
...
Давайте изучим Model Context Protocol (MCP), передовую платформу, разработанную для стандартизации взаимодействий между AI-моделями и клиентскими приложениями. В рамках этой сессии для начинающих мы познакомим вас с MCP и покажем, как создать ваш первый сервер MCP.  
...
Спасибо Microsoft Valued Professional [Шиваму Гойалу](https://www.linkedin.com/in/shivam2003/) за вклад в важные примеры кода.
