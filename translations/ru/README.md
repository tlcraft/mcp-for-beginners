...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-27T14:42:07+00:00",
...
**Model Context Protocol (MCP)** — это передовой фреймворк, созданный для стандартизации взаимодействия между ИИ-моделями и клиентскими приложениями. Этот открытый учебный курс предлагает структурированный путь обучения с практическими примерами кода и реальными кейсами на популярных языках программирования, включая C#, Java, JavaScript, TypeScript и Python.
...
- 📘 [Документация MCP](https://modelcontextprotocol.io/) – Подробные уроки и руководства пользователя  
...
- **00. Введение в MCP**  
  Обзор Model Context Protocol и его роли в ИИ-процессах. [Подробнее](./00-Introduction/README.md)
- **01. Основные понятия**  
...
- **3.4. Использование сервера через Visual Studio Code** – [Руководство](./03-GettingStarted/04-vscode/README.md)
...
- **05. Продвинутые темы MCP**  
  Мультимодальный ИИ, масштабирование, корпоративное использование. [Подробнее](./05-AdvancedTopics/README.md)
...
- **5.11. Поиск в реальном времени через веб** – [Руководство](./05-AdvancedTopics/mcp-realtimesearch/README.md)
...
### 💡 Расширенные проекты MCP Calculator:
<details>
...
- Рекомендации по обучающим маршрутам для разных уровней подготовки
...
Благодарим Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) за важный вклад в виде образцов кода. 
...
Этот проект приветствует ваши предложения и вклады. Большинство вкладов требуют согласия с
...
- [Выберите своё приключение с Copilot](https://github.com/microsoft/CopilotAdventures?WT.mc_id=academic-105485-koreyst)
