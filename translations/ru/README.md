...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T07:02:14+00:00",
...
| **Модуль 4-5: Практика и продвинутые темы** | | | |
...
| 5.10 | Реальный стриминг | Создание функционала реального стриминга | [Руководство](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
...
| **Модуль 6-10: Сообщество и лучшие практики** | | | |
...
| 11.3 | Безопасность и многопользовательский доступ | Управление доступом на уровне строк, аутентификация и доступ к данным для нескольких арендаторов | [Lab 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
| 11.4 | Настройка окружения | Настройка среды разработки, Docker, ресурсов Azure | [Lab 03](./11-MCPServerHandsOnLabs/03-Setup/README.md) |
| 11.5 | Проектирование базы данных | Настройка PostgreSQL, проектирование схемы для розничной торговли и создание примеров данных | [Lab 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
| 11.6 | Реализация MCP сервера | Создание сервера FastMCP с интеграцией базы данных | [Lab 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
| 11.7 | Разработка инструментов | Создание инструментов для запросов к базе данных и анализа схемы | [Lab 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
| 11.8 | Семантический поиск | Реализация векторных эмбеддингов с использованием Azure OpenAI и pgvector | [Lab 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
| 11.9 | Тестирование и отладка | Стратегии тестирования, инструменты отладки и подходы к проверке | [Lab 08](./11-MCPServerHandsOnLabs/08-Testing/README.md) |
| 11.10 | Интеграция с VS Code | Настройка интеграции MCP с VS Code и использование AI Chat | [Lab 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
| 11.11 | Стратегии развертывания | Развертывание с помощью Docker, Azure Container Apps и масштабирование | [Lab 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
| 11.12 | Мониторинг | Application Insights, логирование, мониторинг производительности | [Lab 11](./11-MCPServerHandsOnLabs/11-Monitoring/README.md) |
| 11.13 | Лучшие практики | Оптимизация производительности, усиление безопасности и советы для продакшена | [Lab 12](./11-MCPServerHandsOnLabs/12-Best-Practices/README.md) |
...
Детальное [Руководство по обучению](./study_guide.md) доступно для того, чтобы помочь вам эффективно ориентироваться в этом репозитории. В нем содержится:
...
Давайте изучим Model Context Protocol (MCP), передовую структуру, разработанную для стандартизации взаимодействий между AI моделями и клиентскими приложениями. В этом уроке для начинающих мы познакомим вас с MCP и проведем через процесс создания вашего первого MCP сервера.
...
- **11-MCPServerHandsOnLabs/**: Полный учебный путь из 13 лабораторий для создания готовых к продакшену MCP серверов с интеграцией PostgreSQL
...
Этот проект может содержать товарные знаки или логотипы, связанные с проектами, продуктами или услугами. Использование товарных знаков или логотипов Microsoft разрешено только в соответствии с [Руководством по использованию товарных знаков и брендов Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). Использование товарных знаков или логотипов Microsoft в модифицированных версиях этого проекта не должно вызывать путаницу или подразумевать спонсорство со стороны Microsoft. Любое использование товарных знаков или логотипов третьих сторон должно соответствовать политике этих сторон.

## Получение помощи

Если вы столкнулись с трудностями или у вас есть вопросы о создании приложений с искусственным интеллектом, присоединяйтесь:
