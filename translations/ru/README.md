...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-20T15:41:30+00:00",
...
- 📘 [Документация MCP](https://modelcontextprotocol.io/) – Подробные руководства и обучающие материалы  
...
| 01 | **Основные концепции** | Глубокое изучение ключевых понятий MCP: клиент-серверная архитектура, основные компоненты протокола, паттерны обмена сообщениями | [Основные концепции](./01-CoreConcepts/README.md) |
...
| 03 | **Начало работы с MCP** | Настройка среды, создание базовых MCP серверов и клиентов, интеграция MCP в существующие приложения | [Начало работы](./03-GettingStarted/README.md) |
| 3.1 | **Первый сервер** | Настройка базового сервера по протоколу MCP, понимание взаимодействия сервер-клиент, тестирование сервера | [Первый сервер](./03-GettingStarted/01-first-server/README.md) |
| 3.2 | **Первый клиент** | Настройка базового клиента по протоколу MCP, понимание взаимодействия клиент-сервер, тестирование клиента | [Первый клиент](./03-GettingStarted/02-client/README.md) |
| 3.3 | **Клиент с LLM** | Настройка клиента MCP с использованием крупной языковой модели (LLM) | [Клиент с LLM](./03-GettingStarted/03-llm-client/README.md) |
...
| 3.5 | **Создание сервера с помощью SSE** | SSE позволяет сделать сервер доступным в интернете. В этом разделе вы научитесь создавать сервер с использованием SSE | [Создание сервера с помощью SSE](./03-GettingStarted/05-sse-server/README.md) |
...
| 3.7 | **Тестирование сервера** | Тестирование — важная часть разработки. В этом разделе вы узнаете, как использовать различные инструменты для тестирования | [Тестирование сервера](./03-GettingStarted/07-testing/README.md) |
...
Чтобы максимально эффективно использовать эту программу, у вас должны быть:
...
Этот материал лицензирован под **MIT License**. Условия лицензии смотрите в [LICENSE](../../LICENSE).

## 🤝 Руководство по участию

Этот проект приветствует ваши вклад и предложения. Большинство вкладов требуют согласия с  
Contributor License Agreement (CLA), в котором вы подтверждаете, что имеете право и действительно предоставляете  
нам права на использование вашего вклада. Подробнее на <https://cla.opensource.microsoft.com>.

При отправке pull request, бот CLA автоматически определит, нужно ли вам предоставлять  
...
В этом проекте применяется [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).  
...
Использование товарных знаков или логотипов третьих сторон подчиняется правилам этих третьих сторон.
