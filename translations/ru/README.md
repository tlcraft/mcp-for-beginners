...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T23:19:21+00:00",
...
#### День 1: MCP, инструменты разработчика и сообщество
...
Чтобы максимально эффективно использовать этот учебный план, рекомендуется иметь:
...
- **Основной учебный план (00-10)**: Основное содержание, разделенное на десять последовательных модулей
- **images/**: Диаграммы и иллюстрации, используемые в учебном плане
...
- **alternative_layouts/**: Различные форматы представления учебного материала
- **study_guide.md**: Подробное руководство по навигации в репозитории
- **changelog.md**: Запись всех значимых изменений учебных материалов
- **mcp.json**: Конфигурационный файл спецификации MCP
...
Использование товарных знаков или логотипов третьих сторон подчиняется правилам этих третьих лиц.
