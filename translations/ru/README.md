...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T06:54:21+00:00",
...
**Model Context Protocol (MCP)** — это передовая структура, разработанная для стандартизации взаимодействий между AI-моделями и клиентскими приложениями. Этот открытый учебный курс предлагает структурированный путь обучения с практическими примерами кода и реальными кейсами на популярных языках программирования, таких как C#, Java, JavaScript, TypeScript и Python.  

Будь вы разработчиком AI, системным архитектором или инженером-программистом, это руководство станет вашим универсальным ресурсом для освоения основ MCP и стратегий его реализации.  
...
| 3.8 | Тестирование | Тестирование реализации вашего MCP-сервера | [Руководство](./03-GettingStarted/08-testing/README.md) |
...
| 5.3 | OAuth2 Demo | Реализация аутентификации OAuth2 | [Руководство](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
| 5.4 | Root Contexts | Понимание и реализация корневых контекстов | [Руководство](./05-AdvancedTopics/mcp-root-contexts/README.md) |
...
| 5.12 | Аутентификация Entra ID | Аутентификация с использованием Microsoft Entra ID | [Руководство](./05-AdvancedTopics/mcp-security-entra/README.md) |
...
| TypeScript | Пример с контейнером | [View Code](./04-PracticalImplementation/samples/typescript/README.md) |

## 🎯 Необходимые знания для изучения MCP

Чтобы получить максимум от этой программы, вам потребуется:
...
Посвящен тому, чтобы помочь разработчикам использовать MCP в их рабочем процессе и отметить достижения сообщества MCP. Мы пригласим участников сообщества и партнеров, таких как Arcade, Block, Okta и Neon, чтобы показать, как они сотрудничают с Microsoft для создания открытой, расширяемой экосистемы MCP.  
...
Независимо от того, только ли вы начинаете работать с MCP или уже используете его, День 1 вдохновит вас и предоставит полезные рекомендации.  
...
Изучите в интенсивных видеосессиях, как создавать MCP-серверы, интегрировать их с VS Code и профессионально развертывать на Azure, основываясь на содержании учебной программы MCP для начинающих. Получите практические навыки в технологии, которую уже используют крупные компании.
...
права на использование вашего вклада. Подробности смотрите на 
...
- **Основная учебная программа (00-10)**: Основной контент, организованный в десять последовательных модулей
