...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T07:12:50+00:00",
...
В этом руководстве показано, как интегрировать серверы Model Context Protocol (MCP) с агентами Azure AI Foundry, что позволяет создавать мощные инструменты оркестрации и корпоративные AI-решения.

## Введение

Model Context Protocol (MCP) — это открытый стандарт, который позволяет AI-приложениям безопасно подключаться к внешним источникам данных и инструментам. При интеграции с Azure AI Foundry MCP даёт агентам возможность получать доступ и взаимодействовать с различными внешними сервисами, API и источниками данных по единому стандарту.

Эта интеграция сочетает гибкость экосистемы инструментов MCP с надёжной архитектурой агентов Azure AI Foundry, обеспечивая корпоративные AI-решения с широкими возможностями настройки.
...
Model Context Protocol — это стандартизированный способ подключения AI-приложений к внешним источникам данных и инструментам. Основные преимущества:
...
### 4. Создание определения MCP-инструмента

```csharp
MCPToolDefinition mcpTool = new(mcpServerLabel, mcpServerUrl);
```

### 5. Создание агента с MCP-инструментами
...
## Параметры конфигурации MCP-инструментов

При настройке MCP-инструментов для вашего агента можно указать несколько важных параметров:
...
- Убедитесь в правильности учётных данных для аутентификации
- Проверьте сетевое соединение

### 2. Ошибки вызова инструментов
- Проверьте аргументы и форматирование вызовов инструментов
- Убедитесь в соответствии требованиям конкретного сервера
...
1. **Изучите создание собственных MCP-серверов**: создавайте серверы для проприетарных источников данных
2. **Реализуйте продвинутую безопасность**: добавьте OAuth2 или кастомные механизмы аутентификации
