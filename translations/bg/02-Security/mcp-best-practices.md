...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T16:28:55+00:00",
...
3. **Съгласие на потребителя**: MCP прокси сървърите, използващи статични клиентски идентификатори, **ТРЯБВА** да получат изрично съгласие от потребителя за всеки динамично регистриран клиент.
...
### 1. Валидиране и пречистване на входни данни
- **Цялостно валидиране на входни данни**: Валидирайте и пречиствайте всички входни данни, за да предотвратите атаки чрез инжектиране, проблеми с объркани заместници и уязвимости от тип "prompt injection".
- **Принудително спазване на параметърни схеми**: Прилагайте строга JSON схема за валидиране на всички параметри на инструменти и входни данни за API.
...
- **Пречистване на изходни данни**: Валидирайте и пречиствайте всички изходни данни от модела, преди да ги представите на потребители или системи надолу по веригата.
...
- **Детайлни разрешения**: Прилагайте гранулирани, специфични за инструменти разрешения, следвайки принципа на минималните привилегии.
- **Управление на жизнения цикъл на токени**: Използвайте краткотрайни токени за достъп със сигурна ротация и правилна проверка на аудиторията.
- **Многофакторна автентикация**: Изисквайте MFA за всички административни достъпи и чувствителни операции.

### 3. Сигурни комуникационни протоколи
- **Сигурност на транспортния слой**: Използвайте HTTPS/TLS 1.3 за всички MCP комуникации с правилна проверка на сертификати.
...
- **Принудително спазване на версия на протокола**: Използвайте текущата версия на MCP протокола (2025-06-18) с правилна преговорна процедура за версията.
...
- **Защита от DDoS**: Внедрете цялостна защита от DDoS атаки и системи за анализ на трафика.

### 5. Цялостно логване и мониторинг
- **Структурирано логване за одит**: Прилагайте подробни, търсими логове за всички MCP операции, изпълнения на инструменти и събития, свързани със сигурността.
- **Мониторинг на сигурността в реално време**: Внедрете SIEM системи с AI-базирано откриване на аномалии за MCP натоварвания.
- **Логване, съобразено с поверителността**: Логвайте събития, свързани със сигурността, като същевременно спазвате изискванията за поверителност на данните и регулациите.
...
- **Валидиране на аудиторията**: Винаги проверявайте твърденията за аудиторията на токените, за да съответстват на идентичността на целевия MCP сървър.
...
- **Контроли за жизнения цикъл на сесии**: Прилагайте правилно изтичане, ротация и механизми за анулиране на сесии.
- **Сигурни заглавия за сесии**: Използвайте подходящи HTTP заглавия за защита на сесиите.

### 9. Специфични за AI мерки за сигурност
- **Защита от инжектиране в подсказки**: Внедрете Microsoft Prompt Shields с техники като spotlighting, разделители и маркиране на данни.
...
- **Валидиране на изходни данни от модела**: Сканирайте изходните данни от модела за потенциално изтичане на данни, вредно съдържание или нарушения на политиките за сигурност.
...
### 11. Непрекъсната проверка на сигурността
...
- **Проверка на компонентите**: Проверявайте произхода, цялостта и сигурността на всички AI компоненти (модели, вграждания, API).
...
- **Мониторинг на веригата за доставки**: Непрекъснато следете за компрометиране на доставчици на AI услуги и хранилища на модели.
...
- **Микро-сегментация**: Изолирайте MCP компонентите с детайлни мрежови и идентичностни контроли.
...
- **Форензични способности**: Поддържайте готовност за форензичен анализ при компрометиране на AI системи и изтичане на данни.
- **Процедури за възстановяване**: Установете процедури за възстановяване от отравяне на AI модели, атаки чрез инжектиране в подсказки и компрометиране на услуги.

## Ресурси за внедряване и стандарти

### Официална документация за MCP
- [MCP Спецификация 2025-06-18](https://spec.modelcontextprotocol.io/specification/2025-06-18/) - Текуща спецификация на MCP протокола
...
- [Сигурност на транспорта за MCP](https://modelcontextprotocol.io/specification/2025-06-18/transports/) - Изисквания за сигурност на транспортния слой
...
- [GitHub Advanced Security](https://github.com/security/advanced-security) - Сканиране за сигурност на веригата за доставки и код

### Стандарти и рамки за сигурност
- [Най-добри практики за сигурност на OAuth 2.1](https://datatracker.ietf.org/doc/html/draft-ietf-oauth-security-topics) - Текущи насоки за сигурност на OAuth
...
- [Рамка за управление на рискове на AI от NIST](https://www.nist.gov/itl/ai-risk-management-framework) - Цялостно управление на рискове за AI
...
- [Microsoft Entra ID с MCP сървъри](https://den.dev/blog/mcp-server-auth-entra-id-session/) - Интеграция с доставчици на идентичност
...
- [Крайно-крайно криптиране за AI](https://learn.microsoft.com/azure/architecture/example-scenario/confidential/end-to-end-encryption) -
- **Разработване на инструменти**: Разработване и споделяне на инструменти и библиотеки за сигурност за екосистемата MCP

---

*Този документ отразява най-добрите практики за сигурност на MCP към 18 август 2025 г., базирани на спецификацията MCP 2025-06-18. Практиките за сигурност трябва да се преглеждат и актуализират редовно, тъй като протоколът и заплахите се развиват.*
