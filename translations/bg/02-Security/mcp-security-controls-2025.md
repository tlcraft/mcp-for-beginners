...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T21:14:32+00:00",
...
**Рискове за сигурността, които се адресират:**
...
- **Йерархия на инструкциите**: Правилно приоритизиране при конфликтни инструкции  
...
- **Работни потоци за одобрение**: Изрично съгласие от потребителя за модификации на инструментите  
...
- **Защита на кодовете за авторизация**: Краткотрайни кодове с принудително използване само веднъж  
...
- **Отделни контексти на процесите**: Всяко изпълнение на инструмент в изолирано пространство на процеса  
...
- **Запазване на одитните следи**: Непроменимо регистриране с криптографска цялост  
...
- **Дублиращи се контроли**: Препокриващи се мерки за сигурност за критични функции  
...
- [Azure Content Safety](https://learn.microsoft.com/azure/ai-services/content-s
