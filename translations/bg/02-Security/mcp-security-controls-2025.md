...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T16:29:51+00:00",
...
> **Текущ стандарт**: Този документ отразява [MCP Спецификация 2025-06-18](https://spec.modelcontextprotocol.io/specification/2025-06-18/) изискванията за сигурност и официалните [MCP Най-добри практики за сигурност](https://modelcontextprotocol.io/specification/2025-06-18/basic/security_best_practices).

Протоколът за контекст на модела (MCP) значително се е развил с подобрени контроли за сигурност, които адресират както традиционните заплахи за софтуерната сигурност, така и специфичните за AI рискове. Този документ предоставя изчерпателни контроли за сигурност за сигурни MCP реализации към август 2025.
...
>
> **ЗАДЪЛЖИТЕЛНО**: MCP прокси сървърите, използващи статични клиентски идентификатори, **ТРЯБВА** да получат потребителско съгласие за всеки динамично регистриран клиент  
...
- **Одитни записи**: Пълно записване на всички решения за авторизация за мониторинг на сигурността  
...
### **Предотвратяване на предаване на токени**
...
- **Заобикаляне на контрола**: Пропускане на основни контроли за сигурност като ограничаване на скоростта, валидиране на заявки и мониторинг на трафика  
- **Разпадане на отчетността**: Невъзможност за идентифициране на клиента, което компрометира одитните следи и разследването на инциденти  
...
**Най-добри практики:**
- **Краткотрайни токени**: Минимизиране на прозореца за експозиция чрез честа ротация на токените  
- **Издаване при необходимост**: Издаване на токени само когато са необходими за конкретни операции  
...
- **Инжектиране на злонамерени събития в споделено състояние на сесията**  
- **Имперсонализация на сесията**: Неоторизирано използване на откраднати идентификатори на сесии за заобикаляне на удостоверяването  
- **Атаки чрез възобновяеми потоци**: Експлоатация на възобновяване на събития, изпратени от сървъра, за инжектиране на злонамерено съдържание  
...
- Намалена повърхност за атака, но изисква надеждна проверка на токените  
...
- **Работни потоци за одобрение**: Изрично потребителско съгласие за модификации на инструментите  
...
**Изисквания за реализация:**
- **Проверка на потребителското съгласие**: Никога не пропускайте екрани за съгласие при динамична регистрация на клиенти  
- **Валидиране на пренасочващите URI**: Строга проверка на базата на бели списъци за дестинации за пренасочване  
...
### **Изолиране и пясъчници**

**Изолиране чрез контейнери:**
```yaml
...
**Изчерпателна стратегия за записване:**
```yaml
...
- **Засичане на аномалии чрез машинно обучение**: Идентифициране на заплахи за сигурността чрез AI  
- **Корелация на разузнаването за заплахи**: Съпоставяне на наблюдаваните дейности с известни модели на атаки  
...
### **Възможности за криминалистичен анализ**

**Подкрепа за разследване:**
- **Запазване на одитните следи**: Непроменими записи с криптографска цялост  
...
- **Дублиращи се контроли**: Прекриващи се мерки за сигурност за критични функции  
- **Механизми за безопасен отказ**: Сигурни настройки по подразбиране при грешки или атаки  

### **Реализация на принципа "нулево доверие"**
...
- **Адаптация към заплахите**: Редовни актуализации за справяне с нововъзникващи заплахи  
