...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-04T18:52:35+00:00",
...
- **Функционалност на MCP сървъра**:  
    ...
    - Форматиране на отговори: Структурира изхода от инструментите в формат, разбираем за модела.
