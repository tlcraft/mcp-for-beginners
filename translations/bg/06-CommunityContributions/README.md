...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-14T04:04:15+00:00",
...
- Създавате и споделяте персонализирани MCP инструменти
...
1. **Поддържачи на основния протокол**: Microsoft и други организации, които поддържат основните MCP спецификации и референтни реализации  
2. **Разработчици на инструменти**: Индивиди и екипи, които създават MCP инструменти  
...
#### Ресурси, създадени от общността

- SDK реализации за различни езици  
- Серверни реализации и библиотеки с инструменти  
- Блог постове и уроци  
- Общностни форуми и дискусии в социалните мрежи  
...
3. **Общностна подкрепа**:  
   - Отговаряне на въпроси във форумите  
   - Тестване и докладване на проблеми  
   - Организиране на събития за общността  
   - Наставничество на нови приносители  

### Процес на принос: Основен протокол

За да допринесете към основния MCP протокол или официалните реализации:

#### .NET пример: Принос за подобрение на протокола
...
#### Java пример: Принос за отстраняване на грешка
...
#### Python пример: Принос с нов инструмент към стандартната библиотека
...
1. **Започнете с малко**: Започнете с документация, отстраняване на грешки или малки подобрения  
2. **Следвайте стиловия гид**: Спазвайте стила на кодиране и конвенциите на проекта  
3. **Пишете тестове**: Включвайте модулни тестове за вашите кодови приноси  
...
6. **Взаимодействайте с обратната връзка**: Бъдете отзивчиви към коментари и предложения  
...
## Създаване и споделяне на персонализирани MCP инструменти

Един от най-ценните начини да допринесете за MCP екосистемата е чрез създаване и споделяне на персонализирани инструменти.

### Разработка на споделими инструменти

#### .NET пример: Създаване на пакет с инструменти за споделяне
...
4. **Сигурност**:  
   ...
   - Имплементирайте ограничение на честотата за външни API повиквания  
...
1. **Яснота**: Кодът ясен и добре документиран ли е?  
...
3. **Съвместимост със сървъри**: Следвайте указанията за сървърни реализации  
4. **Промени, които нарушават съвместимостта**: Ясно документирайте такива промени  

## Примерен общностен проект: MCP Tool Registry

Един важен принос към общността може да бъде разработването на публичен регистър за MCP инструменти.
...
- Приносите към MCP могат да варират от подобрения на основния протокол до персонализирани инструменти  
...
1. Идентифицирайте област в MCP екосистемата, в която можете да допринесете според уменията и интересите си  
2. Форкнете MCP хранилището и настройте локална среда за разработка  
3. Създайте малко подобрение, отстраняване на грешка или инструмент, който би бил полезен за общността  
...
Следва: [Lessons from Early Adoption](../07-LessonsfromEarlyAdoption/README.md)
