...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T16:41:07+00:00",
...
Този урок се фокусира върху това как да се ангажирате с общността на MCP, да допринесете за екосистемата на MCP и да следвате най-добрите практики за съвместна разработка. Разбирането как да участвате в проекти с отворен код на MCP е от съществено значение за тези, които искат да оформят бъдещето на тази технология.
...
- Да участвате ефективно във форуми и дискусии на MCP общността
- Да допринасяте за хранилищата с отворен код на MCP
- Да създавате и споделяте персонализирани MCP инструменти и сървъри
...
- [MCP хранилище за примери и сървъри](https://github.com/modelcontextprotocol/servers)
...
- [Сървъри на MCP общността](https://github.com/modelcontextprotocol/servers?tab=readme-ov-file#-community-servers) - Нарастващ списък с MCP сървъри, разработени от общността.
- [Awesome MCP Servers](https://github.com/wong2/awesome-mcp-servers) - Курирани списъци с MCP сървъри.
- [PulseMCP](https://www.pulsemcp.com/) - Център и бюлетин на общността за откриване на MCP ресурси.
...
3. **Етапи на предложение**:
   - Дефиниране: Изследвайте проблема, валидирайте, че други потребители на MCP срещат подобен проблем.
...
2. **Следвайте стиловото ръководство**: Придържайте се към стила и конвенциите на проекта.
...
5. **Изпращайте целенасочени PR**: Дръжте pull request-ите фокусирани върху един проблем или функция.
...
Един от най-ценните начини за принос към екосистемата на MCP е създаването и споделянето на персонализирани MCP сървъри. Общността вече е разработила стотици сървъри за различни услуги и случаи на употреба.

### Рамки за разработка на MCP сървъри

Няколко рамки са налични за опростяване на разработката на MCP сървъри:
...
2. **Рамки на общността**:
   ...
   - [Next.js MCP Server Template](https://github.com/vercel-labs/mcp-for-next.js) - Стартов проект за MCP сървъри в Next.js.
...
Когато споделяте MCP инструменти с общността:
...
Когато преглеждате MCP приноси:
...
4. **Промени, нарушаващи съвместимостта**: Ясно документирайте всички промени, които нарушават съвместимостта.
