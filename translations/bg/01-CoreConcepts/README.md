...
Този урок разглежда фундаменталната архитектура и компоненти, които изграждат екосистемата на Model Context Protocol (MCP). Ще научите за клиент-сървърната архитектура, основните компоненти и комуникационните механизми, които задвижват взаимодействията в MCP.
...
Следва: [Chapter 2: Security](../02-Security/README.md)
