...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-02T10:42:40+00:00",
...
Сега, когато сте инсталирали SDK, нека създадем проект: 

### -3- Създаване на файлове за проекта

### -4- Създаване на сървърния код
...
Inspector е страхотен инструмент, който може да стартира вашия сървър и ви позволява да взаимодействате с него, за да тествате дали работи. Нека го стартираме:

> [!NOTE]
> може да изглежда различно в полето „command“, тъй като съдържа командата за стартиране на сървър с вашия конкретен runtime/

Ще видите следния потребителски интерфейс:
