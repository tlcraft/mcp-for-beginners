...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-10T16:25:36+00:00",
...
- `WebClient` с `bodyToFlux()` позволява реактивно консумиране на стрийм
...
- **За сложни, интерактивни приложения:** MCP стриймингът предлага по-структуриран подход с по-богати метаданни и разделение между нотификации и крайни резултати.
...
Например, клиентът трябва да изпрати нотификация веднага след като първоначалното свързване със сървъра е установено.
...
### Основни точки
- **Валидация на Origin хедъра**: Винаги проверявайте `Origin` хедъра, за да предотвратите DNS rebinding атаки.
...
### Предизвикателства
- Балансиране между сигурност и лесна разработка
...
- **Тествайте съвместимостта** с настоящите инструменти и работни процеси.
