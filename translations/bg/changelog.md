...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T20:58:08+00:00",
...
- **MCP-SECURITY-BEST-PRACTICES-2025.md**: Пълно пренаписване в съответствие със спецификацията MCP 2025-06-18
  ...
  - **12 основни практики за сигурност**: Преструктурирани от списък с 15 елемента към обширни домейни за сигурност
    ...
    - Разширени мерки за сигурност със Zero Trust архитектура
...
#### Разширени мерки за сигурност (02-Security/) - Корпоративна имплементация
- **MCP-SECURITY-CONTROLS-2025.md**: Пълно преработване с рамка за сигурност на корпоративно ниво
  - **9 обширни домейна за сигурност**: Разширени от базови контроли до детайлна корпоративна рамка
    ...
    - Специфични за ИИ мерки за сигурност с предотвратяване на инжектиране на промпти и отравяне на инструменти
...
- **README.md**: Пълно пренаписване за корпоративна имплементация на сигурност
  ...
  - **Контролен списък за имплементация**: Ясно разграничение между задължителни и препоръчителни мерки за сигурност с ползи от екосистемата за сигурност на Microsoft
...
- **Актуализация на версията на протокола**: Актуализирано с препратки към текущата спецификация MCP 2025-06-18 с форматиране на версията по дата (YYYY-MM-DD)
- **Рефинемент на архитектурата**: Подобрени описания на Hosts, Clients и Servers, за да отразяват текущите архитектурни модели на MCP
  - Hosts вече ясно дефинирани като AI приложения, координиращи множество MCP клиентски връзки
  - Клиенти описани като протоколни конектори, поддържащи едно към едно отношения със сървъри
...
- **Съответствие със стандартите**: Пълно съгласуване с изискванията за сигурност на MCP 2025-06-18
...
- **Разширено смекчаване на заплахи**: Детайлни мерки за сигурност за
