...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T16:13:26+00:00",
...
- **MCP-SECURITY-BEST-PRACTICES-2025.md**: Пълно пренаписване в съответствие със спецификацията MCP 2025-06-18
  ...
  - **12 основни практики за сигурност**: Преструктурирани от списък с 15 елемента към обширни домейни за сигурност
    ...
    - Съответствие и управление с регулаторно съгласуване
...
- **MCP-SECURITY-CONTROLS-2025.md**: Пълно преработване с рамка за сигурност на корпоративно ниво
  - **9 обширни домейна за сигурност**: Разширени от базови контроли до детайлна корпоративна рамка
...
- **README.md**: Пълно пренаписване за корпоративна имплементация на сигурност
  ...
  - **Контролен списък за имплементация**: Ясни задължителни и препоръчителни контроли за сигурност с предимства на екосистемата за сигурност на Microsoft
...
- **Актуализация на версията на протокола**: Актуализирано към текущата спецификация MCP 2025-06-18 с форматиране на версията по дата (YYYY-MM-DD)
- **Рефинансиране на архитектурата**: Подобрени описания на Hosts, Clients и Servers, за да отразяват текущите архитектурни модели на MCP
...
- **Преструктуриране на примитивите**: Пълно преработване на сървърни и клиентски примитиви
...
- **Архитектура на протокола**: Въведен двуслоен архитектурен модел
  ...
  - Транспортен слой: STDIO (локален) и Streamable HTTP със SSE (отдалечен) транспортни механизми
- **Рамка за сигурност**: Цялостни принципи за сигурност, включително изрично потребителско съгласие, защита на личните данни, безопасност на изпълнението на инструменти и транспортна сигурност
- **Комуникационни модели**: Актуализирани съобщения на протокола за инициализация, откриване, изпълнение и потоци за уведомяване
- **Примери за код**: Обновени многоезични примери (.NET, Java, Python, JavaScript), за да отразяват текущите MCP SDK модели
...
- **Анализ на заплахи, специфични за ИИ**: Подобрено покритие на съвременни вектори на атака за ИИ
...
- **Актуална информация**: Актуализирани всички препратки към дати и връзки към спецификации към текущите стандарти
...
- Напълно преработено учебно ръководство, за да съответства на текущата структура на хранилището
- Добавени нови раздели за MCP клиенти и инструменти, както и популярни MCP сървъри
...
- Добавен този цялостен дневник на промените
