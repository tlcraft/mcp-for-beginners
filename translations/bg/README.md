...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T20:56:59+00:00",
...
**Model Context Protocol (MCP)** е иновативна рамка, създадена за стандартизиране на взаимодействията между AI модели и клиентски приложения. Тази отворена учебна програма предлага структурирана пътека за обучение, включваща практически примери за програмиране и реални случаи на употреба, с поддръжка на популярни програмни езици като C#, Java, JavaScript, TypeScript и Python.
...
- 🧑‍💻 [MCP GitHub Репозитория](https://github.com/modelcontextprotocol) – Отворени SDK, инструменти и примерен код
- 🌐 [MCP Общество](https://github.com/orgs/modelcontextprotocol/discussions) – Присъединете се към дискусии и допринесете към общността


 ### ➡️Гледайте при поискване - MCP Dev Days
Подгответе се за два дни на задълбочени технически прозрения, връзка с общността и практическо обучение на MCP Dev Days, виртуално събитие, посветено на Model Context Protocol (MCP) — нововъзникващ стандарт, който свързва AI модели и инструментите, на които те разчитат.
Можете да гледате MCP Dev Days, като се регистрирате на нашата страница за събития: https://aka.ms/mcpdevdays. 

#### Ден 1: MCP Продуктивност, DevTools и Общество: 

Посветен на това да даде възможност на разработчиците да използват MCP в своя работен процес и да отпразнуват невероятната MCP общност. Ще бъдем заедно с членове на общността и партньори като Arcade, Block, Okta и Neon, за да видим как те си сътрудничат с Microsoft за изграждане на отворена, разширяема MCP екосистема. Реални демонстрации във VS Code, Visual Studio, GitHub Copilot и популярни инструменти на общността
...
Посветен на MCP разработчиците. Ще се задълбочим в стратегии за внедряване и добри практики за създаване на MCP сървъри и интегриране на MCP във вашите AI работни процеси.

### Теми включват:

- Създаване на MCP сървъри и интегрирането им в агентски преживявания
- Разработка, базирана на подканвания
- Най-добри практики за сигурност
- Използване на градивни блокове като Functions, ACA и API Management
- Подравняване на регистъра и инструменти (1P + 3P)

Ако сте разработчик, създател на инструменти или AI продуктов стратег, този ден е изпълнен с прозрения, от които се нуждаете, за да изградите мащабируеми, сигурни и готови за бъдещето MCP решения.
...
| 04 | Практическа имплементация | SDK, дебъгване, тестване, повторно използваеми шаблони за подканвания | [Прочетете повече](./04-PracticalImplementation/README.md) |
...
| 07 | Уроци от ранното внедряване | Истории за реално приложение | [Ръководство](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | Най-добри практики за MCP | Производителност, устойчивост на грешки, издръжливост | [Ръководство](./08-BestPractices/README.md) |
| 09 | MCP казуси | Примери за практическо приложение | [Ръководство](./09-CaseStudy/README.md) |
...
- (По желание) Основи в концепциите за AI/ML
...
Подробно [Учебно ръководство](./study_guide.md) е налично, за да ви помогне да се ориентирате в това хранилище. Ръководството включва:
...
Благодарности към Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) за приноса на важни примерни кодове. 
...
Contributor License Agreement (CLA), декларирайки, че имате правото и действително предоставяте правата за използване на вашия принос. За подробности посетете 
<https://cla.opensource.microsoft.com>.

Когато изпратите pull request, CLA бот автоматично ще определи дали трябва да предоставите CLA и ще отбележи PR съответно (например, статус проверка, коментар). Просто следвайте инструкциите, предоставени от бота. Това ще трябва да направите само веднъж за всички хранилища, използващи нашия CLA.
...
Хранилището е организирано, както следва:
...
- **translations/**: Поддръжка на няколко езика с автоматизирани преводи
- **translated_images/**: Локализирани версии на диаграми и илюстрации
- **study_guide.md**: Подробно ръководство за навигация в хранилището
...
Този проект може да съдържа търговски марки или лога за проекти, продукти или услуги. Разрешеното използване на търговски марки или лога на Microsoft подлежи на и трябва да следва
