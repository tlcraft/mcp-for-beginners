...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-21T14:06:45+00:00",
...
- **3.9. Деплойване на вашия сървър** – [Ръководство](./03-GettingStarted/09-deployment/README.md)
</details>
...
- **04. Практическо внедряване**  
  SDK-та, отстраняване на грешки, тестване, повторно използваеми шаблони за подканяне. [Прочетете повече](./04-PracticalImplementation/README.md)
...
- **5.3. MCP OAuth2 демонстрация** – [Ръководство](./05-AdvancedTopics/mcp-oauth2-demo/README.md)
...
- **5.6. Извадка (Sampling)** – [Ръководство](./05-AdvancedTopics/mcp-sampling/README.md)
...
<details>
  <summary><strong>Разгледайте имплементациите по езици</strong></summary>
  ...
  - [Пример за MCP на TypeScript](./03-GettingStarted/samples/typescript/README.md)

</details>

### 💡 Разширени проекти на MCP калкулатор:
<details>
...
## 🛠️ Как да използвате ефективно този учебен план
...
Когато подадете pull request, CLA ботът автоматично ще определи дали трябва да предоставите
...
се свържете на [opencode@microsoft.com](mailto:opencode@microsoft.com) при допълнителни въпроси или коментари.
