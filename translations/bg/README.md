...
|--------|-------|-------------|------|
| **Модули 1-3: Основи** | | | |
| 00 | Въведение в MCP | Преглед на Model Context Protocol и значението му в AI процесите | [Прочетете повече](./00-Introduction/README.md) |
...
| 03 | Започване с MCP | Настройка на средата, базови сървъри/клиенти, интеграция | [Прочетете повече](./03-GettingStarted/README.md) |
...
| 3.5 | SSE сървър | Създайте сървъри с Server-Sent Events | [Ръководство](./03-GettingStarted/05-sse-server/README.md) |
...
|----------|-------------|------|
| C# | Пример за MCP сървър | [View Code](./03-GettingStarted/samples/csharp/README.md) |
| Java | MCP калкулатор | [View Code](./03-GettingStarted/samples/java/calculator/README.md) |
| JavaScript | Демонстрация на MCP | [View Code](./03-GettingStarted/samples/javascript/README.md) |
| Python | MCP сървър | [View Code](../../03-GettingStarted/samples/python/mcp_calculator_server.py) |
| TypeScript | Пример за MCP | [View Code](./03-GettingStarted/samples/typescript/README.md) |
...
| Java | Пример за контейнерно приложение | [View Code](./04-PracticalImplementation/samples/java/containerapp/README.md) |
| JavaScript | Разширен пример | [View Code](./04-PracticalImplementation/samples/javascript/README.md) |
| Python | Сложна реализация | [View Code](../../04-PracticalImplementation/samples/python/mcp_sample.py) |
...
Поддържаме подробен [Списък с промени](./changelog.md), който следи всички значими актуализации на учебните материали, включително:
