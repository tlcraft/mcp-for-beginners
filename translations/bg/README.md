...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-19T17:10:13+00:00",
...
1. **Форкнете хранилището**: Кликнете [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/network)
...
- 🧑‍💻 [MCP GitHub Repository](https://github.com/modelcontextprotocol) – Отворени SDK-та, инструменти и кодови примери  

## 🧭 Пълна структура на учебната програма MCP

| Заглавие | Описание | Връзка |
|--|--|--|
| **00 - Въведение в MCP** | Преглед на Model Context Protocol и неговото значение в AI процесите, включително какво представлява MCP, защо стандартизацията е важна и практически случаи на употреба и ползи | [Въведение](./00-Introduction/README.md) |
...
| **02 - Сигурност в MCP** | Идентифициране на заплахи за сигурността в системи базирани на MCP, техники и добри практики за защита на внедряванията | [Сигурност](./02-Security/readme.md) |
| **03 - Започване с MCP** | Настройка и конфигурация на средата, създаване на базови MCP сървъри и клиенти, интегриране на MCP с вече съществуващи приложения | [Започване](./03-GettingStarted/README.md) |
...
| **3.8 - Разгръщане на вашия сървър** | Как да преминете от локална разработка към продукция? Този раздел ще ви помогне да разработите и разположите вашия сървър. | [Разгръщане на вашия сървър](./03-GettingStarted/08-deployment/README.md) |
| **04 - Практическо внедряване** | Използване на SDK-та на различни езици, отстраняване на грешки, тестване и валидация, създаване на многократно използваеми шаблони за prompt-и и работни процеси | [Практическо внедряване](./04-PracticalImplementation/README.md) |
...
| **09 - Казуси за MCP** | Подробни анализи на архитектури на MCP решения, планове за разгръщане и съвети за интеграция, анотирани диаграми и обхождания на проекти | [Казуси](./09-CaseStudy/README.md) |
...
които ботът ви даде. Това се прави само веднъж за всички репозитории, използващи нашия CLA.
...
Този проект може да съдържа търговски марки или лога на проекти, продукти или услуги. Упълномощеното използване на Microsoft
...
Всяко използване на търговски марки или лога на трети страни подлежи на политиките на тези трети страни.
