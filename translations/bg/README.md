...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-13T01:08:40+00:00",
...
**Model Context Protocol (MCP)** е модерна рамка, създадена да стандартизира взаимодействията между AI модели и клиентски приложения. Тази отворена учебна програма предлага структуриран път на обучение с практически примери за код и реални случаи на употреба на популярни програмни езици като C#, Java, JavaScript, TypeScript и Python.
...
- 🧑‍💻 [MCP GitHub Repository](https://github.com/modelcontextprotocol) – Отворени SDK-та, инструменти и примери с код  

## 🧭 Цялостна структура на учебната програма MCP

| Гл | Заглавие | Описание | Връзка |
|--|--|--|--|
| 00 | **Въведение в MCP** | Преглед на Model Context Protocol и значението му в AI процесите, включително какво представлява MCP, защо е важна стандартизацията, както и практически случаи на употреба и ползи | [Въведение](./00-Introduction/README.md) |
...
| 02 | **Сигурност в MCP** | Идентифициране на заплахи за сигурността в системи, базирани на MCP, техники и добри практики за осигуряване на сигурност при внедряване | [Сигурност](/02-Security/README.md) |
| 03 | **Първи стъпки с MCP** | Настройка и конфигурация на среда, създаване на основни MCP сървъри и клиенти, интегриране на MCP с вече съществуващи приложения | [Първи стъпки](./03-GettingStarted/README.md) |
...
| 3.5 | **Създаване на сървър с SSE** | SSE ни помага да направим сървър достъпен в интернет. Този раздел ще ви помогне да създадете сървър с SSE | [Създаване на сървър с SSE](./03-GettingStarted/05-sse-server/README.md) |
...
| 3.8 | **Деплойване на вашия сървър** | Как да преминете от локална разработка към продукция? Този раздел ще ви помогне да разработите и пуснете вашия сървър. | [Деплойване на вашия сървър](./03-GettingStarted/08-deployment/README.md) |
...
| 5.1 | **Интеграция на MCP с Azure** | Демонстрира интеграция с Azure | [Интеграция MCP с Azure](./05-AdvancedTopics/mcp-integration/README.md) |
...
| 5.8 | **Сигурност** | Осигурете своя MCP сървър, включително автентикация, авторизация и стратегии за защита на данните | [Сигурност](./05-AdvancedTopics/mcp-security/README.md) |
| 5.9 | **Web Search MCP** | Python MCP сървър и клиент, интегрирани със SerpAPI за търсене в реално време в уеб, новини, продукти и въпроси и отговори. Демонстрира мулти-инструментна оркестрация, интеграция с външни API-та и надеждно обработване на грешки | [Web Search MCP](./05-AdvancedTopics/web-search-mcp/README.md) |
| 5.10 | **Реално време стрийминг** | Поточно предаване на данни в реално време, което е от съществено значение в днешния свят, ориентиран към данни, където бизнесите и приложенията изискват незабавен достъп до информация за вземане на навременни решения. | [Реално време стрийминг](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
| 5.11 | **Реално време уеб търсене** | Как MCP трансформира уеб търсенето в реално време, като предоставя стандартизиран подход за управление на контекста между AI модели, търсачки и приложения. | [Реално време уеб търсене](./05-AdvancedTopics/mcp-realtimesearch/README.md) |
...
| 07 | **Уроци от ранно приемане** | Реални внедрявания и какво е работило, изграждане и пускане на решения, базирани на MCP, тенденции и бъдеща пътна карта | [Уроци](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | **Най-добри практики за MCP** | Оптимизация на производителността и настройка, проектиране на устойчиви MCP системи, стратегии за тестване и устойчивост | [Best Practices](./08-BestPractices/README.md) |
| 09 | **Казуси за MCP** | Подробни анализи на архитектури на MCP решения, планове за внедряване и съвети за интеграция, анотирани диаграми и прегледи на проекти | [Case Studies](./09-CaseStudy/README.md) |
...
<details>
  ...
  - [Сложна реализация на Python](../../04-PracticalImplementation/samples/python/mcp_sample.py)
...
- Разбиране на клиент-сървър модел и API  
- (По избор) Запознатост с концепции на машинното обучение  
...
Contributor License Agreement (CLA), който удостоверява, че имате право и наистина предоставяте
...
които ботът дава. Това трябва да направите само веднъж за всички хранилища, използващи нашия CLA.
