...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-20T22:31:38+00:00",
...
1. **Fork-нете хранилището**: Кликнете [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/network)
...
| 3.1 | **Първи сървър** | Настройване на основен сървър с помощта на MCP протокола, разбиране на взаимодействието сървър-клиент и тестване на сървъра | [Първи сървър](./03-GettingStarted/01-first-server/README.md) |
...
| 3.7 | **Тестване на сървъра** | Тестването е важна част от процеса на разработка. Този раздел ще ви помогне да тествате, използвайки няколко различни инструмента. | [Тестване на сървъра](./03-GettingStarted/07-testing/README.md) |
| 3.8 | **Деплойване на сървъра** | Как да преминете от локална разработка към продукция? Този раздел ще ви помогне да разработите и пуснете вашия сървър. | [Деплойване на сървъра](./03-GettingStarted/08-deployment/README.md) |
...
| 06 | **Общностен принос** | Как да допринасяте с код и документация, сътрудничество чрез GitHub, подобрения и обратна връзка от общността | [Общностен принос](./06-CommunityContributions/README.md) |
...
| 09 | **Казуси за MCP** | Подробен анализ на архитектури на MCP решения, планове за внедряване и съвети за интеграция, анотирани диаграми и разходки през проекти | [Казуси](./09-CaseStudy/README.md) |
...
## 🎯 Изисквания за усвояване на MCP
...
Всяка тема в това ръководство включва:
...
Всяка употреба на търговски марки или лога на трети страни е предмет на политиките на съответните трети страни.
