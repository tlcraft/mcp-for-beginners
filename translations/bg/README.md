...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T22:30:10+00:00",
...
- 🧑‍💻 [MCP GitHub Хранилище](https://github.com/modelcontextprotocol) – SDK, инструменти и примерен код с отворен код
...
| 04 | Практическа имплементация | SDK, дебъгване, тестване, шаблони за повторно използване | [Прочетете повече](./04-PracticalImplementation/README.md) |
...
| 5.15 | MCP Custom Transport | Персонализирани имплементации на транспорт | [Ръководство](./05-AdvancedTopics/mcp-transport/README.md) |
...
| 11 | Интеграция на MCP сървър с база данни | Цялостен 13-лабораторен учебен път за интеграция с PostgreSQL | [Лаборатории](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.3 | Сигурност и Мултитенантност | Сигурност на ниво ред, автентикация и достъп до данни за множество наематели | [Lab 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.11 | Стратегии за разгръщане | Разгръщане с Docker, Azure Container Apps и мащабиране | [Lab 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
...
Подробно [Ръководство за обучение](./study_guide.md) е налично, за да ви помогне да се ориентирате в този репозиторий. Ръководството включва:
...
Пригответе се за два дни дълбоки технически прозрения, връзка с общността и практически обучения на MCP Dev Days, виртуално събитие, посветено на Model Context Protocol (MCP) — новия стандарт, който свързва AI модели и инструментите, на които те разчитат.
...
Научете в интензивни видео сесии как да създавате MCP сървъри, да интегрирате с VS Code и да разгръщате професионално в Azure, базирано на съдържанието от MCP за начинаещи. Усвоете практически умения в технология, която вече се използва от големи компании.
...
Този проект може да съдържа търговски марки или лога на проекти, продукти или услуги. Разрешеното използване на търговски марки или лога на Microsoft трябва да бъде в съответствие с и да следва [Ръководството за търговски марки и бранд на Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). Използването на търговски марки или лога на Microsoft в модифицирани версии на този проект не трябва да създава объркване или да предполага спонсорство от страна на Microsoft. Всяко използване на търговски марки или лога на трети страни трябва да бъде в съответствие с политиките на съответните трети страни.
