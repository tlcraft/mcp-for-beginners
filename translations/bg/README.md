...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-23T06:59:29+00:00",
...
## 🧭 Структура на цялата учебна програма MCP

| Гл | Заглавие | Описание | Връзка |
|--|--|--|--|
| 00 | **Въведение в MCP** | Преглед на Model Context Protocol и неговото значение в AI процесите, включително какво е MCP, защо стандартизацията е важна и практични случаи на употреба и ползи | [Въведение](./00-Introduction/README.md) |
...
| 02 | **Сигурност в MCP** | Идентифициране на заплахи за сигурността в системи базирани на MCP, техники и добри практики за осигуряване на имплементациите | [Сигурност](./02-Security/README.md) |
...
| 3.3 | **Клиент с LLM**  | Настройка на клиент с MCP протокола, използващ голям езиков модел (LLM) | [Клиент с LLM](./03-GettingStarted/03-llm-client/README.md) |
...
| 3.7 | **Тестване на сървъра** | Тестването е важна част от процеса на разработка. Тази секция ще ви помогне да използвате няколко различни инструмента за тестване. | [Тестване на сървъра](./03-GettingStarted/07-testing/README.md) |
| 3.8 | **Деплой на сървъра** | Как да преминете от локална разработка към продукция? Тази секция ще ви помогне да разработите и разположите сървъра си. | [Деплой на сървъра](./03-GettingStarted/08-deployment/README.md) |
| 04 | **Практическа имплементация** | Използване на SDK-та на различни езици, дебъгване, тестване и валидиране, създаване на повторно използваеми шаблони за заявки и работни потоци | [Практическа имплементация](./04-PracticalImplementation/README.md) |
...
| 07 | **Уроци от ранните потребители** | Реални имплементации и какво е проработило, изграждане и разгръщане на решения базирани на MCP, тенденции и бъдеща пътна карта | [Уроци](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | **Най-добри практики за MCP** | Оптимизация на производителността, проектиране на устойчиви на грешки MCP системи, стратегии за тестване и устойчивост | [Най-добри практики](./08-BestPractices/README.md) |
| 09 | **Казуси за MCP** | Подробен анализ на архитектури на MCP решения, планове за внедряване и съвети за интеграция, анотирани диаграми и прегледи на проекти | [Казуси](./09-CaseStudy/README.md) |
...
<details>
  ...
  - [Примерен MCP сървър на C#](./03-GettingStarted/samples/csharp/README.md)
  - [MCP калкулатор на Java](./03-GettingStarted/samples/java/calculator/README.md)
  - [MCP демо на JavaScript](./03-GettingStarted/samples/javascript/README.md)
  - [MCP сървър на Python](../../03-GettingStarted/samples/python/mcp_calculator_server.py)
  - [Пример на MCP на TypeScript](./03-GettingStarted/samples/typescript/README.md)
...
- Разбиране на клиент-сървър модела и API-та  
- (По избор) Запознатост с концепциите на машинното обучение  
...
които ботът ви даде. Тази процедура се прави само веднъж за всички репозитории, използващи нашия CLA.
...
Използването на търговски марки или лога на трети страни е предмет на правилата на съответните трети страни.
