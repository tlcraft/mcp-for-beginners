...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T16:12:06+00:00",
...
**Model Context Protocol (MCP)** е иновативна рамка, създадена за стандартизиране на взаимодействията между AI модели и клиентски приложения. Тази отворена учебна програма предлага структурирана пътека за обучение, включваща практически примери за кодиране и реални случаи на употреба, на популярни програмни езици като C#, Java, JavaScript, TypeScript и Python.
...
- 📘 [Документация за MCP](https://modelcontextprotocol.io/) – Подробни уроци и ръководства за потребители  
- 📜 [Спецификация на MCP](https://modelcontextprotocol.io/docs/) – Архитектура на протокола и технически справки  
- 📜 [Оригинална спецификация на MCP](https://spec.modelcontextprotocol.io/) – Наследени технически справки (може да съдържат допълнителни детайли)  
- 🧑‍💻 [GitHub репозитория на MCP](https://github.com/modelcontextprotocol) – Отворени SDK, инструменти и примери за код
- 🌐 [Общност на MCP](https://github.com/orgs/modelcontextprotocol/discussions) – Присъединете се към дискусии и допринесете за общността


 ### ➡️Гледайте при поискване - MCP Dev Days
Подгответе се за два дни на задълбочени технически прозрения, връзка с общността и практическо обучение на MCP Dev Days, виртуално събитие, посветено на Model Context Protocol (MCP) — нововъзникващ стандарт, който свързва AI моделите и инструментите, на които те разчитат.
Можете да гледате MCP Dev Days, като се регистрирате на нашата страница за събития: https://aka.ms/mcpdevdays. 

#### Ден 1: MCP Продуктивност, инструменти за разработка и общност: 

Посветен на това да даде възможност на разработчиците да използват MCP в своя работен процес и да отпразнуват невероятната MCP общност. Ще се присъединим към членове на общността и партньори като Arcade, Block, Okta и Neon, за да видим как те си сътрудничат с Microsoft за изграждане на отворена, разширяема MCP екосистема. Реални демонстрации във VS Code, Visual Studio, GitHub Copilot и популярни инструменти на общността
Практически, контекстно-ориентирани работни процеси за разработка
Сесии, водени от общността, и прозрения
Независимо дали тепърва започвате с MCP или вече изграждате с него, Ден 1 ще ви вдъхнови и ще ви даде практически насоки.

#### Ден 2: Създаване на MCP сървъри с увереност

Посветен на създателите на MCP. Ще се задълбочим в стратегии за внедряване и добри практики за създаване на MCP сървъри и интегриране на MCP във вашите AI работни процеси.
...
Ако сте разработчик, създател на инструменти или стратег за AI продукти, този ден е изпълнен с прозрения, от които се нуждаете, за да изградите мащабируеми, сигурни и готови за бъдещето MCP решения.
...
| 04 | Практическо внедряване | SDK, дебъгване, тестване, повторно използваеми шаблони за подканвания | [Прочетете повече](./04-PracticalImplementation/README.md) |
...
| 5.4 | Основни контексти | Разберете и реализирайте основни контексти | [Ръководство](./05-AdvancedTopics/mcp-root-contexts/README.md) |
...
| 5.10 | Поточно предаване в реално време | Създайте функционалност за поточно предаване в реално време | [Ръководство](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
...
| 06 | Приноси от общността | Как да допринесете за екосистемата MCP | [Ръководство](./06-CommunityContributions/README.md) |
| 07 | Уроци от ранното внедряване | Истории за реални реализации | [Ръководство](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | Най-добри практики за MCP | Производителност, устойчивост на грешки, устойчивост | [Ръководство](./08-BestPractices/README.md) |
| 09 | Примери за MCP | Практически примери за внедряване | [Ръководство](./09-CaseStudy/README.md) |
...
Достъпно е подробно [Учебно ръководство](./study_guide.md), което да ви помогне да се ориентирате в този репозиторий. Ръководството включва:
...
Благодарности към Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) за важните примерни кодове.
...
Contributor License Agreement (CLA), декларирайки, че имате право и действително предоставяте права за използване на вашия принос. За подробности посетете 
<https://cla.opensource.microsoft.com>.

Когато изпратите pull request, CLA бот автоматично ще определи дали трябва да предоставите CLA и ще маркира PR съответно (например, проверка на статус, коментар). Просто следвайте инструкциите, предоставени от бота. Ще трябва да направите това само веднъж за всички репозитории, използващи нашия CLA.
...
- **mcp.json**: Конфигурационен файл за спецификацията MCP
