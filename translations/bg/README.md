...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:00:07+00:00",
...
- 📜 [Оригинална спецификация на MCP](https://spec.modelcontextprotocol.io/) – Технически справки от предишни версии (може да съдържат допълнителни детайли)  
- 🧑‍💻 [GitHub хранилище за MCP](https://github.com/modelcontextprotocol) – SDK-та с отворен код, инструменти и примерен код
...
| 04 | Практическа имплементация | SDK-та, дебъгване, тестване, шаблони за повторно използване | [Прочетете повече](./04-PracticalImplementation/README.md) |
...
| 5.15 | MCP Custom Transport | Реализации на персонализиран транспорт | [Ръководство](./05-AdvancedTopics/mcp-transport/README.md) |

| **Модул 6-10: Общност и добри практики** | | | |
| 06 | Приноси към общността | Как да допринесете за екосистемата на MCP | [Ръководство](./06-CommunityContributions/README.md) |
| 07 | Прозрения от ранно внедряване | Истории за реални имплементации | [Ръководство](./07-LessonsFromEarlyAdoption/README.md) |
...
#### Основни MCP примери за калкулатор

| Език | Описание | Линк |
|----------|-------------|------|
| C# | MCP сървър пример | [Вижте кода](./03-GettingStarted/samples/csharp/README.md) |
...
| Java със Spring | Пример за приложение в контейнер | [Преглед на кода](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
Достъпно е подробно [Учебно ръководство](./study_guide.md), което ще ви помогне да се ориентирате в този репозиторий. Ръководството включва:

- Визуална карта на учебната програма, показваща всички разглеждани теми
...
Поддържаме подробен [Списък с промени](./changelog.md), който проследява всички значителни актуализации на учебните материали, включително:
...
Пригответе се за два дни на задълбочени технически прозрения, връзки с общността и практически обучения на MCP Dev Days, виртуално събитие, посветено на Model Context Protocol (MCP) — нововъзникващия стандарт, който свързва AI моделите и инструментите, на които те разчитат.
...
Посветен на MCP разработчиците. Ще се задълбочим в стратегии за реализация и най-добри практики за създаване на MCP сървъри и интегриране на MCP във вашите AI работни процеси.
...
Научете в интензивни видео сесии как да създавате MCP сървъри, да се интегрирате с VS Code и да разгръщате професионално в Azure, базирано на съдържанието от учебната програма MCP за начинаещи. Придобийте практически умения в технология, която вече се използва от големи компании.
...
Да научим за Model Context Protocol (MCP), авангардна рамка, предназначена да стандартизира взаимодействията между AI модели и клиентски приложения. В тази сесия за начинаещи ще ви запознаем с MCP и ще ви насочим към създаването на вашия първи MCP сървър.
