...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-19T17:36:21+00:00",
...
**Model Context Protocol (MCP)** to nowoczesny framework stworzony, aby ustandaryzować interakcje między modelami AI a aplikacjami klienckimi. Ten otwarty kurs oferuje uporządkowaną ścieżkę nauki, zawierającą praktyczne przykłady kodu i rzeczywiste zastosowania, obejmujące popularne języki programowania, takie jak C#, Java, JavaScript, TypeScript i Python.

Niezależnie od tego, czy jesteś deweloperem AI, architektem systemów czy inżynierem oprogramowania, ten przewodnik jest kompleksowym źródłem wiedzy o podstawach MCP i strategiach jego implementacji.
...
| **01 - Wyjaśnienie podstawowych pojęć** | Szczegółowe omówienie kluczowych koncepcji MCP, w tym architektury klient-serwer, głównych elementów protokołu i wzorców komunikacji | [Core Concepts](./01-CoreConcepts/README.md) |
...
| **3.1 - Pierwszy serwer** | Konfiguracja podstawowego serwera z wykorzystaniem protokołu MCP, zrozumienie interakcji serwer-klient oraz testowanie serwera | [First Server](./03-GettingStarted/01-first-server/README.md) |
...
| **3.3 - Klient z LLM** | Konfiguracja klienta MCP z wykorzystaniem dużego modelu językowego (LLM) | [Client with LLM](./03-GettingStarted/03-llm-client/README.md) |
| **3.4 - Konsumowanie serwera w Visual Studio Code** | Konfiguracja Visual Studio Code do korzystania z serwerów działających na protokole MCP | [Consuming a server with Visual Studio Code](./03-GettingStarted/04-vscode/README.md) |
| **3.5 - Tworzenie serwera z wykorzystaniem SSE** | SSE pozwala na udostępnienie serwera w internecie. Ta sekcja pomoże Ci stworzyć serwer wykorzystujący SSE | [Creating a server using SSE](./03-GettingStarted/05-sse-server/README.md) |
| **3.6 - Korzystanie z AI Toolkit** | AI Toolkit to świetne narzędzie, które pomoże Ci zarządzać Twoim workflow AI i MCP | [Use AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
...
| **04 - Praktyczna implementacja** | Wykorzystanie SDK w różnych językach, debugowanie, testowanie i walidacja, tworzenie wielokrotnego użytku szablonów promptów i workflow | [Practical Implementation](./04-PracticalImplementation/README.md) |
...
| **07 - Wnioski z wczesnej adopcji** | Rzeczywiste wdrożenia i co się sprawdziło, budowa i wdrażanie rozwiązań opartych na MCP, trendy i przyszłe plany | [Insights](./07-LessonsFromEarlyAdoption/README.md) |
...
| **09 - Studia przypadków MCP** | Dogłębne analizy architektur rozwiązań MCP, plany wdrożeń i wskazówki dotyczące integracji, schematy i omówienia projektów | [Case Studies](./09-CaseStudy/README.md) |
...
Aby w pełni skorzystać z tego programu nauczania, powinieneś mieć:
...
Zawartość ta jest objęta **licencją MIT**. Szczegóły warunków znajdziesz w pliku [LICENSE](../../LICENSE).

## 🤝 Zasady współpracy

Ten projekt zachęca do współtworzenia i zgłaszania sugestii. Większość wkładów wymaga zgody na Contributor License Agreement (CLA), w którym potwierdzasz, że masz prawo i faktycznie udzielasz nam licencji na korzystanie z Twojego wkładu. Szczegóły znajdziesz pod adresem <https://cla.opensource.microsoft.com>.

Po przesłaniu pull requesta bot CLA automatycznie sprawdzi, czy musisz dostarczyć CLA i odpowiednio oznaczy PR (np. sprawdzenie statusu, komentarz). Wystarczy, że wykonasz to raz dla wszystkich repozytoriów korzystających z naszego CLA.

Projekt przyjął [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).  
Więcej informacji znajdziesz w [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) lub możesz skontaktować się pod adresem [opencode@microsoft.com](mailto:opencode@microsoft.com) w razie dodatkowych pytań lub uwag.
