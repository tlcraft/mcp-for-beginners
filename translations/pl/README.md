...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T12:49:55+00:00",
...
## **Naucz się MCP za pomocą praktycznych przykładów kodu w C#, Java, JavaScript, Rust, Python i TypeScript**  
...
Przygotuj się na dwa dni głębokich wglądów technicznych, nawiązywania kontaktów ze społecznością i praktycznej nauki podczas MCP Dev Days, wirtualnego wydarzenia poświęconego Model Context Protocol (MCP) — nowemu standardowi łączącemu modele AI z narzędziami, na których polegają.  
...
Skupia się na umożliwieniu programistom korzystania z MCP w ich przepływie pracy oraz na świętowaniu niesamowitej społeczności MCP. Dołączą do nas członkowie społeczności i partnerzy, tacy jak Arcade, Block, Okta i Neon, aby pokazać, jak współpracują z Microsoftem, aby kształtować otwarty, rozszerzalny ekosystem MCP.  
- Rzeczywiste demonstracje w VS Code, Visual Studio, GitHub Copilot i popularnych narzędziach społecznościowych  
- Praktyczne, kontekstowe przepływy pracy deweloperów  
...
- Korzystanie z komponentów, takich jak Functions, ACA i API Management  
- Wyrównanie rejestru i narzędzia (1P + 3P)  

Jeśli jesteś programistą, twórcą narzędzi lub strategiem produktów AI, ten dzień dostarczy Ci wiedzy potrzebnej do budowy skalowalnych, bezpiecznych i przyszłościowych rozwiązań MCP.  

## 🧭 Przegląd programu nauczania MCP  

### 📚 Struktura kompletnego programu nauczania  
...
| 01 | Wyjaśnienie podstawowych pojęć | Szczegółowe omówienie podstawowych pojęć MCP | [Czytaj więcej](./01-CoreConcepts/README.md) |  
...
| 10 | Warsztaty Praktyczne | Tworzenie serwera MCP z wykorzystaniem AI Toolkit | [Laboratorium](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |

### 💻 Przykładowe Projekty Kodów
...
- (Opcjonalnie) Podstawy wiedzy o AI/ML  

- Dołączenie do naszych dyskusji społecznościowych w celu uzyskania wsparcia  

## 📚 Przewodnik do Nauki i Zasoby

To repozytorium zawiera różnorodne zasoby, które pomogą Ci efektywnie się uczyć:

### Przewodnik do Nauki

Dostępny jest kompleksowy [Przewodnik do Nauki](./study_guide.md), który pomoże Ci skutecznie poruszać się po tym repozytorium. Przewodnik zawiera:
...
kontaktując się z [opencode@microsoft.com](mailto:opencode@microsoft.com) w przypadku dodatkowych pytań lub komentarzy.  

## 📂 Struktura Repozytorium

Repozytorium jest zorganizowane w następujący sposób:

- **Podstawowy Program Nauczania (00-10)**: Główna zawartość podzielona na dziesięć kolejnych modułów  
