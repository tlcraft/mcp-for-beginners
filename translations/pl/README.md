...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-11T11:28:12+00:00",
...
## **Poznaj MCP dzięki praktycznym przykładom kodu w C#, Java, JavaScript, Python i TypeScript**  
...
Niezależnie od tego, czy jesteś programistą AI, architektem systemów, czy inżynierem oprogramowania, ten przewodnik to kompleksowe źródło wiedzy na temat podstaw MCP i strategii wdrażania.  
...
Przygotuj się na dwa dni pełne dogłębnych informacji technicznych, nawiązywania kontaktów ze społecznością i praktycznej nauki podczas MCP Dev Days, wirtualnego wydarzenia poświęconego Model Context Protocol (MCP) — nowemu standardowi łączącemu modele AI z narzędziami, na których polegają.  

➡️ [Zarejestruj się na MCP Dev Days](https://developer.microsoft.com/en-us/reactor/series/S-1563/)  

Możesz oglądać MCP Dev Days, rejestrując się na naszej stronie wydarzenia: https://aka.ms/mcpdevdays. Stamtąd będziesz mógł dołączyć do transmisji na żywo na YouTube lub Twitchu. Cała zawartość zostanie nagrana i będzie dostępna później na kanale Microsoft Developer na YouTube. Kod źródłowy demonstracji będzie również dostępny na GitHub.  

### Szczegóły wydarzenia  
- Daty: 29 lipca (Dzień 1) i 30 lipca (Dzień 2)  
- Godzina: 9:00 PST każdego dnia  
- Gdzie: Online – dołącz z dowolnego miejsca!  
...
- Sesje prowadzone przez społeczność i wgląd w MCP  

Niezależnie od tego, czy dopiero zaczynasz przygodę z MCP, czy już z niego korzystasz, Dzień 1 dostarczy inspiracji i praktycznych wskazówek.  

#### Dzień 2: Budowanie serwerów MCP z pewnością  

Skierowany do twórców MCP. Zgłębimy strategie wdrażania i najlepsze praktyki tworzenia serwerów MCP oraz integracji MCP z przepływami pracy AI.  
...
- Wykorzystanie komponentów, takich jak Functions, ACA i API Management  
...
|--------|-------|-------------|------|  
| **Moduły 1-3: Podstawy** | | |  
| 00 | Wprowadzenie do MCP | Przegląd Model Context Protocol i jego znaczenia w przepływach pracy AI | [Czytaj więcej](./00-Introduction/README.md) |  
...
| 3.5 | Serwer SSE | Tworzenie serwerów z użyciem Server-Sent Events | [Przewodnik](./03-GettingStarted/05-sse-server/README.md) |  
| 3.6 | HTTP Streaming | Implementacja HTTP streaming w MCP | [Przewodnik](./03-GettingStarted/06-http-streaming/README.md) |  
...
| 3.9 | Wdrażanie | Wdrażanie serwerów MCP na produkcję | [Przewodnik](./03-GettingStarted/09-deployment/README.md) |  
...
| 05 | Zaawansowane tematy w MCP | Multi-modalne AI, skalowanie, zastosowania w przedsiębiorstwach | [Czytaj więcej](./05-AdvancedTopics/README.md) |  
| 5.1 | Integracja z Azure | Integracja MCP z Azure | [Przewodnik](./05-AdvancedTopics/mcp-integration/README.md) |  
| 5.2 | Multi-modalność | Praca z wieloma modalnościami | [Przewodnik](./05-AdvancedTopics/mcp-multi-modality/README.md) |  
...
| 06 | Wkład społeczności | Jak wnosić wkład w ekosystem MCP | [Przewodnik](./06-CommunityContributions/README.md) |
...
Contributor License Agreement (CLA), który potwierdza, że masz prawo do udzielenia nam
...
- **Podstawowy program nauczania (00-10)**: Główna treść podzielona na dziesięć kolejnych modułów
