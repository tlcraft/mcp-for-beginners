...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T07:18:24+00:00",
...
- 🧑‍💻 [Repozytorium MCP na GitHubie](https://github.com/modelcontextprotocol) – Otwartoźródłowe SDK, narzędzia i przykłady kodu
...
| 01 | Wyjaśnienie podstawowych pojęć | Dogłębne omówienie podstawowych koncepcji MCP | [Czytaj więcej](./01-CoreConcepts/README.md) |
...
| 3.3 | Klient z LLM | Zintegruj duże modele językowe | [Przewodnik](./03-GettingStarted/03-llm-client/README.md) |
...
| 3.6 | HTTP Streaming | Wdrażaj HTTP streaming w MCP | [Przewodnik](./03-GettingStarted/06-http-streaming/README.md) |
| 3.7 | AI Toolkit | Używaj AI Toolkit z MCP | [Przewodnik](./03-GettingStarted/07-aitk/README.md) |
| 3.8 | Testowanie | Testuj implementację swojego serwera MCP | [Przewodnik](./03-GettingStarted/08-testing/README.md) |
| 3.9 | Wdrażanie | Wdrażaj serwery MCP na produkcję | [Przewodnik](./03-GettingStarted/09-deployment/README.md) |
...
| 5.3 | Demo OAuth2 | Wdrażanie uwierzytelniania OAuth2 | [Przewodnik](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
| 5.4 | Konteksty główne | Zrozumienie i wdrażanie kontekstów głównych | [Przewodnik](./05-AdvancedTopics/mcp-root-contexts/README.md) |
...
| 5.9 | Wyszukiwanie w sieci | Wdrażanie funkcji wyszukiwania w sieci | [Przewodnik](./05-AdvancedTopics/web-search-mcp/README.md) |
...
| 5.11 | Wyszukiwanie w czasie rzeczywistym | Wdrażanie wyszukiwania w czasie rzeczywistym | [Przewodnik](./05-AdvancedTopics/mcp-realtimesearch/README.md) |
...
| 07 | Wnioski z wczesnego wdrażania | Historie wdrożeń w rzeczywistych warunkach | [Przewodnik](./07-LessonsFromEarlyAdoption/README.md) |
...
| JavaScript | MCP Demo | [Zobacz kod](./03-GettingStarted/samples/javascript/README.md) |
...
Jeśli jesteś deweloperem, twórcą narzędzi lub strategiem produktów AI, ten dzień jest pełen wglądów potrzebnych do budowania skalowalnych, bezpiecznych i przyszłościowych rozwiązań MCP.

### MCP Boot Camp Sierpień 2025
Naucz się w intensywnych sesjach wideo, jak tworzyć serwery MCP, integrować z VS Code i wdrażać profesjonalnie na Azure, bazując na treściach z programu MCP dla początkujących. Zdobądź praktyczne umiejętności w technologii, którą już wykorzystują największe firmy.
...
- **Core Curriculum (00-10)**: Główna treść zorganizowana w dziesięciu kolejnych modułach
