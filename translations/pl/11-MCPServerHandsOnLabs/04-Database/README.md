...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T14:20:28+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "pl"
}
-->
# Projektowanie bazy danych i schemat

## 🎯 Co obejmuje ten lab

Ten lab szczegółowo omawia projektowanie bazy danych PostgreSQL dla systemu Zava Retail. Nauczysz się implementować kompleksowy schemat dla handlu detalicznego z funkcjami wyszukiwania wektorowego, modelowaniem danych dla wielu najemców oraz Row Level Security (RLS) w celu izolacji danych.

## Przegląd

Baza danych jest fundamentem naszego serwera MCP, przechowując dane handlowe dla wielu sklepów przy jednoczesnym zachowaniu ścisłej izolacji danych. Korzystamy z PostgreSQL z rozszerzeniem pgvector, aby umożliwić semantyczne wyszukiwanie, pozwalając klientom na znajdowanie produktów za pomocą zapytań w języku naturalnym.

Nasz schemat opiera się na nowoczesnych wzorcach dla wielu najemców, a Row Level Security zapewnia, że użytkownicy mają dostęp tylko do danych ze swoich autoryzowanych sklepów. Takie podejście oferuje bezpieczeństwo na poziomie korporacyjnym przy jednoczesnym zachowaniu optymalnej wydajności.

## Cele nauki

Po ukończeniu tego labu będziesz w stanie:

- **Projektować** skalowalne schematy baz danych dla wielu najemców
- **Implementować** PostgreSQL z pgvector do wyszukiwania wektorowego
- **Konfigurować** Row Level Security dla izolacji danych
- **Generować** realistyczne dane testowe
- **Optymalizować** wydajność bazy danych dla obciążeń handlowych
- **Implementować** strategie tworzenia kopii zapasowych i odzyskiwania danych

## 🗃️ Architektura bazy danych

### PostgreSQL z pgvector

Nasza baza danych wykorzystuje funkcje korporacyjne PostgreSQL w połączeniu z rozszerzeniem pgvector do wyszukiwania wspomaganego przez AI:
...
### Architektura dla wielu najemców

Baza danych korzysta z modelu **wspólnej bazy danych, wspólnego schematu** dla wielu najemców z Row Level Security:
...
## 📊 Projektowanie głównego schematu

### Tabela sklepów (główna tabela najemców)
...
### Tabela produktów z kategoriami
...
## 🔍 Implementacja wyszukiwania wektorowego

### Tabela osadzeń produktów
...
### Funkcje wyszukiwania wektorowego
...
## 🔐 Konfiguracja Row Level Security

### Role i uprawnienia w bazie danych
...
### Skrypt realistycznych danych testowych
...
Po ukończeniu tego labu powinieneś:

✅ **Projektowanie bazy danych dla wielu najemców**: Zaimplementować Row Level Security dla bezpiecznej izolacji danych  
✅ **Funkcje wyszukiwania wektorowego**: Skonfigurować pgvector do semantycznego wyszukiwania produktów  
✅ **Kompleksowy schemat**: Stworzyć gotowy do produkcji schemat bazy danych dla handlu detalicznego  
✅ **Generowanie danych testowych**: Zbudować realistyczne dane testowe do rozwoju i testowania  
✅ **Optymalizacja wydajności**: Skonfigurować indeksy i optymalizację zapytań  
✅ **Kopie zapasowe i odzyskiwanie**: Ustanowić solidne strategie ochrony danych  

## 🚀 Co dalej

Kontynuuj z **[Lab 05: Implementacja serwera MCP](../05-MCP-Server/README.md)**, aby:

- Zbudować serwer FastMCP, który łączy się z tą bazą danych
- Zaimplementować narzędzia zapytań do bazy danych dla protokołu MCP
- Dodać funkcje wyszukiwania semantycznego za pomocą osadzeń
- Skonfigurować pooling połączeń i obsługę błędów

## 📚 Dodatkowe zasoby

### PostgreSQL & pgvector
- [Dokumentacja PostgreSQL](https://www.postgresql.org/docs/) - Kompletny przewodnik po PostgreSQL
- [Rozszerzenie pgvector](https://github.com/pgvector/pgvector) - Wyszukiwanie podobieństwa wektorów dla PostgreSQL
- [Optymalizacja wydajności PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Najlepsze praktyki optymalizacji

### Architektura dla wielu najemców
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Dokumentacja RLS PostgreSQL
- [Architektura danych dla wielu najemców](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Wzorce architektury Azure
- [Najlepsze praktyki bezpieczeństwa bazy danych](https://www.postgresql.org/docs/current/security.html) - Przewodnik bezpieczeństwa PostgreSQL

### Bazy danych wektorowych
- [Podstawy wyszukiwania wektorowego](https://www.pinecone.io/learn/vector-database/) - Zrozumienie baz danych wektorowych
- [Modele osadzeń](https://platform.openai.com/docs/guides/embeddings) - Dokumentacja osadzeń OpenAI
- [Algorytm HNSW](https://arxiv.org/abs/1603.09320) - Hierarchiczne nawigowalne grafy małego świata

---

**Poprzedni**: [Lab 03: Konfiguracja środowiska](../03-Setup/README.md)  
**Następny**: [Lab 05: Implementacja serwera MCP](../05-MCP-Server/README.md)
