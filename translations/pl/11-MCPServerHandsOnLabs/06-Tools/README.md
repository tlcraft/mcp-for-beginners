...
Ten warsztat zagłębia się w tworzenie zaawansowanych narzędzi MCP, które umożliwiają asystentom AI korzystanie z potężnych funkcji zapytań do baz danych, introspekcji schematów oraz analiz. Nauczysz się budować narzędzia, które są zarówno wydajne, jak i bezpieczne, z kompleksowym obsługiwaniem błędów i optymalizacją wydajności.

## Przegląd

Narzędzia MCP są interfejsem między asystentami AI a Twoimi systemami danych. Dobrze zaprojektowane narzędzia zapewniają strukturalny, zweryfikowany dostęp do skomplikowanych operacji, jednocześnie utrzymując bezpieczeństwo i wydajność. Ten warsztat obejmuje pełny cykl życia tworzenia narzędzi, od projektowania po wdrożenie.

Nasz serwer MCP dla branży detalicznej implementuje kompleksowy zestaw narzędzi, które umożliwiają zapytania w języku naturalnym dotyczące danych sprzedażowych, katalogów produktów oraz analiz biznesowych, jednocześnie utrzymując ścisłe granice bezpieczeństwa i optymalną wydajność.

## Cele Nauki

Po ukończeniu tego warsztatu będziesz w stanie:

- **Projektować** zaawansowane narzędzia MCP z kompleksową walidacją parametrów
- **Implementować** bezpieczne narzędzia zapytań do baz danych z ochroną przed SQL injection
- **Tworzyć** funkcje introspekcji schematów dla dynamicznych zapytań
- **Budować** niestandardowe narzędzia analityczne dla inteligencji biznesowej
- **Stosować** kompleksowe obsługiwanie błędów i łagodne degradacje
- **Optymalizować** wydajność narzędzi dla środowisk produkcyjnych

## 🛠️ Podstawowa Architektura Narzędzi
...
### Walidacja Zapytań i Bezpieczeństwo
...
## 🗃️ Narzędzia Zapytań do Baz Danych

### Narzędzie Analizy Sprzedaży
...
### Narzędzie Introspekcji Schematów
...
## 📊 Narzędzia Analityczne i Użytkowe

### Narzędzie Inteligencji Biznesowej
...
Po ukończeniu tego warsztatu powinieneś:

✅ **Zaawansowana Architektura Narzędzi**: Zaimplementować zaawansowane narzędzia MCP z kompleksowym obsługiwaniem błędów  
✅ **Walidacja Zapytań**: Zbudować bezpieczną walidację SQL, aby zapobiec atakom typu injection  
✅ **Narzędzia Bazodanowe**: Stworzyć potężne funkcje analizy sprzedaży i introspekcji schematów  
✅ **Inteligencja Biznesowa**: Rozwinąć narzędzia analityczne dla kompleksowych wglądów biznesowych  
✅ **Optymalizacja Wydajności**: Zastosować mechanizmy cache, pooling połączeń i optymalizację zapytań  
✅ **Integracja Bezpieczeństwa**: Zaimplementować kontrolę dostępu opartą na rolach oraz logowanie audytowe  

## 🚀 Co Dalej

Kontynuuj z **[Lab 07: Integracja Wyszukiwania Semantycznego](../07-Semantic-Search/README.md)**, aby:

- Zintegrować funkcje wyszukiwania wektorowego z narzędziami MCP
- Zbudować funkcjonalność semantycznego wyszukiwania produktów
- Zaimplementować zrozumienie zapytań wspomagane przez AI
- Stworzyć hybrydowe wyszukiwanie łączące tradycyjne zapytania z wektorowymi

## 📚 Dodatkowe Zasoby

### Tworzenie Narzędzi MCP
- [Dokumentacja Model Context Protocol](https://modelcontextprotocol.io/docs) - Oficjalna specyfikacja MCP
- [FastMCP Framework](https://github.com/jlowin/fastmcp) - Implementacja MCP w Pythonie
- [Wzorce Narzędzi MCP](https://github.com/modelcontextprotocol/servers) - Przykłady implementacji narzędzi

### Bezpieczeństwo Baz Danych
- [Zapobieganie SQL Injection](https://owasp.org/www-community/attacks/SQL_Injection) - Przewodnik bezpieczeństwa OWASP
- [Bezpieczeństwo PostgreSQL](https://www.postgresql.org/docs/current/security.html) - Najlepsze praktyki bezpieczeństwa baz danych
- [Techniki Walidacji Zapytań](https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html) - Wzorce bezpiecznych zapytań

### Optymalizacja Wydajności
- [Optymalizacja Zapytań do Baz Danych](https://www.postgresql.org/docs/current/performance-tips.html) - Przewodnik wydajności PostgreSQL
- [Najlepsze Praktyki Poolingu Połączeń](https://www.postgresql.org/docs/current/runtime-config-connection.html) - Zarządzanie połączeniami
- [Asynchroniczne Wzorce w Pythonie](https://docs.python.org/3/library/asyncio.html) - Przewodnik programowania asynchronicznego

---

**Poprzedni**: [Lab 05: Implementacja Serwera MCP](../05-MCP-Server/README.md)  
**Następny**: [Lab 07: Integracja Wyszukiwania Semantycznego](../07-Semantic-Search/README.md)
