...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T13:48:45+00:00",
...
Ten lab dostarcza kompleksowych wskazówek dotyczących testowania i debugowania serwerów MCP w środowiskach produkcyjnych. Nauczysz się wdrażać solidne strategie testowania, rozwiązywać złożone problemy oraz zapewniać niezawodność działania serwera MCP w różnych warunkach.

## Przegląd

Testowanie serwerów MCP wymaga wielowarstwowego podejścia, obejmującego testy jednostkowe, testy integracyjne, walidację wydajności oraz testowanie w rzeczywistych scenariuszach. Ten lab obejmuje pełny cykl testowania, od rozwoju po monitorowanie w produkcji.

Nasza strategia testowania kładzie nacisk na niezawodność, bezpieczeństwo i wydajność, zapewniając, że Twój serwer MCP poradzi sobie z obciążeniami produkcyjnymi, zachowując integralność danych i wysoką jakość doświadczenia użytkownika.

## Cele nauki

Po ukończeniu tego labu będziesz w stanie:

- **Wdrażać** kompleksowe zestawy testów jednostkowych i integracyjnych  
- **Projektować** skuteczne strategie testowania narzędzi MCP i operacji na bazach danych  
- **Debugować** złożone problemy za pomocą zaawansowanych technik debugowania  
- **Walidować** wydajność pod obciążeniem w realistycznych scenariuszach testowych  
- **Monitorować** systemy produkcyjne za pomocą efektywnego alertowania i obserwowalności  
- **Automatyzować** przepływy testowe w ramach ciągłej integracji  
...
### Testowanie przepływu end-to-end
...
### Framework testowania obciążenia
...
### Zaawansowany framework debugowania
...
Po ukończeniu tego labu powinieneś posiadać:

✅ **Kompleksowy framework testowania**: Testy jednostkowe, integracyjne i wydajnościowe dla wszystkich komponentów  
✅ **Zaawansowane narzędzia debugowania**: Wyrafinowane narzędzia debugowania z możliwością śledzenia wykonania  
✅ **Walidację wydajności**: Testy obciążeniowe i analiza skalowalności  
✅ **Testy bezpieczeństwa**: Zapobieganie SQL injection i walidacja RLS  
✅ **Integrację monitorowania**: Metryki wydajności i analiza wąskich gardeł  
✅ **Gotowość do CI/CD**: Zautomatyzowane przepływy testowe w ramach ciągłej integracji  

## 🚀 Co dalej

Kontynuuj z **[Lab 09: Integracja z VS Code](../09-VS-Code/README.md)**, aby:

- Skonfigurować VS Code do rozwoju serwera MCP  
- Ustawić środowiska debugowania w VS Code  
- Zintegrować serwer MCP z VS Code Chat  
- Przetestować kompletny przepływ pracy w VS Code  

## 📚 Dodatkowe zasoby

### Frameworki testowania
- [Dokumentacja pytest](https://docs.pytest.org/) - Framework testowania w Pythonie  
- [AsyncPG Testing](https://magicstack.github.io/asyncpg/current/index.html) - Testowanie asynchronicznego PostgreSQL  
- [FastAPI Testing](https://fastapi.tiangolo.com/tutorial/testing/) - Wzorce testowania API  

### Testy wydajności
- [Najlepsze praktyki testowania obciążenia](https://docs.python.org/3/library/asyncio.html) - Testowanie wydajności asynchronicznej  
- [Testowanie wydajności baz danych](https://www.postgresql.org/docs/current/performance-tips.html) - Optymalizacja PostgreSQL  
- [Profilowanie pamięci](https://docs.python.org/3/library/tracemalloc.html) - Analiza pamięci w Pythonie  

### Narzędzia debugowania
- [Debugowanie w Pythonie](https://docs.python.org/3/library/pdb.html) - Debugger Python  
- [Debugowanie asynchroniczne](https://docs.python.org/3/library/asyncio-dev.html) - Debugowanie asyncio  
- [Debugowanie SQL](https://www.postgresql.org/docs/current/runtime-config-logging.html) - Logowanie PostgreSQL  

---

**Poprzedni**: [Lab 07: Integracja wyszukiwania semantycznego](../07-Semantic-Search/README.md)  
**Następny**: [Lab 09: Integracja z VS Code](../09-VS-Code/README.md)  
