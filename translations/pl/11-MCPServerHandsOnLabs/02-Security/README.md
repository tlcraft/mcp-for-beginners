...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T14:01:22+00:00",
...
Ten lab dostarcza kompleksowych wskazówek dotyczących wdrażania bezpieczeństwa na poziomie korporacyjnym oraz multi-tenancy dla serwerów MCP. Nauczysz się projektować bezpieczne, zgodne z przepisami systemy, które chronią wrażliwe dane detaliczne, jednocześnie umożliwiając elastyczne wzorce dostępu dla wielu najemców.

## Przegląd

Bezpieczeństwo jest kluczowe w aplikacjach detalicznych, które obsługują dane klientów, informacje o płatnościach i analizy biznesowe. Ten lab obejmuje pełną architekturę bezpieczeństwa, od uwierzytelniania i autoryzacji po izolację danych i monitorowanie zgodności.

Wdrażamy strategię obrony w głąb, łącząc usługi tożsamości Azure, Row Level Security PostgreSQL, kontrolę na poziomie aplikacji oraz kompleksowe logowanie audytowe, aby stworzyć solidną, zgodną platformę.

## Cele nauki

Po ukończeniu tego labu będziesz w stanie:

- **Wdrożyć** Row Level Security na poziomie korporacyjnym dla izolacji danych w środowisku multi-tenant
- **Zaprojektować** bezpieczne wzorce uwierzytelniania i autoryzacji z Azure
- **Skonfigurować** kompleksowe logowanie audytowe dla wymagań zgodności
- **Zastosować** strategie obrony w głąb na wszystkich warstwach aplikacji
- **Zweryfikować** wdrożenia bezpieczeństwa poprzez systematyczne testowanie
- **Monitorować** zdarzenia związane z bezpieczeństwem i reagować na potencjalne zagrożenia

## 🔐 Architektura bezpieczeństwa w środowisku multi-tenant

### Przegląd warstw bezpieczeństwa
...
### Modele multi-tenancy

Nasze wdrożenie wykorzystuje model **Wspólna baza danych, wspólny schemat** z Row Level Security:

**Korzyści:**
- Efektywne kosztowo wykorzystanie zasobów
- Uproszczona konserwacja i aktualizacje
- Silna izolacja danych dzięki RLS
- Ścieżki audytowe zgodne z przepisami

**Kompromisy:**
- Wymaga starannego projektowania polityk RLS
- Zmiany w schemacie wpływają na wszystkich najemców
- Potrzeba solidnych procedur tworzenia kopii zapasowych/przywracania

## 🛡️ Wdrożenie Row Level Security
...
### Widoki monitorowania bezpieczeństwa
...
✅ **Bezpieczeństwo w środowisku multi-tenant**: Wdrożone Row Level Security dla pełnej izolacji danych  
✅ **Uwierzytelnianie Azure**: Zintegrowane Azure Entra ID z walidacją JWT  
✅ **Autoryzacja oparta na rolach**: Skonfigurowany hierarchiczny system ról i uprawnień  
✅ **Kompleksowe logowanie audytowe**: Ustanowione śledzenie i monitorowanie zdarzeń bezpieczeństwa  
✅ **Testowanie bezpieczeństwa**: Wdrożone zautomatyzowane testy walidacji bezpieczeństwa  
✅ **Monitorowanie zagrożeń**: Utworzone wykrywanie zdarzeń bezpieczeństwa w czasie rzeczywistym i alerty  

## 🚀 Co dalej

Kontynuuj z **[Lab 03: Konfiguracja środowiska](../03-Setup/README.md)**, aby:

- Skonfigurować środowiska deweloperskie zgodnie z najlepszymi praktykami bezpieczeństwa
- Ustawić usługi Azure dla uwierzytelniania i monitorowania
- Wdrożyć bezpieczne połączenia z bazą danych i zarządzanie sekretami
- Zweryfikować konfiguracje bezpieczeństwa w środowiskach deweloperskich

## 📚 Dodatkowe zasoby

### Bezpieczeństwo Azure
- [Dokumentacja Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - Kompletny przewodnik po platformie tożsamości
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Usługa zarządzania sekretami
- [Najlepsze praktyki bezpieczeństwa Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Wskazówki dotyczące bezpieczeństwa

### Bezpieczeństwo bazy danych
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Oficjalna dokumentacja RLS
- [Lista kontrolna bezpieczeństwa bazy danych](https://www.postgresql.org/docs/current/security.html) - Przewodnik bezpieczeństwa PostgreSQL
- [Wzorce bazy danych dla środowiska multi-tenant](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Wzorce architektury

### Testowanie bezpieczeństwa
- [Przewodnik testowania OWASP](https://owasp.org/www-project-web-security-testing-guide/) - Kompleksowe testowanie bezpieczeństwa
- [Najlepsze praktyki bezpieczeństwa JWT](https://tools.ietf.org/html/rfc8725) - Rozważania dotyczące bezpieczeństwa JWT
- [Testowanie bezpieczeństwa API](https://owasp.org/www-project-api-security/) - Testowanie bezpieczeństwa specyficznego dla API

---

**Poprzedni**: [Lab 01: Podstawowe koncepcje architektury](../01-Architecture/README.md)  
**Następny**: [Lab 03: Konfiguracja środowiska](../03-Setup/README.md)
