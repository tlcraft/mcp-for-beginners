...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T14:23:49+00:00",
...
Ten warsztat dostarcza kompleksowych wskazówek dotyczących wdrożenia funkcji wyszukiwania semantycznego przy użyciu osadzeń Azure OpenAI oraz rozszerzenia pgvector dla PostgreSQL. Nauczysz się budować wyszukiwanie produktów oparte na AI, które rozumie zapytania w języku naturalnym i dostarcza trafne wyniki na podstawie podobieństwa semantycznego.

## Przegląd

Tradycyjne wyszukiwanie oparte na słowach kluczowych często nie oddaje intencji użytkownika ani znaczenia semantycznego. Wyszukiwanie semantyczne z wykorzystaniem osadzeń wektorowych umożliwia zapytania w języku naturalnym, takie jak „wygodne buty do biegania na deszczową pogodę”, aby znaleźć odpowiednie produkty, nawet jeśli te dokładne słowa nie pojawiają się w opisach produktów.

Nasza implementacja łączy potężne modele osadzeń Azure OpenAI z rozszerzeniem pgvector dla PostgreSQL, tworząc wydajny, skalowalny system wyszukiwania semantycznego, który wzbogaca doświadczenie zakupowe dzięki inteligentnemu odkrywaniu produktów.

## Cele nauki

Po ukończeniu tego warsztatu będziesz w stanie:

- **Zintegrować** modele osadzeń Azure OpenAI do wektoryzacji tekstu  
- **Zaimplementować** pgvector do efektywnych operacji wyszukiwania podobieństwa  
- **Zbudować** narzędzia wyszukiwania semantycznego dla zapytań o produkty w języku naturalnym  
- **Stworzyć** hybrydowe wyszukiwanie łączące tradycyjne i wektorowe podejście  
- **Optymalizować** zapytania wektorowe pod kątem wydajności produkcyjnej  
- **Projektować** systemy rekomendacji oparte na podobieństwie osadzeń  

## 🧠 Architektura wyszukiwania semantycznego

### Pipeline wyszukiwania wektorowego
...
## 🔍 Generowanie osadzeń produktów

### Zautomatyzowany pipeline osadzeń
...
## 🔎 Narzędzia wyszukiwania semantycznego

### Narzędzie wyszukiwania produktów semantycznych
...
### Optymalizacja zapytań wektorowych
...
### Strategia cache'owania osadzeń
...
Po ukończeniu tego warsztatu powinieneś mieć:

✅ **Integrację Azure OpenAI**: Kompletną generację osadzeń z cache'owaniem i optymalizacją  
✅ **Implementację wyszukiwania wektorowego**: Gotowe do produkcji wyszukiwanie semantyczne z pgvector  
✅ **Możliwości wyszukiwania hybrydowego**: Połączenie wyszukiwania słowami kluczowymi i semantycznego dla optymalnych wyników  
✅ **Systemy rekomendacji**: Rekomendacje produktów oparte na AI z wykorzystaniem podobieństwa  
✅ **Optymalizację wydajności**: Optymalizację indeksów wektorowych i inteligentne cache'owanie  
✅ **Skalowalną architekturę**: Infrastruktura wyszukiwania semantycznego gotowa na potrzeby przedsiębiorstw  

## 🚀 Co dalej

Kontynuuj z **[Lab 08: Testowanie i debugowanie](../08-Testing/README.md)**, aby:

- Wdrożyć kompleksowe strategie testowania wyszukiwania semantycznego  
- Debugować problemy z wydajnością wyszukiwania wektorowego  
- Walidować jakość i trafność osadzeń  
- Testować dokładność systemu rekomendacji  

## 📚 Dodatkowe zasoby

### Azure OpenAI  
- [Dokumentacja usługi Azure OpenAI](https://docs.microsoft.com/azure/cognitive-services/openai/) - Kompletny przewodnik po usłudze  
- [Referencja API osadzeń](https://platform.openai.com/docs/api-reference/embeddings) - Dokumentacja API  
- [Najlepsze praktyki dla osadzeń](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Wskazówki dotyczące implementacji  

### Bazy danych wektorowych  
- [Dokumentacja pgvector](https://github.com/pgvector/pgvector) - Rozszerzenie wektorowe dla PostgreSQL  
- [Optymalizacja wyszukiwania wektorowego](https://www.pinecone.io/learn/vector-search-optimization/) - Strojenie wydajności  
- [Algorytm HNSW](https://arxiv.org/abs/1603.09320) - Hierarchiczne nawigowalne grafy małego świata  

### Wyszukiwanie semantyczne  
- [Podstawy wyszukiwania informacji](https://nlp.stanford.edu/IR-book/) - Podręcznik IR Stanford  
- [Najlepsze praktyki wyszukiwania wektorowego](https://weaviate.io/blog/vector-search-best-practices) - Wzorce implementacji  
- [Strategie wyszukiwania hybrydowego](https://blog.vespa.ai/hybrid-search/) - Łączenie różnych podejść do wyszukiwania  

---

**Poprzedni**: [Lab 06: Tworzenie narzędzi](../06-Tools/README.md)  
**Następny**: [Lab 08: Testowanie i debugowanie](../08-Testing/README.md)  
