...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T21:47:43+00:00",
  "source_file": "11-MCPServerHandsOnLabs/08-Testing/README.md",
  "language_code": "sw"
}
-->
# Kupima na Kusuluhisha Hitilafu

## 🎯 Maudhui ya Somo Hili

Somo hili linatoa mwongozo wa kina juu ya kupima na kusuluhisha hitilafu za seva za MCP katika mazingira ya uzalishaji. Utajifunza jinsi ya kutekeleza mikakati madhubuti ya upimaji, kusuluhisha masuala magumu, na kuhakikisha seva yako ya MCP inafanya kazi kwa uaminifu chini ya hali mbalimbali.

## Muhtasari

Kupima seva za MCP kunahitaji mbinu ya tabaka nyingi inayojumuisha majaribio ya vitengo, majaribio ya muunganiko, uthibitishaji wa utendaji, na upimaji wa hali halisi. Somo hili linashughulikia mzunguko mzima wa upimaji kuanzia maendeleo hadi ufuatiliaji wa uzalishaji.

Mkakati wetu wa upimaji unasisitiza uaminifu, usalama, na utendaji, kuhakikisha seva yako ya MCP inaweza kushughulikia mzigo wa uzalishaji huku ikidumisha uadilifu wa data na ubora wa uzoefu wa mtumiaji.

## Malengo ya Kujifunza

Mwisho wa somo hili, utaweza:

- **Kutekeleza** majaribio ya kina ya vitengo na muunganiko  
- **Kubuni** mikakati madhubuti ya upimaji kwa zana za MCP na operesheni za hifadhidata  
- **Kusuluhisha** masuala magumu kwa kutumia mbinu za hali ya juu za kusuluhisha hitilafu  
- **Kuthibitisha** utendaji chini ya mzigo kwa kutumia hali halisi za upimaji  
- **Kufuatilia** mifumo ya uzalishaji kwa kutumia tahadhari na ufuatiliaji madhubuti  
- **Kuwezesha** mtiririko wa kazi wa upimaji kwa ujumuishaji endelevu  

## 🧪 Usanifu wa Upimaji

### Muhtasari wa Mkakati wa Upimaji
...
### Usanidi wa Mazingira ya Upimaji
...
## 🚀 Upimaji wa Muunganiko

### Upimaji wa Mtiririko wa Kazi Mwisho kwa Mwisho
...
## 🔍 Zana za Kusuluhisha Hitilafu

### Mfumo wa Kusuluhisha Hitilafu wa Hali ya Juu
...
Baada ya kukamilisha somo hili, unapaswa kuwa na:

✅ **Mfumo wa Kina wa Upimaji**: Majaribio ya vitengo, muunganiko, na utendaji kwa vipengele vyote  
✅ **Zana za Kusuluhisha Hitilafu za Hali ya Juu**: Zana za hali ya juu za kusuluhisha hitilafu na ufuatiliaji wa utekelezaji  
✅ **Uthibitishaji wa Utendaji**: Uwezo wa upimaji wa mzigo na uchambuzi wa upanuzi  
✅ **Upimaji wa Usalama**: Kuzuia sindikizo la SQL na uthibitishaji wa RLS  
✅ **Ujumuishaji wa Ufuatiliaji**: Vipimo vya utendaji na uchambuzi wa vikwazo  
✅ **Tayari kwa CI/CD**: Mtiririko wa kazi wa upimaji uliojiendesha kwa ujumuishaji endelevu  

## 🚀 Nini Kinachofuata

Endelea na **[Somo la 09: Ujumuishaji wa VS Code](../09-VS-Code/README.md)** ili:

- Kuseti VS Code kwa maendeleo ya seva ya MCP  
- Kuseti mazingira ya kusuluhisha hitilafu ndani ya VS Code  
- Kujumuisha seva ya MCP na VS Code Chat  
- Kupima mtiririko mzima wa kazi wa VS Code  

## 📚 Rasilimali za Ziada

### Mifumo ya Upimaji
- [pytest Documentation](https://docs.pytest.org/) - Mfumo wa upimaji wa Python  
- [AsyncPG Testing](https://magicstack.github.io/asyncpg/current/index.html) - Upimaji wa PostgreSQL ya Async  
- [FastAPI Testing](https://fastapi.tiangolo.com/tutorial/testing/) - Mifumo ya upimaji wa API  

### Upimaji wa Utendaji
- [Load Testing Best Practices](https://docs.python.org/3/library/asyncio.html) - Upimaji wa utendaji wa Async  
- [Database Performance Testing](https://www.postgresql.org/docs/current/performance-tips.html) - Uboreshaji wa PostgreSQL  
- [Memory Profiling](https://docs.python.org/3/library/tracemalloc.html) - Uchambuzi wa kumbukumbu wa Python  

### Zana za Kusuluhisha Hitilafu
- [Python Debugging](https://docs.python.org/3/library/pdb.html) - Kisuluhishi hitilafu cha Python  
- [Async Debugging](https://docs.python.org/3/library/asyncio-dev.html) - Kusuluhisha hitilafu za Asyncio  
- [SQL Debugging](https://www.postgresql.org/docs/current/runtime-config-logging.html) - Uwekaji kumbukumbu wa PostgreSQL  

---

**Iliyopita**: [Somo la 07: Ujumuishaji wa Utafutaji wa Kisemantiki](../07-Semantic-Search/README.md)  
**Inayofuata**: [Somo la 09: Ujumuishaji wa VS Code](../09-VS-Code/README.md)  
