...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T21:57:43+00:00",
...
## 🎯 Maudhui ya Darasa Hili

Darasa hili linatoa mwongozo wa kina wa kutekeleza ufuatiliaji, uangalizi, na arifa kwa seva yako ya MCP katika mazingira ya uzalishaji. Utajifunza jinsi ya kusanidi Application Insights, kuunda dashibodi zenye maana, kutekeleza arifa bora, na kuanzisha mifumo ya utatuzi wa matatizo kwa ubora wa kiutendaji.

## Muhtasari

Ufuatiliaji na uangalizi bora ni muhimu kwa kudumisha seva za MCP zinazotegemewa katika uzalishaji. Darasa hili linashughulikia nguzo tatu za uangalizi—metriksi, kumbukumbu, na nyayo—na linaonyesha jinsi ya kutekeleza ufuatiliaji wa kina unaowezesha kugundua matatizo mapema na kutatua matatizo haraka.

Utajifunza jinsi ya kubadilisha data ghafi ya telemetry kuwa maarifa yanayoweza kuchukuliwa hatua, ambayo yatakusaidia kuelewa tabia ya mfumo, kuboresha utendaji, na kuhakikisha upatikanaji wa hali ya juu.

## Malengo ya Kujifunza

Mwisho wa darasa hili, utaweza:

- **Kutekeleza** ushirikiano wa kina wa Application Insights kwa seva za MCP  
- **Kubuni** mifumo ya kumbukumbu iliyopangwa kwa utatuzi bora wa matatizo  
- **Kuunda** mifumo ya ukusanyaji na uchambuzi wa metriksi za utendaji  
- **Kusanidi** arifa za akili zenye taarifa zinazoweza kuchukuliwa hatua  
- **Kujenga** dashibodi za kiutendaji kwa ufuatiliaji wa wakati halisi  
- **Kuanzisha** mifumo bora ya utatuzi wa matatizo na runbooks  

## 📊 Ushirikiano wa Application Insights

### Kuseti Application Insights
...
### Kuboresha Kumbukumbu kwa Data Iliyopangwa
...
### Utekelezaji wa Dashibodi Maalum
...
Baada ya kukamilisha darasa hili, unapaswa kuwa na:

✅ **Ushirikiano wa Application Insights**: Usanidi kamili wa telemetry na ufuatiliaji  
✅ **Kumbukumbu Iliyopangwa**: Kumbukumbu za uzalishaji zilizo tayari na muktadha na uhusiano  
✅ **Metriksi Maalum**: Ukusanyaji na uchambuzi wa metriksi za biashara na kiufundi  
✅ **Arifa za Akili**: Arifa za proaktifu na njia nyingi za taarifa  
✅ **Dashibodi za Kiutendaji**: Ufuatiliaji wa wakati halisi na maarifa ya biashara  
✅ **Mifumo ya Utatuzi wa Matatizo**: Utambuzi wa kiotomatiki na runbooks za kiutendaji  

## 🚀 Nini Cha Kufanya Baadaye

Endelea na **[Darasa la 12: Mbinu Bora na Uboreshaji](../12-Best-Practices/README.md)** ili:

- Kutumia mbinu za uboreshaji wa utendaji  
- Kutekeleza uimarishaji wa usalama wa kina  
- Kujifunza mbinu bora za kupeleka uzalishaji  
- Kuanzisha mikakati ya uboreshaji wa gharama  

## 📚 Rasilimali za Ziada

### Azure Monitor
- [Application Insights Documentation](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Mwongozo kamili wa ufuatiliaji  
- [KQL Query Reference](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Lugha ya maswali kwa Application Insights  
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - Uundaji wa dashibodi maalum  

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - Mwongozo wa upimaji  
- [Distributed Tracing](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - Dhana za ufuatiliaji  
- [Metrics Collection](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - Mbinu bora za metriksi  

### Ubora wa Kiutendaji
- [SRE Handbook](https://sre.google/sre-book/table-of-contents/) - Kanuni za Site Reliability Engineering  
- [Monitoring Best Practices](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - Mbinu bora za sekta  
- [Incident Response](https://response.pagerduty.com/) - Mwongozo wa usimamizi wa matukio  

---

**Iliyopita**: [Darasa la 10: Mikakati ya Utekelezaji](../10-Deployment/README.md)  
**Ijayo**: [Darasa la 12: Mbinu Bora na Uboreshaji](../12-Best-Practices/README.md)
