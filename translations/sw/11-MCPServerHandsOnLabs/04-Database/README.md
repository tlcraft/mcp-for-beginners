...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T22:06:27+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "sw"
}
-->
# Muundo wa Hifadhidata na Schema

## 🎯 Kinachofunikwa na Maabara Hii

Maabara hii inachunguza kwa kina muundo wa hifadhidata ya PostgreSQL kwa mfumo wa Zava Retail. Utajifunza kutekeleza schema ya kina ya rejareja yenye uwezo wa utafutaji wa vector, uundaji wa data wa wateja wengi (multi-tenant), na Usalama wa Kiwango cha Safu (Row Level Security - RLS) kwa kutenganisha data.

## Muhtasari

Hifadhidata ni msingi wa seva yetu ya MCP, ikihifadhi data ya rejareja kutoka kwa maduka mengi huku ikidumisha kutenganisha data kwa ukali. Tunatumia PostgreSQL na kiendelezi cha pgvector kuwezesha uwezo wa utafutaji wa semantic, kuruhusu wateja kupata bidhaa kwa kutumia maswali ya lugha asilia.

Schema yetu inafuata mifumo ya kisasa ya wateja wengi (multi-tenant) na Usalama wa Kiwango cha Safu (RLS) kuhakikisha watumiaji wanaweza kufikia tu data kutoka kwa maduka waliyoidhinishwa. Mbinu hii inatoa usalama wa kiwango cha biashara huku ikidumisha utendaji bora.

## Malengo ya Kujifunza

Ifikapo mwisho wa maabara hii, utaweza:

- **Kubuni** schema za hifadhidata za rejareja zinazoweza kupanuka kwa wateja wengi  
- **Kutumia** PostgreSQL na pgvector kwa utafutaji wa vector  
- **Kusanidi** Usalama wa Kiwango cha Safu kwa kutenganisha data  
- **Kuzalisha** data halisi ya sampuli kwa majaribio  
- **Kuboresha** utendaji wa hifadhidata kwa mzigo wa kazi wa rejareja  
- **Kutumia** mikakati ya kuhifadhi nakala na kurejesha data  

## 🗃️ Muundo wa Hifadhidata

### PostgreSQL na pgvector

Hifadhidata yetu inatumia vipengele vya biashara vya PostgreSQL pamoja na kiendelezi cha pgvector kwa utafutaji unaoendeshwa na AI:
...
### Muundo wa Wateja Wengi (Multi-Tenant)

Hifadhidata inatumia mfano wa **hifadhidata iliyoshirikiwa, schema iliyoshirikiwa** kwa wateja wengi na Usalama wa Kiwango cha Safu:
...
## 📊 Muundo wa Msingi wa Schema

### Jedwali la Maduka (Tenant Master)
...
### Jedwali la Bidhaa na Kategoria
...
## 🔍 Utekelezaji wa Utafutaji wa Vector

### Jedwali la Embeddings za Bidhaa
...
## 🔐 Usanidi wa Usalama wa Kiwango cha Safu

### Majukumu ya Hifadhidata na Ruhusa
...
## 📊 Uzalishaji wa Data ya Sampuli

### Script ya Data Halisi ya Majaribio
...
### Maoni ya Uboreshaji wa Maswali
...
✅ **Muundo wa Hifadhidata ya Wateja Wengi**: Umetekeleza Usalama wa Kiwango cha Safu kwa kutenganisha data kwa usalama  
✅ **Uwezo wa Utafutaji wa Vector**: Umesanidi pgvector kwa utafutaji wa semantic wa bidhaa  
✅ **Schema Kamili**: Umeunda schema ya hifadhidata ya rejareja tayari kwa uzalishaji  
✅ **Uzalishaji wa Data ya Sampuli**: Umeunda data halisi ya majaribio kwa maendeleo na majaribio  
✅ **Uboreshaji wa Utendaji**: Umesanidi faharasa na uboreshaji wa maswali  
✅ **Hifadhi Nakala na Urejeshaji**: Umeanzisha mikakati thabiti ya ulinzi wa data  

## 🚀 Kinachofuata

Endelea na **[Maabara 05: Utekelezaji wa Seva ya MCP](../05-MCP-Server/README.md)** ili:

- Kujenga seva ya FastMCP inayounganisha na hifadhidata hii  
- Kutekeleza zana za maswali ya hifadhidata kwa itifaki ya MCP  
- Kuongeza uwezo wa utafutaji wa semantic kwa kutumia embeddings  
- Kusanidi usimamizi wa muunganisho na utunzaji wa makosa  

## 📚 Rasilimali za Ziada

### PostgreSQL & pgvector
- [Nyaraka za PostgreSQL](https://www.postgresql.org/docs/) - Marejeleo kamili ya PostgreSQL  
- [Kiendelezi cha pgvector](https://github.com/pgvector/pgvector) - Utafutaji wa kufanana kwa vector kwa PostgreSQL  
- [Uboreshaji wa Utendaji wa PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Mbinu bora za uboreshaji  

### Muundo wa Wateja Wengi
- [Usalama wa Kiwango cha Safu](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Nyaraka za RLS za PostgreSQL  
- [Muundo wa Data ya Wateja Wengi](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Mifumo ya usanifu ya Azure  
- [Mbinu Bora za Usalama wa Hifadhidata](https://www.postgresql.org/docs/current/security.html) - Mwongozo wa usalama wa PostgreSQL  

### Hifadhidata za Vector
- [Misingi ya Utafutaji wa Vector](https://www.pinecone.io/learn/vector-database/) - Kuelewa hifadhidata za vector  
- [Mifano ya Embedding](https://platform.openai.com/docs/guides/embeddings) - Nyaraka za embeddings za OpenAI  
- [Algorithimu ya HNSW](https://arxiv.org/abs/1603.09320) - Grafu za Hierarchical Navigable Small World  

---

**Iliyotangulia**: [Maabara 03: Usanidi wa Mazingira](../03-Setup/README.md)  
**Inayofuata**: [Maabara 05: Utekelezaji wa Seva ya MCP](../05-MCP-Server/README.md)
