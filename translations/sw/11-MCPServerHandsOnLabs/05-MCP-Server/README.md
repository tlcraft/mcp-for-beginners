...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T21:45:49+00:00",
  "source_file": "11-MCPServerHandsOnLabs/05-MCP-Server/README.md",
  "language_code": "sw"
}
-->
# Utekelezaji wa Seva ya MCP

## 🎯 Nini Maabara Hii Inashughulikia

Maabara hii ya vitendo inakuongoza jinsi ya kutekeleza seva ya MCP inayofaa kwa uzalishaji kwa kutumia mfumo wa FastMCP. Utajenga muundo wa msingi wa seva, kutekeleza ujumuishaji wa hifadhidata, kuunda zana za ufikiaji wa data, na kuweka msingi wa uchanganuzi wa rejareja unaotumia AI.

## Muhtasari

Seva ya MCP ni moyo wa suluhisho letu la uchanganuzi wa rejareja. Inafanya kazi kama daraja kati ya wasaidizi wa AI na hifadhidata ya PostgreSQL, ikitoa ufikiaji salama na wa akili wa data ya biashara kupitia itifaki iliyosawazishwa.

Maabara hii inakufundisha jinsi ya kujenga seva ya MCP yenye nguvu na inayoweza kupanuka kwa kufuata mifumo ya biashara na mbinu bora.

## Malengo ya Kujifunza

Mwisho wa maabara hii, utaweza:

- **Kujenga** seva ya FastMCP yenye usanifu na mpangilio sahihi
- **Kutekeleza** ujumuishaji wa hifadhidata kwa kutumia usimamizi wa muunganisho na kushughulikia makosa
- **Kuunda** zana za MCP kwa uchunguzi wa muundo wa hifadhidata na utekelezaji wa maswali
- **Kusanidi** usimamizi wa muktadha wa Usalama wa Kiwango cha Safu (Row Level Security)
- **Kuongeza** vipengele vya ufuatiliaji wa afya na uchunguzi
- **Kupima** utekelezaji wa seva yako ya MCP kwa ndani na kwa kutumia VS Code

## 📁 Muundo wa Mradi

Hebu tuangalie mpangilio wa seva ya MCP:
...
### Usanidi wa Mazingira (`config.py`)

Kwanza, hebu tuunde mfumo wa usanidi wenye nguvu:
...
### Vipengele Muhimu vya Usanidi

- **Upakiaji wa Vigezo vya Mazingira**: Msaada wa moja kwa moja wa faili za .env
- **Usalama wa Aina**: Uthibitishaji wa dataclass na vidokezo vya aina
- **Chaguo Mbadala Zinazobadilika**: Chaguo za msingi zinazofaa kwa maendeleo
- **Uthibitishaji**: Uthibitishaji wa usanidi na ujumbe wa makosa unaosaidia
- **Usalama**: Thamani nyeti tu kutoka kwa vigezo vya mazingira

## 🗄️ Safu ya Ujumuishaji wa Hifadhidata

### Mtoa Huduma wa PostgreSQL (`sales_analysis_postgres.py`)

Hebu tuelekeze safu ya ujumuishaji wa hifadhidata:
...
### Vipengele Muhimu vya Safu ya Hifadhidata

- **Usimamizi wa Muunganisho**: Usimamizi mzuri wa rasilimali kwa asyncpg
- **Ujumuishaji wa RLS**: Usanidi wa muktadha wa Usalama wa Kiwango cha Safu moja kwa moja
- **Uchunguzi wa Muundo**: Ugunduzi wa muundo wa meza kwa njia ya nguvu
- **Ushughulikiaji wa Makosa**: Usimamizi wa makosa wa kina na uandishi wa kumbukumbu
- **Uundaji wa Maswali**: Uundaji wa matokeo yanayofaa kwa AI
- **Ufuatiliaji wa Afya**: Ukaguzi wa muunganisho wa hifadhidata na hali ya usimamizi wa muunganisho

## 🔧 Utekelezaji wa Seva Kuu ya MCP

### Seva ya FastMCP (`sales_analysis.py`)

Sasa hebu tuelekeze utekelezaji wa seva kuu ya MCP:
...
### Vipengele Muhimu vya Seva ya MCP

- **Usajili wa Zana**: Ufafanuzi wa zana kwa njia ya tamko na usalama wa aina
- **Usimamizi wa Muktadha wa RLS**: Utoaji wa utambulisho wa mtumiaji na usanidi wa muktadha moja kwa moja
- **Ushughulikiaji wa Makosa**: Usimamizi wa makosa wa kina na ujumbe unaofaa kwa mtumiaji
- **Usimamizi wa Mzunguko wa Maisha**: Kuanza/kuzima kwa usahihi na kusafisha rasilimali
- **Ufuatiliaji wa Afya**: Njia za ukaguzi wa afya zilizojengwa ndani
- **Msaada wa Maendeleo**: Uwezo wa kupakia upya na kutatua hitilafu

## 🏥 Ufuatiliaji wa Afya

### Utekelezaji wa Ukaguzi wa Afya (`health_check.py`)
...
### Kupima Ujumuishaji wa VS Code

1. **Sanidi VS Code MCP**:
   ```json
   // .vscode/mcp.json
   {
       "servers": {
...
2. **Pima katika Mazungumzo ya AI**:
   - Fungua Mazungumzo ya AI ya VS Code
   - Andika `#zava` na uchague seva yako
   - Uliza: "Ni meza gani zinapatikana?"
   - Uliza: "Nionyeshe maduka 5 bora kwa idadi ya maagizo"

### Kupima kwa Vitengo

Unda vipimo vya kina vya vitengo:
...
✅ **Seva ya MCP Inayofanya Kazi**: Seva ya FastMCP yenye ujumuishaji wa hifadhidata  
✅ **Usimamizi wa Usanidi**: Usanidi wa mazingira wenye nguvu  
✅ **Safu ya Hifadhidata**: Ujumuishaji wa PostgreSQL na usimamizi wa muunganisho  
✅ **Zana za MCP**: Zana za uchunguzi wa muundo na utekelezaji wa maswali  
✅ **Ujumuishaji wa RLS**: Usimamizi wa muktadha wa Usalama wa Kiwango cha Safu  
✅ **Ufuatiliaji wa Afya**: Njia za ukaguzi wa afya za kina  
✅ **Mkakati wa Kupima**: Kupima kwa ndani na ujumuishaji wa VS Code  

## 🚀 Nini Cha Kufanya Baadaye

Endelea na **[Maabara ya 06: Uundaji wa Zana](../06-Tools/README.md)** ili:

- Kupanua mkusanyiko wako wa zana za MCP
- Kutekeleza mifumo ya maswali ya hali ya juu
- Kuongeza uthibitishaji na mabadiliko ya data
- Kuunda zana maalum za uchanganuzi

## 📚 Rasilimali za Ziada

### Mfumo wa FastMCP
- [Nyaraka za FastMCP](https://github.com/modelcontextprotocol/python-sdk) - Mwongozo rasmi wa FastMCP
- [Maelezo ya MCP](https://modelcontextprotocol.io/docs/) - Maelezo ya itifaki
- [Mwongozo wa Uundaji wa Zana](https://modelcontextprotocol.io/docs/tools/) - Kuunda zana za MCP

### Ujumuishaji wa Hifadhidata
- [Nyaraka za asyncpg](https://magicstack.github.io/asyncpg/current/) - Dereva wa PostgreSQL wa async
- [Mbinu Bora za Usimamizi wa Muunganisho](https://www.postgresql.org/docs/current/runtime-config-connection.html) - Usanidi wa PostgreSQL
- [Mwongozo wa Usalama wa Kiwango cha Safu](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Utekelezaji wa RLS

### Mifumo ya FastAPI
- [Nyaraka za FastAPI](https://fastapi.tiangolo.com/) - Marejeleo ya mfumo wa wavuti
- [Uingizaji wa Utegemezi](https://fastapi.tiangolo.com/tutorial/dependencies/) - Mifumo ya FastAPI
- [Kazi za Nyuma](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Usimamizi wa kazi za async

---

**Ijayo**: Tayari kupanua zana zako? Endelea na [Maabara ya 06: Uundaji wa Zana](../06-Tools/README.md)
