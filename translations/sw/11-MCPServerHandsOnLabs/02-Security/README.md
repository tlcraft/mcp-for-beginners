...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T21:54:43+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "sw"
}
-->
# Usalama na Multi-Tenancy

## 🎯 Nini Maabara Hii Inashughulikia

Maabara hii inatoa mwongozo wa kina juu ya kutekeleza usalama wa kiwango cha biashara na multi-tenancy kwa seva za MCP. Utajifunza kubuni mifumo salama na inayozingatia kanuni za kulinda data nyeti ya rejareja huku ukiruhusu mifumo rahisi ya ufikiaji kwa wateja wengi.

## Muhtasari

Usalama ni jambo la msingi katika programu za rejareja zinazoshughulikia data ya wateja, taarifa za malipo, na akili ya biashara. Maabara hii inashughulikia usanifu kamili wa usalama kuanzia uthibitishaji na ruhusa hadi kutenganisha data na ufuatiliaji wa kufuata kanuni.

Tunatekeleza mkakati wa ulinzi wa kina unaochanganya huduma za utambulisho za Azure, Usalama wa Kiwango cha Safu ya PostgreSQL, udhibiti wa kiwango cha programu, na ukaguzi wa kina wa kumbukumbu ili kuunda jukwaa thabiti na linalozingatia kanuni.

## Malengo ya Kujifunza

Mwisho wa maabara hii, utaweza:

- **Kutekeleza** Usalama wa Kiwango cha Safu ya Biashara kwa kutenganisha data ya wateja wengi  
- **Kubuni** mifumo salama ya uthibitishaji na ruhusa kwa kutumia Azure  
- **Kusanidi** ukaguzi wa kina wa kumbukumbu kwa mahitaji ya kufuata kanuni  
- **Kutumia** mikakati ya usalama wa kina katika tabaka zote za programu  
- **Kuthibitisha** utekelezaji wa usalama kupitia majaribio ya kimfumo  
- **Kufuatilia** matukio ya usalama na kujibu vitisho vinavyoweza kutokea  

## 🔐 Usanifu wa Usalama wa Multi-Tenancy

### Muhtasari wa Tabaka za Usalama
...
### Miundo ya Multi-Tenancy

Utekelezaji wetu unatumia muundo wa **Hifadhidata ya Pamoja, Schema ya Pamoja** na Usalama wa Kiwango cha Safu:

**Faida:**
- Matumizi ya rasilimali kwa gharama nafuu  
- Matengenezo na masasisho rahisi  
- Kutenganisha data kwa nguvu kupitia RLS  
- Njia za ukaguzi zinazozingatia kanuni  

**Hasara:**
- Inahitaji muundo wa sera za RLS kwa umakini  
- Mabadiliko ya schema huathiri wateja wote  
- Inahitaji taratibu thabiti za kuhifadhi nakala na kurejesha  

## 🛡️ Utekelezaji wa Usalama wa Kiwango cha Safu
...
### Upimaji na Uthibitishaji wa RLS
...
## 🔍 Ukaguzi wa Usalama na Ufuatiliaji wa Kanuni

### Ukaguzi wa Kumbukumbu wa Kina
...
### Maoni ya Ufuatiliaji wa Usalama
...
### Ufuatiliaji wa Matukio ya Usalama
...
## 🧪 Upimaji na Uthibitishaji wa Usalama

### Majaribio ya Usalama ya Kiotomatiki
...
### Orodha ya Ukaguzi wa Upimaji wa Upenyo
...
✅ **Usalama wa Multi-Tenancy**: Umetekeleza Usalama wa Kiwango cha Safu kwa kutenganisha data kikamilifu  
✅ **Uthibitishaji wa Azure**: Umeunganisha Azure Entra ID na uthibitishaji wa JWT  
✅ **Ruhusa ya Kulingana na Majukumu**: Umesanidi mfumo wa majukumu na ruhusa ya kihierarkia  
✅ **Ukaguzi wa Kumbukumbu wa Kina**: Umeanzisha ufuatiliaji wa matukio ya usalama  
✅ **Upimaji wa Usalama**: Umetekeleza majaribio ya uthibitishaji wa usalama ya kiotomatiki  
✅ **Ufuatiliaji wa Vitisho**: Umeunda ufuatiliaji wa matukio ya usalama kwa muda halisi na tahadhari  

## 🚀 Nini Cha Kufanya Baadaye

Endelea na **[Maabara 03: Usanidi wa Mazingira](../03-Setup/README.md)** ili:

- Kusanidi mazingira ya maendeleo kwa kutumia mbinu bora za usalama  
- Kuweka huduma za Azure kwa uthibitishaji na ufuatiliaji  
- Kutekeleza muunganisho salama wa hifadhidata na usimamizi wa siri  
- Kuthibitisha usanidi wa usalama katika mazingira ya maendeleo  

## 📚 Rasilimali za Ziada

### Usalama wa Azure
- [Nyaraka za Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - Mwongozo kamili wa jukwaa la utambulisho  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Huduma ya usimamizi wa siri  
- [Mbinu Bora za Usalama wa Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Mwongozo wa usalama  

### Usalama wa Hifadhidata
- [Usalama wa Kiwango cha Safu ya PostgreSQL](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Nyaraka rasmi za RLS  
- [Orodha ya Ukaguzi wa Usalama wa Hifadhidata](https://www.postgresql.org/docs/current/security.html) - Mwongozo wa usalama wa PostgreSQL  
- [Miundo ya Hifadhidata ya Multi-Tenancy](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Miundo ya usanifu  

### Upimaji wa Usalama
- [Mwongozo wa Upimaji wa OWASP](https://owasp.org/www-project-web-security-testing-guide/) - Upimaji wa usalama wa kina  
- [Mbinu Bora za Usalama wa JWT](https://tools.ietf.org/html/rfc8725) - Mazingatio ya usalama wa JWT  
- [Upimaji wa Usalama wa API](https://owasp.org/www-project-api-security/) - Upimaji wa usalama wa API  

---

**Iliyopita**: [Maabara 01: Dhana za Msingi za Usanifu](../01-Architecture/README.md)  
**Inayofuata**: [Maabara 03: Usanidi wa Mazingira](../03-Setup/README.md)
