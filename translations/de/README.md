...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-23T06:30:08+00:00",
...
| 02 | **Sicherheit in MCP** | Erkennung von Sicherheitsbedrohungen in MCP-basierten Systemen, Techniken und Best Practices zur Absicherung von Implementierungen | [Sicherheit](./02-Security/README.md) |
...
| 3.4 | **Einen Server mit Visual Studio Code nutzen** | Einrichtung von Visual Studio Code zur Nutzung von Servern über das MCP-Protokoll | [Einen Server mit Visual Studio Code nutzen](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | **Erstellen eines Servers mit SSE** | SSE ermöglicht es uns, einen Server im Internet verfügbar zu machen. Dieser Abschnitt hilft dir, einen Server mit SSE zu erstellen | [Erstellen eines Servers mit SSE](./03-GettingStarted/05-sse-server/README.md) |
...
| 3.7 | **Testen deines Servers** | Testen ist ein wichtiger Teil des Entwicklungsprozesses. Dieser Abschnitt zeigt dir, wie du verschiedene Tools zum Testen nutzen kannst. | [Testen deines Servers](./03-GettingStarted/07-testing/README.md) |
| 3.8 | **Deinen Server bereitstellen** | Wie kommst du von der lokalen Entwicklung in die Produktion? Dieser Abschnitt unterstützt dich bei der Entwicklung und Bereitstellung deines Servers. | [Deinen Server bereitstellen](./03-GettingStarted/08-deployment/README.md) |
| 04 | **Praktische Umsetzung** | Nutzung von SDKs in verschiedenen Sprachen, Debugging, Testen und Validierung, Erstellen wiederverwendbarer Prompt-Vorlagen und Workflows | [Praktische Umsetzung](./04-PracticalImplementation/README.md) |
...
| 07 | **Erfahrungen aus der frühen Nutzung** | Praxisnahe Implementierungen und was funktioniert hat, Aufbau und Bereitstellung MCP-basierter Lösungen, Trends und zukünftige Roadmap | [Erfahrungen](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | **Best Practices für MCP** | Performance-Optimierung, Entwurf fehlertoleranter MCP-Systeme, Test- und Resilienzstrategien | [Best Practices](./08-BestPractices/README.md) |
| 09 | **MCP Fallstudien** | Tiefgehende Analysen von MCP-Lösungsarchitekturen, Bereitstellungspläne und Integrationstipps, annotierte Diagramme und Projekt-Durchgänge | [Fallstudien](./09-CaseStudy/README.md) |
...
Dieses Projekt freut sich über Beiträge und Vorschläge. Die meisten Beiträge erfordern, dass du einer Contributor License Agreement (CLA) zustimmst, die bestätigt, dass du die Rechte besitzt und tatsächlich gewährst, uns die Nutzung deiner Beiträge zu erlauben. Details findest du unter <https://cla.opensource.microsoft.com>.
