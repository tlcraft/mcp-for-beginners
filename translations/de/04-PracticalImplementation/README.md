...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T22:44:02+00:00",
...
### Resources  
Resources liefern Kontext und Daten, die vom Nutzer oder KI-Modell verwendet werden:  
...
Hier ein Azure-Beispiel, das genau das macht, also [einen MCP-Server erstellt und mit Azure API Management absichert](https://github.com/Azure-Samples/remote-mcp-apim-functions-python).
...
1. Registrieren Sie den `Microsoft.App` Resource Provider.  
...
2. Führen Sie diesen [azd](https://aka.ms/azd)-Befehl aus, um den API Management Service, die Function App (mit Code) und alle weiteren benötigten Azure-Ressourcen bereitzustellen:
...
[Remote-mcp-functions](https://github.com/Azure-Samples/remote-mcp-functions-dotnet): Dieses Set von Repositories ist eine Schnellstartvorlage zum Erstellen und Bereitstellen benutzerdefinierter Remote-MCP-Server (Model Context Protocol) mit Azure Functions in Python, C# .NET oder Node/TypeScript.
...
- Bereitstellung in Azure: Einfache Cloud-Bereitstellung mit einem einzigen azd up-Befehl  
