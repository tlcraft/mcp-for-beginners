...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-12T21:52:57+00:00",
...
- **3 Client mit LLM**, eine noch bessere Möglichkeit, einen Client zu schreiben, besteht darin, ihm ein LLM hinzuzufügen, damit er mit deinem Server „verhandeln“ kann, was zu tun ist, [zur Lektion](/03-GettingStarted/03-llm-client/README.md)
...
- **6 HTTP Streaming mit MCP (Streamable HTTP)**. Erfahre mehr über modernes HTTP-Streaming, Fortschrittsbenachrichtigungen und wie du skalierbare, Echtzeit-fähige MCP-Server und -Clients mit Streamable HTTP implementierst. [zur Lektion](/03-GettingStarted/06-http-streaming/README.md)
...
Bevor du mit MCP arbeitest, ist es wichtig, deine Entwicklungsumgebung vorzubereiten und den grundlegenden Ablauf zu verstehen. Dieser Abschnitt führt dich durch die ersten Einrichtungsschritte, um einen reibungslosen Start mit MCP zu gewährleisten.
...
- Deployment-Optionen reichen von lokaler Entwicklung bis hin zu cloudbasierten Lösungen

## Praxis

Wir haben eine Sammlung von Beispielen, die die Übungen in allen Kapiteln dieses Abschnitts ergänzen. Zusätzlich enthält jedes Kapitel eigene Übungen und Aufgaben.
...
Weiter zu: [Deinen ersten MCP Server erstellen](/03-GettingStarted/01-first-server/README.md)
