...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:36:25+00:00",
...
Lab ini memberikan panduan lengkap tentang pengujian dan debugging server MCP di lingkungan produksi. Anda akan belajar menerapkan strategi pengujian yang kuat, memecahkan masalah yang kompleks, dan memastikan server MCP Anda berfungsi dengan andal dalam berbagai kondisi.

## Ikhtisar

Pengujian server MCP membutuhkan pendekatan berlapis yang mencakup pengujian unit, pengujian integrasi, validasi kinerja, dan pengujian skenario dunia nyata. Lab ini mencakup seluruh siklus pengujian dari pengembangan hingga pemantauan produksi.

Strategi pengujian kami menekankan pada keandalan, keamanan, dan kinerja, memastikan server MCP Anda dapat menangani beban kerja produksi sambil menjaga integritas data dan kualitas pengalaman pengguna.

## Tujuan Pembelajaran

Pada akhir lab ini, Anda akan dapat:

- **Menerapkan** suite pengujian unit dan integrasi yang komprehensif  
- **Merancang** strategi pengujian yang efektif untuk alat MCP dan operasi database  
- **Memecahkan masalah** kompleks menggunakan teknik debugging tingkat lanjut  
- **Memvalidasi** kinerja di bawah beban dengan skenario pengujian yang realistis  
- **Memantau** sistem produksi dengan peringatan dan observabilitas yang efektif  
- **Mengotomatisasi** alur kerja pengujian untuk integrasi berkelanjutan  

## 🧪 Arsitektur Pengujian

### Ikhtisar Strategi Pengujian
...
### Kerangka Debugging Tingkat Lanjut
...
✅ **Kerangka Pengujian Komprehensif**: Pengujian unit, integrasi, dan kinerja untuk semua komponen  
✅ **Alat Debugging Tingkat Lanjut**: Utilitas debugging canggih dengan pelacakan eksekusi  
✅ **Validasi Kinerja**: Pengujian beban dan analisis skalabilitas  
✅ **Pengujian Keamanan**: Pencegahan injeksi SQL dan validasi RLS  
✅ **Integrasi Pemantauan**: Metrik kinerja dan analisis hambatan  
✅ **Siap CI/CD**: Alur kerja pengujian otomatis untuk integrasi berkelanjutan  

## 🚀 Langkah Selanjutnya

Lanjutkan dengan **[Lab 09: Integrasi VS Code](../09-VS-Code/README.md)** untuk:

- Mengonfigurasi VS Code untuk pengembangan server MCP  
- Menyiapkan lingkungan debugging di VS Code  
- Mengintegrasikan server MCP dengan VS Code Chat  
- Menguji alur kerja VS Code secara lengkap  

## 📚 Sumber Daya Tambahan

### Kerangka Pengujian
- [Dokumentasi pytest](https://docs.pytest.org/) - Kerangka pengujian Python  
- [Pengujian AsyncPG](https://magicstack.github.io/asyncpg/current/index.html) - Pengujian PostgreSQL asinkron  
- [Pengujian FastAPI](https://fastapi.tiangolo.com/tutorial/testing/) - Pola pengujian API  

### Pengujian Kinerja
- [Praktik Terbaik Pengujian Beban](https://docs.python.org/3/library/asyncio.html) - Pengujian kinerja asinkron  
- [Pengujian Kinerja Database](https://www.postgresql.org/docs/current/performance-tips.html) - Optimasi PostgreSQL  
- [Profil Memori](https://docs.python.org/3/library/tracemalloc.html) - Analisis memori Python  

### Alat Debugging
- [Debugging Python](https://docs.python.org/3/library/pdb.html) - Debugger Python  
- [Debugging Asinkron](https://docs.python.org/3/library/asyncio-dev.html) - Debugging asyncio  
- [Debugging SQL](https://www.postgresql.org/docs/current/runtime-config-logging.html) - Logging PostgreSQL  

---

**Sebelumnya**: [Lab 07: Integrasi Pencarian Semantik](../07-Semantic-Search/README.md)  
**Selanjutnya**: [Lab 09: Integrasi VS Code](../09-VS-Code/README.md)  
