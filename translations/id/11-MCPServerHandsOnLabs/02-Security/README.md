...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:47:03+00:00",
...
Lab ini memberikan panduan lengkap tentang penerapan keamanan tingkat perusahaan dan multi-tenancy untuk server MCP. Anda akan belajar merancang sistem yang aman dan sesuai regulasi untuk melindungi data sensitif ritel sambil memungkinkan pola akses fleksibel di berbagai tenant.

## Ikhtisar

Keamanan sangat penting dalam aplikasi ritel yang menangani data pelanggan, informasi pembayaran, dan intelijen bisnis. Lab ini mencakup arsitektur keamanan lengkap mulai dari autentikasi dan otorisasi hingga isolasi data dan pemantauan kepatuhan.

Kami menerapkan strategi pertahanan berlapis yang menggabungkan layanan identitas Azure, PostgreSQL Row Level Security, kontrol tingkat aplikasi, dan pencatatan audit yang komprehensif untuk menciptakan platform yang kuat dan sesuai regulasi.

## Tujuan Pembelajaran

Pada akhir lab ini, Anda akan dapat:

- **Menerapkan** Row Level Security tingkat perusahaan untuk isolasi data multi-tenant
- **Merancang** pola autentikasi dan otorisasi yang aman dengan Azure
- **Mengonfigurasi** pencatatan audit yang komprehensif untuk memenuhi persyaratan kepatuhan
- **Menerapkan** strategi keamanan pertahanan berlapis di semua lapisan aplikasi
- **Memvalidasi** implementasi keamanan melalui pengujian sistematis
- **Memantau** peristiwa keamanan dan merespons ancaman potensial

## 🔐 Arsitektur Keamanan Multi-Tenant

### Ikhtisar Lapisan Keamanan
...
Implementasi kami menggunakan model **Shared Database, Shared Schema** dengan Row Level Security:

**Keuntungan:**
- Pemanfaatan sumber daya yang hemat biaya
- Pemeliharaan dan pembaruan yang lebih sederhana
- Isolasi data yang kuat melalui RLS
- Jejak audit yang sesuai regulasi

**Kompromi:**
- Membutuhkan desain kebijakan RLS yang cermat
- Perubahan skema memengaruhi semua tenant
- Memerlukan prosedur pencadangan/pemulihan yang kuat

## 🛡️ Penerapan Row Level Security
...
Setelah menyelesaikan lab ini, Anda seharusnya telah:

✅ **Keamanan Multi-Tenant**: Menerapkan Row Level Security untuk isolasi data yang lengkap  
✅ **Autentikasi Azure**: Mengintegrasikan Azure Entra ID dengan validasi JWT  
✅ **Otorisasi Berbasis Peran**: Mengonfigurasi sistem peran dan izin hierarkis  
✅ **Pencatatan Audit yang Komprehensif**: Membangun pelacakan dan pemantauan peristiwa keamanan  
✅ **Pengujian Keamanan**: Menerapkan pengujian validasi keamanan otomatis  
✅ **Pemantauan Ancaman**: Membuat deteksi peristiwa keamanan real-time dan pemberitahuan  

## 🚀 Langkah Selanjutnya

Lanjutkan dengan **[Lab 03: Environment Setup](../03-Setup/README.md)** untuk:

- Mengonfigurasi lingkungan pengembangan dengan praktik terbaik keamanan
- Menyiapkan layanan Azure untuk autentikasi dan pemantauan
- Menerapkan koneksi database yang aman dan pengelolaan rahasia
- Memvalidasi konfigurasi keamanan di lingkungan pengembangan

## 📚 Sumber Daya Tambahan

### Keamanan Azure
- [Dokumentasi Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - Panduan lengkap platform identitas
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Layanan pengelolaan rahasia
- [Praktik Terbaik Keamanan Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Panduan keamanan

### Keamanan Database
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Dokumentasi resmi RLS
- [Daftar Periksa Keamanan Database](https://www.postgresql.org/docs/current/security.html) - Panduan keamanan PostgreSQL
- [Pola Database Multi-Tenant](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Pola arsitektur

### Pengujian Keamanan
- [Panduan Pengujian OWASP](https://owasp.org/www-project-web-security-testing-guide/) - Pengujian keamanan yang komprehensif
- [Praktik Terbaik Keamanan JWT](https://tools.ietf.org/html/rfc8725) - Pertimbangan keamanan JWT
- [Pengujian Keamanan API](https://owasp.org/www-project-api-security/) - Pengujian keamanan khusus API

---

**Sebelumnya**: [Lab 01: Core Architecture Concepts](../01-Architecture/README.md)  
**Selanjutnya**: [Lab 03: Environment Setup](../03-Setup/README.md)
