...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T20:00:36+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "id"
}
-->
# Desain Database dan Skema

## 🎯 Apa yang Dibahas dalam Lab Ini

Lab ini membahas secara mendalam desain database PostgreSQL untuk sistem Zava Retail. Anda akan belajar menerapkan skema ritel yang komprehensif dengan kemampuan pencarian vektor, pemodelan data multi-tenant, dan Row Level Security (RLS) untuk isolasi data.

## Ikhtisar

Database adalah fondasi dari server MCP kami, menyimpan data ritel dari berbagai toko sambil menjaga isolasi data yang ketat. Kami menggunakan PostgreSQL dengan ekstensi pgvector untuk memungkinkan kemampuan pencarian semantik, sehingga pelanggan dapat menemukan produk menggunakan kueri bahasa alami.

Skema kami mengikuti pola multi-tenant modern dengan Row Level Security yang memastikan pengguna hanya dapat mengakses data dari toko yang mereka otorisasi. Pendekatan ini memberikan keamanan tingkat perusahaan sambil mempertahankan kinerja yang optimal.

## Tujuan Pembelajaran

Pada akhir lab ini, Anda akan dapat:

- **Merancang** skema database ritel multi-tenant yang skalabel
- **Menerapkan** PostgreSQL dengan pgvector untuk pencarian vektor
- **Mengonfigurasi** Row Level Security untuk isolasi data
- **Menghasilkan** data sampel realistis untuk pengujian
- **Mengoptimalkan** kinerja database untuk beban kerja ritel
- **Menerapkan** strategi pencadangan dan pemulihan

## 🗃️ Arsitektur Database

### PostgreSQL dengan pgvector

Database kami memanfaatkan fitur enterprise PostgreSQL yang dikombinasikan dengan ekstensi pgvector untuk pencarian berbasis AI:
...
Database menggunakan model multi-tenancy **shared database, shared schema** dengan Row Level Security:
...
### Tabel Products dengan Kategori
...
## 🔍 Implementasi Pencarian Vektor

### Tabel Embeddings Produk
...
## 🔐 Pengaturan Row Level Security

### Peran dan Izin Database
...
✅ **Desain Database Multi-Tenant**: Menerapkan Row Level Security untuk isolasi data yang aman  
✅ **Kemampuan Pencarian Vektor**: Mengonfigurasi pgvector untuk pencarian semantik produk  
✅ **Skema Komprehensif**: Membuat skema database ritel siap produksi  
✅ **Pembuatan Data Sampel**: Membuat data uji realistis untuk pengembangan dan pengujian  
✅ **Optimasi Kinerja**: Mengonfigurasi indeks dan optimasi kueri  
✅ **Pencadangan dan Pemulihan**: Menetapkan strategi perlindungan data yang kuat  

## 🚀 Langkah Selanjutnya

Lanjutkan ke **[Lab 05: Implementasi Server MCP](../05-MCP-Server/README.md)** untuk:

- Membangun server FastMCP yang terhubung ke database ini
- Menerapkan alat kueri database untuk protokol MCP
- Menambahkan kemampuan pencarian semantik menggunakan embeddings
- Mengonfigurasi pooling koneksi dan penanganan kesalahan

## 📚 Sumber Daya Tambahan

### PostgreSQL & pgvector
- [Dokumentasi PostgreSQL](https://www.postgresql.org/docs/) - Referensi lengkap PostgreSQL
- [Ekstensi pgvector](https://github.com/pgvector/pgvector) - Pencarian kesamaan vektor untuk PostgreSQL
- [Optimasi Kinerja PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Praktik terbaik optimasi

### Arsitektur Multi-Tenant
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Dokumentasi RLS PostgreSQL
- [Arsitektur Data Multi-Tenant](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Pola arsitektur Azure
- [Praktik Terbaik Keamanan Database](https://www.postgresql.org/docs/current/security.html) - Panduan keamanan PostgreSQL

### Database Vektor
- [Dasar-dasar Pencarian Vektor](https://www.pinecone.io/learn/vector-database/) - Memahami database vektor
...
**Sebelumnya**: [Lab 03: Persiapan Lingkungan](../03-Setup/README.md)  
**Selanjutnya**: [Lab 05: Implementasi Server MCP](../05-MCP-Server/README.md)
