...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-23T06:13:56+00:00",
...
|--|--|--|--|
| 00 | **Pengenalan MCP** | Gambaran Model Context Protocol dan pentingnya dalam pipeline AI, termasuk apa itu Model Context Protocol, mengapa standarisasi penting, serta kasus penggunaan dan manfaat praktis | [Pengenalan](./00-Introduction/README.md) |
...
| 3.6 | **Menggunakan AI Toolkit** | AI toolkit adalah alat hebat yang akan membantu Anda mengelola alur kerja AI dan MCP | [Menggunakan AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
| 3.7 | **Menguji server Anda** | Pengujian adalah bagian penting dari proses pengembangan. Bagian ini akan membantu Anda menguji menggunakan berbagai alat | [Menguji server Anda](./03-GettingStarted/07-testing/README.md) |
| 3.8 | **Menyebarkan server Anda** | Bagaimana cara beralih dari pengembangan lokal ke produksi? Bagian ini akan membantu Anda mengembangkan dan menyebarkan server | [Menyebarkan server Anda](./03-GettingStarted/08-deployment/README.md) |
...
| 05 | **Topik Lanjutan dalam MCP** | Alur kerja AI multi-modal dan ekstensi, strategi penskalaan aman, MCP dalam ekosistem perusahaan | [Topik Lanjutan](./05-AdvancedTopics/README.md) |
| 06 | **Kontribusi Komunitas** | Cara berkontribusi kode dan dokumentasi, kolaborasi melalui GitHub, peningkatan dan umpan balik berbasis komunitas | [Kontribusi Komunitas](./06-CommunityContributions/README.md) |
| 07 | **Wawasan dari Adopsi Awal** | Implementasi dunia nyata dan apa yang berhasil, membangun dan menyebarkan solusi berbasis MCP, tren dan roadmap masa depan | [Wawasan](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | **Praktik Terbaik untuk MCP** | Penyempurnaan kinerja dan optimasi, merancang sistem MCP tahan kesalahan, strategi pengujian dan ketahanan | [Praktik Terbaik](./08-BestPractices/README.md) |
| 09 | **Studi Kasus MCP** | Pendalaman arsitektur solusi MCP, cetak biru penyebaran dan tips integrasi, diagram beranotasi dan walkthrough proyek | [Studi Kasus](./09-CaseStudy/README.md) |
...
CLA dan menandai PR dengan tepat (misalnya, pemeriksaan status, komentar). Cukup ikuti instruksi yang
...
Penggunaan merek dagang atau logo Microsoft dalam versi modifikasi dari proyek ini tidak boleh menimbulkan kebingungan atau mengindikasikan sponsor dari Microsoft.
