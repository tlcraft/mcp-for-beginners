...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-01T09:46:29+00:00",
...
### Membangun dan menerapkan server dan klien MCP pertama Anda serta Laboratorium dan Skenario Praktis  
<details>
...
### Implementasi Praktis Model Context Protocol dan Konten Lanjutan  
<details>
...
- **05. Topik Lanjutan dalam MCP**  
  AI multi-modal, skalabilitas, penggunaan enterprise. [Baca selengkapnya](./05-AdvancedTopics/README.md)
...
<details>
  <summary><strong> Pelajaran 6-9: Komunitas, Praktik Terbaik & Laboratorium</strong></summary>
...
### Model Context Protocol Praktikum dengan AI Toolkit untuk VScode  
<details>  
  <summary><strong>Pembelajaran 10: Praktikum Membangun Server MCP dengan AI Toolkit untuk VScode</strong></summary>  
    
- **10. Menyederhanakan Alur Kerja AI: Membangun Server MCP dengan AI Toolkit** – [Praktikum](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md)  
</details>

## Proyek Contoh Model Context Protocol Membangun Proyek Kalkulator MCP di Java, C#, JavaScript, TypeScript, dan Python

### 🧮 Proyek Contoh Kalkulator MCP di Java, C#, JavaScript, TypeScript, dan Python  
<details>  
...
### 💡 Solusi Contoh Lanjutan MCP: Proyek Kalkulator di C#, Java, JavaScript, TypeScript, dan Python  
<details>  
...
Agar bisa memanfaatkan kurikulum ini secara maksimal, Anda sebaiknya memiliki:
...
Tersedia [Panduan Belajar](./study_guide.md) yang lengkap untuk membantu Anda menavigasi repositori ini dengan efektif. Panduan ini mencakup:

- Peta kurikulum visual yang menunjukkan semua topik yang dibahas  
- Rincian tiap bagian repositori  
- Panduan penggunaan proyek contoh  
- Jalur belajar yang direkomendasikan untuk berbagai tingkat kemampuan  
- Sumber tambahan untuk melengkapi proses pembelajaran Anda  
...
Saat Anda mengajukan pull request, bot CLA secara otomatis akan menentukan apakah Anda perlu  
menyediakan CLA dan menandai PR dengan tepat (misalnya, pemeriksaan status, komentar). Ikuti saja  
...
Proyek ini mungkin berisi merek dagang atau logo untuk proyek, produk, atau layanan. Penggunaan merek dagang atau logo Microsoft yang sah harus mengikuti dan tunduk pada  
