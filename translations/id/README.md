...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-19T22:13:37+00:00",
...
**Model Context Protocol (MCP)** adalah kerangka kerja mutakhir yang dirancang untuk menstandarisasi interaksi antara model AI dan aplikasi klien. Kurikulum open-source ini menawarkan jalur pembelajaran yang terstruktur, lengkap dengan contoh kode praktis dan kasus penggunaan nyata, di berbagai bahasa pemrograman populer termasuk C#, Java, JavaScript, TypeScript, dan Python.

Apakah Anda seorang pengembang AI, arsitek sistem, atau insinyur perangkat lunak, panduan ini adalah sumber komprehensif Anda untuk menguasai dasar-dasar MCP dan strategi implementasinya.
...
| 01 | **Konsep Inti Dijelaskan** | Eksplorasi mendalam tentang konsep inti MCP, termasuk arsitektur client-server, komponen utama protokol, dan pola pesan | [Core Concepts](./01-CoreConcepts/README.md) |
...
| 05 | **Topik Lanjutan di MCP** | Alur kerja AI multimodal dan ekstensi, strategi skalabilitas yang aman, MCP dalam ekosistem perusahaan | [Advanced Topics](./05-AdvancedTopics/README.md) |
...
| 09 | **Studi Kasus MCP** | Penjelajahan mendalam arsitektur solusi MCP, blueprint deployment dan tips integrasi, diagram beranotasi dan walkthrough proyek | [Case Studies](./09-CaseStudy/README.md) |
...
Agar mendapatkan manfaat maksimal dari kurikulum ini, kamu harus memiliki:
...
Contributor License Agreement (CLA) yang menyatakan bahwa kamu memiliki hak dan memang memberikan hak  
kepada kami untuk menggunakan kontribusimu. Untuk detail, kunjungi <https://cla.opensource.microsoft.com>.

Saat kamu mengirim pull request, bot CLA akan secara otomatis menentukan apakah kamu perlu menyediakan  
CLA dan menghias PR sesuai (misalnya, pemeriksaan status, komentar). Cukup ikuti instruksi yang diberikan bot.  
Kamu hanya perlu melakukan ini sekali untuk semua repositori yang menggunakan CLA kami.
...
Penggunaan merek dagang atau logo Microsoft dalam versi proyek yang dimodifikasi tidak boleh menyebabkan kebingungan atau menyiratkan sponsor Microsoft.  
