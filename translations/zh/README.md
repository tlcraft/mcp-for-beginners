...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T12:38:46+00:00",
...
我们提供了全面的[学习指南](./study_guide.md)，帮助您有效地浏览本仓库。指南内容包括：
...
在修改版本中使用 Microsoft 商标或标志不得引起混淆或暗示 Microsoft 赞助。任何第三方商标或标志的使用需遵守相关第三方政策。
