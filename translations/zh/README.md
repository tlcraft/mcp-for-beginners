...
| 5.8 | 安全性 | 高级安全考虑 | [指南](./05-AdvancedTopics/mcp-security/README.md) |
...
本内容根据 **MIT 许可** 授权。有关条款和条件，请参阅 [LICENSE](../../LICENSE)。
...
本项目可能包含项目、产品或服务的商标或标志。使用微软商标或标志需遵守并必须符合[微软商标与品牌指南](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general)。  
