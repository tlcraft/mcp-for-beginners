...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-20T20:34:11+00:00",
...
本课重点介绍如何参与 MCP 社区、为 MCP 生态系统做出贡献，以及遵循协作开发的最佳实践。了解如何参与开源 MCP 项目，对于希望推动这项技术未来发展的人来说至关重要。
...
1. **核心协议维护者**：Microsoft 及其他维护 MCP 核心规范和参考实现的组织
2. **工具开发者**：开发 MCP 工具的个人和团队
...
1. **从小处开始**：先从文档、漏洞修复或小的改进入手
2. **遵循风格指南**：遵守项目的编码风格和规范
3. **编写测试**：为代码贡献添加单元测试
4. **完善文档**：为新功能或更改添加清晰的文档
5. **提交针对性 PR**：保持拉取请求聚焦于单个问题或功能
6. **积极响应反馈**：及时回复关于贡献的反馈
...
- Microsoft 技术社区
- Discord 和 Slack 频道
- Stack Overflow（标签：`model-context-protocol` or `mcp`）
...
**免责声明**：  
本文件已使用 AI 翻译服务 [Co-op Translator](https://github.com/Azure/co-op-translator) 进行翻译。虽然我们力求准确，但请注意自动翻译可能包含错误或不准确之处。原始文件的母语版本应被视为权威来源。对于重要信息，建议使用专业人工翻译。我们不对因使用本翻译而产生的任何误解或误释承担责任。