...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-16T15:53:05+00:00",
...
1. **核心协议维护者**：微软及其他组织，负责维护核心 MCP 规范和参考实现
2. **工具开发者**：个人和团队，负责开发 MCP 工具
...
- 遵循贡献指南有助于提高 PR 被接受的几率
- 创建并分享 MCP 工具是丰富生态系统的重要方式
- 社区协作对 MCP 的成长和完善至关重要

## 练习

1. 根据您的技能和兴趣，找出 MCP 生态系统中您可以贡献的领域
2. Fork MCP 仓库并搭建本地开发环境
3. 创建一个小的增强、Bug 修复或工具，惠及社区
4. 用适当的测试和文档说明您的贡献
5. 向相应仓库提交拉取请求
...
**免责声明**：  
本文件使用 AI 翻译服务 [Co-op Translator](https://github.com/Azure/co-op-translator) 进行翻译。尽管我们力求准确，但请注意自动翻译可能存在错误或不准确之处。原始文件的母语版本应被视为权威来源。对于重要信息，建议采用专业人工翻译。对于因使用本翻译而产生的任何误解或误释，我们不承担任何责任。