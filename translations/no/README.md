...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T07:26:26+00:00",
...
| 3.8 | Testing | Test din MCP-serverimplementasjon | [Guide](./03-GettingStarted/08-testing/README.md) |
...
| 5.7 | Skalering | Skalere MCP-implementasjoner | [Guide](./05-AdvancedTopics/mcp-scaling/README.md) |
...
| Java med Spring | Eksempel på containerapp | [View Code](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
Vi opprettholder en detaljert [Endringslogg](./changelog.md) som sporer alle viktige oppdateringer av kursmaterialet, inkludert:
...
Handler om å gi utviklere mulighet til å bruke MCP i arbeidsflyten sin og feire det fantastiske MCP-fellesskapet. Vi får selskap av fellesskapsmedlemmer og partnere som Arcade, Block, Okta og Neon for å se hvordan de samarbeider med Microsoft for å forme et åpent, utvidbart MCP-økosystem.  
...
Lær gjennom intensive videosesjoner hvordan du lager MCP-servere, integrerer med VS Code og distribuerer profesjonelt på Azure basert på innhold fra MCP for nybegynnere. Gå derfra med praktiske ferdigheter i en teknologi som store selskaper allerede bruker.
...
rettighetene til å bruke bidraget ditt. For detaljer, besøk  
...
- **changelog.md**: Oversikt over alle viktige endringer i kursmaterialet
...
- [Mestring av GitHub Copilot for AI-parprogrammering](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
