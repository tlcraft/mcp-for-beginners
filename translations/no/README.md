...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-23T06:49:23+00:00",
...
**Model Context Protocol (MCP)** er et banebrytende rammeverk utviklet for å standardisere samhandling mellom AI-modeller og klientapplikasjoner. Denne åpne læreplanen gir en strukturert læringsvei, komplett med praktiske kodeeksempler og virkelige bruksområder, på populære programmeringsspråk som C#, Java, JavaScript, TypeScript og Python.

Enten du er AI-utvikler, systemarkitekt eller programvareingeniør, er denne guiden din komplette ressurs for å mestre MCP-grunnleggende og implementeringsstrategier.
...
| 03 | **Kom i gang med MCP** | Oppsett og konfigurasjon av miljø, lage grunnleggende MCP-servere og klienter, integrere MCP med eksisterende applikasjoner | [Kom i gang](./03-GettingStarted/README.md) |
| 3.1 | **Første server** | Sette opp en enkel server med MCP-protokollen, forstå server-klient-interaksjonen, og teste serveren | [Første server](./03-GettingStarted/01-first-server/README.md) |
| 3.2 | **Første klient**  | Sette opp en enkel klient med MCP-protokollen, forstå klient-server-interaksjonen, og teste klienten | [Første klient](./03-GettingStarted/02-client/README.md) |
...
| 3.4 | **Bruke en server med Visual Studio Code** | Konfigurere Visual Studio Code for å konsumere servere via MCP-protokollen | [Bruke en server med Visual Studio Code](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | **Opprette en server med SSE** | SSE hjelper oss med å eksponere en server mot internett. Denne delen hjelper deg med å lage en server med SSE | [Opprette en server med SSE](./03-GettingStarted/05-sse-server/README.md) |
| 3.6 | **Bruk AI Toolkit** | AI Toolkit er et flott verktøy som hjelper deg å administrere AI- og MCP-arbeidsflyten din. | [Bruk AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
| 3.7 | **Teste serveren din** | Testing er en viktig del av utviklingsprosessen. Denne delen hjelper deg med å teste ved hjelp av flere forskjellige verktøy. | [Teste serveren din](./03-GettingStarted/07-testing/README.md) |
| 3.8 | **Distribuer serveren din** | Hvordan går du fra lokal utvikling til produksjon? Denne delen hjelper deg med å utvikle og distribuere serveren din. | [Distribuer serveren din](./03-GettingStarted/08-deployment/README.md) |
| 04 | **Praktisk implementering** | Bruke SDK-er på tvers av språk, feilsøking, testing og validering, lage gjenbrukbare promptmaler og arbeidsflyter | [Praktisk implementering](./04-PracticalImplementation/README.md) |
...
| 07 | **Innsikter fra tidlig adopsjon** | Virkelige implementasjoner og hva som fungerte, bygge og distribuere MCP-baserte løsninger, trender og fremtidig veikart | [Innsikter](./07-LessonsFromEarlyAdoption/README.md) |
...
| 09 | **MCP casestudier** | Dypdykk i MCP-løsningsarkitekturer, distribusjonsplaner og integrasjonstips, annoterte diagrammer og prosjektgjennomganger | [Casestudier](./09-CaseStudy/README.md) |
...
Når du sender en pull request, vil en CLA-bot automatisk avgjøre om du må levere en CLA og merke PR-en deretter (f.eks. statuskontroll, kommentar). Følg bare instruksjonene fra boten. Du trenger bare gjøre dette én gang for alle repos som bruker vår CLA.

Dette prosjektet har tatt i bruk [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/). For mer informasjon, se [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) eller kontakt [opencode@microsoft.com](mailto:opencode@microsoft.com) med spørsmål eller kommentarer.
