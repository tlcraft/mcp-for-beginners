...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-20T17:22:42+00:00",
...
## 🧠 Oversikt over Model Context Protocol Læreplan

**Model Context Protocol (MCP)** er et banebrytende rammeverk utviklet for å standardisere samhandling mellom AI-modeller og klientapplikasjoner. Denne åpne læreplanen tilbyr en strukturert læringsvei, komplett med praktiske kodeeksempler og virkelige bruksområder, på populære programmeringsspråk som C#, Java, JavaScript, TypeScript og Python.
...
| 3.3 | **Klient med LLM**  | Sette opp en klient med MCP-protokollen og en stor språkmodell (LLM) | [Klient med LLM](./03-GettingStarted/03-llm-client/README.md) |
...
| 3.5 | **Opprette en server med SSE** | SSE hjelper oss med å eksponere en server på internett. Denne delen hjelper deg å lage en server med SSE | [Opprette en server med SSE](./03-GettingStarted/05-sse-server/README.md) |
...
| 3.7 | **Teste serveren din** | Testing er en viktig del av utviklingsprosessen. Denne delen hjelper deg å teste med flere ulike verktøy. | [Teste serveren din](./03-GettingStarted/07-testing/README.md) |
| 3.8 | **Distribuer serveren din** | Hvordan går du fra lokal utvikling til produksjon? Denne delen hjelper deg å utvikle og distribuere serveren din. | [Distribuer serveren din](./03-GettingStarted/08-deployment/README.md) |
...
| 07 | **Innsikter fra tidlig adopsjon** | Virkelige implementeringer og hva som fungerte, bygge og distribuere MCP-baserte løsninger, trender og fremtidig veikart | [Innsikter](./07-LessonsFromEarlyAdoption/README.md) |
...
<details>
  <summary><strong>Utforsk kodeimplementeringer etter språk</strong></summary>
...
Dette prosjektet tar imot bidrag og forslag. De fleste bidrag krever at du godtar en Contributor License Agreement (CLA) som bekrefter at du har rettighetene til, og faktisk gir oss rett til å bruke ditt bidrag. For detaljer, besøk <https://cla.opensource.microsoft.com>.
...
## 🎒 Andre kurs
Vårt team tilbyr flere kurs! Sjekk ut:
