...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-23T06:10:01+00:00",
...
# 🚀 Modellkontekstprotokoll (MCP) Læreplan for Nybegynnere

## **Lær MCP med Praktiske Kodeeksempler i C#, Java, JavaScript, Python og TypeScript**

## 🧠 Oversikt over Modellkontekstprotokollens Læreplan

**Modellkontekstprotokollen (MCP)** er et banebrytende rammeverk utviklet for å standardisere samspillet mellom AI-modeller og klientapplikasjoner. Denne åpen kildekode-læreplanen tilbyr en strukturert læringsvei, komplett med praktiske kodeeksempler og virkelige bruksområder, på populære programmeringsspråk som C#, Java, JavaScript, TypeScript og Python.
...
## 🧭 Fullstendig Struktur for MCP Læreplan
...
| 02 | **Sikkerhet i MCP** | Identifisering av sikkerhetstrusler i MCP-baserte systemer, teknikker og beste praksis for sikre implementasjoner | [Sikkerhet](./02-Security/README.md) |
...
| 3.3 | **Klient med LLM** | Oppsett av en klient med MCP-protokollen som bruker en stor språkmodell (LLM) | [Klient med LLM](./03-GettingStarted/03-llm-client/README.md) |
| 3.4 | **Bruke Visual Studio Code til å konsumere en server** | Konfigurere Visual Studio Code for å bruke servere via MCP-protokollen | [Bruke Visual Studio Code](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | **Opprette en server med SSE** | SSE hjelper oss med å eksponere en server på internett. Denne delen viser hvordan du lager en server med SSE | [Opprette server med SSE](./03-GettingStarted/05-sse-server/README.md) |
...
| 3.7 | **Teste serveren din** | Testing er en viktig del av utviklingsprosessen. Denne delen hjelper deg å teste med flere ulike verktøy | [Teste serveren](./03-GettingStarted/07-testing/README.md) |
| 3.8 | **Distribuere serveren din** | Hvordan går du fra lokal utvikling til produksjon? Denne delen hjelper deg med utvikling og distribusjon av serveren | [Distribuere serveren](./03-GettingStarted/08-deployment/README.md) |
| 04 | **Praktisk implementering** | Bruke SDK-er på forskjellige språk, feilsøking, testing og validering, lage gjenbrukbare promptmaler og arbeidsflyter | [Praktisk implementering](./04-PracticalImplementation/README.md) |
...
| 06 | **Fellesskapsbidrag** | Hvordan bidra med kode og dokumentasjon, samarbeid via GitHub, fellesskapsdrevne forbedringer og tilbakemeldinger | [Fellesskapsbidrag](./06-CommunityContributions/README.md) |
| 07 | **Erfaringer fra tidlig adopsjon** | Virkelige implementeringer og hva som fungerte, bygge og distribuere MCP-baserte løsninger, trender og fremtidig veikart | [Erfaringer](./07-LessonsFromEarlyAdoption/README.md) |
...
| 09 | **MCP Casestudier** | Dypdykk i MCP-løsningsarkitekturer, distribusjonsmaler og integrasjonstips, kommenterte diagrammer og prosjektgjennomganger | [Casestudier](./09-CaseStudy/README.md) |
...
- Grunnleggende kunnskaper i C#, Java eller Python  
- Forståelse av klient-server-modellen og API-er  
- (Valgfritt) Kjennskap til maskinlæring  

## 🛠️ Hvordan bruke dette læreopplegget effektivt
...
Dette prosjektet ønsker bidrag og forslag velkommen. De fleste bidrag krever at du godtar en Contributor License Agreement (CLA) som bekrefter at du har rett til å, og faktisk gir oss, rettighetene til å bruke ditt bidrag. For detaljer, besøk <https://cla.opensource.microsoft.com>.

Når du sender en pull request, vil en CLA-bot automatisk avgjøre om du må levere en CLA og merke PR-en deretter (f.eks. statuskontroll, kommentar). Følg bare instruksjonene fra boten. Du trenger bare å gjøre dette én gang for alle repoer som bruker vår CLA.
...
## 🎒 Andre kurs
Teamet vårt lager flere kurs! Ta en titt på:
