...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:30:49+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "no"
}
-->
# Database Design og Skjema

## 🎯 Hva Denne Labben Dekker

Denne labben går i dybden på PostgreSQL-databasedesign for Zava Retail-systemet. Du vil lære å implementere et omfattende detaljhandelsskjema med vektorsøk, multi-tenant datamodellering og Row Level Security (RLS) for dataisolasjon.

## Oversikt

Databasen er grunnlaget for vår MCP-server, og lagrer detaljhandelsdata på tvers av flere butikker samtidig som den opprettholder streng dataisolasjon. Vi bruker PostgreSQL med pgvector-utvidelsen for å muliggjøre semantiske søk, slik at kundene kan finne produkter ved hjelp av naturlige språkspørsmål.

Skjemaet vårt følger moderne multi-tenant mønstre med Row Level Security som sikrer at brukere kun kan få tilgang til data fra sine autoriserte butikker. Denne tilnærmingen gir sikkerhet på bedriftsnivå samtidig som den opprettholder optimal ytelse.

## Læringsmål

Ved slutten av denne labben vil du kunne:

- **Designe** skalerbare multi-tenant detaljhandelsskjemaer
- **Implementere** PostgreSQL med pgvector for vektorsøk
- **Konfigurere** Row Level Security for dataisolasjon
- **Generere** realistiske testdata for testing
- **Optimalisere** databaseytelse for detaljhandelsarbeidsbelastninger
- **Implementere** backup- og gjenopprettingsstrategier

## 🗃️ Databasearkitektur

### PostgreSQL med pgvector

Databasen vår utnytter PostgreSQLs funksjoner kombinert med pgvector-utvidelsen for AI-drevet søk:
...
Databasen bruker en **delt database, delt skjema** multi-tenant modell med Row Level Security:
...
## 🔍 Implementering av Vektorsøk

### Produktembedding-tabell
...
## 🔐 Oppsett av Row Level Security

### Database Roller og Tillatelser
...
### Spørringsoptimaliseringsvisninger
...
✅ **Multi-tenant Databasedesign**: Implementert Row Level Security for sikker dataisolasjon  
✅ **Vektorsøkfunksjonalitet**: Konfigurert pgvector for semantisk produktsøk  
✅ **Omfattende Skjema**: Opprettet produksjonsklart detaljhandelsskjema  
✅ **Generering av Testdata**: Bygget realistiske testdata for utvikling og testing  
✅ **Ytelsesoptimalisering**: Konfigurert indekser og spørringsoptimalisering  
✅ **Backup og Gjenoppretting**: Etablert robuste databeskyttelsesstrategier  

## 🚀 Hva Nå

Fortsett med **[Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)** for å:

- Bygge FastMCP-serveren som kobles til denne databasen
- Implementere databaseverktøy for MCP-protokollen
- Legge til semantisk søk ved hjelp av embedding
- Konfigurere tilkoblingspooling og feilhåndtering

## 📚 Ekstra Ressurser

### PostgreSQL & pgvector
- [PostgreSQL Dokumentasjon](https://www.postgresql.org/docs/) - Komplett PostgreSQL-referanse
- [pgvector Utvidelse](https://github.com/pgvector/pgvector) - Vektorsøk for PostgreSQL
- [PostgreSQL Ytelsesoptimalisering](https://wiki.postgresql.org/wiki/Performance_Optimization) - Beste praksis for optimalisering

### Multi-tenant Arkitektur
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS-dokumentasjon
- [Multi-tenant Dataarkitektur](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure arkitekturmønstre
- [Beste praksis for databasesikkerhet](https://www.postgresql.org/docs/current/security.html) - PostgreSQL sikkerhetsveiledning

### Vektordatabaser
- [Grunnleggende om Vektorsøk](https://www.pinecone.io/learn/vector-database/) - Forstå vektordatabaser
- [Embedding-modeller](https://platform.openai.com/docs/guides/embeddings) - OpenAI embedding-dokumentasjon
...
**Neste**: [Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)
