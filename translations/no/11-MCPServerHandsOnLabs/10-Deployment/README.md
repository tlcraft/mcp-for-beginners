...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:28:47+00:00",
...
Denne labben gir omfattende veiledning om hvordan du kan utrullere MCP retail-serveren din til produksjonsmiljøer ved hjelp av moderne containerisering og skybaserte tilnærminger. Du vil lære å utrullere skalerbare, sikre og overvåkede MCP-servere som kan håndtere arbeidsmengder på bedriftsnivå.

## Oversikt

Produksjonsutrullering av MCP-servere krever nøye vurdering av containerisering, orkestrering, sikkerhet, skalerbarhet og overvåking. Denne labben dekker utrullering til Azure Container Apps med PostgreSQL Flexible Server, implementering av CI/CD-pipelines og konfigurering av automatisk skalering for varierende arbeidsmengder.

Utrullingsstrategiene spenner fra enkle enkeltcontainer-utrullinger for utvikling til sofistikerte multi-region, automatisk skalerende produksjonsmiljøer med omfattende overvåking og sikkerhetsfunksjoner.

## Læringsmål

Ved slutten av denne labben vil du kunne:

- **Containerisere** MCP-servere ved hjelp av Docker med multi-stage builds
- **Utrullere** til Azure Container Apps med sikker nettverkskonfigurasjon
- **Konfigurere** produksjonsklare PostgreSQL med høy tilgjengelighet
- **Implementere** CI/CD-pipelines for automatisert utrullering
- **Skalere** applikasjoner automatisk basert på etterspørsel
- **Overvåke** produksjonsutrullinger med omfattende observasjonsverktøy
...
## ☁️ Utrullering til Azure Container Apps
...
## 🚀 Konfigurering av CI/CD-pipeline
...
### Konfigurering av automatisk skalering
...
## 🔐 Sikkerhetskonfigurasjon for produksjon
...
✅ **Containerstrategi**: Produksjonsklare Docker-containere med sikkerhetsforbedringer  
✅ **Skyutrullering**: Azure Container Apps med automatisk skalering og overvåking  
✅ **Databaseutrullering**: PostgreSQL Flexible Server med høy tilgjengelighet  
✅ **CI/CD-pipelines**: Automatiserte test-, bygge- og utrulleringsarbeidsflyter  
✅ **Ytelsesovervåking**: Omfattende innsamling av metrikker og varsling  
✅ **Sikkerhetskonfigurasjon**: Produksjonsklare sikkerhetspolicyer og nettverksisolasjon  

## 🚀 Hva Nå?

Fortsett med **[Lab 11: Overvåking og Observasjon](../11-Monitoring/README.md)** for å:

- Sette opp omfattende overvåking med Application Insights
- Konfigurere strukturert logging og distribuert sporing
- Implementere varsling og automatiserte responssystemer
- Overvåke forretningsmetrikker og ytelses-KPIer

## 📚 Tilleggsressurser

### Containerteknologier
- [Docker Best Practices](https://docs.docker.com/develop/dev-best-practices/) - Offisielle Docker beste praksiser
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Dokumentasjon for Azure Container Apps
- [Kubernetes Documentation](https://kubernetes.io/docs/) - Offisiell dokumentasjon for Kubernetes

### CI/CD og DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - Dokumentasjon for GitHub Actions
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Tjenester for Azure DevOps
- [Infrastructure as Code](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Dokumentasjon for Azure Bicep

### Sikkerhet og Overvåking
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Anbefalinger for sikkerhet i Azure
- [Container Security](https://kubernetes.io/docs/concepts/security/) - Sikkerhetskonsepter for Kubernetes
- [Application Insights](https://docs.microsoft.com/en-us/azure/azure-monitor/app/app-insights-overview) - Oversikt over Azure Application Insights

---

**Forrige**: [Lab 09: VS Code-integrasjon](../09-VS-Code/README.md)  
**Neste**: [Lab 11: Overvåking og Observasjon](../11-Monitoring/README.md)
