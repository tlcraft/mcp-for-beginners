...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:03:29+00:00",
...
Denne praktiske labben veileder deg gjennom implementeringen av en produksjonsklar MCP-server ved hjelp av FastMCP-rammeverket. Du vil bygge den grunnleggende serverstrukturen, implementere databaseintegrasjon, lage verktøy for datatilgang, og etablere grunnlaget for AI-drevet detaljhandelsanalyse.

## Oversikt

MCP-serveren er hjertet i vår løsning for detaljhandelsanalyse. Den fungerer som en bro mellom AI-assistenter og PostgreSQL-databasen, og gir sikker, intelligent tilgang til forretningsdata gjennom en standardisert protokoll.

Denne labben lærer deg å bygge en robust og skalerbar MCP-server som følger mønstre og beste praksis for bedrifter.

## Læringsmål

Ved slutten av denne labben vil du kunne:

- **Bygge** en FastMCP-server med riktig arkitektur og organisering
- **Implementere** databaseintegrasjon med tilkoblingspooling og feilhåndtering
- **Lage** MCP-verktøy for database-skjema introspeksjon og spørringsutførelse
- **Konfigurere** kontekststyring for Row Level Security
- **Legge til** funksjoner for helsesjekk og observabilitet
- **Teste** MCP-serverimplementeringen lokalt og med VS Code

## 📁 Prosjektstruktur

La oss se nærmere på organiseringen av MCP-serveren:
...
### Miljøkonfigurasjon (`config.py`)

Først, la oss lage et robust konfigurasjonssystem:
...
### Viktige Konfigurasjonsfunksjoner

- **Lading av miljøvariabler**: Automatisk støtte for .env-filer
- **Type-sikkerhet**: Validering med dataklasser og typehint
- **Fleksible standardverdier**: Fornuftige standarder for utvikling
- **Validering**: Konfigurasjonsvalidering med nyttige feilmeldinger
- **Sikkerhet**: Sensitive verdier kun fra miljøvariabler

## 🗄️ Databaseintegrasjonslag

### PostgreSQL-leverandør (`sales_analysis_postgres.py`)

La oss implementere databaseintegrasjonslaget:
...
### Viktige Funksjoner i Database-laget

- **Tilkoblingspooling**: Effektiv ressursstyring med asyncpg
- **RLS-integrasjon**: Automatisk kontekstinnstilling for Row Level Security
- **Skjema-introspeksjon**: Dynamisk oppdagelse av tabellskjema
- **Feilhåndtering**: Omfattende feilhåndtering og logging
- **Spørringsformatering**: AI-vennlig resultatformatering
- **Helsesjekk**: Kontroll av databaseforbindelse og poolstatus

## 🔧 Hovedimplementasjon av MCP-serveren

### FastMCP-server (`sales_analysis.py`)

Nå skal vi implementere hoved-MCP-serveren:
...
### Viktige Funksjoner i MCP-serveren

- **Verktøyregistrering**: Deklarative verktøydefinisjoner med type-sikkerhet
- **RLS-kontekststyring**: Automatisk utvinning av brukeridentitet og kontekstinnstilling
- **Feilhåndtering**: Omfattende feilhåndtering med brukervennlige meldinger
- **Livssyklusstyring**: Riktig oppstart/nedstenging med ressursopprydding
- **Helsesjekk**: Innebygde helsesjekk-endepunkter
- **Utviklingsstøtte**: Hot reload og feilsøkingsmuligheter

## 🏥 Helsesjekk

### Implementering av Helsesjekk (`health_check.py`)
...
### Testing med VS Code-integrasjon
...
2. **Test i AI Chat**:
   - Åpne VS Code AI Chat
   - Skriv `#zava` og velg serveren din
   - Spør: "Hvilke tabeller er tilgjengelige?"
   - Spør: "Vis meg de 5 beste butikkene basert på antall bestillinger"

### Enhetstesting

Lag omfattende enhetstester:
...
✅ **Fungerende MCP-server**: FastMCP-server med databaseintegrasjon  
✅ **Konfigurasjonsstyring**: Robust miljøbasert konfigurasjon  
✅ **Databaselag**: PostgreSQL-integrasjon med tilkoblingspooling  
✅ **MCP-verktøy**: Verktøy for skjema-introspeksjon og spørringsutførelse  
✅ **RLS-integrasjon**: Kontekststyring for Row Level Security  
✅ **Helsesjekk**: Omfattende helsesjekk-endepunkter  
✅ **Teststrategi**: Lokal testing og VS Code-integrasjon  

## 🚀 Hva Nå

Fortsett med **[Lab 06: Verktøyutvikling](../06-Tools/README.md)** for å:

- Utvide MCP-verktøysamlingen din
- Implementere avanserte spørringsmønstre
- Legge til datavalidering og transformasjon
- Lage spesialiserte analyseverktøy

## 📚 Ekstra Ressurser

### FastMCP-rammeverket
- [FastMCP Dokumentasjon](https://github.com/modelcontextprotocol/python-sdk) - Offisiell FastMCP-guide
- [MCP Spesifikasjon](https://modelcontextprotocol.io/docs/) - Protokollspesifikasjon
- [Verktøyutviklingsguide](https://modelcontextprotocol.io/docs/tools/) - Lage MCP-verktøy

### Databaseintegrasjon
- [asyncpg Dokumentasjon](https://magicstack.github.io/asyncpg/current/) - PostgreSQL async-driver
- [Beste praksis for tilkoblingspooling](https://www.postgresql.org/docs/current/runtime-config-connection.html) - PostgreSQL-innstillinger
- [Row Level Security Guide](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - RLS-implementering

### FastAPI-mønstre
- [FastAPI Dokumentasjon](https://fastapi.tiangolo.com/) - Referanse for webrammeverk
- [Avhengighetsinjeksjon](https://fastapi.tiangolo.com/tutorial/dependencies/) - FastAPI-mønstre
- [Bakgrunnsoppgaver](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Asynkron oppgavehåndtering

---

**Neste**: Klar til å utvide verktøyene dine? Fortsett med [Lab 06: Verktøyutvikling](../06-Tools/README.md)
