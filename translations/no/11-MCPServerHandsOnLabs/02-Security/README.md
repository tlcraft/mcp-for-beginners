...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:15:18+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "no"
}
-->
# Sikkerhet og Multi-Tenancy

## 🎯 Hva Denne Labben Dekker

Denne labben gir omfattende veiledning om hvordan man implementerer sikkerhet i bedriftsklasse og multi-tenancy for MCP-servere. Du vil lære å designe sikre, kompatible systemer som beskytter sensitiv detaljhandelsdata samtidig som du muliggjør fleksible tilgangsmønstre på tvers av flere leietakere.

## Oversikt

Sikkerhet er avgjørende i detaljhandelsapplikasjoner som håndterer kundedata, betalingsinformasjon og forretningsintelligens. Denne labben dekker hele sikkerhetsarkitekturen fra autentisering og autorisasjon til dataisolasjon og samsvarsmonitorering.

Vi implementerer en "defense-in-depth"-strategi som kombinerer Azure identitetstjenester, PostgreSQL Row Level Security, applikasjonsnivåkontroller og omfattende revisjonslogging for å skape en robust, kompatibel plattform.

## Læringsmål

Ved slutten av denne labben vil du kunne:

- **Implementere** Row Level Security i bedriftsklasse for dataisolasjon mellom leietakere
- **Designe** sikre autentiserings- og autorisasjonsmønstre med Azure
- **Konfigurere** omfattende revisjonslogging for samsvarskrav
- **Anvende** "defense-in-depth"-sikkerhetsstrategier på alle applikasjonslag
- **Validere** sikkerhetsimplementeringer gjennom systematisk testing
- **Overvåke** sikkerhetshendelser og reagere på potensielle trusler

## 🔐 Multi-Tenant Sikkerhetsarkitektur

### Oversikt over Sikkerhetslag
...
Vår implementering bruker modellen **Shared Database, Shared Schema** med Row Level Security:

**Fordeler:**
- Kostnadseffektiv ressursutnyttelse
- Forenklet vedlikehold og oppdateringer
- Sterk dataisolasjon gjennom RLS
- Samsvarsvennlige revisjonsspor

**Ulemper:**
- Krever nøye design av RLS-policyer
- Skjemaendringer påvirker alle leietakere
- Behov for robuste backup/gjenopprettingsprosedyrer
...
### Administrasjon av Butikkontekst
...
### Integrasjon med Azure Entra ID
...
### Sikkerhetsmonitoreringsvisninger
...
### Sjekkliste for Penetrasjonstesting
...
✅ **Multi-Tenant Sikkerhet**: Implementert Row Level Security for full dataisolasjon  
✅ **Azure Autentisering**: Integrert Azure Entra ID med JWT-validering  
✅ **Rollebasert Autorisasjon**: Konfigurert hierarkisk rolle- og tillatelsessystem  
✅ **Omfattende Revisjonslogging**: Etablert sporing og monitorering av sikkerhetshendelser  
✅ **Sikkerhetstesting**: Implementert automatiserte sikkerhetsvalideringstester  
✅ **Trusselmonitorering**: Opprettet sanntidsdeteksjon og varsling av sikkerhetshendelser  

## 🚀 Hva Nå

Fortsett med **[Lab 03: Miljøoppsett](../03-Setup/README.md)** for å:

- Konfigurere utviklingsmiljøer med sikkerhetsbeste praksis
- Sette opp Azure-tjenester for autentisering og monitorering
- Implementere sikre databaseforbindelser og hemmelighetsadministrasjon
- Validere sikkerhetskonfigurasjoner i utviklingsmiljøer

## 📚 Ekstra Ressurser

### Azure Sikkerhet
- [Azure Entra ID Dokumentasjon](https://docs.microsoft.com/azure/active-directory/) - Komplett guide til identitetsplattformen
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Tjeneste for hemmelighetsadministrasjon
- [Azure Sikkerhetsbeste Praksis](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Veiledning for sikkerhet

### Databasesikkerhet
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Offisiell RLS-dokumentasjon
- [Sjekkliste for Databasesikkerhet](https://www.postgresql.org/docs/current/security.html) - PostgreSQL sikkerhetsguide
- [Multi-Tenant Database Mønstre](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Arkitekturmønstre

### Sikkerhetstesting
- [OWASP Testing Guide](https://owasp.org/www-project-web-security-testing-guide/) - Omfattende sikkerhetstesting
- [JWT Sikkerhetsbeste Praksis](https://tools.ietf.org/html/rfc8725) - JWT sikkerhetsbetraktninger
- [API Sikkerhetstesting](https://owasp.org/www-project-api-security/) - API-spesifikk sikkerhetstesting

---

**Forrige**: [Lab 01: Grunnleggende Arkitekturkonsepter](../01-Architecture/README.md)  
**Neste**: [Lab 03: Miljøoppsett](../03-Setup/README.md)
