...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-20T20:51:30+00:00",
...
이 강의에서는 MCP 커뮤니티에 참여하는 방법, MCP 생태계에 기여하는 방법, 그리고 협업 개발을 위한 모범 사례를 다룹니다. 오픈소스 MCP 프로젝트에 참여하는 방법을 이해하는 것은 이 기술의 미래를 형성하고자 하는 사람들에게 매우 중요합니다.
...
- MCP 오픈소스 저장소에 기여하기
- 맞춤형 MCP 도구를 만들고 공유하기
- MCP 개발과 협업을 위한 모범 사례 따르기
...
1. **Core Protocol Maintainers**: Microsoft 및 기타 조직으로, 핵심 MCP 사양과 참조 구현을 관리합니다
...
5. **Contributors**: 코드, 문서, 기타 자원을 기여하는 커뮤니티 멤버
...
1. **작게 시작하기**: 문서, 버그 수정, 작은 개선부터 시작하세요
2. **스타일 가이드 준수하기**: 프로젝트의 코딩 스타일과 규칙을 따르세요
3. **테스트 작성하기**: 코드 기여에는 단위 테스트를 포함하세요
4. **작업 문서화하기**: 새로운 기능이나 변경 사항을 명확히 문서화하세요
5. **목표가 명확한 PR 제출하기**: 한 이슈나 기능에 집중된 풀 리퀘스트를 만드세요
6. **피드백에 적극 대응하기**: 기여에 대한 피드백에 신속히 응답하세요
...
## 맞춤형 MCP 도구 만들기 및 공유하기

MCP 생태계에 기여하는 가장 가치 있는 방법 중 하나는 맞춤형 도구를 만들어 공유하는 것입니다.
...
2. **클라이언트 호환성**: 하위 호환성을 고려하세요
3. **서버 호환성**: 서버 구현 지침을 따르세요
4. **파괴적 변경**: 파괴적 변경 사항은 명확히 문서화하세요

## 커뮤니티 프로젝트 예시: MCP Tool Registry

중요한 커뮤니티 기여 중 하나는 MCP 도구의 공개 레지스트리를 개발하는 것입니다.
...
- MCP 커뮤니티는 다양하며 여러 유형의 기여를 환영합니다
- MCP 기여는 핵심 프로토콜 개선부터 맞춤형 도구까지 다양합니다
- 기여 가이드라인을 따르면 PR 승인 확률이 높아집니다
...
3. 커뮤니티에 도움이 될 작은 개선, 버그 수정 또는 도구를 만들어보세요
4. 적절한 테스트와 문서화로 기여 내용을 기록하세요
