...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T09:47:39+00:00",
...
3. [**Azure AI Foundry Discord에 참여하여 전문가 및 개발자들과 교류하기**](https://discord.com/invite/ByRwuEEgH4)
...
- 📜 [MCP 명세서](https://modelcontextprotocol.io/docs/) – 프로토콜 아키텍처 및 기술 참고자료  
- 📜 [원본 MCP 명세서](https://spec.modelcontextprotocol.io/) – 이전 기술 참고자료 (추가 정보 포함 가능)  
...
|--------|-------|-------------|------|
| **모듈 1-3: 기본 개념** | | | |
| 00 | MCP 소개 | Model Context Protocol 개요 및 AI 파이프라인에서의 중요성 | [자세히 읽기](./00-Introduction/README.md) |
...
| 3.5 | SSE 서버 | Server-Sent Events를 이용한 서버 만들기 | [가이드](./03-GettingStarted/05-sse-server/README.md) |
...
| 3.8 | 테스트 | MCP 서버 구현 테스트하기 | [가이드](./03-GettingStarted/08-testing/README.md) |
| 3.9 | 배포 | MCP 서버를 프로덕션에 배포하기 | [가이드](./03-GettingStarted/09-deployment/README.md) |
| **모듈 4-5: 실전 및 고급 주제** | | | |
| 04 | 실전 구현 | SDK, 디버깅, 테스트, 재사용 가능한 프롬프트 템플릿 | [자세히 읽기](./04-PracticalImplementation/README.md) |
| 05 | MCP 고급 주제 | 멀티모달 AI, 확장, 엔터프라이즈 활용 | [자세히 읽기](./05-AdvancedTopics/README.md) |
| 5.1 | Azure 통합 | Azure와 MCP 통합 | [가이드](./05-AdvancedTopics/mcp-integration/README.md) |
| 5.2 | 멀티모달리티 | 여러 모달리티 다루기 | [가이드](./05-AdvancedTopics/mcp-multi-modality/README.md) |
...
| 5.7 | 확장 | MCP 구현 확장하기 | [가이드](./05-AdvancedTopics/mcp-scaling/README.md) |
...
| 5.12 | Entra ID 인증 | Microsoft Entra ID를 이용한 인증 | [Guide](./05-AdvancedTopics/mcp-security-entra/README.md) |
| 5.13 | Foundry 통합 | Azure AI Foundry와 통합하기 | [Guide](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
...
| 07 | 초기 도입 사례 인사이트 | 실제 구현 사례 이야기 | [Guide](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | MCP 모범 사례 | 성능, 내결함성, 복원력 | [Guide](./08-BestPractices/README.md) |
| 09 | MCP 사례 연구 | 실무 적용 사례 | [Guide](./09-CaseStudy/README.md) |
| 10 | 실습 워크숍 | AI 툴킷으로 MCP 서버 구축하기 | [Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
| Java | 컨테이너 앱 예제 | [View Code](./04-PracticalImplementation/samples/java/containerapp/README.md) |
| JavaScript | 고급 샘플 | [View Code](./04-PracticalImplementation/samples/javascript/README.md) |
| Python | 복잡한 구현 | [View Code](../../04-PracticalImplementation/samples/python/mcp_sample.py) |
...
포괄적인 [학습 가이드](./study_guide.md)를 통해 이 저장소를 효율적으로 탐색할 수 있습니다. 가이드에는 다음이 포함됩니다:
...
커리큘럼 자료의 주요 업데이트를 기록한 상세한 [변경 로그](./changelog.md)를 유지하고 있습니다. 내용에는 다음이 포함됩니다:
...
이 프로젝트는 기여와 제안을 환영합니다. 대부분의 기여는 기여자가 해당 기여에 대한 권리를 보유하고 있으며 실제로 권리를 부여한다는 내용을 명시하는
Contributor License Agreement(CLA)에 동의해야 합니다. 자세한 내용은 
<https://cla.opensource.microsoft.com>를 참고하세요.

풀 리퀘스트를 제출하면 CLA 봇이 자동으로 CLA 제출 필요 여부를 판단하고 PR에 적절한 표시(예: 상태 검사, 댓글)를 추가합니다. 봇의 안내에 따라 진행하면 되며,
이 과정은 모든 저장소에서 한 번만 수행하면 됩니다.
...
- [데이터 과학 입문](https://aka.ms/datascience-beginners?WT.mc_id=academic-105485-koreyst)
...
- [웹 개발 입문](https://aka.ms/webdev-beginners?WT.mc_id=academic-105485-koreyst)
- [IoT 입문](https://aka.ms/iot-beginners?WT.mc_id=academic-105485-koreyst)
- [XR 개발 입문](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)
