...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T17:47:50+00:00",
...
> ![!TIP]
> 일반적으로 브라우저보다 CLI 모드에서 인스펙터를 실행하는 것이 훨씬 빠릅니다.
> 인스펙터에 대해 더 자세히 알고 싶다면 [여기](https://github.com/modelcontextprotocol/inspector)를 참고하세요.
