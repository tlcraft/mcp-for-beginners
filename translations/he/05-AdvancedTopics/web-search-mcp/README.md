...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-14T03:41:13+00:00",
...
ראו את [`server.py`](../../../../05-AdvancedTopics/web-search-mcp/server.py) ו-[`client.py`](../../../../05-AdvancedTopics/web-search-mcp/client.py) לפרטים מלאים על המימוש.
