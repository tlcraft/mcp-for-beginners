...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:35:39+00:00",
...
המעבדה הזו מספקת הדרכה מקיפה על בדיקות וניפוי שגיאות של שרתי MCP בסביבות ייצור. תלמדו כיצד ליישם אסטרטגיות בדיקה חזקות, לנפות בעיות מורכבות ולהבטיח ששרת ה-MCP שלכם יפעל בצורה אמינה בתנאים שונים.

## סקירה כללית

בדיקות שרתי MCP דורשות גישה רב-שכבתית הכוללת בדיקות יחידה, בדיקות אינטגרציה, אימות ביצועים ובדיקות תרחישים מציאותיים. המעבדה הזו מכסה את מחזור הבדיקות המלא, החל מפיתוח ועד לניטור בייצור.

אסטרטגיית הבדיקות שלנו מדגישה אמינות, אבטחה וביצועים, ומבטיחה ששרת ה-MCP שלכם יוכל להתמודד עם עומסי עבודה בייצור תוך שמירה על שלמות הנתונים ואיכות חוויית המשתמש.

## מטרות למידה

בסיום המעבדה הזו, תוכלו:

- **ליישם** מערכי בדיקות יחידה ואינטגרציה מקיפים  
- **לעצב** אסטרטגיות בדיקה יעילות עבור כלי MCP ותפעול בסיסי נתונים  
- **לנפות** בעיות מורכבות באמצעות טכניקות ניפוי שגיאות מתקדמות  
- **לאמת** ביצועים תחת עומס עם תרחישי בדיקה מציאותיים  
- **לנטר** מערכות ייצור עם התראות ונראות אפקטיביות  
- **לאוטומט** תהליכי בדיקה עבור אינטגרציה רציפה  

## 🧪 ארכיטקטורת בדיקות

### סקירה כללית של אסטרטגיית הבדיקות
...
לאחר השלמת המעבדה הזו, תצאו עם:

✅ **מסגרת בדיקות מקיפה**: בדיקות יחידה, אינטגרציה וביצועים לכל הרכיבים  
✅ **כלי ניפוי שגיאות מתקדמים**: כלי ניפוי שגיאות מתוחכמים עם מעקב ביצוע  
✅ **אימות ביצועים**: יכולות בדיקות עומס וניתוח יכולת הרחבה  
✅ **בדיקות אבטחה**: מניעת הזרקות SQL ואימות RLS  
✅ **אינטגרציית ניטור**: מדדי ביצועים וניתוח צווארי בקבוק  
✅ **מוכנות CI/CD**: תהליכי בדיקות אוטומטיים לאינטגרציה רציפה  

## 🚀 מה הלאה

המשיכו עם **[מעבדה 09: אינטגרציה עם VS Code](../09-VS-Code/README.md)** כדי:

- להגדיר את VS Code לפיתוח שרתי MCP  
- להקים סביבות ניפוי שגיאות ב-VS Code  
- לשלב את שרת ה-MCP עם VS Code Chat  
- לבדוק את תהליך העבודה המלא ב-VS Code  

## 📚 משאבים נוספים

### מסגרות בדיקה
- [תיעוד pytest](https://docs.pytest.org/) - מסגרת בדיקות Python  
- [בדיקות AsyncPG](https://magicstack.github.io/asyncpg/current/index.html) - בדיקות PostgreSQL אסינכרוניות  
- [בדיקות FastAPI](https://fastapi.tiangolo.com/tutorial/testing/) - תבניות בדיקות API  

### בדיקות ביצועים
- [שיטות עבודה מומלצות לבדיקות עומס](https://docs.python.org/3/library/asyncio.html) - בדיקות ביצועים אסינכרוניות  
- [בדיקות ביצועים של בסיסי נתונים](https://www.postgresql.org/docs/current/performance-tips.html) - אופטימיזציה של PostgreSQL  
- [פרופיל זיכרון](https://docs.python.org/3/library/tracemalloc.html) - ניתוח זיכרון ב-Python  

### כלי ניפוי שגיאות
- [ניפוי שגיאות ב-Python](https://docs.python.org/3/library/pdb.html) - מנפה שגיאות של Python  
- [ניפוי שגיאות אסינכרוני](https://docs.python.org/3/library/asyncio-dev.html) - ניפוי שגיאות asyncio  
- [ניפוי שגיאות SQL](https://www.postgresql.org/docs/current/runtime-config-logging.html) - רישום PostgreSQL  

---

**קודם**: [מעבדה 07: אינטגרציה עם חיפוש סמנטי](../07-Semantic-Search/README.md)  
**הבא**: [מעבדה 09: אינטגרציה עם VS Code](../09-VS-Code/README.md)  
