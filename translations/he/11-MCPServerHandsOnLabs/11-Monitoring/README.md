...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:50:00+00:00",
...
המעבדה הזו מספקת הדרכה מקיפה ליישום ניטור, תצפית והתראות עבור שרת MCP בסביבות ייצור. תלמדו כיצד להגדיר את Application Insights, ליצור לוחות מחוונים משמעותיים, ליישם התראות אפקטיביות ולהקים תהליכי פתרון בעיות למצוינות תפעולית.

## סקירה כללית

ניטור ותצפית אפקטיביים הם קריטיים לשמירה על אמינות שרתי MCP בסביבת ייצור. המעבדה הזו מכסה את שלושת עמודי התצפית—מדדים, לוגים ועקבות—ומראה לכם כיצד ליישם ניטור מקיף שמאפשר זיהוי בעיות באופן יזום ופתרון מהיר של תקלות.

תלמדו כיצד להפוך נתוני טלמטריה גולמיים לתובנות מעשיות שיעזרו לכם להבין את התנהגות המערכת, לשפר ביצועים ולהבטיח זמינות גבוהה.

## מטרות למידה

בסיום המעבדה הזו, תוכלו:

- **ליישם** אינטגרציה מקיפה של Application Insights עבור שרתי MCP  
- **לעצב** תבניות לוגים מובנות לפתרון בעיות אפקטיבי  
- **ליצור** מערכות לאיסוף וניתוח מדדי ביצועים  
- **להגדיר** התראות חכמות עם הודעות פעולה  
- **לבנות** לוחות מחוונים תפעוליים לניטור בזמן אמת  
- **להקים** תהליכי פתרון בעיות אפקטיביים ומדריכי פעולה  

## 📊 אינטגרציה של Application Insights
...
### לוגים משופרים עם נתונים מובנים
...
### יישום לוחות מחוונים מותאמים אישית
...
לאחר השלמת המעבדה הזו, יהיו לכם:

✅ **אינטגרציה של Application Insights**: הגדרת טלמטריה וניטור מלאה  
✅ **לוגים מובנים**: לוגים מוכנים לייצור עם קורלציה והקשר  
✅ **מדדים מותאמים אישית**: איסוף וניתוח מדדים עסקיים וטכניים  
✅ **התראות חכמות**: התראות יזומות עם ערוצי הודעה מרובים  
✅ **לוחות מחוונים תפעוליים**: ניטור בזמן אמת ותובנות עסקיות  
✅ **תהליכי פתרון בעיות**: אבחון אוטומטי ומדריכי פעולה תפעוליים  

## 🚀 מה הלאה

המשיכו עם **[מעבדה 12: שיטות עבודה מיטביות ואופטימיזציה](../12-Best-Practices/README.md)** כדי:

- ליישם טכניקות אופטימיזציה ביצועים  
- ליישם חיזוק אבטחה מקיף  
- ללמוד שיטות עבודה מיטביות לפריסת ייצור  
- להקים אסטרטגיות אופטימיזציה עלויות  

## 📚 משאבים נוספים

### Azure Monitor  
- [תיעוד Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - מדריך ניטור מלא  
- [התייחסות לשאילתות KQL](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - שפת שאילתות עבור Application Insights  
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - יצירת לוחות מחוונים מותאמים אישית  

### OpenTelemetry  
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - מדריך אינסטרומנטציה  
- [מעקב מבוזר](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - מושגי מעקב  
- [איסוף מדדים](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - שיטות עבודה מיטביות למדדים  

### מצוינות תפעולית  
- [מדריך SRE](https://sre.google/sre-book/table-of-contents/) - עקרונות הנדסת אמינות אתרים  
- [שיטות עבודה מיטביות לניטור](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - שיטות עבודה מיטביות בתעשייה  
- [תגובה לאירועים](https://response.pagerduty.com/) - מדריך לניהול אירועים  

---

**קודם**: [מעבדה 10: אסטרטגיות פריסה](../10-Deployment/README.md)  
**הבא**: [מעבדה 12: שיטות עבודה מיטביות ואופטימיזציה](../12-Best-Practices/README.md)  
