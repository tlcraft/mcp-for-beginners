...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:58:32+00:00",
...
המעבדה הזו מספקת הדרכה מקיפה על פריסת שרת MCP לסביבות ייצור באמצעות גישות מודרניות של קונטיינריזציה וטכנולוגיות ענן. תלמדו כיצד לפרוס שרתי MCP בקנה מידה גדול, מאובטחים ומנוטרים שיכולים להתמודד עם עומסי עבודה ארגוניים.

## סקירה כללית

פריסת שרתי MCP בסביבת ייצור דורשת התייחסות מדוקדקת לקונטיינריזציה, אורקסטרציה, אבטחה, יכולת גידול וניטור. המעבדה הזו מכסה פריסה ל-Azure Container Apps עם PostgreSQL Flexible Server, יישום של צינורות CI/CD, והגדרת יכולת גידול אוטומטית לעומסי עבודה משתנים.

אסטרטגיות הפריסה נעות מפריסות פשוטות של קונטיינר יחיד לפיתוח ועד לסביבות ייצור מתקדמות מרובות אזורים עם יכולת גידול אוטומטית, ניטור מקיף ותכונות אבטחה.

## מטרות למידה

בסיום המעבדה הזו, תוכלו:

- **לקונטיינר** שרתי MCP באמצעות Docker עם בניות רב-שלביות  
- **לפרוס** ל-Azure Container Apps עם רשת מאובטחת  
- **להגדיר** PostgreSQL ברמת ייצור עם זמינות גבוהה  
- **ליישם** צינורות CI/CD לפריסה אוטומטית  
- **לגדול** אפליקציות באופן אוטומטי בהתאם לדרישה  
- **לנטר** פריסות ייצור עם יכולות תצפית מקיפות  
...
## ☁️ פריסה ל-Azure Container Apps
...
✅ **אסטרטגיית קונטיינר**: קונטיינרים מוכנים לייצור עם חיזוק אבטחה  
✅ **פריסת ענן**: Azure Container Apps עם גידול אוטומטי וניטור  
✅ **פריסת בסיס נתונים**: PostgreSQL Flexible Server עם זמינות גבוהה  
✅ **צינורות CI/CD**: תהליכי בדיקה, בנייה ופריסה אוטומטיים  
✅ **ניטור ביצועים**: איסוף מדדים מקיף והגדרת התראות  
✅ **הגדרת אבטחה**: מדיניות אבטחה ברמת ייצור ובידוד רשת  

## 🚀 מה הלאה

המשיכו עם **[מעבדה 11: ניטור ותצפית](../11-Monitoring/README.md)** כדי:

- להגדיר ניטור מקיף עם Application Insights  
- להגדיר לוגים מובנים ומעקב מבוזר  
- ליישם מערכות התראה ותגובה אוטומטית  
- לנטר מדדי עסק וביצועי KPI  

## 📚 משאבים נוספים

### טכנולוגיות קונטיינר
- [Docker Best Practices](https://docs.docker.com/develop/dev-best-practices/) - המלצות רשמיות של Docker  
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - תיעוד Azure Container Apps  
- [Kubernetes Documentation](https://kubernetes.io/docs/) - תיעוד רשמי של Kubernetes  

### CI/CD ו-DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - תיעוד GitHub Actions  
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - שירותי Azure DevOps  
- [Infrastructure as Code](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - תיעוד Azure Bicep  

### אבטחה וניטור
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - המלצות אבטחה של Azure  
- [Container Security](https://kubernetes.io/docs/concepts/security/) - מושגי אבטחה של Kubernetes  
- [Application Insights](https://docs.microsoft.com/en-us/azure/azure-monitor/app/app-insights-overview) - תיעוד Application Insights של Azure  

---

**קודם**: [מעבדה 09: אינטגרציה עם VS Code](../09-VS-Code/README.md)  
**הבא**: [מעבדה 11: ניטור ותצפית](../11-Monitoring/README.md)  
