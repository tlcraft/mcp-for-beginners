...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:46:26+00:00",
...
המעבדה הזו מספקת הדרכה מקיפה ליישום אבטחה ברמה ארגונית ורב-שוכנות עבור שרתי MCP. תלמדו כיצד לעצב מערכות מאובטחות ותואמות שמגנות על נתוני קמעונאות רגישים תוך מתן גמישות בגישה עבור שוכנים מרובים.

## סקירה כללית

אבטחה היא קריטית באפליקציות קמעונאות שמטפלות בנתוני לקוחות, מידע תשלום ומודיעין עסקי. המעבדה הזו מכסה את כל ארכיטקטורת האבטחה, החל מאימות והרשאות ועד בידוד נתונים וניטור תאימות.

אנו מיישמים אסטרטגיית הגנה לעומק שמשלבת שירותי זהות של Azure, אבטחת שורות ברמת PostgreSQL, בקרות ברמת האפליקציה ורישום ביקורת מקיף ליצירת פלטפורמה חזקה ותואמת.

## מטרות למידה

בסיום המעבדה הזו, תוכלו:

- **ליישם** אבטחת שורות ברמה ארגונית לבידוד נתונים רב-שוכני  
- **לעצב** דפוסי אימות והרשאה מאובטחים עם Azure  
- **להגדיר** רישום ביקורת מקיף לדרישות תאימות  
- **ליישם** אסטרטגיות אבטחה לעומק בכל שכבות האפליקציה  
- **לאמת** יישומי אבטחה באמצעות בדיקות שיטתיות  
- **לנטר** אירועי אבטחה ולהגיב לאיומים פוטנציאליים  

## 🔐 ארכיטקטורת אבטחה רב-שוכנית
...
היישום שלנו משתמש במודל **מסד נתונים משותף, סכימה משותפת** עם אבטחת שורות:

**יתרונות:**  
- ניצול משאבים חסכוני  
- תחזוקה ועדכונים פשוטים  
- בידוד נתונים חזק באמצעות RLS  
- רישומי ביקורת ידידותיים לתאימות  

**חסרונות:**  
- דורש עיצוב מדויק של מדיניות RLS  
- שינויים בסכימה משפיעים על כל השוכנים  
- צורך בהליכי גיבוי/שחזור חזקים  
...
✅ **אבטחה רב-שוכנית**: יישום אבטחת שורות לבידוד נתונים מלא  
✅ **אימות Azure**: אינטגרציה עם Azure Entra ID ואימות JWT  
✅ **הרשאה מבוססת תפקידים**: הגדרת מערכת תפקידים והרשאות היררכית  
✅ **רישום ביקורת מקיף**: הקמת מעקב וניטור אירועי אבטחה  
✅ **בדיקות אבטחה**: יישום בדיקות אימות אבטחה אוטומטיות  
✅ **ניטור איומים**: יצירת זיהוי והתראה בזמן אמת לאירועי אבטחה  

## 🚀 מה הלאה

המשיכו עם **[מעבדה 03: הגדרת סביבה](../03-Setup/README.md)** כדי:  

- להגדיר סביבות פיתוח עם שיטות אבטחה מומלצות  
- להגדיר שירותי Azure לאימות וניטור  
- ליישם חיבורים מאובטחים למסד נתונים וניהול סודות  
- לאמת הגדרות אבטחה בסביבות פיתוח  

## 📚 משאבים נוספים

### אבטחת Azure  
- [תיעוד Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - מדריך מלא לפלטפורמת זהות  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - שירות לניהול סודות  
- [שיטות אבטחה מומלצות של Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - הנחיות אבטחה  

### אבטחת מסד נתונים  
- [אבטחת שורות PostgreSQL](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - תיעוד רשמי של RLS  
- [רשימת בדיקות אבטחת מסד נתונים](https://www.postgresql.org/docs/current/security.html) - מדריך אבטחת PostgreSQL  
- [דפוסי מסד נתונים רב-שוכני](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - דפוסי ארכיטקטורה  

### בדיקות אבטחה  
- [מדריך בדיקות OWASP](https://owasp.org/www-project-web-security-testing-guide/) - בדיקות אבטחה מקיפות  
- [שיטות אבטחה מומלצות ל-JWT](https://tools.ietf.org/html/rfc8725) - שיקולי אבטחה ל-JWT  
- [בדיקות אבטחת API](https://owasp.org/www-project-api-security/) - בדיקות אבטחה ספציפיות ל-API  

---

**קודם**: [מעבדה 01: מושגי ארכיטקטורה מרכזיים](../01-Architecture/README.md)  
**הבא**: [מעבדה 03: הגדרת סביבה](../03-Setup/README.md)  
