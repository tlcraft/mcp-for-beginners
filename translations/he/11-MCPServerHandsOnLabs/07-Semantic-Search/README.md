...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T20:02:12+00:00",
...
המעבדה הזו מספקת הדרכה מקיפה ליישום יכולות חיפוש סמנטי באמצעות הטמעות של Azure OpenAI והרחבת pgvector של PostgreSQL. תלמדו לבנות חיפוש מוצרים מבוסס AI שמבין שאילתות בשפה טבעית ומספק תוצאות רלוונטיות בהתבסס על דמיון סמנטי.

## סקירה כללית

חיפוש מסורתי המבוסס על מילות מפתח לעיתים קרובות אינו מצליח לתפוס את כוונת המשתמש ואת המשמעות הסמנטית. חיפוש סמנטי באמצעות הטמעות וקטוריות מאפשר שאילתות בשפה טבעית כמו "נעלי ריצה נוחות למזג אוויר גשום" למצוא מוצרים רלוונטיים גם אם המילים המדויקות הללו אינן מופיעות בתיאורי המוצרים.

היישום שלנו משלב את מודלי ההטמעות החזקים של Azure OpenAI עם הרחבת pgvector של PostgreSQL ליצירת מערכת חיפוש סמנטי בעלת ביצועים גבוהים וניתנת להרחבה, שמשפרת את חוויית הקנייה עם גילוי מוצרים חכם.

## מטרות למידה

בסיום המעבדה הזו, תוכלו:

- **לשלב** מודלי הטמעות של Azure OpenAI לוקטוריזציה של טקסט  
- **ליישם** את pgvector לפעולות חיפוש דמיון יעילות  
- **לבנות** כלי חיפוש סמנטי לשאילתות מוצרים בשפה טבעית  
- **ליצור** חיפוש היברידי שמשלב חיפוש מסורתי וחיפוש וקטורי  
- **לייעל** שאילתות וקטוריות לביצועים בסביבת ייצור  
- **לעצב** מערכות המלצה באמצעות דמיון הטמעות  

## 🧠 ארכיטקטורת חיפוש סמנטי
...
## 🔍 יצירת הטמעות למוצרים

### צינור הטמעות אוטומטי
...
✅ **שילוב Azure OpenAI**: יצירת הטמעות מלאה עם מטמון ואופטימיזציה  
✅ **יישום חיפוש וקטורי**: חיפוש סמנטי מוכן לייצור עם pgvector  
✅ **יכולות חיפוש היברידי**: שילוב חיפוש מילות מפתח וחיפוש סמנטי לתוצאות מיטביות  
✅ **מערכות המלצה**: המלצות מוצרים מבוססות AI באמצעות דמיון  
✅ **אופטימיזציית ביצועים**: אופטימיזציה של אינדקסים וקטוריים ומטמון חכם  
✅ **ארכיטקטורה ניתנת להרחבה**: תשתית חיפוש סמנטי מוכנה לארגונים  

## 🚀 מה הלאה

המשיכו עם **[מעבדה 08: בדיקות וניפוי שגיאות](../08-Testing/README.md)** כדי:

- ליישם אסטרטגיות בדיקה מקיפות לחיפוש סמנטי  
- לנפות בעיות ביצועים בחיפוש וקטורי  
- לאמת את איכות ורלוונטיות ההטמעות  
- לבדוק את דיוק מערכת ההמלצות  

## 📚 משאבים נוספים

### Azure OpenAI  
- [תיעוד שירות Azure OpenAI](https://docs.microsoft.com/azure/cognitive-services/openai/) - מדריך שירות מלא  
- [תיעוד API של הטמעות](https://platform.openai.com/docs/api-reference/embeddings) - תיעוד API  
- [שיטות עבודה מומלצות להטמעות](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - הנחיות ליישום  

### מסדי נתונים וקטוריים  
- [תיעוד pgvector](https://github.com/pgvector/pgvector) - הרחבת וקטורים ל-PostgreSQL  
- [אופטימיזציית חיפוש וקטורי](https://www.pinecone.io/learn/vector-search-optimization/) - כוונון ביצועים  
- [אלגוריתם HNSW](https://arxiv.org/abs/1603.09320) - גרפים קטנים ניתנים לניווט היררכי  

### חיפוש סמנטי  
- [יסודות אחזור מידע](https://nlp.stanford.edu/IR-book/) - ספר לימוד של סטנפורד  
- [שיטות עבודה מומלצות לחיפוש וקטורי](https://weaviate.io/blog/vector-search-best-practices) - דפוסי יישום  
- [אסטרטגיות חיפוש היברידי](https://blog.vespa.ai/hybrid-search/) - שילוב גישות חיפוש שונות  

---

**קודם**: [מעבדה 06: פיתוח כלים](../06-Tools/README.md)  
**הבא**: [מעבדה 08: בדיקות וניפוי שגיאות](../08-Testing/README.md)  
