...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T20:00:00+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "he"
}
-->
# עיצוב בסיס נתונים וסכימה

## 🎯 מה מכסה המעבדה הזו

המעבדה הזו מתעמקת בעיצוב בסיס הנתונים PostgreSQL עבור מערכת הקמעונאות של Zava. תלמדו ליישם סכימה קמעונאית מקיפה עם יכולות חיפוש וקטורי, מודל נתונים רב-דיירים, ואבטחת רמת שורה (RLS) לבידוד נתונים.

## סקירה כללית

בסיס הנתונים הוא הבסיס לשרת MCP שלנו, המאחסן נתוני קמעונאות עבור חנויות רבות תוך שמירה על בידוד נתונים קפדני. אנו משתמשים ב-PostgreSQL עם הרחבת pgvector כדי לאפשר יכולות חיפוש סמנטי, המאפשרות ללקוחות למצוא מוצרים באמצעות שאילתות בשפה טבעית.

הסכימה שלנו עוקבת אחר דפוסים מודרניים של רב-דיירים עם אבטחת רמת שורה שמבטיחה שמשתמשים יכולים לגשת רק לנתונים מהחנויות המורשות שלהם. גישה זו מספקת אבטחה ברמה ארגונית תוך שמירה על ביצועים מיטביים.

## מטרות למידה

בסיום המעבדה הזו, תוכלו:

- **לעצב** סכימות בסיס נתונים קמעונאיות רב-דיירים הניתנות להרחבה  
- **ליישם** PostgreSQL עם pgvector לחיפוש וקטורי  
- **להגדיר** אבטחת רמת שורה לבידוד נתונים  
- **ליצור** נתוני דוגמה מציאותיים לבדיקות  
- **לייעל** ביצועי בסיס נתונים עבור עומסי עבודה קמעונאיים  
- **ליישם** אסטרטגיות גיבוי ושחזור  

## 🗃️ ארכיטקטורת בסיס נתונים

### PostgreSQL עם pgvector

בסיס הנתונים שלנו מנצל את התכונות הארגוניות של PostgreSQL בשילוב עם הרחבת pgvector לחיפוש מבוסס AI:
...
### ארכיטקטורת רב-דיירים

בסיס הנתונים משתמש במודל רב-דיירים של **בסיס נתונים משותף, סכימה משותפת** עם אבטחת רמת שורה:
...
## 🔐 הגדרת אבטחת רמת שורה

### תפקידי בסיס נתונים והרשאות
...
לאחר השלמת המעבדה הזו, תדעו:

✅ **עיצוב בסיס נתונים רב-דיירים**: יישום אבטחת רמת שורה לבידוד נתונים מאובטח  
✅ **יכולות חיפוש וקטורי**: הגדרת pgvector לחיפוש סמנטי של מוצרים  
✅ **סכימה מקיפה**: יצירת סכימת בסיס נתונים קמעונאית מוכנה לייצור  
✅ **יצירת נתוני דוגמה**: בניית נתוני בדיקה מציאותיים לפיתוח ובדיקות  
✅ **אופטימיזציית ביצועים**: הגדרת אינדקסים ואופטימיזציית שאילתות  
✅ **גיבוי ושחזור**: הקמת אסטרטגיות הגנה על נתונים חזקות  

## 🚀 מה הלאה

המשיכו עם **[מעבדה 05: יישום שרת MCP](../05-MCP-Server/README.md)** כדי:

- לבנות את שרת FastMCP שמתחבר לבסיס הנתונים הזה  
- ליישם כלי שאילתות בסיס נתונים עבור פרוטוקול MCP  
- להוסיף יכולות חיפוש סמנטי באמצעות הטמעות  
- להגדיר בריכת חיבורים וטיפול בשגיאות  

## 📚 משאבים נוספים

### PostgreSQL & pgvector
- [תיעוד PostgreSQL](https://www.postgresql.org/docs/) - מדריך מלא ל-PostgreSQL  
- [הרחבת pgvector](https://github.com/pgvector/pgvector) - חיפוש דמיון וקטורי עבור PostgreSQL  
- [אופטימיזציית ביצועים PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - שיטות אופטימיזציה מומלצות  

### ארכיטקטורת רב-דיירים
- [אבטחת רמת שורה](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - תיעוד RLS של PostgreSQL  
- [ארכיטקטורת נתונים רב-דיירים](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - דפוסי ארכיטקטורה של Azure  
- [שיטות אבטחת בסיס נתונים](https://www.postgresql.org/docs/current/security.html) - מדריך אבטחת PostgreSQL  

### בסיסי נתונים וקטוריים
- [יסודות חיפוש וקטורי](https://www.pinecone.io/learn/vector-database/) - הבנת בסיסי נתונים וקטוריים  
- [מודלי הטמעות](https://platform.openai.com/docs/guides/embeddings) - תיעוד הטמעות של OpenAI  
- [אלגוריתם HNSW](https://arxiv.org/abs/1603.09320) - גרפים קטנים ניתנים לניווט היררכי  

---

**קודם**: [מעבדה 03: הגדרת סביבה](../03-Setup/README.md)  
**הבא**: [מעבדה 05: יישום שרת MCP](../05-MCP-Server/README.md)  
