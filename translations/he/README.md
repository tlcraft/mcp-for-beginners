...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T07:30:08+00:00",
...
1. **עשו Fork למאגר**: לחצו [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
...
- 📜 [מפרט MCP מקורי](https://spec.modelcontextprotocol.io/) – הפניות טכניות ישנות (עשויות להכיל פרטים נוספים)  
...
| 3.5 | שרת SSE | יצירת שרתים באמצעות Server-Sent Events | [מדריך](./03-GettingStarted/05-sse-server/README.md) |
...
התכוננו לשני ימים של תובנות טכניות מעמיקות, חיבור קהילתי ולמידה מעשית ב-MCP Dev Days, אירוע וירטואלי המוקדש ל-Model Context Protocol (MCP) — הסטנדרט המתפתח שמחבר בין מודלים של AI לכלים שהם מסתמכים עליהם.  
...
שסופקו על ידי הבוט. תצטרך לעשות זאת רק פעם אחת בכל הרפוזיטוריז המשתמשים ב-CLA שלנו.  
