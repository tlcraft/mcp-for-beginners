...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-19T17:43:01+00:00",
...
1. **צור Fork של המאגר**: לחצו על [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/network)
...
**Model Context Protocol (MCP)** הוא מסגרת חדשנית שנועדה לאחד את האינטראקציות בין מודלים של בינה מלאכותית ליישומי לקוח. תכנית הלימודים בקוד פתוח הזו מציעה מסלול למידה מובנה, כולל דוגמאות קוד מעשיות ומקרי שימוש מהעולם האמיתי, בשפות תכנות פופולריות כמו C#, Java, JavaScript, TypeScript ו-Python.

בין אם אתם מפתחים בתחום הבינה המלאכותית, אדריכלי מערכות או מהנדסי תוכנה, מדריך זה הוא המשאב המקיף שלכם לשליטה ביסודות MCP ואסטרטגיות יישום.
...
- 🧑‍💻 [MCP GitHub Repository](https://github.com/modelcontextprotocol) – SDKs בקוד פתוח, כלים ודוגמאות קוד  
...
| **01 - הסברים על מושגי יסוד** | חקירה מעמיקה של מושגי היסוד של MCP, כולל ארכיטקטורת לקוח-שרת, רכיבי פרוטוקול מרכזיים ודפוסי מסרים | [Core Concepts](./01-CoreConcepts/README.md) |
...
| **03 - התחלה עם MCP** | הגדרת סביבה וקונפיגורציה, יצירת שרתי ולקוחות MCP בסיסיים, אינטגרציה של MCP עם יישומים קיימים | [Getting Started](./03-GettingStarted/README.md) |
...
| **3.5 - יצירת שרת באמצעות SSE** | SSE מאפשר לנו לחשוף שרת לאינטרנט. חלק זה יעזור לכם ליצור שרת באמצעות SSE | [Creating a server using SSE](./03-GettingStarted/05-sse-server/README.md) |
...
| **3.7 - בדיקת השרת שלכם** | בדיקות הן חלק חשוב בתהליך הפיתוח. חלק זה יעזור לכם לבדוק באמצעות מספר כלים שונים. | [Testing your server](./03-GettingStarted/07-testing/README.md) |
| **3.8 - פריסת השרת שלכם** | איך עוברים מפיתוח מקומי לייצור? חלק זה יעזור לכם לפתח ולפרוס את השרת שלכם. | [Deploy your server](./03-GettingStarted/08-deployment/README.md) |
| **04 - יישום מעשי** | שימוש ב-SDKs בשפות שונות, איתור באגים, בדיקות ואימות, יצירת תבניות פרומפטים וזרימות עבודה לשימוש חוזר | [Practical Implementation](./04-PracticalImplementation/README.md) |
| **05 - נושאים מתקדמים ב-MCP** | זרימות עבודה רב-מודליות והרחבה, אסטרטגיות סקיילינג מאובטחות, MCP במערכות ארגוניות | [Advanced Topics](./05-AdvancedTopics/README.md) |
| **06 - תרומות קהילתיות** | איך לתרום קוד ותיעוד, שיתוף פעולה דרך GitHub, שיפורים ומשוב מונעי קהילה | [Community Contributions](./06-CommunityContributions/README.md) |
...
| **08 - שיטות עבודה מומלצות ל-MCP** | כוונון ביצועים ואופטימיזציה, תכנון מערכות MCP עמידות לתקלות, אסטרטגיות בדיקה וחוסן | [Best Practices](./08-BestPractices/README.md) |
| **09 - מקרי מבחן של MCP** | ניתוחים מעמיקים של ארכיטקטורות פתרונות MCP, תבניות פריסה וטיפים לאינטגרציה, דיאגרמות עם הערות והדרכות פרויקט | [Case Studies](./09-CaseStudy/README.md) |
...
כדי להפיק את המירב מתוכנית הלימודים הזו, כדאי שתהיה לך:
...
התוכן הזה מורשה תחת **רישיון MIT**. לתנאים והגבלות, ראו את [LICENSE](../../LICENSE).

## 🤝 הנחיות לתרומה

הפרויקט הזה מקבל תרומות והצעות. רוב התרומות דורשות שתסכים להסכם רישיון תורם (CLA) המצהיר שיש לך את הזכות, ושאתה באמת מעניק לנו את הזכויות להשתמש בתרומתך. לפרטים נוספים, בקר בכתובת <https://cla.opensource.microsoft.com>.

כשאתה מגיש בקשת משיכה, בוט CLA יבדוק אוטומטית אם עליך לספק CLA ויעניק לבקשה את התגיות המתאימות (למשל, בדיקת סטטוס, תגובה). פשוט פעל לפי ההוראות של הבוט. תצטרך לעשות זאת רק פעם אחת בכל הרפוזיטוריות שמשתמשות ב-CLA שלנו.

הפרויקט אימץ את [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/). למידע נוסף ראו את [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) או פנו ל-[opencode@microsoft.com](mailto:opencode@microsoft.com) עם שאלות או הערות נוספות.
...
ייתכן שהפרויקט הזה מכיל סימני מסחר או לוגואים של פרויקטים, מוצרים או שירותים. שימוש מורשה בסימני המסחר או בלוגואים של Microsoft כפוף ומחויב ל[Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
שימוש בסימני מסחר או בלוגואים של Microsoft בגרסאות מותאמות של הפרויקט אסור שיגרום לבלבול או ירמוז על חסות של Microsoft.  
שימוש בסימני מסחר או בלוגואים של צד שלישי כפוף למדיניות של אותם צדדים.

**כתב ויתור**:  
מסמך זה תורגם באמצעות שירות תרגום מבוסס בינה מלאכותית [Co-op Translator](https://github.com/Azure/co-op-translator). למרות שאנו שואפים לדיוק, יש לקחת בחשבון שתרגומים אוטומטיים עלולים להכיל שגיאות או אי דיוקים. יש להתייחס למסמך המקורי בשפת המקור כסמכותי. למידע קריטי מומלץ להשתמש בתרגום מקצועי על ידי אדם. איננו אחראים לכל אי הבנה או פרשנות שגויה הנובעת משימוש בתרגום זה.