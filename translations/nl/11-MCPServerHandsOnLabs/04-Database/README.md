...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:59:45+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "nl"
}
-->
# Databaseontwerp en Schema

## 🎯 Wat Deze Lab Behandelt

Deze lab gaat diep in op het PostgreSQL-databaseontwerp voor het Zava Retail-systeem. Je leert een uitgebreid retailschema te implementeren met vectorzoekmogelijkheden, multi-tenant datamodellering en Row Level Security (RLS) voor gegevensisolatie.

## Overzicht

De database vormt de basis van onze MCP-server en slaat retailgegevens op van meerdere winkels, terwijl strikte gegevensisolatie wordt gehandhaafd. We gebruiken PostgreSQL met de pgvector-extensie om semantische zoekmogelijkheden mogelijk te maken, zodat klanten producten kunnen vinden met natuurlijke taalqueries.

Ons schema volgt moderne multi-tenant patronen met Row Level Security, waardoor gebruikers alleen toegang hebben tot gegevens van hun geautoriseerde winkels. Deze aanpak biedt beveiliging op ondernemingsniveau en behoudt tegelijkertijd optimale prestaties.

## Leerdoelen

Aan het einde van deze lab kun je:

- **Ontwerpen** schaalbare multi-tenant retailschemas
- **Implementeren** PostgreSQL met pgvector voor vectorzoekopdrachten
- **Configureren** Row Level Security voor gegevensisolatie
- **Genereren** realistische voorbeeldgegevens voor testen
- **Optimaliseren** databaseprestaties voor retailworkloads
- **Implementeren** back-up- en herstelstrategieën

## 🗃️ Databasearchitectuur

### PostgreSQL met pgvector

Onze database maakt gebruik van de enterprise-functies van PostgreSQL, gecombineerd met de pgvector-extensie voor AI-gestuurde zoekopdrachten:
...
De database gebruikt een **gedeelde database, gedeeld schema** multi-tenant model met Row Level Security:
...
### Products Tabel met Categorieën
...
## 🔍 Implementatie van Vectorzoekopdrachten

### Product Embeddings Tabel
...
### Databaserollen en Machtigingen
...
## 📊 Genereren van Voorbeeldgegevens

### Script voor Realistische Testgegevens
...
✅ **Multi-Tenant Databaseontwerp**: Row Level Security geïmplementeerd voor veilige gegevensisolatie  
✅ **Vectorzoekmogelijkheden**: pgvector geconfigureerd voor semantische productzoekopdrachten  
✅ **Uitgebreid Schema**: Productieklaar retailschema gemaakt  
✅ **Genereren van Voorbeeldgegevens**: Realistische testgegevens gebouwd voor ontwikkeling en testen  
✅ **Prestatieoptimalisatie**: Indexen en queryoptimalisatie geconfigureerd  
✅ **Back-up en Herstel**: Robuuste gegevensbeschermingsstrategieën opgezet  

## 🚀 Wat Nu?

Ga verder met **[Lab 05: MCP Server Implementatie](../05-MCP-Server/README.md)** om:

- De FastMCP-server te bouwen die verbinding maakt met deze database
- Databasequerytools te implementeren voor het MCP-protocol
- Semantische zoekmogelijkheden toe te voegen met behulp van embeddings
- Verbindingspooling en foutafhandeling te configureren

## 📚 Aanvullende Bronnen

### PostgreSQL & pgvector
- [PostgreSQL Documentatie](https://www.postgresql.org/docs/) - Complete PostgreSQL referentie
- [pgvector Extensie](https://github.com/pgvector/pgvector) - Vector gelijkeniszoekopdrachten voor PostgreSQL
- [PostgreSQL Prestatieoptimalisatie](https://wiki.postgresql.org/wiki/Performance_Optimization) - Optimalisatie best practices

### Multi-Tenant Architectuur
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS documentatie
- [Multi-Tenant Data Architectuur](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure architectuurpatronen
- [Database Beveiligingsbest Practices](https://www.postgresql.org/docs/current/security.html) - PostgreSQL beveiligingsgids

### Vector Databases
- [Basisprincipes van Vectorzoekopdrachten](https://www.pinecone.io/learn/vector-database/) - Begrip van vector databases
- [Embedding Modellen](https://platform.openai.com/docs/guides/embeddings) - OpenAI embeddings documentatie
- [HNSW Algoritme](https://arxiv.org/abs/1603.09320) - Hierarchical Navigable Small World grafieken

---

**Vorige**: [Lab 03: Omgevingsinstelling](../03-Setup/README.md)  
**Volgende**: [Lab 05: MCP Server Implementatie](../05-MCP-Server/README.md)
