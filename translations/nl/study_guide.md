...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T15:15:58+00:00",
...
6. **Geavanceerde Onderwerpen (05-AdvancedTopics/)**
   - Multi-modale AI-workflows en uitbreidbaarheid
   - Veilige schaalstrategieën
   - MCP in enterprise-ecosystemen
   - Gespecialiseerde onderwerpen zoals Azure-integratie, multi-modality, OAuth2, root contexts, routing, sampling, scaling, security, web search integratie en streaming.
...
10. **Case Studies (09-CaseStudy/)**
    ...
    - Deployment blueprints en integratietips
    - Toelichtende diagrammen en project walkthroughs

11. **Hands-on Workshop (10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/)**
    - Uitgebreide hands-on workshop die MCP combineert met Microsoft’s AI Toolkit voor VS Code
    - Intelligente applicaties bouwen die AI-modellen koppelen aan tools uit de praktijk
    - Praktische modules over de basis, custom serverontwikkeling en productie-deploymentstrategieën

## Voorbeeldprojecten

De repository bevat meerdere voorbeeldprojecten die MCP-implementaties in verschillende programmeertalen laten zien:
...
- **Afbeeldingen map**: Bevat diagrammen en illustraties die door de cursus heen worden gebruikt
...
5. **Community Betrokkenheid**: Word lid van de [Azure AI Foundry Discord](https://discord.com/invite/ByRwuEEgH4) om in contact te komen met experts en mede-ontwikkelaars.
