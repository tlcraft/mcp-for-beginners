...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-18T18:16:17+00:00",
...
2. 選擇「Tools」並點選「listTools」，你應該會看到「Add」出現，點選「Add」並填入參數值。
...
下一篇：[開始使用 MCP 用戶端](/03-GettingStarted/02-client/README.md)

**免責聲明**：  
本文件使用 AI 翻譯服務 [Co-op Translator](https://github.com/Azure/co-op-translator) 進行翻譯。雖然我們致力於確保準確性，但請注意自動翻譯可能包含錯誤或不準確之處。原始文件的母語版本應被視為權威來源。對於重要資訊，建議採用專業人工翻譯。我們不對因使用此翻譯而引起的任何誤解或誤釋負責。