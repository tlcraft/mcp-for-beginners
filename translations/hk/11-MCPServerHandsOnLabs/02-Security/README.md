...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T12:47:24+00:00",
...
本實驗提供全面指導，幫助您在 MCP 伺服器上實現企業級安全性與多租戶架構。您將學習如何設計安全且符合規範的系統，保護敏感的零售數據，同時支持多租戶的靈活訪問模式。

## 概述

安全性在處理客戶數據、支付信息和商業智能的零售應用中至關重要。本實驗涵蓋完整的安全架構，從身份驗證和授權到數據隔離和合規性監控。
...
✅ **Azure 身份驗證**：集成 Azure Entra ID 並進行 JWT 驗證  
✅ **基於角色的授權**：配置分層角色和權限系統  
✅ **全面審計記錄**：建立安全事件跟踪與監控  
✅ **安全測試**：實施自動化安全驗證測試  
✅ **威脅監控**：創建實時安全事件檢測與警報  
...
繼續進行 **[實驗 03：環境設置](../03-Setup/README.md)**：

- 配置符合安全最佳實踐的開發環境
- 設置 Azure 服務以進行身份驗證和監控
- 實現安全的數據庫連接和密鑰管理
- 驗證開發環境中的安全配置
...
### 數據庫安全性
- [PostgreSQL 行級安全性](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - 官方行級安全性文件
...
### 安全測試
- [OWASP 測試指南](https://owasp.org/www-project-web-security-testing-guide/) - 全面的安全測試指南
