...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T12:58:53+00:00",
...
本實驗提供全面指導，幫助您使用現代容器化和雲原生方法將 MCP 零售伺服器部署到生產環境中。您將學習如何部署可擴展、安全且具備監控功能的 MCP 伺服器，以應對企業級工作負載。

## 概覽

MCP 伺服器的生產部署需要仔細考慮容器化、編排、安全性、可擴展性和監控。本實驗涵蓋了如何部署到 Azure Container Apps，使用 PostgreSQL Flexible Server，實現 CI/CD 流水線，以及為變動的工作負載配置自動擴展。

部署策略範圍從用於開發的簡單單容器部署，到具備全面監控和安全功能的多區域、自動擴展的生產環境。

## 學習目標

完成本實驗後，您將能夠：

- **容器化** MCP 伺服器，使用 Docker 的多階段構建
- **部署** 到 Azure Container Apps，並配置安全網絡
- **配置** 生產級 PostgreSQL，實現高可用性
- **實現** CI/CD 流水線，進行自動化部署
- **自動擴展** 應用程序以應對需求變化
- **監控** 生產部署，實現全面可觀測性
...
✅ **雲部署**：Azure Container Apps，支持自動擴展和監控  
✅ **數據庫部署**：高可用性的 PostgreSQL Flexible Server  
✅ **CI/CD 流水線**：自動化測試、構建和部署工作流  
✅ **性能監控**：全面的指標收集和警報功能  
✅ **安全配置**：生產級安全策略和網絡隔離  

## 🚀 下一步

繼續進行 **[實驗 11：監控與可觀測性](../11-Monitoring/README.md)**，學習以下內容：

- 使用 Application Insights 設置全面監控
- 配置結構化日誌和分佈式追蹤
- 實現警報和自動響應系統
- 監控業務指標和性能 KPI
...
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Azure Container Apps 文檔
- [Kubernetes 文檔](https://kubernetes.io/docs/) - Kubernetes 官方文檔

### CI/CD 和 DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - GitHub Actions 文檔
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Azure DevOps 服務
- [基礎設施即代碼](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Azure Bicep 文檔
...
**上一節**: [實驗 09：VS Code 集成](../09-VS-Code/README.md)  
**下一節**: [實驗 11：監控與可觀測性](../11-Monitoring/README.md)
