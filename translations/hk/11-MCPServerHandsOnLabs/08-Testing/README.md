...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T12:40:53+00:00",
...
本實驗提供全面的指導，幫助您在生產環境中測試和除錯 MCP 伺服器。您將學習如何實施穩健的測試策略、解決複雜問題，並確保 MCP 伺服器在各種條件下可靠運行。

## 概述

測試 MCP 伺服器需要多層次的方法，包括單元測試、整合測試、性能驗證以及真實場景測試。本實驗涵蓋了從開發到生產監控的完整測試生命周期。

我們的測試策略強調可靠性、安全性和性能，確保您的 MCP 伺服器能夠處理生產工作負載，同時保持數據完整性和良好的用戶體驗。
...
- **實施** 全面的單元和整合測試套件  
- **設計** MCP 工具和數據庫操作的有效測試策略  
- **除錯** 使用高級除錯技術解決複雜問題  
- **驗證** 在負載下的性能，並進行真實場景測試  
- **監控** 使用有效的警報和可觀測性監控生產系統  
- **自動化** 測試工作流程以支持持續整合  
...
✅ **全面的測試框架**：涵蓋所有組件的單元、整合和性能測試  
✅ **高級除錯工具**：具備執行追蹤的高級除錯工具  
✅ **性能驗證能力**：負載測試和可擴展性分析能力  
✅ **安全測試**：防止 SQL 注入並驗證 RLS  
✅ **監控整合**：性能指標和瓶頸分析能力  
✅ **CI/CD 準備**：支持持續整合的自動化測試工作流程  

## 🚀 下一步

繼續進行 **[實驗 09：VS Code 整合](../09-VS-Code/README.md)**，以：

- 配置 VS Code 用於 MCP 伺服器開發  
- 設置 VS Code 中的除錯環境  
- 將 MCP 伺服器整合到 VS Code Chat  
- 測試完整的 VS Code 工作流程  

## 📚 其他資源

### 測試框架
- [pytest 文檔](https://docs.pytest.org/) - Python 測試框架  
- [AsyncPG 測試](https://magicstack.github.io/asyncpg/current/index.html) - Async PostgreSQL 測試  
- [FastAPI 測試](https://fastapi.tiangolo.com/tutorial/testing/) - API 測試模式  

### 性能測試
- [負載測試最佳實踐](https://docs.python.org/3/library/asyncio.html) - 非同步性能測試  
- [數據庫性能測試](https://www.postgresql.org/docs/current/performance-tips.html) - PostgreSQL 優化  
- [內存分析](https://docs.python.org/3/library/tracemalloc.html) - Python 內存分析  

### 除錯工具
- [Python 除錯](https://docs.python.org/3/library/pdb.html) - Python 除錯器  
- [非同步除錯](https://docs.python.org/3/library/asyncio-dev.html) - Asyncio 除錯  
- [SQL 除錯](https://www.postgresql.org/docs/current/runtime-config-logging.html) - PostgreSQL 日誌  

---

**上一章**: [實驗 07：語義搜索整合](../07-Semantic-Search/README.md)  
**下一章**: [實驗 09：VS Code 整合](../09-VS-Code/README.md)  
