...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T12:50:48+00:00",
...
本實驗提供全面的指導，幫助您在生產環境中為 MCP 伺服器實現監控、可觀測性和警報功能。您將學習如何設置 Application Insights、創建有意義的儀表板、實現有效的警報系統，以及建立故障排除工作流程，以達到卓越的運營效果。

## 概述

有效的監控與可觀測性對於維持生產環境中的 MCP 伺服器的可靠性至關重要。本實驗涵蓋了可觀測性的三大支柱——指標、日誌和追蹤，並展示如何實現全面的監控，從而實現主動問題檢測和快速問題解決。
...
- **實現** MCP 伺服器的全面 Application Insights 集成  
- **設計** 結構化日誌模式以便於故障排除  
- **創建** 性能指標收集與分析系統  
- **配置** 智能警報並提供可操作的通知  
- **構建** 用於實時監控的運營儀表板  
...
✅ **Application Insights 集成**：完整的遙測和監控設置  
✅ **結構化日誌**：具備關聯性和上下文的生產級日誌  
✅ **自定義指標**：業務和技術指標的收集與分析  
✅ **智能警報**：多通知渠道的主動警報  
✅ **運營儀表板**：實時監控和業務洞察  
✅ **故障排除工作流程**：自動化診斷和運營手冊  
...
繼續學習 **[實驗 12：最佳實踐與優化](../12-Best-Practices/README.md)**，以：
...
### Azure Monitor
- [Application Insights 文檔](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - 完整的監控指南  
...
### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - 插桿指南  
...
**上一節**: [實驗 10：部署策略](../10-Deployment/README.md)  
**下一節**: [實驗 12：最佳實踐與優化](../12-Best-Practices/README.md)  
