...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T13:02:45+00:00",
...
本實驗提供了使用 Azure OpenAI 嵌入和 PostgreSQL 的 pgvector 擴展實現語義搜索功能的全面指導。您將學習如何構建基於 AI 的產品搜索，理解自然語言查詢，並根據語義相似性提供相關結果。

## 概述

傳統的基於關鍵字的搜索往往無法捕捉用戶意圖和語義含義。使用向量嵌入的語義搜索使得自然語言查詢（如「適合雨天穿的舒適跑鞋」）能夠找到相關產品，即使這些準確的詞語並未出現在產品描述中。

我們的實現結合了 Azure OpenAI 強大的嵌入模型和 PostgreSQL 的 pgvector 擴展，創建了一個高性能、可擴展的語義搜索系統，通過智能產品發現提升零售體驗。
...
- **實現** pgvector 進行高效的相似性搜索操作
- **構建** 用於自然語言產品查詢的語義搜索工具
- **創建** 結合傳統搜索和向量搜索的混合搜索
- **優化** 向量查詢以達到生產環境性能
- **設計** 基於嵌入相似性的推薦系統
...
✅ **Azure OpenAI 整合**：完成嵌入生成，並實現緩存和優化  
✅ **向量搜索實現**：基於 pgvector 的生產級語義搜索  
✅ **混合搜索功能**：結合關鍵字和語義搜索以獲得最佳結果  
...
繼續進行 **[實驗 08：測試與調試](../08-Testing/README.md)**，以：
...
### Azure OpenAI
- [Azure OpenAI 服務文檔](https://docs.microsoft.com/azure/cognitive-services/openai/) - 完整服務指南
- [嵌入 API 參考](https://platform.openai.com/docs/api-reference/embeddings) - API 文檔
- [嵌入的最佳實踐](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - 實現指導

### 向量數據庫
- [pgvector 文檔](https://github.com/pgvector/pgvector) - PostgreSQL 向量擴展
- [向量搜索優化](https://www.pinecone.io/learn/vector-search-optimization/) - 性能調優
- [HNSW 算法](https://arxiv.org/abs/1603.09320) - 分層可導航小世界圖

### 語義搜索
- [信息檢索基礎](https://nlp.stanford.edu/IR-book/) - 斯坦福信息檢索教科書
- [向量搜索最佳實踐](https://weaviate.io/blog/vector-search-best-practices) - 實現模式
- [混合搜索策略](https://blog.vespa.ai/hybrid-search/) - 結合不同搜索方法

---

**上一節**: [實驗 06：工具開發](../06-Tools/README.md)  
**下一節**: [實驗 08：測試與調試](../08-Testing/README.md)
