...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-02T05:26:27+00:00",
...
**Model Context Protocol (MCP)** 是一個先進的框架，旨在標準化 AI 模型與客戶端應用程式之間的互動。這個開源課程提供結構化的學習路徑，包含實務程式範例和真實案例，涵蓋 C#, Java, JavaScript, TypeScript 及 Python 等熱門程式語言。

無論你是 AI 開發者、系統架構師或軟件工程師，本指南都是你掌握 MCP 基礎與實作策略的完整資源。
...
<details>
  <summary><strong> 第1-3課：Model Context Protocol 基礎</strong></summary>
...
### 建立與部署你的第一個 MCP 伺服器與客戶端，以及實作練習和場景  
<details>
  <summary><strong> 第3課：建立與部署你的第一個 MCP 伺服器與客戶端</strong></summary>
...
<details>
  <summary><strong> 第4-5課：實務與進階</strong></summary>
...
- **5.7. 擴展性** – [指南](./05-AdvancedTopics/mcp-scaling/README.md)
...
<details>
  <summary><strong> 第6-9課：社群、最佳實踐與實作練習</strong></summary>
...
### 💡 MCP 進階範例解決方案：C#、Java、JavaScript、TypeScript 和 Python 計算機專案
<details>
...
這裡有一份完整的[學習指南](./study_guide.md)幫助你有效瀏覽此資源庫。指南內容包括：
...
本專案歡迎貢獻與建議。大多數貢獻需同意一份
Contributor License Agreement (CLA)，聲明你擁有且確實授權我們使用你的貢獻。詳情請參考 <https://cla.opensource.microsoft.com>。

當你提交 pull request 時，CLA 機器人會自動判斷你是否需要提供 CLA 並在 PR 上標示（例如狀態檢查、評論）。只需依照機器人指示操作即可。你只需在所有使用我們 CLA 的資源庫中完成一次。

本專案已採用 [Microsoft 開源行為守則](https://opensource.microsoft.com/codeofconduct/)。更多資訊請參閱 [行為守則 FAQ](https://opensource.microsoft.com/codeofconduct/faq/) 或
聯絡 [opencode@microsoft.com](mailto:opencode@microsoft.com) 以獲得更多問題或建議。
...
- [精通 GitHub Copilot 以進行 AI 配對編程](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
此專案可能包含專案、產品或服務的商標或標誌。授權使用 Microsoft 商標或標誌須遵守並依據
...
**免責聲明**：  
本文件由 AI 翻譯服務 [Co-op Translator](https://github.com/Azure/co-op-translator) 進行翻譯。雖然我們致力於準確性，但請注意自動翻譯可能包含錯誤或不準確之處。原始文件的母語版本應被視為權威來源。對於重要資訊，建議採用專業人工翻譯。我們對因使用本翻譯而引起的任何誤解或誤釋概不負責。