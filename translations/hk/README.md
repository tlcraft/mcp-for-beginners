...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T10:41:06+00:00",
...
專注於幫助開發者在開發工作流程中使用 MCP，並慶祝 MCP 社群的卓越成就。我們將與社群成員和合作夥伴如 Arcade、Block、Okta 和 Neon 一起探討他們如何與 Microsoft 合作，共同打造一個開放且可擴展的 MCP 生態系統。  
...
一份全面的 [學習指南](./study_guide.md) 可幫助您有效地使用此存儲庫。指南包括：
