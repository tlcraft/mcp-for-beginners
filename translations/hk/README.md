...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-12T07:34:37+00:00",
...
- 🌐 [MCP 社群](https://github.com/orgs/modelcontextprotocol/discussions) – 加入討論並為社群做出貢獻
 ...
 ### ➡️隨選觀看 - MCP 開發者日
準備好迎接兩天的深入技術洞察、社群連結和實作學習，參加 MCP 開發者日，一個專注於模型上下文協議（MCP）的虛擬活動——這個新興標準連接了 AI 模型及其依賴的工具。
您可以透過註冊活動頁面觀看 MCP 開發者日：https://aka.ms/mcpdevdays。 

#### 第一天：MCP 生產力、開發工具與社群：

專注於幫助開發者在其開發工作流程中使用 MCP，並慶祝令人驚嘆的 MCP 社群。我們將與社群成員和合作夥伴（如 Arcade、Block、Okta 和 Neon）一起探討他們如何與 Microsoft 合作，共同打造一個開放、可擴展的 MCP 生態系統。  
...
如果您是開發者、工具建設者或 AI 產品策略師，第二天將充滿您需要的洞察力，幫助您構建可擴展、安全且面向未來的 MCP 解決方案。
...
| 3.3 | 與 LLM 的客戶端 | 整合大型語言模型 | [指南](./03-GettingStarted/03-llm-client/README.md) |
...
提供一份全面的 [學習指南](./study_guide.md)，幫助您有效地探索此存儲庫。指南包括：
