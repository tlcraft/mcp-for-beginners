...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T18:31:44+00:00",
...
一份全面的 [學習指南](./study_guide.md) 可幫助你有效地使用此存儲庫。指南包括：
...
準備好參加為期兩天的深入技術洞察、社群連結和實踐學習的 MCP 開發者日活動，這是一個專注於模型上下文協議（MCP）的虛擬活動——這是一個連接 AI 模型及其依賴工具的新興標準。
你可以通過註冊我們的活動頁面觀看 MCP 開發者日：https://aka.ms/mcpdevdays。

#### [第一天：MCP 生產力、開發工具與社群](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

第一天的重點是幫助開發者在開發工作流程中使用 MCP，並慶祝 MCP 社群的卓越成就。我們將與社群成員和合作夥伴（如 Arcade、Block、Okta 和 Neon）一起探討他們如何與 Microsoft 合作，共同打造一個開放、可擴展的 MCP 生態系統。  
實際演示包括 VS Code、Visual Studio、GitHub Copilot 和流行的社群工具  
實用的、上下文驅動的開發工作流程  
社群主導的會議和洞察  
無論你是剛開始接觸 MCP 還是已經在使用它，第一天將提供靈感和可操作的收穫。

#### [第二天：自信地構建 MCP 伺服器](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

第二天適合 MCP 建設者。我們將深入探討構建 MCP 伺服器的實現策略和最佳實踐，以及如何將 MCP 整合到你的 AI 工作流程中。
...
### MCP 訓練營 2025 年 8 月
通過密集的視頻課程學習如何構建 MCP 伺服器、整合 VS Code 並基於 MCP 初學者課程內容在 Azure 上專業部署。掌握主要公司已經使用的技術的實用技能。
...
### 一起學習 MCP 與 C# - 教程系列
一起學習模型上下文協議（MCP），這是一個旨在標準化 AI 模型與客戶端應用之間交互的尖端框架。通過這個適合初學者的課程，我們將向你介紹 MCP 並指導你創建第一個 MCP 伺服器。
...
此內容根據 **MIT 授權** 授權。欲了解條款和條件，請參閱 [LICENSE](../../LICENSE)。

## 🤝 貢獻指南

此項目歡迎貢獻和建議。大多數貢獻需要你同意一份
貢獻者授權協議（CLA），聲明你有權並實際授予我們使用你的貢獻的權利。詳情請訪問  
...
聯繫 [opencode@microsoft.com](mailto:opencode@microsoft.com) 提出其他問題或意見。
...
此項目可能包含項目、產品或服務的商標或標誌。授權使用 Microsoft 商標或標誌必須遵守並符合 [Microsoft 的商標與品牌指南](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general)。  
