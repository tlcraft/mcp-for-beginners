...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:23:58+00:00",
...
按照以下步驟開始使用這些資源：
1. **Fork 此倉庫**：點擊 [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
...
| **模組 4-5：實作與進階** | | | |
| 04 | 實作指南 | SDK、除錯、測試、可重用的提示模板 | [了解更多](./04-PracticalImplementation/README.md) |
...
| 5.15 | MCP 自定義傳輸 | 自定義傳輸的實作 | [指南](./05-AdvancedTopics/mcp-transport/README.md) |
...
| Java with Spring | 容器應用程式範例 | [查看程式碼](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
我們提供了一份全面的 [學習指南](./study_guide.md)，幫助您有效地瀏覽此存儲庫。指南內容包括：
...
我們維護了一份詳細的 [更新日誌](./changelog.md)，記錄所有課程材料的重要更新，包括：
...
準備好迎接兩天深入的技術洞察、社群連結和實作學習吧！MCP 開發日是一個專注於模型上下文協議（MCP）的虛擬活動，這是一個連接 AI 模型與其依賴工具的新興標準。
...
第一天的重點是幫助開發者將 MCP 整合到開發工作流程中，並慶祝 MCP 社群的成就。我們將邀請社群成員和合作夥伴，例如 Arcade、Block、Okta 和 Neon，展示他們如何與 Microsoft 合作，共同打造開放且可擴展的 MCP 生態系統。  
實際範例包括：
...
第二天專為 MCP 建設者設計。我們將深入探討構建 MCP 伺服器的實作策略及最佳實踐，並如何將 MCP 整合到您的 AI 工作流程中。
...
### MCP 訓練營 2025 年 8 月
透過密集的影片課程學習如何建立 MCP 伺服器、整合 VS Code 並根據 MCP 初學者課程內容在 Azure 上專業部署。學習後您將掌握一項已被多家大型公司採用的技術。
...
此專案歡迎貢獻與建議。大多數貢獻需要您同意一份貢獻者授權協議（CLA），聲明您有權並實際授予我們使用您的貢獻的權利。詳情請訪問 <https://cla.opensource.microsoft.com>。
