...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T22:20:49+00:00",
...
6. **موضوعات پیشرفته (05-AdvancedTopics/)**
   ...
   - استریمینگ بلادرنگ
   - پیاده‌سازی کانتکست‌های ریشه‌ای
...
5. **مشارکت در جامعه**: از طریق بحث‌های GitHub و کانال‌های Discord به جامعه MCP بپیوندید و با کارشناسان و توسعه‌دهندگان دیگر ارتباط برقرار کنید.
...
| تاریخ | تغییرات |
|-------|---------|
| 16 ژوئیه 2025 | - به‌روزرسانی ساختار مخزن برای بازتاب محتوای فعلی<br>- افزودن بخش کلاینت‌ها و ابزارهای MCP<br>- افزودن بخش سرورهای محبوب MCP<br>- به‌روزرسانی نقشه بصری دوره با تمام موضوعات فعلی<br>- تقویت بخش موضوعات پیشرفته با تمام حوزه‌های تخصصی<br>- به‌روزرسانی مطالعات موردی با نمونه‌های واقعی<br>- روشن‌سازی منشأ MCP به عنوان ساخته شده توسط Anthropic |
| 11 ژوئن 2025 | - ایجاد اولیه راهنمای مطالعه<br>- افزودن نقشه بصری دوره<br>- ترسیم ساختار مخزن<br>- افزودن پروژه‌های نمونه و منابع اضافی |

---

*این راهنمای مطالعه در تاریخ 16 ژوئیه 2025 به‌روزرسانی شده و نمای کلی مخزن تا آن تاریخ را ارائه می‌دهد. محتوای مخزن ممکن است پس از این تاریخ به‌روزرسانی شود.*
