...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T15:26:28+00:00",
...
MCP از مدل **کلاینت-سرور** پیروی می‌کند، جایی که:
...
به یک برنامه هوش مصنوعی که علاقه دارید بسازید فکر کنید.
