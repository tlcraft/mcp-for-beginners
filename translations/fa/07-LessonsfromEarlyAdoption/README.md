...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-13T16:49:09+00:00",
...
#### سازمان Microsoft  
1. [playwright-mcp](https://github.com/microsoft/playwright-mcp) - سرور Playwright MCP برای خودکارسازی مرورگر و تست  
...
1. [mcp](https://github.com/Azure-Samples/mcp) - لینک به نمونه‌ها، ابزارها و منابع
...
- [سرور فایل‌های MCP (OneDrive)](https://github.com/microsoft/files-mcp-server)
