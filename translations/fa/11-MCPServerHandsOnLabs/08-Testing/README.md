...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T13:48:08+00:00",
...
این آزمایشگاه راهنمای جامعی برای آزمایش و اشکال‌زدایی سرورهای MCP در محیط‌های تولید ارائه می‌دهد. شما یاد خواهید گرفت که استراتژی‌های آزمایشی قوی را اجرا کنید، مشکلات پیچیده را اشکال‌زدایی کنید و اطمینان حاصل کنید که سرور MCP شما تحت شرایط مختلف به‌طور قابل‌اعتمادی عمل می‌کند.

## مرور کلی

آزمایش سرورهای MCP نیازمند رویکردی چندلایه است که شامل آزمایش‌های واحد، آزمایش‌های یکپارچه، اعتبارسنجی عملکرد و آزمایش سناریوهای واقعی می‌شود. این آزمایشگاه چرخه کامل آزمایش را از توسعه تا نظارت بر تولید پوشش می‌دهد.

استراتژی آزمایشی ما بر قابلیت اطمینان، امنیت و عملکرد تأکید دارد و اطمینان حاصل می‌کند که سرور MCP شما می‌تواند بارهای کاری تولید را مدیریت کند و در عین حال یکپارچگی داده‌ها و کیفیت تجربه کاربری را حفظ کند.

## اهداف یادگیری

در پایان این آزمایشگاه، شما قادر خواهید بود:

- **اجرای** مجموعه‌های جامع آزمایش واحد و یکپارچه  
- **طراحی** استراتژی‌های آزمایشی مؤثر برای ابزارهای MCP و عملیات پایگاه داده  
- **اشکال‌زدایی** مشکلات پیچیده با استفاده از تکنیک‌های پیشرفته  
- **اعتبارسنجی** عملکرد تحت بار با سناریوهای آزمایشی واقعی  
- **نظارت** بر سیستم‌های تولید با هشداردهی و مشاهده‌پذیری مؤثر  
- **خودکارسازی** جریان‌های کاری آزمایشی برای یکپارچگی مداوم  

## 🧪 معماری آزمایش

### مرور کلی استراتژی آزمایش
...
### آزمایش جریان کاری انتها به انتها
...
✅ **چارچوب آزمایشی جامع**: آزمایش‌های واحد، یکپارچه و عملکردی برای همه اجزا  
✅ **ابزارهای اشکال‌زدایی پیشرفته**: ابزارهای اشکال‌زدایی پیچیده با ردیابی اجرا  
✅ **اعتبارسنجی عملکرد**: قابلیت‌های آزمایش بار و تحلیل مقیاس‌پذیری  
✅ **آزمایش امنیتی**: پیشگیری از تزریق SQL و اعتبارسنجی RLS  
✅ **یکپارچگی نظارت**: معیارهای عملکرد و تحلیل گلوگاه‌ها  
✅ **آمادگی CI/CD**: جریان‌های کاری آزمایشی خودکار برای یکپارچگی مداوم  

## 🚀 مرحله بعدی

ادامه دهید با **[آزمایشگاه 09: یکپارچگی VS Code](../09-VS-Code/README.md)** برای:

- پیکربندی VS Code برای توسعه سرور MCP  
- تنظیم محیط‌های اشکال‌زدایی در VS Code  
- یکپارچه‌سازی سرور MCP با VS Code Chat  
- آزمایش جریان کاری کامل VS Code  

## 📚 منابع اضافی

### چارچوب‌های آزمایشی  
- [مستندات pytest](https://docs.pytest.org/) - چارچوب آزمایشی پایتون  
- [آزمایش AsyncPG](https://magicstack.github.io/asyncpg/current/index.html) - آزمایش پایگاه داده PostgreSQL غیرهمزمان  
- [آزمایش FastAPI](https://fastapi.tiangolo.com/tutorial/testing/) - الگوهای آزمایش API  

### آزمایش عملکرد  
- [بهترین شیوه‌های آزمایش بار](https://docs.python.org/3/library/asyncio.html) - آزمایش عملکرد غیرهمزمان  
- [آزمایش عملکرد پایگاه داده](https://www.postgresql.org/docs/current/performance-tips.html) - بهینه‌سازی PostgreSQL  
- [پروفایل حافظه](https://docs.python.org/3/library/tracemalloc.html) - تحلیل حافظه پایتون  

### ابزارهای اشکال‌زدایی  
- [اشکال‌زدایی پایتون](https://docs.python.org/3/library/pdb.html) - اشکال‌زدای پایتون  
- [اشکال‌زدایی غیرهمزمان](https://docs.python.org/3/library/asyncio-dev.html) - اشکال‌زدایی asyncio  
- [اشکال‌زدایی SQL](https://www.postgresql.org/docs/current/runtime-config-logging.html) - ثبت وقایع PostgreSQL  

---

**قبلی**: [آزمایشگاه 07: یکپارچگی جستجوی معنایی](../07-Semantic-Search/README.md)  
**بعدی**: [آزمایشگاه 09: یکپارچگی VS Code](../09-VS-Code/README.md)  
