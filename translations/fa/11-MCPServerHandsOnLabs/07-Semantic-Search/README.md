...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T14:23:09+00:00",
...
این آزمایشگاه راهنمای جامعی برای پیاده‌سازی قابلیت‌های جستجوی معنایی با استفاده از تعبیه‌های Azure OpenAI و افزونه pgvector در PostgreSQL ارائه می‌دهد. شما یاد خواهید گرفت که چگونه یک جستجوی محصول مبتنی بر هوش مصنوعی بسازید که زبان طبیعی را درک کند و نتایج مرتبط بر اساس شباهت معنایی ارائه دهد.

## مرور کلی

جستجوی سنتی مبتنی بر کلمات کلیدی اغلب نمی‌تواند قصد کاربر و معنای معنایی را به درستی درک کند. جستجوی معنایی با استفاده از تعبیه‌های برداری امکان پرسش‌های زبان طبیعی مانند "کفش‌های راحت برای دویدن در هوای بارانی" را فراهم می‌کند تا محصولات مرتبط را پیدا کند، حتی اگر این کلمات دقیقاً در توضیحات محصول ذکر نشده باشند.

پیاده‌سازی ما مدل‌های قدرتمند تعبیه Azure OpenAI را با افزونه pgvector در PostgreSQL ترکیب می‌کند تا یک سیستم جستجوی معنایی با عملکرد بالا و مقیاس‌پذیر ایجاد کند که تجربه خرید را با کشف هوشمند محصولات بهبود می‌بخشد.

## اهداف یادگیری

تا پایان این آزمایشگاه، شما قادر خواهید بود:

- **ادغام** مدل‌های تعبیه Azure OpenAI برای بردارسازی متن  
- **پیاده‌سازی** pgvector برای عملیات جستجوی شباهت کارآمد  
- **ساخت** ابزارهای جستجوی معنایی برای پرسش‌های زبان طبیعی محصولات  
- **ایجاد** جستجوی ترکیبی که جستجوی سنتی و برداری را ترکیب می‌کند  
- **بهینه‌سازی** پرسش‌های برداری برای عملکرد تولید  
- **طراحی** سیستم‌های توصیه با استفاده از شباهت تعبیه‌ها  

## 🧠 معماری جستجوی معنایی

### خط لوله جستجوی برداری
...
## 🔎 ابزارهای جستجوی معنایی

### ابزار جستجوی معنایی محصولات
...
✅ **ادغام Azure OpenAI**: تولید کامل تعبیه‌ها با کش و بهینه‌سازی  
✅ **پیاده‌سازی جستجوی برداری**: جستجوی معنایی آماده تولید با pgvector  
✅ **قابلیت‌های جستجوی ترکیبی**: ترکیب جستجوی کلمات کلیدی و معنایی برای نتایج بهینه  
✅ **سیستم‌های توصیه**: توصیه‌های محصول مبتنی بر هوش مصنوعی با استفاده از شباهت  
✅ **بهینه‌سازی عملکرد**: بهینه‌سازی شاخص برداری و کش هوشمند  
✅ **معماری مقیاس‌پذیر**: زیرساخت جستجوی معنایی آماده برای سازمان  

## 🚀 مرحله بعدی

ادامه دهید با **[آزمایشگاه 08: آزمایش و رفع اشکال](../08-Testing/README.md)** برای:

- پیاده‌سازی استراتژی‌های جامع آزمایش برای جستجوی معنایی  
- رفع اشکال مشکلات عملکرد جستجوی برداری  
- اعتبارسنجی کیفیت و ارتباط تعبیه‌ها  
- آزمایش دقت سیستم توصیه  

## 📚 منابع اضافی

### Azure OpenAI  
- [مستندات سرویس Azure OpenAI](https://docs.microsoft.com/azure/cognitive-services/openai/) - راهنمای کامل سرویس  
- [مستندات API تعبیه‌ها](https://platform.openai.com/docs/api-reference/embeddings) - مستندات API  
- [بهترین روش‌ها برای تعبیه‌ها](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - راهنمای پیاده‌سازی  

### پایگاه‌های داده برداری  
- [مستندات pgvector](https://github.com/pgvector/pgvector) - افزونه برداری PostgreSQL  
- [بهینه‌سازی جستجوی برداری](https://www.pinecone.io/learn/vector-search-optimization/) - تنظیم عملکرد  
- [الگوریتم HNSW](https://arxiv.org/abs/1603.09320) - گراف‌های کوچک قابل پیمایش سلسله‌مراتبی  

### جستجوی معنایی  
- [مبانی بازیابی اطلاعات](https://nlp.stanford.edu/IR-book/) - کتاب درسی بازیابی اطلاعات استنفورد  
- [بهترین روش‌های جستجوی برداری](https://weaviate.io/blog/vector-search-best-practices) - الگوهای پیاده‌سازی  
- [استراتژی‌های جستجوی ترکیبی](https://blog.vespa.ai/hybrid-search/) - ترکیب رویکردهای مختلف جستجو  

---

**قبلی**: [آزمایشگاه 06: توسعه ابزار](../06-Tools/README.md)  
**بعدی**: [آزمایشگاه 08: آزمایش و رفع اشکال](../08-Testing/README.md)  
