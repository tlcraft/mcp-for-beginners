...
این آزمایشگاه راهنمای جامعی برای پیاده‌سازی نظارت، مشاهده‌پذیری و هشداردهی برای سرور MCP در محیط‌های تولیدی ارائه می‌دهد. شما یاد خواهید گرفت که چگونه Application Insights را تنظیم کنید، داشبوردهای معنادار ایجاد کنید، هشداردهی مؤثر را پیاده‌سازی کنید و جریان‌های کاری عیب‌یابی را برای دستیابی به برتری عملیاتی برقرار کنید.

## مرور کلی

نظارت و مشاهده‌پذیری مؤثر برای حفظ سرورهای MCP در محیط تولید بسیار حیاتی است. این آزمایشگاه سه ستون اصلی مشاهده‌پذیری—متریک‌ها، لاگ‌ها و تریس‌ها—را پوشش می‌دهد و به شما نشان می‌دهد که چگونه نظارت جامعی را پیاده‌سازی کنید که امکان شناسایی پیشگیرانه مشکلات و حل سریع آن‌ها را فراهم می‌کند.

شما یاد خواهید گرفت که چگونه داده‌های خام تله‌متری را به بینش‌های عملی تبدیل کنید که به شما در درک رفتار سیستم، بهینه‌سازی عملکرد و تضمین دسترسی بالا کمک می‌کند.

## اهداف یادگیری

در پایان این آزمایشگاه، شما قادر خواهید بود:

- **پیاده‌سازی کنید** یکپارچگی جامع Application Insights برای سرورهای MCP  
- **طراحی کنید** الگوهای لاگ‌برداری ساختاریافته برای عیب‌یابی مؤثر  
- **ایجاد کنید** سیستم‌های جمع‌آوری و تحلیل متریک‌های عملکرد  
- **پیکربندی کنید** هشداردهی هوشمند با اعلان‌های عملی  
- **بسازید** داشبوردهای عملیاتی برای نظارت بلادرنگ  
- **برقرار کنید** جریان‌های کاری عیب‌یابی مؤثر و راهنماهای عملیاتی  

## 📊 یکپارچگی Application Insights
...
### لاگ‌برداری پیشرفته با داده‌های ساختاریافته
...
✅ **یکپارچگی Application Insights**: تنظیم کامل تله‌متری و نظارت  
✅ **لاگ‌برداری ساختاریافته**: لاگ‌برداری آماده تولید با همبستگی و زمینه  
✅ **متریک‌های سفارشی**: جمع‌آوری و تحلیل متریک‌های تجاری و فنی  
✅ **هشداردهی هوشمند**: هشداردهی پیشگیرانه با کانال‌های اعلان متعدد  
✅ **داشبوردهای عملیاتی**: نظارت بلادرنگ و بینش‌های تجاری  
✅ **جریان‌های کاری عیب‌یابی**: تشخیص خودکار و راهنماهای عملیاتی  

## 🚀 گام بعدی

ادامه دهید با **[آزمایشگاه ۱۲: بهترین شیوه‌ها و بهینه‌سازی](../12-Best-Practices/README.md)** برای:

- اعمال تکنیک‌های بهینه‌سازی عملکرد  
- پیاده‌سازی سخت‌گیری امنیتی جامع  
- یادگیری بهترین شیوه‌های استقرار در محیط تولید  
- ایجاد استراتژی‌های بهینه‌سازی هزینه  

## 📚 منابع اضافی

### Azure Monitor
- [مستندات Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - راهنمای کامل نظارت  
- [مرجع کوئری KQL](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - زبان کوئری برای Application Insights  
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - ایجاد داشبورد سفارشی  

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - راهنمای ابزارسازی  
- [تریسینگ توزیع‌شده](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - مفاهیم تریسینگ  
- [جمع‌آوری متریک‌ها](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - بهترین شیوه‌های متریک  

### برتری عملیاتی
- [کتاب راهنمای SRE](https://sre.google/sre-book/table-of-contents/) - اصول مهندسی قابلیت اطمینان سایت  
- [بهترین شیوه‌های نظارت](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - بهترین شیوه‌های صنعتی  
- [پاسخ به حوادث](https://response.pagerduty.com/) - راهنمای مدیریت حوادث  

---

**قبلی**: [آزمایشگاه ۱۰: استراتژی‌های استقرار](../10-Deployment/README.md)  
**بعدی**: [آزمایشگاه ۱۲: بهترین شیوه‌ها و بهینه‌سازی](../12-Best-Practices/README.md)  
