...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T14:01:01+00:00",
...
این آزمایشگاه راهنمای جامعی برای پیاده‌سازی امنیت در سطح سازمانی و چند‌مستاجری برای سرورهای MCP ارائه می‌دهد. شما یاد خواهید گرفت که چگونه سیستم‌های امن و سازگار طراحی کنید که داده‌های حساس خرده‌فروشی را محافظت کرده و الگوهای دسترسی انعطاف‌پذیر را در میان مستاجران مختلف امکان‌پذیر سازد.

## مقدمه

امنیت در برنامه‌های خرده‌فروشی که داده‌های مشتری، اطلاعات پرداخت و هوش تجاری را مدیریت می‌کنند، اهمیت بالایی دارد. این آزمایشگاه معماری کامل امنیت را از احراز هویت و مجوزدهی تا جداسازی داده‌ها و نظارت بر سازگاری پوشش می‌دهد.

ما استراتژی دفاع در عمق را با ترکیب خدمات هویتی Azure، امنیت سطح ردیف در PostgreSQL، کنترل‌های سطح برنامه و ثبت جامع گزارش‌ها پیاده‌سازی می‌کنیم تا یک پلتفرم قوی و سازگار ایجاد کنیم.

## اهداف یادگیری

در پایان این آزمایشگاه، شما قادر خواهید بود:

- **پیاده‌سازی کنید** امنیت سطح ردیف در سطح سازمانی برای جداسازی داده‌های چند‌مستاجری  
- **طراحی کنید** الگوهای امن احراز هویت و مجوزدهی با Azure  
- **پیکربندی کنید** ثبت جامع گزارش‌ها برای الزامات سازگاری  
- **اعمال کنید** استراتژی‌های امنیتی دفاع در عمق در تمام لایه‌های برنامه  
- **اعتبارسنجی کنید** پیاده‌سازی‌های امنیتی از طریق آزمایش‌های سیستماتیک  
- **نظارت کنید** بر رویدادهای امنیتی و پاسخ به تهدیدات احتمالی  

## 🔐 معماری امنیت چند‌مستاجری

### نمای کلی لایه‌های امنیتی
...
پیاده‌سازی ما از مدل **پایگاه داده مشترک، طرح‌واره مشترک** با امنیت سطح ردیف استفاده می‌کند:

**مزایا:**  
- استفاده بهینه از منابع  
- نگهداری و به‌روزرسانی ساده‌تر  
- جداسازی قوی داده‌ها از طریق RLS  
- مسیرهای ثبت گزارش سازگار با الزامات  

**معایب:**  
- نیاز به طراحی دقیق سیاست‌های RLS  
- تغییرات در طرح‌واره بر تمام مستاجران تأثیر می‌گذارد  
- نیاز به روش‌های پشتیبان‌گیری و بازیابی قوی  

## 🛡️ پیاده‌سازی امنیت سطح ردیف
...
## 🔍 ثبت گزارش‌های امنیتی و سازگاری
...
## 🧪 آزمایش و اعتبارسنجی امنیت

### آزمایش‌های امنیتی خودکار
...
✅ **امنیت چند‌مستاجری**: امنیت سطح ردیف را برای جداسازی کامل داده‌ها پیاده‌سازی کرده باشید  
✅ **احراز هویت Azure**: Azure Entra ID را با اعتبارسنجی JWT یکپارچه کرده باشید  
✅ **مجوزدهی مبتنی بر نقش**: سیستم سلسله‌مراتبی نقش و مجوز را پیکربندی کرده باشید  
✅ **ثبت جامع گزارش‌ها**: ردیابی و نظارت بر رویدادهای امنیتی را برقرار کرده باشید  
✅ **آزمایش امنیتی**: آزمایش‌های اعتبارسنجی امنیتی خودکار را پیاده‌سازی کرده باشید  
✅ **نظارت بر تهدیدات**: تشخیص و هشداردهی رویدادهای امنیتی در زمان واقعی ایجاد کرده باشید  

## 🚀 مرحله بعدی

ادامه دهید با **[آزمایشگاه 03: تنظیم محیط](../03-Setup/README.md)** برای:  

- پیکربندی محیط‌های توسعه با بهترین شیوه‌های امنیتی  
- راه‌اندازی خدمات Azure برای احراز هویت و نظارت  
- پیاده‌سازی اتصالات امن پایگاه داده و مدیریت اسرار  
- اعتبارسنجی پیکربندی‌های امنیتی در محیط‌های توسعه  

## 📚 منابع اضافی

### امنیت Azure  
- [مستندات Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - راهنمای کامل پلتفرم هویت  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - سرویس مدیریت اسرار  
- [بهترین شیوه‌های امنیت Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - راهنمای امنیت  

### امنیت پایگاه داده  
- [امنیت سطح ردیف PostgreSQL](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - مستندات رسمی RLS  
- [چک‌لیست امنیت پایگاه داده](https://www.postgresql.org/docs/current/security.html) - راهنمای امنیت PostgreSQL  
- [الگوهای پایگاه داده چند‌مستاجری](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - الگوهای معماری  

### آزمایش امنیت  
- [راهنمای آزمایش OWASP](https://owasp.org/www-project-web-security-testing-guide/) - آزمایش امنیت جامع  
- [بهترین شیوه‌های امنیت JWT](https://tools.ietf.org/html/rfc8725) - ملاحظات امنیتی JWT  
- [آزمایش امنیت API](https://owasp.org/www-project-api-security/) - آزمایش امنیت خاص API  

---

**قبلی**: [آزمایشگاه 01: مفاهیم اصلی معماری](../01-Architecture/README.md)  
**بعدی**: [آزمایشگاه 03: تنظیم محیط](../03-Setup/README.md)  

---

**سلب مسئولیت**:  
این سند با استفاده از سرویس ترجمه هوش مصنوعی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. در حالی که ما تلاش می‌کنیم دقت را رعایت کنیم، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است حاوی خطاها یا نادقتی‌هایی باشند. سند اصلی به زبان اصلی آن باید به عنوان منبع معتبر در نظر گرفته شود. برای اطلاعات حساس، ترجمه انسانی حرفه‌ای توصیه می‌شود. ما هیچ مسئولیتی در قبال سوءتفاهم‌ها یا تفسیرهای نادرست ناشی از استفاده از این ترجمه نداریم.