...
این آزمایشگاه راهنمای جامعی برای استقرار سرور خرده‌فروشی MCP در محیط‌های تولید با استفاده از روش‌های مدرن کانتینری‌سازی و رویکردهای بومی ابری ارائه می‌دهد. شما یاد خواهید گرفت که چگونه سرورهای MCP مقیاس‌پذیر، امن و قابل نظارت را که توانایی مدیریت بارهای کاری سازمانی را دارند، مستقر کنید.

## مرور کلی

استقرار سرورهای MCP در محیط تولید نیازمند توجه دقیق به کانتینری‌سازی، ارکستراسیون، امنیت، مقیاس‌پذیری و نظارت است. این آزمایشگاه شامل استقرار در Azure Container Apps با PostgreSQL Flexible Server، پیاده‌سازی خطوط CI/CD و پیکربندی مقیاس‌گذاری خودکار برای بارهای کاری متغیر است.

استراتژی‌های استقرار از استقرارهای ساده تک‌کانتینری برای توسعه تا محیط‌های تولید چندمنطقه‌ای، مقیاس‌پذیر خودکار با ویژگی‌های جامع نظارت و امنیت متغیر هستند.

## اهداف یادگیری

در پایان این آزمایشگاه، شما قادر خواهید بود:

- **کانتینری‌سازی** سرورهای MCP با استفاده از Docker و ساخت‌های چندمرحله‌ای  
- **استقرار** در Azure Container Apps با شبکه‌سازی امن  
- **پیکربندی** PostgreSQL در سطح تولید با قابلیت دسترسی بالا  
- **پیاده‌سازی** خطوط CI/CD برای استقرار خودکار  
- **مقیاس‌گذاری** برنامه‌ها به صورت خودکار بر اساس تقاضا  
- **نظارت** بر استقرارهای تولید با قابلیت مشاهده جامع  
...
## ☁️ استقرار در Azure Container Apps
...
✅ **استراتژی کانتینر**: کانتینرهای Docker آماده تولید با تقویت امنیت  
✅ **استقرار ابری**: Azure Container Apps با مقیاس‌گذاری خودکار و نظارت  
✅ **استقرار پایگاه داده**: PostgreSQL Flexible Server با قابلیت دسترسی بالا  
✅ **خطوط CI/CD**: جریان‌های کاری تست، ساخت و استقرار خودکار  
✅ **نظارت بر عملکرد**: جمع‌آوری جامع معیارها و هشداردهی  
✅ **پیکربندی امنیتی**: سیاست‌های امنیتی در سطح تولید و جداسازی شبکه  

## 🚀 گام بعدی

ادامه دهید با **[آزمایشگاه ۱۱: نظارت و قابلیت مشاهده](../11-Monitoring/README.md)** برای:

- راه‌اندازی نظارت جامع با Application Insights  
- پیکربندی لاگ‌برداری ساختاریافته و ردیابی توزیع‌شده  
- پیاده‌سازی سیستم‌های هشداردهی و پاسخ خودکار  
- نظارت بر معیارهای کسب‌وکار و شاخص‌های عملکرد کلیدی  

## 📚 منابع اضافی

### فناوری‌های کانتینر
- [بهترین شیوه‌های Docker](https://docs.docker.com/develop/dev-best-practices/) - بهترین شیوه‌های رسمی Docker  
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - مستندات Azure Container Apps  
- [مستندات Kubernetes](https://kubernetes.io/docs/) - مستندات رسمی Kubernetes  

### CI/CD و DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - مستندات GitHub Actions  
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - خدمات Azure DevOps  
- [زیرساخت به عنوان کد](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - مستندات Azure Bicep  

### امنیت و نظارت
- [مرکز امنیت Azure](https://docs.microsoft.com/en-us/azure/security-center/) - توصیه‌های امنیتی Azure  
- [امنیت کانتینر](https://kubernetes.io/docs/concepts/security/) - مفاهیم امنیتی Kubernetes  
...
**قبلی**: [آزمایشگاه ۰۹: یکپارچه‌سازی با VS Code](../09-VS-Code/README.md)  
**بعدی**: [آزمایشگاه ۱۱: نظارت و قابلیت مشاهده](../11-Monitoring/README.md)  
