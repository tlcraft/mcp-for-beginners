...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-20T20:26:39+00:00",
...
این درس به چگونگی تعامل با جامعه MCP، مشارکت در اکوسیستم MCP و پیروی از بهترین روش‌ها برای توسعه مشارکتی می‌پردازد. درک نحوه شرکت در پروژه‌های متن‌باز MCP برای کسانی که می‌خواهند آینده این فناوری را شکل دهند، بسیار مهم است.
...
- بهترین روش‌های توسعه و همکاری در MCP را دنبال کنید

## اکوسیستم جامعه MCP

اکوسیستم MCP شامل اجزا و شرکت‌کنندگان مختلفی است که با هم برای پیشبرد پروتکل همکاری می‌کنند.

### اجزای کلیدی جامعه

1. **نگهدارندگان اصلی پروتکل**: مایکروسافت و سازمان‌های دیگر که مشخصات اصلی MCP و پیاده‌سازی‌های مرجع را نگهداری می‌کنند  
...
- [مخزن MCP در گیت‌هاب](https://github.com/modelcontextprotocol)  
...
- پیاده‌سازی SDKهای مخصوص زبان‌های مختلف  
...
3. **تست بنویسید**: برای مشارکت‌های کد خود تست واحد بنویسید  
...
6. **با بازخوردها تعامل داشته باشید**: به بازخوردها درباره مشارکت‌ها پاسخگو باشید  
...
## ساخت و اشتراک‌گذاری ابزارهای سفارشی MCP

یکی از ارزشمندترین روش‌های مشارکت در اکوسیستم MCP، ساخت و اشتراک‌گذاری ابزارهای سفارشی است.
...
1. **وضوح**: آیا کد واضح و به خوبی مستندسازی شده است؟  
2. **درستی**: آیا کد مطابق انتظار کار می‌کند؟  
3. **سازگاری**: آیا با قراردادهای پروژه مطابقت دارد؟  
4. **کامل بودن**: آیا تست‌ها و مستندات همراه است؟  
...
- پیروی از راهنمای مشارکت شانس پذیرفته شدن درخواست‌های کشش را افزایش می‌دهد  
- ساخت و اشتراک‌گذاری ابزارهای MCP راهی ارزشمند برای بهبود اکوسیستم است  
- همکاری جامعه برای رشد و پیشرفت MCP ضروری است  

## تمرین

1. حوزه‌ای در اکوسیستم MCP که می‌توانید با توجه به مهارت‌ها و علاقه‌مندی‌های خود در آن مشارکت کنید را شناسایی کنید  
...
5. درخواست کشش به مخزن مربوطه ارسال کنید  
...
بعدی: [درس‌هایی از پذیرش زودهنگام](../07-LessonsfromEarlyAdoption/README.md)

**سلب مسئولیت**:  
این سند با استفاده از سرویس ترجمه ماشینی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. در حالی که ما برای دقت تلاش می‌کنیم، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است حاوی اشتباهات یا نادرستی‌هایی باشند. سند اصلی به زبان بومی خود باید به عنوان منبع معتبر در نظر گرفته شود. برای اطلاعات حیاتی، ترجمه حرفه‌ای انسانی توصیه می‌شود. ما مسئول هیچ‌گونه سوءتفاهم یا تفسیر نادرست ناشی از استفاده از این ترجمه نیستیم.