...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-17T15:46:52+00:00",
...
این درس بر نحوه تعامل با جامعه MCP، مشارکت در اکوسیستم MCP و رعایت بهترین شیوه‌ها برای توسعه مشترک تمرکز دارد. درک نحوه مشارکت در پروژه‌های منبع باز MCP برای کسانی که می‌خواهند آینده این فناوری را شکل دهند، ضروری است.
...
- ابزارهای سفارشی MCP ایجاد و به اشتراک بگذارید
- بهترین شیوه‌ها برای توسعه و همکاری MCP را دنبال کنید

## اکوسیستم جامعه MCP

اکوسیستم MCP از اجزا و شرکت‌کنندگان مختلفی تشکیل شده است که با هم برای پیشبرد پروتکل همکاری می‌کنند.

### اجزای کلیدی جامعه

1. **نگهدارندگان پروتکل اصلی**: مایکروسافت و سایر سازمان‌هایی که مشخصات اصلی MCP و پیاده‌سازی‌های مرجع را نگهداری می‌کنند
2. **توسعه‌دهندگان ابزار**: افراد و تیم‌هایی که ابزارهای MCP ایجاد می‌کنند
...
5. **مشارکت‌کنندگان**: اعضای جامعه که کد، مستندات یا منابع دیگر را مشارکت می‌کنند
...
- پیاده‌سازی‌های SDK زبان‌های خاص
- پیاده‌سازی‌های سرور و کتابخانه‌های ابزار
- پست‌های وبلاگ و آموزش‌ها
- انجمن‌های جامعه و بحث‌های رسانه‌های اجتماعی
...
1. **مشارکت‌های کد**:
   ...
   - رفع اشکال‌ها
   - پیاده‌سازی ابزارها
   - کتابخانه‌های مشتری/سرور در زبان‌های مختلف
...
#### مثال Python: مشارکت در ایجاد ابزار جدید برای کتابخانه استاندارد
...
1. **کوچک شروع کنید**: با مستندات، رفع اشکال‌ها یا بهبودهای کوچک شروع کنید
2. **راهنمای سبک را دنبال کنید**: به سبک کدنویسی و قراردادهای پروژه پایبند باشید
3. **تست بنویسید**: تست‌های واحد برای مشارکت‌های کد خود شامل کنید
4. **کار خود را مستند کنید**: مستندات واضحی برای ویژگی‌ها یا تغییرات جدید اضافه کنید
5. **ارسال PRهای هدفمند**: درخواست‌های ادغام را بر روی یک مسئله یا ویژگی متمرکز نگه دارید
...
## ایجاد و اشتراک‌گذاری ابزارهای سفارشی MCP

یکی از ارزشمندترین روش‌های مشارکت در اکوسیستم MCP ایجاد و اشتراک‌گذاری ابزارهای سفارشی است.

### توسعه ابزارهای قابل اشتراک

#### مثال .NET: ایجاد یک بسته ابزار قابل اشتراک
...
#### مثال Java: ایجاد بسته Maven برای ابزارها
...
هنگام اشتراک‌گذاری ابزارهای MCP با جامعه:

1. **مستندات کامل**:
   - هدف، استفاده و مثال‌ها را مستند کنید
...
2. **مدیریت خطا**:
   ...
   - موارد حاشیه‌ای را به‌خوبی مدیریت کنید

3. **ملاحظات عملکرد**:
   - بهینه‌سازی برای سرعت و استفاده از منابع
   - پیاده‌سازی کش زمانی که مناسب است
   - قابلیت مقیاس‌پذیری را در نظر بگیرید
...
5. **آزمایش**:
   - پوشش تست جامع شامل کنید
   - با انواع مختلف ورودی و موارد حاشیه‌ای تست کنید
...
- Stack Overflow (برچسب: `model-context-protocol` or `mcp`)
...
2. **درستی**: آیا به‌طور مورد انتظار کار می‌کند؟
3. **سازگاری**: آیا قراردادهای پروژه را دنبال می‌کند؟
4. **کامل بودن**: آیا تست‌ها و مستندات شامل شده‌اند؟
5. **امنیت**: آیا نگرانی امنیتی وجود دارد؟
...
- مشارکت در MCP می‌تواند از بهبودهای پروتکل اصلی تا ابزارهای سفارشی باشد
- رعایت راهنمای مشارکت شانس پذیرش PR شما را افزایش می‌دهد
- ایجاد و اشتراک‌گذاری ابزارهای MCP راهی ارزشمند برای تقویت اکوسیستم است
- همکاری جامعه برای رشد و بهبود MCP ضروری است

## تمرین

1. یک حوزه در اکوسیستم MCP را شناسایی کنید که بر اساس مهارت‌ها و علاقه‌های شما می‌توانید مشارکت کنید
2. مخزن MCP را فورک کنید و محیط توسعه محلی راه‌اندازی کنید
3. یک بهبود کوچک، رفع اشکال یا ابزار ایجاد کنید که برای جامعه مفید باشد
4. مشارکت خود را با تست‌ها و مستندات مناسب مستند کنید
5. یک درخواست ادغام به مخزن مناسب ارسال کنید
...
**سلب مسئولیت**:  
این سند با استفاده از سرویس ترجمه هوش مصنوعی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. در حالی که ما برای دقت تلاش می‌کنیم، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است حاوی خطاها یا نادقتی‌هایی باشند. سند اصلی به زبان بومی آن باید به عنوان منبع معتبر در نظر گرفته شود. برای اطلاعات حیاتی، ترجمه انسانی حرفه‌ای توصیه می‌شود. ما در قبال هرگونه سوء تفاهم یا تفسیر نادرست ناشی از استفاده از این ترجمه مسئولیتی نداریم.