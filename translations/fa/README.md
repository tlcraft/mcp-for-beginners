...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T11:53:40+00:00",
...
| 3.8 | تست | تست پیاده‌سازی سرور MCP شما | [راهنما](./03-GettingStarted/08-testing/README.md) |
...
| RUST | نمونه کانتینر | [مشاهده کد](.03-GettingStarted/samples/rust/README.md) |
...
برای بهره‌گیری کامل از این دوره، باید:
...
توافقنامه مجوز مشارکت‌کننده (CLA) موافقت کنید که اعلام می‌کند شما حق دارید و واقعاً حقوق استفاده از مشارکت خود را به ما اعطا می‌کنید. برای جزئیات، به 
