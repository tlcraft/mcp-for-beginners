...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T18:27:11+00:00",
...
| 04 | پیاده‌سازی عملی | SDKها، دیباگ کردن، تست، قالب‌های قابل استفاده مجدد | [بیشتر بخوانید](./04-PracticalImplementation/README.md) |
...
| Java با Spring | مثال برنامه کانتینر | [View Code](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
- (اختیاری) پیش‌زمینه‌ای در مفاهیم هوش مصنوعی و یادگیری ماشین  
...
ما یک [تغییرات](./changelog.md) دقیق نگهداری می‌کنیم که تمام به‌روزرسانی‌های مهم در مواد دوره آموزشی را دنبال می‌کند، از جمله:
...
آماده شوید برای دو روز بینش فنی عمیق، ارتباط با جامعه، و یادگیری عملی در روزهای توسعه MCP، یک رویداد مجازی اختصاص داده شده به پروتکل مدل کانتکست (MCP) — استاندارد نوظهوری که مدل‌های هوش مصنوعی و ابزارهایی که به آن‌ها وابسته هستند را به هم متصل می‌کند.  
...
روز دوم برای سازندگان MCP است. ما به استراتژی‌های پیاده‌سازی و بهترین روش‌ها برای ایجاد سرورهای MCP و ادغام MCP در جریان‌های کاری هوش مصنوعی می‌پردازیم.
...
در جلسات ویدیویی فشرده یاد بگیرید چگونه سرورهای MCP ایجاد کنید، با VS Code ادغام کنید، و به صورت حرفه‌ای در Azure مستقر کنید، بر اساس محتوای دوره MCP برای مبتدیان. با مهارت‌های عملی در فناوری که شرکت‌های بزرگ از آن استفاده می‌کنند، از بوت کمپ خارج شوید.
...
بیایید درباره پروتکل مدل کانتکست (MCP)، یک چارچوب پیشرفته طراحی شده برای استانداردسازی تعاملات بین مدل‌های هوش مصنوعی و برنامه‌های کلاینت، یاد بگیریم. در این جلسه دوستانه برای مبتدیان، ما شما را با MCP آشنا می‌کنیم و شما را در ساخت اولین سرور MCP راهنمایی می‌کنیم.  
