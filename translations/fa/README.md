...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-11T11:14:37+00:00",
...
3. [**به دیسکورد Azure AI Foundry بپیوندید و با متخصصان و توسعه‌دهندگان دیگر ملاقات کنید**](https://discord.com/invite/ByRwuEEgH4)  
...
## **یادگیری MCP با مثال‌های کدنویسی عملی در C#، جاوا، جاوااسکریپت، پایتون و تایپ‌اسکریپت**  
...
## به ما در روزهای توسعه MCP در تاریخ ۲۹-۳۰ جولای ۲۰۲۵ بپیوندید  

برای دو روز بینش فنی عمیق، ارتباط با جامعه و یادگیری عملی در روزهای توسعه MCP آماده شوید، یک رویداد مجازی اختصاص داده شده به پروتکل زمینه مدل (MCP) — استاندارد نوظهوری که مدل‌های هوش مصنوعی و ابزارهای مورد نیاز آن‌ها را به هم متصل می‌کند.  

➡️ [ثبت‌نام برای روزهای توسعه MCP](https://developer.microsoft.com/en-us/reactor/series/S-1563/)  

شما می‌توانید روزهای توسعه MCP را با ثبت‌نام در صفحه رویداد ما مشاهده کنید: https://aka.ms/mcpdevdays. از آنجا، می‌توانید به پخش زنده در یوتیوب یا توییچ بپیوندید. تمام محتوا ضبط شده و بعداً در کانال یوتیوب Microsoft Developer در دسترس خواهد بود. کد منبع برای دموها نیز در GitHub موجود خواهد بود.  

### جزئیات رویداد  
- تاریخ‌ها: ۲۹ جولای (روز اول) و ۳۰ جولای (روز دوم)  
- زمان: هر روز ساعت ۹ صبح به وقت PST  
- مکان: آنلاین – از هر جایی بپیوندید!  

#### روز اول: بهره‌وری MCP، ابزارهای توسعه و جامعه:  

روز اول به توانمندسازی توسعه‌دهندگان برای استفاده از MCP در جریان کاری توسعه‌دهنده و جشن گرفتن جامعه شگفت‌انگیز MCP اختصاص دارد. ما با اعضای جامعه و شرکای خود مانند Arcade، Block، Okta و Neon همراه خواهیم بود تا ببینیم چگونه با مایکروسافت همکاری می‌کنند تا یک اکوسیستم MCP باز و قابل توسعه شکل دهند.  
...
روز دوم برای سازندگان MCP است. ما به استراتژی‌های پیاده‌سازی و بهترین روش‌ها برای ایجاد سرورهای MCP و ادغام MCP در جریان‌های کاری هوش مصنوعی خواهیم پرداخت.  
...
| ۰۰ | معرفی MCP | مروری بر پروتکل زمینه مدل و اهمیت آن در خطوط لوله هوش مصنوعی | [بیشتر بخوانید](./00-Introduction/README.md) |  
...
| ۳.۱ | اولین سرور | ایجاد اولین سرور MCP | [راهنما](./03-GettingStarted/01-first-server/README.md) |  
...
| ۳.۴ | ادغام VS Code | مصرف سرورهای MCP در VS Code | [راهنما](./03-GettingStarted/04-vscode/README.md) |  
...
| ۰۴ | پیاده‌سازی عملی | SDKها، دیباگ کردن، تست، قالب‌های پرامپت قابل استفاده مجدد | [بیشتر بخوانید](./04-PracticalImplementation/README.md) |  
| ۰۵ | موضوعات پیشرفته در MCP | هوش مصنوعی چندوجهی، مقیاس‌پذیری، استفاده در سطح سازمانی | [بیشتر بخوانید](./05-AdvancedTopics/README.md) |  
...
| 07 | بینش‌هایی از پذیرش اولیه | داستان‌های واقعی از پیاده‌سازی | [راهنما](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | بهترین شیوه‌ها برای MCP | عملکرد، تحمل خطا، تاب‌آوری | [راهنما](./08-BestPractices/README.md) |
| 09 | مطالعات موردی MCP | مثال‌های عملی از پیاده‌سازی | [راهنما](./09-CaseStudy/README.md) |
...
#### نمونه‌های اولیه ماشین‌حساب MCP
...
| Java با Spring | مثال برنامه کانتینری | [مشاهده کد](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
برای بهره‌برداری حداکثری از این دوره، باید:

- دانش پایه‌ای از برنامه‌نویسی در حداقل یکی از زبان‌های زیر داشته باشید: C#، Java، JavaScript، Python یا TypeScript
...
این مخزن شامل منابع متعددی است که به شما در یادگیری و پیمایش مؤثر کمک می‌کند:

### راهنمای مطالعه

یک [راهنمای مطالعه](./study_guide.md) جامع در دسترس است که به شما کمک می‌کند این مخزن را به طور مؤثر پیمایش کنید. این راهنما شامل:
...
ما یک [تغییرات](./changelog.md) دقیق را نگهداری می‌کنیم که تمام به‌روزرسانی‌های مهم در مواد آموزشی را ردیابی می‌کند، از جمله:
...
از [شیوام گوئل](https://www.linkedin.com/in/shivam2003/) به عنوان Microsoft Valued Professional برای ارائه نمونه‌های کد مهم تشکر می‌کنیم. 
...
این پروژه از مشارکت‌ها و پیشنهادات استقبال می‌کند. اکثر مشارکت‌ها نیاز به توافق‌نامه مجوز مشارکت‌کننده (CLA) دارند که اعلام می‌کند شما حق دارید و واقعاً حقوق استفاده از مشارکت خود را به ما اعطا می‌کنید. برای جزئیات، به 
<https://cla.opensource.microsoft.com> مراجعه کنید.

هنگامی که یک درخواست pull ارسال می‌کنید، یک ربات CLA به طور خودکار تعیین می‌کند که آیا باید CLA ارائه دهید و درخواست را به طور مناسب تزئین می‌کند (مثلاً بررسی وضعیت، نظر). فقط دستورالعمل‌های ارائه شده توسط ربات را دنبال کنید. شما فقط یک بار این کار را در تمام مخازن استفاده‌کننده از CLA ما انجام خواهید داد.
...
- **study_guide.md**: راهنمای جامع برای پیمایش در مخزن
...
این پروژه ممکن است شامل علائم تجاری یا لوگوهایی برای پروژه‌ها، محصولات یا خدمات باشد. استفاده مجاز از علائم تجاری یا لوگوهای مایکروسافت باید مطابق با [دستورالعمل‌های علائم تجاری و برند مایکروسافت](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) باشد.
