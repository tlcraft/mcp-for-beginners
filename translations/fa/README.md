...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T22:20:04+00:00",
...
| ۵.۲ | چندرسانه‌ای | کار با چندین مدیا | [راهنما](./05-AdvancedTopics/mcp-multi-modality/README.md) |
...
| 10 | کارگاه عملی | ساخت سرور MCP با جعبه‌ابزار هوش مصنوعی | [آزمایشگاه](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
| Java | نمونه اپلیکیشن کانتینری | [مشاهده کد](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
- (اختیاری) زمینه‌ای در مفاهیم هوش مصنوعی و یادگیری ماشین داشته باشید
...
- **alternative_layouts/**: قالب‌های مختلف ارائه محتوای دوره
