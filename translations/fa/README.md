...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-11T12:51:49+00:00",
...
برای دو روز بینش فنی عمیق، ارتباط با جامعه و یادگیری عملی در رویداد مجازی MCP Dev Days آماده شوید. این رویداد به پروتکل زمینه مدل (MCP) اختصاص دارد — استاندارد نوظهوری که مدل‌های هوش مصنوعی و ابزارهای مورد نیاز آن‌ها را به هم متصل می‌کند.  
...
این روز به توانمندسازی توسعه‌دهندگان برای استفاده از MCP در جریان کاری توسعه‌دهنده و جشن گرفتن جامعه شگفت‌انگیز MCP اختصاص دارد. ما با اعضای جامعه و شرکای خود مانند Arcade، Block، Okta و Neon همراه خواهیم بود تا ببینیم چگونه با مایکروسافت همکاری می‌کنند تا یک اکوسیستم MCP باز و قابل توسعه شکل دهند.  
...
این روز برای سازندگان MCP است. ما به استراتژی‌های پیاده‌سازی و بهترین روش‌ها برای ایجاد سرورهای MCP و ادغام MCP در جریان‌های کاری هوش مصنوعی خواهیم پرداخت.
...
| 5.4 | زمینه‌های اصلی | درک و پیاده‌سازی زمینه‌های اصلی | [راهنما](./05-AdvancedTopics/mcp-root-contexts/README.md) |
...
| Java با Spring | مثال اپلیکیشن کانتینر | [View Code](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
| TypeScript | نمونه کانتینر | [View Code](./04-PracticalImplementation/samples/typescript/README.md) |

## 🎯 پیش‌نیازهای یادگیری MCP

برای بهره‌برداری کامل از این دوره، باید موارد زیر را داشته باشید:
...
- نقشه تصویری دوره که تمام موضوعات پوشش داده شده را نشان می‌دهد  
...
ما یک [تغییرات](./changelog.md) دقیق را نگهداری می‌کنیم که تمام به‌روزرسانی‌های مهم در مواد دوره را شامل می‌شود، از جمله:
...
- **images/**: نمودارها و تصاویر استفاده شده در سراسر دوره  
...
استفاده از علائم تجاری یا لوگوهای Microsoft در نسخه‌های اصلاح‌شده این پروژه نباید باعث سردرگمی شود یا حمایت Microsoft را نشان دهد.  
