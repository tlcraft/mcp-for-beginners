...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-01T09:26:49+00:00",
...
**پروتکل مدل کانتکست (MCP)** یک چارچوب پیشرفته است که برای استانداردسازی تعاملات بین مدل‌های هوش مصنوعی و برنامه‌های کلاینت طراحی شده است. این برنامه درسی متن‌باز، مسیر یادگیری ساختاریافته‌ای ارائه می‌دهد که شامل مثال‌های کدنویسی کاربردی و موارد استفاده واقعی در زبان‌های برنامه‌نویسی محبوب مانند C#، Java، JavaScript، TypeScript و Python می‌باشد.

چه شما توسعه‌دهنده هوش مصنوعی، معمار سیستم یا مهندس نرم‌افزار باشید، این راهنما منبع جامعی برای تسلط بر مبانی MCP و استراتژی‌های پیاده‌سازی آن است.
...
### مبانی پروتکل مدل کانتکست  
<details>
  <summary><strong> درس ۱-۳: مبانی پروتکل مدل کانتکست</strong></summary>

- **۰۰. مقدمه‌ای بر MCP**  
  مروری بر پروتکل مدل کانتکست و اهمیت آن در خطوط لوله هوش مصنوعی. [مطالعه بیشتر](./00-Introduction/README.md)
...
- **۰۳. شروع کار با MCP**  
  راه‌اندازی محیط، سرورها/کلاینت‌های پایه، یکپارچه‌سازی. [مطالعه بیشتر](./03-GettingStarted/README.md)
</details>

### ساخت و استقرار اولین سرور و کلاینت MCP و کارگاه‌ها و سناریوهای عملی  
<details>
...
- **۳.۸. تست سرور شما** – [راهنما](./03-GettingStarted/08-testing/README.md)
- **۳.۹. استقرار سرور شما** – [راهنما](./03-GettingStarted/09-deployment/README.md)
</details>

### پیاده‌سازی‌های عملی و محتوای پیشرفته پروتکل مدل کانتکست  
<details>
  <summary><strong> درس ۴-۵: عملی و پیشرفته</strong></summary>
...
- **۰۵. موضوعات پیشرفته در MCP**  
  هوش مصنوعی چندوجهی، مقیاس‌پذیری، استفاده سازمانی. [مطالعه بیشتر](./05-AdvancedTopics/README.md)
...
- **۵.۴. کانتکست‌های ریشه** – [راهنما](./05-AdvancedTopics/mcp-root-contexts/README.md)
...
<details>
  <summary><strong> درس ۶-۹: جامعه، بهترین شیوه‌ها و کارگاه‌ها</strong></summary>
...
- **۱۰. بهینه‌سازی جریان‌های کاری هوش مصنوعی: ساخت سرور MCP با AI Toolkit** – [آزمایشگاه عملی](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md)
</details>
...
### 💡 راهکار پیشرفته MCP: پروژه‌های ماشین‌حساب در C#، Java، JavaScript، TypeScript و Python
<details>
...
- (اختیاری) با مفاهیم یادگیری ماشین آشنایی داشته باشید  
...
از [Shivam Goyal](https://www.linkedin.com/in/shivam2003/)، متخصص محترم مایکروسافت، برای ارائه نمونه‌های کد مهم تشکر می‌کنیم.
...
این پروژه از مشارکت‌ها و پیشنهادات استقبال می‌کند. بیشتر مشارکت‌ها مستلزم آن است که شما با توافق‌نامه مجوز مشارکت‌کننده (CLA) موافقت کنید که اعلام می‌کند شما حق استفاده از مشارکت خود را به ما می‌دهید. برای جزئیات بیشتر به <https://cla.opensource.microsoft.com> مراجعه کنید.

وقتی درخواست Pull ارسال می‌کنید، ربات CLA به‌طور خودکار بررسی می‌کند که آیا باید توافق‌نامه CLA را ارائه دهید و درخواست شما را به‌درستی علامت‌گذاری می‌کند (مثلاً بررسی وضعیت، نظر). کافی است دستورالعمل‌های ربات را دنبال کنید. این کار فقط یک بار برای همه مخازنی که از CLA ما استفاده می‌کنند لازم است.

این پروژه از [کد رفتاری منبع باز مایکروسافت](https://opensource.microsoft.com/codeofconduct/) پیروی می‌کند. برای اطلاعات بیشتر به [سؤالات متداول کد رفتاری](https://opensource.microsoft.com/codeofconduct/faq/) مراجعه کنید یا با [opencode@microsoft.com](mailto:opencode@microsoft.com) تماس بگیرید.
...
**سلب مسئولیت**:  
این سند با استفاده از سرویس ترجمه هوش مصنوعی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. در حالی که ما در تلاش برای دقت هستیم، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است حاوی اشتباهات یا نواقص باشند. سند اصلی به زبان مادری آن باید به عنوان منبع معتبر در نظر گرفته شود. برای اطلاعات حیاتی، ترجمه حرفه‌ای انسانی توصیه می‌شود. ما مسئول هیچ گونه سوء تفاهم یا تفسیر نادرستی که ناشی از استفاده از این ترجمه باشد، نیستیم.