...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:19:36+00:00",
...
- 🧑‍💻 [مخزن GitHub MCP](https://github.com/modelcontextprotocol) – SDKها، ابزارها و نمونه‌های کدنویسی متن‌باز
...
| 3.1 | اولین سرور | ایجاد اولین سرور MCP | [راهنما](./03-GettingStarted/01-first-server/README.md) |
...
| 3.4 | یکپارچه‌سازی VS Code | استفاده از سرورهای MCP در VS Code | [راهنما](./03-GettingStarted/04-vscode/README.md) |
...
| Java با Spring | مثال برنامه کانتینر | [مشاهده کد](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
#### [➡️تماشای آنلاین - روزهای توسعه MCP](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
آماده باشید برای دو روز بینش فنی عمیق، ارتباط با جامعه، و یادگیری عملی در روزهای توسعه MCP، یک رویداد مجازی اختصاص داده شده به پروتکل مدل کانتکست (MCP) — استاندارد نوظهوری که مدل‌های هوش مصنوعی و ابزارهایی که به آن‌ها وابسته هستند را به هم متصل می‌کند.
...
جریان‌های کاری توسعه‌دهنده عملی و مبتنی بر کانتکست
...
در جلسات ویدیویی فشرده یاد بگیرید چگونه سرورهای MCP ایجاد کنید، با VS Code ادغام کنید، و به صورت حرفه‌ای بر روی Azure مستقر کنید، بر اساس محتوای دوره آموزشی MCP برای مبتدیان. با مهارت‌های عملی در فناوری که شرکت‌های بزرگ از آن استفاده می‌کنند، از بوت کمپ خارج شوید.

#### [➡️تماشای آنلاین بوت کمپ MCP | انگلیسی](https://developer.microsoft.com/en-us/reactor/series/s-1568/)
#### [➡️تماشای آنلاین بوت کمپ MCP | برزیل](https://developer.microsoft.com/en-us/reactor/series/S-1566/)
#### [➡️تماشای آنلاین بوت کمپ MCP | اسپانیایی](https://developer.microsoft.com/en-us/reactor/series/S-1567/)


### بیایید MCP را با C# یاد بگیریم - سری آموزشی
بیایید درباره پروتکل مدل کانتکست (MCP)، یک چارچوب پیشرفته طراحی شده برای استانداردسازی تعاملات بین مدل‌های هوش مصنوعی و برنامه‌های کلاینت، یاد بگیریم. در این جلسه دوستانه برای مبتدیان، ما شما را با MCP آشنا می‌کنیم و شما را در ایجاد اولین سرور MCP راهنمایی می‌کنیم.
...
CLA ارائه دهید و درخواست کشش را به طور مناسب تزئین می‌کند (مانند بررسی وضعیت، نظر). فقط دستورالعمل‌های
...
- **دوره اصلی (00-10)**: محتوای اصلی سازماندهی شده در ده ماژول متوالی
