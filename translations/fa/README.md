...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T07:04:57+00:00",
...
| 00 | معرفی MCP | مرور کلی پروتکل زمینه مدل و اهمیت آن در خطوط لوله هوش مصنوعی | [بیشتر بخوانید](./00-Introduction/README.md) |
...
| 03 | شروع کار با MCP | تنظیم محیط، سرورها/کلاینت‌های پایه، یکپارچه‌سازی | [بیشتر بخوانید](./03-GettingStarted/README.md) |
| **ماژول 3: ساخت اولین سرور و کلاینت شما** | | | |
| 3.1 | اولین سرور | ساخت اولین سرور MCP خود | [راهنما](./03-GettingStarted/01-first-server/README.md) |
| 3.2 | اولین کلاینت | توسعه یک کلاینت MCP پایه | [راهنما](./03-GettingStarted/02-client/README.md) |
| 3.3 | کلاینت با LLM | یکپارچه‌سازی مدل‌های زبان بزرگ | [راهنما](./03-GettingStarted/03-llm-client/README.md) |
| 3.4 | یکپارچه‌سازی VS Code | مصرف سرورهای MCP در VS Code | [راهنما](./03-GettingStarted/04-vscode/README.md) |
...
| 05 | موضوعات پیشرفته در MCP | هوش مصنوعی چندوجهی، مقیاس‌پذیری، استفاده سازمانی | [بیشتر بخوانید](./05-AdvancedTopics/README.md) |
| 5.1 | یکپارچه‌سازی Azure | یکپارچه‌سازی MCP با Azure | [راهنما](./05-AdvancedTopics/mcp-integration/README.md) |
| 5.2 | چندوجهی | کار با چند وجه | [راهنما](./05-AdvancedTopics/mcp-multi-modality/README.md) |
...
| 5.10 | استریم بلادرنگ | ساخت قابلیت‌های استریم بلادرنگ | [راهنما](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
...
| 11 | یکپارچه‌سازی پایگاه داده سرور MCP | مسیر یادگیری جامع 13 آزمایشگاه برای یکپارچه‌سازی PostgreSQL | [آزمایشگاه‌ها](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | معرفی | مرور کلی MCP با یکپارچه‌سازی پایگاه داده و مورد استفاده تحلیل خرده‌فروشی | [آزمایشگاه 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
### 💻 نمونه پروژه‌های کدنویسی

#### نمونه‌های پایه‌ای محاسبه‌گر MCP
...
- نقشه تصویری دوره آموزشی که تمام موضوعات پوشش داده شده را نشان می‌دهد
...
ما یک [تغییرات](./changelog.md) دقیق نگهداری می‌کنیم که تمام به‌روزرسانی‌های مهم در مواد دوره آموزشی را شامل می‌شود، از جمله:
...
2. نمونه‌های کدنویسی زنده در زبان‌های مختلف  
...
آماده شوید برای دو روز بینش فنی عمیق، ارتباط با جامعه و یادگیری عملی در روزهای توسعه MCP، یک رویداد مجازی اختصاص داده شده به پروتکل مدل زمینه (MCP) — استاندارد نوظهوری که پل ارتباطی بین مدل‌های هوش مصنوعی و ابزارهایی که به آن‌ها وابسته هستند، ایجاد می‌کند.
...
روز دوم برای سازندگان MCP است. ما به استراتژی‌های پیاده‌سازی و بهترین روش‌ها برای ایجاد سرورهای MCP و یکپارچه‌سازی MCP در جریان‌های کاری هوش مصنوعی خواهیم پرداخت.
...
در جلسات ویدیویی فشرده یاد بگیرید چگونه سرورهای MCP ایجاد کنید، با VS Code یکپارچه شوید و به صورت حرفه‌ای در Azure مستقر کنید، بر اساس محتوای دوره آموزشی MCP برای مبتدیان. با مهارت‌های عملی در فناوری که شرکت‌های بزرگ در حال حاضر از آن استفاده می‌کنند، از بوت کمپ خارج شوید.
...
هنگامی که یک درخواست کشش ارسال می‌کنید، یک ربات CLA به طور خودکار تعیین می‌کند که آیا شما نیاز دارید
CLA ارائه دهید و درخواست کشش را به طور مناسب تزئین کنید (مانند بررسی وضعیت، نظر). فقط دستورالعمل‌های
...
- **دوره آموزشی اصلی (00-11)**: محتوای اصلی سازماندهی شده در یازده ماژول متوالی، شامل آزمایشگاه‌های جامع یکپارچه‌سازی پایگاه داده
- **11-MCPServerHandsOnLabs/**: مسیر یادگیری کامل 13 آزمایشگاه برای ساخت سرورهای MCP آماده تولید با یکپارچه‌سازی PostgreSQL
- **images/**: نمودارها و تصاویر استفاده شده در سراسر دوره آموزشی
...
- **changelog.md**: ثبت تغییرات مهم در مواد دوره آموزشی
