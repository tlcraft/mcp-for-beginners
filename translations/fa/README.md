...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-12T08:03:25+00:00",
...
**پروتکل زمینه مدل (MCP)** یک چارچوب پیشرفته است که برای استانداردسازی تعاملات بین مدل‌های هوش مصنوعی و برنامه‌های کلاینت طراحی شده است. این برنامه آموزشی متن‌باز یک مسیر یادگیری ساختاریافته ارائه می‌دهد که شامل مثال‌های کدنویسی عملی و موارد استفاده واقعی در زبان‌های برنامه‌نویسی محبوب مانند C#، جاوا، جاوااسکریپت، تایپ‌اسکریپت و پایتون است.

چه توسعه‌دهنده هوش مصنوعی باشید، چه معمار سیستم یا مهندس نرم‌افزار، این راهنما منبع جامع شما برای تسلط بر اصول MCP و استراتژی‌های پیاده‌سازی آن است.
...
### ➡️ تماشای رویداد MCP Dev Days به‌صورت درخواستی  
برای دو روز بینش فنی عمیق، ارتباط با جامعه و یادگیری عملی در رویداد مجازی MCP Dev Days آماده شوید. این رویداد به پروتکل زمینه مدل (MCP) اختصاص دارد — استاندارد نوظهوری که مدل‌های هوش مصنوعی و ابزارهای مورد استفاده آن‌ها را به هم متصل می‌کند.  
می‌توانید MCP Dev Days را با ثبت‌نام در صفحه رویداد ما تماشا کنید: https://aka.ms/mcpdevdays.

#### روز اول: بهره‌وری MCP، ابزارهای توسعه‌دهنده و جامعه:  

تمرکز بر توانمندسازی توسعه‌دهندگان برای استفاده از MCP در جریان کاری توسعه‌دهنده و جشن گرفتن جامعه شگفت‌انگیز MCP است. با اعضای جامعه و شرکای مانند Arcade، Block، Okta و Neon همراه خواهیم بود تا ببینیم چگونه با مایکروسافت همکاری می‌کنند تا یک اکوسیستم MCP باز و قابل توسعه شکل دهند.  
...
برای سازندگان MCP است. به استراتژی‌های پیاده‌سازی و بهترین روش‌ها برای ایجاد سرورهای MCP و ادغام MCP در جریان‌های کاری هوش مصنوعی خواهیم پرداخت.
...
| 04 | پیاده‌سازی عملی | SDKها، دیباگ کردن، تست، قالب‌های پرامپت قابل استفاده مجدد | [بیشتر بخوانید](./04-PracticalImplementation/README.md) |
...
| 5.13 | ادغام با Foundry | ادغام با Azure AI Foundry | [راهنما](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
| 5.14 | مهندسی زمینه | تکنیک‌های مهندسی زمینه مؤثر | [راهنما](./05-AdvancedTopics/mcp-contextengineering/README.md) |
| **ماژول 6-10: جامعه و بهترین روش‌ها** | | | |
| 06 | مشارکت‌های جامعه | چگونه به اکوسیستم MCP کمک کنیم | [Guide](./06-CommunityContributions/README.md) |
| 07 | درس‌هایی از پذیرش اولیه | داستان‌های پیاده‌سازی در دنیای واقعی | [Guide](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | بهترین روش‌ها برای MCP | عملکرد، تحمل خطا، تاب‌آوری | [Guide](./08-BestPractices/README.md) |
| 09 | مطالعات موردی MCP | مثال‌های عملی پیاده‌سازی | [Guide](./09-CaseStudy/README.md) |
| 10 | کارگاه عملی | ساخت سرور MCP با ابزار هوش مصنوعی | [Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |

### 💻 پروژه‌های نمونه کدنویسی

#### نمونه‌های اولیه محاسبه‌گر MCP

| زبان | توضیحات | لینک |
|------|---------|------|
| C# | مثال سرور MCP | [View Code](./03-GettingStarted/samples/csharp/README.md) |
| Java | محاسبه‌گر MCP | [View Code](./03-GettingStarted/samples/java/calculator/README.md) |
| JavaScript | دموی MCP | [View Code](./03-GettingStarted/samples/javascript/README.md) |
| Python | سرور MCP | [View Code](../../03-GettingStarted/samples/python/mcp_calculator_server.py) |
| TypeScript | مثال MCP | [View Code](./03-GettingStarted/samples/typescript/README.md) |
...
| Java با Spring | مثال اپلیکیشن کانتینری | [View Code](./04-PracticalImplementation/samples/java/containerapp/README.md) |
| JavaScript | نمونه پیشرفته | [View Code](./04-PracticalImplementation/samples/javascript/README.md) |
| Python | پیاده‌سازی پیچیده | [View Code](../../04-PracticalImplementation/samples/python/mcp_sample.py) |
| TypeScript | نمونه کانتینری | [View Code](./04-PracticalImplementation/samples/typescript/README.md) |

## 🎯 پیش‌نیازهای یادگیری MCP

برای بهره‌گیری کامل از این دوره آموزشی، باید موارد زیر را داشته باشید:
...
این مخزن شامل منابع مختلفی است که به شما کمک می‌کند به طور مؤثر یاد بگیرید و پیش بروید:
...
ما یک [تغییرات](./changelog.md) دقیق را نگهداری می‌کنیم که تمام به‌روزرسانی‌های مهم در مواد دوره آموزشی را شامل می‌شود، از جمله:
...
3. تمرین‌هایی برای ساخت اپلیکیشن‌های واقعی MCP  
4. منابع اضافی برای یادگیرندگان پیشرفته  

## 🌟 تشکر از جامعه

تشکر ویژه از Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) برای ارائه نمونه‌های کدنویسی مهم.  
...
این پروژه از مشارکت‌ها و پیشنهادات استقبال می‌کند. اکثر مشارکت‌ها نیاز دارند که شما با یک توافقنامه مجوز مشارکت‌کننده (CLA) موافقت کنید که اعلام می‌کند شما حق دارید و واقعاً حقوق استفاده از مشارکت خود را به ما اعطا می‌کنید. برای جزئیات، به  
...
- **دوره اصلی (00-10)**: محتوای اصلی در ده ماژول متوالی سازماندهی شده است  
...
- **changelog.md**: ثبت تمام تغییرات مهم در مواد دوره آموزشی  
...
استفاده از علائم تجاری یا لوگوهای Microsoft در نسخه‌های اصلاح‌شده این پروژه نباید باعث سردرگمی یا القای حمایت Microsoft شود.  
