...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T19:44:27+00:00",
...
- دانش پایه‌ای برنامه‌نویسی در حداقل یکی از زبان‌های زیر داشته باشید: C#، Java، JavaScript، Python یا TypeScript  
- درک مدل کلاینت-سرور و APIها  
- آشنایی با مفاهیم REST و HTTP  
- (اختیاری) پیش‌زمینه‌ای در مفاهیم AI/ML داشته باشید  
...
2. مثال‌های زنده کدنویسی در چندین زبان  
...
#### [➡️تماشای ضبط شده - روزهای توسعه‌دهندگان MCP](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
آماده شوید برای دو روز بینش فنی عمیق، ارتباط با جامعه، و یادگیری عملی در روزهای توسعه‌دهندگان MCP، یک رویداد مجازی که به پروتکل مدل کانتکست (MCP) اختصاص داده شده است — استاندارد نوظهوری که مدل‌های هوش مصنوعی و ابزارهای مورد استفاده آن‌ها را به هم متصل می‌کند.  
می‌توانید با ثبت‌نام در صفحه رویداد ما، روزهای توسعه‌دهندگان MCP را تماشا کنید: https://aka.ms/mcpdevdays.  

#### [روز اول: بهره‌وری MCP، ابزارهای توسعه‌دهنده و جامعه:](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
...
در جلسات ویدیویی فشرده یاد بگیرید چگونه سرورهای MCP ایجاد کنید، با VS Code ادغام کنید و به صورت حرفه‌ای در Azure مستقر کنید، بر اساس محتوای دوره آموزشی MCP برای مبتدیان. با مهارت‌های عملی در فناوری که شرکت‌های بزرگ در حال حاضر از آن استفاده می‌کنند، آماده شوید.  
...
- **برنامه درسی اصلی (00-10)**: محتوای اصلی سازماندهی شده در ده ماژول متوالی  
