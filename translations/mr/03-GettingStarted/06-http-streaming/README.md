...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-10T16:04:09+00:00",
...
पूर्वीच्या अध्यायांमध्ये तुम्हाला stdio आणि SSE ट्रान्सपोर्ट दाखवले गेले होते, तर या अध्यायात Streamable HTTP या ट्रान्सपोर्टवर लक्ष केंद्रित केले आहे.
...
**स्ट्रीमिंग** ही नेटवर्क प्रोग्रामिंगमधील एक तंत्र आहे ज्यात संपूर्ण प्रतिसाद तयार होण्याची वाट पाहण्याऐवजी डेटा लहान, हाताळण्याजोग्या तुकड्यांमध्ये किंवा घटनांच्या मालिकेत पाठवला आणि प्राप्त केला जातो. हे विशेषतः उपयुक्त आहे:
...
"क्लासिक" स्ट्रीमिंग आणि MCP स्ट्रीमिंग कसे वेगळे आहेत हे खालील तक्त्यात दाखवले आहे:

| वैशिष्ट्य               | क्लासिक HTTP स्ट्रीमिंग       | MCP स्ट्रीमिंग (नोटिफिकेशन्स)    |
|------------------------|------------------------------|----------------------------------|
| मुख्य प्रतिसाद          | तुकड्यांमध्ये पाठवला जातो    | एकदाच, शेवटी पाठवला जातो        |
| प्रगती अपडेट्स         | डेटा तुकड्यांमध्ये पाठवले जातात | नोटिफिकेशन्सद्वारे पाठवले जातात  |
...
- **संवाद पद्धत:**
   - क्लासिक HTTP स्ट्रीमिंग: साधा chunked ट्रान्सफर एन्कोडिंग वापरतो
   - MCP स्ट्रीमिंग: JSON-RPC प्रोटोकॉलसह संरचित नोटिफिकेशन सिस्टम वापरतो

- **मेसेज फॉरमॅट:**
   - क्लासिक HTTP: साधे टेक्स्ट तुकडे, नवीन ओळींसह
   - MCP: मेटाडेटा सहित संरचित LoggingMessageNotification ऑब्जेक्ट्स

- **क्लायंट अंमलबजावणी:**
   - क्लासिक HTTP: सोपा क्लायंट जो स्ट्रीमिंग प्रतिसाद प्रक्रिया करतो
   - MCP: अधिक प्रगत क्लायंट जो वेगवेगळ्या प्रकारच्या मेसेजेससाठी मेसेज हँडलर वापरतो

- **प्रगती अपडेट्स:**
   - क्लासिक HTTP: प्रगती मुख्य प्रतिसाद स्ट्रीमचा भाग असते
   - MCP: प्रगती स्वतंत्र नोटिफिकेशन मेसेजेसद्वारे पाठवली जाते, मुख्य प्रतिसाद शेवटी येतो

### शिफारसी

क्लासिक स्ट्रीमिंग (`/stream` एन्डपॉइंट वापरून) आणि MCP स्ट्रीमिंग यामध्ये निवड करताना काही शिफारसी:

- **सोप्या स्ट्रीमिंगसाठी:** क्लासिक HTTP स्ट्रीमिंग सोपे आणि मूलभूत गरजांसाठी पुरेसे आहे.
...
आता तुम्हाला क्लासिक आणि MCP स्ट्रीमिंगमधील फरक समजले आहेत. चला पाहूया MCP मध्ये स्ट्रीमिंग कसे वापरायचे.

MCP फ्रेमवर्कमध्ये स्ट्रीमिंग कसे कार्य करते हे समजून घेणे आवश्यक आहे जेणेकरून तुम्ही दीर्घकालीन ऑपरेशन्स दरम्यान वापरकर्त्यांना रिअल-टाइम फीडबॅक देणारी प्रतिसादक्षम अॅप्लिकेशन्स तयार करू शकता.
...
मुख्य निकाल अजूनही एकदाच पाठवला जातो. मात्र, प्रक्रिया दरम्यान नोटिफिकेशन्स स्वतंत्र मेसेजेस म्हणून पाठवता येतात ज्यामुळे क्लायंटला रिअल-टाइम अपडेट्स मिळतात. क्लायंटला हे नोटिफिकेशन्स हाताळता आणि दाखवता यायला हवे.

## नोटिफिकेशन म्हणजे काय?

"नोटिफिकेशन" म्हटलं तर MCP च्या संदर्भात काय अर्थ?

नोटिफिकेशन म्हणजे सर्व्हरकडून क्लायंटला पाठवलेला मेसेज जो दीर्घकालीन ऑपरेशन दरम्यान प्रगती, स्थिती किंवा इतर इव्हेंट्सची माहिती देतो. नोटिफिकेशन्समुळे पारदर्शकता आणि वापरकर्ता अनुभव सुधारतो.
...
नोटिफिकेशन्स MCP मधील ["Logging"](https://modelcontextprotocol.io/specification/draft/server/utilities/logging) या विषयाशी संबंधित असतात.
...
> [!NOTE]
> SDK नुसार, लॉगिंग डीफॉल्टने सक्षम असू शकते किंवा तुम्हाला ते सर्व्हर कॉन्फिगरेशनमध्ये स्पष्टपणे सक्षम करावे लागू शकते.
...
MCP मध्ये नोटिफिकेशन्स अंमलात आणण्यासाठी, तुम्हाला सर्व्हर आणि क्लायंट दोन्ही बाजू सेटअप करावे लागतात जेणेकरून रिअल-टाइम अपडेट्स हाताळता येतील. यामुळे तुमचे अॅप्लिकेशन दीर्घकालीन ऑपरेशन्स दरम्यान वापरकर्त्यांना त्वरित फीडबॅक देऊ शकते.
...
या .NET उदाहरणात, `ProcessFiles` टूल `Tool` अ‍ॅट्रिब्यूटसह सजवलेले आहे आणि प्रत्येक फाइल प्रक्रिया करताना क्लायंटला तीन नोटिफिकेशन्स पाठवते. `ctx.Info()` मेथड माहितीपूर्ण मेसेजेस पाठवण्यासाठी वापरली जाते.
...
क्लायंटला नोटिफिकेशन्स प्राप्त करून त्यांना प्रक्रिया आणि प्रदर्शन करण्यासाठी मेसेज हँडलर अंमलात आणावा लागतो.
...
प्रगती नोटिफिकेशन्स महत्त्वाच्या कारणांसाठी आवश्यक आहेत
...
### मुख्य मुद्दे
- **Origin हेडरची पडताळणी**: DNS रीबाइंडिंग हल्ले टाळण्यासाठी नेहमी `Origin` हेडरची पडताळणी करा.
...
- सर्व प्रवेश आणि त्रुटींचे लॉगिंग आणि निरीक्षण करा.
...
सध्या Server-Sent Events (SSE) वापरणाऱ्या अनुप्रयोगांसाठी, Streamable HTTP कडे स्थलांतर केल्याने अधिक क्षमता आणि दीर्घकालीन टिकाऊपणा मिळतो.

### का अपग्रेड करावे?

SSE वरून Streamable HTTP कडे अपग्रेड करण्यासाठी दोन महत्त्वाचे कारणे आहेत:

- Streamable HTTP SSE पेक्षा अधिक स्केलेबल, सुसंगत आणि समृद्ध सूचना समर्थन देते.
- नवीन MCP अनुप्रयोगांसाठी हा शिफारस केलेला ट्रान्सपोर्ट आहे.

### स्थलांतर चरण

तुमच्या MCP अनुप्रयोगांमध्ये SSE वरून Streamable HTTP कडे स्थलांतर कसे कराल:
...
- क्लायंटमध्ये सूचना प्रक्रिया करण्यासाठी मेसेज हँडलर लागू करा.
...
- सर्व क्लायंट अद्ययावत करणे
- सूचनांच्या वितरणातील फरक हाताळणे

## सुरक्षा विचार

HTTP-आधारित ट्रान्सपोर्टसारख्या Streamable HTTP वापरताना कोणत्याही सर्व्हरची सुरक्षा सर्वोच्च प्राधान्य असावी.
...
MCP स्ट्रीमिंगसह तुमचा प्रवास सुरू ठेवण्यासाठी आणि अधिक प्रगत अनुप्रयोग तयार करण्यासाठी या विभागात अतिरिक्त संसाधने आणि पुढील पावले दिली आहेत.
