...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T00:26:54+00:00",
...
आत्तापर्यंत, तुम्ही पाहिले आहे की सर्व्हर आणि क्लायंट कसे तयार करायचे. क्लायंटने स्पष्टपणे सर्व्हरला कॉल करून त्याचे टूल्स, संसाधने आणि प्रॉम्प्ट्स यादीबद्ध केली आहे. मात्र, हा दृष्टिकोन फारसा व्यवहार्य नाही. तुमचा वापरकर्ता एजंटिक युगात राहतो आणि प्रॉम्प्ट्स वापरून LLM शी संवाद साधण्याची अपेक्षा करतो. तुमच्या वापरकर्त्यास याची पर्वा नाही की तुम्ही तुमच्या क्षमतांसाठी MCP वापरत आहात की नाही, पण ते नैसर्गिक भाषेत संवाद साधण्याची अपेक्षा करतात. तर आपण हे कसे सोडवू? यासाठी क्लायंटमध्ये LLM जोडणे हा उपाय आहे.
...
2. क्षमतांची, प्रॉम्प्ट्सची, संसाधनांची आणि टूल्सची यादी करा आणि त्यांचा स्कीमा जतन करा.

3. LLM जोडा आणि जतन केलेल्या क्षमतांशी संबंधित स्कीमा LLM समजेल अशा स्वरूपात द्या.

4. वापरकर्त्याचा प्रॉम्प्ट LLM कडे पाठवा, ज्यास क्लायंटने यादी केलेले टूल्स देखील दिले जातील.

छान, आता आपण उच्च स्तरावर हे कसे करायचे ते समजले, तर खालील सरावात हे करून पाहूया.

## सराव: LLM सह क्लायंट तयार करणे

या सरावात आपण आपल्या क्लायंटमध्ये LLM कसे जोडायचे ते शिकू.

## GitHub Personal Access Token वापरून प्रमाणीकरण

GitHub टोकन तयार करणे सोपे आहे. हे कसे करायचे:

- GitHub सेटिंग्जमध्ये जा – वरच्या उजव्या कोपऱ्यात तुमच्या प्रोफाइल चित्रावर क्लिक करा आणि Settings निवडा.
...
- तुमचा टोकन कॉन्फिगर करा – संदर्भासाठी नोट जोडा, समाप्ती तारीख सेट करा आणि आवश्यक scopes (परवानग्या) निवडा.
...
छान, पुढील टप्प्यासाठी, आता सर्व्हरवरील क्षमतांची यादी करूया.

### -2 सर्व्हर क्षमतांची यादी करा

आता आपण सर्व्हरशी कनेक्ट होऊन त्याच्या क्षमतांची विचारणा करूया:
...
- `run` मेथड तयार केली आहे जी आमच्या अॅपच्या फ्लोची जबाबदारी सांभाळेल. आतापर्यंत ती फक्त टूल्सची यादी करते, पण लवकरच त्यात अधिक जोडू.
...
- संसाधने आणि टूल्सची यादी केली आणि ती प्रिंट केली. टूल्ससाठी `inputSchema` देखील यादीबद्ध केली, जी नंतर वापरली जाईल.
...
- MCP सर्व्हरवरील उपलब्ध टूल्सची यादी केली आहे
- प्रत्येक टूलसाठी नाव, वर्णन आणि त्याचा स्कीमा यादीबद्ध केला आहे. हा स्कीमा आपण लवकरच टूल कॉल करण्यासाठी वापरणार आहोत.
...
- `McpToolProvider` तयार केला आहे जो MCP सर्व्हरमधील सर्व टूल्स आपोआप शोधून नोंदणी करतो
- टूल प्रोव्हायडर MCP टूल स्कीमा आणि LangChain4j च्या टूल फॉरमॅटमधील रूपांतरण अंतर्गत हाताळतो
- हा दृष्टिकोन मॅन्युअल टूल लिस्टिंग आणि रूपांतरण प्रक्रियेला दूर करतो

### -3- सर्व्हर क्षमतांना LLM टूल्समध्ये रूपांतर करा

सर्व्हर क्षमतांची यादी केल्यानंतर पुढील टप्पा म्हणजे त्यांना LLM समजेल अशा स्वरूपात रूपांतरित करणे. एकदा हे केल्यावर, आपण या क्षमतांना LLM साठी टूल्स म्हणून पुरवू शकतो.

### TypeScript

1. MCP सर्व्हरकडून आलेल्या प्रतिसादाला LLM वापरू शकणाऱ्या टूल स्वरूपात रूपांतरित करण्यासाठी खालील कोड जोडा:
    ...
    वरील कोड MCP सर्व्हरकडून आलेला प्रतिसाद घेऊन तो LLM समजेल अशा टूल डिफिनिशन स्वरूपात रूपांतरित करतो.

2. नंतर `run` मेथड अपडेट करा जेणेकरून सर्व्हर क्षमतांची यादी करता येईल:
    ...
    वरील कोडमध्ये, `run` मेथडमध्ये परिणामावर मॅपिंग करून प्रत्येक एन्ट्रीसाठी `openAiToolAdapter` कॉल केला आहे.

### Python

1. प्रथम, खालील कन्व्हर्टर फंक्शन तयार करा:
    ...
    `convert_to_llm_tools` फंक्शनमध्ये MCP टूल प्रतिसाद घेऊन तो LLM समजेल अशा स्वरूपात रूपांतरित केला जातो.

2. नंतर, क्लायंट कोडमध्ये हा फंक्शन वापरण्यासाठी अपडेट करा:
    ...
    येथे, आपण MCP टूल प्रतिसाद `convert_to_llm_tool` कॉल करून रूपांतरित करत आहोत, जे नंतर LLM ला दिले जाईल.
...
- `ConvertFrom` नावाचा फंक्शन तयार केला आहे जो नाव, वर्णन आणि इनपुट स्कीमा घेतो.
- हा फंक्शन `FunctionDefinition` तयार करतो जो `ChatCompletionsDefinition` मध्ये दिला जातो. हे LLM समजेल अशा स्वरूपात आहे.

2. आता या फंक्शनचा फायदा घेण्यासाठी काही विद्यमान कोड कसा अपडेट करायचा ते पाहू:
    ...
    - MCP टूल प्रतिसाद LLM टूलमध्ये रूपांतरित करण्यासाठी फंक्शन अपडेट केला आहे. खालील कोड भागावर लक्ष द्या:
        ...
        इनपुट स्कीमा टूल प्रतिसादाचा भाग आहे पण "properties" अ‍ॅट्रिब्यूटमध्ये आहे, त्यामुळे ते एक्स्ट्रॅक्ट करणे आवश्यक आहे. त्यानंतर `ConvertFrom` कॉल केला जातो टूल तपशीलांसह. आता आपण मुख्य काम केले आहे, पुढे वापरकर्त्याचा प्रॉम्प्ट कसा हाताळायचा ते पाहू.
...
- LangChain4j चा `AiServices` वापरून LLM आणि MCP टूल प्रोव्हायडर आपोआप जोडले आहेत
- फ्रेमवर्क टूल स्कीमा रूपांतरण आणि फंक्शन कॉलिंग मागे हाताळतो
- मॅन्युअल टूल रूपांतरणाची गरज नाही - LangChain4j MCP टूल्सना LLM-योग्य स्वरूपात रूपांतरित करण्याचा संपूर्ण क्लिष्टपणा हाताळतो

छान, आता आपण वापरकर्त्याच्या विनंत्या हाताळण्यासाठी तयार आहोत, तर पुढे ते पाहू.
...
1. LLM कॉल करण्यासाठी खालील मेथड जोडा:
    ...
    - हा मेथड LLM प्रतिसाद घेतो आणि कोणते टूल्स कॉल झाले आहेत का ते तपासतो:
...
2. `run` मेथड अपडेट करा जेणेकरून LLM कॉल्स आणि `callTools` कॉल्स समाविष्ट होतील:
...
2. नंतर, LLM कॉल करणारा फंक्शन जोडा:
    ...
    - MCP सर्व्हरवरून मिळालेल्या आणि रूपांतरित केलेल्या फंक्शन्स LLM ला दिल्या.
    - नंतर LLM कॉल केला.
...
2. शेवटचा टप्पा, LLM ला फंक्शन कॉल करायचे आहे का ते तपासा:
...
- LangChain4j फ्रेमवर्क आपोआप हाताळतो:
  - वापरकर्त्याचे प्रॉम्प्ट्स आवश्यकतेनुसार टूल कॉलमध्ये रूपांतरित करणे
