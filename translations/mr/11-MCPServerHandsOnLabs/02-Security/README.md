...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T16:40:58+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "mr"
}
-->
# सुरक्षा आणि मल्टी-टेनन्सी

## 🎯 हे लॅब काय कव्हर करते

हे लॅब MCP सर्व्हरसाठी एंटरप्राइझ-ग्रेड सुरक्षा आणि मल्टी-टेनन्सी लागू करण्यासाठी सविस्तर मार्गदर्शन प्रदान करते. तुम्ही संवेदनशील रिटेल डेटाचे संरक्षण करणारी आणि एकाच वेळी अनेक टेनंट्ससाठी लवचिक प्रवेश पद्धती सक्षम करणारी सुरक्षित, अनुपालन प्रणाली डिझाइन करणे शिकाल.

## आढावा

ग्राहक डेटा, पेमेंट माहिती आणि व्यवसाय बुद्धिमत्ता हाताळणाऱ्या रिटेल अॅप्लिकेशन्ससाठी सुरक्षा अत्यंत महत्त्वाची आहे. हे लॅब प्रमाणीकरण आणि अधिकृततेपासून डेटा वेगळेपणा आणि अनुपालन निरीक्षणापर्यंत संपूर्ण सुरक्षा आर्किटेक्चर कव्हर करते.

आम्ही Azure ओळख सेवा, PostgreSQL Row Level Security, अॅप्लिकेशन-स्तरीय नियंत्रण आणि व्यापक ऑडिट लॉगिंग एकत्र करून एक मजबूत, अनुपालन प्लॅटफॉर्म तयार करण्यासाठी "डिफेन्स-इन-डेप्थ" रणनीती लागू करतो.

## शिकण्याची उद्दिष्टे

या लॅबच्या शेवटी, तुम्ही खालील गोष्टी करण्यात सक्षम असाल:

- **अंमलबजावणी करा**: मल्टी-टेनंट डेटा वेगळेपणासाठी एंटरप्राइझ-ग्रेड Row Level Security  
- **डिझाइन करा**: Azure सह सुरक्षित प्रमाणीकरण आणि अधिकृतता पद्धती  
- **कॉन्फिगर करा**: अनुपालन आवश्यकता पूर्ण करण्यासाठी व्यापक ऑडिट लॉगिंग  
- **लागू करा**: अॅप्लिकेशनच्या सर्व स्तरांवर डिफेन्स-इन-डेप्थ सुरक्षा रणनीती  
- **सत्यापित करा**: सुरक्षा अंमलबजावणी प्रणालीबद्ध चाचणीद्वारे  
- **निरीक्षण करा**: सुरक्षा घटना आणि संभाव्य धोके ओळखून प्रतिसाद द्या  

## 🔐 मल्टी-टेनंट सुरक्षा आर्किटेक्चर

### सुरक्षा स्तरांचा आढावा
...
### मल्टी-टेनन्सी मॉडेल्स

आमची अंमलबजावणी **Shared Database, Shared Schema** मॉडेल वापरते, ज्यामध्ये Row Level Security आहे:

**फायदे:**
- संसाधनांचा खर्च-प्रभावी वापर  
- देखभाल आणि अद्यतन सुलभ  
- RLS द्वारे मजबूत डेटा वेगळेपणा  
- अनुपालन-अनुकूल ऑडिट ट्रेल्स  

**तोटे:**
- RLS धोरण डिझाइन काळजीपूर्वक करणे आवश्यक  
- स्कीमा बदल सर्व टेनंट्सवर परिणाम करतात  
- मजबूत बॅकअप/पुनर्संचयित प्रक्रियेची आवश्यकता  

## 🛡️ Row Level Security अंमलबजावणी
...
## 🧪 सुरक्षा चाचणी आणि सत्यापन

### स्वयंचलित सुरक्षा चाचण्या
...
हे लॅब पूर्ण केल्यानंतर, तुम्ही खालील गोष्टी साध्य केल्या असतील:

✅ **मल्टी-टेनंट सुरक्षा**: पूर्ण डेटा वेगळेपणासाठी Row Level Security अंमलबजावणी  
✅ **Azure प्रमाणीकरण**: Azure Entra ID सह JWT सत्यापन एकत्रित केले  
✅ **भूमिका-आधारित अधिकृतता**: श्रेणीबद्ध भूमिका आणि परवानगी प्रणाली कॉन्फिगर केली  
✅ **विस्तृत ऑडिट लॉगिंग**: सुरक्षा घटना ट्रॅकिंग आणि निरीक्षण स्थापित केले  
✅ **सुरक्षा चाचणी**: स्वयंचलित सुरक्षा सत्यापन चाचण्या अंमलात आणल्या  
✅ **धोका निरीक्षण**: रिअल-टाइम सुरक्षा घटना शोध आणि अलर्टिंग तयार केले  

## 🚀 पुढे काय?

**[Lab 03: Environment Setup](../03-Setup/README.md)** सह पुढे जा:

- सुरक्षा सर्वोत्तम पद्धतींसह विकास वातावरण कॉन्फिगर करा  
- प्रमाणीकरण आणि निरीक्षणासाठी Azure सेवा सेट अप करा  
- सुरक्षित डेटाबेस कनेक्शन आणि गुपित व्यवस्थापन अंमलात आणा  
- विकास वातावरणातील सुरक्षा कॉन्फिगरेशन सत्यापित करा  

## 📚 अतिरिक्त संसाधने

### Azure सुरक्षा
- [Azure Entra ID Documentation](https://docs.microsoft.com/azure/active-directory/) - संपूर्ण ओळख प्लॅटफॉर्म मार्गदर्शक  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - गुपित व्यवस्थापन सेवा  
- [Azure Security Best Practices](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - सुरक्षा मार्गदर्शन  

### डेटाबेस सुरक्षा
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - अधिकृत RLS दस्तऐवज  
- [Database Security Checklist](https://www.postgresql.org/docs/current/security.html) - PostgreSQL सुरक्षा मार्गदर्शक  
- [Multi-Tenant Database Patterns](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - आर्किटेक्चर पद्धती  

### सुरक्षा चाचणी
- [OWASP Testing Guide](https://owasp.org/www-project-web-security-testing-guide/) - व्यापक सुरक्षा चाचणी  
- [JWT Security Best Practices](https://tools.ietf.org/html/rfc8725) - JWT सुरक्षा विचार  
- [API Security Testing](https://owasp.org/www-project-api-security/) - API-विशिष्ट सुरक्षा चाचणी  

---

**मागील**: [Lab 01: Core Architecture Concepts](../01-Architecture/README.md)  
**पुढील**: [Lab 03: Environment Setup](../03-Setup/README.md)  
