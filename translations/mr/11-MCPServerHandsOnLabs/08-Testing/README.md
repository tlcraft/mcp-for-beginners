...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T16:30:04+00:00",
...
ही प्रयोगशाळा उत्पादन वातावरणात MCP सर्व्हरची चाचणी आणि डीबगिंगसाठी सविस्तर मार्गदर्शन प्रदान करते. तुम्ही मजबूत चाचणी धोरणे अंमलात आणणे, जटिल समस्या डीबग करणे आणि विविध परिस्थितींमध्ये तुमचा MCP सर्व्हर विश्वासार्हपणे कार्य करतो याची खात्री करणे शिकाल.

## आढावा

MCP सर्व्हरची चाचणी करणे युनिट चाचण्या, एकत्रीकरण चाचण्या, कार्यक्षमता पडताळणी आणि वास्तविक परिस्थिती चाचणी यांचा समावेश असलेल्या बहु-स्तरीय दृष्टिकोनाची आवश्यकता आहे. ही प्रयोगशाळा विकासापासून उत्पादन निरीक्षणापर्यंत संपूर्ण चाचणी जीवनचक्र कव्हर करते.

आमचे चाचणी धोरण विश्वासार्हता, सुरक्षा आणि कार्यक्षमता यावर भर देते, जेणेकरून तुमचा MCP सर्व्हर उत्पादन कार्यभार हाताळू शकेल आणि डेटा अखंडता आणि वापरकर्ता अनुभवाची गुणवत्ता टिकवून ठेवू शकेल.

## शिकण्याची उद्दिष्टे

या प्रयोगशाळेच्या शेवटी, तुम्ही हे करू शकाल:

- **अंमलात आणणे** सविस्तर युनिट आणि एकत्रीकरण चाचणी संच  
- **डिझाइन करणे** MCP साधने आणि डेटाबेस ऑपरेशन्ससाठी प्रभावी चाचणी धोरणे  
- **डीबग करणे** प्रगत डीबगिंग तंत्रांचा वापर करून जटिल समस्या  
- **पडताळणी करणे** लोड अंतर्गत कार्यक्षमता वास्तववादी चाचणी परिस्थितींसह  
- **निरीक्षण करणे** प्रभावी अलर्टिंग आणि निरीक्षणासह उत्पादन प्रणाली  
- **स्वयंचलित करणे** सतत एकत्रीकरणासाठी चाचणी कार्यप्रवाह  
...
ही प्रयोगशाळा पूर्ण केल्यानंतर, तुमच्याकडे असावे:

✅ **सविस्तर चाचणी फ्रेमवर्क**: सर्व घटकांसाठी युनिट, एकत्रीकरण आणि कार्यक्षमता चाचण्या  
✅ **प्रगत डीबगिंग साधने**: अंमलबजावणी ट्रेसिंगसह प्रगत डीबगिंग उपयोगिता  
✅ **कार्यक्षमता पडताळणी**: लोड चाचणी आणि स्केलेबिलिटी विश्लेषण क्षमता  
✅ **सुरक्षा चाचणी**: SQL इंजेक्शन प्रतिबंध आणि RLS पडताळणी  
✅ **निरीक्षण एकत्रीकरण**: कार्यक्षमता मेट्रिक्स आणि अडथळ्यांचे विश्लेषण  
✅ **CI/CD तयार**: सतत एकत्रीकरणासाठी स्वयंचलित चाचणी कार्यप्रवाह  

## 🚀 पुढे काय?

**[प्रयोगशाळा 09: VS कोड एकत्रीकरण](../09-VS-Code/README.md)** सह सुरू ठेवा:

- MCP सर्व्हर विकासासाठी VS कोड कॉन्फिगर करा  
- VS कोडमध्ये डीबगिंग वातावरण सेट करा  
- MCP सर्व्हरला VS कोड चॅटसह एकत्रित करा  
- संपूर्ण VS कोड कार्यप्रवाहाची चाचणी करा  

## 📚 अतिरिक्त संसाधने

### चाचणी फ्रेमवर्क
- [pytest दस्तऐवजीकरण](https://docs.pytest.org/) - Python चाचणी फ्रेमवर्क  
- [AsyncPG चाचणी](https://magicstack.github.io/asyncpg/current/index.html) - Async PostgreSQL चाचणी  
- [FastAPI चाचणी](https://fastapi.tiangolo.com/tutorial/testing/) - API चाचणी नमुने  

### कार्यक्षमता चाचणी
- [लोड चाचणी सर्वोत्तम पद्धती](https://docs.python.org/3/library/asyncio.html) - Async कार्यक्षमता चाचणी  
- [डेटाबेस कार्यक्षमता चाचणी](https://www.postgresql.org/docs/current/performance-tips.html) - PostgreSQL ऑप्टिमायझेशन  
- [मेमरी प्रोफाइलिंग](https://docs.python.org/3/library/tracemalloc.html) - Python मेमरी विश्लेषण  

### डीबगिंग साधने
- [Python डीबगिंग](https://docs.python.org/3/library/pdb.html) - Python डीबगर  
- [Async डीबगिंग](https://docs.python.org/3/library/asyncio-dev.html) - Asyncio डीबगिंग  
- [SQL डीबगिंग](https://www.postgresql.org/docs/current/runtime-config-logging.html) - PostgreSQL लॉगिंग  

---

**मागील**: [प्रयोगशाळा 07: सेमॅंटिक शोध एकत्रीकरण](../07-Semantic-Search/README.md)  
**पुढील**: [प्रयोगशाळा 09: VS कोड एकत्रीकरण](../09-VS-Code/README.md)  
