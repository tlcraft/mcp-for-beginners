...
-->
# डेटाबेस डिझाइन आणि स्कीमा

## 🎯 या प्रयोगशाळेत काय शिकाल

ही प्रयोगशाळा Zava Retail प्रणालीसाठी PostgreSQL डेटाबेस डिझाइनवर सखोल प्रकाश टाकते. तुम्ही व्हेक्टर शोध क्षमता, मल्टी-टेनंट डेटा मॉडेलिंग आणि डेटा वेगळ्या ठेवण्यासाठी Row Level Security (RLS) सह एक व्यापक रिटेल स्कीमा कशी अंमलात आणायची ते शिकाल.

## आढावा

आमचा डेटाबेस MCP सर्व्हरचा पाया आहे, जो अनेक स्टोअरमधील रिटेल डेटा संग्रहित करतो आणि कठोर डेटा वेगळ्या ठेवण्याची खात्री करतो. आम्ही PostgreSQL सह pgvector विस्तार वापरतो ज्यामुळे ग्राहकांना नैसर्गिक भाषेतील क्वेरी वापरून उत्पादने शोधता येतात.

आमची स्कीमा आधुनिक मल्टी-टेनंट पद्धतींचे अनुसरण करते, ज्यामध्ये Row Level Security वापरून वापरकर्त्यांना त्यांच्या अधिकृत स्टोअरमधील डेटा पाहण्याची परवानगी दिली जाते. हा दृष्टिकोन एंटरप्राइझ-ग्रेड सुरक्षा प्रदान करतो आणि कार्यक्षमतेत कोणतीही तडजोड करत नाही.

## शिकण्याची उद्दिष्टे

या प्रयोगशाळेच्या शेवटी, तुम्ही खालील गोष्टी करण्यात सक्षम असाल:

- **डिझाइन**: स्केलेबल मल्टी-टेनंट रिटेल डेटाबेस स्कीमा तयार करणे  
- **अंमलबजावणी**: PostgreSQL सह pgvector वापरून व्हेक्टर शोध अंमलात आणणे  
- **कॉन्फिगर**: डेटा वेगळ्या ठेवण्यासाठी Row Level Security सेट करणे  
- **निर्मिती**: चाचणीसाठी वास्तववादी नमुना डेटा तयार करणे  
- **ऑप्टिमाइझ**: रिटेल वर्कलोडसाठी डेटाबेस कार्यक्षमता सुधारणे  
- **अंमलबजावणी**: बॅकअप आणि पुनर्प्राप्ती धोरणे तयार करणे  

## 🗃️ डेटाबेस आर्किटेक्चर

### PostgreSQL सह pgvector

आमचा डेटाबेस PostgreSQL च्या एंटरप्राइझ वैशिष्ट्यांसह pgvector विस्ताराचा वापर करून AI-सक्षम शोधासाठी तयार केला आहे:
...
डेटाबेस **सामायिक डेटाबेस, सामायिक स्कीमा** मल्टी-टेनन्सी मॉडेल वापरतो, ज्यामध्ये Row Level Security आहे:
...
## 🔍 व्हेक्टर शोध अंमलबजावणी

### उत्पादन एम्बेडिंग्स टेबल
...
### वास्तववादी चाचणी डेटा स्क्रिप्ट
...
✅ **मल्टी-टेनंट डेटाबेस डिझाइन**: सुरक्षित डेटा वेगळ्या ठेवण्यासाठी Row Level Security अंमलात आणले  
✅ **व्हेक्टर शोध क्षमता**: उत्पादन शोधासाठी pgvector कॉन्फिगर केले  
✅ **व्यापक स्कीमा**: उत्पादन-तयार रिटेल डेटाबेस स्कीमा तयार केली  
✅ **नमुना डेटा निर्मिती**: विकास आणि चाचणीसाठी वास्तववादी डेटा तयार केला  
✅ **कार्यक्षमता सुधारणा**: इंडेक्स आणि क्वेरी ऑप्टिमायझेशन कॉन्फिगर केले  
✅ **बॅकअप आणि पुनर्प्राप्ती**: मजबूत डेटा संरक्षण धोरणे स्थापित केली  

## 🚀 पुढे काय?

**[Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)** सह पुढे जा:

- या डेटाबेसशी जोडणारा FastMCP सर्व्हर तयार करा  
- MCP प्रोटोकॉलसाठी डेटाबेस क्वेरी टूल्स अंमलात आणा  
- एम्बेडिंग्स वापरून सेमॅंटिक शोध क्षमता जोडा  
- कनेक्शन पूलिंग आणि त्रुटी हाताळणी कॉन्फिगर करा  

## 📚 अतिरिक्त संसाधने

### PostgreSQL & pgvector
- [PostgreSQL Documentation](https://www.postgresql.org/docs/) - संपूर्ण PostgreSQL संदर्भ  
- [pgvector Extension](https://github.com/pgvector/pgvector) - PostgreSQL साठी व्हेक्टर समानता शोध  
- [PostgreSQL Performance Tuning](https://wiki.postgresql.org/wiki/Performance_Optimization) - ऑप्टिमायझेशनसाठी सर्वोत्तम पद्धती  

### मल्टी-टेनंट आर्किटेक्चर
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS दस्तऐवज  
- [Multi-Tenant Data Architecture](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure आर्किटेक्चर पद्धती  
- [Database Security Best Practices](https://www.postgresql.org/docs/current/security.html) - PostgreSQL सुरक्षा मार्गदर्शक  

### व्हेक्टर डेटाबेस
- [Vector Search Fundamentals](https://www.pinecone.io/learn/vector-database/) - व्हेक्टर डेटाबेस समजून घेणे  
- [Embedding Models](https://platform.openai.com/docs/guides/embeddings) - OpenAI एम्बेडिंग्स दस्तऐवज  
- [HNSW Algorithm](https://arxiv.org/abs/1603.09320) - हायरार्किकल नेव्हिगेबल स्मॉल वर्ल्ड ग्राफ्स  

---

**मागील**: [Lab 03: Environment Setup](../03-Setup/README.md)  
**पुढील**: [Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)  
