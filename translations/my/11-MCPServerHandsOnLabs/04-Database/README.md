...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:34:09+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "my"
}
-->
# ဒေတာဘေစ့်ဒီဇိုင်းနှင့် Schema

## 🎯 ဒီလက်တွေ့လေ့ကျင့်ခန်းမှာ ဘာတွေပါဝင်သလဲ

ဒီလက်တွေ့လေ့ကျင့်ခန်းမှာ Zava Retail စနစ်အတွက် PostgreSQL ဒေတာဘေစ့်ဒီဇိုင်းကို အနက်ရှိုင်းဆုံးလေ့လာပါမည်။ သင်သည် vector ရှာဖွေမှုစွမ်းရည်များ၊ multi-tenant ဒေတာမော်ဒယ်တစ်ခုနှင့် ဒေတာခွဲခြားမှုအတွက် Row Level Security (RLS) ပါဝင်သော retail schema တစ်ခုကို အကောင်အထည်ဖော်နိုင်မည်ဖြစ်သည်။

## အကျဉ်းချုပ်

ဒေတာဘေစ့်သည် MCP server ၏ အခြေခံအဆောက်အအုံဖြစ်ပြီး၊ စတိုးဆိုင်များစွာ၏ retail ဒေတာကို သိမ်းဆည်းထားပြီး ဒေတာခွဲခြားမှုကို တင်းကြပ်စွာထိန်းသိမ်းထားသည်။ PostgreSQL ကို pgvector extension ဖြင့် အသုံးပြုပြီး semantic ရှာဖွေမှုစွမ်းရည်များကို ပေးစွမ်းသည်။ ၎င်းသည် သုံးစွဲသူများကို သဘာဝဘာသာစကားမေးခွန်းများဖြင့် ထုတ်ကုန်များကို ရှာဖွေစေသည်။

ကျွန်ုပ်တို့၏ schema သည် Row Level Security ဖြင့် အသုံးပြုသူများသည် ၎င်းတို့၏ အတည်ပြုထားသော စတိုးဆိုင်များမှသာ ဒေတာကို ဝင်ရောက်ကြည့်ရှုနိုင်စေရန် အခေတ်မီ multi-tenant ပုံစံများကို လိုက်နာသည်။ ဒီနည်းလမ်းသည် လုပ်ငန်းအဆင့်လုံခြုံရေးကို ပေးစွမ်းသည့်အပြင် အကောင်းဆုံးစွမ်းဆောင်ရည်ကိုလည်း ထိန်းသိမ်းပေးသည်။

## သင်ယူရမည့်ရည်မှန်းချက်များ

ဒီလက်တွေ့လေ့ကျင့်ခန်းပြီးဆုံးချိန်တွင် သင်သည် အောက်ပါအရာများကို လုပ်နိုင်မည်ဖြစ်သည်-

- **ဒီဇိုင်း**: စွမ်းဆောင်ရည်မြင့် multi-tenant retail ဒေတာဘေစ့် schema များ
- **အကောင်အထည်ဖော်**: PostgreSQL ကို pgvector ဖြင့် vector ရှာဖွေမှုအတွက် အသုံးပြုခြင်း
- **ဖွဲ့စည်း**: Row Level Security ကို ဒေတာခွဲခြားမှုအတွက် ဖွဲ့စည်းခြင်း
- **ထုတ်လုပ်**: စမ်းသပ်ရန်အတွက် အမှန်တကယ် sample data များ
- **အကောင်းဆုံးစွမ်းဆောင်ရည်**: retail workload များအတွက် ဒေတာဘေစ့်စွမ်းဆောင်ရည်ကို အကောင်းဆုံးဖြစ်စေရန်
- **Backup နှင့် Recovery**: ဒေတာကို ပြန်လည်ရယူနိုင်ရေးနည်းလမ်းများ

## 🗃️ ဒေတာဘေစ့်အဆောက်အအုံ

### PostgreSQL နှင့် pgvector

ကျွန်ုပ်တို့၏ဒေတာဘေစ့်သည် PostgreSQL ၏ လုပ်ငန်းအဆင့် features များနှင့် pgvector extension ကို ပေါင်းစပ်အသုံးပြုထားသည်-
...
ဒေတာဘေစ့်သည် **shared database, shared schema** multi-tenancy ပုံစံကို Row Level Security ဖြင့် အသုံးပြုထားသည်-
...
## 🔍 Vector ရှာဖွေမှုအကောင်အထည်ဖော်ခြင်း
...
## 🔐 Row Level Security ဖွဲ့စည်းခြင်း

### ဒေတာဘေစ့် Roles နှင့် Permissions
...
## 📊 Sample Data ထုတ်လုပ်ခြင်း

### အမှန်တကယ် Sample Data Script
...
ဒီလက်တွေ့လေ့ကျင့်ခန်းပြီးဆုံးချိန်တွင် သင်သည်-

✅ **Multi-Tenant Database Design**: ဒေတာခွဲခြားမှုအတွက် Row Level Security ကို အကောင်အထည်ဖော်ထားသည်  
✅ **Vector Search Capabilities**: semantic ထုတ်ကုန်ရှာဖွေမှုအတွက် pgvector ကို ဖွဲ့စည်းထားသည်  
✅ **Comprehensive Schema**: ထုတ်လုပ်မှုအဆင့် retail ဒေတာဘေစ့် schema ကို ဖန်တီးထားသည်  
✅ **Sample Data Generation**: ဖွံ့ဖြိုးတိုးတက်မှုနှင့် စမ်းသပ်မှုအတွက် အမှန်တကယ် sample data ကို ဖန်တီးထားသည်  
✅ **Performance Optimization**: indexes နှင့် query optimization ကို ဖွဲ့စည်းထားသည်  
✅ **Backup နှင့် Recovery**: ဒေတာကို ကာကွယ်ရန် strategy များကို ဖွဲ့စည်းထားသည်  

## 🚀 နောက်တစ်ခု

**[Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)** ကို ဆက်လက်လုပ်ဆောင်ပါ-

- ဒီဒေတာဘေစ့်နှင့် ချိတ်ဆက်ထားသော FastMCP server ကို တည်ဆောက်ပါ
- MCP protocol အတွက် ဒေတာဘေစ့် query tools များကို အကောင်အထည်ဖော်ပါ
- embeddings ကို အသုံးပြု၍ semantic ရှာဖွေမှုစွမ်းရည်များကို ထည့်သွင်းပါ
- connection pooling နှင့် error handling ကို ဖွဲ့စည်းပါ

## 📚 အပိုဆောင်းအရင်းအမြစ်များ

### PostgreSQL & pgvector
- [PostgreSQL Documentation](https://www.postgresql.org/docs/) - PostgreSQL အပြည့်အစုံကို ရှာဖွေပါ
- [pgvector Extension](https://github.com/pgvector/pgvector) - PostgreSQL အတွက် vector similarity ရှာဖွေမှု
- [PostgreSQL Performance Tuning](https://wiki.postgresql.org/wiki/Performance_Optimization) - စွမ်းဆောင်ရည်မြှင့်တင်ရေးအကောင်းဆုံးနည်းလမ်းများ
...
- [Database Security Best Practices](https://www.postgresql.org/docs/current/security.html) - PostgreSQL လုံခြုံရေးလမ်းညွှန်

### Vector Databases
- [Vector Search Fundamentals](https://www.pinecone.io/learn/vector-database/) - vector databases ကို နားလည်ခြင်း
...
**အကြောင်းကြားချက်**:  
ဤစာရွက်စာတမ်းကို AI ဘာသာပြန်ဝန်ဆောင်မှု [Co-op Translator](https://github.com/Azure/co-op-translator) ကို အသုံးပြု၍ ဘာသာပြန်ထားပါသည်။ ကျွန်ုပ်တို့သည် တိကျမှုအတွက် ကြိုးစားနေသော်လည်း အလိုအလျောက် ဘာသာပြန်ခြင်းတွင် အမှားများ သို့မဟုတ် မမှန်ကန်မှုများ ပါဝင်နိုင်သည်ကို သတိပြုပါ။ မူရင်းစာရွက်စာတမ်းကို ၎င်း၏ မူလဘာသာစကားဖြင့် အာဏာတရားရှိသော အရင်းအမြစ်အဖြစ် ရှုလို့ရပါသည်။ အရေးကြီးသော အချက်အလက်များအတွက် လူက ဘာသာပြန်ခြင်းကို အကြံပြုပါသည်။ ဤဘာသာပြန်ကို အသုံးပြုခြင်းမှ ဖြစ်ပေါ်လာသော အလွဲသုံးစားမှု သို့မဟုတ် အနားလွဲမှုများအတွက် ကျွန်ုပ်တို့သည် တာဝန်မယူပါ။