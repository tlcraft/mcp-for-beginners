...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:02:40+00:00",
...
## 🎯 ဒီလက်တွေ့လေ့လာရေးမှာ ပါဝင်သောအရာများ

ဒီလက်တွေ့လေ့လာရေးမှာ FastMCP framework ကို အသုံးပြုပြီး ထုတ်လုပ်မှုအဆင့် MCP server တစ်ခုကို အကောင်အထည်ဖော်ရန် လမ်းညွှန်ပေးပါမည်။ သင်သည် server အခြေခံဖွဲ့စည်းမှုကို တည်ဆောက်ခြင်း၊ database integration ကို အကောင်အထည်ဖော်ခြင်း၊ ဒေတာရယူရန် tools ဖန်တီးခြင်းနှင့် AI-powered retail analytics အတွက် အခြေခံအုတ်မြစ်ကို တည်ဆောက်ခြင်းတို့ကို လေ့လာရမည်ဖြစ်သည်။

## အကျဉ်းချုပ်

MCP server သည် ကျွန်ုပ်တို့၏ retail analytics ဖြေရှင်းနည်း၏ အဓိကအချက်ဖြစ်သည်။ AI assistant များနှင့် PostgreSQL database အကြား တည်ငြိမ်သော၊ စိတ်ချရသော အချက်အလက်များကို စံသတ်မှတ် protocol ဖြင့် ရယူနိုင်ရန် တံတားအဖြစ် လုပ်ဆောင်ပေးသည်။

ဒီလက်တွေ့လေ့လာရေးသည် စီးပွားရေးလုပ်ငန်းများအတွက် အကောင်းဆုံးနည်းလမ်းများနှင့် ပုံစံများကို လိုက်နာပြီး တည်ငြိမ်သော၊ အဆင့်မြင့် MCP server တစ်ခုကို တည်ဆောက်ရန် သင်ကြားပေးသည်။

## လေ့လာရေးရည်မှန်းချက်များ

ဒီလက်တွေ့လေ့လာရေးအဆုံးတွင် သင်သည် အောက်ပါအရာများကို လုပ်ဆောင်နိုင်မည်ဖြစ်သည်-

- **တည်ဆောက်ခြင်း**: FastMCP server ကို သင့်လျော်သော architecture နှင့် organization ဖြင့် တည်ဆောက်ခြင်း  
- **အကောင်အထည်ဖော်ခြင်း**: connection pooling နှင့် error handling ပါဝင်သော database integration  
- **ဖန်တီးခြင်း**: database schema introspection နှင့် query execution အတွက် MCP tools  
- **ချိန်ညှိခြင်း**: Row Level Security context management  
- **ထည့်သွင်းခြင်း**: health monitoring နှင့် observability features  
- **စမ်းသပ်ခြင်း**: MCP server implementation ကို locally နှင့် VS Code ဖြင့် စမ်းသပ်ခြင်း  

## 📁 Project ဖွဲ့စည်းမှု

MCP server organization ကို ကြည့်ရှုကြမည်-
...
ပထမဦးဆုံး Robust configuration system တစ်ခုကို ဖန်တီးကြမည်-
...
- **Environment Variable Loading**: .env ဖိုင်ကို အလိုအလျောက် support ပြုလုပ်ခြင်း  
- **Type Safety**: Dataclass validation နှင့် type hints  
- **Flexible Defaults**: Development အတွက် သင့်လျော်သော defaults  
- **Validation**: Configuration validation နှင့် error messages  
- **Security**: Sensitive values ကို environment variables မှသာ ရယူခြင်း  

## 🗄️ Database Integration Layer

### PostgreSQL Provider (`sales_analysis_postgres.py`)

Database integration layer ကို အကောင်အထည်ဖော်ကြမည်-
...
- **Connection Pooling**: asyncpg ဖြင့် resource management ကို ထိရောက်စွာ ပြုလုပ်ခြင်း  
- **RLS Integration**: Row Level Security context ကို အလိုအလျောက်ချိန်ညှိခြင်း  
- **Schema Introspection**: Dynamic table schema ရှာဖွေခြင်း  
- **Error Handling**: Error management နှင့် logging  
- **Query Formatting**: AI-friendly result formatting  
- **Health Monitoring**: Database connectivity နှင့် pool status စစ်ဆေးခြင်း  

## 🔧 Main MCP Server Implementation

### FastMCP Server (`sales_analysis.py`)

အခု MCP server ကို အကောင်အထည်ဖော်ကြမည်-
...
- **Tool Registration**: Type safety ပါဝင်သော declarative tool definitions  
- **RLS Context Management**: User identity extraction နှင့် context setting  
- **Error Handling**: User-friendly messages ပါဝင်သော error management  
- **Lifecycle Management**: Startup/shutdown နှင့် resource cleanup  
- **Health Monitoring**: Health check endpoints  
- **Development Support**: Hot reload နှင့် debugging capabilities  
...
## 🧪 MCP Server ကို စမ်းသပ်ခြင်း

### Local Testing

1. **MCP Server ကို စတင်ရန်**:
   ```bash
...
2. **Health Endpoints ကို စမ်းသပ်ရန်**:
   ```bash
   # Basic health check
...
2. **AI Chat တွင် စမ်းသပ်ရန်**:
   - VS Code AI Chat ကို ဖွင့်ပါ  
   - `#zava` ကို ရိုက်ထည့်ပြီး သင့် server ကို ရွေးပါ  
   - မေးပါ: "What tables are available?"  
   - မေးပါ: "Show me the top 5 stores by number of orders"  

### Unit Testing

Comprehensive unit tests ဖန်တီးပါ:
...
ဒီလက်တွေ့လေ့လာရေးကို ပြီးဆုံးပြီးနောက် သင်သည်-

✅ **လုပ်ဆောင်နိုင်သော MCP Server**: Database integration ပါဝင်သော FastMCP server  
✅ **Configuration Management**: Environment-based configuration  
✅ **Database Layer**: Connection pooling ပါဝင်သော PostgreSQL integration  
✅ **MCP Tools**: Schema introspection နှင့် query execution tools  
✅ **RLS Integration**: Row Level Security context management  
✅ **Health Monitoring**: Health check endpoints  
✅ **Testing Strategy**: Local testing နှင့် VS Code integration  

## 🚀 အခုနောက်တစ်ဆင့်

**[Lab 06: Tool Development](../06-Tools/README.md)** ကို ဆက်လက်လုပ်ဆောင်ပါ-

- MCP tool collection ကို တိုးချဲ့ပါ  
- အဆင့်မြင့် query patterns ကို အကောင်အထည်ဖော်ပါ  
- Data validation နှင့် transformation ကို ထည့်သွင်းပါ  
- အထူး analytics tools ကို ဖန်တီးပါ  

## 📚 အပိုဆောင်းအရင်းအမြစ်များ

### FastMCP Framework
- [FastMCP Documentation](https://github.com/modelcontextprotocol/python-sdk) - FastMCP အတိအကျလမ်းညွှန်  
- [MCP Specification](https://modelcontextprotocol.io/docs/) - Protocol specification  
- [Tool Development Guide](https://modelcontextprotocol.io/docs/tools/) - MCP tools ဖန်တီးခြင်း  
...
**Next**: Tools ကို တိုးချဲ့ရန် **[Lab 06: Tool Development](../06-Tools/README.md)** ကို ဆက်လက်လုပ်ဆောင်ပါ
