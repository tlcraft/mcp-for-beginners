...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-23T14:32:05+00:00",
...
- **01. Kärnkoncept förklarade**  
  Djupdykning i MCP:s grundläggande begrepp. [Läs mer](./01-CoreConcepts/README.md)
- **02. Säkerhet i MCP**  
  Säkerhetshot och bästa metoder. [Läs mer](./02-Security/README.md)
...
- En visuell kurskarta som visar alla behandlade ämnen  
...
en CLA och märka PR på rätt sätt (t.ex. statuskontroll, kommentar). Följ bara instruktionerna  
...
All användning av tredje parts varumärken eller logotyper måste följa dessa tredjeparts policyer.
