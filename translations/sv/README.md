...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-23T06:47:59+00:00",
...
| 3.1 | **Första servern** | Sätta upp en enkel server med MCP-protokollet, förstå server-klient-interaktionen och testa servern | [First Server](./03-GettingStarted/01-first-server/README.md) |
| 3.2 | **Första klienten**  | Sätta upp en enkel klient med MCP-protokollet, förstå klient-server-interaktionen och testa klienten | [First Client](./03-GettingStarted/02-client/README.md) |
...
| 3.4 | **Använda en server med Visual Studio Code** | Ställa in Visual Studio Code för att konsumera servrar med MCP-protokollet | [Consuming a server with Visual Studio Code](./03-GettingStarted/04-vscode/README.md) |
...
| 04 | **Praktisk implementation** | Använda SDK:er på olika språk, felsökning, testning och validering, skapa återanvändbara promptmallar och arbetsflöden | [Practical Implementation](./04-PracticalImplementation/README.md) |
...
| 06 | **Communitybidrag** | Hur man bidrar med kod och dokumentation, samarbeta via GitHub, community-drivna förbättringar och feedback | [Community Contributions](./06-CommunityContributions/README.md) |
...
| 08 | **Bästa praxis för MCP** | Prestandaoptimering och finjustering, design av felfria MCP-system, testning och robusthetsstrategier | [Best Practices](./08-BestPractices/README.md) |
| 09 | **MCP fallstudier** | Djupdykningar i MCP-lösningsarkitekturer, distributionsplaner och integrationsråd, annoterade diagram och projektdemonstrationer | [Case Studies](./09-CaseStudy/README.md) |
...
Detta projekt välkomnar bidrag och förslag. De flesta bidrag kräver att du godkänner ett Contributor License Agreement (CLA) som intygar att du har rätt att, och faktiskt gör, ge oss rättigheterna att använda ditt bidrag. För detaljer, besök <https://cla.opensource.microsoft.com>.
