...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T18:30:13+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "sv"
}
-->
# Databasedesign och Schema

## 🎯 Vad Denna Labb Täcker

Denna labb går på djupet i PostgreSQL-databasedesignen för Zava Retail-systemet. Du kommer att lära dig att implementera ett omfattande detaljhandelsschema med vektorsökningsfunktioner, multi-tenant datamodellering och Row Level Security (RLS) för dataisolering.

## Översikt

Databasen är grunden för vår MCP-server och lagrar detaljhandelsdata från flera butiker samtidigt som strikt dataisolering upprätthålls. Vi använder PostgreSQL med pgvector-tillägget för att möjliggöra semantiska sökfunktioner, vilket gör det möjligt för kunder att hitta produkter med naturliga språkfrågor.

Vårt schema följer moderna multi-tenant-mönster med Row Level Security som säkerställer att användare endast kan komma åt data från sina auktoriserade butiker. Denna metod ger säkerhet på företagsnivå samtidigt som optimal prestanda bibehålls.

## Lärandemål

Efter denna labb kommer du att kunna:

- **Designa** skalbara multi-tenant detaljhandelsscheman  
- **Implementera** PostgreSQL med pgvector för vektorsökning  
- **Konfigurera** Row Level Security för dataisolering  
- **Generera** realistiska testdata för testning  
- **Optimera** databasprestanda för detaljhandelsbelastningar  
- **Implementera** strategier för säkerhetskopiering och återställning  

## 🗃️ Databasarkitektur

### PostgreSQL med pgvector

Vår databas utnyttjar PostgreSQL:s företagsfunktioner kombinerat med pgvector-tillägget för AI-drivna sökningar:
...
Databasen använder en **delad databas, delat schema** multi-tenant-modell med Row Level Security:
...
### Products-tabell med kategorier
...
## 🔍 Implementering av Vektorsökning

### Produktembeddingstabell
...
## 🔐 Row Level Security-inställning

### Databasroller och behörigheter
...
### Script för realistiska testdata
...
✅ **Multi-Tenant Databasedesign**: Implementerat Row Level Security för säker dataisolering  
✅ **Vektorsökningsfunktioner**: Konfigurerat pgvector för semantisk produktsökning  
✅ **Omfattande Schema**: Skapat produktionsklart detaljhandelsschema  
✅ **Generering av Testdata**: Byggt realistiska testdata för utveckling och testning  
✅ **Prestandaoptimering**: Konfigurerat index och frågeoptimering  
✅ **Säkerhetskopiering och Återställning**: Etablerat robusta strategier för dataskydd  

## 🚀 Vad Nästa Steg Är

Fortsätt med **[Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)** för att:

- Bygga FastMCP-servern som ansluter till denna databas  
- Implementera databasfrågeverktyg för MCP-protokollet  
- Lägga till semantiska sökfunktioner med embeddings  
- Konfigurera anslutningspoolning och felhantering  

## 📚 Ytterligare Resurser

### PostgreSQL & pgvector
- [PostgreSQL Dokumentation](https://www.postgresql.org/docs/) - Komplett PostgreSQL-referens  
- [pgvector-tillägg](https://github.com/pgvector/pgvector) - Vektorsimilaritetssökning för PostgreSQL  
- [PostgreSQL Prestandaoptimering](https://wiki.postgresql.org/wiki/Performance_Optimization) - Optimeringsbästa praxis  

### Multi-Tenant Arkitektur
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS-dokumentation  
- [Multi-Tenant Dataarkitektur](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure arkitekturmönster  
- [Databassäkerhet Bästa Praxis](https://www.postgresql.org/docs/current/security.html) - PostgreSQL säkerhetsguide  

### Vektordatabaser
- [Grunderna i Vektorsökning](https://www.pinecone.io/learn/vector-database/) - Förstå vektordatabaser  
- [Embedding-modeller](https://platform.openai.com/docs/guides/embeddings) - OpenAI embeddings-dokumentation  
- [HNSW-algoritmen](https://arxiv.org/abs/1603.09320) - Hierarchical Navigable Small World-grafer  

---

**Föregående**: [Lab 03: Miljöinställning](../03-Setup/README.md)  
**Nästa**: [Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)  
