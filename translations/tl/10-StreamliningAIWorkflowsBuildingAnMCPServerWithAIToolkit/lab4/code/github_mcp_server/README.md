...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-10T07:16:09+00:00",
...
Ito ay isang halimbawa ng MCP Server sa Python na nagpapatupad ng mga weather tools gamit ang mga mock na sagot. Maaari itong gamitin bilang pundasyon para sa iyong sariling MCP Server. Kasama nito ang mga sumusunod na tampok:
...
> **Mga Kinakailangan**
>
> Para mapatakbo ang MCP Server sa iyong lokal na dev machine, kakailanganin mo ang mga sumusunod:
>
...
> - (*Opsyonal - kung gusto mo ang uv*) [uv](https://github.com/astral-sh/uv)
...
> Tandaan: I-reload ang VSCode o terminal para matiyak na ang python mula sa virtual environment ang gagamitin pagkatapos gawin ang virtual environment.
...
Pagkatapos ma-setup ang kapaligiran, maaari mong patakbuhin ang server sa iyong lokal na dev machine gamit ang Agent Builder bilang MCP Client para makapagsimula:
...
| ------------ | -------------------------------------------- |
| `.vscode`    | Mga VSCode files para sa debugging                   |
...
> Mga Tala:
> - Ang [MCP Inspector](https://github.com/modelcontextprotocol/inspector) ay isang visual na developer tool para sa testing at debugging ng MCP servers.
...
### Weather Tool
Ang `get_weather` tool ay nagbibigay ng mock na impormasyon tungkol sa panahon para sa isang tinukoy na lokasyon.

| Parameter | Uri | Paglalarawan |
| --------- | ---- | ----------- |
| `location` | string | Lokasyon na gustong kunan ng impormasyon tungkol sa panahon (hal. pangalan ng lungsod, estado, o coordinates) |
...
- `success`: Boolean na nagsasaad kung matagumpay ang operasyon
- `target_folder` o `error`: Ang path ng na-clone na repository o isang mensahe ng error
...
Ang tool ay nagbabalik ng JSON object na may:
- `success`: Boolean na nagsasaad kung matagumpay ang operasyon
- `message` o `error`: Isang kumpirmasyon na mensahe o isang mensahe ng error
...
Kung mayroon kang anumang feedback o suhestiyon para sa template na ito, mangyaring magbukas ng isyu sa [AI Toolkit GitHub repository](https://github.com/microsoft/vscode-ai-toolkit/issues)

**Paalala**:  
Ang dokumentong ito ay isinalin gamit ang AI translation service na [Co-op Translator](https://github.com/Azure/co-op-translator). Bagama't nagsusumikap kami para sa katumpakan, pakatandaan na ang awtomatikong pagsasalin ay maaaring maglaman ng mga pagkakamali o di-tumpak na impormasyon. Ang orihinal na dokumento sa orihinal nitong wika ang dapat ituring na pinagmulan ng tama at opisyal. Para sa mahahalagang impormasyon, inirerekomenda ang propesyonal na pagsasalin ng tao. Hindi kami mananagot sa anumang hindi pagkakaunawaan o maling interpretasyon na nagmula sa paggamit ng pagsasaling ito.