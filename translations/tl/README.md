...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T18:07:29+00:00",
...
Ang **Model Context Protocol (MCP)** ay isang makabagong framework na idinisenyo upang gawing standard ang interaksyon sa pagitan ng mga AI model at client application. Ang open-source na kurikulum na ito ay nag-aalok ng maayos na landas sa pag-aaral, na may kasamang mga praktikal na halimbawa ng coding at mga tunay na kaso ng paggamit, sa mga sikat na programming language tulad ng C#, Java, JavaScript, TypeScript, at Python.
...
- 📜 [Original MCP Specification](https://spec.modelcontextprotocol.io/) – Legacy na teknikal na mga reference (maaaring may karagdagang detalye)  
...
- 🌐 [MCP Community](https://github.com/orgs/modelcontextprotocol/discussions) – Sumali sa mga diskusyon at mag-ambag sa komunidad
 ...
 ### ➡️Panoorin On-Demand - MCP Dev Days
Maghanda para sa dalawang araw ng malalim na teknikal na insight, koneksyon sa komunidad, at hands-on na pag-aaral sa MCP Dev Days, isang virtual na event na nakatuon sa Model Context Protocol (MCP) — ang umuusbong na standard na nag-uugnay sa mga AI model at mga tool na kanilang ginagamit.
...
Nakatuon sa pagbibigay kapangyarihan sa mga developer na gamitin ang MCP sa kanilang workflow bilang developer at sa pagdiriwang ng kamangha-manghang komunidad ng MCP. Makakasama ang mga miyembro ng komunidad at mga partner tulad ng Arcade, Block, Okta, at Neon upang makita kung paano sila nakikipagtulungan sa Microsoft upang hubugin ang isang bukas at extensible na ecosystem ng MCP. 
Mga demo sa totoong mundo gamit ang VS Code, Visual Studio, GitHub Copilot, at mga sikat na tool ng komunidad
Praktikal, context-driven na mga workflow ng developer
Mga sesyon na pinangungunahan ng komunidad at mga insight
Kung ikaw ay nagsisimula pa lang sa MCP o gumagawa na gamit ito, ang Araw 1 ay magbibigay ng inspirasyon at mga actionable na takeaway.

#### Araw 2: Gumawa ng MCP Servers nang may Kumpiyansa

Para sa mga tagabuo ng MCP. Magbibigay ito ng malalim na mga estratehiya sa implementasyon at pinakamahusay na mga kasanayan para sa paggawa ng MCP servers at pag-integrate ng MCP sa iyong mga workflow ng AI.

### Mga Paksa:

- Pagbuo ng MCP Servers at pag-integrate ng mga ito sa agent experiences
...
| 01 | Paliwanag sa Core Concepts | Malalim na pagtalakay sa mga pangunahing konsepto ng MCP | [Basahin pa](./01-CoreConcepts/README.md) |
| 02 | Seguridad sa MCP | Mga banta sa seguridad at pinakamahusay na mga kasanayan | [Basahin pa](./02-Security/README.md) |
| 03 | Pagsisimula sa MCP | Setup ng environment, mga pangunahing server/client, integration | [Basahin pa](./03-GettingStarted/README.md) |
...
| 3.2 | Unang Client | Bumuo ng isang basic na MCP client | [Gabay](./03-GettingStarted/02-client/README.md) |
| 3.3 | Client na may LLM | Mag-integrate ng large language models | [Gabay](./03-GettingStarted/03-llm-client/README.md) |
| 3.4 | VS Code Integration | Gamitin ang MCP servers sa VS Code | [Gabay](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | SSE Server | Gumawa ng mga server gamit ang Server-Sent Events | [Gabay](./03-GettingStarted/05-sse-server/README.md) |
...
| 5.1 | Azure Integration | MCP Integration sa Azure | [Gabay](./05-AdvancedTopics/mcp-integration/README.md) |
...
| 5.13 | Foundry Integration | Mag-integrate sa Azure AI Foundry | [Gabay](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
...
| **Module 6-10: Komunidad at Pinakamahusay na Mga Kasanayan** | | | |
| 06 | Mga Ambag ng Komunidad | Paano mag-ambag sa MCP ecosystem | [Guide](./06-CommunityContributions/README.md) |
| 07 | Mga Aral mula sa Maagang Paggamit | Mga kwento ng aktwal na implementasyon | [Guide](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | Mga Pinakamahusay na Praktika para sa MCP | Pagganap, fault-tolerance, resilience | [Guide](./08-BestPractices/README.md) |
| 09 | Mga Pag-aaral ng Kaso ng MCP | Mga praktikal na halimbawa ng implementasyon | [Guide](./09-CaseStudy/README.md) |
...
| Wika | Deskripsyon | Link |
|------|-------------|------|
| C# | Advanced na Halimbawa | [View Code](./04-PracticalImplementation/samples/csharp/README.md) |
| Java gamit ang Spring | Halimbawa ng Container App | [View Code](./04-PracticalImplementation/samples/java/containerapp/README.md) |
| JavaScript | Advanced na Halimbawa | [View Code](./04-PracticalImplementation/samples/javascript/README.md) |
...
- Sumali sa aming mga talakayan ng komunidad para sa suporta
...
3. Mga ehersisyo upang bumuo ng aktwal na mga aplikasyon ng MCP  
4. Karagdagang mapagkukunan para sa mga advanced na mag-aaral  

## 🌟 Pasasalamat sa Komunidad

Salamat kay Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) para sa mahalagang ambag ng mga sample ng code. 
...
Ang proyektong ito ay tumatanggap ng mga ambag at mungkahi. Karamihan sa mga ambag ay nangangailangan sa iyo na sumang-ayon sa isang
Contributor License Agreement (CLA) na nagsasaad na mayroon kang karapatan, at aktwal na ginagawa, na bigyan kami
ng mga karapatan upang gamitin ang iyong ambag. Para sa mga detalye, bisitahin ang 
...
- **translations/**: Suporta sa multi-language gamit ang automated na mga pagsasalin
...
Ang proyektong ito ay maaaring naglalaman ng mga trademark o logo para sa mga proyekto, produkto, o serbisyo. Ang awtorisadong paggamit ng mga trademark o logo ng Microsoft ay dapat sumunod sa at sundin ang
