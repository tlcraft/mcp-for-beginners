...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-04T18:19:10+00:00",
...
1. **I-configure ang networking**: Siguraduhing naa-access ang server sa inaasahang port.  
...
Sinusuportahan ng Azure Container Apps ang pag-deploy ng MCP Servers. Ito ay patuloy pang pinapaunlad at kasalukuyang sinusuportahan ang SSE servers.
...
1. Para subukan ito nang lokal, gumawa ng *mcp.json* na file sa loob ng *.vscode* na direktoryo at idagdag ang sumusunod na nilalaman:
  ...
  Kapag nagsimula na ang SSE server, maaari mong i-click ang play icon sa JSON file, at makikita mo na ang mga tools sa server ay makikilala na ng GitHub Copilot, tingnan ang Tool icon.
