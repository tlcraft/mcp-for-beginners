...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T20:01:07+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "tl"
}
-->
# Disenyo ng Database at Schema

## 🎯 Ano ang Saklaw ng Lab na Ito

Ang lab na ito ay sumisid nang malalim sa disenyo ng PostgreSQL database para sa sistema ng Zava Retail. Matutunan mong ipatupad ang isang komprehensibong retail schema na may kakayahan sa vector search, multi-tenant na pagmomodelo ng data, at Row Level Security (RLS) para sa paghiwalay ng data.

## Pangkalahatang-ideya

Ang database ang pundasyon ng aming MCP server, na nag-iimbak ng retail data mula sa iba't ibang tindahan habang pinapanatili ang mahigpit na paghiwalay ng data. Ginagamit namin ang PostgreSQL na may pgvector extension upang paganahin ang semantic search capabilities, na nagbibigay-daan sa mga customer na maghanap ng mga produkto gamit ang natural na wika.

Ang aming schema ay sumusunod sa modernong multi-tenant na mga pattern na may Row Level Security upang matiyak na ang mga user ay makakakuha lamang ng access sa data mula sa kanilang awtorisadong mga tindahan. Ang disenyong ito ay nagbibigay ng enterprise-grade na seguridad habang pinapanatili ang pinakamainam na pagganap.

## Mga Layunin sa Pag-aaral

Sa pagtatapos ng lab na ito, magagawa mo ang:

- **Magdisenyo** ng scalable multi-tenant retail database schemas  
- **Magpatupad** ng PostgreSQL na may pgvector para sa vector search  
- **Mag-configure** ng Row Level Security para sa paghiwalay ng data  
- **Lumikha** ng makatotohanang sample data para sa testing  
- **Mag-optimize** ng pagganap ng database para sa retail workloads  
- **Magpatupad** ng mga estratehiya sa backup at recovery  

## 🗃️ Arkitektura ng Database

### PostgreSQL na may pgvector

Ang aming database ay gumagamit ng mga enterprise features ng PostgreSQL na pinagsama sa pgvector extension para sa AI-powered search:
...
### Multi-Tenant na Arkitektura

Ang database ay gumagamit ng **shared database, shared schema** na modelo ng multi-tenancy na may Row Level Security:
...
### Products Table na may Categories
...
## 🔍 Implementasyon ng Vector Search
...
## 🔐 Setup ng Row Level Security

### Mga Role at Permissions ng Database
...
## 📊 Pagbuo ng Sample Data

### Script para sa Makatotohanang Test Data
...
✅ **Disenyo ng Multi-Tenant Database**: Naipatupad ang Row Level Security para sa secure na paghiwalay ng data  
✅ **Kakayahan sa Vector Search**: Na-configure ang pgvector para sa semantic product search  
✅ **Komprehensibong Schema**: Nilikha ang production-ready na retail database schema  
✅ **Pagbuo ng Sample Data**: Nagtayo ng makatotohanang test data para sa development at testing  
✅ **Pag-optimize ng Pagganap**: Na-configure ang mga index at query optimization  
✅ **Backup at Recovery**: Nagtatag ng matibay na estratehiya sa proteksyon ng data  

## 🚀 Ano ang Susunod

Magpatuloy sa **[Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)** upang:

- Bumuo ng FastMCP server na kumokonekta sa database na ito  
- Magpatupad ng mga tool sa database query para sa MCP protocol  
- Magdagdag ng kakayahan sa semantic search gamit ang embeddings  
- Mag-configure ng connection pooling at error handling  

## 📚 Karagdagang Mga Mapagkukunan

### PostgreSQL & pgvector
- [PostgreSQL Documentation](https://www.postgresql.org/docs/) - Kumpletong reference ng PostgreSQL  
- [pgvector Extension](https://github.com/pgvector/pgvector) - Vector similarity search para sa PostgreSQL  
- [PostgreSQL Performance Tuning](https://wiki.postgresql.org/wiki/Performance_Optimization) - Mga pinakamahusay na kasanayan sa optimization  

### Multi-Tenant na Arkitektura
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Dokumentasyon ng PostgreSQL RLS  
- [Multi-Tenant Data Architecture](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Mga pattern ng arkitektura ng Azure  
- [Database Security Best Practices](https://www.postgresql.org/docs/current/security.html) - Gabay sa seguridad ng PostgreSQL  

### Vector Databases
- [Vector Search Fundamentals](https://www.pinecone.io/learn/vector-database/) - Pag-unawa sa vector databases  
- [Embedding Models](https://platform.openai.com/docs/guides/embeddings) - Dokumentasyon ng OpenAI embeddings  
- [HNSW Algorithm](https://arxiv.org/abs/1603.09320) - Hierarchical Navigable Small World graphs  

---

**Nakaraan**: [Lab 03: Environment Setup](../03-Setup/README.md)  
**Susunod**: [Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)  
