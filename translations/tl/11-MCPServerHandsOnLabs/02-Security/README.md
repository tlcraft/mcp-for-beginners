...
Ang lab na ito ay nagbibigay ng detalyadong gabay sa pagpapatupad ng enterprise-grade na seguridad at multi-tenancy para sa MCP servers. Matututuhan mong magdisenyo ng mga sistemang ligtas at sumusunod sa regulasyon na nagpoprotekta sa sensitibong retail data habang nagbibigay ng flexible na access patterns sa iba't ibang tenants.

## Pangkalahatang-ideya

Napakahalaga ng seguridad sa mga retail application na humahawak ng data ng customer, impormasyon sa pagbabayad, at business intelligence. Saklaw ng lab na ito ang kumpletong arkitektura ng seguridad mula sa authentication at authorization hanggang sa data isolation at compliance monitoring.

Ipinapatupad namin ang isang defense-in-depth na estratehiya na pinagsasama ang Azure identity services, PostgreSQL Row Level Security, application-level controls, at komprehensibong audit logging upang makabuo ng isang matatag at sumusunod na platform.

## Mga Layunin sa Pag-aaral

Sa pagtatapos ng lab na ito, magagawa mo ang:

- **Ipapatupad** ang enterprise-grade Row Level Security para sa multi-tenant na data isolation  
- **Magdisenyo** ng secure na authentication at authorization patterns gamit ang Azure  
- **I-configure** ang komprehensibong audit logging para sa compliance requirements  
- **I-apply** ang defense-in-depth na mga estratehiya sa lahat ng application layers  
- **I-validate** ang mga implementasyon ng seguridad sa pamamagitan ng sistematikong testing  
- **I-monitor** ang mga security event at tumugon sa mga potensyal na banta  

## 🔐 Arkitektura ng Seguridad para sa Multi-Tenancy

### Pangkalahatang-ideya ng Mga Layer ng Seguridad
...
### Mga Modelo ng Multi-Tenancy

Ang aming implementasyon ay gumagamit ng **Shared Database, Shared Schema** na modelo na may Row Level Security:

**Mga Benepisyo:**
- Cost-effective na paggamit ng resources  
- Mas pinadaling maintenance at updates  
- Malakas na data isolation gamit ang RLS  
- Compliance-friendly na audit trails  

**Mga Trade-off:**
- Nangangailangan ng maingat na disenyo ng RLS policy  
- Ang mga pagbabago sa schema ay nakakaapekto sa lahat ng tenants  
- Kailangan ng matibay na backup/restore procedures  

## 🛡️ Implementasyon ng Row Level Security
...
### Pagsubok at Pag-validate ng RLS
...
## 🔍 Audit ng Seguridad at Pagsunod

### Komprehensibong Audit Logging
...
### Pag-monitor ng Security Events
...
## 🧪 Pagsubok at Pag-validate ng Seguridad
...
### Checklist para sa Penetration Testing
...
✅ **Multi-Tenant Security**: Naipatupad ang Row Level Security para sa kumpletong data isolation  
✅ **Azure Authentication**: Na-integrate ang Azure Entra ID gamit ang JWT validation  
✅ **Role-Based Authorization**: Na-configure ang hierarchical role at permission system  
✅ **Comprehensive Audit Logging**: Na-establish ang security event tracking at monitoring  
✅ **Security Testing**: Naipatupad ang automated security validation tests  
✅ **Threat Monitoring**: Nalikha ang real-time na security event detection at alerting  

## 🚀 Ano ang Susunod

Magpatuloy sa **[Lab 03: Environment Setup](../03-Setup/README.md)** upang:

- I-configure ang development environments gamit ang security best practices  
- I-set up ang Azure services para sa authentication at monitoring  
- Ipatupad ang secure database connections at secrets management  
- I-validate ang security configurations sa development environments  

## 📚 Karagdagang Resources

### Azure Security
- [Azure Entra ID Documentation](https://docs.microsoft.com/azure/active-directory/) - Kumpletong gabay sa identity platform  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Serbisyo para sa secrets management  
- [Azure Security Best Practices](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Gabay sa seguridad  

### Database Security
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Opisyal na dokumentasyon ng RLS  
- [Database Security Checklist](https://www.postgresql.org/docs/current/security.html) - Gabay sa seguridad ng PostgreSQL  
- [Multi-Tenant Database Patterns](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Mga pattern ng arkitektura  

### Security Testing
- [OWASP Testing Guide](https://owasp.org/www-project-web-security-testing-guide/) - Komprehensibong gabay sa security testing  
- [JWT Security Best Practices](https://tools.ietf.org/html/rfc8725) - Mga konsiderasyon sa seguridad ng JWT  
- [API Security Testing](https://owasp.org/www-project-api-security/) - Security testing para sa API  

---

**Nakaraan**: [Lab 01: Core Architecture Concepts](../01-Architecture/README.md)  
**Susunod**: [Lab 03: Environment Setup](../03-Setup/README.md)  
