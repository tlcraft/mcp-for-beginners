...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T14:19:13+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "es"
}
-->
# Diseño de Base de Datos y Esquema

## 🎯 Qué Cubre Este Laboratorio

Este laboratorio profundiza en el diseño de la base de datos PostgreSQL para el sistema de Zava Retail. Aprenderás a implementar un esquema de retail completo con capacidades de búsqueda vectorial, modelado de datos multi-tenant y Seguridad a Nivel de Fila (RLS) para aislamiento de datos.

## Resumen

La base de datos es la base de nuestro servidor MCP, almacenando datos de retail de múltiples tiendas mientras mantiene un estricto aislamiento de datos. Usamos PostgreSQL con la extensión pgvector para habilitar capacidades de búsqueda semántica, permitiendo a los clientes encontrar productos mediante consultas en lenguaje natural.

Nuestro esquema sigue patrones modernos de multi-tenancy con Seguridad a Nivel de Fila, asegurando que los usuarios solo puedan acceder a los datos de sus tiendas autorizadas. Este enfoque proporciona seguridad de nivel empresarial mientras mantiene un rendimiento óptimo.

## Objetivos de Aprendizaje

Al final de este laboratorio, serás capaz de:

- **Diseñar** esquemas de bases de datos escalables para retail multi-tenant  
- **Implementar** PostgreSQL con pgvector para búsqueda vectorial  
- **Configurar** Seguridad a Nivel de Fila para aislamiento de datos  
- **Generar** datos de muestra realistas para pruebas  
- **Optimizar** el rendimiento de la base de datos para cargas de trabajo de retail  
...
Nuestra base de datos aprovecha las características empresariales de PostgreSQL combinadas con la extensión pgvector para búsqueda impulsada por IA:
...
La base de datos utiliza un modelo de multi-tenancy de **base de datos compartida, esquema compartido** con Seguridad a Nivel de Fila:
...
### Tabla de Tiendas (Maestro de Tenants)
...
### Vistas de Optimización de Consultas
...
✅ **Diseño de Base de Datos Multi-Tenant**: Implementado Seguridad a Nivel de Fila para aislamiento seguro de datos  
✅ **Capacidades de Búsqueda Vectorial**: Configurado pgvector para búsqueda semántica de productos  
✅ **Esquema Completo**: Creado un esquema de base de datos de retail listo para producción  
✅ **Generación de Datos de Muestra**: Construido datos de prueba realistas para desarrollo y pruebas  
✅ **Optimización del Rendimiento**: Configurado índices y optimización de consultas  
✅ **Respaldo y Recuperación**: Establecido estrategias robustas de protección de datos  

## 🚀 Qué Sigue

Continúa con **[Laboratorio 05: Implementación del Servidor MCP](../05-MCP-Server/README.md)** para:

- Construir el servidor FastMCP que se conecta a esta base de datos  
- Implementar herramientas de consulta de base de datos para el protocolo MCP  
- Agregar capacidades de búsqueda semántica usando los embeddings  
- Configurar agrupación de conexiones y manejo de errores  

## 📚 Recursos Adicionales

### PostgreSQL & pgvector
- [Documentación de PostgreSQL](https://www.postgresql.org/docs/) - Referencia completa de PostgreSQL  
- [Extensión pgvector](https://github.com/pgvector/pgvector) - Búsqueda de similitud vectorial para PostgreSQL  
- [Optimización de Rendimiento de PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Mejores prácticas de optimización  

### Arquitectura Multi-Tenant
- [Seguridad a Nivel de Fila](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Documentación de RLS en PostgreSQL  
- [Arquitectura de Datos Multi-Tenant](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Patrones de arquitectura de Azure  
- [Mejores Prácticas de Seguridad de Bases de Datos](https://www.postgresql.org/docs/current/security.html) - Guía de seguridad de PostgreSQL  

### Bases de Datos Vectoriales
- [Fundamentos de Búsqueda Vectorial](https://www.pinecone.io/learn/vector-database/) - Entendiendo las bases de datos vectoriales  
- [Modelos de Embeddings](https://platform.openai.com/docs/guides/embeddings) - Documentación de embeddings de OpenAI  
- [Algoritmo HNSW](https://arxiv.org/abs/1603.09320) - Grafos Hierarchical Navigable Small World  

---

**Anterior**: [Laboratorio 03: Configuración del Entorno](../03-Setup/README.md)  
**Siguiente**: [Laboratorio 05: Implementación del Servidor MCP](../05-MCP-Server/README.md)  
