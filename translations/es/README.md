...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-07T08:29:32+00:00",
...
- 🧑‍💻 [Repositorio de MCP en GitHub](https://github.com/modelcontextprotocol) – SDKs de código abierto, herramientas y ejemplos de código
...
## Únete a nosotros en MCP Dev Days 29-30 de julio de 2025 

Prepárate para dos días de aprendizaje técnico profundo, conexión comunitaria y aprendizaje práctico en MCP Dev Days, un evento virtual dedicado al Protocolo de Contexto de Modelo (MCP), el estándar emergente que conecta modelos de IA con las herramientas que necesitan.

➡️ [Regístrate para MCP Dev Days](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

Puedes ver MCP Dev Days registrándote en nuestra página del evento: https://aka.ms/mcpdevdays. Desde allí, podrás unirte a una transmisión en vivo en YouTube o Twitch. Todo el contenido será grabado y estará disponible posteriormente en el canal de YouTube de Microsoft Developer. El código fuente de las demostraciones también estará disponible en GitHub.

### Detalles del Evento
- Fechas: 29 de julio (Día 1) y 30 de julio (Día 2)
- Hora: 9:00 AM PST diariamente
- Dónde: En línea – ¡únete desde cualquier lugar!

#### Día 1: Productividad con MCP, Herramientas de Desarrollo y Comunidad: 

Se centrará en empoderar a los desarrolladores para usar MCP en su flujo de trabajo y celebrar la increíble comunidad de MCP. Nos acompañarán miembros de la comunidad y socios como Arcade, Block, Okta y Neon para ver cómo están colaborando con Microsoft para dar forma a un ecosistema MCP abierto y extensible. 
Demostraciones reales en VS Code, Visual Studio, GitHub Copilot y herramientas comunitarias populares
...
| 3.7 | Kit de Herramientas de IA | Usa el Kit de Herramientas de IA con MCP | [Guía](./03-GettingStarted/07-aitk/README.md) |
...
| 5.12 | Entra ID Auth | Autenticación con Microsoft Entra ID | [Guía](./05-AdvancedTopics/mcp-security-entra/README.md) |
| 5.13 | Integración con Foundry | Integrar con Azure AI Foundry | [Guía](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
| 5.14 | Ingeniería de Contexto | Técnicas para una ingeniería de contexto efectiva | [Guía](./05-AdvancedTopics/mcp-contextengineering/README.md) |
...
| JavaScript | Demostración de MCP | [Ver Código](./03-GettingStarted/samples/javascript/README.md) |
| Python | Servidor MCP | [Ver Código](../../03-GettingStarted/samples/python/mcp_calculator_server.py) |
| TypeScript | Ejemplo de MCP | [Ver Código](./03-GettingStarted/samples/typescript/README.md) |
...
| Java | Ejemplo de Aplicación en Contenedor | [Ver Código](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
Este contenido está licenciado bajo la **Licencia MIT**. Para términos y condiciones, consulta el archivo [LICENSE](../../LICENSE).
