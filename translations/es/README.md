...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-23T05:51:19+00:00",
...
|--|--|--|--|
| 00 | **Introducción a MCP** | Visión general del Protocolo de Contexto de Modelo y su importancia en las pipelines de IA, incluyendo qué es el Protocolo de Contexto de Modelo, por qué es importante la estandarización y casos de uso y beneficios prácticos | [Introducción](./00-Introduction/README.md) |
...
| 3.8 | **Desplegar tu servidor** | ¿Cómo pasas del desarrollo local a producción? Esta sección te ayudará a desarrollar y desplegar tu servidor. | [Desplegar tu servidor](./03-GettingStarted/08-deployment/README.md) |
...
Cuando envíes una pull request, un bot de CLA determinará automáticamente si necesitas proporcionar  
un CLA y marcará el PR adecuadamente (por ejemplo, verificación de estado, comentario). Simplemente sigue las instrucciones  
que proporciona el bot. Solo necesitarás hacer esto una vez en todos los repositorios que usan nuestro CLA.
