...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T13:21:14+00:00",
...
[![Colaboradores de GitHub](https://img.shields.io/github/contributors/microsoft/mcp-for-beginners.svg)](https://GitHub.com/microsoft/mcp-for-beginners/graphs/contributors)
[![Problemas en GitHub](https://img.shields.io/github/issues/microsoft/mcp-for-beginners.svg)](https://GitHub.com/microsoft/mcp-for-beginners/issues)
[![Solicitudes de extracción en GitHub](https://img.shields.io/github/issues-pr/microsoft/mcp-for-beginners.svg)](https://GitHub.com/microsoft/mcp-for-beginners/pulls)
[![PRs Bienvenidos](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)

[![Observadores en GitHub](https://img.shields.io/github/watchers/microsoft/mcp-for-beginners.svg?style=social&label=Watch)](https://GitHub.com/microsoft/mcp-for-beginners/watchers)
[![Bifurcaciones en GitHub](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
[![Estrellas en GitHub](https://img.shields.io/github/stars/microsoft/mcp-for-beginners?style=social&label=Star)](https://GitHub.com/microsoft/mcp-for-beginners/stargazers)
...
1. **Haz un Fork del Repositorio**: Haz clic en [![Bifurcaciones en GitHub](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
...
- 🧑‍💻 [Repositorio de MCP en GitHub](https://github.com/modelcontextprotocol) – SDKs, herramientas y ejemplos de código de código abierto
- 🌐 [Comunidad de MCP](https://github.com/orgs/modelcontextprotocol/discussions) – Únete a las discusiones y contribuye a la comunidad
...
| 00 | Introducción a MCP | Resumen del Protocolo de Contexto de Modelo y su importancia en los flujos de trabajo de IA | [Leer más](./00-Introduction/README.md) |
| 01 | Conceptos Básicos Explicados | Exploración detallada de los conceptos clave de MCP | [Leer más](./01-CoreConcepts/README.md) |
...
| 3.7 | Herramientas de IA | Usa herramientas de IA con MCP | [Guía](./03-GettingStarted/07-aitk/README.md) |
...
| 5.12 | Autenticación con Entra ID | Autenticación con Microsoft Entra ID | [Guía](./05-AdvancedTopics/mcp-security-entra/README.md) |
...
| 5.15 | Transporte Personalizado de MCP | Implementaciones de Transporte Personalizado | [Guía](./05-AdvancedTopics/mcp-transport/README.md) |
...
| 10 | Taller Práctico | Construyendo un Servidor MCP con Herramientas de IA | [Laboratorio](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
| **Módulo 11: Laboratorio Práctico de Servidor MCP** | | | |
| 11 | Integración de Base de Datos en Servidor MCP | Ruta de aprendizaje práctica de 13 laboratorios para integración con PostgreSQL | [Laboratorios](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | Introducción | Resumen de MCP con integración de base de datos y caso de uso de análisis minorista | [Laboratorio 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
| 11.2 | Arquitectura Principal | Comprensión de la arquitectura del servidor MCP, capas de base de datos y patrones de seguridad | [Laboratorio 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
| 11.3 | Seguridad y Multi-Tenancy | Seguridad a nivel de fila, autenticación y acceso a datos multi-tenant | [Lab 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.5 | Diseño de Base de Datos | Configuración de PostgreSQL, diseño del esquema de retail y datos de ejemplo | [Lab 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
...
| 11.10 | Integración con VS Code | Configuración de la integración de MCP en VS Code y uso de AI Chat | [Lab 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
...
| 11.12 | Monitoreo | Application Insights, registro de logs y monitoreo de rendimiento | [Lab 11](./11-MCPServerHandsOnLabs/11-Monitoring/README.md) |
...
| Java con Spring | Ejemplo de App en Contenedor | [Ver Código](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
| TypeScript | Ejemplo en Contenedor | [Ver Código](./04-PracticalImplementation/samples/typescript/README.md) |
...
Prepárate para dos días de profundo conocimiento técnico, conexión comunitaria y aprendizaje práctico en MCP Dev Days, un evento virtual dedicado al Protocolo de Contexto de Modelo (MCP), el estándar emergente que conecta modelos de IA con las herramientas que necesitan.
Puedes ver MCP Dev Days registrándote en nuestra página del evento: https://aka.ms/mcpdevdays. 

#### [Día 1: Productividad con MCP, Herramientas de Desarrollo y Comunidad:](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
...
- **Currículo Principal (00-11)**: El contenido principal organizado en once módulos secuenciales, incluyendo laboratorios completos de integración de bases de datos
- **11-MCPServerHandsOnLabs/**: Ruta de aprendizaje de 13 laboratorios para construir servidores MCP listos para producción con integración de PostgreSQL
