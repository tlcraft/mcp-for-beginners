...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-23T06:29:27+00:00",
...
- 🧑‍💻 [MCP GitHub Repository](https://github.com/modelcontextprotocol) – SDKs de código abierto, herramientas y ejemplos de código  

## 🧭 Estructura Completa del Currículo MCP

| Ch | Título | Descripción | Enlace |
|--|--|--|--|
| 00 | **Introducción al MCP** | Visión general del Protocolo de Contexto de Modelo y su importancia en pipelines de IA, incluyendo qué es el Protocolo de Contexto de Modelo, por qué la estandarización es importante, y casos de uso y beneficios prácticos | [Introducción](./00-Introduction/README.md) |
| 01 | **Conceptos Básicos Explicados** | Exploración profunda de los conceptos centrales del MCP, incluyendo arquitectura cliente-servidor, componentes clave del protocolo y patrones de mensajería | [Conceptos Básicos](./01-CoreConcepts/README.md) |
| 02 | **Seguridad en MCP** | Identificación de amenazas de seguridad en sistemas basados en MCP, técnicas y mejores prácticas para asegurar implementaciones | [Seguridad](./02-Security/README.md) |
...
| 3.3 | **Cliente con LLM**  | Configuración de un cliente usando el protocolo MCP con un Modelo de Lenguaje Extenso (LLM) | [Cliente con LLM](./03-GettingStarted/03-llm-client/README.md) |
...
| 04 | **Implementación Práctica** | Uso de SDKs en diferentes lenguajes, depuración, pruebas y validación, creación de plantillas y flujos de trabajo reutilizables para prompts | [Implementación Práctica](./04-PracticalImplementation/README.md) |
| 05 | **Temas Avanzados en MCP** | Flujos de trabajo de IA multimodal y extensibilidad, estrategias seguras de escalado, MCP en ecosistemas empresariales | [Temas Avanzados](./05-AdvancedTopics/README.md) |
...
| 07 | **Lecciones de la Adopción Temprana** | Implementaciones reales y lo que funcionó, construcción y despliegue de soluciones basadas en MCP, tendencias y hoja de ruta futura | [Lecciones](./07-LessonsFromEarlyAdoption/README.md) |
...
Para aprovechar al máximo este currículo, debes tener:
...
que proporcione el bot. Solo necesitarás hacer esto una vez en todos los repositorios que usan nuestro CLA.
...
las [Directrices de marcas y marcas registradas de Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
