...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-02T11:51:10+00:00",
...
|--|--|--|--|
| 00 | **Introducción a MCP** | Visión general del Protocolo de Contexto de Modelo y su importancia en las pipelines de IA, incluyendo qué es MCP, por qué la estandarización es importante y casos de uso prácticos y beneficios | [Introducción](./00-Introduction/README.md) |
| 01 | **Conceptos Básicos Explicados** | Exploración profunda de los conceptos clave de MCP, incluyendo arquitectura cliente-servidor, componentes principales del protocolo y patrones de mensajería | [Conceptos Básicos](./01-CoreConcepts/README.md) |
...
| 3.3 | **Cliente con LLM**  | Configuración de un cliente usando MCP con un Modelo de Lenguaje Grande (LLM) | [Cliente con LLM](./03-GettingStarted/03-llm-client/README.md) |
| 3.4 | **Consumir un servidor con Visual Studio Code** | Configurar Visual Studio Code para consumir servidores usando el protocolo MCP | [Consumir un servidor con Visual Studio Code](./03-GettingStarted/04-vscode/README.md) |
...
| 3.6 | **Usar AI Toolkit** | AI Toolkit es una herramienta excelente que te ayudará a gestionar tu flujo de trabajo de IA y MCP. | [Usar AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
...
| 04 | **Implementación Práctica** | Uso de SDKs en distintos lenguajes, depuración, pruebas y validación, creación de plantillas y flujos reutilizables para prompts | [Implementación Práctica](./04-PracticalImplementation/README.md) |
| 05 | **Temas Avanzados en MCP** | Flujos de trabajo de IA multimodal y extensibilidad, estrategias seguras para escalado, MCP en ecosistemas empresariales | [Temas Avanzados](./05-AdvancedTopics/README.md) |
| 5.1 | **Demo MCP OAuth2** | Implementación de autenticación OAuth2 con servidores MCP, incluyendo validación de tokens de acceso, autorización basada en scopes y protección segura de endpoints API | [Demo MCP OAuth2](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
| 5.2 | **Búsqueda Web con MCP** | Implementación de capacidades de búsqueda web usando el Protocolo de Contexto de Modelo, incluyendo procesamiento de consultas, manejo de resultados e integración con APIs de búsqueda | [Búsqueda Web MCP](./05-AdvancedTopics/web-search-mcp/README.md) |
| 06 | **Contribuciones de la Comunidad** | Cómo contribuir con código y documentación, colaboración a través de GitHub, mejoras impulsadas por la comunidad y retroalimentación | [Contribuciones de la Comunidad](./06-CommunityContributions/README.md) |
| 07 | **Lecciones de la Adopción Temprana** | Implementaciones reales y qué funcionó, construcción y despliegue de soluciones basadas en MCP, tendencias y hoja de ruta futura | [Lecciones](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | **Mejores Prácticas para MCP** | Optimización y ajuste de rendimiento, diseño de sistemas MCP tolerantes a fallos, estrategias de pruebas y resiliencia | [Mejores Prácticas](./08-BestPractices/README.md) |
| 09 | **Estudios de Caso MCP** | Análisis detallados de arquitecturas de soluciones MCP, planos de despliegue y consejos de integración, diagramas anotados y recorridos de proyectos | [Estudios de Caso](./09-CaseStudy/README.md) |

## Proyectos de Ejemplo

### 🧮 Proyectos de Ejemplo Calculadora MCP:
<details>
...
3. Ejercicios para crear aplicaciones reales de MCP  
...
Contributor License Agreement (CLA) declarando que tienes el derecho y realmente otorgas
...
un CLA y decorará el PR apropiadamente (por ejemplo, verificación de estado, comentario). Solo sigue las instrucciones
que te dé el bot. Solo tendrás que hacer esto una vez en todos los repositorios que usen nuestro CLA.

Este proyecto ha adoptado el [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
Para más información, consulta el [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) o
...
las [Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
