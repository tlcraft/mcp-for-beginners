...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-18T05:46:34+00:00",
...
Abre una terminal aparte antes de ejecutar lo siguiente (asegúrate de que el servidor siga en funcionamiento).
...
- try listing tools and run `add`, con los argumentos 2 y 4, deberías ver 6 como resultado.
