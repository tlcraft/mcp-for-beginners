...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-18T05:46:24+00:00",
...
- Type a prompt in your chat window that matches the description of your tool. For example to trigger the tool `add` escribe algo como "add 3 to 20".
    ...
    Seleccionar la herramienta debería producir un resultado numérico que diga "23" si tu solicitud fue como mencionamos anteriormente.
