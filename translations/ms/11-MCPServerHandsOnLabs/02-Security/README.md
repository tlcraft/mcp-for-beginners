...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:47:21+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "ms"
}
-->
# Keselamatan dan Multi-Tenancy

## 🎯 Apa Yang Diliputi Dalam Makmal Ini

Makmal ini menyediakan panduan lengkap untuk melaksanakan keselamatan peringkat perusahaan dan multi-tenancy untuk pelayan MCP. Anda akan belajar untuk mereka bentuk sistem yang selamat dan patuh yang melindungi data runcit sensitif sambil membolehkan corak akses fleksibel di kalangan pelbagai penyewa.

## Gambaran Keseluruhan

Keselamatan adalah sangat penting dalam aplikasi runcit yang mengendalikan data pelanggan, maklumat pembayaran, dan kecerdasan perniagaan. Makmal ini meliputi keseluruhan seni bina keselamatan daripada pengesahan dan kebenaran kepada pengasingan data dan pemantauan pematuhan.

Kami melaksanakan strategi pertahanan mendalam yang menggabungkan perkhidmatan identiti Azure, PostgreSQL Row Level Security, kawalan peringkat aplikasi, dan log audit yang komprehensif untuk mencipta platform yang kukuh dan patuh.

## Objektif Pembelajaran

Menjelang akhir makmal ini, anda akan dapat:

- **Melaksanakan** Row Level Security peringkat perusahaan untuk pengasingan data multi-penyewa  
- **Mereka bentuk** corak pengesahan dan kebenaran yang selamat dengan Azure  
- **Mengkonfigurasi** log audit yang komprehensif untuk keperluan pematuhan  
- **Mengaplikasikan** strategi keselamatan pertahanan mendalam di semua lapisan aplikasi  
- **Mengesahkan** pelaksanaan keselamatan melalui ujian sistematik  
- **Memantau** acara keselamatan dan bertindak balas terhadap ancaman yang berpotensi  

## 🔐 Seni Bina Keselamatan Multi-Tenancy

### Gambaran Keseluruhan Lapisan Keselamatan
...
Pelaksanaan kami menggunakan model **Pangkalan Data Berkongsi, Skema Berkongsi** dengan Row Level Security:

**Kelebihan:**
- Penggunaan sumber yang kos efektif  
- Penyelenggaraan dan kemas kini yang dipermudahkan  
- Pengasingan data yang kukuh melalui RLS  
- Jejak audit yang mesra pematuhan  

**Kekurangan:**
- Memerlukan reka bentuk dasar RLS yang teliti  
- Perubahan skema memberi kesan kepada semua penyewa  
- Memerlukan prosedur sandaran/pemulihan yang kukuh  

## 🛡️ Pelaksanaan Row Level Security
...
## 🔍 Audit Keselamatan dan Pematuhan
...
### Paparan Pemantauan Keselamatan
...
## 🧪 Ujian dan Pengesahan Keselamatan
...
### Senarai Semak Ujian Penembusan
...
Selepas melengkapkan makmal ini, anda seharusnya telah:

✅ **Keselamatan Multi-Tenancy**: Melaksanakan Row Level Security untuk pengasingan data sepenuhnya  
✅ **Pengesahan Azure**: Mengintegrasikan Azure Entra ID dengan pengesahan JWT  
✅ **Kebenaran Berasaskan Peranan**: Mengkonfigurasi sistem peranan dan kebenaran hierarki  
✅ **Log Audit Komprehensif**: Menubuhkan penjejakan dan pemantauan acara keselamatan  
✅ **Ujian Keselamatan**: Melaksanakan ujian pengesahan keselamatan automatik  
✅ **Pemantauan Ancaman**: Mencipta pengesanan acara keselamatan masa nyata dan amaran  

## 🚀 Apa Seterusnya

Teruskan dengan **[Makmal 03: Persediaan Persekitaran](../03-Setup/README.md)** untuk:

- Mengkonfigurasi persekitaran pembangunan dengan amalan terbaik keselamatan  
- Menyediakan perkhidmatan Azure untuk pengesahan dan pemantauan  
- Melaksanakan sambungan pangkalan data yang selamat dan pengurusan rahsia  
- Mengesahkan konfigurasi keselamatan dalam persekitaran pembangunan  

## 📚 Sumber Tambahan

### Keselamatan Azure
- [Dokumentasi Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - Panduan lengkap platform identiti  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Perkhidmatan pengurusan rahsia  
- [Amalan Terbaik Keselamatan Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Panduan keselamatan  

### Keselamatan Pangkalan Data
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Dokumentasi rasmi RLS  
- [Senarai Semak Keselamatan Pangkalan Data](https://www.postgresql.org/docs/current/security.html) - Panduan keselamatan PostgreSQL  
- [Corak Pangkalan Data Multi-Tenancy](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Corak seni bina  

### Ujian Keselamatan
- [Panduan Ujian OWASP](https://owasp.org/www-project-web-security-testing-guide/) - Ujian keselamatan yang komprehensif  
- [Amalan Terbaik Keselamatan JWT](https://tools.ietf.org/html/rfc8725) - Pertimbangan keselamatan JWT  
- [Ujian Keselamatan API](https://owasp.org/www-project-api-security/) - Ujian keselamatan khusus API  

---

**Sebelumnya**: [Makmal 01: Konsep Seni Bina Teras](../01-Architecture/README.md)  
**Seterusnya**: [Makmal 03: Persediaan Persekitaran](../03-Setup/README.md)  
