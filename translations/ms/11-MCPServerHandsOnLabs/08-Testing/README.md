...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:36:56+00:00",
...
Makmal ini menyediakan panduan menyeluruh tentang ujian dan penyahpepijatan pelayan MCP dalam persekitaran pengeluaran. Anda akan belajar melaksanakan strategi ujian yang kukuh, menyahpepijat isu yang kompleks, dan memastikan pelayan MCP anda berfungsi dengan boleh dipercayai di bawah pelbagai keadaan.

## Gambaran Keseluruhan

Ujian pelayan MCP memerlukan pendekatan berlapis-lapis yang merangkumi ujian unit, ujian integrasi, pengesahan prestasi, dan ujian senario dunia sebenar. Makmal ini meliputi keseluruhan kitaran ujian dari pembangunan hingga pemantauan pengeluaran.

Strategi ujian kami menekankan kebolehpercayaan, keselamatan, dan prestasi, memastikan pelayan MCP anda dapat menangani beban kerja pengeluaran sambil mengekalkan integriti data dan kualiti pengalaman pengguna.

## Objektif Pembelajaran

Menjelang akhir makmal ini, anda akan dapat:

- **Melaksanakan** suite ujian unit dan integrasi yang menyeluruh
- **Merancang** strategi ujian yang berkesan untuk alat MCP dan operasi pangkalan data
- **Menyahpepijat** isu kompleks menggunakan teknik penyahpepijatan lanjutan
- **Mengesahkan** prestasi di bawah beban dengan senario ujian yang realistik
- **Memantau** sistem pengeluaran dengan amaran dan pemerhatian yang berkesan
- **Mengautomasi** aliran kerja ujian untuk integrasi berterusan

## 🧪 Seni Bina Ujian

### Gambaran Keseluruhan Strategi Ujian
...
### Ujian Aliran Kerja Hujung-ke-Hujung
...
### Kerangka Penyahpepijatan Lanjutan
...
✅ **Kerangka Ujian Menyeluruh**: Ujian unit, integrasi, dan prestasi untuk semua komponen  
✅ **Alat Penyahpepijatan Lanjutan**: Utiliti penyahpepijatan canggih dengan penjejakan pelaksanaan  
✅ **Pengesahan Prestasi**: Keupayaan ujian beban dan analisis kebolehskalaan  
✅ **Ujian Keselamatan**: Pencegahan suntikan SQL dan pengesahan RLS  
✅ **Integrasi Pemantauan**: Metrik prestasi dan analisis titik kelemahan  
✅ **Sedia CI/CD**: Aliran kerja ujian automatik untuk integrasi berterusan  

## 🚀 Apa Seterusnya

Teruskan dengan **[Makmal 09: Integrasi VS Code](../09-VS-Code/README.md)** untuk:

- Konfigurasi VS Code untuk pembangunan pelayan MCP
- Menyediakan persekitaran penyahpepijatan dalam VS Code
- Mengintegrasikan pelayan MCP dengan VS Code Chat
- Menguji keseluruhan aliran kerja VS Code

## 📚 Sumber Tambahan

### Kerangka Ujian
- [Dokumentasi pytest](https://docs.pytest.org/) - Kerangka ujian Python
- [Ujian AsyncPG](https://magicstack.github.io/asyncpg/current/index.html) - Ujian PostgreSQL Async
- [Ujian FastAPI](https://fastapi.tiangolo.com/tutorial/testing/) - Corak ujian API

### Ujian Prestasi
- [Amalan Terbaik Ujian Beban](https://docs.python.org/3/library/asyncio.html) - Ujian prestasi Async
- [Ujian Prestasi Pangkalan Data](https://www.postgresql.org/docs/current/performance-tips.html) - Pengoptimuman PostgreSQL
- [Profil Memori](https://docs.python.org/3/library/tracemalloc.html) - Analisis memori Python

### Alat Penyahpepijatan
- [Penyahpepijatan Python](https://docs.python.org/3/library/pdb.html) - Penyahpepijat Python
- [Penyahpepijatan Async](https://docs.python.org/3/library/asyncio-dev.html) - Penyahpepijatan Asyncio
- [Penyahpepijatan SQL](https://www.postgresql.org/docs/current/runtime-config-logging.html) - Log PostgreSQL

---

**Sebelumnya**: [Makmal 07: Integrasi Carian Semantik](../07-Semantic-Search/README.md)  
**Seterusnya**: [Makmal 09: Integrasi VS Code](../09-VS-Code/README.md)
