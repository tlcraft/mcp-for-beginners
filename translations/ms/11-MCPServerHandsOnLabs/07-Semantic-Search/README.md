...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T20:03:30+00:00",
...
Makmal ini menyediakan panduan lengkap untuk melaksanakan keupayaan carian semantik menggunakan embedding Azure OpenAI dan sambungan pgvector PostgreSQL. Anda akan belajar membina carian produk berkuasa AI yang memahami pertanyaan bahasa semula jadi dan memberikan hasil yang relevan berdasarkan kesamaan semantik.

## Gambaran Keseluruhan

Carian berasaskan kata kunci tradisional sering gagal menangkap niat pengguna dan makna semantik. Carian semantik menggunakan embedding vektor membolehkan pertanyaan bahasa semula jadi seperti "kasut lari yang selesa untuk cuaca hujan" mencari produk yang relevan walaupun kata-kata tersebut tidak muncul dalam penerangan produk.

Pelaksanaan kami menggabungkan model embedding yang kuat dari Azure OpenAI dengan sambungan pgvector PostgreSQL untuk mencipta sistem carian semantik berprestasi tinggi dan boleh diskalakan yang meningkatkan pengalaman runcit dengan penemuan produk pintar.

## Objektif Pembelajaran

Menjelang akhir makmal ini, anda akan dapat:

- **Mengintegrasi** model embedding Azure OpenAI untuk penvektoran teks  
- **Melaksanakan** pgvector untuk operasi carian kesamaan yang cekap  
- **Membina** alat carian semantik untuk pertanyaan produk bahasa semula jadi  
- **Mencipta** carian hibrid yang menggabungkan carian tradisional dan vektor  
- **Mengoptimumkan** pertanyaan vektor untuk prestasi pengeluaran  
- **Merancang** sistem cadangan menggunakan kesamaan embedding  

## 🧠 Seni Bina Carian Semantik

### Saluran Carian Vektor
...
## 🔍 Penjanaan Embedding Produk

### Saluran Embedding Automatik
...
## 🔎 Alat Carian Semantik

### Alat Carian Produk Semantik
...
### Pengoptimuman Pertanyaan Vektor
...
✅ **Integrasi Azure OpenAI**: Penjanaan embedding lengkap dengan caching dan pengoptimuman  
✅ **Pelaksanaan Carian Vektor**: Carian semantik sedia pengeluaran dengan pgvector  
✅ **Keupayaan Carian Hibrid**: Gabungan carian kata kunci dan semantik untuk hasil optimum  
✅ **Sistem Cadangan**: Cadangan produk berkuasa AI menggunakan kesamaan  
✅ **Pengoptimuman Prestasi**: Pengoptimuman indeks vektor dan caching pintar  
✅ **Seni Bina Boleh Diskalakan**: Infrastruktur carian semantik sedia perusahaan  

## 🚀 Apa Seterusnya

Teruskan dengan **[Makmal 08: Ujian dan Penyahpepijatan](../08-Testing/README.md)** untuk:

- Melaksanakan strategi ujian menyeluruh untuk carian semantik  
- Menyahpepijat isu prestasi carian vektor  
- Mengesahkan kualiti dan relevansi embedding  
- Menguji ketepatan sistem cadangan  

## 📚 Sumber Tambahan

### Azure OpenAI
- [Dokumentasi Perkhidmatan Azure OpenAI](https://docs.microsoft.com/azure/cognitive-services/openai/) - Panduan perkhidmatan lengkap  
- [Rujukan API Embedding](https://platform.openai.com/docs/api-reference/embeddings) - Dokumentasi API  
- [Amalan Terbaik untuk Embedding](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Panduan pelaksanaan  

### Pangkalan Data Vektor
- [Dokumentasi pgvector](https://github.com/pgvector/pgvector) - Sambungan vektor PostgreSQL  
- [Pengoptimuman Carian Vektor](https://www.pinecone.io/learn/vector-search-optimization/) - Penalaan prestasi  
- [Algoritma HNSW](https://arxiv.org/abs/1603.09320) - Graf dunia kecil navigasi hierarki  

### Carian Semantik
- [Asas Pengambilan Maklumat](https://nlp.stanford.edu/IR-book/) - Buku teks IR Stanford  
- [Amalan Terbaik Carian Vektor](https://weaviate.io/blog/vector-search-best-practices) - Corak pelaksanaan  
- [Strategi Carian Hibrid](https://blog.vespa.ai/hybrid-search/) - Menggabungkan pendekatan carian yang berbeza  

---

**Sebelumnya**: [Makmal 06: Pembangunan Alat](../06-Tools/README.md)  
**Seterusnya**: [Makmal 08: Ujian dan Penyahpepijatan](../08-Testing/README.md)  
