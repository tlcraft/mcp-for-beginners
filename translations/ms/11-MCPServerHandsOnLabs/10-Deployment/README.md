...
Makmal ini menyediakan panduan lengkap untuk menggunakan pelayan MCP runcit anda ke persekitaran pengeluaran menggunakan pendekatan kontainerisasi moden dan berasaskan awan. Anda akan belajar cara menggunakan pelayan MCP yang boleh diskalakan, selamat, dan dipantau untuk menangani beban kerja perusahaan.

## Gambaran Keseluruhan

Penggunaan pelayan MCP ke pengeluaran memerlukan pertimbangan teliti terhadap kontainerisasi, orkestrasi, keselamatan, skalabiliti, dan pemantauan. Makmal ini meliputi penggunaan ke Azure Container Apps dengan PostgreSQL Flexible Server, pelaksanaan saluran CI/CD, dan konfigurasi auto-scaling untuk beban kerja yang berubah-ubah.

Strategi penggunaan merangkumi dari penggunaan kontainer tunggal yang mudah untuk pembangunan hingga persekitaran pengeluaran multi-wilayah yang canggih, auto-scaling dengan ciri pemantauan dan keselamatan yang komprehensif.

## Objektif Pembelajaran

Menjelang akhir makmal ini, anda akan dapat:

- **Kontainerisasi** pelayan MCP menggunakan Docker dengan binaan berbilang peringkat
- **Menggunakan** ke Azure Container Apps dengan rangkaian yang selamat
- **Mengkonfigurasi** PostgreSQL gred pengeluaran dengan ketersediaan tinggi
- **Melaksanakan** saluran CI/CD untuk penggunaan automatik
- **Menskalakan** aplikasi secara automatik berdasarkan permintaan
- **Memantau** penggunaan pengeluaran dengan pemerhatian yang komprehensif

## 🐳 Kontainerisasi Docker

### Dockerfile Berbilang Peringkat
...
### Docker Compose untuk Pembangunan
...
## ☁️ Penggunaan Azure Container Apps
...
## 🔐 Konfigurasi Keselamatan Pengeluaran
...
✅ **Strategi Kontainer**: Kontainer Docker sedia pengeluaran dengan pengukuhan keselamatan  
✅ **Penggunaan Awan**: Azure Container Apps dengan auto-scaling dan pemantauan  
✅ **Penggunaan Pangkalan Data**: PostgreSQL Flexible Server dengan ketersediaan tinggi  
✅ **Saluran CI/CD**: Alur kerja ujian, binaan, dan penggunaan automatik  
✅ **Pemantauan Prestasi**: Pengumpulan metrik yang komprehensif dan amaran  
✅ **Konfigurasi Keselamatan**: Polisi keselamatan gred pengeluaran dan pengasingan rangkaian  

## 🚀 Apa Seterusnya

Teruskan dengan **[Makmal 11: Pemantauan dan Pemerhatian](../11-Monitoring/README.md)** untuk:

- Menyediakan pemantauan komprehensif dengan Application Insights
- Mengkonfigurasi log berstruktur dan penjejakan teragih
- Melaksanakan sistem amaran dan tindak balas automatik
- Memantau metrik perniagaan dan KPI prestasi

## 📚 Sumber Tambahan

### Teknologi Kontainer
- [Amalan Terbaik Docker](https://docs.docker.com/develop/dev-best-practices/) - Amalan terbaik rasmi Docker
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Dokumentasi Azure Container Apps
- [Dokumentasi Kubernetes](https://kubernetes.io/docs/) - Dokumentasi rasmi Kubernetes

### CI/CD dan DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - Dokumentasi GitHub Actions
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Perkhidmatan Azure DevOps
- [Infrastruktur sebagai Kod](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Dokumentasi Azure Bicep

### Keselamatan dan Pemantauan
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Cadangan keselamatan Azure
- [Keselamatan Kontainer](https://kubernetes.io/docs/concepts/security/) - Konsep keselamatan Kubernetes
...
**Sebelumnya**: [Makmal 09: Integrasi VS Code](../09-VS-Code/README.md)  
**Seterusnya**: [Makmal 11: Pemantauan dan Pemerhatian](../11-Monitoring/README.md)
