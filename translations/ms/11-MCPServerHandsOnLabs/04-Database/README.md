...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T20:00:51+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "ms"
}
-->
# Reka Bentuk dan Skema Pangkalan Data

## 🎯 Apa Yang Diliputi Dalam Makmal Ini

Makmal ini mendalami reka bentuk pangkalan data PostgreSQL untuk sistem Zava Retail. Anda akan belajar untuk melaksanakan skema runcit yang komprehensif dengan keupayaan carian vektor, pemodelan data multi-penyewa, dan Row Level Security (RLS) untuk pengasingan data.

## Gambaran Keseluruhan

Pangkalan data adalah asas kepada pelayan MCP kami, menyimpan data runcit merentasi pelbagai kedai sambil mengekalkan pengasingan data yang ketat. Kami menggunakan PostgreSQL dengan sambungan pgvector untuk membolehkan keupayaan carian semantik, membolehkan pelanggan mencari produk menggunakan pertanyaan bahasa semula jadi.

Skema kami mengikuti corak multi-penyewa moden dengan Row Level Security yang memastikan pengguna hanya boleh mengakses data dari kedai yang mereka diberi kuasa. Pendekatan ini menyediakan keselamatan bertaraf perusahaan sambil mengekalkan prestasi yang optimum.

## Objektif Pembelajaran

Menjelang akhir makmal ini, anda akan dapat:

- **Mereka bentuk** skema pangkalan data runcit multi-penyewa yang boleh diskalakan
- **Melaksanakan** PostgreSQL dengan pgvector untuk carian vektor
- **Mengkonfigurasi** Row Level Security untuk pengasingan data
- **Menjana** data sampel yang realistik untuk ujian
- **Mengoptimumkan** prestasi pangkalan data untuk beban kerja runcit
- **Melaksanakan** strategi sandaran dan pemulihan

## 🗃️ Seni Bina Pangkalan Data

### PostgreSQL dengan pgvector

Pangkalan data kami memanfaatkan ciri perusahaan PostgreSQL yang digabungkan dengan sambungan pgvector untuk carian berkuasa AI:
...
### Seni Bina Multi-Penyewa

Pangkalan data menggunakan model multi-penyewa **pangkalan data dikongsi, skema dikongsi** dengan Row Level Security:
...
## 📊 Reka Bentuk Skema Teras

### Jadual Kedai (Tenant Master)
...
## 🔍 Pelaksanaan Carian Vektor

### Jadual Embedding Produk
...
## 🔐 Persediaan Row Level Security

### Peranan dan Kebenaran Pangkalan Data
...
### Paparan Pengoptimuman Pertanyaan
...
Selepas menyelesaikan makmal ini, anda sepatutnya telah:

✅ **Reka Bentuk Pangkalan Data Multi-Penyewa**: Melaksanakan Row Level Security untuk pengasingan data yang selamat  
✅ **Keupayaan Carian Vektor**: Mengkonfigurasi pgvector untuk carian semantik produk  
✅ **Skema Komprehensif**: Mencipta skema pangkalan data runcit yang sedia untuk pengeluaran  
✅ **Penjanaan Data Sampel**: Membina data ujian yang realistik untuk pembangunan dan ujian  
✅ **Pengoptimuman Prestasi**: Mengkonfigurasi indeks dan pengoptimuman pertanyaan  
✅ **Sandaran dan Pemulihan**: Menubuhkan strategi perlindungan data yang kukuh  

## 🚀 Apa Seterusnya

Teruskan dengan **[Lab 05: Pelaksanaan Pelayan MCP](../05-MCP-Server/README.md)** untuk:

- Membina pelayan FastMCP yang berhubung dengan pangkalan data ini
- Melaksanakan alat pertanyaan pangkalan data untuk protokol MCP
- Menambah keupayaan carian semantik menggunakan embedding
- Mengkonfigurasi pengumpulan sambungan dan pengendalian ralat

## 📚 Sumber Tambahan

### PostgreSQL & pgvector
- [Dokumentasi PostgreSQL](https://www.postgresql.org/docs/) - Rujukan lengkap PostgreSQL
- [Sambungan pgvector](https://github.com/pgvector/pgvector) - Carian persamaan vektor untuk PostgreSQL
- [Pengoptimuman Prestasi PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Amalan terbaik pengoptimuman

### Seni Bina Multi-Penyewa
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Dokumentasi RLS PostgreSQL
- [Seni Bina Data Multi-Penyewa](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Corak seni bina Azure
- [Amalan Terbaik Keselamatan Pangkalan Data](https://www.postgresql.org/docs/current/security.html) - Panduan keselamatan PostgreSQL

### Pangkalan Data Vektor
- [Asas Carian Vektor](https://www.pinecone.io/learn/vector-database/) - Memahami pangkalan data vektor
- [Model Embedding](https://platform.openai.com/docs/guides/embeddings) - Dokumentasi embedding OpenAI
- [Algoritma HNSW](https://arxiv.org/abs/1603.09320) - Graf Hierarchical Navigable Small World

---

**Sebelumnya**: [Lab 03: Persediaan Persekitaran](../03-Setup/README.md)  
**Seterusnya**: [Lab 05: Pelaksanaan Pelayan MCP](../05-MCP-Server/README.md)
