...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:50:49+00:00",
...
Makmal ini menyediakan panduan lengkap untuk melaksanakan pemantauan, pemerhatian, dan pemberitahuan untuk pelayan MCP anda dalam persekitaran pengeluaran. Anda akan belajar cara menyediakan Application Insights, mencipta papan pemuka yang bermakna, melaksanakan pemberitahuan yang berkesan, dan membangunkan aliran kerja penyelesaian masalah untuk kecemerlangan operasi.

## Gambaran Keseluruhan

Pemantauan dan pemerhatian yang berkesan adalah penting untuk mengekalkan pelayan MCP yang boleh dipercayai dalam pengeluaran. Makmal ini merangkumi tiga tonggak pemerhatian—metrik, log, dan jejak—dan menunjukkan cara melaksanakan pemantauan menyeluruh yang membolehkan pengesanan isu secara proaktif dan penyelesaian masalah yang pantas.

Anda akan belajar cara mengubah data telemetri mentah menjadi pandangan yang boleh diambil tindakan untuk membantu anda memahami tingkah laku sistem, mengoptimumkan prestasi, dan memastikan ketersediaan tinggi.

## Objektif Pembelajaran

Menjelang akhir makmal ini, anda akan dapat:

- **Melaksanakan** integrasi Application Insights yang menyeluruh untuk pelayan MCP
- **Mereka bentuk** corak log berstruktur untuk penyelesaian masalah yang berkesan
- **Mencipta** sistem pengumpulan dan analisis metrik prestasi
- **Mengkonfigurasi** pemberitahuan pintar dengan notifikasi yang boleh diambil tindakan
- **Membina** papan pemuka operasi untuk pemantauan masa nyata
- **Membangunkan** aliran kerja penyelesaian masalah dan runbook yang berkesan

## 📊 Integrasi Application Insights

### Menyediakan Application Insights
...
### Log Dipertingkatkan dengan Data Berstruktur
...
### Pelaksanaan Papan Pemuka Tersuai
...
✅ **Integrasi Application Insights**: Persediaan telemetri dan pemantauan lengkap  
✅ **Log Berstruktur**: Log bersedia untuk pengeluaran dengan korelasi dan konteks  
✅ **Metrik Tersuai**: Pengumpulan dan analisis metrik perniagaan dan teknikal  
✅ **Pemberitahuan Pintar**: Pemberitahuan proaktif dengan pelbagai saluran notifikasi  
✅ **Papan Pemuka Operasi**: Pemantauan masa nyata dan pandangan perniagaan  
✅ **Aliran Kerja Penyelesaian Masalah**: Diagnostik automatik dan runbook operasi  

## 🚀 Apa Seterusnya

Teruskan dengan **[Makmal 12: Amalan Terbaik dan Pengoptimuman](../12-Best-Practices/README.md)** untuk:

- Menerapkan teknik pengoptimuman prestasi
- Melaksanakan pengukuhan keselamatan yang menyeluruh
- Belajar amalan terbaik untuk pengeluaran
- Membangunkan strategi pengoptimuman kos

## 📚 Sumber Tambahan

### Azure Monitor
- [Dokumentasi Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Panduan pemantauan lengkap
- [Rujukan Pertanyaan KQL](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Bahasa pertanyaan untuk Application Insights
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - Penciptaan papan pemuka tersuai

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - Panduan instrumentasi
- [Jejak Teragih](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - Konsep penjejakan
- [Pengumpulan Metrik](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - Amalan terbaik metrik

### Kecemerlangan Operasi
- [SRE Handbook](https://sre.google/sre-book/table-of-contents/) - Prinsip Kejuruteraan Kebolehpercayaan Laman
- [Amalan Terbaik Pemantauan](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - Amalan terbaik industri
- [Respons Insiden](https://response.pagerduty.com/) - Panduan pengurusan insiden

---

**Sebelumnya**: [Makmal 10: Strategi Pengeluaran](../10-Deployment/README.md)  
**Seterusnya**: [Makmal 12: Amalan Terbaik dan Pengoptimuman](../12-Best-Practices/README.md)
