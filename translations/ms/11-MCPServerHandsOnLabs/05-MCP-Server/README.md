...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T19:34:13+00:00",
...
Makmal praktikal ini membimbing anda untuk melaksanakan pelayan MCP yang sedia untuk pengeluaran menggunakan rangka kerja FastMCP. Anda akan membina struktur pelayan teras, melaksanakan integrasi pangkalan data, mencipta alat untuk akses data, dan mewujudkan asas untuk analitik runcit berkuasa AI.

## Gambaran Keseluruhan

Pelayan MCP adalah nadi kepada penyelesaian analitik runcit kami. Ia bertindak sebagai jambatan antara pembantu AI dan pangkalan data PostgreSQL, menyediakan akses data perniagaan yang selamat dan pintar melalui protokol yang standard.

Makmal ini mengajar anda untuk membina pelayan MCP yang kukuh dan boleh diskalakan mengikut corak perusahaan dan amalan terbaik.

## Objektif Pembelajaran

Pada akhir makmal ini, anda akan dapat:

- **Membina** pelayan FastMCP dengan seni bina dan organisasi yang betul
- **Melaksanakan** integrasi pangkalan data dengan pengumpulan sambungan dan pengendalian ralat
- **Mencipta** alat MCP untuk introspeksi skema pangkalan data dan pelaksanaan pertanyaan
- **Mengkonfigurasi** pengurusan konteks Keselamatan Tahap Baris (Row Level Security)
- **Menambah** ciri pemantauan kesihatan dan pemerhatian
- **Menguji** pelaksanaan pelayan MCP anda secara tempatan dan dengan VS Code

## 📁 Struktur Projek

Mari kita lihat organisasi pelayan MCP:
...
### Konfigurasi Persekitaran (`config.py`)

Pertama, mari kita cipta sistem konfigurasi yang kukuh:
...
### Ciri Utama Konfigurasi

- **Pemuatan Pembolehubah Persekitaran**: Sokongan automatik untuk fail .env
- **Keselamatan Jenis**: Pengesahan dataclass dan petunjuk jenis
- **Default Fleksibel**: Default yang sesuai untuk pembangunan
- **Pengesahan**: Pengesahan konfigurasi dengan mesej ralat yang berguna
- **Keselamatan**: Nilai sensitif hanya daripada pembolehubah persekitaran

## 🗄️ Lapisan Integrasi Pangkalan Data

### Penyedia PostgreSQL (`sales_analysis_postgres.py`)

Mari kita laksanakan lapisan integrasi pangkalan data:
...
### Ciri Utama Lapisan Pangkalan Data

- **Pengumpulan Sambungan**: Pengurusan sumber yang cekap dengan asyncpg
- **Integrasi RLS**: Penetapan konteks Keselamatan Tahap Baris secara automatik
- **Introspeksi Skema**: Penemuan skema jadual secara dinamik
- **Pengendalian Ralat**: Pengurusan ralat dan log yang komprehensif
- **Pemformatan Pertanyaan**: Pemformatan hasil yang mesra AI
- **Pemantauan Kesihatan**: Pemeriksaan kesambungan pangkalan data dan status kumpulan

## 🔧 Pelaksanaan Utama Pelayan MCP

### Pelayan FastMCP (`sales_analysis.py`)

Sekarang mari kita laksanakan pelayan MCP utama:
...
### Ciri Utama Pelayan MCP

- **Pendaftaran Alat**: Definisi alat secara deklaratif dengan keselamatan jenis
- **Pengurusan Konteks RLS**: Pengekstrakan identiti pengguna dan penetapan konteks secara automatik
- **Pengendalian Ralat**: Pengurusan ralat yang komprehensif dengan mesej mesra pengguna
- **Pengurusan Kitaran Hayat**: Permulaan/penghentian yang betul dengan pembersihan sumber
- **Pemantauan Kesihatan**: Titik akhir pemeriksaan kesihatan terbina dalam
- **Sokongan Pembangunan**: Muat semula pantas dan keupayaan nyahpepijat

## 🏥 Pemantauan Kesihatan

### Pelaksanaan Pemeriksaan Kesihatan (`health_check.py`)
...
### Ujian Integrasi VS Code

1. **Konfigurasi VS Code MCP**:
   ```json
   // .vscode/mcp.json
   {
       "servers": {
...
2. **Uji dalam AI Chat**:
   ...
   - Taip `#zava` dan pilih pelayan anda
   - Tanya: "Apakah jadual yang tersedia?"
   - Tanya: "Tunjukkan kepada saya 5 kedai teratas berdasarkan bilangan pesanan"

### Ujian Unit

Cipta ujian unit yang komprehensif:
...
✅ **Pelayan MCP Berfungsi**: Pelayan FastMCP dengan integrasi pangkalan data  
✅ **Pengurusan Konfigurasi**: Konfigurasi berdasarkan persekitaran yang kukuh  
✅ **Lapisan Pangkalan Data**: Integrasi PostgreSQL dengan pengumpulan sambungan  
✅ **Alat MCP**: Alat introspeksi skema dan pelaksanaan pertanyaan  
✅ **Integrasi RLS**: Pengurusan konteks Keselamatan Tahap Baris  
✅ **Pemantauan Kesihatan**: Titik akhir pemeriksaan kesihatan yang komprehensif  
✅ **Strategi Ujian**: Ujian tempatan dan integrasi VS Code  

## 🚀 Apa Seterusnya

Teruskan dengan **[Makmal 06: Pembangunan Alat](../06-Tools/README.md)** untuk:

- Mengembangkan koleksi alat MCP anda
- Melaksanakan corak pertanyaan lanjutan
- Menambah pengesahan dan transformasi data
- Mencipta alat analitik khusus

## 📚 Sumber Tambahan

### Rangka Kerja FastMCP
- [Dokumentasi FastMCP](https://github.com/modelcontextprotocol/python-sdk) - Panduan rasmi FastMCP
- [Spesifikasi MCP](https://modelcontextprotocol.io/docs/) - Spesifikasi protokol
- [Panduan Pembangunan Alat](https://modelcontextprotocol.io/docs/tools/) - Mencipta alat MCP

### Integrasi Pangkalan Data
- [Dokumentasi asyncpg](https://magicstack.github.io/asyncpg/current/) - Pemacu PostgreSQL async
- [Amalan Terbaik Pengumpulan Sambungan](https://www.postgresql.org/docs/current/runtime-config-connection.html) - Penalaan PostgreSQL
- [Panduan Keselamatan Tahap Baris](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Pelaksanaan RLS

### Corak FastAPI
- [Dokumentasi FastAPI](https://fastapi.tiangolo.com/) - Rujukan rangka kerja web
- [Suntikan Kebergantungan](https://fastapi.tiangolo.com/tutorial/dependencies/) - Corak FastAPI
- [Tugas Latar Belakang](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Pengurusan tugas async

---

**Seterusnya**: Sedia untuk mengembangkan alat anda? Teruskan dengan [Makmal 06: Pembangunan Alat](../06-Tools/README.md)
