...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T20:05:41+00:00",
...
Makmal ini mendalami penciptaan alat MCP yang canggih untuk memberikan pembantu AI keupayaan pertanyaan pangkalan data yang kuat, introspeksi skema, dan fungsi analitik. Anda akan belajar membina alat yang berkuasa dan selamat, dengan pengendalian ralat yang menyeluruh dan pengoptimuman prestasi.

## Gambaran Keseluruhan

Alat MCP adalah antara muka antara pembantu AI dan sistem data anda. Alat yang direka dengan baik menyediakan akses terstruktur dan disahkan kepada operasi kompleks sambil mengekalkan keselamatan dan prestasi. Makmal ini merangkumi keseluruhan kitaran hayat pembangunan alat dari reka bentuk hingga pelaksanaan.

Pelayan MCP runcit kami melaksanakan suite alat yang komprehensif yang membolehkan pertanyaan bahasa semula jadi terhadap data jualan, katalog produk, dan analitik perniagaan sambil mengekalkan sempadan keselamatan yang ketat dan prestasi yang optimum.

## Objektif Pembelajaran

Menjelang akhir makmal ini, anda akan dapat:

- **Mereka Bentuk** alat MCP canggih dengan pengesahan parameter yang kompleks  
- **Melaksanakan** alat pertanyaan pangkalan data yang selamat dengan perlindungan suntikan SQL  
- **Mencipta** keupayaan introspeksi skema untuk pertanyaan dinamik  
- **Membina** alat analitik tersuai untuk kecerdasan perniagaan  
- **Mengaplikasikan** pengendalian ralat yang menyeluruh dan penurunan prestasi yang terkawal  
- **Mengoptimumkan** prestasi alat untuk beban kerja pengeluaran  

## 🛠️ Seni Bina Alat Teras
...
### Pengesahan Pertanyaan dan Keselamatan
...
## 🗃️ Alat Pertanyaan Pangkalan Data
...
## 📊 Alat Analitik dan Utiliti

### Alat Kecerdasan Perniagaan
...
Selepas melengkapkan makmal ini, anda seharusnya mempunyai:

✅ **Seni Bina Alat Canggih**: Melaksanakan alat MCP yang canggih dengan pengendalian ralat yang menyeluruh  
✅ **Pengesahan Pertanyaan**: Membina pengesahan SQL yang selamat untuk mencegah serangan suntikan  
✅ **Alat Pangkalan Data**: Mencipta keupayaan analisis jualan dan introspeksi skema yang berkuasa  
✅ **Kecerdasan Perniagaan**: Membangunkan alat analitik untuk pandangan perniagaan yang komprehensif  
✅ **Pengoptimuman Prestasi**: Mengaplikasikan caching, pengumpulan sambungan, dan pengoptimuman pertanyaan  
✅ **Integrasi Keselamatan**: Melaksanakan kawalan akses berdasarkan peranan dan log audit  

## 🚀 Apa Seterusnya

Teruskan dengan **[Makmal 07: Integrasi Carian Semantik](../07-Semantic-Search/README.md)** untuk:

- Mengintegrasikan keupayaan carian vektor dengan alat MCP  
- Membina fungsi carian produk semantik  
- Melaksanakan pemahaman pertanyaan yang dikuasakan AI  
- Mencipta carian hibrid yang menggabungkan pertanyaan tradisional dan vektor  

## 📚 Sumber Tambahan

### Pembangunan Alat MCP
- [Dokumentasi Protokol Konteks Model](https://modelcontextprotocol.io/docs) - Spesifikasi rasmi MCP  
- [Kerangka FastMCP](https://github.com/jlowin/fastmcp) - Pelaksanaan MCP Python  
- [Corak Alat MCP](https://github.com/modelcontextprotocol/servers) - Pelaksanaan alat contoh  

### Keselamatan Pangkalan Data
- [Pencegahan Suntikan SQL](https://owasp.org/www-community/attacks/SQL_Injection) - Panduan keselamatan OWASP  
- [Keselamatan PostgreSQL](https://www.postgresql.org/docs/current/security.html) - Amalan terbaik keselamatan pangkalan data  
- [Teknik Pengesahan Pertanyaan](https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html) - Corak pertanyaan yang selamat  

### Pengoptimuman Prestasi
- [Pengoptimuman Pertanyaan Pangkalan Data](https://www.postgresql.org/docs/current/performance-tips.html) - Panduan prestasi PostgreSQL  
- [Amalan Terbaik Pengumpulan Sambungan](https://www.postgresql.org/docs/current/runtime-config-connection.html) - Pengurusan sambungan  
- [Corak Python Asinkron](https://docs.python.org/3/library/asyncio.html) - Panduan pengaturcaraan asinkron  

---

**Sebelumnya**: [Makmal 05: Pelaksanaan Pelayan MCP](../05-MCP-Server/README.md)  
**Seterusnya**: [Makmal 07: Integrasi Carian Semantik](../07-Semantic-Search/README.md)  
