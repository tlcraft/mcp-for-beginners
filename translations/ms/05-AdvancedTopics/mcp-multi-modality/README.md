...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T08:07:29+00:00",
...
## Contoh Multi-Modal: Analisis Imej
...
- Mencipta `ImageAnalysisTool` yang boleh menganalisis imej menggunakan `IImageAnalysisService` hipotetikal.
- Mengkonfigurasi pelayan MCP untuk mengendalikan permintaan yang lebih besar dan menyokong jenis kandungan imej.
...
## Contoh Multi-Modal: Pemprosesan Audio
...
- Mencipta `AudioTranscriptionTool` yang boleh menyalin fail audio.
- Mendefinisikan skema alat untuk menerima sama ada URL atau data audio yang disandikan base64.
- Melaksanakan kaedah `execute` untuk mengendalikan pemprosesan audio dan transkripsi.
- Mengkonfigurasi pelayan MCP untuk mengendalikan permintaan multi-modal, termasuk pemprosesan audio dan imej.
...
- Menggunakan perkhidmatan `AudioProcessor` untuk mengendalikan logik transkripsi sebenar.
- Memulakan pelayan MCP untuk mendengar permintaan.

### Contoh Multi-Modal: Penjanaan Respons Multi-Modal
