...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T14:01:21+00:00",
...
Протокол MCP є стандартом, що розвивається, використовуючи версії на основі дати (формат YYYY-MM-DD). Поточна версія протоколу — **2025-06-18**. Ви можете переглянути останні оновлення [специфікації протоколу](https://modelcontextprotocol.io/specification/2025-06-18/).
...
- **Запит `initialize`**: Встановлює з'єднання та узгоджує версію протоколу й можливості  
