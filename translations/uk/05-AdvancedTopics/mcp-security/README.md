...
<<<<<<< HEAD
  "translation_date": "2025-08-18T22:52:49+00:00",
=======
  "translation_date": "2025-08-18T18:13:27+00:00",
>>>>>>> origin/main
...
> **Поточний стандарт**: Цей посібник відповідає вимогам безпеки [MCP Specification 2025-06-18](https://spec.modelcontextprotocol.io/specification/2025-06-18/) та офіційним [MCP Security Best Practices](https://modelcontextprotocol.io/specification/2025-06-18/basic/security_best_practices).

Безпека є критично важливою для реалізації MCP, особливо в корпоративних середовищах. Цей розширений посібник охоплює комплексні практики безпеки для розгортання MCP у виробничих середовищах, враховуючи як традиційні проблеми безпеки, так і загрози, пов’язані з AI, які є унікальними для Model Context Protocol.

## Вступ

<<<<<<< HEAD
Model Context Protocol (MCP) створює унікальні виклики безпеки, які виходять за межі традиційної програмної безпеки. Оскільки системи AI отримують доступ до інструментів, даних і зовнішніх сервісів, з’являються нові вектори атак, включаючи ін’єкцію підказок, отруєння інструментів, викрадення сесій, проблеми "заплутаного заступника" та вразливості передачі токенів.
=======
Model Context Protocol (MCP) створює унікальні виклики безпеки, які виходять за межі традиційної безпеки програмного забезпечення. Оскільки системи AI отримують доступ до інструментів, даних і зовнішніх сервісів, з’являються нові вектори атак, включаючи ін’єкцію підказок, отруєння інструментів, викрадення сесій, проблеми "заплутаного заступника" та вразливості передачі токенів.
>>>>>>> origin/main

У цьому уроці розглядаються розширені реалізації безпеки на основі останньої специфікації MCP (2025-06-18), рішень безпеки Microsoft та усталених корпоративних шаблонів безпеки.

### **Основні принципи безпеки**

**З MCP Specification (2025-06-18):**

- **Явні заборони**: MCP-сервери **НЕ ПОВИННІ** приймати токени, які не були видані для них, і **НЕ ПОВИННІ** використовувати сесії для автентифікації
- **Обов’язкова перевірка**: Усі вхідні запити **ПОВИННІ** бути перевірені, а згода користувача **ПОВИННА** бути отримана для проксі-операцій
<<<<<<< HEAD
- **Безпечні налаштування за замовчуванням**: Реалізуйте надійні засоби безпеки з підходом "захист у глибину"
=======
- **Безпечні налаштування за замовчуванням**: Реалізуйте надійні заходи безпеки з підходом "захист у глибину"
>>>>>>> origin/main
- **Контроль користувача**: Користувачі повинні надати явну згоду перед доступом до будь-яких даних або виконанням інструментів

## Навчальні цілі

До кінця цього розширеного уроку ви зможете:

- **Реалізувати розширену автентифікацію**: Впровадити інтеграцію з зовнішніми постачальниками ідентифікації, такими як Microsoft Entra ID, та шаблони безпеки OAuth 2.1
- **Запобігати атакам, специфічним для AI**: Захиститися від ін’єкції підказок, отруєння інструментів і викрадення сесій за допомогою Microsoft Prompt Shields та Azure Content Safety
- **Застосовувати корпоративну безпеку**: Реалізувати комплексне логування, моніторинг і реагування на інциденти для виробничих розгортань MCP  
- **Забезпечити безпечне виконання інструментів**: Проєктувати ізольовані середовища виконання з належним контролем ресурсів
<<<<<<< HEAD
- **Усувати вразливості MCP**: Виявляти та пом’якшувати проблеми "заплутаного заступника", вразливості передачі токенів і ризики ланцюга постачання
=======
- **Усунути вразливості MCP**: Виявляти та пом’якшувати проблеми "заплутаного заступника", вразливості передачі токенів і ризики ланцюга постачання
>>>>>>> origin/main
- **Інтегрувати безпеку Microsoft**: Використовувати служби безпеки Azure та GitHub Advanced Security для комплексного захисту

## **ОБОВ’ЯЗКОВІ вимоги до безпеки**

### **Критичні вимоги з MCP Specification (2025-06-18):**
...
Сучасні реалізації MCP виграють від еволюції специфікації в напрямку делегування зовнішнім постачальникам ідентифікації, що значно покращує рівень безпеки порівняно з кастомними реалізаціями автентифікації.

### **Інтеграція Microsoft Entra ID**

Поточна специфікація MCP (2025-06-18) дозволяє делегування зовнішнім постачальникам ідентифікації, таким як Microsoft Entra ID, забезпечуючи функції безпеки корпоративного рівня:

**Переваги безпеки:**
- Багатофакторна автентифікація (MFA) корпоративного рівня
- Політики умовного доступу на основі оцінки ризиків
- Централізоване управління життєвим циклом ідентифікації
- Захист від загроз і виявлення аномалій
- Відповідність корпоративним стандартам безпеки

### Реалізація .NET з Entra ID

Розширена реалізація з використанням екосистеми безпеки Microsoft:
...
Розширена реалізація Spring Security відповідно до шаблонів безпеки OAuth 2.1, передбачених специфікацією MCP:
...
## Контроль безпеки, специфічний для AI, та рішення Microsoft

### **Захист від ін’єкції підказок за допомогою Microsoft Prompt Shields**

Сучасні реалізації MCP стикаються зі складними атаками, специфічними для AI, які потребують спеціалізованого захисту:
...
## Розширене пом’якшення загроз безпеки MCP

### **1. Запобігання атакам "заплутаного заступника"**

**Розширена реалізація відповідно до MCP Specification (2025-06-18):**
...
### **Комплексне логування з Azure Application Insights**
...
Автентифікація та авторизація:
  Інтеграція зовнішніх постачальників ідентифікації (Microsoft Entra ID)
...
Контроль безпеки AI:
  ...
  Перевірка контенту за допомогою Azure Content Safety  
...
- **Інтегрована безпека**: Уніфікований захист ідентифікації, інфраструктури та додатків
- **Розширений захист AI**: Спеціалізовані засоби захисту від загроз, специфічних для AI  
<<<<<<< HEAD
- **Відповідність корпоративним стандартам**: Вбудована підтримка регуляторних вимог та галузевих стандартів
- **Інтелект загроз**: Інтеграція глобальної інформації про загрози для проактивного захисту
- **Масштабована архітектура**: Масштабування корпоративного рівня з підтримкою засобів безпеки
=======
- **Відповідність корпоративним стандартам**: Вбудована підтримка регуляторних вимог і галузевих стандартів
- **Інтелект загроз**: Інтеграція глобальної інформації про загрози для проактивного захисту
- **Масштабована архітектура**: Масштабування корпоративного рівня з підтримкою заходів безпеки
>>>>>>> origin/main
...
<<<<<<< HEAD
> **Повідомлення про безпеку**: Цей посібник з розширеної реалізації відображає вимоги поточної специфікації MCP (2025-06-18). Завжди перевіряйте відповідність останній офіційній документації та враховуйте ваші конкретні вимоги до безпеки та модель загроз під час впровадження цих засобів контролю.

## Що далі

- [5.9 Пошук у вебі](../web-search-mcp/README.md)

**Відмова від відповідальності**:  
Цей документ було перекладено за допомогою сервісу автоматичного перекладу [Co-op Translator](https://github.com/Azure/co-op-translator). Хоча ми прагнемо до точності, зверніть увагу, що автоматичні переклади можуть містити помилки або неточності. Оригінальний документ мовою оригіналу слід вважати авторитетним джерелом. Для критично важливої інформації рекомендується професійний людський переклад. Ми не несемо відповідальності за будь-які непорозуміння або неправильні тлумачення, що виникли внаслідок використання цього перекладу.
=======
> **Повідомлення про безпеку**: Цей посібник з розширеної реалізації відображає вимоги поточної специфікації MCP (2025-06-18). Завжди перевіряйте відповідність останній офіційній документації та враховуйте ваші конкретні вимоги до безпеки та модель загроз під час реалізації цих заходів.
