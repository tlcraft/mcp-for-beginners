...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-19T19:15:10+00:00",
  "source_file": "05-AdvancedTopics/mcp-security/README.md",
  "language_code": "uk"
}
-->
# Рекомендації з безпеки MCP - Посібник з розширеної реалізації
...
Безпека є критично важливою для реалізації MCP, особливо в корпоративних середовищах. Цей розширений посібник охоплює комплексні практики безпеки для розгортання MCP у виробничих середовищах, враховуючи як традиційні загрози, так і специфічні для штучного інтелекту ризики, притаманні Model Context Protocol.

## Вступ

Model Context Protocol (MCP) створює унікальні виклики для безпеки, які виходять за межі традиційної програмної безпеки. Оскільки системи штучного інтелекту отримують доступ до інструментів, даних і зовнішніх сервісів, з'являються нові вектори атак, такі як ін'єкція підказок, отруєння інструментів, викрадення сесій, проблеми "заплутаного заступника" та вразливості передачі токенів.

Цей урок досліджує розширені реалізації безпеки на основі останньої специфікації MCP (2025-06-18), рішень Microsoft у сфері безпеки та перевірених корпоративних шаблонів безпеки.
...
- **Безпечні налаштування за замовчуванням**: Реалізуйте захисні механізми з підходом "захист у глибину"
- **Контроль користувача**: Користувачі повинні надавати явну згоду перед доступом до даних або виконанням інструментів

## Навчальні цілі

До кінця цього розширеного уроку ви зможете:

- **Реалізувати розширену автентифікацію**: Інтегрувати зовнішні постачальники ідентифікації, такі як Microsoft Entra ID, та використовувати шаблони безпеки OAuth 2.1
- **Запобігати атакам, специфічним для ШІ**: Захищатися від ін'єкції підказок, отруєння інструментів і викрадення сесій за допомогою Microsoft Prompt Shields та Azure Content Safety
...
- **Усувати вразливості MCP**: Виявляти та зменшувати ризики "заплутаного заступника", передачі токенів і ризики ланцюга постачання
- **Інтегрувати рішення Microsoft**: Використовувати служби безпеки Azure та GitHub Advanced Security для комплексного захисту
...
Сучасні реалізації MCP отримують переваги від еволюції специфікації у напрямку делегування зовнішнім постачальникам ідентифікації, що значно покращує рівень безпеки порівняно з кастомними реалізаціями автентифікації.
...
Покращена реалізація Spring Security відповідно до шаблонів безпеки OAuth 2.1, передбачених специфікацією MCP:
...
## Контроль безпеки для ШІ та рішення Microsoft

### **Захист від ін'єкції підказок за допомогою Microsoft Prompt Shields**

Сучасні реалізації MCP стикаються зі складними атаками, специфічними для ШІ, що вимагає спеціалізованих засобів захисту:
...
## Розширене усунення загроз безпеки MCP

### **1. Запобігання атакам "заплутаного заступника"**

**Покращена реалізація відповідно до MCP Specification (2025-06-18):**
...
- **Розширений захист ШІ**: Спеціалізовані засоби захисту від загроз, специфічних для ШІ  
- **Корпоративна відповідність**: Вбудована підтримка регуляторних вимог і галузевих стандартів
- **Інтелект загроз**: Інтеграція глобальної інформації про загрози для проактивного захисту
- **Масштабована архітектура**: Масштабування корпоративного рівня з підтримкою безпеки
...
> **Повідомлення про безпеку**: Цей посібник з розширеної реалізації відповідає вимогам поточної специфікації MCP (2025-06-18). Завжди перевіряйте відповідність останній офіційній документації та враховуйте ваші конкретні вимоги до безпеки та модель загроз під час реалізації цих заходів.

## Що далі

- [5.9 Пошук у веб](../web-search-mcp/README.md)
