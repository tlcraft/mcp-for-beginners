...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T14:40:08+00:00",
...
Цей посібник демонструє, як інтегрувати сервери Model Context Protocol (MCP) з агентами Azure AI Foundry, що дозволяє ефективно організовувати інструменти та використовувати корпоративні можливості штучного інтелекту.
...
**Note:** Якщо ви хочете використовувати MCP у службі Azure AI Foundry Agent Service, наразі підтримуються лише такі регіони: westus, westus2, uaenorth, southindia та switzerlandnorth
...
***Note*** Ви можете запустити цей [ноутбук](../../../../05-AdvancedTopics/mcp-foundry-agent-integration/mcp_support_python.ipynb)
...
***Note*** Ви можете запустити цей [ноутбук](../../../../05-AdvancedTopics/mcp-foundry-agent-integration/mcp_support_dotnet.ipynb)
