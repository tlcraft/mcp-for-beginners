...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T07:22:18+00:00",
  "source_file": "05-AdvancedTopics/mcp-foundry-agent-integration/README.md",
  "language_code": "uk"
}
-->
# Model Context Protocol (MCP) Інтеграція з Azure AI Foundry

Цей посібник демонструє, як інтегрувати сервери Model Context Protocol (MCP) з агентами Azure AI Foundry, що дозволяє ефективно організовувати роботу інструментів та забезпечувати корпоративні можливості штучного інтелекту.

## Вступ

Model Context Protocol (MCP) — це відкритий стандарт, який дозволяє AI-додаткам безпечно підключатися до зовнішніх джерел даних та інструментів. При інтеграції з Azure AI Foundry MCP дає змогу агентам отримувати доступ і взаємодіяти з різними зовнішніми сервісами, API та джерелами даних у стандартизований спосіб.
...
- **Стандартизована інтеграція**: Єдиний інтерфейс для різних інструментів і сервісів
...
- [Реалізація на Python](../../../../05-AdvancedTopics/mcp-foundry-agent-integration)
- [Реалізація на .NET](../../../../05-AdvancedTopics/mcp-foundry-agent-integration)
...
4. **Масштабування рішення**: Розгляньте балансування навантаження та розподілену архітектуру серверів MCP
