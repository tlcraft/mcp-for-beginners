...
<<<<<<< HEAD
  "translation_date": "2025-08-18T22:52:28+00:00",
=======
...
<<<<<<< HEAD
|-----------|-------|------|
| [5.1 Інтеграція з Azure](./mcp-integration/README.md) | Інтеграція з Azure | Дізнайтеся, як інтегрувати ваш сервер MCP на платформі Azure |
=======
|-----------|-------|-------|
...
<<<<<<< HEAD
| [5.6 Семплінг](./mcp-sampling/README.md) | Семплінг | Дізнайтеся, як працювати із семплінгом |
| [5.7 Масштабування](./mcp-scaling/README.md) | Масштабування | Дізнайтеся про масштабування |
| [5.8 Безпека](./mcp-security/README.md) | Безпека | Захистіть ваш сервер MCP |
| [5.9 Приклад веб-пошуку](./web-search-mcp/README.md) | Веб-пошук MCP | Сервер і клієнт MCP на Python, що інтегруються з SerpAPI для реального часу веб-, новинного, товарного пошуку та Q&A. Демонструє оркестрацію багатофункціональних інструментів, інтеграцію зовнішніх API та надійне оброблення помилок. |
| [5.10 Потокова передача в реальному часі](./mcp-realtimestreaming/README.md) | Потокова передача | Потокова передача даних у реальному часі стала важливою в сучасному світі, де бізнес і додатки потребують негайного доступу до інформації для прийняття своєчасних рішень. |
...
| [5.12 Аутентифікація Entra ID для серверів MCP](./mcp-security-entra/README.md) | Аутентифікація Entra ID | Microsoft Entra ID забезпечує надійне хмарне рішення для управління ідентифікацією та доступом, допомагаючи гарантувати, що лише авторизовані користувачі та додатки можуть взаємодіяти з вашим сервером MCP. |
| [5.13 Інтеграція агента Azure AI Foundry](./mcp-foundry-agent-integration/README.md) | Інтеграція Azure AI Foundry | Дізнайтеся, як інтегрувати сервери MCP з агентами Azure AI Foundry, забезпечуючи потужну оркестрацію інструментів і корпоративні AI-можливості зі стандартизованими підключеннями до зовнішніх джерел даних. |
| [5.14 Інженерія контексту](./mcp-contextengineering/README.md) | Інженерія контексту | Майбутні можливості технік інженерії контексту для серверів MCP, включаючи оптимізацію контексту, динамічне управління контекстом і стратегії ефективного створення запитів у рамках MCP. |
=======
