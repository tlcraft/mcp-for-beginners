...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T22:48:24+00:00",
...
**Model Context Protocol (MCP)** — це сучасна структура, розроблена для стандартизації взаємодії між AI-моделями та клієнтськими додатками. Ця навчальна програма з відкритим кодом пропонує структурований шлях навчання, включаючи практичні приклади коду та реальні випадки використання, на популярних мовах програмування, таких як C#, Java, JavaScript, TypeScript та Python.
...
| 11.2 | Основна архітектура | Розуміння архітектури сервера MCP, шарів бази даних та моделей безпеки | [Лабораторія 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
...
| 11.5 | Проектування бази даних | Налаштування PostgreSQL, проектування схеми для роздрібної торгівлі та зразкові дані | [Lab 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
...
| 11.9 | Тестування та налагодження | Стратегії тестування, інструменти для налагодження та підходи до перевірки | [Lab 08](./11-MCPServerHandsOnLabs/08-Testing/README.md) |
...
Щоб максимально ефективно засвоїти цей матеріал, вам слід мати:
...
Цей проєкт може містити торговельні марки або логотипи для проєктів, продуктів чи послуг. Дозволене використання торговельних марок або логотипів Microsoft підпорядковується та має відповідати [Керівництву щодо торговельних марок та брендів Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). Використання торговельних марок або логотипів Microsoft у змінених версіях цього проєкту не повинно викликати плутанину або натякати на спонсорство з боку Microsoft. Будь-яке використання торговельних марок або логотипів третіх сторін підпорядковується політикам цих третіх сторін.
