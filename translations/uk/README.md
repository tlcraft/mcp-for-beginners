...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-02T06:30:30+00:00",
...
3. [**Приєднуйтесь до Azure AI Foundry Discord, щоб зустріти експертів і інших розробників**](https://discord.com/invite/ByRwuEEgH4)
...
**Model Context Protocol (MCP)** — це сучасний фреймворк, створений для стандартизації взаємодії між AI-моделями та клієнтськими додатками. Ця відкрита навчальна програма пропонує структурований шлях навчання з практичними прикладами коду та реальними кейсами, охоплюючи популярні мови програмування: C#, Java, JavaScript, TypeScript та Python.

Чи ви розробник AI, системний архітектор чи інженер-програміст — цей посібник стане вашим повним ресурсом для опанування основ MCP та стратегій його впровадження.
...
Приготуйтеся до двох днів глибоких технічних знань, спілкування з спільнотою та практичного навчання на MCP Dev Days — віртуальному заході, присвяченому Model Context Protocol (MCP) — новому стандарту, що поєднує AI-моделі та інструменти, на яких вони базуються.

➡️ [Реєстрація на MCP Dev Days](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

Ви можете дивитися MCP Dev Days, зареєструвавшись на сторінці заходу: https://aka.ms/mcpdevdays. Там ви зможете приєднатися до прямої трансляції на YouTube або Twitch. Весь контент буде записаний і доступний пізніше на каналі Microsoft Developer у YouTube. Вихідний код демонстрацій також буде доступний на GitHub.

### Деталі заходу
- Дати: 29 липня (День 1) та 30 липня (День 2)
- Час: 9:00 ранку за PST щодня
- Де: Онлайн — приєднуйтесь звідки завгодно!

#### День 1: Продуктивність MCP, DevTools та спільнота

Присвячений тому, щоб допомогти розробникам ефективно використовувати MCP у своїй роботі та відзначити неймовірну спільноту MCP. До нас приєднаються учасники спільноти та партнери, такі як Arcade, Block, Okta та Neon, щоб показати, як вони співпрацюють з Microsoft для формування відкритої, розширюваної екосистеми MCP. Реальні демонстрації у VS Code, Visual Studio, GitHub Copilot та популярних інструментах спільноти.
Практичні робочі процеси, орієнтовані на контекст.
Сесії та інсайти від спільноти.
Чи тільки починаєте працювати з MCP, чи вже створюєте проекти — День 1 надихне вас і дасть корисні поради.

#### День 2: Створення MCP серверів з упевненістю

Присвячений розробникам MCP. Ми заглибимося в стратегії впровадження та кращі практики створення MCP серверів та інтеграції MCP у ваші AI-робочі процеси.

### Теми включають:

- Створення MCP серверів та інтеграція їх у агентські середовища
...
Якщо ви розробник, творець інструментів або стратег AI-продуктів, цей день буде насичений знаннями, необхідними для створення масштабованих, безпечних та готових до майбутнього рішень MCP.
...
- **01. Пояснення основних концепцій**  
  Глибоке вивчення основних концепцій MCP. [Читати далі](./01-CoreConcepts/README.md)
- **02. Безпека в MCP**  
  Загрози безпеці та кращі практики. [Читати далі](./02-Security/README.md)
...
<details>
  <summary><strong> Урок 3: Створення та розгортання вашого першого MCP сервера та клієнта</strong></summary>
...
- **3.8. Тестування сервера** – [Посібник](./03-GettingStarted/08-testing/README.md)
- **3.9. Розгортання сервера** – [Посібник](./03-GettingStarted/09-deployment/README.md)
</details>

### Практичні впровадження та просунутий контент Model Context Protocol  
<details>
  <summary><strong> Уроки 4-5: Практичний та просунутий рівень</strong></summary>

- **04. Практичне впровадження**  
  SDK, налагодження, тестування, багаторазові шаблони підказок. [Читати далі](./04-PracticalImplementation/README.md)
...
- **5.4. Кореневі контексти** – [Посібник](./05-AdvancedTopics/mcp-root-contexts/README.md)
...
- **5.11. Пошук в реальному часі у вебі** – [Посібник](./05-AdvancedTopics/mcp-realtimesearch/README.md)
...
## Зразкові проекти Model Context Protocol: створення проекту калькулятора MCP на Java, C#, JavaScript, TypeScript та Python

### 🧮 Зразкові проекти калькулятора MCP на Java, C#, JavaScript, TypeScript та Python  
<details>
...
### 💡 Розширений приклад рішення MCP: проекти калькулятора на C#, Java, JavaScript, TypeScript та Python  
<details>
...
- (За бажанням) Знайомство з концепціями машинного навчання  

## 📚 Навчальний посібник

Доступний детальний [Навчальний посібник](./study_guide.md), який допоможе вам ефективно орієнтуватися в цьому репозиторії. Посібник включає:
...
2. Приклади коду в реальному часі на різних мовах  
...
Цей проект вітає внески та пропозиції. Більшість внесків вимагає, щоб ви погодилися з
Угодою про ліцензію для контрибуторів (CLA), яка підтверджує, що ви маєте право і фактично надаєте
нам права на використання вашого внеску. Деталі за адресою <https://cla.opensource.microsoft.com>.

Під час надсилання pull request, бот CLA автоматично визначить, чи потрібно вам надати
CLA, і відповідно позначить PR (наприклад, перевірка статусу, коментар). Просто дотримуйтесь інструкцій
бота. Цю процедуру потрібно виконати лише один раз для всіх репозиторіїв, що використовують наш CLA.

Цей проект прийняв [Кодекс поведінки Microsoft Open Source](https://opensource.microsoft.com/codeofconduct/).
Детальніше дивіться у [FAQ Кодексу поведінки](https://opensource.microsoft.com/codeofconduct/faq/) або
зв’яжіться з нами за адресою [opencode@microsoft.com](mailto:opencode@microsoft.com) з будь-якими додатковими питаннями чи коментарями.
...
Цей проєкт може містити торговельні марки або логотипи проєктів, продуктів чи послуг. Авторизоване використання торговельних марок або логотипів Microsoft підпорядковується та має відповідати [Правилам використання торговельних марок і брендів Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
Використання торговельних марок або логотипів Microsoft у змінених версіях цього проєкту не повинно викликати плутанину або створювати враження підтримки Microsoft.  
