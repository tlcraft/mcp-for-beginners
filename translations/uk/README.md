...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-23T14:47:13+00:00",
...
- **01. Пояснення ключових концепцій**  
  Глибоке вивчення основних концепцій MCP. [Детальніше](./01-CoreConcepts/README.md)
- **02. Безпека в MCP**  
...
<details>
  <summary><strong>04-05: Практичне застосування та поглиблені теми</strong></summary>

- **04. Практична реалізація**  
  SDK, налагодження, тестування, багаторазові шаблони prompt. [Детальніше](./04-PracticalImplementation/README.md)
- **05. Поглиблені теми MCP**  
...
- **5.11. Пошук в реальному часі в вебі** – [Посібник](./05-AdvancedTopics/mcp-realtimesearch/README.md)
</details>

<details>
  <summary><strong>06-10: Спільнота, найкращі практики та лабораторні роботи</strong></summary>

- **06. Внесок спільноти** – [Посібник](./06-CommunityContributions/README.md)
...
<details>
  <summary><strong>Ознайомтеся з реалізаціями коду за мовами</strong></summary>
...
<details>
  <summary><strong>Ознайомтеся з розширеними зразками</strong></summary>
...
- (За бажанням) Ознайомлення з концепціями машинного навчання  

## 📚 Посібник для навчання

Доступний докладний [Посібник для навчання](./study_guide.md), який допоможе вам ефективно орієнтуватися в цьому репозиторії. Посібник містить:
...
Цей контент ліцензовано за **MIT License**. Умови використання див. у файлі [LICENSE](../../LICENSE).

## 🤝 Правила внеску

Цей проєкт вітає внески та пропозиції. Більшість внесків потребують вашої згоди з Contributor License Agreement (CLA), що підтверджує ваше право надати нам ліцензію на використання вашого внеску. Деталі див. на <https://cla.opensource.microsoft.com>.

Коли ви надсилаєте pull request, бот CLA автоматично визначає, чи потрібно вам надати CLA, і відповідно позначає PR (наприклад, статус перевірки, коментар). Просто дотримуйтесь інструкцій бота. Це потрібно зробити лише один раз для всіх репозиторіїв, які використовують наш CLA.

Цей проєкт прийняв [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).  
Для додаткової інформації див. [Поширені запитання щодо Кодексу поведінки](https://opensource.microsoft.com/codeofconduct/faq/) або звертайтеся за адресою [opencode@microsoft.com](mailto:opencode@microsoft.com).
