...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:06:08+00:00",
...
3. [**Приєднайтеся до Discord Azure AI Foundry, щоб поспілкуватися з експертами та іншими розробниками**](https://discord.com/invite/ByRwuEEgH4)
...
# 🚀 Навчальний курс протоколу контексту моделі (MCP) для початківців

## **Вивчайте MCP за допомогою практичних прикладів коду на C#, Java, JavaScript, Rust, Python та TypeScript**

## 🧠 Огляд навчального курсу протоколу контексту моделі

**Model Context Protocol (MCP)** — це сучасна структура, розроблена для стандартизації взаємодії між AI-моделями та клієнтськими додатками. Цей відкритий навчальний курс пропонує структурований шлях навчання, включаючи практичні приклади коду та реальні випадки використання, на популярних мовах програмування, таких як C#, Java, JavaScript, TypeScript та Python.
...
- 📜 [Оригінальна специфікація MCP](https://spec.modelcontextprotocol.io/) – Технічні посилання на попередню версію (може містити додаткові деталі)  
...
|--------|-------|-------------|------|
| **Модуль 1-3: Основи** | | | |
| 00 | Вступ до MCP | Огляд протоколу контексту моделі та його значення в AI-пайплайнах | [Детальніше](./00-Introduction/README.md) |
...
| 3.5 | Сервер stdio | Створення серверів за допомогою транспорту stdio | [Посібник](./03-GettingStarted/05-stdio-server/README.md) |
...
| Java з Spring | Приклад додатку-контейнера | [Переглянути код](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
Готуйтеся до двох днів глибокого технічного аналізу, спілкування зі спільнотою та практичного навчання на MCP Dev Days — віртуальному заході, присвяченому Model Context Protocol (MCP), новому стандарту, який об'єднує AI-моделі та інструменти, на які вони спираються.
...
Сесії, які ведуться спільнотою, та інсайти
Незалежно від того, чи ви тільки починаєте працювати з MCP, чи вже створюєте з ним, День 1 стане джерелом натхнення та практичних висновків.
...
Навчіться на інтенсивних відеосесіях створювати MCP-сервери, інтегрувати їх із VS Code та професійно розгортати на Azure на основі матеріалів курсу MCP для початківців. Отримайте практичні навички в технології, яку вже використовують провідні компанії.
...
Давайте дізнаємося про Model Context Protocol (MCP), передову структуру, розроблену для стандартизації взаємодії між AI-моделями та клієнтськими додатками. У цьому дружньому до початківців занятті ми познайомимо вас із MCP і допоможемо створити ваш перший MCP-сервер.
...
Дякуємо Microsoft Valued Professional [Шиваму Гойалу](https://www.linkedin.com/in/shivam2003/) за внесок важливих прикладів коду. 
...
Цей проєкт вітає внески та пропозиції. Більшість внесків вимагають від вас погодитися з
Contributor License Agreement (CLA), який підтверджує, що ви маєте право і фактично надаєте нам
права використовувати ваш внесок. Для деталей відвідайте <https://cla.opensource.microsoft.com>.
...
Цей проєкт може містити торговельні марки або логотипи для проєктів, продуктів або послуг. Авторизоване використання торговельних марок або логотипів Microsoft підлягає і повинно відповідати
