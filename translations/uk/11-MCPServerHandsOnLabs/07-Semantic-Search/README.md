...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:37:56+00:00",
...
## 🎯 Що охоплює цей практикум

Цей практикум надає детальні інструкції щодо впровадження можливостей семантичного пошуку за допомогою вбудовувань Azure OpenAI та розширення pgvector для PostgreSQL. Ви навчитеся створювати пошук продуктів на основі штучного інтелекту, який розуміє запити природною мовою та надає релевантні результати на основі семантичної схожості.

## Огляд

Традиційний пошук за ключовими словами часто не враховує наміри користувача та семантичне значення. Семантичний пошук із використанням векторних вбудовувань дозволяє виконувати запити природною мовою, наприклад, "зручні бігові кросівки для дощової погоди", щоб знайти відповідні продукти, навіть якщо ці слова не зустрічаються в описах продуктів.

Наша реалізація поєднує потужні моделі вбудовувань Azure OpenAI із розширенням pgvector для PostgreSQL, створюючи високопродуктивну, масштабовану систему семантичного пошуку, яка покращує роздрібний досвід завдяки інтелектуальному пошуку продуктів.

## Навчальні цілі

Після завершення цього практикуму ви зможете:

- **Інтегрувати** моделі вбудовувань Azure OpenAI для векторизації тексту
- **Реалізувати** pgvector для ефективних операцій пошуку за схожістю
- **Створити** інструменти семантичного пошуку для запитів природною мовою
- **Розробити** гібридний пошук, що поєднує традиційний і векторний пошук
- **Оптимізувати** векторні запити для продуктивності в реальних умовах
- **Спроєктувати** системи рекомендацій на основі схожості вбудовувань

## 🧠 Архітектура семантичного пошуку

### Конвеєр пошуку за векторами
...
### Стратегія генерації вбудовувань
...
## 🔍 Генерація вбудовувань продуктів

### Автоматизований конвеєр вбудовувань
...
### Інструмент семантичного пошуку продуктів
...
### Оптимізація запитів за векторами
...
### Стратегія кешування вбудовувань
...
Після завершення цього практикуму ви матимете:

✅ **Інтеграцію Azure OpenAI**: Повна генерація вбудовувань із кешуванням та оптимізацією  
✅ **Реалізацію пошуку за векторами**: Готовий до використання семантичний пошук із pgvector  
✅ **Можливості гібридного пошуку**: Поєднання пошуку за ключовими словами та семантичного пошуку для оптимальних результатів  
✅ **Системи рекомендацій**: Рекомендації продуктів на основі штучного інтелекту та схожості  
✅ **Оптимізацію продуктивності**: Оптимізація індексів векторів та інтелектуальне кешування  
✅ **Масштабовану архітектуру**: Інфраструктура семантичного пошуку, готова до використання в корпоративному середовищі  

## 🚀 Що далі

Продовжуйте з **[Практикум 08: Тестування та налагодження](../08-Testing/README.md)**, щоб:

- Реалізувати комплексні стратегії тестування семантичного пошуку
- Налагодити проблеми продуктивності пошуку за векторами
- Перевірити якість і релевантність вбудовувань
- Тестувати точність системи рекомендацій

## 📚 Додаткові ресурси

### Azure OpenAI
- [Документація Azure OpenAI Service](https://docs.microsoft.com/azure/cognitive-services/openai/) - Повний посібник із сервісу
- [Довідник API Embeddings](https://platform.openai.com/docs/api-reference/embeddings) - Документація API
- [Найкращі практики для Embeddings](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Рекомендації щодо впровадження

### Векторні бази даних
- [Документація pgvector](https://github.com/pgvector/pgvector) - Розширення PostgreSQL для векторів
- [Оптимізація пошуку за векторами](https://www.pinecone.io/learn/vector-search-optimization/) - Налаштування продуктивності
- [Алгоритм HNSW](https://arxiv.org/abs/1603.09320) - Ієрархічні навігаційні малі світові графи

### Семантичний пошук
- [Основи інформаційного пошуку](https://nlp.stanford.edu/IR-book/) - Підручник зі Стенфорда
- [Найкращі практики пошуку за векторами](https://weaviate.io/blog/vector-search-best-practices) - Шаблони реалізації
- [Стратегії гібридного пошуку](https://blog.vespa.ai/hybrid-search/) - Поєднання різних підходів до пошуку

---

**Попередній**: [Практикум 06: Розробка інструментів](../06-Tools/README.md)  
**Наступний**: [Практикум 08: Тестування та налагодження](../08-Testing/README.md)
