...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:41:01+00:00",
...
Цей практикум глибоко занурюється у створення складних MCP-інструментів, які надають AI-асистентам потужні можливості для запитів до баз даних, інспекції схем і аналітичних функцій. Ви навчитеся створювати інструменти, які є одночасно потужними та безпечними, з комплексною обробкою помилок і оптимізацією продуктивності.

## Огляд

MCP-інструменти є інтерфейсом між AI-асистентами та вашими системами даних. Добре спроєктовані інструменти забезпечують структурований, перевірений доступ до складних операцій, зберігаючи при цьому безпеку та продуктивність. Цей практикум охоплює повний життєвий цикл розробки інструментів — від проєктування до впровадження.

Наш сервер MCP для роздрібної торгівлі реалізує комплексний набір інструментів, які дозволяють виконувати запити природною мовою до даних про продажі, каталогів продуктів і бізнес-аналітики, зберігаючи суворі межі безпеки та оптимальну продуктивність.

## Навчальні цілі

До кінця цього практикуму ви зможете:

- **Проєктувати** складні MCP-інструменти з перевіркою складних параметрів
- **Реалізовувати** безпечні інструменти для запитів до баз даних із захистом від SQL-ін'єкцій
- **Створювати** можливості інспекції схем для динамічних запитів
- **Розробляти** індивідуальні аналітичні інструменти для бізнес-аналітики
- **Застосовувати** комплексну обробку помилок і плавну деградацію
- **Оптимізувати** продуктивність інструментів для робочих навантажень у виробничому середовищі

## 🛠️ Основна архітектура інструментів
...
## 🗃️ Інструменти для запитів до баз даних

### Інструмент аналізу продажів
...
## 📊 Аналітичні та утилітарні інструменти
...
✅ **Складна архітектура інструментів**: Реалізувати складні MCP-інструменти з комплексною обробкою помилок  
✅ **Перевірка запитів**: Створити безпечну перевірку SQL для запобігання атакам ін'єкцій  
✅ **Інструменти для баз даних**: Розробити потужні можливості аналізу продажів і інспекції схем  
✅ **Бізнес-аналітика**: Створити аналітичні інструменти для всебічного аналізу бізнесу  
✅ **Оптимізація продуктивності**: Застосувати кешування, пулінг з'єднань і оптимізацію запитів  
✅ **Інтеграція безпеки**: Реалізувати контроль доступу на основі ролей і ведення журналу аудиту  

## 🚀 Що далі

Продовжуйте з **[Лабораторія 07: Інтеграція семантичного пошуку](../07-Semantic-Search/README.md)**, щоб:

- Інтегрувати можливості пошуку за векторами з MCP-інструментами
- Розробити функціонал семантичного пошуку продуктів
- Реалізувати AI-розуміння запитів
- Створити гібридний пошук, що поєднує традиційні та векторні запити

## 📚 Додаткові ресурси

### Розробка MCP-інструментів
- [Документація Model Context Protocol](https://modelcontextprotocol.io/docs) - Офіційна специфікація MCP
- [FastMCP Framework](https://github.com/jlowin/fastmcp) - Реалізація MCP на Python
- [Шаблони MCP-інструментів](https://github.com/modelcontextprotocol/servers) - Приклади реалізації інструментів

### Безпека баз даних
- [Запобігання SQL-ін'єкціям](https://owasp.org/www-community/attacks/SQL_Injection) - Посібник з безпеки OWASP
- [Безпека PostgreSQL](https://www.postgresql.org/docs/current/security.html) - Найкращі практики безпеки баз даних
- [Техніки перевірки запитів](https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html) - Безпечні шаблони запитів

### Оптимізація продуктивності
- [Оптимізація запитів до баз даних](https://www.postgresql.org/docs/current/performance-tips.html) - Посібник з продуктивності PostgreSQL
...
- [Асинхронні шаблони Python](https://docs.python.org/3/library/asyncio.html) - Посібник з асинхронного програмування

---

**Попередній**: [Лабораторія 05: Реалізація MCP-сервера](../05-MCP-Server/README.md)  
**Наступний**: [Лабораторія 07: Інтеграція семантичного пошуку](../07-Semantic-Search/README.md)
