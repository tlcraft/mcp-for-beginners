...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-19T19:25:26+00:00",
...
Рекомендується встановити `uv`, але це не обов’язково, див. [інструкції](https://docs.astral.sh/uv/#highlights)
...
Це має запустити вебсервер із візуальним інтерфейсом, що дозволяє протестувати приклад.

Після підключення до сервера:

- спробуйте перелічити інструменти та запустіть `add` з аргументами 2 і 4, у результаті ви маєте побачити 6.
- перейдіть до ресурсів і шаблону ресурсу, викличте get_greeting, введіть ім’я, і ви маєте побачити привітання з введеним вами ім’ям.
...
Це перелічить усі інструменти, доступні на сервері. Ви маєте побачити наступний вивід:
...
Ви маєте побачити наступний вивід:
