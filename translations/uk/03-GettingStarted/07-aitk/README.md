...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T21:43:50+00:00",
...
AI Toolkit — це потужне розширення для Visual Studio Code, яке спрощує розробку агентів. AI-інженери можуть легко створювати AI-додатки, розробляючи та тестуючи генеративні AI-моделі — локально або в хмарі. Розширення підтримує більшість основних генеративних моделей, доступних сьогодні.
...
- Налаштувати конфігурацію агента, щоб він міг знаходити та використовувати інструменти, які надає MCP-сервер.
...
У цьому завданні ви створите, запустите та вдосконалите AI-агента з інструментами з MCP-сервера всередині Visual Studio Code за допомогою AI Toolkit.
...
![Скріншот інтерфейсу вибору моделі в розширенні AI Toolkit для Visual Studio Code. Заголовок: "Find the right model for your AI Solution" з підзаголовком, що заохочує відкривати, тестувати та розгортати AI-моделі. Нижче, у розділі “Popular Models,” показано шість карток моделей: DeepSeek-R1 (розміщена на GitHub), OpenAI GPT-4o, OpenAI GPT-4.1, OpenAI o1, Phi 4 Mini (CPU - Small, Fast) та DeepSeek-R1 (розміщена на Ollama). Кожна картка має опції “Add” або “Try in Playground”.](../../../../translated_images/aitk-model-catalog.2acd38953bb9c119aa629fe74ef34cc56e4eed35e7f5acba7cd0a59e614ab335.uk.png)
...
4. Натисніть **+ Add**, щоб додати модель до списку **My Models**. Переконайтеся, що ви обрали модель, яка **Hosted by GitHub**.
...
2. У полі **User prompt** у **Agent (Prompt) Builder** введіть: `I bought 3 items priced at $25 each, and then used a $20 discount. How much did I pay?`
...
Спробуйте додати додатковий інструмент у файл **server.py** (наприклад, обчислення квадратного кореня числа). Надсилайте додаткові запити, які вимагатимуть від агента використання вашого нового інструменту (або існуючих). Не забудьте перезапустити сервер, щоб завантажити нові інструменти.
...
- AI Toolkit включає шаблони (наприклад, шаблони MCP-серверів на Python), що спрощують створення власних інструментів.
