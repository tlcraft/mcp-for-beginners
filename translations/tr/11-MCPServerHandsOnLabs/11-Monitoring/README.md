...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T16:49:05+00:00",
...
Bu laboratuvar, üretim ortamlarında MCP sunucunuz için izleme, gözlemlenebilirlik ve uyarı sistemlerini uygulamak için kapsamlı bir rehber sunar. Application Insights kurmayı, anlamlı panolar oluşturmayı, etkili uyarı sistemleri uygulamayı ve operasyonel mükemmeliyet için sorun giderme iş akışları oluşturmayı öğreneceksiniz.

## Genel Bakış

Etkili izleme ve gözlemlenebilirlik, üretim ortamındaki MCP sunucularının güvenilirliğini sağlamak için kritik öneme sahiptir. Bu laboratuvar, gözlemlenebilirliğin üç temel direğini—metrikler, günlükler ve izler—kapsar ve proaktif sorun tespiti ile hızlı problem çözümüne olanak tanıyan kapsamlı bir izleme sisteminin nasıl uygulanacağını gösterir.

Ham telemetri verilerini, sistem davranışını anlamanıza, performansı optimize etmenize ve yüksek erişilebilirliği sağlamanıza yardımcı olacak eyleme dönüştürülebilir içgörülere dönüştürmeyi öğreneceksiniz.

## Öğrenme Hedefleri

Bu laboratuvarın sonunda şunları yapabileceksiniz:

- MCP sunucuları için kapsamlı Application Insights entegrasyonunu **uygulamak**  
- Etkili sorun giderme için yapılandırılmış günlükleme desenleri **tasarlamak**  
- Performans metrikleri toplama ve analiz sistemleri **oluşturmak**  
- Eyleme dönüştürülebilir bildirimlerle akıllı uyarı sistemleri **yapılandırmak**  
- Gerçek zamanlı izleme için operasyonel panolar **oluşturmak**  
- Etkili sorun giderme iş akışları ve çalışma kitapları **oluşturmak**  
...
### Yapılandırılmış Veri ile Gelişmiş Günlükleme
...
✅ **Application Insights Entegrasyonu**: Tam telemetri ve izleme kurulumu  
✅ **Yapılandırılmış Günlükleme**: Korelasyon ve bağlam içeren üretime hazır günlükleme  
✅ **Özel Metrikler**: İş ve teknik metriklerin toplanması ve analizi  
✅ **Akıllı Uyarı Sistemi**: Birden fazla bildirim kanalıyla proaktif uyarılar  
✅ **Operasyonel Panolar**: Gerçek zamanlı izleme ve iş içgörüleri  
✅ **Sorun Giderme İş Akışları**: Otomatik tanılama ve operasyonel çalışma kitapları  

## 🚀 Sırada Ne Var?

**[Laboratuvar 12: En İyi Uygulamalar ve Optimizasyon](../12-Best-Practices/README.md)** ile devam edin:

- Performans optimizasyon tekniklerini uygulayın  
- Kapsamlı güvenlik güçlendirmesi gerçekleştirin  
- Üretim dağıtımı için en iyi uygulamaları öğrenin  
- Maliyet optimizasyon stratejileri oluşturun  

## 📚 Ek Kaynaklar

### Azure Monitor
- [Application Insights Belgeleri](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Tam izleme rehberi  
- [KQL Sorgu Referansı](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Application Insights için sorgu dili  
- [Azure Monitor Çalışma Kitapları](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - Özel pano oluşturma  

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - Enstrümantasyon rehberi  
- [Dağıtılmış İzleme](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - İzleme kavramları  
- [Metrik Toplama](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - Metrik en iyi uygulamaları  

### Operasyonel Mükemmellik
- [SRE El Kitabı](https://sre.google/sre-book/table-of-contents/) - Site Güvenilirlik Mühendisliği prensipleri  
- [İzleme En İyi Uygulamaları](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - Endüstri en iyi uygulamaları  
- [Olay Müdahalesi](https://response.pagerduty.com/) - Olay yönetimi rehberi  

---

**Önceki**: [Laboratuvar 10: Dağıtım Stratejileri](../10-Deployment/README.md)  
**Sonraki**: [Laboratuvar 12: En İyi Uygulamalar ve Optimizasyon](../12-Best-Practices/README.md)  
