...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T16:43:24+00:00",
  "source_file": "11-MCPServerHandsOnLabs/02-Security/README.md",
  "language_code": "tr"
}
-->
# Güvenlik ve Çoklu Kiracılık

## 🎯 Bu Laboratuvar Neleri Kapsıyor?

Bu laboratuvar, MCP sunucuları için kurumsal düzeyde güvenlik ve çoklu kiracılık uygulama konusunda kapsamlı rehberlik sunar. Hassas perakende verilerini korurken, birden fazla kiracı arasında esnek erişim modellerini mümkün kılan güvenli ve uyumlu sistemler tasarlamayı öğreneceksiniz.

## Genel Bakış

Müşteri verileri, ödeme bilgileri ve iş zekâsı gibi verileri işleyen perakende uygulamalarında güvenlik son derece önemlidir. Bu laboratuvar, kimlik doğrulama ve yetkilendirmeden veri izolasyonu ve uyumluluk izlemeye kadar tam güvenlik mimarisini kapsar.

Azure kimlik hizmetleri, PostgreSQL Satır Düzeyi Güvenlik (Row Level Security), uygulama düzeyinde kontroller ve kapsamlı denetim kaydı gibi unsurları birleştirerek savunma derinliği stratejisi uygular ve sağlam, uyumlu bir platform oluşturur.

## Öğrenme Hedefleri

Bu laboratuvarın sonunda şunları yapabileceksiniz:

- **Uygulama**: Çoklu kiracı veri izolasyonu için kurumsal düzeyde Satır Düzeyi Güvenlik (RLS) uygulamak  
- **Tasarım**: Azure ile güvenli kimlik doğrulama ve yetkilendirme modelleri tasarlamak  
- **Yapılandırma**: Uyumluluk gereksinimleri için kapsamlı denetim kaydı yapılandırmak  
- **Uygulama**: Tüm uygulama katmanlarında savunma derinliği güvenlik stratejileri uygulamak  
- **Doğrulama**: Sistematik testlerle güvenlik uygulamalarını doğrulamak  
- **İzleme**: Güvenlik olaylarını izlemek ve potansiyel tehditlere yanıt vermek  

## 🔐 Çoklu Kiracı Güvenlik Mimarisi

### Güvenlik Katmanlarına Genel Bakış
...
### Çoklu Kiracılık Modelleri

Uygulamamız, Satır Düzeyi Güvenlik (RLS) ile **Paylaşılan Veritabanı, Paylaşılan Şema** modelini kullanır:

**Avantajlar:**
- Maliyet etkin kaynak kullanımı  
- Basitleştirilmiş bakım ve güncellemeler  
- RLS ile güçlü veri izolasyonu  
- Uyumluluk dostu denetim izleri  

**Dezavantajlar:**
- Dikkatli RLS politika tasarımı gerektirir  
- Şema değişiklikleri tüm kiracıları etkiler  
- Güçlü yedekleme/geri yükleme prosedürleri gerektirir  

## 🛡️ Satır Düzeyi Güvenlik Uygulaması
...
✅ **Çoklu Kiracı Güvenliği**: Tam veri izolasyonu için Satır Düzeyi Güvenlik uygulandı  
✅ **Azure Kimlik Doğrulama**: Azure Entra ID ile JWT doğrulama entegre edildi  
✅ **Rol Tabanlı Yetkilendirme**: Hiyerarşik rol ve izin sistemi yapılandırıldı  
✅ **Kapsamlı Denetim Kaydı**: Güvenlik olaylarını izleme ve takip sistemi kuruldu  
✅ **Güvenlik Testi**: Otomatik güvenlik doğrulama testleri uygulandı  
✅ **Tehdit İzleme**: Gerçek zamanlı güvenlik olay algılama ve uyarı sistemi oluşturuldu  

## 🚀 Sıradaki Adımlar

**[Lab 03: Ortam Kurulumu](../03-Setup/README.md)** ile devam edin:

- Güvenlik en iyi uygulamalarıyla geliştirme ortamlarını yapılandırın  
- Kimlik doğrulama ve izleme için Azure hizmetlerini kurun  
- Güvenli veritabanı bağlantıları ve gizli bilgiler yönetimini uygulayın  
- Geliştirme ortamlarında güvenlik yapılandırmalarını doğrulayın  

## 📚 Ek Kaynaklar

### Azure Güvenliği
- [Azure Entra ID Belgeleri](https://docs.microsoft.com/azure/active-directory/) - Tam kimlik platformu rehberi  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Gizli bilgiler yönetim hizmeti  
- [Azure Güvenlik En İyi Uygulamaları](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Güvenlik rehberi  

### Veritabanı Güvenliği
- [PostgreSQL Satır Düzeyi Güvenlik](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Resmi RLS belgeleri  
- [Veritabanı Güvenlik Kontrol Listesi](https://www.postgresql.org/docs/current/security.html) - PostgreSQL güvenlik rehberi  
- [Çoklu Kiracı Veritabanı Modelleri](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Mimari modeller  

### Güvenlik Testi
- [OWASP Test Rehberi](https://owasp.org/www-project-web-security-testing-guide/) - Kapsamlı güvenlik testi  
- [JWT Güvenlik En İyi Uygulamaları](https://tools.ietf.org/html/rfc8725) - JWT güvenlik önerileri  
- [API Güvenlik Testi](https://owasp.org/www-project-api-security/) - API'ye özel güvenlik testi  

---

**Önceki**: [Lab 01: Temel Mimari Kavramlar](../01-Architecture/README.md)  
**Sonraki**: [Lab 03: Ortam Kurulumu](../03-Setup/README.md)  
