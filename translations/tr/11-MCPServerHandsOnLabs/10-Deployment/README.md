...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T17:01:05+00:00",
...
Bu laboratuvar, MCP perakende sunucunuzu modern konteynerleştirme ve bulut tabanlı yaklaşımlar kullanarak üretim ortamlarına dağıtma konusunda kapsamlı rehberlik sağlar. Kurumsal iş yüklerini kaldırabilecek ölçeklenebilir, güvenli ve izlenebilir MCP sunucularını nasıl dağıtacağınızı öğreneceksiniz.

## Genel Bakış

MCP sunucularının üretim ortamına dağıtımı, konteynerleştirme, orkestrasyon, güvenlik, ölçeklenebilirlik ve izleme gibi konuların dikkatlice ele alınmasını gerektirir. Bu laboratuvar, Azure Container Apps ile PostgreSQL Flexible Server'a dağıtımı, CI/CD boru hatlarının uygulanmasını ve değişken iş yükleri için otomatik ölçeklendirme yapılandırmasını kapsar.

Dağıtım stratejileri, geliştirme için basit tek konteyner dağıtımlarından, kapsamlı izleme ve güvenlik özelliklerine sahip, çok bölgeli, otomatik ölçeklendirme üretim ortamlarına kadar çeşitlilik gösterir.

## Öğrenme Hedefleri

Bu laboratuvarın sonunda şunları yapabileceksiniz:

- **Konteynerleştirme**: MCP sunucularını çok aşamalı Docker yapılarıyla konteynerleştirme  
- **Dağıtım**: Azure Container Apps'e güvenli ağ bağlantılarıyla dağıtım  
- **Yapılandırma**: Yüksek erişilebilirlik ile üretim seviyesinde PostgreSQL yapılandırma  
- **Uygulama**: Otomatik dağıtım için CI/CD boru hatları oluşturma  
- **Ölçeklendirme**: Talebe göre uygulamaları otomatik olarak ölçeklendirme  
- **İzleme**: Kapsamlı gözlemlenebilirlik ile üretim dağıtımlarını izleme  
...
### Geliştirme için Docker Compose
...
## ☁️ Azure Container Apps Dağıtımı
...
✅ **Konteyner Stratejisi**: Güvenlik sertleştirmesi yapılmış üretim seviyesinde Docker konteynerleri  
✅ **Bulut Dağıtımı**: Otomatik ölçeklendirme ve izleme ile Azure Container Apps  
✅ **Veritabanı Dağıtımı**: Yüksek erişilebilirlik ile PostgreSQL Flexible Server  
✅ **CI/CD Boru Hatları**: Otomatik test, yapı ve dağıtım iş akışları  
✅ **Performans İzleme**: Kapsamlı metrik toplama ve uyarı sistemleri  
✅ **Güvenlik Yapılandırması**: Üretim seviyesinde güvenlik politikaları ve ağ izolasyonu  

## 🚀 Sırada Ne Var?

**[Laboratuvar 11: İzleme ve Gözlemlenebilirlik](../11-Monitoring/README.md)** ile devam edin:

- Application Insights ile kapsamlı izleme kurun  
- Yapılandırılmış günlük kaydı ve dağıtılmış izleme yapılandırın  
- Uyarı ve otomatik yanıt sistemleri uygulayın  
- İş metriklerini ve performans KPI'larını izleyin  

## 📚 Ek Kaynaklar

### Konteyner Teknolojileri
- [Docker En İyi Uygulamalar](https://docs.docker.com/develop/dev-best-practices/) - Resmi Docker en iyi uygulamaları  
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Azure Container Apps belgeleri  
- [Kubernetes Belgeleri](https://kubernetes.io/docs/) - Kubernetes resmi belgeleri  

### CI/CD ve DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - GitHub Actions belgeleri  
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Azure DevOps hizmetleri  
- [Kod Olarak Altyapı](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Azure Bicep belgeleri  

### Güvenlik ve İzleme
- [Azure Güvenlik Merkezi](https://docs.microsoft.com/en-us/azure/security-center/) - Azure güvenlik önerileri  
- [Konteyner Güvenliği](https://kubernetes.io/docs/concepts/security/) - Kubernetes güvenlik konseptleri  
...
**Önceki**: [Laboratuvar 09: VS Code Entegrasyonu](../09-VS-Code/README.md)  
**Sonraki**: [Laboratuvar 11: İzleme ve Gözlemlenebilirlik](../11-Monitoring/README.md)  
