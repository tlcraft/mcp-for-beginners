...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T17:06:02+00:00",
...
Bu laboratuvar, Azure OpenAI gömme modelleri ve PostgreSQL'in pgvector uzantısını kullanarak anlamsal arama yeteneklerini uygulama konusunda kapsamlı rehberlik sağlar. Doğal dil sorgularını anlayan ve anlamsal benzerliğe dayalı olarak ilgili sonuçlar sunan yapay zeka destekli ürün arama oluşturmayı öğreneceksiniz.

## Genel Bakış

Geleneksel anahtar kelime tabanlı arama, genellikle kullanıcı niyetini ve anlamsal anlamı yakalamakta başarısız olur. Vektör gömmeleri kullanarak yapılan anlamsal arama, "yağmurlu hava için rahat koşu ayakkabıları" gibi doğal dil sorgularının, bu kelimeler ürün açıklamalarında geçmese bile ilgili ürünleri bulmasını sağlar.

Uygulamamız, Azure OpenAI'nin güçlü gömme modellerini PostgreSQL'in pgvector uzantısıyla birleştirerek yüksek performanslı, ölçeklenebilir bir anlamsal arama sistemi oluşturur ve perakende deneyimini akıllı ürün keşfi ile geliştirir.

## Öğrenme Hedefleri

Bu laboratuvarın sonunda şunları yapabileceksiniz:

- **Entegre Etmek**: Metin vektörleştirme için Azure OpenAI gömme modellerini entegre etmek  
- **Uygulamak**: Benzerlik arama işlemleri için pgvector'u kullanmak  
- **Oluşturmak**: Doğal dil ürün sorguları için anlamsal arama araçları geliştirmek  
- **Tasarım Yapmak**: Geleneksel ve vektör aramayı birleştiren hibrit arama oluşturmak  
- **Optimize Etmek**: Üretim performansı için vektör sorgularını optimize etmek  
- **Tasarım Yapmak**: Gömme benzerliğini kullanarak öneri sistemleri oluşturmak  

## 🧠 Anlamsal Arama Mimarisi
...
## 🔍 Ürün Gömme Oluşturma

### Otomatik Gömme Süreci
...
## 🔎 Anlamsal Arama Araçları

### Anlamsal Ürün Arama Aracı
...
✅ **Azure OpenAI Entegrasyonu**: Önbellekleme ve optimizasyon ile tam gömme oluşturma  
✅ **Vektör Arama Uygulaması**: pgvector ile üretime hazır anlamsal arama  
✅ **Hibrit Arama Yetenekleri**: Anahtar kelime ve anlamsal aramayı birleştirerek en iyi sonuçları elde etme  
✅ **Öneri Sistemleri**: Benzerlik kullanarak yapay zeka destekli ürün önerileri  
✅ **Performans Optimizasyonu**: Vektör dizin optimizasyonu ve akıllı önbellekleme  
✅ **Ölçeklenebilir Mimari**: Kurumsal düzeyde anlamsal arama altyapısı  

## 🚀 Sıradaki Adım

**[Laboratuvar 08: Test ve Hata Ayıklama](../08-Testing/README.md)** ile devam edin:

- Anlamsal arama için kapsamlı test stratejileri uygulayın  
- Vektör arama performans sorunlarını giderin  
- Gömme kalitesini ve alaka düzeyini doğrulayın  
- Öneri sisteminin doğruluğunu test edin  

## 📚 Ek Kaynaklar

### Azure OpenAI
- [Azure OpenAI Hizmet Dokümantasyonu](https://docs.microsoft.com/azure/cognitive-services/openai/) - Tam hizmet rehberi  
- [Gömme API Referansı](https://platform.openai.com/docs/api-reference/embeddings) - API dokümantasyonu  
- [Gömme için En İyi Uygulamalar](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Uygulama rehberi  

### Vektör Veritabanları
- [pgvector Dokümantasyonu](https://github.com/pgvector/pgvector) - PostgreSQL vektör uzantısı  
- [Vektör Arama Optimizasyonu](https://www.pinecone.io/learn/vector-search-optimization/) - Performans ayarları  
- [HNSW Algoritması](https://arxiv.org/abs/1603.09320) - Hiyerarşik gezilebilir küçük dünya grafikleri  

### Anlamsal Arama
- [Bilgi Getirme Temelleri](https://nlp.stanford.edu/IR-book/) - Stanford IR ders kitabı  
- [Vektör Arama En İyi Uygulamalar](https://weaviate.io/blog/vector-search-best-practices) - Uygulama desenleri  
- [Hibrit Arama Stratejileri](https://blog.vespa.ai/hybrid-search/) - Farklı arama yaklaşımlarını birleştirme  

---

**Önceki**: [Laboratuvar 06: Araç Geliştirme](../06-Tools/README.md)  
**Sonraki**: [Laboratuvar 08: Test ve Hata Ayıklama](../08-Testing/README.md)  
