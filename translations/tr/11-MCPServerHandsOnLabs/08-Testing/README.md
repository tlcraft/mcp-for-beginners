...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T16:32:50+00:00",
...
Bu laboratuvar, üretim ortamlarında MCP sunucularını test etme ve hata ayıklama konusunda kapsamlı rehberlik sağlar. Güçlü test stratejileri uygulamayı, karmaşık sorunları çözmeyi ve MCP sunucunuzun çeşitli koşullarda güvenilir bir şekilde çalışmasını sağlamayı öğreneceksiniz.

## Genel Bakış

MCP sunucularını test etmek, birim testleri, entegrasyon testleri, performans doğrulaması ve gerçek dünya senaryolarını kapsayan çok katmanlı bir yaklaşım gerektirir. Bu laboratuvar, geliştirmeden üretim izlemeye kadar tüm test yaşam döngüsünü kapsar.

Test stratejimiz, güvenilirlik, güvenlik ve performansa odaklanarak MCP sunucunuzun üretim iş yüklerini yönetirken veri bütünlüğünü ve kullanıcı deneyimi kalitesini korumasını sağlar.

## Öğrenme Hedefleri

Bu laboratuvarın sonunda şunları yapabileceksiniz:

- **Kapsamlı birim ve entegrasyon test paketleri** uygulamak  
- MCP araçları ve veritabanı işlemleri için **etkili test stratejileri tasarlamak**  
- **Gelişmiş hata ayıklama teknikleri** kullanarak karmaşık sorunları çözmek  
- Gerçekçi test senaryolarıyla **yük altında performansı doğrulamak**  
- **Etkili uyarı ve gözlemlenebilirlik ile üretim sistemlerini izlemek**  
- Sürekli entegrasyon için **test iş akışlarını otomatikleştirmek**  
...
### Gelişmiş Hata Ayıklama Çerçevesi
...
✅ **Kapsamlı Test Çerçevesi**: Tüm bileşenler için birim, entegrasyon ve performans testleri  
✅ **Gelişmiş Hata Ayıklama Araçları**: İleri düzey hata ayıklama araçları ve yürütme izleme  
✅ **Performans Doğrulaması**: Yük testi ve ölçeklenebilirlik analizi yetenekleri  
✅ **Güvenlik Testi**: SQL enjeksiyon önleme ve RLS doğrulaması  
✅ **İzleme Entegrasyonu**: Performans metrikleri ve darboğaz analizi  
✅ **CI/CD Hazır**: Sürekli entegrasyon için otomatik test iş akışları  

## 🚀 Sırada Ne Var?

**[Lab 09: VS Code Entegrasyonu](../09-VS-Code/README.md)** ile devam edin:

- MCP sunucu geliştirme için VS Code'u yapılandırın  
- VS Code'da hata ayıklama ortamlarını kurun  
- MCP sunucusunu VS Code Chat ile entegre edin  
- VS Code iş akışını tamamen test edin  

## 📚 Ek Kaynaklar

### Test Çerçeveleri
- [pytest Belgeleri](https://docs.pytest.org/) - Python test çerçevesi  
- [AsyncPG Testi](https://magicstack.github.io/asyncpg/current/index.html) - Async PostgreSQL testi  
- [FastAPI Testi](https://fastapi.tiangolo.com/tutorial/testing/) - API test desenleri  

### Performans Testi
- [Yük Testi En İyi Uygulamaları](https://docs.python.org/3/library/asyncio.html) - Async performans testi  
- [Veritabanı Performans Testi](https://www.postgresql.org/docs/current/performance-tips.html) - PostgreSQL optimizasyonu  
- [Bellek Profili](https://docs.python.org/3/library/tracemalloc.html) - Python bellek analizi  

### Hata Ayıklama Araçları
- [Python Hata Ayıklama](https://docs.python.org/3/library/pdb.html) - Python hata ayıklayıcı  
- [Async Hata Ayıklama](https://docs.python.org/3/library/asyncio-dev.html) - Asyncio hata ayıklama  
- [SQL Hata Ayıklama](https://www.postgresql.org/docs/current/runtime-config-logging.html) - PostgreSQL günlükleme  

---

**Önceki**: [Lab 07: Anlamsal Arama Entegrasyonu](../07-Semantic-Search/README.md)  
**Sonraki**: [Lab 09: VS Code Entegrasyonu](../09-VS-Code/README.md)  
