...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T20:35:22+00:00",
...
- ਸਰਵਰ ਹਰ ਸੁਨੇਹਾ ਜਿਵੇਂ ਤਿਆਰ ਹੁੰਦਾ ਹੈ, ਭੇਜਦਾ ਹੈ।
- ਕਲਾਇੰਟ ਹਰ ਹਿੱਸਾ ਜਿਵੇਂ ਮਿਲਦਾ ਹੈ, ਪ੍ਰਿੰਟ ਕਰਦਾ ਹੈ।

**ਲੋੜੀਂਦੇ:**
- ਸਰਵਰ ਨੂੰ ਸਟ੍ਰੀਮਿੰਗ ਰਿਸਪਾਂਸ ਵਰਤਣਾ ਚਾਹੀਦਾ ਹੈ (ਜਿਵੇਂ FastAPI ਵਿੱਚ `StreamingResponse`)।
- ਕਲਾਇੰਟ ਨੂੰ ਰਿਸਪਾਂਸ ਨੂੰ ਸਟ੍ਰੀਮ ਵਜੋਂ ਪ੍ਰਕਿਰਿਆ ਕਰਨਾ ਚਾਹੀਦਾ ਹੈ (`stream=True` requests ਵਿੱਚ)।
...
- ਇਵੈਂਟਾਂ ਨੂੰ ਪ੍ਰਕਾਰ (ਜਿਵੇਂ `info`, `result`) ਦਿੱਤੇ ਜਾ ਸਕਦੇ ਹਨ ਜੋ ਕਲਾਇੰਟ ਲਈ ਬਿਹਤਰ ਹੁੰਦੇ ਹਨ
