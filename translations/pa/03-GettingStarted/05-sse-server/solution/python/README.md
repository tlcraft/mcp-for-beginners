...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T16:50:35+00:00",
...
- ਟੂਲਸ ਦੀ ਸੂਚੀ ਬਣਾਉਣ ਦੀ ਕੋਸ਼ਿਸ਼ ਕਰੋ ਅਤੇ `add` ਚਲਾਓ, ਦਲੀਲਾਂ 2 ਅਤੇ 4 ਦੇ ਨਾਲ, ਤੁਹਾਨੂੰ ਨਤੀਜੇ ਵਿੱਚ 6 ਦੇਖਣਾ ਚਾਹੀਦਾ ਹੈ।
- ਰਿਸੋਰਸ ਅਤੇ ਰਿਸੋਰਸ ਟੈਂਪਲੇਟ ਤੇ ਜਾਓ ਅਤੇ `get_greeting` ਕਾਲ ਕਰੋ, ਇੱਕ ਨਾਮ ਟਾਈਪ ਕਰੋ ਅਤੇ ਤੁਹਾਨੂੰ ਉਸ ਨਾਮ ਦੇ ਨਾਲ ਇੱਕ ਗ੍ਰੀਟਿੰਗ ਦੇਖਣੀ ਚਾਹੀਦੀ ਹੈ ਜੋ ਤੁਸੀਂ ਦਿੱਤਾ ਹੈ।

### CLI ਮੋਡ ਵਿੱਚ ਟੈਸਟਿੰਗ

ਜੋ ਇੰਸਪੈਕਟਰ ਤੁਸੀਂ ਚਲਾਇਆ ਹੈ ਉਹ ਅਸਲ ਵਿੱਚ ਇੱਕ Node.js ਐਪ ਹੈ ਅਤੇ `mcp dev` ਇਸ ਦਾ ਇੱਕ ਰੈਪਰ ਹੈ।

ਤੁਸੀਂ ਇਸਨੂੰ CLI ਮੋਡ ਵਿੱਚ ਸਿੱਧੇ ਹੇਠਾਂ ਦਿੱਤੇ ਕਮਾਂਡ ਰਾਹੀਂ ਚਲਾ ਸਕਦੇ ਹੋ:

```bash
npx @modelcontextprotocol/inspector --cli http://localhost:8000/sse --method tools/list
```

ਇਹ ਸਰਵਰ ਵਿੱਚ ਉਪਲਬਧ ਸਾਰੇ ਟੂਲਸ ਦੀ ਸੂਚੀ ਦਿਖਾਵੇਗਾ। ਤੁਹਾਨੂੰ ਹੇਠਾਂ ਦਿੱਤਾ ਆਉਟਪੁੱਟ ਦੇਖਣਾ ਚਾਹੀਦਾ ਹੈ:
...
> [!TIP]  
> CLI ਮੋਡ ਵਿੱਚ ਇੰਸਪੈਕਟਰ ਚਲਾਉਣਾ ਆਮ ਤੌਰ 'ਤੇ ਬ੍ਰਾਊਜ਼ਰ ਦੇ ਮੁਕਾਬਲੇ ਕਾਫ਼ੀ ਤੇਜ਼ ਹੁੰਦਾ ਹੈ।  
