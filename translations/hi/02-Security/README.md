...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-13T16:40:22+00:00",
...
- Model Context Protocol (MCP) द्वारा प्रस्तुत अद्वितीय सुरक्षा जोखिमों की पहचान और व्याख्या करना, जिनमें प्रॉम्प्ट इंजेक्शन, टूल पॉइज़निंग, अत्यधिक अनुमतियाँ, और सप्लाई चेन कमजोरियाँ शामिल हैं।
...
- टूल मेटाडेटा की वैधता की पुष्टि करने, डायनेमिक परिवर्तनों की निगरानी करने, और अप्रत्यक्ष प्रॉम्प्ट इंजेक्शन हमलों से बचाव के महत्व को समझना।
...
MCP सर्वर या डाउनस्ट्रीम API महत्वपूर्ण सुरक्षा नियंत्रण लागू कर सकते हैं जैसे कि रेट लिमिटिंग, अनुरोध सत्यापन, या ट्रैफ़िक मॉनिटरिंग, जो टोकन ऑडियंस या अन्य क्रेडेंशियल प्रतिबंधों पर निर्भर करते हैं। यदि क्लाइंट सीधे डाउनस्ट्रीम API के साथ टोकन प्राप्त कर सकते हैं और उपयोग कर सकते हैं बिना MCP सर्वर द्वारा उचित सत्यापन के, तो वे इन नियंत्रणों को बायपास कर देते हैं।
...
ये दोनों कारक घटना जांच, नियंत्रण, और ऑडिटिंग को कठिन बना देते हैं।  
...
### समस्या विवरण  
MCP सर्वरों को उस सेवा/संसाधन के लिए अत्यधिक अनुमतियाँ दी गई हो सकती हैं जिसे वे एक्सेस कर रहे हैं। उदाहरण के लिए, एक AI बिक्री अनुप्रयोग का हिस्सा होने वाला MCP सर्वर जो एक उद्यम डेटा स्टोर से जुड़ा है, उसे केवल बिक्री डेटा तक पहुंच होनी चाहिए, न कि स्टोर की सभी फाइलों तक। न्यूनतम विशेषाधिकार के सिद्धांत (जो सबसे पुरानी सुरक्षा सिद्धांतों में से एक है) के अनुसार, किसी भी संसाधन को केवल उतनी ही अनुमतियाँ मिलनी चाहिए जितनी उसे अपने कार्यों को निष्पादित करने के लिए आवश्यक हैं। AI इस क्षेत्र में एक चुनौती प्रस्तुत करता है क्योंकि इसे लचीला बनाने के लिए आवश्यक सटीक अनुमतियों को परिभाषित करना कठिन हो सकता है।
...
- **भूमिका-आधारित एक्सेस नियंत्रण (RBAC) का उपयोग करें:** MCP सर्वर को विशिष्ट संसाधनों और क्रियाओं के लिए सख्त रूप से सीमित भूमिकाएँ सौंपें, व्यापक या अनावश्यक अनुमतियों से बचें।
...
दुर्भावनापूर्ण या समझौता किए गए MCP सर्वर ग्राहक डेटा को उजागर करके या अनपेक्षित क्रियाएँ सक्षम करके महत्वपूर्ण जोखिम पैदा कर सकते हैं। ये जोखिम विशेष रूप से AI और MCP-आधारित वर्कलोड्स में प्रासंगिक हैं, जहाँ:

- **प्रॉम्प्ट इंजेक्शन हमले**: हमलावर प्रॉम्प्ट या बाहरी सामग्री में दुर्भावनापूर्ण निर्देश छिपाते हैं, जिससे AI सिस्टम अनपेक्षित क्रियाएँ करता है या संवेदनशील डेटा लीक करता है। अधिक जानें: [Prompt Injection](https://simonwillison.net/2025/Apr/9/mcp-prompt-injection/)
...
## जोखिम  
अनपेक्षित AI क्रियाएँ विभिन्न सुरक्षा जोखिम प्रस्तुत करती हैं जिनमें डेटा चोरी और गोपनीयता उल्लंघन शामिल हैं।
...
4.  **निरंतर निगरानी और अपडेट:** Microsoft लगातार प्रॉम्प्ट शील्ड्स की निग
...
- **सुरक्षित डिप्लॉयमेंट पाइपलाइनों को बनाए रखें:** स्वचालित CI/CD पाइपलाइनों का उपयोग करें जिनमें सुरक्षा स्कैनिंग एकीकृत हो ताकि समस्याओं को जल्दी पकड़ा जा सके। सुनिश्चित करें कि केवल विश्वसनीय आर्टिफैक्ट्स ही प्रोडक्शन में डिप्लॉय हों।
...
- **न्यूनतम विशेषाधिकार और एक्सेस नियंत्रण लागू करें:** मॉडल, डेटा, और सेवाओं तक पहुंच केवल उतनी ही हो जितनी MCP सर्वर के संचालन के लिए आवश्यक हो।
- **खतरों पर तेजी से प्रतिक्रिया करें:** समझौता किए गए घटकों को पैच करने या बदलने, और यदि कोई उल्लंघन पाया जाए तो सीक्रेट्स या क्रेडेंशियल्स को रोटेट करने की प्रक्रिया तैयार रखें।

[GitHub Advanced Security](https://github.com/security/advanced-security) में सीक्रेट स्कैनिंग, डिपेंडेंसी स्कैनिंग, और CodeQL विश्लेषण जैसी सुविधाएं उपलब्ध हैं। ये टूल्स [Azure DevOps](https://azure.microsoft.com/en-us/products/devops) और [Azure Repos](https://azure.microsoft.com/en-us/products/devops/repos/) के साथ एकीकृत होकर टीमों को कोड और AI सप्लाई चेन घटकों में कमजोरियों की पहचान और उन्हें कम करने में मदद करते हैं।
...
-   सर्वर हार्डनिंग — जहां संभव हो MFA का उपयोग करें, पैचिंग को अपडेट रखें, एक्सेस के लिए सर्वर को थर्ड पार्टी पहचान प्रदाता के साथ एकीकृत करें आदि।
