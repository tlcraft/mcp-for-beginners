...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T23:00:55+00:00",
...
इंस्पेक्टर एक बेहतरीन टूल है जो आपके सर्वर को शुरू करता है और आपको इसके साथ इंटरैक्ट करने देता है ताकि आप यह जांच सकें कि यह सही काम कर रहा है। आइए इसे शुरू करें:
> [!NOTE]
