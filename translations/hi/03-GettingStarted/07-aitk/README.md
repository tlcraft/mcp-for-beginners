...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-04T16:27:13+00:00",
...
AI Toolkit Visual Studio Code के लिए एक शक्तिशाली एक्सटेंशन है जो एजेंट विकास को सरल बनाता है। AI इंजीनियर आसानी से स्थानीय या क्लाउड में जनरेटिव AI मॉडल विकसित और परीक्षण करके AI एप्लिकेशन बना सकते हैं। यह एक्सटेंशन आज उपलब्ध अधिकांश प्रमुख जनरेटिव मॉडल का समर्थन करता है।
...
यहाँ उच्च स्तर पर हमारा दृष्टिकोण है:
...
बहुत बढ़िया, अब जब हमें प्रक्रिया समझ आ गई है, तो चलिए MCP के जरिए बाहरी टूल्स का उपयोग करने के लिए AI एजेंट को कॉन्फ़िगर करते हैं और उसकी क्षमताओं को बढ़ाते हैं!
...
इस अभ्यास में, आप Visual Studio Code के अंदर AI Toolkit का उपयोग करके MCP सर्वर से टूल्स के साथ एक AI एजेंट बनाएंगे, चलाएंगे और बेहतर बनाएंगे।
...
![Visual Studio Code के AI Toolkit एक्सटेंशन में मॉडल चयन इंटरफ़ेस का स्क्रीनशॉट। शीर्षक है "Find the right model for your AI Solution" और उपशीर्षक उपयोगकर्ताओं को AI मॉडल खोजने, परीक्षण करने और तैनात करने के लिए प्रोत्साहित करता है। नीचे, “Popular Models” के तहत छह मॉडल कार्ड दिखाए गए हैं: DeepSeek-R1 (GitHub-hosted), OpenAI GPT-4o, OpenAI GPT-4.1, OpenAI o1, Phi 4 Mini (CPU - Small, Fast), और DeepSeek-R1 (Ollama-hosted)। प्रत्येक कार्ड में मॉडल को “Add” करने या “Try in Playground” में आज़माने के विकल्प हैं।](../../../../translated_images/aitk-model-catalog.2acd38953bb9c119aa629fe74ef34cc56e4eed35e7f5acba7cd0a59e614ab335.hi.png)
...
4. **+ Add** पर क्लिक करें ताकि मॉडल आपकी **My Models** सूची में जुड़ जाए। सुनिश्चित करें कि आपने वह मॉडल चुना है जो **GitHub द्वारा होस्टेड** है।
...
![Visual Studio Code के AI Toolkit एक्सटेंशन में "Calculator Agent" बिल्डर इंटरफ़ेस का स्क्रीनशॉट। बाएं पैनल में चुना गया मॉडल "OpenAI GPT-4o (via GitHub)" है। एक सिस्टम प्रॉम्प्ट है "You are a professor in university teaching math," और यूजर प्रॉम्प्ट है "Explain to me the Fourier equation in simple terms." अतिरिक्त विकल्पों में टूल जोड़ने, MCP Server सक्षम करने, और संरचित आउटपुट चुनने के बटन हैं। नीचे नीला “Run” बटन है। दाएं पैनल में "Get Started with Examples" के तहत तीन नमूना एजेंट सूचीबद्ध हैं: Web Developer (MCP Server, Second-Grade Simplifier, और Dream Interpreter के साथ, प्रत्येक के संक्षिप्त विवरण के साथ)।](../../../../translated_images/aitk-agent-builder.901e3a2960c3e4774b29a23024ff5bec2d4232f57fae2a418b2aaae80f81c05f.hi.png)

1. **Activity Bar** से **AI Toolkit** एक्सटेंशन खोलें।
2. **Tools** सेक्शन में, **Agent (Prompt) Builder** चुनें। इसे चुनने पर **Agent (Prompt) Builder** एक नए एडिटर टैब में खुलता है।
...
![Visual Studio Code के AI Toolkit में "Calculator Agent" इंटरफ़ेस का स्क्रीनशॉट जिसमें "Generate a prompt" शीर्षक वाला एक मोडल विंडो खुला है। मोडल में बताया गया है कि एक प्रॉम्प्ट टेम्पलेट बुनियादी विवरण साझा करके बनाया जा सकता है। टेक्स्ट बॉक्स में नमूना सिस्टम प्रॉम्प्ट है: "You are a helpful and efficient math assistant. When given a problem involving basic arithmetic, you respond with the correct result." नीचे "Close" और "Generate" बटन हैं। पृष्ठभूमि में एजेंट कॉन्फ़िगरेशन का हिस्सा दिख रहा है, जिसमें चुना गया मॉडल "OpenAI GPT-4o (via GitHub)" और सिस्टम तथा यूजर प्रॉम्प्ट के फ़ील्ड शामिल हैं।](../../../../translated_images/aitk-generate-prompt.ba9e69d3d2bbe2a26444d0c78775540b14196061eee32c2054e9ee68c4f51f3a.hi.png)

1. **Prompts** सेक्शन में, **Generate system prompt** बटन पर क्लिक करें। यह बटन प्रॉम्प्ट बिल्डर खोलेगा जो AI का उपयोग करके एजेंट के लिए सिस्टम प्रॉम्प्ट बनाएगा।
...
3. **Generate** बटन पर क्लिक करें। नीचे-दाएं कोने में एक नोटिफिकेशन दिखेगा जो पुष्टि करेगा कि सिस्टम प्रॉम्प्ट बन रहा है। प्रॉम्प्ट बनने के बाद यह **Agent (Prompt) Builder** के **System prompt** फ़ील्ड में दिखेगा।
4. **System prompt** की समीक्षा करें और आवश्यकतानुसार संशोधित करें।

### -3- एक MCP सर्वर बनाएं

अब जब आपने एजेंट का सिस्टम प्रॉम्प्ट परिभाषित कर दिया है—जो उसके व्यवहार और प्रतिक्रियाओं को निर्देशित करता है—तो एजेंट को व्यावहारिक क्षमताओं से लैस करने का समय है। इस भाग में, आप एक कैलकुलेटर MCP सर्वर बनाएंगे जिसमें जोड़, घटाव, गुणा और भाग के टूल होंगे। यह सर्वर आपके एजेंट को प्राकृतिक भाषा प्रॉम्प्ट के जवाब में वास्तविक समय गणितीय ऑपरेशन करने में सक्षम बनाएगा।

![Visual Studio Code के AI Toolkit एक्सटेंशन में Calculator Agent इंटरफ़ेस के निचले हिस्से का स्क्रीनशॉट। इसमें “Tools” और “Structure output” के लिए एक्सपैंडेबल मेनू दिख रहे हैं, साथ ही “Choose output format” ड्रॉपडाउन मेनू है जो “text” पर सेट है। दाईं ओर, “+ MCP Server” बटन है जो Model Context Protocol सर्वर जोड़ने के लिए है। Tools सेक्शन के ऊपर एक इमेज आइकन प्लेसहोल्डर भी दिख रहा है।](../../../../translated_images/aitk-add-mcp-server.9742cfddfe808353c0caf9cc0a7ed3e80e13abf4d2ebde315c81c3cb02a2a449.hi.png)
...
6. सर्वर के लिए नाम दर्ज करें: **Calculator**
7. एक नया Visual Studio Code विंडो खुलेगा। चुनें **Yes, I trust the authors**।
8. टर्मिनल का उपयोग करते हुए वर्चुअल एनवायरनमेंट बनाएं: `python -m venv .venv`
9. टर्मिनल में वर्चुअल एनवायरनमेंट सक्रिय करें:
    1. Windows - `.venv\Scripts\activate`
    2. macOS/Linux - `source venv/bin/activate`
10. टर्मिनल में डिपेंडेंसी इंस्टॉल करें: `pip install -e .[dev]`
11. **Activity Bar** के **Explorer** व्यू में, **src** डायरेक्टरी को एक्सपैंड करें और **server.py** फ़ाइल खोलें।
12. **server.py** की कोड को निम्नलिखित से बदलें और सेव करें:
...
अब जब आपके एजेंट के पास टूल्स हैं, तो उन्हें इस्तेमाल करने का समय है! इस भाग में, आप एजेंट को प्रॉम्प्ट भेजेंगे ताकि यह जांचा जा सके कि एजेंट कैलकुलेटर MCP सर्वर के उपयुक्त टूल का उपयोग कर रहा है या नहीं।

![Visual Studio Code के AI Toolkit एक्सटेंशन में Calculator Agent इंटरफ़ेस का स्क्रीनशॉट। बाएं पैनल में, “Tools” के तहत, एक MCP सर्वर जिसका नाम local-server-calculator_server है, जो चार उपलब्ध टूल्स दिखा रहा है: add, subtract, multiply, और divide। एक बैज दिखाता है कि चार टूल सक्रिय हैं। नीचे “Structure output” सेक्शन कोलैप्स्ड है और नीला “Run” बटन है। दाएं पैनल में, “Model Response” के तहत, एजेंट multiply और subtract टूल्स को इनपुट्स {"a": 3, "b": 25} और {"a": 75, "b": 20} के साथ इनवोक करता है। अंतिम “Tool Response” 75.0 दिखा रहा है। नीचे “View Code” बटन है।](../../../../translated_images/aitk-agent-response-with-tools.e7c781869dc8041a25f9903ed4f7e8e0c7e13d7d94f6786a6c51b1e172f56866.hi.png)

आप अपने लोकल डेव मशीन पर **Agent Builder** के माध्यम से MCP क्लाइंट के रूप में कैलकुलेटर MCP सर्वर चलाएंगे।

1. `F5` दबाएं ताकि MCP सर्वर डिबगिंग शुरू हो सके। **Agent (Prompt) Builder** एक नए एडिटर टैब में खुलेगा। टर्मिनल में सर्वर की स्थिति देखी जा सकती है।
...
5. यहाँ क्या होना चाहिए इसका विवरण:
    ...
    - मॉडल से अंतिम आउटपुट अंतिम **Model Response** में दिया जाता है।
...
अपने **server.py** फ़ाइल में एक अतिरिक्त टूल एंट्री जोड़ने का प्रयास करें (जैसे: किसी संख्या का वर्गमूल लौटाना)। ऐसे अतिरिक्त प्रॉम्प्ट सबमिट करें जिनके लिए एजेंट को आपके नए टूल (या मौजूदा टूल्स) का उपयोग करना पड़े। नए टूल्स लोड करने के लिए सर्वर को पुनः आरंभ करना न भूलें।
...
- आप MCP सर्वर में नए टूल जोड़ सकते हैं, जिससे एजेंट की क्षमताएं बढ़ती हैं और वह बदलती आवश्यकताओं को पूरा कर सकता है।
