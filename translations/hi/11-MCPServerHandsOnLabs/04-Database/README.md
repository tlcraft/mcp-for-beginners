...
यह लैब Zava Retail सिस्टम के लिए PostgreSQL डेटाबेस डिज़ाइन पर गहराई से चर्चा करता है। आप एक व्यापक रिटेल स्कीमा को लागू करना सीखेंगे जिसमें वेक्टर सर्च क्षमताएं, मल्टी-टेनेंट डेटा मॉडलिंग, और डेटा आइसोलेशन के लिए Row Level Security (RLS) शामिल हैं।

## अवलोकन

हमारा डेटाबेस MCP सर्वर की नींव है, जो कई स्टोर्स के रिटेल डेटा को संग्रहीत करता है और सख्त डेटा आइसोलेशन बनाए रखता है। हम PostgreSQL का उपयोग करते हैं, जिसमें pgvector एक्सटेंशन शामिल है, जो ग्राहकों को प्राकृतिक भाषा क्वेरी का उपयोग करके उत्पाद खोजने की सुविधा देता है।

हमारी स्कीमा आधुनिक मल्टी-टेनेंट पैटर्न का अनुसरण करती है, जिसमें Row Level Security यह सुनिश्चित करता है कि उपयोगकर्ता केवल अपने अधिकृत स्टोर्स का डेटा ही एक्सेस कर सकें। यह दृष्टिकोण एंटरप्राइज़-ग्रेड सुरक्षा प्रदान करता है और प्रदर्शन को भी अनुकूल बनाए रखता है।

## सीखने के उद्देश्य

इस लैब के अंत तक, आप:

- **डिज़ाइन** कर पाएंगे स्केलेबल मल्टी-टेनेंट रिटेल डेटाबेस स्कीमा  
- **लागू** कर पाएंगे PostgreSQL को pgvector के साथ वेक्टर सर्च के लिए  
- **कॉन्फ़िगर** कर पाएंगे Row Level Security डेटा आइसोलेशन के लिए  
- **जनरेट** कर पाएंगे परीक्षण के लिए यथार्थवादी सैंपल डेटा  
- **अनुकूलित** कर पाएंगे रिटेल वर्कलोड्स के लिए डेटाबेस प्रदर्शन  
- **लागू** कर पाएंगे बैकअप और रिकवरी रणनीतियां  

## 🗃️ डेटाबेस आर्किटेक्चर

### PostgreSQL और pgvector

हमारा डेटाबेस PostgreSQL की एंटरप्राइज़ विशेषताओं का उपयोग करता है, जिसमें pgvector एक्सटेंशन शामिल है, जो AI-संचालित सर्च प्रदान करता है:
...
डेटाबेस **शेयर्ड डेटाबेस, शेयर्ड स्कीमा** मल्टी-टेनेंसी मॉडल का उपयोग करता है, जिसमें Row Level Security शामिल है:
...
## 🔍 वेक्टर सर्च का कार्यान्वयन

### प्रोडक्ट एम्बेडिंग्स टेबल
...
### यथार्थवादी टेस्ट डेटा स्क्रिप्ट
...
इस लैब को पूरा करने के बाद, आप:

✅ **मल्टी-टेनेंट डेटाबेस डिज़ाइन**: सुरक्षित डेटा आइसोलेशन के लिए Row Level Security लागू कर पाएंगे  
✅ **वेक्टर सर्च क्षमताएं**: उत्पादों की सिमेंटिक सर्च के लिए pgvector कॉन्फ़िगर कर पाएंगे  
✅ **व्यापक स्कीमा**: प्रोडक्शन-रेडी रिटेल डेटाबेस स्कीमा बना पाएंगे  
✅ **सैंपल डेटा जनरेशन**: विकास और परीक्षण के लिए यथार्थवादी टेस्ट डेटा तैयार कर पाएंगे  
✅ **प्रदर्शन अनुकूलन**: इंडेक्स और क्वेरी ऑप्टिमाइजेशन कॉन्फ़िगर कर पाएंगे  
✅ **बैकअप और रिकवरी**: मजबूत डेटा सुरक्षा रणनीतियां स्थापित कर पाएंगे  

## 🚀 आगे क्या करें

**[Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)** के साथ जारी रखें:

- उस FastMCP सर्वर को बनाएं जो इस डेटाबेस से जुड़ता है  
- MCP प्रोटोकॉल के लिए डेटाबेस क्वेरी टूल्स लागू करें  
- एम्बेडिंग्स का उपयोग करके सिमेंटिक सर्च क्षमताएं जोड़ें  
- कनेक्शन पूलिंग और एरर हैंडलिंग कॉन्फ़िगर करें  

## 📚 अतिरिक्त संसाधन

### PostgreSQL और pgvector
- [PostgreSQL Documentation](https://www.postgresql.org/docs/) - पूरी PostgreSQL संदर्भ सामग्री  
- [pgvector Extension](https://github.com/pgvector/pgvector) - PostgreSQL के लिए वेक्टर समानता सर्च  
- [PostgreSQL Performance Tuning](https://wiki.postgresql.org/wiki/Performance_Optimization) - अनुकूलन के सर्वोत्तम अभ्यास  

### मल्टी-टेनेंट आर्किटेक्चर
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS दस्तावेज़  
- [Multi-Tenant Data Architecture](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure आर्किटेक्चर पैटर्न  
- [Database Security Best Practices](https://www.postgresql.org/docs/current/security.html) - PostgreSQL सुरक्षा गाइड  

### वेक्टर डेटाबेस
- [Vector Search Fundamentals](https://www.pinecone.io/learn/vector-database/) - वेक्टर डेटाबेस को समझना  
- [Embedding Models](https://platform.openai.com/docs/guides/embeddings) - OpenAI एम्बेडिंग्स दस्तावेज़  
- [HNSW Algorithm](https://arxiv.org/abs/1603.09320) - हायार्किकल नेविगेबल स्मॉल वर्ल्ड ग्राफ्स  

---

**पिछला**: [Lab 03: Environment Setup](../03-Setup/README.md)  
**अगला**: [Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)  
