...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T14:01:39+00:00",
...
यह लैब MCP सर्वरों के लिए एंटरप्राइज़-ग्रेड सुरक्षा और मल्टी-टेनेंसी को लागू करने के लिए व्यापक मार्गदर्शन प्रदान करता है। आप सीखेंगे कि संवेदनशील रिटेल डेटा की सुरक्षा करते हुए और कई टेनेंट्स के बीच लचीले एक्सेस पैटर्न को सक्षम करते हुए सुरक्षित और अनुपालन प्रणाली कैसे डिज़ाइन करें।

## परिचय

सुरक्षा उन रिटेल एप्लिकेशन में सबसे महत्वपूर्ण है जो ग्राहक डेटा, भुगतान जानकारी और बिज़नेस इंटेलिजेंस को संभालते हैं। यह लैब सुरक्षा आर्किटेक्चर को पूरी तरह से कवर करता है, जिसमें ऑथेंटिकेशन और ऑथराइज़ेशन से लेकर डेटा आइसोलेशन और अनुपालन मॉनिटरिंग तक शामिल है।

हम Azure पहचान सेवाओं, PostgreSQL Row Level Security, एप्लिकेशन-स्तरीय नियंत्रण, और व्यापक ऑडिट लॉगिंग को मिलाकर एक मजबूत और अनुपालन प्लेटफ़ॉर्म बनाने के लिए एक गहन रक्षा रणनीति लागू करते हैं।

## सीखने के उद्देश्य

इस लैब के अंत तक, आप सक्षम होंगे:

- **लागू करें** एंटरप्राइज़-ग्रेड Row Level Security मल्टी-टेनेंट डेटा आइसोलेशन के लिए  
- **डिज़ाइन करें** सुरक्षित ऑथेंटिकेशन और ऑथराइज़ेशन पैटर्न Azure के साथ  
- **कॉन्फ़िगर करें** अनुपालन आवश्यकताओं के लिए व्यापक ऑडिट लॉगिंग  
- **लागू करें** सभी एप्लिकेशन लेयर्स में गहन सुरक्षा रणनीतियाँ  
- **सत्यापित करें** सुरक्षा कार्यान्वयन को व्यवस्थित परीक्षण के माध्यम से  
- **मॉनिटर करें** सुरक्षा घटनाओं को और संभावित खतरों का जवाब दें  

## 🔐 मल्टी-टेनेंट सुरक्षा आर्किटेक्चर

### सुरक्षा लेयर्स का अवलोकन
...
### मल्टी-टेनेंसी मॉडल्स

हमारी कार्यान्वयन **Shared Database, Shared Schema** मॉडल का उपयोग करती है Row Level Security के साथ:

**लाभ:**
- संसाधनों का लागत-प्रभावी उपयोग  
- रखरखाव और अपडेट को सरल बनाना  
- RLS के माध्यम से मजबूत डेटा आइसोलेशन  
- अनुपालन-अनुकूल ऑडिट ट्रेल्स  

**समझौते:**
- RLS नीति डिज़ाइन में सावधानी की आवश्यकता  
- स्कीमा परिवर्तन सभी टेनेंट्स को प्रभावित करते हैं  
- मजबूत बैकअप/रिस्टोर प्रक्रियाओं की आवश्यकता  
...
✅ **मल्टी-टेनेंट सुरक्षा**: पूर्ण डेटा आइसोलेशन के लिए Row Level Security लागू किया  
✅ **Azure ऑथेंटिकेशन**: Azure Entra ID को JWT सत्यापन के साथ एकीकृत किया  
✅ **रोल-आधारित ऑथराइज़ेशन**: पदानुक्रमित रोल और अनुमति प्रणाली कॉन्फ़िगर की  
✅ **व्यापक ऑडिट लॉगिंग**: सुरक्षा घटना ट्रैकिंग और मॉनिटरिंग स्थापित की  
✅ **सुरक्षा परीक्षण**: स्वचालित सुरक्षा सत्यापन परीक्षण लागू किए  
✅ **खतरे की निगरानी**: वास्तविक समय में सुरक्षा घटना का पता लगाने और अलर्टिंग बनाई  

## 🚀 आगे क्या करें

**[लैब 03: पर्यावरण सेटअप](../03-Setup/README.md)** के साथ जारी रखें:

- सुरक्षा सर्वोत्तम प्रथाओं के साथ विकास पर्यावरण कॉन्फ़िगर करें  
- ऑथेंटिकेशन और मॉनिटरिंग के लिए Azure सेवाओं को सेट करें  
- सुरक्षित डेटाबेस कनेक्शन और सीक्रेट्स प्रबंधन लागू करें  
- विकास पर्यावरण में सुरक्षा कॉन्फ़िगरेशन को सत्यापित करें  

## 📚 अतिरिक्त संसाधन

### Azure सुरक्षा
- [Azure Entra ID दस्तावेज़](https://docs.microsoft.com/azure/active-directory/) - पूर्ण पहचान प्लेटफ़ॉर्म गाइड  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - सीक्रेट्स प्रबंधन सेवा  
- [Azure सुरक्षा सर्वोत्तम प्रथाएँ](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - सुरक्षा मार्गदर्शन  

### डेटाबेस सुरक्षा
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - आधिकारिक RLS दस्तावेज़  
- [डेटाबेस सुरक्षा चेकलिस्ट](https://www.postgresql.org/docs/current/security.html) - PostgreSQL सुरक्षा गाइड  
- [मल्टी-टेनेंट डेटाबेस पैटर्न्स](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - आर्किटेक्चर पैटर्न  

### सुरक्षा परीक्षण
- [OWASP टेस्टिंग गाइड](https://owasp.org/www-project-web-security-testing-guide/) - व्यापक सुरक्षा परीक्षण  
- [JWT सुरक्षा सर्वोत्तम प्रथाएँ](https://tools.ietf.org/html/rfc8725) - JWT सुरक्षा विचार  
- [API सुरक्षा परीक्षण](https://owasp.org/www-project-api-security/) - API-विशिष्ट सुरक्षा परीक्षण  

---

**पिछला**: [लैब 01: कोर आर्किटेक्चर अवधारणाएँ](../01-Architecture/README.md)  
**अगला**: [लैब 03: पर्यावरण सेटअप](../03-Setup/README.md)  
