...
यह लैब आपके MCP सर्वर के लिए प्रोडक्शन वातावरण में निगरानी, अवलोकन और अलर्टिंग को लागू करने के लिए व्यापक मार्गदर्शन प्रदान करता है। आप सीखेंगे कि Application Insights सेटअप कैसे करें, उपयोगी डैशबोर्ड बनाएं, प्रभावी अलर्टिंग लागू करें, और परिचालन उत्कृष्टता के लिए समस्या निवारण वर्कफ़्लो स्थापित करें।

## अवलोकन

प्रभावी निगरानी और अवलोकन प्रोडक्शन में MCP सर्वर की विश्वसनीयता बनाए रखने के लिए महत्वपूर्ण हैं। यह लैब अवलोकन के तीन स्तंभों—मेट्रिक्स, लॉग्स, और ट्रेस—को कवर करती है और आपको व्यापक निगरानी लागू करने का तरीका दिखाती है जो सक्रिय समस्या पहचान और तेज़ समस्या समाधान को सक्षम बनाती है।

आप सीखेंगे कि कच्चे टेलीमेट्री डेटा को क्रियाशील अंतर्दृष्टि में कैसे बदलें जो आपको सिस्टम व्यवहार को समझने, प्रदर्शन को अनुकूलित करने, और उच्च उपलब्धता सुनिश्चित करने में मदद करें।

## सीखने के उद्देश्य

इस लैब के अंत तक, आप सक्षम होंगे:

- MCP सर्वर के लिए व्यापक Application Insights एकीकरण **लागू करें**  
- प्रभावी समस्या निवारण के लिए संरचित लॉगिंग पैटर्न **डिज़ाइन करें**  
- प्रदर्शन मेट्रिक्स संग्रह और विश्लेषण प्रणाली **बनाएं**  
- क्रियाशील सूचनाओं के साथ बुद्धिमान अलर्टिंग **कॉन्फ़िगर करें**  
- वास्तविक समय निगरानी के लिए परिचालन डैशबोर्ड **बनाएं**  
- प्रभावी समस्या निवारण वर्कफ़्लो और रनबुक **स्थापित करें**  
...
### संरचित डेटा के साथ उन्नत लॉगिंग
...
✅ **Application Insights एकीकरण**: टेलीमेट्री और निगरानी का पूरा सेटअप  
✅ **संरचित लॉगिंग**: प्रोडक्शन-रेडी लॉगिंग जिसमें सहसंबंध और संदर्भ शामिल हैं  
✅ **कस्टम मेट्रिक्स**: व्यवसाय और तकनीकी मेट्रिक्स संग्रह और विश्लेषण  
✅ **बुद्धिमान अलर्टिंग**: सक्रिय अलर्टिंग के साथ कई सूचना चैनल  
✅ **परिचालन डैशबोर्ड**: वास्तविक समय निगरानी और व्यवसाय अंतर्दृष्टि  
✅ **समस्या निवारण वर्कफ़्लो**: स्वचालित डायग्नोस्टिक्स और परिचालन रनबुक  

## 🚀 आगे क्या करें

**[लैब 12: सर्वोत्तम प्रथाएं और अनुकूलन](../12-Best-Practices/README.md)** के साथ जारी रखें:

- प्रदर्शन अनुकूलन तकनीकों को लागू करें  
- व्यापक सुरक्षा सख्ती लागू करें  
- प्रोडक्शन परिनियोजन सर्वोत्तम प्रथाओं को सीखें  
- लागत अनुकूलन रणनीतियाँ स्थापित करें  

## 📚 अतिरिक्त संसाधन

### Azure Monitor
- [Application Insights दस्तावेज़](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - पूरी निगरानी गाइड  
- [KQL क्वेरी संदर्भ](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Application Insights के लिए क्वेरी भाषा  
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - कस्टम डैशबोर्ड निर्माण  

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - इंस्ट्रूमेंटेशन गाइड  
- [डिस्ट्रिब्यूटेड ट्रेसिंग](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - ट्रेसिंग अवधारणाएँ  
- [मेट्रिक्स संग्रह](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - मेट्रिक्स सर्वोत्तम प्रथाएं  

### परिचालन उत्कृष्टता
- [SRE हैंडबुक](https://sre.google/sre-book/table-of-contents/) - साइट विश्वसनीयता इंजीनियरिंग सिद्धांत  
- [निगरानी सर्वोत्तम प्रथाएं](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - उद्योग की सर्वोत्तम प्रथाएं  
- [घटना प्रतिक्रिया](https://response.pagerduty.com/) - घटना प्रबंधन गाइड  

---

**पिछला**: [लैब 10: परिनियोजन रणनीतियाँ](../10-Deployment/README.md)  
**अगला**: [लैब 12: सर्वोत्तम प्रथाएं और अनुकूलन](../12-Best-Practices/README.md)  
