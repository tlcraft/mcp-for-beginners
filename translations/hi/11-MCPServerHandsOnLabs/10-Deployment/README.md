...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T14:18:25+00:00",
...
यह लैब आपके MCP रिटेल सर्वर को उत्पादन वातावरण में आधुनिक कंटेनरीकरण और क्लाउड-नेटिव दृष्टिकोणों का उपयोग करके परिनियोजित करने के लिए व्यापक मार्गदर्शन प्रदान करता है। आप ऐसे MCP सर्वर को परिनियोजित करना सीखेंगे जो एंटरप्राइज़ वर्कलोड को संभालने के लिए स्केलेबल, सुरक्षित और मॉनिटर किए जा सकते हैं।

## अवलोकन

MCP सर्वर का उत्पादन परिनियोजन कंटेनरीकरण, ऑर्केस्ट्रेशन, सुरक्षा, स्केलेबिलिटी और मॉनिटरिंग पर सावधानीपूर्वक विचार करने की आवश्यकता होती है। यह लैब Azure Container Apps के साथ PostgreSQL Flexible Server पर परिनियोजन, CI/CD पाइपलाइनों को लागू करने और वेरिएबल वर्कलोड के लिए ऑटो-स्केलिंग को कॉन्फ़िगर करने को कवर करता है।

परिनियोजन रणनीतियाँ विकास के लिए सरल सिंगल-कंटेनर परिनियोजन से लेकर बहु-क्षेत्रीय, ऑटो-स्केलिंग उत्पादन वातावरण तक होती हैं, जिनमें व्यापक मॉनिटरिंग और सुरक्षा सुविधाएँ होती हैं।

## सीखने के उद्देश्य

इस लैब के अंत तक, आप सक्षम होंगे:

- **कंटेनरीकरण**: Docker का उपयोग करके MCP सर्वर को मल्टी-स्टेज बिल्ड्स के साथ कंटेनरीकृत करना  
- **परिनियोजन**: सुरक्षित नेटवर्किंग के साथ Azure Container Apps पर परिनियोजित करना  
- **कॉन्फ़िगरेशन**: उच्च उपलब्धता के साथ उत्पादन-ग्रेड PostgreSQL को कॉन्फ़िगर करना  
- **लागू करना**: स्वचालित परिनियोजन के लिए CI/CD पाइपलाइनों को लागू करना  
- **स्केलिंग**: मांग के आधार पर एप्लिकेशन को स्वचालित रूप से स्केल करना  
- **मॉनिटरिंग**: व्यापक ऑब्ज़र्वेबिलिटी के साथ उत्पादन परिनियोजन की निगरानी करना  
...
## ☁️ Azure Container Apps परिनियोजन
...
✅ **कंटेनर रणनीति**: सुरक्षा सख्ती के साथ उत्पादन-तैयार Docker कंटेनर  
✅ **क्लाउड परिनियोजन**: ऑटो-स्केलिंग और मॉनिटरिंग के साथ Azure Container Apps  
✅ **डेटाबेस परिनियोजन**: उच्च उपलब्धता के साथ PostgreSQL Flexible Server  
✅ **CI/CD पाइपलाइनों**: स्वचालित परीक्षण, निर्माण और परिनियोजन वर्कफ़्लो  
✅ **प्रदर्शन मॉनिटरिंग**: व्यापक मेट्रिक्स संग्रह और अलर्टिंग  
✅ **सुरक्षा कॉन्फ़िगरेशन**: उत्पादन-ग्रेड सुरक्षा नीतियाँ और नेटवर्क आइसोलेशन  

## 🚀 आगे क्या करें

**[लैब 11: मॉनिटरिंग और ऑब्ज़र्वेबिलिटी](../11-Monitoring/README.md)** के साथ जारी रखें:

- Application Insights के साथ व्यापक मॉनिटरिंग सेट करें  
- संरचित लॉगिंग और वितरित ट्रेसिंग कॉन्फ़िगर करें  
- अलर्टिंग और स्वचालित प्रतिक्रिया प्रणाली लागू करें  
- व्यावसायिक मेट्रिक्स और प्रदर्शन KPI की निगरानी करें  

## 📚 अतिरिक्त संसाधन

### कंटेनर तकनीकें
- [Docker Best Practices](https://docs.docker.com/develop/dev-best-practices/) - आधिकारिक Docker सर्वोत्तम प्रथाएँ  
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Azure Container Apps दस्तावेज़  
- [Kubernetes Documentation](https://kubernetes.io/docs/) - Kubernetes आधिकारिक दस्तावेज़  

### CI/CD और DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - GitHub Actions दस्तावेज़  
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Azure DevOps सेवाएँ  
- [Infrastructure as Code](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Azure Bicep दस्तावेज़  

### सुरक्षा और मॉनिटरिंग
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Azure सुरक्षा सिफारिशें  
- [Container Security](https://kubernetes.io/docs/concepts/security/) - Kubernetes सुरक्षा अवधारणाएँ  
...
**पिछला**: [लैब 09: VS Code इंटीग्रेशन](../09-VS-Code/README.md)  
**अगला**: [लैब 11: मॉनिटरिंग और ऑब्ज़र्वेबिलिटी](../11-Monitoring/README.md)  
