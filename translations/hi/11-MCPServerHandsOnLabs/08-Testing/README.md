...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T13:49:20+00:00",
...
यह लैब उत्पादन वातावरण में MCP सर्वर के परीक्षण और डिबगिंग पर व्यापक मार्गदर्शन प्रदान करता है। आप मजबूत परीक्षण रणनीतियों को लागू करना, जटिल समस्याओं को डिबग करना, और यह सुनिश्चित करना सीखेंगे कि आपका MCP सर्वर विभिन्न परिस्थितियों में विश्वसनीय प्रदर्शन करे।

## अवलोकन

MCP सर्वर का परीक्षण एक बहु-स्तरीय दृष्टिकोण की आवश्यकता होती है, जिसमें यूनिट परीक्षण, इंटीग्रेशन परीक्षण, प्रदर्शन मान्यता, और वास्तविक दुनिया के परिदृश्य परीक्षण शामिल हैं। यह लैब विकास से लेकर उत्पादन निगरानी तक पूरे परीक्षण जीवनचक्र को कवर करता है।

हमारी परीक्षण रणनीति विश्वसनीयता, सुरक्षा, और प्रदर्शन पर जोर देती है, ताकि आपका MCP सर्वर उत्पादन कार्यभार को संभाल सके और डेटा अखंडता और उपयोगकर्ता अनुभव की गुणवत्ता बनाए रख सके।

## सीखने के उद्देश्य

इस लैब के अंत तक, आप सक्षम होंगे:

- **लागू करें** व्यापक यूनिट और इंटीग्रेशन टेस्ट सूट  
- **डिजाइन करें** MCP टूल्स और डेटाबेस ऑपरेशंस के लिए प्रभावी परीक्षण रणनीतियाँ  
- **डिबग करें** जटिल समस्याओं को उन्नत डिबगिंग तकनीकों का उपयोग करके  
- **मान्य करें** लोड के तहत प्रदर्शन को वास्तविक परीक्षण परिदृश्यों के साथ  
- **निगरानी करें** प्रभावी अलर्टिंग और ऑब्ज़र्वेबिलिटी के साथ उत्पादन प्रणाली  
- **स्वचालित करें** निरंतर इंटीग्रेशन के लिए परीक्षण वर्कफ़्लो  

## 🧪 परीक्षण आर्किटेक्चर

### परीक्षण रणनीति का अवलोकन
...
✅ **व्यापक परीक्षण फ्रेमवर्क**: सभी घटकों के लिए यूनिट, इंटीग्रेशन, और प्रदर्शन परीक्षण  
✅ **उन्नत डिबगिंग टूल्स**: निष्पादन ट्रेसिंग के साथ परिष्कृत डिबगिंग उपयोगिताएँ  
✅ **प्रदर्शन मान्यता**: लोड परीक्षण और स्केलेबिलिटी विश्लेषण क्षमताएँ  
✅ **सुरक्षा परीक्षण**: SQL इंजेक्शन रोकथाम और RLS मान्यता  
✅ **निगरानी एकीकरण**: प्रदर्शन मेट्रिक्स और बॉटलनेक विश्लेषण  
✅ **CI/CD तैयार**: निरंतर इंटीग्रेशन के लिए स्वचालित परीक्षण वर्कफ़्लो  

## 🚀 आगे क्या करें

**[लैब 09: VS कोड इंटीग्रेशन](../09-VS-Code/README.md)** के साथ जारी रखें:

- MCP सर्वर विकास के लिए VS कोड कॉन्फ़िगर करें  
- VS कोड में डिबगिंग वातावरण सेट करें  
- MCP सर्वर को VS कोड चैट के साथ एकीकृत करें  
- VS कोड वर्कफ़्लो का पूरा परीक्षण करें  

## 📚 अतिरिक्त संसाधन

### परीक्षण फ्रेमवर्क
- [pytest दस्तावेज़](https://docs.pytest.org/) - पायथन परीक्षण फ्रेमवर्क  
- [AsyncPG परीक्षण](https://magicstack.github.io/asyncpg/current/index.html) - Async PostgreSQL परीक्षण  
- [FastAPI परीक्षण](https://fastapi.tiangolo.com/tutorial/testing/) - API परीक्षण पैटर्न  

### प्रदर्शन परीक्षण
- [लोड परीक्षण सर्वोत्तम प्रथाएँ](https://docs.python.org/3/library/asyncio.html) - Async प्रदर्शन परीक्षण  
- [डेटाबेस प्रदर्शन परीक्षण](https://www.postgresql.org/docs/current/performance-tips.html) - PostgreSQL अनुकूलन  
- [मेमोरी प्रोफाइलिंग](https://docs.python.org/3/library/tracemalloc.html) - पायथन मेमोरी विश्लेषण  

### डिबगिंग टूल्स
- [पायथन डिबगिंग](https://docs.python.org/3/library/pdb.html) - पायथन डिबगर  
- [Async डिबगिंग](https://docs.python.org/3/library/asyncio-dev.html) - Asyncio डिबगिंग  
- [SQL डिबगिंग](https://www.postgresql.org/docs/current/runtime-config-logging.html) - PostgreSQL लॉगिंग  

---

**पिछला**: [लैब 07: सेमांटिक सर्च इंटीग्रेशन](../07-Semantic-Search/README.md)  
**अगला**: [लैब 09: VS कोड इंटीग्रेशन](../09-VS-Code/README.md)  
