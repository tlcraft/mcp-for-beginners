...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-14T00:55:17+00:00",
...
> 
> 1. **Python कार्यान्वयन**: एक FastMCP सर्वर कार्यान्वयन जो वेब सर्च टूल प्रदान करता है और बाहरी सर्च API से जुड़ता है। यह उदाहरण उचित जीवनकाल प्रबंधन, संदर्भ हैंडलिंग, और टूल कार्यान्वयन को दिखाता है, जो [आधिकारिक MCP Python SDK](https://github.com/modelcontextprotocol/python-sdk) के पैटर्न का पालन करता है। सर्वर अनुशंसित Streamable HTTP ट्रांसपोर्ट का उपयोग करता है, जो उत्पादन तैनाती के लिए पुराने SSE ट्रांसपोर्ट की जगह ले चुका है।
> 
> 2. **JavaScript कार्यान्वयन**: एक TypeScript/JavaScript कार्यान्वयन जो [आधिकारिक MCP TypeScript SDK](https://github.com/modelcontextprotocol/typescript-sdk) से FastMCP पैटर्न का उपयोग करता है, जिसमें उचित टूल परिभाषाएं और क्लाइंट कनेक्शन शामिल हैं। यह नवीनतम अनुशंसित पैटर्न का पालन करता है जो सत्र प्रबंधन और संदर्भ संरक्षण के लिए हैं।
> 
...
मूल रूप से, Model Context Protocol AI मॉडल, एप्लिकेशन, और सेवाओं के बीच संदर्भ साझा करने का एक मानकीकृत तरीका प्रदान करता है। रियल-टाइम वेब सर्च में, यह फ्रेमवर्क सुसंगत, बहु-चरणीय सर्च अनुभव बनाने के लिए आवश्यक है। मुख्य घटक हैं:

1. **क्लाइंट-सर्वर आर्किटेक्चर**: MCP सर्च क्लाइंट्स (अनुरोधकर्ता) और सर्च सर्वर्स (प्रदाता) के बीच स्पष्ट विभाजन स्थापित करता है, जिससे लचीले तैनाती मॉडल संभव होते हैं।
...
3. **संदर्भ प्रबंधन**: MCP कई इंटरैक्शन के दौरान सर्च संदर्भ को बनाए रखने, अपडेट करने, और उपयोग करने के लिए संरचित विधियां परिभाषित करता है।
...
5. **स्ट्रीमिंग समर्थन**: प्रोटोकॉल स्ट्रीमिंग परिणामों का समर्थन करता है, जो रियल-टाइम सर्च के लिए आवश्यक है जहां परिणाम क्रमिक रूप से आ सकते हैं।
...
- **उपयोगकर्ता प्राथमिकताएं**: भाषा, क्षेत्र, सुरक्षित सर्च सेटिंग्स
...
MCP AI-संवर्धित ब्राउज़िंग के लिए नई संभावनाएं बनाता है:
...
### अभ्यास 3: MCP के साथ मल्टी-सोर्स खोज संघटन लागू करना  
