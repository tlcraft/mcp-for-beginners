...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-24T16:27:31+00:00",
...
- **00. MCP का परिचय**  
  Model Context Protocol का परिचय और AI पाइपलाइनों में इसकी महत्ता। [अधिक पढ़ें](./00-Introduction/README.md)
- **01. मुख्य अवधारणाओं की व्याख्या**  
  MCP की मुख्य अवधारणाओं की गहन समीक्षा। [अधिक पढ़ें](./01-CoreConcepts/README.md)
- **02. MCP में सुरक्षा**  
  सुरक्षा खतरों और सर्वोत्तम प्रथाओं पर चर्चा। [अधिक पढ़ें](./02-Security/README.md)
- **03. MCP के साथ शुरुआत**  
  पर्यावरण सेटअप, बुनियादी सर्वर/क्लाइंट, एकीकरण। [अधिक पढ़ें](./03-GettingStarted/README.md)
</details>

<details>
  <summary><strong>03.x: प्रायोगिक लैब्स</strong></summary>
...
- **3.4. Visual Studio Code से सर्वर का उपयोग** – [मार्गदर्शिका](./03-GettingStarted/04-vscode/README.md)
...
- **3.7. AI टूलकिट का उपयोग करें** – [मार्गदर्शिका](./03-GettingStarted/07-aitk/README.md)
- **3.8. अपने सर्वर का परीक्षण करें** – [मार्गदर्शिका](./03-GettingStarted/08-testing/README.md)
...
- **04. व्यावहारिक कार्यान्वयन**  
  SDKs, डिबगिंग, परीक्षण, पुन: उपयोग योग्य प्रॉम्प्ट टेम्पलेट। [अधिक पढ़ें](./04-PracticalImplementation/README.md)
...
- **5.2. मल्टी मोडालिटी** – [मार्गदर्शिका](./05-AdvancedTopics/mcp-multi-modality/README.md)
...
- **06. समुदाय योगदान** – [मार्गदर्शिका](./06-CommunityContributions/README.md)
- **07. प्रारंभिक अपनाने से प्राप्त अंतर्दृष्टि** – [Guide](./07-LessonsFromEarlyAdoption/README.md)
...
- नमूना प्रोजेक्ट्स का उपयोग कैसे करें इसकी जानकारी
...
Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) को महत्वपूर्ण कोड नमूने प्रदान करने के लिए धन्यवाद। 

## 📜 लाइसेंस जानकारी

यह सामग्री **MIT License** के अंतर्गत लाइसेंस प्राप्त है। शर्तें और नियमों के लिए, देखें [LICENSE](../../LICENSE)।

## 🤝 योगदान दिशानिर्देश

यह परियोजना योगदान और सुझावों का स्वागत करती है। अधिकांश योगदानों के लिए आपको Contributor License Agreement (CLA) से सहमति देनी होती है जिसमें आप यह घोषित करते हैं कि आपके पास अपने योगदान के उपयोग के अधिकार हैं। विवरण के लिए देखें <https://cla.opensource.microsoft.com>।

जब आप पुल रिक्वेस्ट सबमिट करते हैं, तो CLA बॉट स्वचालित रूप से यह निर्धारित करेगा कि आपको CLA प्रदान करने की आवश्यकता है या नहीं और PR को उपयुक्त रूप से चिह्नित करेगा (जैसे, स्थिति जांच, टिप्पणी)। बस बॉट द्वारा दिए गए निर्देशों का पालन करें। आपको हमारे CLA का उपयोग करने वाले सभी रिपॉजिटरीज़ में केवल एक बार यह करना होगा।
...
यह प्रोजेक्ट प्रोजेक्ट्स, उत्पादों, या सेवाओं के ट्रेडमार्क या लोगो शामिल कर सकता है। Microsoft ट्रेडमार्क या लोगो का अधिकृत उपयोग [Microsoft के ट्रेडमार्क और ब्रांड दिशानिर्देशों](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) का पालन करना आवश्यक है। इस प्रोजेक्ट के संशोधित संस्करणों में Microsoft ट्रेडमार्क या लोगो का उपयोग भ्रम पैदा नहीं करना चाहिए या Microsoft की प्रायोजन का संकेत नहीं देना चाहिए। तृतीय-पक्ष ट्रेडमार्क या लोगो का कोई भी उपयोग उन तृतीय-पक्ष की नीतियों के अधीन होता है।

**अस्वीकरण**:  
यह दस्तावेज़ AI अनुवाद सेवा [Co-op Translator](https://github.com/Azure/co-op-translator) का उपयोग करके अनुवादित किया गया है। जबकि हम सटीकता के लिए प्रयासरत हैं, कृपया ध्यान दें कि स्वचालित अनुवाद में त्रुटियाँ या असत्यताएँ हो सकती हैं। मूल दस्तावेज़ अपनी मूल भाषा में ही प्रामाणिक स्रोत माना जाना चाहिए। महत्वपूर्ण जानकारी के लिए पेशेवर मानव अनुवाद की सिफारिश की जाती है। इस अनुवाद के उपयोग से उत्पन्न किसी भी गलतफहमी या गलत व्याख्या के लिए हम उत्तरदायी नहीं हैं।