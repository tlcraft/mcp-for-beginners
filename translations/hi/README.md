...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T07:07:23+00:00",
...
MCP Dev Days के लिए तैयार हो जाइए, एक वर्चुअल इवेंट जो मॉडल कॉन्टेक्स्ट प्रोटोकॉल (MCP) पर केंद्रित है — एक उभरता हुआ मानक जो AI मॉडल और उनके द्वारा उपयोग किए जाने वाले टूल्स को जोड़ता है। यह दो दिनों का गहन तकनीकी अंतर्दृष्टि, सामुदायिक कनेक्शन, और व्यावहारिक सीखने का अवसर है।  
...
यह दिन MCP को डेवलपर वर्कफ़्लो में उपयोग करने और अद्भुत MCP समुदाय का जश्न मनाने के बारे में है। हम समुदाय के सदस्यों और Arcade, Block, Okta, और Neon जैसे भागीदारों के साथ जुड़ेंगे, यह देखने के लिए कि वे Microsoft के साथ मिलकर एक खुला, विस्तार योग्य MCP इकोसिस्टम कैसे बना रहे हैं।  
...
गहन वीडियो सत्रों में सीखें कि MCP सर्वर कैसे बनाएं, VS Code के साथ एकीकृत करें, और MCP फॉर बिगिनर्स पाठ्यक्रम की सामग्री के आधार पर Azure पर पेशेवर रूप से तैनात करें। व्यावहारिक कौशल के साथ बाहर निकलें जो प्रमुख कंपनियां पहले से ही उपयोग कर रही हैं।  

#### [➡️ ऑन डिमांड देखें MCP बूट कैंप | अंग्रेजी](https://developer.microsoft.com/en-us/reactor/series/s-1568/)  
#### [➡️ ऑन डिमांड देखें MCP बूट कैंप | ब्रासील](https://developer.microsoft.com/en-us/reactor/series/S-1566/)  
#### [➡️ ऑन डिमांड देखें MCP बूट कैंप | स्पेनिश](https://developer.microsoft.com/en-us/reactor/series/S-1567/)  

## 🌟 सामुदायिक धन्यवाद

महत्वपूर्ण कोड नमूने योगदान करने के लिए Microsoft Valued Professional [शिवम गोयल](https://www.linkedin.com/in/shivam2003/) का धन्यवाद।  
...
Contributor License Agreement (CLA) से सहमत होना आवश्यक है, जिसमें यह घोषित किया जाता है कि आपके पास अधिकार हैं और आप वास्तव में हमें अपने योगदान का उपयोग करने का अधिकार प्रदान करते हैं। विवरण के लिए देखें  
...
इस प्रोजेक्ट में प्रोजेक्ट्स, उत्पादों, या सेवाओं के लिए ट्रेडमार्क या लोगो हो सकते हैं। Microsoft ट्रेडमार्क या लोगो का अधिकृत उपयोग [Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) का पालन करना चाहिए।  
Microsoft ट्रेडमार्क या लोगो का संशोधित संस्करणों में उपयोग भ्रम पैदा नहीं करना चाहिए या Microsoft प्रायोजन का संकेत नहीं देना चाहिए।  
