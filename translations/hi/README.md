...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-23T14:22:52+00:00",
...
<details>
  <summary><strong>00-03: मूल बातें</strong></summary>

- **00. MCP का परिचय**  
  Model Context Protocol का अवलोकन और AI पाइपलाइनों में इसकी महत्ता। [अधिक पढ़ें](./00-Introduction/README.md)
- **01. कोर कॉन्सेप्ट्स की व्याख्या**  
  MCP के मूल सिद्धांतों का गहन अध्ययन। [अधिक पढ़ें](./01-CoreConcepts/README.md)
- **02. MCP में सुरक्षा**  
  सुरक्षा खतरों और सर्वोत्तम प्रथाओं का विवरण। [अधिक पढ़ें](./02-Security/README.md)
- **03. MCP के साथ शुरुआत**  
  पर्यावरण सेटअप, बेसिक सर्वर/क्लाइंट, इंटीग्रेशन। [अधिक पढ़ें](./03-GettingStarted/README.md)
</details>

<details>
  <summary><strong>03.x: व्यावहारिक प्रयोगशालाएं</strong></summary>
...
- **3.4. Visual Studio Code के साथ सर्वर का उपयोग** – [मार्गदर्शिका](./03-GettingStarted/04-vscode/README.md)
...
- **3.7. AI Toolkit का उपयोग करें** – [मार्गदर्शिका](./03-GettingStarted/07-aitk/README.md)
...
<details>
  <summary><strong>04-05: व्यावहारिक एवं उन्नत विषय</strong></summary>

- **04. व्यावहारिक कार्यान्वयन**  
  SDKs, डिबगिंग, परीक्षण, पुन: उपयोग योग्य प्रॉम्प्ट टेम्प्लेट। [अधिक पढ़ें](./04-PracticalImplementation/README.md)
- **05. MCP के उन्नत विषय**  
  मल्टी-मोडल AI, स्केलिंग, एंटरप्राइज उपयोग। [अधिक पढ़ें](./05-AdvancedTopics/README.md)
- **5.1. Azure के साथ MCP इंटीग्रेशन** – [मार्गदर्शिका](./05-AdvancedTopics/mcp-integration/README.md)
...
<details>
  <summary><strong>06-10: समुदाय, सर्वोत्तम प्रथाएं और प्रयोगशालाएं</strong></summary>

- **06. समुदाय योगदान** – [मार्गदर्शिका](./06-CommunityContributions/README.md)
- **07. प्रारंभिक अपनाने से मिली अंतर्दृष्टि** – [गाइड](./07-LessonsFromEarlyAdoption/README.md)
- **08. MCP के लिए सर्वोत्तम प्रथाएँ** – [गाइड](./08-BestPractices/README.md)
...
इस रिपॉजिटरी को प्रभावी ढंग से नेविगेट करने के लिए एक व्यापक [अध्ययन मार्गदर्शिका](./study_guide.md) उपलब्ध है। इस मार्गदर्शिका में शामिल हैं:

- सभी विषयों को दिखाने वाला एक दृश्य पाठ्यक्रम नक्शा  
...
यह सामग्री **MIT लाइसेंस** के अंतर्गत लाइसेंस प्राप्त है। नियम और शर्तों के लिए देखें [LICENSE](../../LICENSE)।

## 🤝 योगदान दिशानिर्देश

यह प्रोजेक्ट योगदान और सुझावों का स्वागत करता है। अधिकांश योगदानों के लिए आपको Contributor License Agreement (CLA) पर सहमति देनी होती है, जिसमें आप यह घोषणा करते हैं कि आपके पास अपने योगदान के उपयोग के अधिकार हैं। विवरण के लिए देखें <https://cla.opensource.microsoft.com>।

जब आप पुल रिक्वेस्ट सबमिट करते हैं, तो CLA बॉट स्वचालित रूप से यह निर्धारित करेगा कि आपको CLA प्रदान करने की आवश्यकता है या नहीं और PR को उपयुक्त रूप से चिह्नित करेगा (जैसे, स्थिति जांच, टिप्पणी)। बस बॉट द्वारा दिए गए निर्देशों का पालन करें। आपको यह केवल एक बार सभी रिपॉजिटरीज में करना होगा जो हमारे CLA का उपयोग करती हैं।
...
यह प्रोजेक्ट प्रोजेक्ट्स, उत्पादों या सेवाओं के ट्रेडमार्क या लोगो शामिल कर सकता है। Microsoft के ट्रेडमार्क या लोगो का अधिकृत उपयोग
...
तीसरे पक्ष के ट्रेडमार्क या लोगो का उपयोग उनके नीतियों के अधीन होता है।

**अस्वीकरण**:  
इस दस्तावेज़ का अनुवाद AI अनुवाद सेवा [Co-op Translator](https://github.com/Azure/co-op-translator) का उपयोग करके किया गया है। जबकि हम सटीकता के लिए प्रयासरत हैं, कृपया ध्यान दें कि स्वचालित अनुवादों में त्रुटियाँ या असंगतियाँ हो सकती हैं। मूल दस्तावेज़ अपनी मूल भाषा में ही प्राधिकृत स्रोत माना जाना चाहिए। महत्वपूर्ण जानकारी के लिए, पेशेवर मानव अनुवाद की सलाह दी जाती है। इस अनुवाद के उपयोग से उत्पन्न किसी भी गलतफहमी या गलत व्याख्या के लिए हम जिम्मेदार नहीं हैं।