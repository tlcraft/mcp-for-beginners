...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T12:22:08+00:00",
...
**मॉडल कॉन्टेक्स्ट प्रोटोकॉल (MCP)** एक अत्याधुनिक फ्रेमवर्क है जिसे AI मॉडल और क्लाइंट एप्लिकेशन के बीच इंटरैक्शन को मानकीकृत करने के लिए डिज़ाइन किया गया है। यह ओपन-सोर्स पाठ्यक्रम एक संरचित शिक्षण पथ प्रदान करता है, जिसमें लोकप्रिय प्रोग्रामिंग भाषाओं जैसे C#, Java, JavaScript, TypeScript, और Python में व्यावहारिक कोडिंग उदाहरण और वास्तविक दुनिया के उपयोग के मामले शामिल हैं।

चाहे आप एक AI डेवलपर हों, सिस्टम आर्किटेक्ट हों, या सॉफ़्टवेयर इंजीनियर हों, यह गाइड MCP के मूलभूत और कार्यान्वयन रणनीतियों को मास्टर करने के लिए आपका व्यापक संसाधन है।
...
डेवलपर्स को उनके डेवलपर वर्कफ़्लो में MCP का उपयोग करने और अद्भुत MCP समुदाय का जश्न मनाने के लिए सशक्त बनाने पर केंद्रित है।  
हम Arcade, Block, Okta, और Neon जैसे समुदाय के सदस्यों और भागीदारों के साथ जुड़ेंगे, यह देखने के लिए कि वे Microsoft के साथ मिलकर एक ओपन, एक्स्टेंसिबल MCP इकोसिस्टम को कैसे आकार दे रहे हैं।  
...
| 09 | MCP केस स्टडीज़ | व्यावहारिक कार्यान्वयन के उदाहरण | [गाइड](./09-CaseStudy/README.md) |
...
| RUST | कंटेनर सैंपल | [कोड देखें](.03-GettingStarted/samples/rust/README.md) |
...
- कम से कम एक प्रोग्रामिंग भाषा (C#, Java, JavaScript, Python, या TypeScript) का बुनियादी ज्ञान  
...
एक व्यापक [अध्ययन गाइड](./study_guide.md) उपलब्ध है, जो इस रिपॉजिटरी को प्रभावी ढंग से नेविगेट करने में आपकी मदद करता है। इसमें शामिल हैं:
...
महत्वपूर्ण कोड सैंपल्स में योगदान देने के लिए Microsoft Valued Professional [शिवम गोयल](https://www.linkedin.com/in/shivam2003/) का धन्यवाद।  
...
Contributor License Agreement (CLA) से सहमत होना होगा, जिसमें यह घोषित करना होगा कि आपके पास योगदान करने का अधिकार है और आप हमें इसका उपयोग करने का अधिकार देते हैं। विवरण के लिए देखें  
