...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-11T12:58:32+00:00",
...
# 🚀 शुरुआती लोगों के लिए मॉडल कॉन्टेक्स्ट प्रोटोकॉल (MCP) पाठ्यक्रम
...
- 📜 [मूल MCP विनिर्देश](https://spec.modelcontextprotocol.io/) – पुराने तकनीकी संदर्भ (अतिरिक्त विवरण हो सकते हैं)  
...
MCP Dev Days, एक वर्चुअल इवेंट, जो मॉडल कॉन्टेक्स्ट प्रोटोकॉल (MCP) को समर्पित है, में गहन तकनीकी जानकारी, सामुदायिक कनेक्शन, और व्यावहारिक सीखने के लिए तैयार हो जाएं।  
...
डेवलपर्स को उनके डेवलपर वर्कफ़्लो में MCP का उपयोग करने के लिए सशक्त बनाने और अद्भुत MCP समुदाय का जश्न मनाने के बारे में है।  
हम Arcade, Block, Okta, और Neon जैसे समुदाय के सदस्यों और भागीदारों के साथ Microsoft के साथ एक खुले, विस्तारित MCP इकोसिस्टम को आकार देने के लिए उनके सहयोग को देखेंगे।  
...
Contributor License Agreement (CLA) से सहमत होना होगा, जिसमें यह घोषणा करनी होगी कि आपके पास योगदान का अधिकार है और आप हमें इसका उपयोग करने का अधिकार देते हैं। विवरण के लिए देखें  
