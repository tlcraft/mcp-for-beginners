...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T12:51:23+00:00",
...
**मॉडल कॉन्टेक्स्ट प्रोटोकॉल (MCP)** एक अत्याधुनिक फ्रेमवर्क है जिसे AI मॉडल और क्लाइंट एप्लिकेशन के बीच इंटरैक्शन को मानकीकृत करने के लिए डिज़ाइन किया गया है। यह ओपन-सोर्स पाठ्यक्रम एक संरचित शिक्षण पथ प्रदान करता है, जिसमें व्यावहारिक कोडिंग उदाहरण और वास्तविक दुनिया के उपयोग के मामले शामिल हैं, जो C#, Java, JavaScript, TypeScript, और Python जैसी लोकप्रिय प्रोग्रामिंग भाषाओं में उपलब्ध हैं।

चाहे आप एक AI डेवलपर हों, सिस्टम आर्किटेक्ट हों, या सॉफ़्टवेयर इंजीनियर हों, यह गाइड MCP की मूलभूत बातों और कार्यान्वयन रणनीतियों को मास्टर करने के लिए आपका व्यापक संसाधन है।
...
- 🌐 [MCP समुदाय](https://github.com/orgs/modelcontextprotocol/discussions) – चर्चाओं में शामिल हों और समुदाय में योगदान दें
 ...
 ### ➡️ ऑन डिमांड देखें - MCP डेवलपर डेज़
MCP डेवलपर डेज़, एक वर्चुअल इवेंट जो मॉडल कॉन्टेक्स्ट प्रोटोकॉल (MCP) को समर्पित है, में गहन तकनीकी जानकारी, सामुदायिक कनेक्शन, और व्यावहारिक शिक्षण के लिए तैयार हो जाएं।  
आप हमारे इवेंट पेज पर रजिस्टर करके MCP डेवलपर डेज़ देख सकते हैं: https://aka.ms/mcpdevdays। 

#### दिन 1: MCP उत्पादकता, डेवलपर टूल्स, और समुदाय: 

यह डेवलपर्स को उनके डेवलपर वर्कफ़्लो में MCP का उपयोग करने और अद्भुत MCP समुदाय का जश्न मनाने के लिए सशक्त बनाने के बारे में है।  
हम समुदाय के सदस्यों और Arcade, Block, Okta, और Neon जैसे भागीदारों के साथ जुड़ेंगे, यह देखने के लिए कि वे Microsoft के साथ मिलकर एक ओपन, एक्स्टेंसिबल MCP इकोसिस्टम को कैसे आकार दे रहे हैं।  
...
यह MCP बिल्डरों के लिए है। हम MCP सर्वर बनाने और उन्हें AI वर्कफ़्लो में एकीकृत करने के लिए कार्यान्वयन रणनीतियों और सर्वोत्तम प्रथाओं में गहराई से जाएंगे।
...
| 3.4 | VS Code एकीकरण | VS Code में MCP सर्वर का उपभोग करें | [गाइड](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | SSE सर्वर | सर्वर-सेंट इवेंट्स का उपयोग करके सर्वर बनाएं | [गाइड](./03-GettingStarted/05-sse-server/README.md) |
| 3.6 | HTTP स्ट्रीमिंग | MCP में HTTP स्ट्रीमिंग को लागू करें | [गाइड](./03-GettingStarted/06-http-streaming/README.md) |
...
| 3.9 | परिनियोजन | MCP सर्वरों को उत्पादन में परिनियोजित करें | [गाइड](./03-GettingStarted/09-deployment/README.md) |
...
| 5.3 | OAuth2 डेमो | OAuth2 प्रमाणीकरण को लागू करें | [गाइड](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
...
| 5.11 | रीयलटाइम खोज | रीयलटाइम खोज को लागू करें | [गाइड](./05-AdvancedTopics/mcp-realtimesearch/README.md) |
...
| 06 | सामुदायिक योगदान | MCP इकोसिस्टम में योगदान कैसे करें | [Guide](./06-CommunityContributions/README.md) |
| 07 | शुरुआती अपनाने से सीख | वास्तविक दुनिया के कार्यान्वयन की कहानियां | [Guide](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | MCP के लिए सर्वोत्तम प्रथाएं | प्रदर्शन, फॉल्ट-टॉलरेंस, लचीलापन | [Guide](./08-BestPractices/README.md) |
...
यह रिपॉजिटरी आपको प्रभावी ढंग से नेविगेट और सीखने में मदद करने के लिए कई संसाधन प्रदान करती है:

### अध्ययन गाइड

एक व्यापक [Study Guide](./study_guide.md) उपलब्ध है जो आपको इस रिपॉजिटरी को प्रभावी ढंग से नेविगेट करने में मदद करता है। गाइड में शामिल हैं:
...
हम एक विस्तृत [Changelog](./changelog.md) बनाए रखते हैं जो पाठ्यक्रम सामग्री में सभी महत्वपूर्ण अपडेट को ट्रैक करता है, जिसमें शामिल हैं:
...
Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) को महत्वपूर्ण कोड सैंपल्स में योगदान देने के लिए धन्यवाद।  

## 📜 लाइसेंस जानकारी

यह सामग्री **MIT License** के तहत लाइसेंस प्राप्त है। शर्तों और नियमों के लिए, [LICENSE](../../LICENSE) देखें।  

## 🤝 योगदान दिशानिर्देश

यह प्रोजेक्ट योगदान और सुझावों का स्वागत करता है। अधिकांश योगदानों के लिए आपको एक  
Contributor License Agreement (CLA) पर सहमत होना होगा, जिसमें यह घोषित किया जाएगा कि आपके पास अधिकार हैं और आप हमें अपने योगदान का उपयोग करने का अधिकार प्रदान करते हैं। विवरण के लिए देखें  
...
Microsoft ट्रेडमार्क या लोगो का उपयोग संशोधित संस्करणों में भ्रम पैदा नहीं करना चाहिए या Microsoft प्रायोजन का संकेत नहीं देना चाहिए।  
