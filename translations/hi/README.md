...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:28:29+00:00",
...
चाहे आप एक AI डेवलपर हों, सिस्टम आर्किटेक्ट हों, या सॉफ़्टवेयर इंजीनियर हों, यह गाइड MCP की मूलभूत बातें और कार्यान्वयन रणनीतियों को सीखने के लिए आपका व्यापक संसाधन है।
...
- समर्थन के लिए हमारे समुदाय चर्चाओं में शामिल हों  
...
- नमूना प्रोजेक्ट का उपयोग करने के लिए मार्गदर्शन  
...
MCP Dev Days के लिए तैयार हो जाएं, एक वर्चुअल इवेंट जो Model Context Protocol (MCP) पर केंद्रित है — एक उभरता हुआ मानक जो AI मॉडल और उनके द्वारा उपयोग किए जाने वाले टूल के बीच पुल बनाता है।  
...
यह डेवलपर्स को उनके डेवलपर वर्कफ़्लो में MCP का उपयोग करने और अद्भुत MCP समुदाय का जश्न मनाने के लिए सशक्त बनाने के बारे में है। हम समुदाय के सदस्यों और Arcade, Block, Okta, और Neon जैसे भागीदारों के साथ जुड़ेंगे ताकि यह देखा जा सके कि वे Microsoft के साथ मिलकर एक खुला, विस्तार योग्य MCP इकोसिस्टम कैसे बना रहे हैं।  
...
इंटेंसिव वीडियो सत्रों में सीखें कि MCP सर्वर कैसे बनाएं, VS Code के साथ एकीकृत करें, और MCP फॉर बिगिनर्स पाठ्यक्रम की सामग्री के आधार पर Azure पर पेशेवर रूप से तैनात करें। एक ऐसी तकनीक में व्यावहारिक कौशल के साथ बाहर निकलें जिसे प्रमुख कंपनियां पहले से ही उपयोग कर रही हैं।  

#### [➡️ ऑन डिमांड देखें MCP बूट कैंप | अंग्रेजी](https://developer.microsoft.com/en-us/reactor/series/s-1568/)  
#### [➡️ ऑन डिमांड देखें MCP बूट कैंप | ब्राजील](https://developer.microsoft.com/en-us/reactor/series/S-1566/)  
...
आपके योगदान का उपयोग करने के अधिकार प्रदान करते हैं। विवरण के लिए, <https://cla.opensource.microsoft.com> पर जाएं।  
...
इस प्रोजेक्ट में प्रोजेक्ट, उत्पाद, या सेवाओं के लिए ट्रेडमार्क या लोगो हो सकते हैं। Microsoft ट्रेडमार्क या लोगो का अधिकृत उपयोग  
