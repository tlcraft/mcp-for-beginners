...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-12T08:14:33+00:00",
...
MCP डेवलपर डेज़, एक वर्चुअल इवेंट जो मॉडल कॉन्टेक्स्ट प्रोटोकॉल (MCP) पर केंद्रित है, में गहन तकनीकी जानकारी, सामुदायिक कनेक्शन, और व्यावहारिक शिक्षण के लिए तैयार हो जाएं।  
आप हमारे इवेंट पेज पर पंजीकरण करके MCP डेवलपर डेज़ देख सकते हैं: https://aka.ms/mcpdevdays।  
...
- VS Code, Visual Studio, GitHub Copilot, और लोकप्रिय सामुदायिक टूल्स के वास्तविक-विश्व डेमो  
- व्यावहारिक, संदर्भ-आधारित डेवलपर वर्कफ़्लो  
- समुदाय-नेतृत्व वाले सत्र और अंतर्दृष्टि  
चाहे आप MCP के साथ शुरुआत कर रहे हों या पहले से ही इसके साथ निर्माण कर रहे हों, दिन 1 प्रेरणा और क्रियाशील टेकअवे के साथ मंच तैयार करेगा।  
...
| 00 | MCP का परिचय | मॉडल कॉन्टेक्स्ट प्रोटोकॉल और AI पाइपलाइनों में इसकी प्रासंगिकता का अवलोकन | [अधिक पढ़ें](./00-Introduction/README.md) |
| 01 | मुख्य अवधारणाएँ समझाई गईं | MCP की मुख्य अवधारणाओं की गहन व्याख्या | [अधिक पढ़ें](./01-CoreConcepts/README.md) |
...
| 07 | प्रारंभिक अपनाने से सीखें | वास्तविक दुनिया की कार्यान्वयन कहानियाँ | [गाइड](./07-LessonsFromEarlyAdoption/README.md) |
...
एक व्यापक [अध्ययन गाइड](./study_guide.md) उपलब्ध है, जो आपको इस रिपॉजिटरी को प्रभावी ढंग से नेविगेट करने में मदद करता है। इसमें शामिल हैं:
...
यह प्रोजेक्ट योगदान और सुझावों का स्वागत करता है। अधिकांश योगदानों के लिए आपको एक Contributor License Agreement (CLA) से सहमत होना होगा, जिसमें यह घोषित करना होगा कि आपके पास योगदान का अधिकार है और आप हमें इसका उपयोग करने का अधिकार देते हैं। विवरण के लिए देखें:  
<https://cla.opensource.microsoft.com>।

जब आप एक पुल अनुरोध सबमिट करते हैं, तो एक CLA बॉट स्वचालित रूप से निर्धारित करेगा कि क्या आपको CLA प्रदान करने की आवश्यकता है और PR को उपयुक्त रूप से चिह्नित करेगा (जैसे, स्थिति जांच, टिप्पणी)। बस बॉट द्वारा प्रदान किए गए निर्देशों का पालन करें। आपको यह केवल एक बार करना होगा, सभी रिपॉजिटरीज़ के लिए जो हमारे CLA का उपयोग करते हैं।
