...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T23:08:38+00:00",
...
Ao trabalhar com servidores MCP, siga estas melhores práticas de segurança para proteger os seus dados, infraestrutura e utilizadores:
...
8. **Gestão de Sessões**: Implemente um tratamento seguro das sessões para evitar sequestro e fixação de sessões.
...
11. **Validação de Prompts**: Analise e filtre tanto os prompts de entrada como de saída para evitar ataques de injeção de prompt.
12. **Delegação de Autenticação**: Utilize provedores de identidade estabelecidos em vez de implementar autenticação personalizada.
...
15. **Análise Automática de Vulnerabilidades**: Faça análises regulares dos seus servidores MCP e dependências para identificar vulnerabilidades conhecidas.
