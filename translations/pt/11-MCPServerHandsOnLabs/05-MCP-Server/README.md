...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T13:43:37+00:00",
...
Este laboratório prático orienta-o na implementação de um servidor MCP pronto para produção utilizando o framework FastMCP. Vai construir a estrutura principal do servidor, integrar uma base de dados, criar ferramentas para acesso a dados e estabelecer a base para análises de retalho impulsionadas por IA.

## Visão Geral

O servidor MCP é o núcleo da nossa solução de análises de retalho. Ele atua como uma ponte entre assistentes de IA e a base de dados PostgreSQL, fornecendo acesso seguro e inteligente aos dados empresariais através de um protocolo padronizado.

Este laboratório ensina-o a construir um servidor MCP robusto e escalável, seguindo padrões empresariais e boas práticas.
...
- **Implementar** integração com base de dados, incluindo pooling de conexões e gestão de erros
- **Criar** ferramentas MCP para introspeção de esquema de base de dados e execução de consultas
- **Configurar** gestão de contexto de Segurança ao Nível de Linha (Row Level Security)
- **Adicionar** funcionalidades de monitorização de saúde e observabilidade
- **Testar** a implementação do servidor MCP localmente e com o VS Code
...
### Principais Funcionalidades de Configuração

- **Carregamento de Variáveis de Ambiente**: Suporte automático para ficheiros .env
- **Segurança de Tipos**: Validação com dataclass e dicas de tipo
- **Defaults Flexíveis**: Valores padrão sensatos para desenvolvimento
...
## 🗄️ Camada de Integração com Base de Dados

### Provedor PostgreSQL (`sales_analysis_postgres.py`)

Vamos implementar a camada de integração com a base de dados:
...
### Principais Funcionalidades da Camada de Base de Dados

- **Pooling de Conexões**: Gestão eficiente de recursos com asyncpg
- **Integração RLS**: Configuração automática de contexto de Segurança ao Nível de Linha
- **Introspeção de Esquema**: Descoberta dinâmica de esquema de tabelas
- **Gestão de Erros**: Gestão abrangente de erros e registo de logs
- **Formatação de Consultas**: Resultados formatados para IA
- **Monitorização de Saúde**: Verificação de conectividade e estado do pool de conexões
...
### Principais Funcionalidades do Servidor MCP

- **Registo de Ferramentas**: Definições declarativas de ferramentas com segurança de tipos
- **Gestão de Contexto RLS**: Extração automática de identidade do utilizador e configuração de contexto
- **Gestão de Erros**: Gestão abrangente de erros com mensagens amigáveis ao utilizador
- **Gestão de Ciclo de Vida**: Inicialização/encerramento adequados com limpeza de recursos
- **Monitorização de Saúde**: Endpoints de verificação de saúde integrados
- **Suporte ao Desenvolvimento**: Capacidade de hot reload e debugging
...
2. **Testar no Chat de IA**:
   - Abra o Chat de IA no VS Code
   - Escreva `#zava` e selecione o seu servidor
   - Pergunte: "Quais tabelas estão disponíveis?"
   - Pergunte: "Mostre-me as 5 lojas principais por número de pedidos"
...
✅ **Servidor MCP Funcional**: Servidor FastMCP com integração de base de dados  
✅ **Gestão de Configuração**: Sistema robusto baseado em ambiente  
✅ **Camada de Base de Dados**: Integração PostgreSQL com pooling de conexões  
✅ **Ferramentas MCP**: Ferramentas para introspeção de esquema e execução de consultas  
✅ **Integração RLS**: Gestão de contexto de Segurança ao Nível de Linha  
✅ **Monitorização de Saúde**: Endpoints abrangentes de verificação de saúde  
✅ **Estratégia de Testes**: Testes locais e integração com VS Code  

## 🚀 O Que Vem a Seguir

Continue com **[Laboratório 06: Desenvolvimento de Ferramentas](../06-Tools/README.md)** para:

- Expandir a sua coleção de ferramentas MCP
...
### Framework FastMCP
- [Documentação FastMCP](https://github.com/modelcontextprotocol/python-sdk) - Guia oficial do FastMCP
- [Especificação MCP](https://modelcontextprotocol.io/docs/) - Especificação do protocolo
- [Guia de Desenvolvimento de Ferramentas](https://modelcontextprotocol.io/docs/tools/) - Criação de ferramentas MCP

### Integração com Base de Dados
- [Documentação asyncpg](https://magicstack.github.io/asyncpg/current/) - Driver assíncrono para PostgreSQL
- [Boas Práticas de Pooling de Conexões](https://www.postgresql.org/docs/current/runtime-config-connection.html) - Otimização do PostgreSQL
- [Guia de Segurança ao Nível de Linha](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Implementação de RLS

### Padrões FastAPI
- [Documentação FastAPI](https://fastapi.tiangolo.com/) - Referência do framework web
- [Injeção de Dependências](https://fastapi.tiangolo.com/tutorial/dependencies/) - Padrões do FastAPI
- [Tarefas em Background](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Gestão de tarefas assíncronas

---

**Próximo**: Pronto para expandir as suas ferramentas? Continue com [Laboratório 06: Desenvolvimento de Ferramentas](../06-Tools/README.md)
