...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T13:59:46+00:00",
...
Este laboratório fornece orientações completas sobre como implementar segurança de nível empresarial e multi-tenancy para servidores MCP. Vais aprender a projetar sistemas seguros e em conformidade que protegem dados sensíveis de retalho, enquanto permitem padrões de acesso flexíveis entre múltiplos inquilinos.

## Visão Geral

A segurança é essencial em aplicações de retalho que lidam com dados de clientes, informações de pagamento e inteligência empresarial. Este laboratório cobre toda a arquitetura de segurança, desde autenticação e autorização até isolamento de dados e monitorização de conformidade.

Implementamos uma estratégia de defesa em profundidade que combina serviços de identidade Azure, Row Level Security do PostgreSQL, controlos ao nível da aplicação e registo abrangente de auditoria para criar uma plataforma robusta e em conformidade.

## Objetivos de Aprendizagem

No final deste laboratório, serás capaz de:

- **Implementar** Row Level Security de nível empresarial para isolamento de dados multi-inquilino  
- **Projetar** padrões seguros de autenticação e autorização com Azure  
- **Configurar** registos de auditoria abrangentes para requisitos de conformidade  
- **Aplicar** estratégias de segurança em profundidade em todas as camadas da aplicação  
- **Validar** implementações de segurança através de testes sistemáticos  
- **Monitorizar** eventos de segurança e responder a potenciais ameaças  
...
A nossa implementação utiliza o modelo **Base de Dados Partilhada, Esquema Partilhado** com Row Level Security:

**Benefícios:**
- Utilização de recursos económica  
- Manutenção e atualizações simplificadas  
- Forte isolamento de dados através de RLS  
- Trilhos de auditoria compatíveis com conformidade  

**Compromissos:**
- Requer um design cuidadoso das políticas de RLS  
- Alterações no esquema afetam todos os inquilinos  
- Necessidade de procedimentos robustos de backup/restauração  

## 🛡️ Implementação de Row Level Security
...
### Registo Abrangente de Auditoria
...
### Visualizações de Monitorização de Segurança
...
### Lista de Verificação de Testes de Penetração
...
Após completar este laboratório, deverás ter:

✅ **Segurança Multi-Inquilino**: Implementado Row Level Security para isolamento completo de dados  
✅ **Autenticação Azure**: Integrado Azure Entra ID com validação JWT  
✅ **Autorização Baseada em Funções**: Configurado sistema hierárquico de funções e permissões  
✅ **Registo Abrangente de Auditoria**: Estabelecido monitorização e rastreamento de eventos de segurança  
✅ **Testes de Segurança**: Implementado testes automatizados de validação de segurança  
✅ **Monitorização de Ameaças**: Criado deteção de eventos de segurança em tempo real e alertas  

## 🚀 Próximos Passos

Continua com **[Laboratório 03: Configuração do Ambiente](../03-Setup/README.md)** para:

- Configurar ambientes de desenvolvimento com as melhores práticas de segurança  
- Configurar serviços Azure para autenticação e monitorização  
- Implementar conexões seguras à base de dados e gestão de segredos  
- Validar configurações de segurança em ambientes de desenvolvimento  

## 📚 Recursos Adicionais

### Segurança Azure
- [Documentação do Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - Guia completo da plataforma de identidade  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Serviço de gestão de segredos  
- [Melhores Práticas de Segurança Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Orientações de segurança  

### Segurança de Base de Dados
- [Row Level Security do PostgreSQL](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Documentação oficial de RLS  
- [Lista de Verificação de Segurança de Base de Dados](https://www.postgresql.org/docs/current/security.html) - Guia de segurança do PostgreSQL  
- [Padrões de Base de Dados Multi-Inquilino](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Padrões de arquitetura  

### Testes de Segurança
- [Guia de Testes OWASP](https://owasp.org/www-project-web-security-testing-guide/) - Testes de segurança abrangentes  
- [Melhores Práticas de Segurança JWT](https://tools.ietf.org/html/rfc8725) - Considerações de segurança para JWT  
- [Testes de Segurança de API](https://owasp.org/www-project-api-security/) - Testes de segurança específicos para API  

---

**Anterior**: [Laboratório 01: Conceitos de Arquitetura Core](../01-Architecture/README.md)  
**Próximo**: [Laboratório 03: Configuração do Ambiente](../03-Setup/README.md)  
