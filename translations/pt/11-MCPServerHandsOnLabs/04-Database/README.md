...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T14:18:58+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "pt"
}
-->
# Design e Esquema de Base de Dados

## 🎯 O Que Este Laboratório Abrange

Este laboratório explora em profundidade o design da base de dados PostgreSQL para o sistema de retalho Zava. Vais aprender a implementar um esquema de retalho abrangente com capacidades de pesquisa vetorial, modelação de dados multi-inquilino e Row Level Security (RLS) para isolamento de dados.

## Visão Geral

A base de dados é a fundação do nosso servidor MCP, armazenando dados de retalho de várias lojas enquanto mantém um isolamento rigoroso de dados. Utilizamos PostgreSQL com a extensão pgvector para permitir capacidades de pesquisa semântica, permitindo que os clientes encontrem produtos através de consultas em linguagem natural.

O nosso esquema segue padrões modernos de multi-inquilino com Row Level Security, garantindo que os utilizadores só podem aceder aos dados das lojas autorizadas. Esta abordagem oferece segurança de nível empresarial enquanto mantém um desempenho otimizado.

## Objetivos de Aprendizagem

No final deste laboratório, serás capaz de:

- **Desenhar** esquemas de base de dados de retalho escaláveis para multi-inquilinos  
- **Implementar** PostgreSQL com pgvector para pesquisa vetorial  
- **Configurar** Row Level Security para isolamento de dados  
- **Gerar** dados de teste realistas  
- **Otimizar** o desempenho da base de dados para cargas de trabalho de retalho  
...
A nossa base de dados utiliza as funcionalidades empresariais do PostgreSQL combinadas com a extensão pgvector para pesquisa alimentada por IA:
...
A base de dados utiliza um modelo de multi-inquilino **base de dados partilhada, esquema partilhado** com Row Level Security:
...
### Tabela de Lojas (Master de Inquilinos)
...
## 🔍 Implementação de Pesquisa Vetorial
...
### Funções e Permissões da Base de Dados
...
### Vistas de Otimização de Consultas
...
✅ **Design de Base de Dados Multi-Inquilino**: Implementado Row Level Security para isolamento seguro de dados  
✅ **Capacidades de Pesquisa Vetorial**: Configurado pgvector para pesquisa semântica de produtos  
✅ **Esquema Abrangente**: Criado um esquema de base de dados de retalho pronto para produção  
✅ **Geração de Dados de Teste**: Construído dados de teste realistas para desenvolvimento e teste  
...
Continua com **[Laboratório 05: Implementação do Servidor MCP](../05-MCP-Server/README.md)** para:

- Construir o servidor FastMCP que se conecta a esta base de dados  
- Implementar ferramentas de consulta de base de dados para o protocolo MCP  
- Adicionar capacidades de pesquisa semântica utilizando os embeddings  
- Configurar pooling de conexões e tratamento de erros  

## 📚 Recursos Adicionais

### PostgreSQL & pgvector
- [Documentação PostgreSQL](https://www.postgresql.org/docs/) - Referência completa do PostgreSQL  
- [Extensão pgvector](https://github.com/pgvector/pgvector) - Pesquisa de similaridade vetorial para PostgreSQL  
- [Otimização de Desempenho PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Melhores práticas de otimização  

### Arquitetura Multi-Inquilino
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Documentação de RLS do PostgreSQL  
- [Arquitetura de Dados Multi-Inquilino](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Padrões de arquitetura Azure  
- [Melhores Práticas de Segurança de Base de Dados](https://www.postgresql.org/docs/current/security.html) - Guia de segurança do PostgreSQL  

### Bases de Dados Vetoriais
- [Fundamentos de Pesquisa Vetorial](https://www.pinecone.io/learn/vector-database/) - Compreender bases de dados vetoriais  
- [Modelos de Embeddings](https://platform.openai.com/docs/guides/embeddings) - Documentação de embeddings da OpenAI  
- [Algoritmo HNSW](https://arxiv.org/abs/1603.09320) - Grafos Hierarchical Navigable Small World  
