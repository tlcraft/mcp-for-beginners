...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T21:33:24+00:00",
...
- **Otimizar Desempenho**: Projetar soluções de transporte para requisitos de escala, latência e capacidade

## **Requisitos de Transporte**

### **Requisitos Centrais da Especificação MCP (2025-06-18):**
...
O Azure Event Grid fornece um serviço de roteamento de eventos sem servidor ideal para arquiteturas MCP orientadas a eventos. Esta implementação demonstra como construir sistemas MCP escaláveis e fracamente acoplados.
...
O Azure Event Hubs fornece capacidades de streaming em tempo real e alta capacidade para cenários MCP que exigem baixa latência e alto volume de mensagens.
...
Usando Azure Event Grid para distribuir pedidos MCP entre vários nós de processamento:
...
1. **Idempotência**: Garantir que o processamento de mensagens seja idempotente para lidar com duplicados
2. **Tratamento de Erros**: Implementar tratamento de erros abrangente e filas de mensagens não entregues
...
5. **Desempenho**: Projetar para requisitos específicos de latência e capacidade

### **Recomendações Específicas do Azure**

1. **Usar Identidade Gerida**: Evitar strings de conexão em produção
2. **Implementar Circuit Breakers**: Proteger contra interrupções nos serviços do Azure
3. **Monitorizar Custos**: Acompanhar o volume de mensagens e os custos de processamento
4. **Planejar para Escala**: Projetar estratégias de particionamento e escalabilidade desde o início
5. **Testar Minuciosamente**: Usar Azure DevTest Labs para testes abrangentes

## **Conclusão**

Transportes MCP personalizados permitem cenários empresariais poderosos usando os serviços de mensagens do Azure. Ao implementar transportes com Event Grid ou Event Hubs, pode construir soluções MCP escaláveis e confiáveis que se integram perfeitamente à infraestrutura existente do Azure.

Os exemplos fornecidos demonstram padrões prontos para produção para implementar transportes personalizados enquanto mantêm a conformidade com o protocolo MCP e as melhores práticas do Azure.
...
> *Este guia foca em padrões práticos de implementação para sistemas MCP em produção. Valide sempre as implementações de transporte de acordo com os seus requisitos específicos e limites dos serviços do Azure.*
