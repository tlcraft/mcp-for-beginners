...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-02T05:32:45+00:00",
...
- **01. Conceitos Essenciais Explicados**  
...
### Construção e implementação do seu primeiro servidor e cliente MCP e Laboratórios Práticos e Cenários  
<details>
  <summary><strong> Aula 3: Construção e implementação do seu primeiro servidor e cliente MCP</strong></summary>
...
## Projetos Exemplares do Model Context Protocol Construindo um Projeto Calculadora MCP em Java, C#, JavaScript, TypeScript e Python

### 🧮 Projetos Exemplares de Calculadora MCP em Java, C#, JavaScript, TypeScript e Python
<details>
...
Para aproveitar ao máximo este currículo, deve ter:
...
Está disponível um [Guia de Estudo](./study_guide.md) abrangente para o ajudar a navegar eficazmente por este repositório. O guia inclui:

- Um mapa curricular visual com todos os tópicos abordados  
...
Obrigado ao Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) pela contribuição com importantes exemplos de código.

## 📜 Informação da Licença

Este conteúdo está licenciado sob a **Licença MIT**. Para os termos e condições, consulte o [LICENSE](../../LICENSE).

## 🤝 Diretrizes para Contribuição

Este projeto aceita contribuições e sugestões. A maioria das contribuições requer que concorde com um
Acordo de Licença de Contribuidor (CLA) declarando que tem o direito de, e de facto concede, os direitos para usarmos a sua contribuição. Para detalhes, visite <https://cla.opensource.microsoft.com>.
...
O uso das marcas ou logótipos da Microsoft em versões modificadas deste projeto não deve causar confusão nem implicar patrocínio da Microsoft.
