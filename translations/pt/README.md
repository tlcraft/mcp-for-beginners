...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-20T21:12:23+00:00",
...
| 3.8 | **Deploy do seu servidor** | Como ir do desenvolvimento local para a produção? Esta seção vai te ajudar a desenvolver e fazer o deploy do seu servidor. | [Deploy do seu servidor](./03-GettingStarted/08-deployment/README.md) |
| 04 | **Implementação Prática** | Usando SDKs em diferentes linguagens, depuração, testes e validação, criação de templates e fluxos de trabalho reutilizáveis para prompts | [Implementação Prática](./04-PracticalImplementation/README.md) |
...
| 07 | **Insights das Adoções Iniciais** | Implementações reais e o que funcionou, construção e deploy de soluções baseadas em MCP, tendências e roadmap futuro | [Insights](./07-LessonsFromEarlyAdoption/README.md) |
