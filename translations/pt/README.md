...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-20T16:45:46+00:00",
...
|--|--|--|--|
| 00 | **Introdução ao MCP** | Visão geral do Model Context Protocol e sua importância em pipelines de IA, incluindo o que é o MCP, por que a padronização é importante, além de casos de uso práticos e benefícios | [Introdução](./00-Introduction/README.md) |
| 01 | **Conceitos Básicos Explicados** | Exploração aprofundada dos conceitos centrais do MCP, incluindo arquitetura cliente-servidor, componentes principais do protocolo e padrões de mensagens | [Conceitos Básicos](./01-CoreConcepts/README.md) |
| 02 | **Segurança no MCP** | Identificação de ameaças de segurança em sistemas baseados no MCP, técnicas e melhores práticas para garantir implementações seguras | [Segurança](./02-Security/readme.md) |
...
| 3.6 | **Usando o AI Toolkit** | O AI Toolkit é uma ótima ferramenta que vai ajudar você a gerenciar seu fluxo de trabalho com IA e MCP. | [Usando o AI Toolkit](./03-GettingStarted/06-aitk/README.md) |
...
| 3.8 | **Fazendo o deploy do seu servidor** | Como sair do desenvolvimento local para produção? Esta seção vai ajudar você a desenvolver e fazer o deploy do seu servidor. | [Fazendo o deploy do seu servidor](./03-GettingStarted/08-deployment/README.md) |
| 04 | **Implementação Prática** | Usando SDKs em diferentes linguagens, depuração, testes e validação, criando templates reutilizáveis de prompts e fluxos de trabalho | [Implementação Prática](./04-PracticalImplementation/README.md) |
...
| 06 | **Contribuições da Comunidade** | Como contribuir com código e documentação, colaboração via GitHub, melhorias e feedback guiados pela comunidade | [Contribuições da Comunidade](./06-CommunityContributions/README.md) |
...
- [Exemplo de Container TypeScript](./04-PracticalImplementation/samples/typescript/README.md)
