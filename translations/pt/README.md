...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-11T10:43:20+00:00",
...
- 📜 [Especificação Original do MCP](https://spec.modelcontextprotocol.io/) – Referências técnicas legadas (pode conter detalhes adicionais)  
...
Prepare-se para dois dias de insights técnicos profundos, conexão com a comunidade e aprendizagem prática no MCP Dev Days, um evento virtual dedicado ao Model Context Protocol (MCP) — o padrão emergente que conecta modelos de IA às ferramentas que eles utilizam.

➡️ [Registe-se para o MCP Dev Days](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

Você pode assistir ao MCP Dev Days registrando-se na nossa página de eventos: https://aka.ms/mcpdevdays. A partir daí, poderá participar de uma transmissão ao vivo no YouTube ou Twitch. Todo o conteúdo será gravado e estará disponível posteriormente no canal Microsoft Developer no YouTube. O código-fonte dos demos também estará disponível no GitHub.

### Detalhes do Evento
- Datas: 29 de Julho (Dia 1) & 30 de Julho (Dia 2)
...
Se você está apenas começando com MCP ou já está desenvolvendo com ele, o Dia 1 será repleto de inspiração e dicas práticas.

#### Dia 2: Construa Servidores MCP com Confiança

É para os criadores de MCP. Vamos aprofundar em estratégias de implementação e melhores práticas para criar servidores MCP e integrar MCP nos seus fluxos de trabalho de IA.
...
um CLA e decorará o PR adequadamente (ex.: verificação de status, comentário). Basta seguir as instruções
