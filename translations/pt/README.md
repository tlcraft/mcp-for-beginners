...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-07T08:27:13+00:00",
...
## Junte-se a nós no MCP Dev Days 29-30 de julho de 2025
...
Pode assistir ao MCP Dev Days registando-se na nossa página do evento: https://aka.ms/mcpdevdays. A partir daí, poderá juntar-se a uma transmissão ao vivo no YouTube ou Twitch. Todo o conteúdo será gravado e estará disponível posteriormente no canal Microsoft Developer no YouTube. O código-fonte das demonstrações também estará disponível no GitHub.
...
#### Dia 1: Produtividade com MCP, Ferramentas de Desenvolvimento e Comunidade:

Focado em capacitar os desenvolvedores a utilizarem o MCP no seu fluxo de trabalho e celebrar a incrível comunidade MCP. Contaremos com membros da comunidade e parceiros como Arcade, Block, Okta e Neon para mostrar como estão a colaborar com a Microsoft para moldar um ecossistema MCP aberto e extensível.  
Demonstrações do mundo real no VS Code, Visual Studio, GitHub Copilot e ferramentas populares da comunidade  
Fluxos de trabalho práticos e orientados por contexto  
Sessões lideradas pela comunidade e insights  
Se está apenas a começar com o MCP ou já está a construir com ele, o Dia 1 será uma base de inspiração e ações práticas.

#### Dia 2: Construa Servidores MCP com Confiança

Dedicado aos criadores de MCP. Vamos aprofundar estratégias de implementação e melhores práticas para criar servidores MCP e integrá-los nos seus fluxos de trabalho de IA.
...
Se é um desenvolvedor, criador de ferramentas ou estrategista de produtos de IA, este dia está repleto de insights para construir soluções MCP escaláveis, seguras e preparadas para o futuro.
...
| 3.8 | Testes | Teste a implementação do seu servidor MCP | [Guia](./03-GettingStarted/08-testing/README.md) |
...
| 5.12 | Entra ID Auth | Autenticação com Microsoft Entra ID | [Guia](./05-AdvancedTopics/mcp-security-entra/README.md) |
| 5.13 | Integração Foundry | Integração com Azure AI Foundry | [Guia](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
...
| Java | Exemplo de Aplicação em Contêiner | [Ver Código](./04-PracticalImplementation/samples/java/containerapp/README.md) |
