...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-02T10:32:41+00:00",
...
1. Conecte-se ao servidor selecionando o botão Conectar  
   Após se conectar ao servidor, você deverá ver o seguinte:
...
3. Execute a ferramenta inspector para garantir que o servidor funciona conforme esperado.
4. Teste a implementação com diferentes entradas.

## Solução

[Solucao](./solution/README.md)
