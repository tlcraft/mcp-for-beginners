...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-18T05:56:41+00:00",
...
> [!NOTE]
> Este exemplo pressupõe que está a usar uma instância do GitHub Codespaces. Se quiser executar isto localmente, precisa de configurar um token de acesso pessoal (PAT) no GitHub.
>
> ```bash
> # zsh/bash
...
Grande parte da saída é apenas para depuração, mas o importante é que está a listar ferramentas do MCP Server, transformá-las em ferramentas LLM e obter uma resposta do cliente MCP "Sum 6".
