...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-17T08:08:40+00:00",
...
- **-4- Consumindo um servidor no modo GitHub Copilot Agent no Visual Studio Code**. Aqui, estamos analisando a execução de nosso MCP Server dentro do Visual Studio Code, [para a lição](/03-GettingStarted/04-vscode/README.md)

- **-5- Consumindo de um SSE (Server Sent Events)** SEE é um padrão para streaming de servidor para cliente, permitindo que servidores enviem atualizações em tempo real para clientes via HTTP [para a lição](/03-GettingStarted/05-sse-server/README.md)

- **-6- Utilizando o AI Toolkit para VSCode** para consumir e testar seus MCP Clients e Servers [para a lição](/03-GettingStarted/06-aitk/README.md)
...
O Protocolo de Contexto de Modelo (MCP) é um protocolo aberto que padroniza como aplicativos fornecem contexto para LLMs. Pense no MCP como uma porta USB-C para aplicativos de IA - ele oferece uma maneira padronizada de conectar modelos de IA a diferentes fontes de dados e ferramentas.
...
- Compreender os desafios comuns de configuração e suas soluções
...
- Configurar um ambiente de desenvolvimento MCP é direto com SDKs específicos para cada linguagem
