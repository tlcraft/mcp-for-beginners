...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-12T22:31:32+00:00",
  "source_file": "03-GettingStarted/07-aitk/solution/README.md",
  "language_code": "pt"
}
-->
# 📘 Solução da Tarefa: Estendendo Seu Servidor MCP da Calculadora com uma Ferramenta de Raiz Quadrada
...
- **Importe a ferramenta `math.sqrt()` usando `@server.tool()`**.
- Permitiu que seu agente de IA realizasse cálculos de raiz quadrada por meio de comandos em linguagem natural.
- Praticou a adição de novas ferramentas e a reinicialização do servidor para integrar funcionalidades extras.

Sinta-se à vontade para experimentar ainda mais, adicionando outras ferramentas matemáticas, como exponenciação ou funções logarítmicas, para continuar aprimorando as capacidades do seu agente!
