...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-04T17:39:25+00:00",
...
- **4 Forbrug af en server GitHub Copilot Agent-tilstand i Visual Studio Code**. Her ser vi på at køre vores MCP Server direkte fra Visual Studio Code, [til lektionen](/03-GettingStarted/04-vscode/README.md)
...
- **6 HTTP Streaming med MCP (Streamable HTTP)**. Lær om moderne HTTP streaming, progress-notifikationer, og hvordan du implementerer skalerbare, realtids MCP-servere og klienter ved hjælp af Streamable HTTP. [til lektionen](/03-GettingStarted/06-http-streaming/README.md)
