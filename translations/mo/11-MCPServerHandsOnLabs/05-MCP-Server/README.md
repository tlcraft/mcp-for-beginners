...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T15:14:44+00:00",
...
這個實作型實驗將指導你使用 FastMCP 框架建立一個可供生產使用的 MCP 伺服器。你將構建核心伺服器架構、實現資料庫整合、創建資料存取工具，並為 AI 驅動的零售分析奠定基礎。

## 概述

MCP 伺服器是我們零售分析解決方案的核心。它充當 AI 助手與 PostgreSQL 資料庫之間的橋樑，通過標準化協議提供安全且智能的商業資料存取。

本實驗教你如何遵循企業模式和最佳實踐，構建一個穩健且可擴展的 MCP 伺服器。
...
- **配置** 行級安全（Row Level Security）上下文管理  
- **新增** 健康監控和可觀察性功能  
- **測試** MCP 伺服器的本地實作並使用 VS Code  
...
✅ **運作中的 MCP 伺服器**：具有資料庫整合的 FastMCP 伺服器  
✅ **配置管理**：基於環境的穩健配置系統  
...
- [連線池最佳實踐](https://www.postgresql.org/docs/current/runtime-config-connection.html) - PostgreSQL 調整指南  
- [行級安全指南](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - 行級安全實作  
...
**下一步**：準備擴展你的工具？繼續進行 [實驗 06：工具開發](../06-Tools/README.md)
