...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T15:42:36+00:00",
...
本實驗提供完整指導，教您如何使用 Azure OpenAI 嵌入和 PostgreSQL 的 pgvector 擴展來實現語意搜尋功能。您將學習如何建立 AI 驅動的產品搜尋，理解自然語言查詢並根據語意相似性提供相關結果。

## 概述

傳統的基於關鍵字的搜尋通常無法捕捉使用者意圖和語意含義。使用向量嵌入的語意搜尋能夠處理像「適合雨天穿的舒適跑鞋」這樣的自然語言查詢，即使產品描述中沒有出現完全相同的字詞，也能找到相關產品。

我們的實現結合了 Azure OpenAI 強大的嵌入模型和 PostgreSQL 的 pgvector 擴展，打造了一個高效、可擴展的語意搜尋系統，通過智能產品發現提升零售體驗。

## 學習目標

完成本實驗後，您將能夠：

- **整合** Azure OpenAI 嵌入模型進行文本向量化
- **實現** pgvector 進行高效的相似性搜尋操作
- **構建**語意搜尋工具以處理自然語言產品查詢
- **創建**結合傳統搜尋和向量搜尋的混合搜尋
- **優化**向量查詢以提升生產性能
- **設計**基於嵌入相似性的推薦系統
...
✅ **Azure OpenAI 整合**：完成嵌入生成，並具備緩存和優化能力  
✅ **向量搜尋實現**：使用 pgvector 的生產級語意搜尋  
✅ **混合搜尋能力**：結合關鍵字和語意搜尋以獲得最佳結果  
✅ **推薦系統**：基於相似性的 AI 驅動產品推薦  
✅ **性能優化**：向量索引優化和智能緩存  
✅ **可擴展架構**：企業級語意搜尋基礎設施  

## 🚀 下一步

繼續進行 **[實驗 08：測試與除錯](../08-Testing/README.md)**，以：
...
### Azure OpenAI
- [Azure OpenAI 服務文件](https://docs.microsoft.com/azure/cognitive-services/openai/) - 完整服務指南
- [嵌入 API 參考](https://platform.openai.com/docs/api-reference/embeddings) - API 文件
- [嵌入最佳實踐](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - 實施指導

### 向量資料庫
- [pgvector 文件](https://github.com/pgvector/pgvector) - PostgreSQL 向量擴展
- [向量搜尋優化](https://www.pinecone.io/learn/vector-search-optimization/) - 性能調整
- [HNSW 演算法](https://arxiv.org/abs/1603.09320) - 分層可導航小世界圖

### 語意搜尋
- [資訊檢索基礎](https://nlp.stanford.edu/IR-book/) - Stanford IR 教科書
- [向量搜尋最佳實踐](https://weaviate.io/blog/vector-search-best-practices) - 實施模式
- [混合搜尋策略](https://blog.vespa.ai/hybrid-search/) - 結合不同搜尋方法

---

**上一章**: [實驗 06：工具開發](../06-Tools/README.md)  
**下一章**: [實驗 08：測試與除錯](../08-Testing/README.md)
