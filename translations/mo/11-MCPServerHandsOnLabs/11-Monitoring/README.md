...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T15:29:27+00:00",
...
本實驗提供完整指導，幫助您在生產環境中為 MCP 伺服器實施監控、可觀察性及警示功能。您將學習如何設置 Application Insights、建立有意義的儀表板、實施有效的警示系統，以及建立故障排除工作流程以達到卓越的運營能力。

## 概述

有效的監控與可觀察性對於維持生產環境中的 MCP 伺服器穩定性至關重要。本實驗涵蓋了可觀察性的三大支柱——指標、日誌和追蹤，並教您如何實施全面的監控，從而實現主動問題檢測和快速問題解決。

您將學習如何將原始的遙測數據轉化為可操作的洞察，幫助您理解系統行為、優化性能並確保高可用性。

## 學習目標

完成本實驗後，您將能夠：

- **實施** MCP 伺服器的全面 Application Insights 整合
- **設計**結構化日誌模式以進行有效的故障排除
- **建立**性能指標收集與分析系統
- **配置**智能警示並提供可操作的通知
- **構建**即時監控的運營儀表板
- **建立**有效的故障排除工作流程及運營手冊
...
✅ **Application Insights 整合**：完整的遙測與監控設置  
✅ **結構化日誌**：具備關聯性與上下文的生產級日誌  
✅ **自定義指標**：業務與技術指標的收集與分析  
✅ **智能警示**：多通知渠道的主動警示  
✅ **運營儀表板**：即時監控與業務洞察  
✅ **故障排除工作流程**：自動診斷與運營手冊  
...
繼續進行 **[實驗 12：最佳實踐與優化](../12-Best-Practices/README.md)**，以：
...
### Azure Monitor
- [Application Insights 文件](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - 完整的監控指南
- [KQL 查詢參考](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Application Insights 的查詢語言
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - 自定義儀表板創建

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - 工具指南
- [分佈式追蹤](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - 追蹤概念
- [指標收集](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - 指標最佳實踐

### 運營卓越
- [SRE 手冊](https://sre.google/sre-book/table-of-contents/) - 站點可靠性工程原則
- [監控最佳實踐](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - 行業最佳實踐
- [事件響應](https://response.pagerduty.com/) - 事件管理指南

---

**上一章**: [實驗 10：部署策略](../10-Deployment/README.md)  
**下一章**: [實驗 12：最佳實踐與優化](../12-Best-Practices/README.md)
