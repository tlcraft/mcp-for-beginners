...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T15:40:49+00:00",
...
本實驗深入探討 Zava 零售系統的 PostgreSQL 資料庫設計。您將學習如何實現一個全面的零售結構，包括向量搜索功能、多租戶資料建模，以及用於資料隔離的行級安全性 (RLS)。

## 概述

資料庫是我們 MCP 伺服器的基礎，負責存儲多家商店的零售資料，同時保持嚴格的資料隔離。我們使用 PostgreSQL 並搭配 pgvector 擴展，啟用語義搜索功能，讓客戶能夠使用自然語言查詢來尋找產品。

我們的結構遵循現代多租戶模式，並通過行級安全性確保使用者只能訪問其授權商店的資料。此方法提供企業級安全性，同時保持最佳性能。
...
我們的資料庫結合了 PostgreSQL 的企業功能與 pgvector 擴展，提供 AI 驅動的搜索功能：
...
資料庫採用 **共享資料庫，共享結構** 的多租戶模型，並搭配行級安全性：
...
✅ **全面結構**：創建適合生產環境的零售資料庫結構  
✅ **樣本資料生成**：構建逼真的測試資料以供開發和測試  
✅ **性能優化**：配置索引和查詢優化  
✅ **備份與恢復**：建立穩健的資料保護策略  
...
**上一頁**: [實驗 03：環境設置](../03-Setup/README.md)  
**下一頁**: [實驗 05：MCP 伺服器實現](../05-MCP-Server/README.md)
