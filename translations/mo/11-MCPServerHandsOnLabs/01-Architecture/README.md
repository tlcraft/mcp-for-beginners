...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T15:22:45+00:00",
...
建立一個具備資料庫整合功能的生產級 MCP 伺服器需要謹慎的架構決策。本實驗將拆解我們 Zava Retail 分析解決方案的關鍵組件、設計模式及技術考量，使其具備穩健性、安全性及可擴展性。

您將了解每一層如何互動、選擇特定技術的原因，以及如何將這些模式應用到您自己的 MCP 實現中。

## 學習目標

完成本實驗後，您將能夠：

- **分析** MCP 伺服器的分層架構及其資料庫整合
- **理解** 每個架構組件的角色及責任
...
我們的 MCP 伺服器採用 **分層架構**，以分離關注點並促進可維護性：
...
**主要特性**：
- **業務規則執行**：存取驗證及資料完整性
- **服務協調**：協調資料庫與 AI 服務之間的運作
- **資料轉換**：將原始資料轉化為業務洞察
- **快取策略**：優化頻繁查詢的性能

### 層 3：資料存取層
**責任**：管理資料庫連線、查詢執行及資料映射
...
繼續進行 **[實驗 02：安全性及多租戶](../02-Security/README.md)**，深入探討：
...
### PostgreSQL 高級主題
- [PostgreSQL 性能調優](https://wiki.postgresql.org/wiki/Performance_Optimization) - 資料庫優化指南
- [連線池最佳實踐](https://www.postgresql.org/docs/current/runtime-config-connection.html) - 連線管理
- [查詢規劃及優化](https://www.postgresql.org/docs/current/planner-optimizer.html) - 查詢性能
...
- [Pydantic 模型](https://pydantic-docs.helpmanual.io/) - 資料驗證及序列化

---

**下一步**：準備探索安全模式？繼續進行 [實驗 02：安全性及多租戶](../02-Security/README.md)
