...
> **टिप:** सही ट्रान्सपोर्ट चयनले प्रदर्शन, स्केलेबिलिटी, र प्रयोगकर्ता अनुभवमा प्रभाव पार्छ। **Streamable HTTP** आधुनिक, स्केलेबल, र क्लाउड-तयार एप्लिकेसनहरूका लागि सिफारिस गरिन्छ।

अघिल्लो अध्यायहरूमा देखाइएको stdio र SSE ट्रान्सपोर्टहरूलाई ध्यान दिनुहोस् र यस अध्यायमा समेटिएको Streamable HTTP ट्रान्सपोर्टलाई पनि।
...
- रियल-टाइम एप्लिकेसनहरू र प्रतिक्रियाशील UI सक्षम पार्दछ।
...
- `ServerSentEvent` ले संरचित इभेन्ट स्ट्रिमिङ र इभेन्ट प्रकारहरू प्रदान गर्छ
- `WebClient` को `bodyToFlux()` ले रियाक्टिभ स्ट्रिमिङ उपभोग सक्षम पार्दछ
- `delayElements()` ले इभेन्टहरू बीच प्रक्रिया समय सिमुलेट गर्छ
...
क्लासिक तरिका र MCP मा स्ट्रिमिङ कसरी फरक हुन्छन् भन्ने कुरा यसरी देखाउन सकिन्छ:
...
थप रूपमा, केही मुख्य भिन्नताहरू:

- **सञ्चार ढाँचा:**
   - क्लासिक HTTP स्ट्रिमिङ: सरल chunked transfer encoding प्रयोग गरेर डाटा पठाउँछ
   - MCP स्ट्रिमिङ: JSON-RPC प्रोटोकलसहित संरचित सूचना प्रणाली प्रयोग गर्छ

- **सन्देश ढाँचा:**
   - क्लासिक HTTP: नयाँ लाइन सहितको साधारण टेक्स्ट टुक्राहरू
...
- **जटिल, अन्तरक्रियात्मक एप्लिकेसनहरूका लागि:** MCP स्ट्रिमिङले धनी मेटाडाटा र सूचनाहरू र अन्तिम परिणाम बीच छुट्टाछुट्टै संरचना प्रदान गर्दछ।

- **AI एप्लिकेसनहरूका लागि:** MCP को सूचना प्रणाली लामो समयसम्म चल्ने AI कार्यहरूमा प्रगति सूचित गर्न विशेष रूपमा उपयोगी छ।

## MCP मा स्ट्रिमिङ

अबसम्म तपाईंले क्लासिक र MCP स्ट्रिमिङ बीचका सिफारिस र तुलना देख्नुभयो। अब MCP मा स्ट्रिमिङ कसरी प्रयोग गर्ने भन्ने विस्तृत रूपमा जानौं।

MCP फ्रेमवर्क भित्र स्ट्रिमिङ कसरी काम गर्छ भन्ने बुझ्नु आवश्यक छ ताकि लामो समयसम्म चल्ने अपरेसनहरूमा प्रयोगकर्तालाई रियल-टाइम प्रतिक्रिया दिने प्रतिक्रियाशील एप्लिकेसनहरू निर्माण गर्न सकियोस्।

MCP मा, स्ट्रिमिङ मुख्य प्रतिक्रिया टुक्रा टुक्रा पठाउने होइन, तर उपकरणले अनुरोध प्रक्रिया गर्दा क्लाइन्टलाई **सूचनाहरू** पठाउने कुरा हो। यी सूचनाहरूमा प्रगति अपडेट, लगहरू, वा अन्य घटनाहरू समावेश हुन सक्छन्।

### कसरी काम गर्छ

मुख्य परिणाम अझै एकल प्रतिक्रियाको रूपमा पठाइन्छ। तर, प्रक्रिया भइरहेका बेला सूचनाहरू अलग सन्देशको रूपमा पठाउन सकिन्छ जसले क्लाइन्टलाई रियल-टाइममा अपडेट गर्छ। क्लाइन्टले यी सूचनाहरूलाई ह्यान्डल र प्रदर्शन गर्न सक्षम हुनुपर्छ।
...
MCP मा सूचनाहरू कार्यान्वयन गर्न, तपाईंले सर्भर र क्लाइन्ट दुवै पक्षलाई रियल-टाइम अपडेटहरू ह्यान्डल गर्न तयार पार्नुपर्छ। यसले लामो समयसम्म चल्ने अपरेसनहरूमा प्रयोगकर्तालाई तुरुन्त प्रतिक्रिया दिन मद्दत गर्छ।

### सर्भर-पक्ष: सूचनाहरू पठाउने

सर्भर पक्षबाट सुरु गरौं। MCP मा, तपाईंले उपकरणहरू परिभाषित गर्नुहुन्छ जसले अनुरोध प्रक्रिया गर्दा सूचनाहरू पठाउन सक्छन्। सर्भरले सन्देश पठाउन सन्दर्भ वस्तु (सामान्यतया `ctx`) प्रयोग गर्छ।
...
अघिल्लो कोडमा, `message_handler` फङ्सनले आउने सन्देश सूचना हो कि होइन जाँच गर्छ। यदि हो भने, सूचना प्रिन्ट गर्छ; नभए सामान्य सर्भर सन्देशको रूपमा प्रक्रिया गर्छ। साथै, `ClientSession` लाई `message_handler` सँग इनिसियलाइज गरिएको छ ताकि आउने सूचनाहरू ह्यान्डल गर्न सकियोस्।
...
यस .NET उदाहरणमा, `MessageHandler` फङ्सनले आउने सन्देश सूचना हो कि होइन जाँच गर्छ। यदि हो भने, सूचना प्रिन्ट गर्छ; नभए सामान्य सर्भर सन्देशको रूपमा प्रक्रिया गर्छ। `ClientSession` लाई `ClientSessionOptions` मार्फत सन्देश ह्यान्डलरसँग इनिसियलाइज गरिएको छ।

</details>

सूचनाहरू सक्षम गर्न, सर्भरले स्ट्रिमिङ ट्रान्सपोर्ट (जस्तै `streamable-http`) प्रयोग गर्नुपर्छ र क्लाइन्टले सूचनाहरू प्रक्रिया गर्न सन्देश ह्यान्डलर कार्यान्वयन गर्नुपर्छ।
...
- **रियल-टाइम प्रतिक्रिया:** क्लाइन्टहरूले प्रगति बार वा लगहरू प्रदर्शन गर्न सक्छन्, जसले एप्लिकेसनलाई प्रतिक्रियाशील बनाउँछ।
...
- **क्लाइन्टमा:** सूचनाहरू प्राप्त गरी प्रदर्शन गर्न सन्देश ह्यान्डलर कार्यान्वयन गर्नुहोस्। यो ह्यान्डलरले सूचनाहरू र अन्तिम परिणाम छुट्याउँछ।
...
- **Localhost बाइन्डिङ**: स्थानीय विकासका लागि सर्भरहरूलाई `localhost` मा बाइन्ड गर्नुहोस् ताकि तिनीहरू सार्वजनिक इन्टरनेटमा नखुलून्।
...
### चुनौतीहरू
- विकास सजिलो र सुरक्षा बीच सन्तुलन मिलाउनु
- विभिन्न क्लाइन्ट वातावरणहरूसँग अनुकूलता सुनिश्चित गर्नु


## SSE बाट Streamable HTTP मा अपग्रेड

हाल Server-Sent Events (SSE) प्रयोग गरिरहेका अनुप्रयोगहरूका लागि Streamable HTTP मा सर्नुले थप क्षमता र दीर्घकालीन टिकाउपन प्रदान गर्दछ।
...
माइग्रेशनको क्रममा यी चुनौतीहरू समाधान गर्नुहोस्:
...
HTTP मार्फत MCP सर्भरहरू कार्यान्वयन गर्दा सुरक्षा धेरै आक्रमणका तरिकाहरू र सुरक्षा उपायहरूमा ध्यान दिन आवश्यक हुन्छ।
