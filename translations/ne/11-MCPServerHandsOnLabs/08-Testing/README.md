...
यो प्रयोगशालाले उत्पादन वातावरणमा MCP सर्भरहरूको परीक्षण र डिबगिङको लागि विस्तृत मार्गदर्शन प्रदान गर्दछ। तपाईंले बलियो परीक्षण रणनीतिहरू लागू गर्न, जटिल समस्याहरू डिबग गर्न, र विभिन्न परिस्थितिमा तपाईंको MCP सर्भरलाई विश्वसनीय रूपमा प्रदर्शन गर्न सिक्नुहुनेछ।

## अवलोकन

MCP सर्भरहरूको परीक्षणले युनिट परीक्षण, इन्टिग्रेसन परीक्षण, प्रदर्शन मान्यता, र वास्तविक संसारको परिदृश्य परीक्षण समेट्ने बहु-स्तरीय दृष्टिकोण आवश्यक छ। यो प्रयोगशालाले विकासदेखि उत्पादन निगरानीसम्मको सम्पूर्ण परीक्षण जीवनचक्र समेट्छ।

हाम्रो परीक्षण रणनीतिले विश्वसनीयता, सुरक्षा, र प्रदर्शनलाई प्राथमिकता दिन्छ, जसले तपाईंको MCP सर्भरलाई उत्पादन कार्यभारहरू ह्यान्डल गर्न सक्षम बनाउँछ, डेटा अखण्डता र प्रयोगकर्ता अनुभवको गुणस्तर कायम राख्दै।

## सिक्ने उद्देश्यहरू

यो प्रयोगशाला समाप्त गर्दा, तपाईं सक्षम हुनुहुनेछ:

- **लागू गर्नुहोस्** व्यापक युनिट र इन्टिग्रेसन परीक्षण सुटहरू  
- **डिजाइन गर्नुहोस्** MCP उपकरणहरू र डाटाबेस अपरेशनहरूको लागि प्रभावकारी परीक्षण रणनीतिहरू  
- **डिबग गर्नुहोस्** जटिल समस्याहरू उन्नत डिबगिङ प्रविधिहरू प्रयोग गरेर  
- **मान्यता दिनुहोस्** लोड अन्तर्गत प्रदर्शन यथार्थपरक परीक्षण परिदृश्यहरूसँग  
- **निगरानी गर्नुहोस्** प्रभावकारी अलर्टिङ र अवलोकनीयतासहित उत्पादन प्रणालीहरू  
- **स्वचालित गर्नुहोस्** निरन्तर एकीकरणको लागि परीक्षण वर्कफ्लोहरू  

## 🧪 परीक्षण आर्किटेक्चर

### परीक्षण रणनीतिको अवलोकन
...
### अन्त-देखि-अन्त वर्कफ्लो परीक्षण
...
यो प्रयोगशाला पूरा गरेपछि, तपाईंले हासिल गर्नुहुनेछ:

✅ **व्यापक परीक्षण फ्रेमवर्क**: सबै कम्पोनेन्टहरूको लागि युनिट, इन्टिग्रेसन, र प्रदर्शन परीक्षण  
✅ **उन्नत डिबगिङ उपकरणहरू**: कार्यान्वयन ट्रेसिङसहित परिष्कृत डिबगिङ युटिलिटीहरू  
✅ **प्रदर्शन मान्यता**: लोड परीक्षण र स्केलेबिलिटी विश्लेषण क्षमता  
✅ **सुरक्षा परीक्षण**: SQL इन्जेक्सन रोकथाम र RLS मान्यता  
✅ **निगरानी एकीकरण**: प्रदर्शन मेट्रिक्स र बोटलनेक विश्लेषण  
✅ **CI/CD तयार**: निरन्तर एकीकरणको लागि स्वचालित परीक्षण वर्कफ्लोहरू  

## 🚀 अब के गर्ने

**[प्रयोगशाला 09: VS कोड एकीकरण](../09-VS-Code/README.md)** जारी राख्नुहोस्:

- MCP सर्भर विकासको लागि VS कोड कन्फिगर गर्नुहोस्  
- VS कोडमा डिबगिङ वातावरण सेटअप गर्नुहोस्  
- MCP सर्भरलाई VS कोड च्याटसँग एकीकृत गर्नुहोस्  
- सम्पूर्ण VS कोड वर्कफ्लो परीक्षण गर्नुहोस्  

## 📚 थप स्रोतहरू

### परीक्षण फ्रेमवर्कहरू  
- [pytest डकुमेन्टेसन](https://docs.pytest.org/) - Python परीक्षण फ्रेमवर्क  
- [AsyncPG परीक्षण](https://magicstack.github.io/asyncpg/current/index.html) - Async PostgreSQL परीक्षण  
- [FastAPI परीक्षण](https://fastapi.tiangolo.com/tutorial/testing/) - API परीक्षण ढाँचाहरू  

### प्रदर्शन परीक्षण  
- [लोड परीक्षणका उत्कृष्ट अभ्यासहरू](https://docs.python.org/3/library/asyncio.html) - Async प्रदर्शन परीक्षण  
- [डाटाबेस प्रदर्शन परीक्षण](https://www.postgresql.org/docs/current/performance-tips.html) - PostgreSQL अनुकूलन  
- [मेमोरी प्रोफाइलिङ](https://docs.python.org/3/library/tracemalloc.html) - Python मेमोरी विश्लेषण  

### डिबगिङ उपकरणहरू  
- [Python डिबगिङ](https://docs.python.org/3/library/pdb.html) - Python डिबगर  
- [Async डिबगिङ](https://docs.python.org/3/library/asyncio-dev.html) - Asyncio डिबगिङ  
- [SQL डिबगिङ](https://www.postgresql.org/docs/current/runtime-config-logging.html) - PostgreSQL लगिङ  

---

**अघिल्लो**: [प्रयोगशाला 07: सेम्यान्टिक सर्च एकीकरण](../07-Semantic-Search/README.md)  
**अर्को**: [प्रयोगशाला 09: VS कोड एकीकरण](../09-VS-Code/README.md)  
