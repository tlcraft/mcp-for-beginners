...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T16:59:24+00:00",
...
यो प्रयोगशालाले आधुनिक कन्टेनराइजेसन र क्लाउड-नेटिभ विधिहरू प्रयोग गरेर उत्पादन वातावरणमा तपाईंको MCP रिटेल सर्भर परिनियोजनको लागि व्यापक मार्गदर्शन प्रदान गर्दछ। तपाईंले उद्यम वर्कलोडहरू ह्यान्डल गर्न सक्ने स्केलेबल, सुरक्षित, र निगरानी गरिएको MCP सर्भर परिनियोजन गर्न सिक्नुहुनेछ।

## अवलोकन

MCP सर्भरको उत्पादन परिनियोजनले कन्टेनराइजेसन, ऑर्केस्ट्रेसन, सुरक्षा, स्केलेबिलिटी, र निगरानीको सावधानीपूर्वक विचार गर्न आवश्यक छ। यो प्रयोगशालाले Azure Container Apps सँग PostgreSQL Flexible Server मा परिनियोजन, CI/CD पाइपलाइन कार्यान्वयन, र परिवर्तनशील वर्कलोडहरूको लागि स्वतः-स्केलिङ कन्फिगर गर्ने विषय समेट्छ।

परिनियोजन रणनीतिहरू विकासको लागि साधारण एकल-कन्टेनर परिनियोजनदेखि लिएर बहु-क्षेत्र, स्वतः-स्केलिङ उत्पादन वातावरणसम्म विस्तृत छन्, जसमा व्यापक निगरानी र सुरक्षा सुविधाहरू समावेश छन्।
...
- **परिनियोजन** Azure Container Apps मा सुरक्षित नेटवर्किङको साथ  
- **कन्फिगर** उत्पादन-ग्रेड PostgreSQL उच्च उपलब्धतासँग  
- **कार्यान्वयन** CI/CD पाइपलाइनहरू स्वचालित परिनियोजनको लागि  
- **स्केल** एप्लिकेसनहरू मागको आधारमा स्वतः  
- **निगरानी** उत्पादन परिनियोजनहरू व्यापक अवलोकनको साथ  
...
यो प्रयोगशाला पूरा गरेपछि, तपाईंले निम्न प्राप्त गर्नुहुनेछ:

✅ **कन्टेनर रणनीति**: सुरक्षा कडा बनाइएको उत्पादन-तयार Docker कन्टेनरहरू  
✅ **क्लाउड परिनियोजन**: स्वतः-स्केलिङ र निगरानीसहित Azure Container Apps  
✅ **डाटाबेस परिनियोजन**: उच्च उपलब्धतासहित PostgreSQL Flexible Server  
✅ **CI/CD पाइपलाइनहरू**: स्वचालित परीक्षण, निर्माण, र परिनियोजन वर्कफ्लोहरू  
✅ **प्रदर्शन निगरानी**: व्यापक मेट्रिक्स सङ्कलन र अलर्टिङ  
✅ **सुरक्षा कन्फिगरेसन**: उत्पादन-ग्रेड सुरक्षा नीतिहरू र नेटवर्क अलगाव  

## 🚀 अब के गर्ने?

**[Lab 11: Monitoring and Observability](../11-Monitoring/README.md)** जारी राख्नुहोस्:

- Application Insights प्रयोग गरेर व्यापक निगरानी सेटअप गर्नुहोस्  
...
### कन्टेनर प्रविधिहरू
- [Docker Best Practices](https://docs.docker.com/develop/dev-best-practices/) - आधिकारिक Docker उत्तम अभ्यासहरू  
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Azure Container Apps दस्तावेज  
- [Kubernetes Documentation](https://kubernetes.io/docs/) - Kubernetes आधिकारिक दस्तावेज  

### CI/CD र DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - GitHub Actions दस्तावेज  
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Azure DevOps सेवाहरू  
- [Infrastructure as Code](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Azure Bicep दस्तावेज  
...
**अघिल्लो**: [Lab 09: VS Code Integration](../09-VS-Code/README.md)  
**अर्को**: [Lab 11: Monitoring and Observability](../11-Monitoring/README.md)  
