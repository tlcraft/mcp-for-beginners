...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T17:01:42+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "ne"
}
-->
# डाटाबेस डिजाइन र स्कीमा

## 🎯 यो प्रयोगशालाले के समेट्छ

यो प्रयोगशालाले Zava Retail प्रणालीको PostgreSQL डाटाबेस डिजाइनमा गहिरो अध्ययन गर्दछ। तपाईंले भेक्टर खोज क्षमताहरू, बहु-भाडावाल डाटा मोडलिङ, र डाटा अलगावका लागि Row Level Security (RLS) सहित एक व्यापक रिटेल स्कीमा कार्यान्वयन गर्न सिक्नुहुनेछ।

## अवलोकन

डाटाबेस हाम्रो MCP सर्भरको आधार हो, जसले धेरै स्टोरहरूमा रिटेल डाटा भण्डारण गर्दछ र कडा डाटा अलगाव कायम राख्छ। हामी PostgreSQL प्रयोग गर्छौं, pgvector विस्तारको साथ, जसले ग्राहकहरूलाई प्राकृतिक भाषा क्वेरीहरू प्रयोग गरेर उत्पादनहरू खोज्न सक्षम बनाउँछ।

हाम्रो स्कीमाले आधुनिक बहु-भाडावाल ढाँचाहरू अनुसरण गर्दछ, जहाँ Row Level Security ले सुनिश्चित गर्दछ कि प्रयोगकर्ताहरूले केवल उनीहरूको स्वीकृत स्टोरहरूको डाटामा पहुँच गर्न सक्छन्। यो दृष्टिकोणले उद्यम-स्तरको सुरक्षा प्रदान गर्दछ भने इष्टतम प्रदर्शन कायम राख्छ।

## सिक्ने उद्देश्यहरू

यो प्रयोगशाला समाप्त गर्दा, तपाईं सक्षम हुनुहुनेछ:

- **डिजाइन गर्नुहोस्**: स्केलेबल बहु-भाडावाल रिटेल डाटाबेस स्कीमा
- **कार्यान्वयन गर्नुहोस्**: PostgreSQL लाई pgvector सहित भेक्टर खोजका लागि
- **कन्फिगर गर्नुहोस्**: डाटा अलगावका लागि Row Level Security
- **उत्पन्न गर्नुहोस्**: परीक्षणका लागि यथार्थपरक नमूना डाटा
- **अनुकूलन गर्नुहोस्**: रिटेल कार्यभारका लागि डाटाबेस प्रदर्शन
- **कार्यान्वयन गर्नुहोस्**: ब्याकअप र पुनःप्राप्ति रणनीतिहरू

## 🗃️ डाटाबेस आर्किटेक्चर

### PostgreSQL र pgvector

हाम्रो डाटाबेसले PostgreSQL को उद्यम सुविधाहरूलाई pgvector विस्तारको साथ प्रयोग गर्दछ, जसले AI-संचालित खोज सक्षम गर्दछ:
...
### बहु-भाडावाल आर्किटेक्चर

डाटाबेसले **साझा डाटाबेस, साझा स्कीमा** बहु-भाडावाल मोडेल प्रयोग गर्दछ, Row Level Security सहित:
...
## 🔍 भेक्टर खोज कार्यान्वयन

### उत्पादन एम्बेडिङ्स टेबल
...
## 🔐 Row Level Security सेटअप

### डाटाबेस भूमिका र अनुमतिहरू
...
### यथार्थपरक परीक्षण डाटा स्क्रिप्ट
...
यो प्रयोगशाला पूरा गरेपछि, तपाईंले हासिल गर्नुभएको हुनेछ:

✅ **बहु-भाडावाल डाटाबेस डिजाइन**: सुरक्षित डाटा अलगावका लागि Row Level Security कार्यान्वयन  
✅ **भेक्टर खोज क्षमताहरू**: उत्पादनको अर्थपूर्ण खोजका लागि pgvector कन्फिगर गरिएको  
✅ **व्यापक स्कीमा**: उत्पादन-तयार रिटेल डाटाबेस स्कीमा सिर्जना गरिएको  
✅ **नमूना डाटा उत्पादन**: विकास र परीक्षणका लागि यथार्थपरक परीक्षण डाटा निर्माण गरिएको  
✅ **प्रदर्शन अनुकूलन**: अनुक्रमणिका र क्वेरी अनुकूलन कन्फिगर गरिएको  
✅ **ब्याकअप र पुनःप्राप्ति**: बलियो डाटा सुरक्षा रणनीतिहरू स्थापना गरिएको  

## 🚀 अब के गर्ने

**[Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)** जारी राख्नुहोस्:

- यस डाटाबेससँग जडान हुने FastMCP सर्भर निर्माण गर्नुहोस्
- MCP प्रोटोकलका लागि डाटाबेस क्वेरी उपकरणहरू कार्यान्वयन गर्नुहोस्
- एम्बेडिङ्स प्रयोग गरेर अर्थपूर्ण खोज क्षमताहरू थप्नुहोस्
- कनेक्शन पूलिङ र त्रुटि ह्यान्डलिङ कन्फिगर गर्नुहोस्

## 📚 थप स्रोतहरू

### PostgreSQL र pgvector
- [PostgreSQL Documentation](https://www.postgresql.org/docs/) - पूर्ण PostgreSQL सन्दर्भ
- [pgvector Extension](https://github.com/pgvector/pgvector) - PostgreSQL का लागि भेक्टर समानता खोज
- [PostgreSQL Performance Tuning](https://wiki.postgresql.org/wiki/Performance_Optimization) - अनुकूलनका लागि उत्कृष्ट अभ्यासहरू

### बहु-भाडावाल आर्किटेक्चर
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS दस्तावेज
- [Multi-Tenant Data Architecture](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure आर्किटेक्चर ढाँचाहरू
- [Database Security Best Practices](https://www.postgresql.org/docs/current/security.html) - PostgreSQL सुरक्षा मार्गदर्शन

### भेक्टर डाटाबेसहरू
- [Vector Search Fundamentals](https://www.pinecone.io/learn/vector-database/) - भेक्टर डाटाबेसहरू बुझ्ने
- [Embedding Models](https://platform.openai.com/docs/guides/embeddings) - OpenAI एम्बेडिङ्स दस्तावेज
- [HNSW Algorithm](https://arxiv.org/abs/1603.09320) - Hierarchical Navigable Small World ग्राफहरू

---

**अघिल्लो**: [Lab 03: Environment Setup](../03-Setup/README.md)  
**अर्को**: [Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)
