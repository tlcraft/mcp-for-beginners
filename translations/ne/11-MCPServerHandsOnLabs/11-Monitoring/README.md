...
यो प्रयोगशालाले उत्पादन वातावरणमा तपाईँको MCP सर्भरको लागि निगरानी, अवलोकनशीलता, र सचेतन प्रणाली कार्यान्वयन गर्न विस्तृत मार्गदर्शन प्रदान गर्दछ। तपाईँले Application Insights सेटअप गर्न, अर्थपूर्ण ड्यासबोर्डहरू सिर्जना गर्न, प्रभावकारी सचेतन प्रणाली लागू गर्न, र सञ्चालन उत्कृष्टताको लागि समस्या समाधान कार्यप्रवाहहरू स्थापना गर्न सिक्नुहुनेछ।

## अवलोकन

उत्पादनमा MCP सर्भरहरूलाई भरपर्दो बनाइराख्न प्रभावकारी निगरानी र अवलोकनशीलता अत्यन्त महत्त्वपूर्ण छ। यो प्रयोगशालाले अवलोकनशीलताको तीन स्तम्भहरू—मेट्रिक्स, लगहरू, र ट्रेसहरू—समेट्छ र तपाईँलाई व्यापक निगरानी कार्यान्वयन गर्न सिकाउँछ, जसले सक्रिय रूपमा समस्या पत्ता लगाउन र छिटो समाधान गर्न मद्दत गर्दछ।

तपाईँले कच्चा टेलिमेट्री डाटालाई उपयोगी जानकारीमा रूपान्तरण गर्न सिक्नुहुनेछ, जसले प्रणालीको व्यवहार बुझ्न, प्रदर्शन अनुकूलन गर्न, र उच्च उपलब्धता सुनिश्चित गर्न मद्दत गर्दछ।

## सिकाइ उद्देश्यहरू

यो प्रयोगशाला समाप्त गर्दा, तपाईँ सक्षम हुनुहुनेछ:

- **Application Insights** को व्यापक एकीकरण MCP सर्भरहरूको लागि कार्यान्वयन गर्न  
- प्रभावकारी समस्या समाधानका लागि **संरचित लगिङ ढाँचाहरू** डिजाइन गर्न  
- **प्रदर्शन मेट्रिक्स सङ्कलन र विश्लेषण प्रणालीहरू** सिर्जना गर्न  
- **बुद्धिमान सचेतन प्रणाली** कन्फिगर गर्न, जसले उपयोगी सूचनाहरू प्रदान गर्छ  
- **सञ्चालन ड्यासबोर्डहरू** निर्माण गर्न, जसले वास्तविक-समय निगरानी सक्षम बनाउँछ  
- **प्रभावकारी समस्या समाधान कार्यप्रवाहहरू र रनबुकहरू** स्थापना गर्न  

## 📊 Application Insights एकीकरण

### Application Insights सेटअप
...
## 🔔 सचेतन प्रणाली कन्फिगरेसन

### बुद्धिमान सचेतन प्रणाली
...
### अनुकूलित ड्यासबोर्ड कार्यान्वयन
...
यो प्रयोगशाला पूरा गरेपछि, तपाईँसँग हुनेछ:

✅ **Application Insights एकीकरण**: टेलिमेट्री र निगरानीको पूर्ण सेटअप  
✅ **संरचित लगिङ**: सम्बन्ध र सन्दर्भसहित उत्पादन-तयार लगिङ  
✅ **अनुकूलित मेट्रिक्स**: व्यवसायिक र प्राविधिक मेट्रिक्स सङ्कलन र विश्लेषण  
✅ **बुद्धिमान सचेतन प्रणाली**: बहु-सूचना च्यानलहरूसहित सक्रिय सचेतन  
✅ **सञ्चालन ड्यासबोर्डहरू**: वास्तविक-समय निगरानी र व्यवसायिक जानकारी  
✅ **समस्या समाधान कार्यप्रवाहहरू**: स्वचालित निदान र सञ्चालन रनबुकहरू  

## 🚀 अब के गर्ने

**[प्रयोगशाला १२: उत्कृष्ट अभ्यास र अनुकूलन](../12-Best-Practices/README.md)** मा जारी राख्नुहोस्:

- प्रदर्शन अनुकूलन प्रविधिहरू लागू गर्न  
- व्यापक सुरक्षा कडा बनाउने उपायहरू कार्यान्वयन गर्न  
- उत्पादन परिनियोजनका उत्कृष्ट अभ्यासहरू सिक्न  
- लागत अनुकूलन रणनीतिहरू स्थापना गर्न  

## 📚 थप स्रोतहरू

### Azure Monitor
- [Application Insights दस्तावेज](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - पूर्ण निगरानी मार्गदर्शन  
- [KQL क्वेरी सन्दर्भ](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Application Insights को लागि क्वेरी भाषा  
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - अनुकूलित ड्यासबोर्ड निर्माण  

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - उपकरण मार्गदर्शन  
- [वितरित ट्रेसिङ](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - ट्रेसिङ अवधारणाहरू  
- [मेट्रिक्स सङ्कलन](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - मेट्रिक्सका उत्कृष्ट अभ्यासहरू  

### सञ्चालन उत्कृष्टता
- [SRE ह्यान्डबुक](https://sre.google/sre-book/table-of-contents/) - साइट विश्वसनीयता इन्जिनियरिङ सिद्धान्तहरू  
- [निगरानीका उत्कृष्ट अभ्यासहरू](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - उद्योगका उत्कृष्ट अभ्यासहरू  
- [घटना प्रतिक्रिया](https://response.pagerduty.com/) - घटना व्यवस्थापन मार्गदर्शन  

---

**अघिल्लो**: [प्रयोगशाला १०: परिनियोजन रणनीतिहरू](../10-Deployment/README.md)  
**अर्को**: [प्रयोगशाला १२: उत्कृष्ट अभ्यास र अनुकूलन](../12-Best-Practices/README.md)  
