...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-22T07:13:14+00:00",
...
歡迎來到 **Model Context Protocol (MCP) 工作坊**！這是一個全面的實作型工作坊，結合兩項尖端技術，徹底改變 AI 應用程式的開發方式：
...
完成此工作坊後，您將掌握建立智慧應用程式的技巧，能夠將 AI 模型與真實世界的工具和服務相結合。從自動化測試到自訂 API 整合，您將獲得解決複雜商業挑戰的實用技能。
...
- 🗂️ 探索模型目錄（100+ 模型，來自 GitHub、ONNX、OpenAI、Anthropic、Google）
- 🎮 掌握互動操作台，用於即時模型測試
- 🤖 使用代理建構器建立您的第一個 AI 代理
- 📊 使用內建指標（F1、相關性、相似性、一致性）評估模型性能
- ⚡ 學習批量處理和多模態支持功能

**🎯 學習成果**：建立一個功能性 AI 代理，並全面了解 AITK 的能力
...
- 🔧 將 MCP 伺服器整合到 AI Toolkit 的代理建構器中
- 📊 配置並測試代理中的 MCP 工具
- 🚀 將 MCP 驅動的代理導出並部署到生產環境

**🎯 學習成果**：部署一個透過 MCP 強化的 AI 代理，並整合外部工具
...
- 🧪 在代理建構器和 Inspector 環境中除錯 MCP 伺服器

**🎯 學習成果**：使用現代工具開發並除錯自訂 MCP 伺服器

### [🐙 模組 4：實作 MCP 開發 - 自訂 GitHub Clone 伺服器](./lab4/README.md)
...
**🎯 學習成果**：部署一個生產級 MCP 伺服器，精簡真實開發工作流程
...
讓我們一起使用 MCP 和 AI Toolkit 建立智慧應用程式的未來！
