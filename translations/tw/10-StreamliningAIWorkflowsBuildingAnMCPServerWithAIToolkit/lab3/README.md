...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-14T08:09:31+00:00",
...
> **⚡ 完整的 package-lock.json：** 整個 package-lock.json 約有 3000 行依賴定義，上述為關鍵結構，請使用提供的檔案以確保完整依賴解析。
