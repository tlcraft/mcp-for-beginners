...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-28T23:36:14+00:00",
...
- **2 客戶端**，在本課程中，您將學習如何撰寫一個能夠連接到伺服器的客戶端，[前往課程](02-client/README.md)

- **3 使用 LLM 的客戶端**，更好的客戶端撰寫方式是加入 LLM，使其能與伺服器「協商」該執行的操作，[前往課程](03-llm-client/README.md)
...
我們提供了一組範例，補充了本章節中所有課程的練習。此外，每個章節也有自己的練習和作業。
