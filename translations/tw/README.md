...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-11T09:44:48+00:00",
...
## 加入我們的 MCP 開發日 2025 年 7 月 29-30 日

準備好迎接兩天的深入技術洞察、社群交流和實作學習吧！MCP 開發日是一個專注於模型上下文協議（MCP）的虛擬活動，這是一個連接 AI 模型與其依賴工具的新興標準。

➡️ [註冊 MCP 開發日](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

您可以透過註冊活動頁面觀看 MCP 開發日：https://aka.ms/mcpdevdays。從那裡，您可以加入 YouTube 或 Twitch 的直播。所有內容都會被錄製，並在活動後於 Microsoft Developer YouTube 頻道上提供。示範的程式碼也會在 GitHub 上提供。
...
- VS Code、Visual Studio、GitHub Copilot 和流行社群工具的真實世界示範
- 實用且以上下文為導向的開發工作流程
- 社群主導的會議和洞察
...
專為 MCP 建設者設計。我們將深入探討構建 MCP 伺服器的實作策略和最佳實踐，以及如何將 MCP 整合到您的 AI 工作流程中。
...
此內容依據 **MIT 授權** 授權。欲了解條款和條件，請參閱 [LICENSE](../../LICENSE)。
