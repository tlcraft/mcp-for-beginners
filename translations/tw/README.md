...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-23T06:35:59+00:00",
...
| 章節 | 標題 | 說明 | 連結 |
|--|--|--|--|
| 00 | **MCP 簡介** | 介紹 Model Context Protocol 及其在 AI 流程中的重要性，包括 MCP 是什麼、為什麼需要標準化，以及實務應用與好處 | [簡介](./00-Introduction/README.md) |
| 01 | **核心概念解析** | 深入探討 MCP 的核心概念，包括客戶端-伺服器架構、主要協定元件與訊息模式 | [核心概念](./01-CoreConcepts/README.md) |
| 02 | **MCP 的安全性** | 識別 MCP 系統中的安全威脅，並介紹保護實作的技術與最佳做法 | [安全性](./02-Security/README.md) |
| 03 | **開始使用 MCP** | 環境設定與配置，建立基本 MCP 伺服器與客戶端，將 MCP 整合到現有應用程式中 | [開始使用](./03-GettingStarted/README.md) |
| 3.1 | **第一個伺服器** | 使用 MCP 協定建立基本伺服器，理解伺服器與客戶端的互動並測試伺服器 | [第一個伺服器](./03-GettingStarted/01-first-server/README.md) |
| 3.2 | **第一個客戶端** | 使用 MCP 協定建立基本客戶端，理解客戶端與伺服器的互動並測試客戶端 | [第一個客戶端](./03-GettingStarted/02-client/README.md) |
| 3.3 | **結合大型語言模型的客戶端** | 使用 MCP 協定搭配大型語言模型（LLM）建立客戶端 | [結合 LLM 的客戶端](./03-GettingStarted/03-llm-client/README.md) |
| 3.4 | **用 Visual Studio Code 使用伺服器** | 設定 Visual Studio Code 來使用 MCP 協定的伺服器 | [用 VS Code 使用伺服器](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | **使用 SSE 建立伺服器** | SSE 幫助我們將伺服器對外開放，本章節將指導你如何使用 SSE 建立伺服器 | [使用 SSE 建立伺服器](./03-GettingStarted/05-sse-server/README.md) |
| 3.6 | **使用 AI 工具包** | AI 工具包是個很棒的工具，能幫助你管理 AI 和 MCP 的工作流程 | [使用 AI 工具包](./03-GettingStarted/06-aitk/README.md) |
| 3.7 | **測試你的伺服器** | 測試是開發過程的重要一環，本章節將介紹多種工具協助你進行測試 | [測試你的伺服器](./03-GettingStarted/07-testing/README.md) |
| 3.8 | **部署你的伺服器** | 從本地開發到正式上線的流程，本章節將協助你開發並部署伺服器 | [部署你的伺服器](./03-GettingStarted/08-deployment/README.md) |
| 04 | **實務應用** | 跨語言使用 SDK、除錯、測試與驗證，打造可重複使用的提示範本與工作流程 | [實務應用](./04-PracticalImplementation/README.md) |
...
| 07 | **早期採用的洞察** | 真實案例與成功經驗分享，建立與部署 MCP 解決方案，趨勢與未來規劃 | [洞察](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | **MCP 最佳實務** | 性能調校與優化、設計容錯 MCP 系統、測試與韌性策略 | [最佳實務](./08-BestPractices/README.md) |
| 09 | **MCP 案例研究** | 深入探討 MCP 解決方案架構、部署藍圖與整合技巧，附註解圖與專案導覽 | [案例研究](./09-CaseStudy/README.md) |

## 範例專案

### 🧮 MCP 計算機範例專案：
<details>
  <summary><strong>按語言瀏覽程式碼實作</strong></summary>
...
### 💡 MCP 進階計算機專案：
<details>
  <summary><strong>瀏覽進階範例</strong></summary>
...
1. 清楚解釋 MCP 概念  
2. 多種語言的即時程式碼範例  
3. 練習題，幫助你打造真實的 MCP 應用程式  
4. 進階學習者的額外資源  

## 📜 授權資訊

本內容採用 **MIT License** 授權。詳細條款請參考 [LICENSE](../../LICENSE)。
...
CLA 並在 PR 上做出相應標記（例如狀態檢查、留言）。只要按照機器人的指示操作即可。
你只需在所有使用我們 CLA 的倉庫中完成一次。
...
聯絡 [opencode@microsoft.com](mailto:opencode@microsoft.com) 詢問任何問題或建議。
...
本專案可能包含專案、產品或服務的商標或標誌。Microsoft 商標或標誌的授權使用須遵守
[Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general)。
修改版本中使用 Microsoft 商標或標誌，不得造成混淆或暗示 Microsoft 贊助。
任何第三方商標或標誌的使用，須遵守該第三方的相關政策。

**免責聲明**：  
本文件係使用 AI 翻譯服務 [Co-op Translator](https://github.com/Azure/co-op-translator) 進行翻譯。雖然我們力求準確，但請注意自動翻譯可能會包含錯誤或不準確之處。原始文件的母語版本應視為權威來源。對於重要資訊，建議採用專業人工翻譯。我們不對因使用本翻譯所產生之任何誤解或誤譯負責。