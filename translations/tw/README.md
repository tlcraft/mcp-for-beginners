...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-07T08:17:08+00:00",
...
您可以通過註冊活動頁面觀看 MCP 開發者日：https://aka.ms/mcpdevdays。從那裡，您可以加入 YouTube 或 Twitch 的直播。所有內容都會被錄製，並在活動後上傳至 Microsoft Developer YouTube 頻道。演示的程式碼也將在 GitHub 上提供。
...
專注於幫助開發者將 MCP 融入開發工作流程，並慶祝 MCP 社群的成就。我們將邀請社群成員和合作夥伴（如 Arcade、Block、Okta 和 Neon），展示他們如何與 Microsoft 合作，共同打造開放且可擴展的 MCP 生態系統。  
