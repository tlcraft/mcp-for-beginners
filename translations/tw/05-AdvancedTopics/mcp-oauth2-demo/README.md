...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-12T21:24:17+00:00",
...
* **Spring Authorization Server**（透過 `client_credentials` 流程發行 JWT 存取權杖），以及  
* **Resource Server**（保護自己的 `/hello` 端點）。

它反映了[Spring 部落格文章 (2025 年 4 月 2 日)](https://spring.io/blog/2025/04/02/mcp-server-oauth2)中展示的設定。
...
Ingress FQDN 將成為你的**issuer**（`https://<fqdn>`).  
