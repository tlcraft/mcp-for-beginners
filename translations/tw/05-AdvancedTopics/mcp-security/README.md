...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-18T10:36:45+00:00",
...
模型上下文協議（MCP）引入了超越傳統軟體安全的獨特安全挑戰。隨著 AI 系統獲得工具、數據和外部服務的訪問權限，新的攻擊向量也隨之出現，包括提示注入、工具污染、會話劫持、混淆代理問題以及令牌傳遞漏洞。

本課程探討基於最新 MCP 規範（2025-06-18）、Microsoft 安全解決方案以及既定企業安全模式的高級安全實施。
...
現代 MCP 實施受益於規範向外部身份提供者委派的演進，顯著改善了相較於自定義身份驗證實施的安全態勢。
...
### 使用 Java Spring Security 與 OAuth 2.1 集成
...
> **安全通知**：本高級實施指南反映了當前 MCP 規範（2025-06-18）的要求。實施這些控制時，請始終核對最新的官方文檔並考慮您的特定安全需求和威脅模型。
