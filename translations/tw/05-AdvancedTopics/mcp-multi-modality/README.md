...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T21:06:28+00:00",
...
- 建立了一個 `ImageAnalysisTool`，使用假設的 `IImageAnalysisService` 來分析影像。
...
音訊處理是多模態應用中另一個常見的模態。以下範例示範如何實作一個音訊轉錄工具，能處理音訊檔案並回傳轉錄結果。
...
- 建立了一個 `AudioTranscriptionTool`，能轉錄音訊檔案。
