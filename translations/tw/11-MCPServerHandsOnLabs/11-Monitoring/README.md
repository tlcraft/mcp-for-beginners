...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T12:50:34+00:00",
...
本實驗提供完整指導，幫助您在生產環境中為 MCP 伺服器實施監控、可觀察性和警示功能。您將學習如何設置 Application Insights、建立有意義的儀表板、實施有效的警示系統，以及建立故障排除工作流程以達到卓越的運營管理。
...
- [Azure Monitor Workbooks](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - 自訂儀表板建立

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - 工具指南
- [分散式追蹤](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - 追蹤概念
