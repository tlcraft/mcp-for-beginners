...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T12:58:36+00:00",
...
本實驗提供全面的指導，幫助您使用現代容器化和雲原生方法將 MCP 零售伺服器部署到生產環境中。您將學習如何部署可擴展、安全且具備監控功能的 MCP 伺服器，以應對企業級工作負載。

## 概述

MCP 伺服器的生產部署需要仔細考慮容器化、編排、安全性、可擴展性和監控。本實驗涵蓋了如何部署到 Azure Container Apps 並使用 PostgreSQL Flexible Server，實現 CI/CD 管道，以及為變動的工作負載配置自動擴展。
...
- 使用 Docker 的多階段構建**容器化** MCP 伺服器  
- **部署**到具有安全網路的 Azure Container Apps  
- 配置具有高可用性的生產級 PostgreSQL  
- **實現**自動化部署的 CI/CD 管道  
- 根據需求**自動擴展**應用程式  
- 使用全面的可觀測性**監控**生產部署  
...
✅ **容器策略**：具備安全強化的生產級 Docker 容器  
✅ **雲端部署**：Azure Container Apps，具備自動擴展和監控功能  
✅ **資料庫部署**：具有高可用性的 PostgreSQL Flexible Server  
...
- [基礎架構即程式碼](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Azure Bicep 文件  
...
**上一節**: [實驗 09：VS Code 整合](../09-VS-Code/README.md)  
