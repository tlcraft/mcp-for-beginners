...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T13:00:16+00:00",
...
資料庫是我們 MCP 伺服器的基礎，負責存儲多家商店的零售數據，同時保持嚴格的資料隔離。我們使用 PostgreSQL 並結合 pgvector 擴展，實現語義搜索功能，讓客戶能夠使用自然語言查詢來尋找產品。

我們的結構遵循現代多租戶模式，並通過行級安全性確保用戶只能訪問其授權商店的數據。此方法提供了企業級的安全性，同時保持最佳性能。
...
我們的資料庫結合了 PostgreSQL 的企業功能與 pgvector 擴展，實現 AI 驅動的搜索：
...
資料庫採用 **共享資料庫，共享結構** 的多租戶模型，並結合行級安全性：
