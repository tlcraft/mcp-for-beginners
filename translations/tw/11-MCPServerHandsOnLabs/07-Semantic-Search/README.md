...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T13:02:26+00:00",
...
本實驗提供完整指導，教您如何使用 Azure OpenAI 嵌入和 PostgreSQL 的 pgvector 擴展來實現語意搜尋功能。您將學習如何構建基於 AI 的產品搜尋，理解自然語言查詢，並根據語意相似性提供相關結果。

## 概述

傳統的基於關鍵字的搜尋通常無法捕捉使用者意圖和語意含義。使用向量嵌入的語意搜尋使得像「適合雨天穿的舒適跑鞋」這樣的自然語言查詢能找到相關產品，即使這些精確詞語未出現在產品描述中。

我們的實現結合了 Azure OpenAI 強大的嵌入模型和 PostgreSQL 的 pgvector 擴展，創建了一個高性能、可擴展的語意搜尋系統，通過智能產品發現提升零售體驗。
...
✅ **向量搜尋實現**：基於 pgvector 的生產級語意搜尋  
✅ **混合搜尋功能**：結合關鍵字和語意搜尋以獲得最佳結果  
✅ **推薦系統**：基於 AI 的產品推薦，利用相似性  
✅ **性能優化**：向量索引優化和智能緩存  
✅ **可擴展架構**：企業級語意搜尋基礎設施  
...
### 語意搜尋
- [資訊檢索基礎](https://nlp.stanford.edu/IR-book/) - 斯坦福 IR 教科書
