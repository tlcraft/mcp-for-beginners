...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T22:07:50+00:00",
  "source_file": "11-MCPServerHandsOnLabs/04-Database/README.md",
  "language_code": "ro"
}
-->
# Design și Schematizare a Bazei de Date

## 🎯 Ce Acoperă Acest Laborator

Acest laborator explorează în detaliu designul bazei de date PostgreSQL pentru sistemul Zava Retail. Vei învăța să implementezi o schemă cuprinzătoare pentru retail, cu capabilități de căutare vectorială, modelare multi-chiriaș și Row Level Security (RLS) pentru izolarea datelor.

## Prezentare Generală

Baza de date este fundația serverului MCP, stocând datele de retail pentru mai multe magazine, menținând în același timp o izolare strictă a datelor. Folosim PostgreSQL cu extensia pgvector pentru a permite capabilități de căutare semantică, astfel încât clienții să poată găsi produse utilizând interogări în limbaj natural.

Schema noastră urmează modele moderne de multi-chiriaș, cu Row Level Security care asigură că utilizatorii pot accesa doar datele magazinelor autorizate. Această abordare oferă securitate de nivel enterprise, menținând în același timp performanța optimă.

## Obiective de Învățare

Până la finalul acestui laborator, vei putea:

- **Proiecta** scheme de baze de date scalabile pentru retail multi-chiriaș
- **Implementa** PostgreSQL cu pgvector pentru căutare vectorială
- **Configura** Row Level Security pentru izolarea datelor
- **Genera** date de testare realiste
- **Optimiza** performanța bazei de date pentru sarcini de lucru din retail
- **Implementa** strategii de backup și recuperare

## 🗃️ Arhitectura Bazei de Date

### PostgreSQL cu pgvector

Baza noastră de date utilizează funcționalitățile enterprise ale PostgreSQL combinate cu extensia pgvector pentru căutare bazată pe AI:
...
### Arhitectura Multi-Chiriaș

Baza de date folosește un model de multi-chiriaș **bază de date partajată, schemă partajată** cu Row Level Security:
...
## 📊 Designul Schemei de Bază

### Tabelul Stores (Master Chiriaș)
...
## 🔍 Implementarea Căutării Vectoriale

### Tabelul Product Embeddings
...
## 🔐 Configurarea Row Level Security

### Roluri și Permisiuni în Baza de Date
...
### Script pentru Date de Testare Realiste
...
### Vizualizări pentru Optimizarea Interogărilor
...
✅ **Design Multi-Chiriaș al Bazei de Date**: Implementat Row Level Security pentru izolarea sigură a datelor  
✅ **Capabilități de Căutare Vectorială**: Configurat pgvector pentru căutare semantică a produselor  
✅ **Schematizare Cuprinzătoare**: Creat o schemă de bază de date pentru retail, gata de producție  
✅ **Generarea Datelor de Testare**: Construit date de testare realiste pentru dezvoltare și testare  
✅ **Optimizarea Performanței**: Configurat indexuri și optimizarea interogărilor  
✅ **Backup și Recuperare**: Stabilit strategii robuste de protecție a datelor  

## 🚀 Ce Urmează

Continuă cu **[Lab 05: Implementarea Serverului MCP](../05-MCP-Server/README.md)** pentru:

- Construirea serverului FastMCP care se conectează la această bază de date
- Implementarea instrumentelor de interogare a bazei de date pentru protocolul MCP
- Adăugarea capabilităților de căutare semantică utilizând embeddings
- Configurarea pooling-ului de conexiuni și gestionarea erorilor

## 📚 Resurse Suplimentare

### PostgreSQL & pgvector
- [Documentația PostgreSQL](https://www.postgresql.org/docs/) - Referință completă PostgreSQL
- [Extensia pgvector](https://github.com/pgvector/pgvector) - Căutare de similaritate vectorială pentru PostgreSQL
- [Optimizarea Performanței PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Cele mai bune practici de optimizare

### Arhitectura Multi-Chiriaș
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Documentația PostgreSQL RLS
- [Arhitectura Datelor Multi-Chiriaș](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Modele de arhitectură Azure
- [Cele Mai Bune Practici de Securitate a Bazei de Date](https://www.postgresql.org/docs/current/security.html) - Ghid de securitate PostgreSQL

### Baze de Date Vectoriale
- [Fundamentele Căutării Vectoriale](https://www.pinecone.io/learn/vector-database/) - Înțelegerea bazelor de date vectoriale
- [Modele de Embedding](https://platform.openai.com/docs/guides/embeddings) - Documentația embeddings OpenAI
- [Algoritmul HNSW](https://arxiv.org/abs/1603.09320) - Grafuri Hierarchical Navigable Small World

---

**Anterior**: [Lab 03: Configurarea Mediului](../03-Setup/README.md)  
**Următor**: [Lab 05: Implementarea Serverului MCP](../05-MCP-Server/README.md)
