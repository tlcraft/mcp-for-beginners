...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-02T05:47:04+00:00",
...
1. **Fork Repository-ul**: Click pe [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
...
## **Învață MCP prin exemple practice de cod în C#, Java, JavaScript, Python și TypeScript**
...
- 🧑‍💻 [Depozitul MCP pe GitHub](https://github.com/modelcontextprotocol) – SDK-uri open-source, unelte și exemple de cod  
...
- **03. Primii pași cu MCP**  
  Configurarea mediului, servere/cliens de bază, integrare. [Citește mai mult](./03-GettingStarted/README.md)
</details>

### Construirea și implementarea primului server și client MCP, laboratoare practice și scenarii  
<details>
...
### Cele mai bune practici Model Context Protocol  
<details>
...
- **07. Lecții din Primele Etape de Adoptare** – [Ghid](./07-LessonsFromEarlyAdoption/README.md)
...
<details>
  <summary><strong>Lecția 10: Laborator Practic Construind un Server MCP cu AI Toolkit pentru VScode</strong></summary>
...
## Proiecte Sample Model Context Protocol Construind un Proiect MCP Calculator în Java, C#, JavaScript, TypeScript și Python

### 🧮 Proiecte Sample MCP Calculator în Java, C#, JavaScript, TypeScript și Python
<details>
...
<details>
  <summary><strong>Explorează Sample-uri Avansate</strong></summary>

  - [Sample Avansat C#](./04-PracticalImplementation/samples/csharp/README.md)
  - [Exemplu Aplicație Container Java](./04-PracticalImplementation/samples/java/containerapp/README.md)
  - [Sample Avansat JavaScript](./04-PracticalImplementation/samples/javascript/README.md)
  - [Implementare Complexă Python](../../04-PracticalImplementation/samples/python/mcp_sample.py)
  - [Sample Container TypeScript](./04-PracticalImplementation/samples/typescript/README.md)
...
- Instrucțiuni despre cum să folosești proiectele sample  
...
drepturile de utilizare a contribuției tale. Pentru detalii, vizitează <https://cla.opensource.microsoft.com>.

Când trimiți un pull request, un bot CLA va determina automat dacă trebuie să furnizezi
un CLA și va marca PR-ul corespunzător (ex. verificare de stare, comentariu). Urmează pur și simplu instrucțiunile
...
Pentru mai multe informații vezi [FAQ Cod de Conduită](https://opensource.microsoft.com/codeofconduct/faq/) sau contactează [opencode@microsoft.com](mailto:opencode@microsoft.com) pentru întrebări sau comentarii suplimentare.
