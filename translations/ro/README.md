...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-13T14:29:07+00:00",
...
1. **Fork la Repository**: Click pe [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
...
- 📜 [Specificație MCP](https://spec.modelcontextprotocol.io/) – Arhitectura protocolului și referințe tehnice  
...
| Cap | Titlu | Descriere | Link |
|--|--|--|--|
| 00 | **Introducere în MCP** | Prezentare generală a Model Context Protocol și importanța sa în pipeline-urile AI, inclusiv ce este MCP, de ce contează standardizarea și cazuri practice de utilizare și beneficii | [Introducere](./00-Introduction/README.md) |
| 01 | **Concepte de bază explicate** | Explorare detaliată a conceptelor cheie MCP, inclusiv arhitectura client-server, componentele principale ale protocolului și modelele de mesagerie | [Concepte de bază](./01-CoreConcepts/README.md) |
| 02 | **Securitate în MCP** | Identificarea amenințărilor de securitate în sistemele bazate pe MCP, tehnici și bune practici pentru asigurarea implementărilor | [Securitate](./02-Security/README.md) |
| 03 | **Început cu MCP** | Configurarea mediului și setările inițiale, crearea serverelor și clienților MCP de bază, integrarea MCP cu aplicații existente | [Început](./03-GettingStarted/README.md) |
| 3.1 | **Primul server** | Configurarea unui server de bază folosind protocolul MCP, înțelegerea interacțiunii server-client și testarea serverului | [Primul server](./03-GettingStarted/01-first-server/README.md) |
| 3.2 | **Primul client** | Configurarea unui client de bază folosind protocolul MCP, înțelegerea interacțiunii client-server și testarea clientului | [Primul client](./03-GettingStarted/02-client/README.md) |
| 3.3 | **Client cu LLM** | Configurarea unui client folosind protocolul MCP împreună cu un Large Language Model (LLM) | [Client cu LLM](./03-GettingStarted/03-llm-client/README.md) |
...
| 3.6 | **HTTP Streaming** | Învață cum să implementezi streaming HTTP pentru transfer de date în timp real între clienți și serverele MCP | [HTTP Streaming](./03-GettingStarted/06-http-streaming/README.md) |
| 3.7 | **Folosirea AI Toolkit** | AI Toolkit este un instrument excelent care te va ajuta să gestionezi fluxul de lucru AI și MCP | [Folosirea AI Toolkit](./03-GettingStarted/07-aitk/README.md) |
...
| 3.9 | **Deplasează serverul tău** | Cum să treci de la dezvoltarea locală la producție? Această secțiune te va ajuta să dezvolți și să implementezi serverul | [Deplasează serverul tău](./03-GettingStarted/09-deployment/README.md) |
| 04 | **Implementare practică** | Folosirea SDK-urilor în diverse limbaje, depanare, testare și validare, crearea de șabloane și fluxuri de lucru reutilizabile pentru prompturi | [Implementare practică](./04-PracticalImplementation/README.md) |
| 05 | **Subiecte avansate în MCP** | Fluxuri de lucru AI multimodale și extensibilitate, strategii sigure de scalare, MCP în ecosisteme enterprise | [Subiecte avansate](./05-AdvancedTopics/README.md) |
| 5.1 | **Integrare MCP cu Azure** | Demonstrează integrarea cu Azure | [Integrare MCP Azure](./05-AdvancedTopics/mcp-integration/README.md) |
| 5.2 | **Multimodalitate** | Arată cum să lucrezi cu diferite modalități, cum ar fi imagini și altele | [Multimodalitate](./05-AdvancedTopics/mcp-multi-modality/README.md) |
| 5.3 | **Demo MCP OAuth2** | Aplicație minimală Spring Boot care demonstrează OAuth2 cu MCP, atât ca Authorization cât și Resource Server. Prezintă emiterea sigură a tokenurilor, endpoint-uri protejate, implementare pe Azure Container Apps și integrare cu API Management | [Demo MCP OAuth2](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
| 5.4 | **Root Contexts** | Află mai multe despre root context și cum să îl implementezi | [Root Contexts](./05-AdvancedTopics/mcp-root-contexts/README.md) |
...
| 5.8 | **Securitate** | Asigură-ți serverul MCP, inclusiv autentificare, autorizare și strategii de protecție a datelor | [Securitate](./05-AdvancedTopics/mcp-security/README.md) |
| 5.9 | **Web Search MCP** | Server și client MCP în Python care integrează SerpAPI pentru căutare web, știri, produse și întrebări & răspunsuri în timp real. Demonstrează orchestrarea multi-unelte, integrarea API extern și gestionarea robustă a erorilor | [Web Search MCP](./05-AdvancedTopics/web-search-mcp/README.md) |
| 5.10 | **Streaming în timp real** | Streaming-ul de date în timp real a devenit esențial în lumea actuală condusă de date, unde afacerile și aplicațiile au nevoie de acces imediat la informații pentru a lua decizii la timp | [Streaming în timp real](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
| 5.11 | **Căutare web în timp real** | Cum MCP transformă căutarea web în timp real prin oferirea unei abordări standardizate pentru gestionarea contextului între modele AI, motoare de căutare și aplicații | [Căutare web în timp real](./05-AdvancedTopics/mcp-realtimesearch/README.md) |
| 06 | **Contribuții ale comunității** | Cum să contribui cu cod și documentație, colaborarea prin GitHub, îmbunătățiri și feedback conduse de comunitate | [Contribuții ale comunității](./06-CommunityContributions/README.md) |
| 07 | **Perspective din Adopția Timpurie** | Implementări în lumea reală și ce a funcționat, construirea și implementarea soluțiilor bazate pe MCP, tendințe și foaia de parcurs viitoare | [Insights](./07-LessonsFromEarlyAdoption/README.md) |
| 08 | **Cele Mai Bune Practici pentru MCP** | Ajustarea performanței și optimizare, proiectarea sistemelor MCP tolerante la erori, strategii de testare și reziliență | [Best Practices](./08-BestPractices/README.md) |
| 09 | **Studii de Caz MCP** | Analize detaliate ale arhitecturilor soluțiilor MCP, planuri de implementare și sfaturi pentru integrare, diagrame comentate și prezentări ale proiectelor | [Case Studies](./09-CaseStudy/README.md) |
| 10 | **Simplificarea Fluxurilor AI: Construirea unui Server MCP cu AI Toolkit** | Atelier practic cuprinzător care combină MCP cu AI Toolkit de la Microsoft pentru VS Code. Învață să construiești aplicații inteligente ce leagă modelele AI de instrumente reale prin module practice ce acoperă fundamentele, dezvoltarea serverului personalizat și strategii de implementare în producție. | [Hands On Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
...
4. Resurse suplimentare pentru cei avansați  
...
Când trimiți un pull request, un bot CLA va determina automat dacă trebuie să furnizezi un CLA și va marca PR-ul corespunzător (de exemplu, verificare de stare, comentariu). Urmează pur și simplu instrucțiunile oferite de bot. Va trebui să faci acest lucru o singură dată pentru toate depozitele care folosesc CLA-ul nostru.

Acest proiect a adoptat [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/). Pentru mai multe informații, vezi [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) sau contactează [opencode@microsoft.com](mailto:opencode@microsoft.com) pentru întrebări sau comentarii suplimentare.
...
- [Stăpânirea GitHub Copilot pentru dezvoltatorii C#/.NET](https://github.com/microsoft/mastering-github-copilot-for-dotnet-csharp-developers?WT.mc_id=academic-105485-koreyst)
...
Orice utilizare a mărcilor comerciale sau logo-urilor terților este supusă politicilor acestor terți.
