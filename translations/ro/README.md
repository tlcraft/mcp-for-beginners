...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-20T22:27:25+00:00",
...
1. **Fă fork la Repository**: Click pe [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/network)
...
**Model Context Protocol (MCP)** este un cadru inovator creat pentru a standardiza interacțiunile dintre modelele AI și aplicațiile client. Acest curriculum open-source oferă un parcurs de învățare structurat, completat cu exemple practice de cod și cazuri de utilizare reale, în limbaje populare precum C#, Java, JavaScript, TypeScript și Python.
...
|--|--|--|--|
| 00 | **Introducere în MCP** | Prezentare generală a Model Context Protocol și importanța sa în fluxurile AI, inclusiv ce este MCP, de ce contează standardizarea și exemple practice cu beneficii | [Introducere](./00-Introduction/README.md) |
...
| 03 | **Începutul cu MCP** | Configurarea mediului, crearea serverelor și clienților MCP de bază, integrarea MCP cu aplicații existente | [Început](./03-GettingStarted/README.md) |
...
| 3.3 | **Client cu LLM**  | Configurarea unui client folosind MCP cu un Large Language Model (LLM) | [Client cu LLM](./03-GettingStarted/03-llm-client/README.md) |
...
| 3.8 | **Deplasează serverul în producție** | Cum treci de la dezvoltarea locală la producție? Această secțiune te va ajuta să dezvolți și să implementezi serverul | [Deplasează serverul în producție](./03-GettingStarted/08-deployment/README.md) |
| 04 | **Implementare practică** | Folosirea SDK-urilor în diverse limbaje, depanare, testare și validare, crearea de șabloane și fluxuri reutilizabile pentru prompturi | [Implementare practică](./04-PracticalImplementation/README.md) |
...
| 06 | **Contribuții din comunitate** | Cum să contribui cu cod și documentație, colaborare prin GitHub, îmbunătățiri și feedback din comunitate | [Contribuții din comunitate](./06-CommunityContributions/README.md) |
...
| 09 | **Studii de caz MCP** | Analize detaliate ale arhitecturilor soluțiilor MCP, planuri de implementare și sfaturi de integrare, diagrame explicative și prezentări de proiect | [Studii de caz](./09-CaseStudy/README.md) |

## Proiecte exemplu

### 🧮 Proiecte exemplu MCP Calculator:
<details>
  <summary><strong>Explorează implementări de cod pe limbaje</strong></summary>
...
Contributor License Agreement (CLA) prin care declari că ai dreptul și chiar ne acorzi drepturile de a folosi contribuția ta. Pentru detalii, vizitează <https://cla.opensource.microsoft.com>.
...
Utilizarea mărcilor sau logo-urilor Microsoft în versiuni modificate ale acestui proiect nu trebuie să creeze confuzie sau să sugereze sponsorizare Microsoft.
Orice utilizare a mărcilor sau logo-urilor unor terți este supusă politicilor acelor terți.
