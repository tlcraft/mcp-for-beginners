...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-06-27T15:20:22+00:00",
...
1. **Fă un fork al Repository-ului**: Apasă pe [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
...
- **01. Explicarea conceptelor de bază**  
  Explorare detaliată a conceptelor esențiale MCP. [Citește mai mult](./01-CoreConcepts/README.md)
...
- **03. Primii pași cu MCP**  
  Configurarea mediului, servere/clișeuri de bază, integrare. [Citește mai mult](./03-GettingStarted/README.md)
</details>
...
- **3.9. Implementarea serverului** – [Ghid](./03-GettingStarted/09-deployment/README.md)
</details>
...
- **05. Subiecte avansate în MCP**  
  AI multimodal, scalare, utilizare în companii. [Citește mai mult](./05-AdvancedTopics/README.md)
...
- **5.6. Eșantionare** – [Ghid](./05-AdvancedTopics/mcp-sampling/README.md)
...
- **06. Contribuții Comunitare** – [Ghid](./06-CommunityContributions/README.md)
...
Acest proiect primește cu interes contribuții și sugestii. Majoritatea contribuțiilor necesită să accepți un
Acord de Licență pentru Contribuitor (CLA) prin care declari că ai dreptul și într-adevăr ne acorzi
