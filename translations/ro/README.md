...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-19T15:08:59+00:00",
...
1. **Fork la Repository**: Click pe [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/network)
2. **Clonează Repository-ul**:   `git clone https://github.com/microsoft/mcp-for-beginners.git`
3. [**Alătură-te Discord-ului Azure AI Foundry și întâlnește experți și dezvoltatori colegi**](https://discord.com/invite/ByRwuEEgH4)
...
# 🚀 Ghidul final pentru curriculumul Model Context Protocol (MCP) pentru începători
...
- 📘 [MCP Documentation](https://modelcontextprotocol.io/) – Tutoriale detaliate și ghiduri de utilizare  
...
- Cazuri practice și avantaje ale MCP  
...
- Mesagerie MCP și modele de schimb de date  

### 🔐 [Securitatea în MCP](./02-Security/readme.md)

- Identificarea amenințărilor de securitate în sistemele bazate pe MCP  
- Tehnici și bune practici pentru implementări sigure  

### 🚀 [Primii pași cu MCP](./03-GettingStarted/README.md)

- Configurarea și pregătirea mediului  
- Crearea de servere și clienți MCP de bază  
- Integrarea MCP cu aplicații existente  
...
- Crearea de template-uri și fluxuri de lucru reutilizabile  
...
2. Exemple live de cod în mai multe limbaje  
3. Exerciții pentru a crea aplicații reale MCP  
4. Resurse suplimentare pentru învățători avansați  

## 📜 Informații despre licență

Acest conținut este licențiat sub **MIT License**. Pentru termenii și condițiile complete, vezi [LICENSE](../../LICENSE).

## 🤝 Ghid pentru contribuții

Acest proiect primește cu plăcere contribuții și sugestii. Majoritatea contribuțiilor necesită să fii de acord cu un Acord de Licențiere a Contribuitorului (CLA) prin care declari că ai dreptul și într-adevăr ne acorzi drepturile de a folosi contribuția ta. Pentru detalii, vizitează <https://cla.opensource.microsoft.com>.

Când trimiți un pull request, un bot CLA va determina automat dacă trebuie să furnizezi un CLA și va marca PR-ul corespunzător (ex. verificare status, comentariu). Urmează pur și simplu instrucțiunile oferite de bot. Aceasta se face o singură dată pentru toate repo-urile care folosesc CLA-ul nostru.
...
## ™️ Notificare privind Marca Comercială
